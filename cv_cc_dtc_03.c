...
bool func_72(var uParam0)
{
	...
	{
		case 1:
			__LIB_7__::func_116(uParam0, -122.374f, -8.581f, 95.2f, 0f, 0f, 0f);
			break;
		case 2:
			__LIB_7__::func_116(uParam0, 669.6f, -1250.3f, 42.96f, 0f, 0f, -165f);
			break;
		case 3:
			__LIB_7__::func_116(uParam0, 1868.05f, -1850.8f, 41.9f, 1.55f, 0f, 83.445f);
			break;
		default:
			return false;
	}
	iLocal_14 = __LIB_7__::func_48(uParam0, 0, 0);
	__LIB_7__::func_47(uParam0, 0.1689f, -0.7804f, 0f, 14f, 1.155f, 1.0825f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_DUTCH"), 1, 1, 1);
	__LIB_6__::func_958(uParam0, joaat("P_CS_BOOKEVELYNMILLER"), 0f, 0f, 0f, "BOOK", 0, 1, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@dutch_3@base", 1, 1, 0, 0);
	iLocal_15 = __LIB_6__::func_959(uParam0, "script@vignette@dutch_3@beckon_a", 2, 0, 1, 1);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@dutch_3@beckon_b", 2, 0, 0, 1);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@dutch_3@action_a", 2, 0, 0, 1);
	iLocal_18 = __LIB_6__::func_959(uParam0, "script@vignette@dutch_3@action_b", 2, 0, 0, 0);
	iLocal_23 = __LIB_6__::func_959(uParam0, "script@vignette@dutch_3@base", 2, 0, 0, 0);
	iLocal_24 = __LIB_6__::func_959(uParam0, "script@vignette@dutch_3@base", 2, 0, 0, 0);
	iLocal_19 = __LIB_6__::func_959(uParam0, "script@vignette@dutch_3@dismiss_sit", 2, 0, 0, 0);
	iLocal_20 = __LIB_6__::func_959(uParam0, "script@vignette@dutch_3@dismiss_stand", 2, 0, 0, 0);
	iLocal_21 = __LIB_6__::func_959(uParam0, "script@vignette@dutch_3@exit_idle", 2, 0, 0, 0);
	iLocal_22 = __LIB_6__::func_959(uParam0, "script@vignette@dutch_3@exit", 0, 0, 0, 0);
	__LIB_7__::func_146(uParam0, "CDT3AUD");
	__LIB_7__::func_149(uParam0, joaat("COMP_DTCCNV3"), joaat("PLAYER_DTCCNV3"));
	__LIB_7__::func_150(uParam0, iLocal_18, -1, 0.85f);
	__LIB_7__::func_147(uParam0, iLocal_14, 2, 3, 0, 0, 0);
	...
	Local_25 = { __LIB_7__::func_160(uParam0, 0.255f, -0.5375f, 0.564f, 173.5f, 10f, 0.9775f, 0.8625f) };
	Local_35 = { __LIB_7__::func_160(uParam0, 0.255f, -0.538f, 0.564f, 171.32f, 7f, 1f, 0.84f) };
	return true;
}
...
{
	return __LIB_7__::func_163(uParam0, Local_25, 1, 0);
}

bool func_93(var uParam0)
{
	if (__LIB_7__::func_38(uParam0, iLocal_15) || __LIB_7__::func_38(uParam0, iLocal_16))
	{
		if (__LIB_7__::func_163(uParam0, Local_35, 1, 0))
		{
			if (__LIB_7__::func_272(__LIB_6__::func_952(uParam0, iLocal_14), -1687173729))
			{
				__LIB_7__::func_154(uParam0, iLocal_17, 1);
			}
		}
	}
	if (__LIB_7__::func_38(uParam0, iLocal_23) || __LIB_7__::func_38(uParam0, iLocal_24))
	{
		if (__LIB_7__::func_163(uParam0, Local_35, 1, 0))
		{
			__LIB_7__::func_154(uParam0, iLocal_17, 1);
	...
	if (__LIB_7__::func_148(uParam0, iLocal_23))
	{
		...
		else if (__LIB_7__::func_163(uParam0, Local_25, 1, 0))
		{
