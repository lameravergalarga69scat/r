...
bool func_72(var uParam0)
{
	...
	__LIB_7__::func_47(uParam0, -2.3021f, -3.5906f, 0f, 0f, 1.3f, 1.3f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_JAVIER"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, 0.1375f, 0.2f, 0.6f, 2f, 3.7175f, 3.495f, 2.685f, joaat("VOLBOX"), -1, 1, 1, 1);
	__LIB_7__::func_159(uParam0, -0.32f, -1.6f, 1.0028f, 0f, 1.3f, 1.3f, 2f, joaat("VOLCYLINDER"), 1);
	iLocal_14 = __LIB_7__::func_48(uParam0, 6, 0);
	iLocal_15 = __LIB_7__::func_48(uParam0, 2, 0);
	__LIB_6__::func_958(uParam0, joaat("P_CIGARETTE_CS01X"), 0f, 0f, 0f, "CIGARETTE", 0, 0, 1);
	__LIB_6__::func_958(uParam0, joaat("P_CHAIR_BARREL04B"), -0.584473f, -1.37158f, -0.00269318f, "CHAIRBARREL", 1, 0, 1);
	iLocal_30 = __LIB_6__::func_958(uParam0, joaat("P_CS_RAG02X"), 0f, 0f, 0f, "RAG", 0, 0, 1);
	iLocal_29 = __LIB_6__::func_958(uParam0, joaat("P_CHAIR_CRATE02X"), 1.42041f, -0.462646f, -0.00141144f, 0, 1, 0, 1);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@javier_8@base", 1, 0, 0, 0);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@javier_8@Action_A", 2, 0, 1, 0);
	iLocal_18 = __LIB_6__::func_959(uParam0, "script@vignette@javier_8@Action_A_INT_LEFT", 2, 0, 0, 1);
	iLocal_19 = __LIB_6__::func_959(uParam0, "script@vignette@javier_8@Action_A_INT_RIGHT", 2, 0, 0, 1);
	iLocal_20 = __LIB_6__::func_959(uParam0, "script@vignette@javier_8@INT_LEFT_TO_ACTION_B", 2, 0, 0, 0);
	iLocal_21 = __LIB_6__::func_959(uParam0, "script@vignette@javier_8@INT_RIGHT_TO_ACTION_B", 2, 0, 0, 0);
	iLocal_22 = __LIB_6__::func_959(uParam0, "script@vignette@javier_8@INT_LEFT_TO_EXIT", 0, 0, 0, 0);
	iLocal_23 = __LIB_6__::func_959(uParam0, "script@vignette@javier_8@INT_RIGHT_TO_EXIT", 0, 0, 0, 0);
	iLocal_24 = __LIB_6__::func_959(uParam0, "script@vignette@javier_8@Action_B", 2, 0, 0, 0);
	iLocal_25 = __LIB_6__::func_959(uParam0, "script@vignette@javier_8@Action_C", 2, 0, 0, 0);
	iLocal_26 = __LIB_6__::func_959(uParam0, "script@vignette@javier_8@Action_D", 0, 0, 0, 0);
	iLocal_28 = __LIB_6__::func_959(uParam0, "script@vignette@javier_8@Action_D_ALT_RIGHT", 0, 0, 0, 1);
	iLocal_27 = __LIB_6__::func_959(uParam0, "script@vignette@javier_8@Action_D_Alt_Left", 0, 0, 0, 1);
	Local_31 = { __LIB_7__::func_160(uParam0, 1.2835f, -0.326f, 0.9877f, -174f, 6f, 0.41f, 0.19f) };
	Local_41 = { __LIB_7__::func_160(uParam0, 1.284f, -0.5185f, 0.9877f, 52f, 5f, 0.424f, 0.459f) };
	__LIB_7__::func_146(uParam0, "CJAV8AU");
	__LIB_7__::func_107(uParam0, iLocal_14, 3, joaat("PROP_CAMP_MICAH_SEAT_CHAIR_CLEAN_GUN"), "PROP_CAMP_MICAH_SEAT_CHAIR_CLEAN_GUN_MALE_A", iLocal_29, 0);
	__LIB_7__::func_127(uParam0, iLocal_14, 3, joaat("PROP_CAMP_MICAH_SEAT_CHAIR_CLEAN_GUN"), "PROP_CAMP_MICAH_SEAT_CHAIR_CLEAN_GUN_MALE_A", iLocal_29, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_139(uParam0, iLocal_14, iLocal_30, "p_cs_rag02x_PH_L_HAND", 0, 0);
	__LIB_7__::func_147(uParam0, iLocal_14, 4, 1, 0, 0, 0);
	__LIB_7__::func_151(uParam0, iLocal_14, 1, -1);
	__LIB_7__::func_277(uParam0, iLocal_14, "GREET_MICAH_JAVCNV8", 60000, 1);
	__LIB_7__::func_147(uParam0, iLocal_15, 4, 1, 0, 0, 0);
	__LIB_7__::func_145(uParam0, 5f, 20f);
	__LIB_7__::func_149(uParam0, joaat("COMP_JAVCNV8"), joaat("PLAYER_JAVCNV8"));
	return true;
}
...
{
	if (!WEAPON::HAS_PED_GOT_WEAPON(__LIB_6__::func_952(uParam0, iLocal_14), iLocal_55, 0, false))
	{
		WEAPON::_GIVE_WEAPON_TO_PED_2(__LIB_6__::func_952(uParam0, iLocal_14), iLocal_55, 1, true, true, 0, false, 0.5f, 1f, 752097756, true, 0f, false);
	}
	else
	{
		WEAPON::SET_CURRENT_PED_WEAPON(__LIB_6__::func_952(uParam0, iLocal_14), iLocal_55, true, 0, false, false);
	}
	iLocal_54 = WEAPON::GET_CURRENT_PED_WEAPON_ENTITY_INDEX(__LIB_6__::func_952(uParam0, iLocal_14), 0);
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_54) && __LIB_0__::func_399(__LIB_6__::func_952(uParam0, iLocal_14), 1, 0, 0) == iLocal_55)
	{
...
bool func_93(var uParam0)
{
	...
	{
		if (__LIB_7__::func_163(uParam0, Local_31, 1, 0))
		{
			fLocal_52 = MISC::GET_DISTANCE_BETWEEN_COORDS(Global_36, __LIB_6__::func_972(uParam0, 1.375f, -0.663f, 0.472f), true);
			iLocal_51 = iLocal_18;
			__LIB_7__::func_173(uParam0, iLocal_18, 1);
		}
		else if (__LIB_7__::func_163(uParam0, Local_41, 1, 0))
		{
			fLocal_52 = MISC::GET_DISTANCE_BETWEEN_COORDS(Global_36, __LIB_6__::func_972(uParam0, 1.375f, -0.663f, 0.472f), true);
			iLocal_51 = iLocal_19;
		...
		{
			__LIB_7__::func_173(uParam0, iLocal_24, 1);
		}
	}
	if (__LIB_7__::func_148(uParam0, iLocal_51))
	{
		fLocal_53 = MISC::GET_DISTANCE_BETWEEN_COORDS(Global_36, __LIB_6__::func_972(uParam0, 1.375f, -0.663f, 0.472f), true);
		if (fLocal_53 < fLocal_52)
		{
			...
			{
				__LIB_7__::func_173(uParam0, iLocal_23, 1);
			}
		}
	...
	if (__LIB_7__::func_148(uParam0, iLocal_20) || __LIB_7__::func_148(uParam0, iLocal_21))
	{
		__LIB_7__::func_173(uParam0, iLocal_24, 1);
	}
	if (__LIB_7__::func_148(uParam0, iLocal_24))
	{
		__LIB_7__::func_173(uParam0, iLocal_25, 1);
	}
	if (__LIB_7__::func_148(uParam0, iLocal_25))
	{
		if (__LIB_7__::func_163(uParam0, Local_31, 1, 0))
		{
			__LIB_7__::func_173(uParam0, iLocal_27, 1);
		}
		else if (__LIB_7__::func_163(uParam0, Local_41, 1, 0))
		{
		...
		{
			__LIB_7__::func_173(uParam0, iLocal_26, 1);
		}
	}
...
void func_196(var uParam0, int iParam1, char* sParam2)
{
	int iVar0;
	iVar0 = 0;
