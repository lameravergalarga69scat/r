...
bool func_77(var uParam0)
{
	...
	{
		case 6:
			__LIB_7__::func_116(uParam0, 2357.349f, 1359.13f, 105.0552f, 0f, 0f, 0f);
			break;
		default:
			return false;
	}
	iLocal_92 = __LIB_7__::func_48(uParam0, 18, 0);
	iLocal_95 = __LIB_6__::func_959(uParam0, "script@vignette@wnt@strauss_4@action", 0, 0, 0, 1);
	iLocal_93 = __LIB_7__::func_165(uParam0, 18, 0, 1);
	__LIB_7__::func_107(uParam0, iLocal_93, 3, joaat("WORLD_ANIMAL_HORSE_GRAZING"), "WORLD_ANIMAL_HORSE_GRAZING", -1, 0);
	__LIB_7__::func_233(uParam0, iLocal_93, 2360.11f, 1335.66f, 104.56f, -115.89f, 0, 0);
	__LIB_7__::func_146(uParam0, "CSTR4AU");
	__LIB_7__::func_172(uParam0, iLocal_92, 1);
	__LIB_7__::func_229(uParam0, iLocal_92);
	__LIB_0__::func_19(&uLocal_18, iLocal_92);
	__LIB_7__::func_397(uParam0, &uLocal_18);
...
{
	__LIB_7__::func_302(uParam0, &uLocal_18);
	__LIB_7__::func_99(uParam0, iLocal_95, 1);
	return true;
}
...
bool func_98(var uParam0)
{
	...
	if (bLocal_94)
	{
		if (!__LIB_0__::func_163(__LIB_6__::func_952(uParam0, iLocal_92), 242628503) || (ENTITY::IS_ENTITY_OCCLUDED(__LIB_6__::func_952(uParam0, iLocal_92)) && (__LIB_1__::func_992(__LIB_6__::func_952(uParam0, iLocal_92), 2360.11f, 1335.66f, 104.56f, 1) > 2401f || __LIB_0__::func_232(Global_35, __LIB_6__::func_952(uParam0, iLocal_92), 1) > 484f)))
		{
	...
	if (!bLocal_94)
	{
		...
		if (__LIB_7__::func_74(uParam0, iLocal_92))
		{
			...
			TASK::TASK_MOUNT_ANIMAL(0, __LIB_6__::func_952(uParam0, iLocal_93), 20000, -1, 1.2f, 1, 0, 0);
			TASK::_TASK_MOVE_IN_TRAFFIC_4(0, 2f, 2433.969f, 843.4677f, 73.4796f, 1);
			TASK::CLOSE_SEQUENCE_TASK(iVar7);
			TASK::TASK_PERFORM_SEQUENCE(__LIB_6__::func_952(uParam0, iLocal_92), iVar7);
