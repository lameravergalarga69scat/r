...
bool func_72(var uParam0)
{
	...
	__LIB_7__::func_47(uParam0, 0.125f, -0.4001f, 1.4875f, 0f, 1.1f, 1.1f, 3.2075f, joaat("VOLBOX"), joaat("APMS_COMP_DUTCH"), 1, 1, 1);
	iLocal_15 = __LIB_6__::func_958(uParam0, joaat("P_CHAIRFOLDING02X"), 0f, 0f, 0f, "Chair", 1, 0, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@dutch_34@base", 1, 1, 0, 0);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@dutch_34@action", 0, 0, 1, 1);
	__LIB_7__::func_146(uParam0, "CDT34AU");
	__LIB_7__::func_149(uParam0, joaat("COMP_DTCCNV34"), joaat("PLAYER_DTCCNV34"));
	__LIB_7__::func_150(uParam0, iLocal_16, -1, 0.78f);
	__LIB_7__::func_127(uParam0, iLocal_14, 3, joaat("PROP_CAMP_FIRE_SEATED"), "PROP_CAMP_FIRE_SEAT_CHAIR_MALE_C", iLocal_15, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	...
	Local_17 = { __LIB_7__::func_160(uParam0, 0f, -0.3f, 0.9877f, 169f, 6.5f, 0.705f, 0.4425f) };
	return true;
}
