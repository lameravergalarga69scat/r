...
bool func_72(var uParam0)
{
	...
	__LIB_7__::func_47(uParam0, -2.25f, 0.75f, 0f, 0f, 3f, 3f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_PEARSON"), 1, 1, 1);
	iLocal_18 = __LIB_6__::func_958(uParam0, joaat("P_CS_CARROTSLICE01X"), 0f, 0f, 0f, "CARROT", 0, 1, 1);
	iLocal_17 = __LIB_6__::func_958(uParam0, joaat("P_KNIFE03X"), 0f, 0f, 0f, "KNIFE", 0, 0, 1);
	iLocal_15 = __LIB_6__::func_958(uParam0, joaat("P_CS_VEGSACK_UP"), 0f, 0f, 0f, "SACK_1", 0, 0, 1);
	iLocal_16 = __LIB_6__::func_958(uParam0, joaat("P_CS_VEGSACK_DOWN"), 0f, 0f, 0f, "SACK_2", 0, 0, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@pearson_4@base", 1, 1, 0, 0);
	__LIB_6__::func_959(uParam0, "script@vignette@pearson_4@action_back", 0, 0, 1, 1);
	__LIB_7__::func_146(uParam0, "CPRAUD4");
	__LIB_7__::func_127(uParam0, iLocal_14, 4, joaat("PROP_HUMAN_FOODPREP_STEW"), "PROP_HUMAN_FOODPREP_STEW_CHOP_CARROT_MALE_B", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_139(uParam0, iLocal_14, iLocal_17, "p_knife03x_PH_R_HAND", 0, 0);
	__LIB_7__::func_139(uParam0, iLocal_14, iLocal_18, "p_cs_carrotSlice01x_PH_L_Hand", 0, 0);
	__LIB_7__::func_147(uParam0, iLocal_14, 4, 3, 0, 0, 0);
	__LIB_7__::func_151(uParam0, iLocal_14, 2, -1);
	Local_22 = { __LIB_7__::func_160(uParam0, -1.92f, -0.8f, 0f, 64.08f, 7f, 1f, 1f) };
...
bool func_84(var uParam0)
{
	...
	{
		case 1:
			__LIB_0__::func_400(-1445186253);
			break;
		case 2:
			__LIB_0__::func_400(-1291679096);
			break;
		case 3:
			__LIB_0__::func_400(-960337247);
			break;
		default:
			return false;
	}
...
{
	ENTITY::SET_ENTITY_COLLISION(__LIB_7__::func_30(uParam0, iLocal_16), false, false);
	return true;
}
...
{
	PLAYER::_0x3946FC742AC305CD(PLAYER::GET_PLAYER_INDEX(), __LIB_6__::func_952(uParam0, iLocal_14), "CCPRS_CNV_4", 0f, 0f, 0f, 0, 0);
	return true;
}

bool func_95(var uParam0)
{
	if (PED::_0x569F1E1237508DEB(__LIB_6__::func_952(uParam0, iLocal_14)) == joaat("PROP_HUMAN_FOODPREP_STEW_VEGDROP_CARROT_MALE_B"))
	{
		if (!bLocal_21)
		{
			bLocal_21 = true;
			ENTITY::SET_ENTITY_AS_MISSION_ENTITY(__LIB_7__::func_30(uParam0, iLocal_18), true, false);
	...
	if (!CAM::IS_SPHERE_VISIBLE(vLocal_32, 1f))
	{
		...
		{
			case 1:
				__LIB_0__::func_401(-1445186253);
				break;
			case 2:
				__LIB_0__::func_401(-1291679096);
				break;
			case 3:
				__LIB_0__::func_401(-960337247);
				break;
		}
		iLocal_19 = __LIB_7__::func_30(uParam0, iLocal_15);
		iLocal_20 = __LIB_7__::func_30(uParam0, iLocal_16);
