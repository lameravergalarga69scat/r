...
{
	PED::_0xDE7B2B4144906CDF(1836698515, __LIB_6__::func_952(uParam0, iLocal_15));
	return true;
}
...
bool func_72(var uParam0)
{
	...
	{
		case 5:
			__LIB_7__::func_45(uParam0, 178, 0, 0, 0);
			break;
		default:
			return false;
	}
	__LIB_7__::func_47(uParam0, 7.823f, 1.9801f, 1.07673f, 0f, 1.1f, 1.1f, 4f, joaat("VOLBOX"), joaat("APMS_COMP_GRIMSHAW"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, -1.788f, -2.72449f, 1.06299f, 0f, 1.2f, 1.2f, 4f, joaat("VOLBOX"), joaat("APMS_COMP_PEARSON"), 1, 1, 1);
	iLocal_20 = __LIB_6__::func_958(uParam0, joaat("P_CRATE03B"), 0f, 0f, 0f, "p_crate03x", 0, 0, 1);
	iLocal_21 = __LIB_6__::func_958(uParam0, joaat("P_CIGARETTE_CS01X"), 0f, 0f, 0f, "p_cigarette_cs01x", 0, 0, 1);
	iLocal_14 = __LIB_7__::func_48(uParam0, 19, 0);
	iLocal_15 = __LIB_7__::func_48(uParam0, 17, 0);
	__LIB_6__::func_959(uParam0, "script@vignette@susan_10@base", 1, 1, 0, 0);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@susan_10@action_a", 2, 0, 1, 0);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@susan_10@action_b_front", 0, 0, 0, 1);
	iLocal_18 = __LIB_6__::func_959(uParam0, "script@vignette@susan_10@action_b_left", 0, 0, 0, 1);
	iLocal_19 = __LIB_6__::func_959(uParam0, "script@vignette@susan_10@action_b_right", 0, 0, 0, 1);
	__LIB_7__::func_146(uParam0, "CSN10AU");
	__LIB_7__::func_107(uParam0, iLocal_14, 3, joaat("WORLD_HUMAN_SMOKE"), "WORLD_HUMAN_SMOKE_FEMALE_A", -1, 1);
	__LIB_7__::func_127(uParam0, iLocal_14, 2, joaat("WORLD_HUMAN_SMOKE"), "WORLD_HUMAN_SMOKE_FEMALE_A", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_139(uParam0, iLocal_14, iLocal_21, "p_cigarette_cs01x_PH_R_HAND", 0, 0);
	__LIB_7__::func_312(uParam0, iLocal_14);
	__LIB_7__::func_127(uParam0, iLocal_15, 3, joaat("WORLD_HUMAN_BOX_PUT_DOWN_1"), "WORLD_HUMAN_BOX_PUT_DOWN_1_MALE_A", -1, 0, 45f, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_171(uParam0, iLocal_15, 3, 0);
	__LIB_7__::func_139(uParam0, iLocal_15, iLocal_20, "p_crate03x_PH_R_HAND", 0, 0);
	__LIB_7__::func_312(uParam0, iLocal_15);
	__LIB_7__::func_328(uParam0, iLocal_15, 0);
	Local_22 = { __LIB_7__::func_160(uParam0, -5.7256f, 1.5881f, 1.0026f, 103.4663f, 8f, 0.285f, 0.575f) };
	Local_32 = { __LIB_7__::func_160(uParam0, -5.726f, 1.588f, 1.003f, 13.68f, 8f, 0.422f, 0.325f) };
	Local_42 = { __LIB_7__::func_160(uParam0, -5.726f, 1.588f, 1.003f, 165.6f, 8f, 0.316f, 0.405f) };
	return true;
}
...
{
	int iVar0;
	iVar0 = __LIB_6__::func_952(uParam0, iLocal_15);
...
{
	if (__LIB_2__::func_774(44) || __LIB_6__::func_110())
	{
		return false;
	}
	return true;
...
{
	bool bVar0;
	if (__LIB_7__::func_329(uParam0, iLocal_15))
	{
	...
	if (__LIB_7__::func_148(uParam0, iLocal_16))
	{
		...
		if (bVar0)
		{
			__LIB_7__::func_149(uParam0, joaat("COMP_SSNCNV10"), joaat("PLAYER_SSNCNV10"));
	...
	switch (Global_1360165[iParam0 /*1157*/].f_11)
	{
		...
		case 3:
			if (!ENTITY::IS_ENTITY_DEAD(Global_1360165[iParam0 /*1157*/]) && !ANIMSCENE::_0x3AB6C7B0BB0DF4B1(Global_1360165[iParam0 /*1157*/], -1))
			{
				...
				func_428(Global_1360165[iParam0 /*1157*/], vVar0, iParam6, 2, 1073741824 /* Float: 2f */);
			}
			else if (bParam16)
			{
	...
	switch (Global_1360165[iParam0 /*1157*/].f_70.f_12)
	{
		...
		case 3:
			...
			if ((bParam2 && !__LIB_0__::func_86(vVar0)) && !__LIB_0__::func_175(vVar0, ENTITY::GET_ENTITY_COORDS(Global_1360165[iParam0 /*1157*/].f_124, true, false), 1056964608 /* Float: 0.5f */, 1))
			{
				...
				func_428(Global_1360165[iParam0 /*1157*/].f_124, vVar0, iParam6, 2, 1073741824 /* Float: 2f */);
			}
			if (bParam1)
			{
