...
{
	__LIB_2__::func_851(uParam0, 10865, 10944, 11705);
}

void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	__LIB_2__::func_853(uParam0, "WOLF_AMBUSH_DEER", "script@ambient@animal@WOLF_AMBUSH_DEER@action", vParam1, vParam4);
	uParam0->f_16 = 1;
	__LIB_2__::func_854(uParam0, 1, "pbl_action", "", 0);
	__LIB_2__::func_855(uParam0, 0, "WOLF", iLocal_9, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 0);
	__LIB_2__::func_855(uParam0, 1, "DEER", iLocal_10, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 0);
}
...
int func_30(var uParam0)
{
	...
	__LIB_1__::func_397(&uLocal_28, 1);
	__LIB_2__::func_830(&uLocal_28, 1);
	__LIB_2__::func_906(&uLocal_28, 55);
	return 1;
}
...
int func_31(var uParam0)
{
	...
	if (!uParam0->f_469[0])
	{
		if (!bLocal_23 == 1)
		{
			if (__LIB_2__::func_908(uParam0, &uLocal_28, 1) || __LIB_0__::func_232(Global_35, uParam0->f_20[0 /*14*/], 1) <= 625f)
			{
				bLocal_23 = true;
			}
		}
		if (bLocal_23)
		{
			...
			{
				if (!__LIB_0__::func_75(&uLocal_25))
				{
	...
	if (uParam0->f_469[0])
	{
		if (__LIB_1__::func_285(&uLocal_25, 4f))
		{
			return 1;
		}
	}
					...
					if (ANIMSCENE::_DOES_ANIM_SCENE_EXIST(uParam0->f_3.f_1))
					{
						if (ANIMSCENE::_IS_ANIM_SCENE_LOADED(uParam0->f_3.f_1, true, false))
						{
							if (ANIMSCENE::_0x1F0E401031E20146(uParam0->f_3.f_1, "pbl_action"))
							{
								...
								{
									__LIB_0__::func_634(&(Local_11.f_6), 50, 10, 0);
								}
								uParam0->f_469[1] = 1;
								uParam0->f_469[2] = 1;
								return 0;
					...
					if (ANIMSCENE::_IS_ANIM_SCENE_LOADED(uParam0->f_3.f_1, true, false))
					{
						if (ANIMSCENE::_0x1F0E401031E20146(uParam0->f_3.f_1, "pbl_action"))
						{
							if (ANIMSCENE::_0x005E6F28DD7ED58D(uParam0->f_3.f_1, uParam0->f_20[0 /*14*/].f_1))
							{
								...
								TASK::TASK_START_SCENARIO_AT_POSITION(uParam0->f_20[0 /*14*/], joaat("WORLD_ANIMAL_WOLF_EATING"), Local_11.f_6, Local_11.f_9.f_2, 0, false, true, 0, -1f, false);
...
void func_71(var uParam0)
{
	if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
	{
		...
		else if (!__LIB_0__::func_163(uParam0->f_20[1 /*14*/], 518218985))
		{
	...
	if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
	{
		if (__LIB_0__::func_232(uParam0->f_20[0 /*14*/], Global_35, 1) <= 3600f)
		{
			if (!__LIB_0__::func_163(uParam0->f_20[0 /*14*/], 780511057))
			{
		...
		else if (!__LIB_0__::func_163(uParam0->f_20[0 /*14*/], 518218985))
		{
			TASK::_TASK_SMART_FLEE_STYLE_PED(uParam0->f_20[0 /*14*/], Global_35, 4, 256, -1082130432 /* Float: -1f */, -1, 0);
			__LIB_2__::func_857(&(uParam0->f_20[0 /*14*/]), 0, 1);
			PED::SET_PED_KEEP_TASK(uParam0->f_20[0 /*14*/], true);
		}
	}
