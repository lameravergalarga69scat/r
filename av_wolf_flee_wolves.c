...
{
	__LIB_2__::func_851(uParam0, 11129, 11218, 12306);
}

void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	__LIB_2__::func_853(uParam0, "WOLF_FLEE_WOLVES", "script@ambient@animal@wolf_flee_from_wolves@action", vParam1, vParam4);
	uParam0->f_16 = 1;
	__LIB_2__::func_854(uParam0, 1, "pbl_action", "", 0);
	__LIB_2__::func_855(uParam0, 0, "wolf_01", iLocal_9, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 0);
	__LIB_2__::func_855(uParam0, 1, "wolf_02", iLocal_9, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 0);
	__LIB_2__::func_855(uParam0, 2, "wolf_03", iLocal_9, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 0);
	__LIB_2__::func_855(uParam0, 3, "wolf_04", iLocal_9, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 0);
	__LIB_2__::func_855(uParam0, 4, "carcass", joaat("A_C_DEER_01"), OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0f, 0.3f, 0f), (vParam4.z - 270f), 1, 0, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
}
...
int func_18(var uParam0)
{
	...
	return __LIB_2__::func_907(uParam0, uParam0->f_20[4 /*14*/].f_5);
}
...
bool func_28(var uParam0)
{
	...
	while (iVar0 <= 3)
	{
		...
		{
			EVENT::_0x9520175B35E2268D(uParam0->f_20[iVar0 /*14*/], 1);
	...
	if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[4 /*14*/]))
	{
		...
		TASK::TASK_PLAY_ANIM(uParam0->f_20[4 /*14*/], sLocal_38, sLocal_39, 1000f, -1000f, -1, 131072, 0f, false, 0, false, 0, false);
		...
		__LIB_2__::func_857(&(uParam0->f_20[4 /*14*/]), 1, 1);
...
int func_31(var uParam0)
{
	...
	if (!uParam0->f_469[0])
	{
		if (!bLocal_52 == 1)
		{
			if (__LIB_2__::func_908(uParam0, &uLocal_10, 1) || __LIB_0__::func_232(Global_35, uParam0->f_20[0 /*14*/], 1) <= 625f)
			{
				bLocal_52 = true;
			}
		}
		if (bLocal_52)
		{
			if (!__LIB_0__::func_75(&uLocal_43))
			{
				__LIB_1__::func_148(&uLocal_43);
			}
			func_71(uParam0);
			if (!uParam0->f_469[8])
			{
	...
	if (uParam0->f_469[0])
	{
		if (__LIB_1__::func_285(&uLocal_43, 4f))
		{
			return 1;
		}
	}
	if (!uParam0->f_469[0] && !bLocal_52)
	{
		...
		if (uParam0->f_469[2])
		{
			if (!uParam0->f_469[8])
			{
				if (__LIB_2__::func_889(uParam0, 1.5f, 80f, 4, joaat("ACTION"), 1))
				{
					__LIB_2__::func_890(*uParam0, uParam0->f_483, 1);
					uParam0->f_469[8] = 1;
				}
					...
					if (ANIMSCENE::_IS_ANIM_SCENE_LOADED(uParam0->f_3.f_1, true, false))
					{
						if (ANIMSCENE::_0x1F0E401031E20146(uParam0->f_3.f_1, "pbl_action"))
						{
							...
							if (!uParam0->f_469[5])
							{
								...
								{
									TASK::_TASK_START_SCENARIO_IN_PLACE(uParam0->f_20[2 /*14*/], joaat("WORLD_ANIMAL_WOLF_EATING"), 70000, false, 0, -1f, false);
									PED::_0x2208438012482A1A(uParam0->f_20[2 /*14*/], false, false);
							...
							if (!uParam0->f_469[6])
							{
								...
								{
									TASK::_TASK_START_SCENARIO_IN_PLACE(uParam0->f_20[3 /*14*/], joaat("WORLD_ANIMAL_WOLF_EATING"), 70000, false, 0, -1f, false);
									PED::_0x2208438012482A1A(uParam0->f_20[3 /*14*/], false, false);
									PED::SET_PED_KEEP_TASK(uParam0->f_20[3 /*14*/], true);
									__LIB_2__::func_857(&(uParam0->f_20[3 /*14*/]), 1, 1);
									uParam0->f_469[6] = 1;
								}
							}
	...
	if (uParam0->f_469[7] && __LIB_1__::func_285(&uLocal_40, 2f))
	{
		return 1;
	}
	return 0;
	...
	while (iVar0 <= 3)
	{
		if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[iVar0 /*14*/]))
		{
			if (iVar0 == 0)
			{
				...
				{
					TASK::_TASK_SMART_FLEE_STYLE_PED(uParam0->f_20[iVar0 /*14*/], Global_35, 4, 256, -1082130432 /* Float: -1f */, -1, 0);
					__LIB_2__::func_857(&(uParam0->f_20[iVar0 /*14*/]), 0, 1);
					PED::SET_PED_KEEP_TASK(uParam0->f_20[iVar0 /*14*/], true);
				}
			}
			else if (__LIB_1__::func_992(Global_35, uParam0->f_483, 1) <= 2500f)
			{
				if (!__LIB_0__::func_163(uParam0->f_20[iVar0 /*14*/], 780511057))
				{
			...
			else if (!__LIB_0__::func_163(uParam0->f_20[iVar0 /*14*/], 518218985))
			{
				TASK::_TASK_SMART_FLEE_STYLE_PED(uParam0->f_20[iVar0 /*14*/], Global_35, 4, 256, -1082130432 /* Float: -1f */, -1, 0);
				__LIB_2__::func_857(&(uParam0->f_20[iVar0 /*14*/]), 0, 1);
				PED::SET_PED_KEEP_TASK(uParam0->f_20[iVar0 /*14*/], true);
