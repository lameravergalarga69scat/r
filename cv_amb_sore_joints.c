...
bool func_7(var uParam0)
{
	...
	switch (__LIB_6__::func_949(uParam0))
	{
		...
		case 3:
			...
			{
				if (__LIB_17__::func_989(uParam0))
				{
...
bool func_72(var uParam0)
{
	switch (__LIB_0__::func_78(uParam0))
	{
		case 1:
			...
			break;
		case 2:
			__LIB_7__::func_116(uParam0, 681.0845f, -1246.778f, 43f, 0f, 0f, 150f);
			break;
		default:
			return false;
	}
	__LIB_7__::func_47(uParam0, -0.0024f, 0.0058f, 0f, -113.79f, 1f, 1f, 2f, joaat("VOLCYLINDER"), -1, 1, 1, 1);
	iLocal_15 = __LIB_6__::func_959(uParam0, "script@vignette@ambient@av_sore_joints@pl_action", 0, 1, 0, 0);
	switch (__LIB_4__::func_576(uParam0))
	{
		case 19:
			__LIB_7__::func_48(uParam0, 19, "Ped");
			iLocal_16 = __LIB_7__::func_32(uParam0, iLocal_15, "PL_FEMALE_ACTION", 1);
			__LIB_7__::func_127(uParam0, iLocal_14, 2, joaat("PROP_HUMAN_SEAT_CHAIR"), "PROP_HUMAN_SEAT_CHAIR_GENERIC_FEMALE_D", -1, 0, 25f, 1065353216 /* Float: 1f */, 1);
			break;
		case 18:
			iLocal_14 = __LIB_7__::func_48(uParam0, 17, "Ped");
			iLocal_16 = __LIB_7__::func_32(uParam0, iLocal_15, "PL_MALE_ACTION", 1);
			__LIB_7__::func_127(uParam0, iLocal_14, 2, joaat("PROP_CAMP_FIRE_SEATED"), "PROP_CAMP_FIRE_SEATED_MALE_I", -1, 0, 25f, 1065353216 /* Float: 1f */, 1);
			__LIB_7__::func_137(uParam0, iLocal_14, "START_SEATED_MALE_I_TO_SEAT_BENCH_MALE_B");
			break;
	}
