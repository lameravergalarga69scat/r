...
bool func_72(var uParam0)
{
	...
	{
		case 2:
			__LIB_7__::func_116(uParam0, 653.0919f, -1252.156f, 42.8372f, 0f, 0f, -64.44f);
			break;
		case 3:
			__LIB_7__::func_116(uParam0, 1890.435f, -1861.724f, 42.1553f, 0f, 0f, -63.54f);
			break;
	}
	iLocal_14 = __LIB_7__::func_48(uParam0, 12, "Dog");
	iLocal_15 = __LIB_6__::func_959(uParam0, "script@ambient@campfiregeneral@dog_jump_up_down_bed@action", 0, 0, 0, 0);
	__LIB_7__::func_47(uParam0, 0.3015f, 0.0164f, 1.0827f, -76.75f, 1.9375f, 1.5675f, 3f, joaat("VOLBOX"), -1, 1, 1, 1);
	switch (__LIB_4__::func_576(uParam0))
	{
		case 3:
			__LIB_7__::func_107(uParam0, iLocal_14, 3, joaat("WORLD_ANIMAL_DOG_RESTING"), "WORLD_ANIMAL_DOG_RESTING", -1, 0);
			iLocal_16 = __LIB_7__::func_32(uParam0, iLocal_15, "pl_DownAction", 1);
			break;
		default:
			return false;
	}
