...
{
	__LIB_2__::func_851(uParam0, 10732, 10769, 11794);
}

void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	__LIB_2__::func_853(uParam0, "EAGLE_CATCH_FISH", "script@ambient@animal@EAGLE_CATCH_FISH@action", vParam1, vParam4);
...
int func_31(var uParam0)
{
	...
	if (!uParam0->f_469[0])
	{
		...
		if ((__LIB_2__::func_908(uParam0, &uLocal_11, 0) || __LIB_0__::func_232(uParam0->f_20[0 /*14*/], Global_35, 1) < 225f) || __LIB_1__::func_992(Global_35, uParam0->f_483, 1) < 49f)
		{
			...
			__LIB_2__::func_949(uParam0);
			__LIB_2__::func_953(uParam0);
			uParam0->f_469[0] = 1;
		}
	}
...
int func_32(var uParam0, bool bParam1)
{
	...
	if (!bParam1)
	{
		...
		while (iVar2 < uParam0->f_19)
		{
			...
			{
				if (ENTITY::IS_ENTITY_ON_SCREEN(uParam0->f_20[iVar2 /*14*/]) || ((uParam0->f_469[4] && !uParam0->f_469[5]) && __LIB_0__::func_232(uParam0->f_20[iVar2 /*14*/], Global_35, 1) < 22500f))
				{
					return 0;
				}
			}
