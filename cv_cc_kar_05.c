...
bool func_72(var uParam0)
{
	...
	{
		case 1:
			__LIB_7__::func_116(uParam0, -136.56f, -39.6f, 95f, 0f, 0f, -70f);
			break;
		case 2:
			__LIB_7__::func_116(uParam0, 688.5637f, -1243.25f, 42.9648f, 0f, 0f, 81.2f);
			break;
		case 3:
			__LIB_7__::func_116(uParam0, 1873.875f, -1835.755f, 41.325f, 0f, 0f, 156.71f);
			break;
		case 6:
			__LIB_7__::func_116(uParam0, 2342.282f, 1370.477f, 105.275f, 0f, 0f, 124.56f);
			break;
		default:
			return false;
	}
	...
	__LIB_7__::func_47(uParam0, -5.5f, 3f, 1f, -25f, 3f, 2f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_KAREN"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, -9.9514f, 4.6061f, 1.0883f, -151.2834f, 1.5f, 1.5f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_GRIMSHAW"), 1, 1, 1);
	__LIB_7__::func_159(uParam0, -4.72f, 2.56f, 1.0307f, 64.08f, 0.72f, 1.52f, 3f, joaat("VOLCYLINDER"), 1);
	iLocal_16 = __LIB_6__::func_958(uParam0, joaat("P_BOTTLEBEER01A"), 0f, 0f, 0f, "BOTTLE", 0, 1, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@karen_5@base", 1, 1, 0, 0);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@karen_5@action_a", 2, 0, 1, 0);
	iLocal_18 = __LIB_6__::func_959(uParam0, "script@vignette@karen_5@action_b_alt_susan_wnt", 0, 0, 0, 1);
	iLocal_19 = __LIB_6__::func_959(uParam0, "script@vignette@karen_5@action_b_alt_karen", 0, 0, 0, 1);
	__LIB_7__::func_146(uParam0, "CKAR5AU");
	__LIB_7__::func_127(uParam0, iLocal_14, 2, joaat("WORLD_HUMAN_SIT_DRINK"), "WORLD_HUMAN_SIT_DRINK_FEMALE_A", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_139(uParam0, iLocal_14, iLocal_16, "p_bottleBeer01x_PH_R_HAND", 0, 0);
	__LIB_7__::func_147(uParam0, iLocal_14, 0, 12, 0, 0, 0);
	__LIB_7__::func_172(uParam0, iLocal_15, 1);
	__LIB_7__::func_147(uParam0, iLocal_15, 2, 1, 0, "Default_Angry", 0);
	Local_20 = { __LIB_7__::func_160(uParam0, -4.745f, 3.39f, 1.4354f, 170f, 7f, 0.1475f, 0.54f) };
	Local_30 = { __LIB_7__::func_160(uParam0, -9.2575f, 3.5225f, 1.4354f, 73.08f, 5.8375f, 0.1475f, 0.54f) };
	return true;
}
...
bool func_93(var uParam0)
{
	if (__LIB_7__::func_74(uParam0, iLocal_15))
	{
		if (bLocal_40)
		{
			__LIB_1__::func_774(uParam0->f_107[iLocal_15 /*113*/].f_1, 0, 0, 0, uParam0->f_107[iLocal_15 /*113*/].f_32.f_4, 1, 1, 0, 0, 0, 0);
		}
		else if (__LIB_7__::func_163(uParam0, Local_30, 1, 0))
		{
			__LIB_7__::func_113(uParam0, iLocal_15, 0, 1);
