...
bool func_72(var uParam0)
{
	...
	{
		case 8:
			__LIB_7__::func_45(uParam0, 41, 0, 0, 0);
			__LIB_7__::func_116(uParam0, -1588.927f, -1406.608f, 80.2f, 0f, 1.5f, 168.12f);
			break;
		default:
			return false;
	}
	iLocal_16 = __LIB_7__::func_48(uParam0, 14, 0);
	__LIB_6__::func_958(uParam0, joaat("P_PITCHFORK01X"), 0f, 0f, 0f, "PITCHFORK", 0, 0, 1);
	__LIB_6__::func_958(uParam0, joaat("P_WHEELBARROW01X"), 0f, 0f, 0f, "WHEELBARROW", 0, 0, 1);
	__LIB_6__::func_958(uParam0, joaat("P_HAYPILEWHEELBARREL01X"), 0f, 0f, 0f, "BarrowHay", 0, 0, 1);
	__LIB_6__::func_958(uParam0, joaat("P_HAYPILEPITCHFORK01X"), 0f, 0f, 0f, "HAYPILE", 0, 0, 1);
	__LIB_6__::func_958(uParam0, joaat("P_HAYPILEPITCHFORK01X"), 0f, 0f, 0f, "HayPile02", 0, 0, 1);
	__LIB_6__::func_958(uParam0, joaat("P_HAYPILEPITCHFORK01X"), 0f, 0f, 0f, "HayPile03", 0, 0, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@beecher@jack_4@base", 1, 1, 0, 0);
	iLocal_14 = __LIB_6__::func_959(uParam0, "script@vignette@beecher@jack_4@action", 2, 0, 1, 1);
	iLocal_15 = __LIB_6__::func_959(uParam0, "script@vignette@beecher@jack_4@exit_stand", 0, 0, 0, 1);
	__LIB_7__::func_149(uParam0, joaat("COMP_BCJCKCNV4"), joaat("PLAYER_BCJCKCNV4"));
	__LIB_7__::func_150(uParam0, iLocal_14, -1, 0.77f);
	__LIB_7__::func_151(uParam0, iLocal_16, 1, -1);
	__LIB_7__::func_146(uParam0, "BJCK4AU");
	iLocal_17 = __LIB_7__::func_156(uParam0, -2.5f, 2.5f, 2f, 0f, 0f, 0f, 5.5f, 5.5f, 2.5f, "volTrigger", joaat("VOLCYLINDER"));
	__LIB_7__::func_129(uParam0, 1);
	__LIB_7__::func_279(uParam0, iLocal_16, 1094713344 /* Float: 12f */, 1092616192 /* Float: 10f */);
	return true;
}
...
{
	return __LIB_7__::func_358(uParam0, &iLocal_17, 1);
}
