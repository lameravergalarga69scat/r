...
bool func_72(var uParam0)
{
	...
	{
		case 0:
			__LIB_7__::func_116(uParam0, -1360.106f, 2438.302f, 307.8079f, 0f, 0f, -20f);
			break;
		default:
			return false;
	}
	...
	__LIB_7__::func_47(uParam0, 1.2356f, 0.9457f, 0.9668f, 4.75f, 4.2f, 2f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_DUTCH"), 1, 1, 1);
	__LIB_7__::func_159(uParam0, 1.0625f, 1.0873f, 1.15f, 38.56f, 1f, 1f, 2.685f, joaat("VOLCYLINDER"), 1);
	__LIB_6__::func_958(uParam0, joaat("P_CS_BOOK02X"), 0f, 0f, 0f, "BIBLE", 0, 0, 1);
	__LIB_6__::func_958(uParam0, joaat("P_CHAIR04X"), 0f, 0f, 0f, "p_chair04x", 0, 0, 1);
	__LIB_6__::func_958(uParam0, joaat("P_CRATE14X"), 0f, 0f, 0f, "p_crate14x", 0, 0, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@dutch_and_hosea_1@base", 1, 1, 0, 0);
	__LIB_6__::func_959(uParam0, "script@vignette@dutch_and_hosea_1@action", 0, 0, 1, 0);
	__LIB_7__::func_146(uParam0, "CDH1AUD");
	__LIB_7__::func_149(uParam0, joaat("COMP_DNHCNV1"), joaat("PLAYER_DNHCNV1"));
	...
	__LIB_7__::func_145(uParam0, 8f, 12.16f);
	return true;
}
