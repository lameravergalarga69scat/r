...
{
	if (ENTITY::HAS_ANIM_EVENT_FIRED(__LIB_6__::func_952(uParam0, iLocal_14), 1044034326) || !__LIB_0__::func_163(__LIB_6__::func_952(uParam0, iLocal_14), 1435919172))
	{
...
bool func_73(var uParam0)
{
	switch (__LIB_0__::func_78(uParam0))
	{
		case 1:
			...
			break;
		case 2:
			__LIB_7__::func_116(uParam0, 676.17f, -1251.42f, 43.0117f, 0f, 0f, -12f);
			break;
		case 3:
	...
	__LIB_7__::func_47(uParam0, 1f, 0.8f, 0f, 0f, 3f, 6f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_PEARSON"), 1, 1, 1);
	__LIB_6__::func_958(uParam0, joaat("P_CS_DEERCARCASS"), 0f, 0f, 0f, "CARCASS", 0, 0, 1);
	iLocal_20 = __LIB_6__::func_958(uParam0, joaat("P_CS_DEERCARCASSARM"), 0f, 0f, 0f, "LEG", 0, 1, 1);
	iLocal_21 = __LIB_6__::func_958(uParam0, joaat("P_KNIFE03X"), 0f, 0f, 0f, "KNIFE", 0, 1, 1);
	__LIB_6__::func_958(uParam0, joaat("P_SAWMEAT01X"), 0f, 0f, 0f, "SAW", 0, 0, 1);
	__LIB_6__::func_958(uParam0, joaat("P_BOTTLEJD01X"), 0f, 0f, 0f, "BOTTLE", 0, 0, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@pearson_3@base_intro", 1, 1, 0, 0);
	iLocal_15 = __LIB_6__::func_959(uParam0, "script@vignette@pearson_3@action_a_front", 2, 0, 0, 1);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@pearson_3@action_a_back", 2, 0, 0, 1);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@pearson_3@action_b_front", 0, 0, 0, 1);
	iLocal_18 = __LIB_6__::func_959(uParam0, "script@vignette@pearson_3@action_b_back", 0, 0, 0, 1);
	__LIB_7__::func_146(uParam0, "CPRS3AU");
	__LIB_7__::func_127(uParam0, iLocal_14, 4, joaat("PROP_HUMAN_BUTCHER_DEER"), "PROP_HUMAN_BUTCHER_DEER_MALE_A_LEG_SLICE", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_158(uParam0, iLocal_14, 4, 1);
	__LIB_7__::func_259(uParam0, iLocal_14, iLocal_21, "Knife", 1, "KNIFE");
	__LIB_7__::func_259(uParam0, iLocal_14, iLocal_20, "LEG", 1, "LEG");
	__LIB_7__::func_147(uParam0, iLocal_14, 4, 3, 0, 0, 0);
	__LIB_7__::func_151(uParam0, iLocal_14, 2, -1);
	Local_22 = { __LIB_7__::func_160(uParam0, 1.6307f, 2.9087f, 1.0166f, -66.9355f, 6f, 1f, 0.143f) };
	Local_32 = { __LIB_7__::func_160(uParam0, 1.631f, 2.909f, 1.017f, 71.64f, 4.3f, 0.5f, 0.5f) };
...
{
	uLocal_42 = STREAMING::_0xB223249B7798EEED(__LIB_6__::func_952(uParam0, iLocal_14), joaat("PROP_HUMAN_BUTCHER_DEER"), 262145, joaat("PROP_HUMAN_BUTCHER_DEER_MALE_A_LEG_SLICE"));
	return true;
}
...
bool func_94(var uParam0)
{
	...
	else if (__LIB_7__::func_148(uParam0, iLocal_16))
	{
