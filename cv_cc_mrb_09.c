...
bool func_72(var uParam0)
{
	...
	__LIB_7__::func_47(uParam0, -0.15f, -0.0125f, 0.85f, -0.5f, 0.885f, 0.825f, 3.2075f, joaat("VOLBOX"), joaat("APMS_COMP_MARYBETH"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, -0.9125f, -1.625f, 0.85f, -14.5f, 1f, 1f, 3.2075f, joaat("VOLBOX"), joaat("APMS_COMP_KAREN"), 1, 1, 1);
	iLocal_24 = __LIB_6__::func_958(uParam0, joaat("P_CS_SOCK01X"), 0f, 0f, 0f, "p_cs_sock", 0, 0, 1);
	iLocal_23 = __LIB_6__::func_958(uParam0, joaat("P_CS_SOCK01X"), 0f, 0f, 0f, "p_cs_sock1", 0, 0, 1);
	iLocal_21 = __LIB_6__::func_958(uParam0, joaat("P_CHAIR_CRATE15X"), -0.93809f, -1.52663f, -0.00883484f, 0, 1, 0, 1);
	iLocal_22 = __LIB_6__::func_958(uParam0, joaat("P_CHAIR_CRATE02X"), 0f, 0f, 0f, 0, 1, 0, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@marybeth_9@base", 1, 1, 0, 0);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@marybeth_9@Action_A", 2, 0, 1, 0);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@marybeth_9@ACTION_B_ALT_BACKLEFT", 0, 0, 0, 1);
	iLocal_18 = __LIB_6__::func_959(uParam0, "script@vignette@marybeth_9@ACTION_B_ALT_BACKRIGHT", 0, 0, 0, 1);
	iLocal_20 = __LIB_6__::func_959(uParam0, "script@vignette@marybeth_9@ACTION_B_ALT_FRONT", 0, 0, 0, 1);
	iLocal_19 = __LIB_6__::func_959(uParam0, "script@vignette@marybeth_9@ACTION_B_ALT_RIGHT", 0, 0, 0, 1);
	__LIB_7__::func_146(uParam0, "CCMB9AU");
	__LIB_7__::func_107(uParam0, iLocal_15, 3, joaat("PROP_HUMAN_SEAT_CHAIR_SEWING"), "PROP_HUMAN_SEAT_CHAIR_SEWING_FEMALE_B", iLocal_22, 0);
	__LIB_7__::func_296(uParam0, iLocal_15, 3, joaat("PROP_HUMAN_SEAT_CHAIR_SEWING"), "PROP_HUMAN_SEAT_CHAIR_SEWING_FEMALE_B", iLocal_22, 0, -1073741824 /* Float: -2f */, 0f, 1);
	__LIB_7__::func_139(uParam0, iLocal_15, iLocal_24, "p_cs_sock01x_PH_L_HAND", 0, 0);
	__LIB_7__::func_107(uParam0, iLocal_14, 3, joaat("PROP_HUMAN_SEAT_CHAIR_SEWING"), "PROP_HUMAN_SEAT_CHAIR_SEWING_FEMALE_A", iLocal_21, 0);
	__LIB_7__::func_296(uParam0, iLocal_14, 3, joaat("PROP_HUMAN_SEAT_CHAIR_SEWING"), "PROP_HUMAN_SEAT_CHAIR_SEWING_FEMALE_A", iLocal_21, 0, -1073741824 /* Float: -2f */, 0f, 1);
	__LIB_7__::func_139(uParam0, iLocal_14, iLocal_23, "p_cs_sock01x_PH_L_HAND", 0, 0);
	Local_25 = { __LIB_7__::func_160(uParam0, -0.175f, -0.7325f, 0.564f, 67.5f, 6.6675f, 0.297f, 0.35f) };
	Local_35 = { __LIB_7__::func_160(uParam0, -0.175f, -0.733f, 0.564f, 124.92f, 6.6675f, 0.176f, 0.35f) };
	Local_45 = { __LIB_7__::func_160(uParam0, -0.175f, -0.733f, 0.564f, 165.96f, 6.6675f, 0.191f, 0.287f) };
	Local_55 = { __LIB_7__::func_160(uParam0, -0.175f, -0.733f, 0.564f, -146.52f, 6.6675f, 0.6125f, 0.35f) };
