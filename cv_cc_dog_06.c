...
bool func_72(var uParam0)
{
	...
	__LIB_7__::func_47(uParam0, -3.55f, -5.1475f, 0f, 0f, 1f, 1f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_JACK"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, -0.5375f, 0.3275f, 0f, -25f, 2.1825f, 4.2175f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_GRIMSHAW"), 1, 1, 1);
	iLocal_16 = __LIB_6__::func_958(uParam0, joaat("P_CS_RAG02X"), 0f, 0f, 0f, "RAG", 0, 0, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@dog_6@base", 1, 1, 0, 0);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@dog_6@action", 0, 0, 1, 0);
	__LIB_7__::func_149(uParam0, joaat("COMP_DOGCNV6"), joaat("PLAYER_DOGCNV6"));
	__LIB_7__::func_150(uParam0, iLocal_17, -1, 0.88f);
	__LIB_7__::func_107(uParam0, iLocal_14, 3, joaat("WORLD_HUMAN_CLEAN_TABLE"), "WORLD_HUMAN_CLEAN_TABLE_FEMALE_B", -1, 1);
	__LIB_7__::func_127(uParam0, iLocal_14, 2, joaat("WORLD_HUMAN_CLEAN_TABLE"), "WORLD_HUMAN_CLEAN_TABLE_FEMALE_B", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	...
	__LIB_7__::func_146(uParam0, "CDOG6AU");
	return true;
}
