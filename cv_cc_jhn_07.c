...
bool func_72(var uParam0)
{
	...
	{
		case 2:
			__LIB_7__::func_116(uParam0, 622.968f, -1253.664f, 40.79f, 0f, 0f, 129.57f);
			break;
		case 3:
			__LIB_7__::func_116(uParam0, 1909.35f, -1819.12f, 40.9299f, 0f, 0f, -17.555f);
			break;
		default:
			return false;
	}
	...
	__LIB_7__::func_47(uParam0, -1.04f, -0.08f, 0f, -1.44f, 2.56f, 2.2475f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_JOHN"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, -2.5686f, -10.618f, 0f, -11.5f, 1.41f, 1.325f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_DUTCH"), 1, 1, 1);
	iLocal_20 = __LIB_6__::func_958(uParam0, joaat("P_CIGAR02X"), 0f, 0f, 0f, "CIGAR", 0, 1, 1);
	iLocal_19 = __LIB_6__::func_958(uParam0, joaat("P_CIGARETTE_CS01X"), 0f, 0f, 0f, "CIGARETTE", 0, 0, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@john_7@base", 65, 1, 0, 0);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@john_7@action_a", 66, 0, 1, 0);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@john_7@action_b", 64, 0, 0, 0);
	iLocal_18 = __LIB_6__::func_959(uParam0, "script@vignette@john_7@action_b_alt", 64, 0, 0, 1);
	__LIB_7__::func_146(uParam0, "CJHN7AU");
	__LIB_7__::func_107(uParam0, iLocal_15, 3, joaat("WORLD_HUMAN_SMOKE"), "WORLD_HUMAN_SMOKE_MALE_C", -1, 1);
	__LIB_7__::func_127(uParam0, iLocal_15, 2, joaat("WORLD_HUMAN_SMOKE"), "WORLD_HUMAN_SMOKE_MALE_C", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_139(uParam0, iLocal_15, iLocal_19, "p_cigarette_cs01x_PH_R_HAND", 0, 0);
	__LIB_7__::func_107(uParam0, iLocal_14, 3, joaat("WORLD_CAMP_DUTCH_SMOKE_CIGAR"), "WORLD_CAMP_DUTCH_SMOKE_CIGAR_MALE_A", -1, 1);
	Local_21 = { __LIB_7__::func_160(uParam0, -1.59f, -1.9876f, 0.988f, -180f, 7.12f, 0.325f, 0.51f) };
	return true;
}
...
bool func_93(var uParam0)
{
	if (__LIB_7__::func_148(uParam0, iLocal_16))
	{
		...
		{
			__LIB_7__::func_154(uParam0, iLocal_18, 0);
		}
	}
	return true;
}
