...
bool func_72(var uParam0)
{
	...
	__LIB_7__::func_146(uParam0, "CUNC5AU");
	iLocal_14 = __LIB_7__::func_48(uParam0, 4, "IG_UNCLE");
	iLocal_15 = __LIB_6__::func_958(uParam0, joaat("P_CS_NEWSPAPER_03X"), 0f, 0f, 0f, "p_cs_newspaper_03x", 0, 0, 1);
	__LIB_7__::func_47(uParam0, 0f, 0f, 0f, 2f, 1.7725f, 1.54f, 2.685f, joaat("VOLBOX"), joaat("APMS_COMP_UNCLE"), 1, 1, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@uncle_5@base", 1, 1, 0, 0);
	__LIB_6__::func_959(uParam0, "script@vignette@uncle_5@action", 0, 0, 1, 0);
	__LIB_7__::func_149(uParam0, joaat("COMP_UNCCNV5"), joaat("PLAYER_UNCCNV5"));
	__LIB_7__::func_107(uParam0, iLocal_14, 3, joaat("WORLD_HUMAN_SIT_GROUND_READ_NEWSPAPER"), "WORLD_HUMAN_SIT_GROUND_READING_NEWSPAPER_MALE_A", -1, 1);
	__LIB_7__::func_127(uParam0, iLocal_14, 2, joaat("WORLD_HUMAN_SIT_GROUND_READ_NEWSPAPER"), "WORLD_HUMAN_SIT_GROUND_READING_NEWSPAPER_MALE_A", -1, 1, 100f, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_139(uParam0, iLocal_14, iLocal_15, "p_cs_newspaper_03x_PH_R_HAND", 0, 0);
...
{
	__LIB_7__::func_116(uParam0, -137.0536f, -41.0484f, 94.5314f, 0f, 0f, -65.78f);
	return 1;
}

int func_150(var uParam0)
{
	__LIB_7__::func_116(uParam0, 670.3481f, -1252.36f, 42.7343f, 0f, 0f, -150.855f);
	return 1;
}

int func_151(var uParam0)
{
	__LIB_7__::func_116(uParam0, 1868.817f, -1858.324f, 42.0093f, 0f, 0f, -83.16f);
	return 1;
}
