...
{
	__LIB_2__::func_851(uParam0, 10798, 10849, 11556);
}

void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	__LIB_2__::func_853(uParam0, "WOLVES_HOWLING", "", vParam1, vParam4);
	__LIB_2__::func_905(uParam0, 0, "WHP_WOLF_1", iLocal_9, vParam1, vParam4.z, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	__LIB_2__::func_905(uParam0, 1, "WHP_WOLF_2", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 2f, 0.5f, 0f), (45f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	__LIB_2__::func_905(uParam0, 2, "WHP_WOLF_3", iLocal_10, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 4f, 3.5f, 0f), (120f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
}
...
int func_31(var uParam0)
{
	if (!uParam0->f_469[1])
	{
		if (__LIB_2__::func_908(uParam0, &uLocal_22, 0))
		{
			__LIB_3__::func_14(uParam0);
	...
	switch (iLocal_11)
	{
		case 0:
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
			{
				...
				uLocal_12[0] = __LIB_2__::func_944(joaat("WORLD_ANIMAL_WOLF_HOWLING_SITTING"), uParam0->f_20[0 /*14*/].f_5, uParam0->f_20[0 /*14*/].f_8, 0, 0, 0);
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
			{
				...
				uLocal_12[1] = __LIB_2__::func_944(joaat("WORLD_ANIMAL_WOLF_SNIFFING_GROUND"), uParam0->f_20[1 /*14*/].f_5, uParam0->f_20[1 /*14*/].f_8, 0, 0, 0);
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[2 /*14*/]))
			{
				...
				uLocal_12[2] = __LIB_2__::func_944(joaat("WORLD_ANIMAL_WOLF_EATING"), uParam0->f_20[2 /*14*/].f_5, uParam0->f_20[2 /*14*/].f_8, 0, 0, 0);
		...
		case 1:
			...
			break;
		case 3:
			if (!__LIB_0__::func_163(uParam0->f_20[2 /*14*/], -875674219))
			{
				TASK::TASK_TURN_PED_TO_FACE_ENTITY(uParam0->f_20[2 /*14*/], Global_35, 0, -1f, -1f, -1f);
			}
			if (__LIB_0__::func_232(uParam0->f_20[0 /*14*/], Global_35, 1) < 324f || __LIB_1__::func_285(&uLocal_19, 12.5f))
			{
				__LIB_3__::func_10(uParam0->f_20[2 /*14*/]);
				__LIB_3__::func_14(uParam0);
			...
			break;
		case 4:
			if (func_73(uParam0) || __LIB_1__::func_285(&uLocal_16, 5f))
			{
				return 1;
			}
			break;
