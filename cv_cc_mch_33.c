...
bool func_72(var uParam0)
{
	...
	iLocal_14 = __LIB_7__::func_48(uParam0, 6, "IG_MicahBell");
	iLocal_15 = __LIB_7__::func_48(uParam0, 17, "IG_MrPearson");
	__LIB_7__::func_46(uParam0, -5.275f, 0.0001f, 2.0875f, -2.5f, 7.3475f, 5.51f, 2.0875f, joaat("VOLCYLINDER"), 1);
	__LIB_7__::func_46(uParam0, 7.3875f, 12.1625f, 2.0875f, 60f, 7.3475f, 5.51f, 2.0875f, joaat("VOLCYLINDER"), 1);
	__LIB_7__::func_47(uParam0, -10.915f, 0.4999f, 0f, -152.95f, 1.2f, 1.2f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_MICAH"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, 10.5064f, 17.607f, 0f, -12.5f, 1.2f, 1.2f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_PEARSON"), 1, 1, 1);
	iLocal_18 = __LIB_6__::func_958(uParam0, joaat("P_RAG02X"), 0f, 0f, 0f, "p_cs_rag02x", 0, 0, 1);
	iLocal_17 = __LIB_6__::func_958(uParam0, joaat("P_CHAIRFOLDING02X"), -11.1678f, 0.393568f, 0.155418f, 0, 1, 0, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@micah_33@base", 1, 1, 0, 0);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@micah_33@action", 0, 0, 1, 0);
	__LIB_7__::func_146(uParam0, "CCM33AU");
	__LIB_7__::func_127(uParam0, iLocal_14, 3, joaat("GENERIC_SEAT_CHAIR_TABLE_SCENARIO"), "GENERIC_SEAT_CHAIR_TABLE_SCENARIO_RF_FWD_MALE_A", iLocal_17, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_151(uParam0, iLocal_14, 1, -1);
	__LIB_7__::func_277(uParam0, iLocal_14, "GREET_MICAH_MCHCNV33", 60000, 1);
	...
	__LIB_7__::func_139(uParam0, iLocal_15, iLocal_18, "p_cs_rag02x_PH_R_HAND", 0, 0);
	__LIB_7__::func_151(uParam0, iLocal_15, 1, -1);
	__LIB_7__::func_149(uParam0, joaat("COMP_MCHCNV33"), joaat("PLAYER_MCHCNV33"));
	__LIB_7__::func_150(uParam0, iLocal_16, -1, 0.89f);
	return true;
}
...
bool func_93(var uParam0)
{
	...
	if (__LIB_7__::func_268(uParam0) && func_204(uParam0))
	{
	...
	switch (Global_1360165[iParam0 /*1157*/].f_11)
	{
		...
		case 3:
			if (!ENTITY::IS_ENTITY_DEAD(Global_1360165[iParam0 /*1157*/]) && !ANIMSCENE::_0x3AB6C7B0BB0DF4B1(Global_1360165[iParam0 /*1157*/], -1))
			{
				...
				func_423(Global_1360165[iParam0 /*1157*/], vVar0, iParam6, 2, 1073741824 /* Float: 2f */);
			}
			else if (bParam16)
			{
	...
	switch (Global_1360165[iParam0 /*1157*/].f_70.f_12)
	{
		...
		case 3:
			...
			if ((bParam2 && !__LIB_0__::func_86(vVar0)) && !__LIB_0__::func_175(vVar0, ENTITY::GET_ENTITY_COORDS(Global_1360165[iParam0 /*1157*/].f_124, true, false), 1056964608 /* Float: 0.5f */, 1))
			{
				...
				func_423(Global_1360165[iParam0 /*1157*/].f_124, vVar0, iParam6, 2, 1073741824 /* Float: 2f */);
			}
			if (bParam1)
			{
