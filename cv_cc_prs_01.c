...
bool func_72(var uParam0)
{
	...
	__LIB_7__::func_48(uParam0, 8, 0);
	__LIB_7__::func_47(uParam0, -1.6427f, 1.1787f, 1.0095f, 0f, 1.5f, 1.5f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_PEARSON"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, -6.53f, -0.9429f, 0.9891f, 0f, 1.5f, 1.5f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_SEAN"), 1, 1, 1);
	iLocal_18 = __LIB_6__::func_958(uParam0, joaat("P_KNIFE03X"), 0f, 0f, 0f, "KNIFE", 0, 1, 1);
	__LIB_6__::func_958(uParam0, joaat("P_CIGARETTE_CS02X"), 0f, 0f, 0f, "CIGAR", 0, 0, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@pearson_1@base", 1, 1, 0, 0);
	iLocal_15 = __LIB_6__::func_959(uParam0, "script@vignette@pearson_1@action_a", 2, 0, 1, 0);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@pearson_1@action_b_alt", 0, 0, 0, 1);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@pearson_1@exit", 0, 0, 0, 1);
	__LIB_7__::func_146(uParam0, "CPRS1AU");
	__LIB_7__::func_149(uParam0, joaat("COMP_PRSCNV1"), joaat("PLAYER_PRSCNV1"));
	__LIB_7__::func_127(uParam0, iLocal_14, 4, joaat("PROP_HUMAN_FOODPREP_STEW"), "PROP_HUMAN_FOODPREP_STEW_GRAB_CARROT_MALE_B", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_139(uParam0, iLocal_14, iLocal_18, "p_knife03x_PH_R_HAND", 0, 0);
	__LIB_7__::func_147(uParam0, iLocal_14, 2, 1, 0, 0, 0);
	__LIB_7__::func_151(uParam0, iLocal_14, 1, -1);
	Local_19 = { __LIB_7__::func_160(uParam0, -1.6427f, 1.1787f, 1.0095f, 15.12f, 7.5f, 0.5f, 0.5f) };
