...
bool func_3(var uParam0)
{
	...
	switch (uParam0->f_464)
	{
		...
		case 6:
			...
			if (__LIB_17__::func_809(uParam0))
			{
...
{
	__LIB_2__::func_851(uParam0, 10828, 10886, 11532);
}

void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	__LIB_2__::func_853(uParam0, "GATOR_BOAR_LEG", "script@ambient@animal@alligator_ambush_boar_leg@action", vParam1, vParam4);
	__LIB_2__::func_854(uParam0, 1, "pbl_action", "", 0);
	__LIB_2__::func_855(uParam0, 0, "alligator", iLocal_9, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 0);
	__LIB_2__::func_855(uParam0, 1, "BOAR", iLocal_10, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 0);
}

int func_30(var uParam0)
{
	__LIB_2__::func_887(&uLocal_17, 0);
	__LIB_1__::func_398(&uLocal_17, 1);
	__LIB_1__::func_401(&uLocal_17, 1);
	__LIB_2__::func_828(&uLocal_17, 1);
	__LIB_2__::func_829(&uLocal_17, 1);
	__LIB_1__::func_404(&uLocal_17, 1);
	__LIB_2__::func_830(&uLocal_17, 1);
	return 1;
}
...
int func_31(var uParam0)
{
	...
	if (!uParam0->f_469[0])
	{
		if (!bLocal_14 == 1)
		{
			if (__LIB_2__::func_908(uParam0, &uLocal_17, 1) || __LIB_1__::func_992(Global_35, uParam0->f_483, 1) < 225f)
			{
				bLocal_14 = true;
			}
		}
	...
	if (uParam0->f_469[0])
	{
		if (__LIB_1__::func_285(&uLocal_11, 3f))
		{
			return 1;
		}
	}
					...
					if (ANIMSCENE::_IS_ANIM_SCENE_LOADED(uParam0->f_3.f_1, true, false))
					{
						if (ANIMSCENE::_0x1F0E401031E20146(uParam0->f_3.f_1, "pbl_action"))
						{
							if (ANIMSCENE::_IS_ANIM_SCENE_FINISHED(uParam0->f_3.f_1, false) || ANIMSCENE::_IS_ANIM_SCENE_ACTIVE(uParam0->f_3.f_1))
							{
								...
								{
									__LIB_2__::func_426(&(uParam0->f_20[1 /*14*/]));
									__LIB_2__::func_426(&(uParam0->f_20[0 /*14*/]));
									uParam0->f_469[3] = 1;
									return 1;
								}
							}
