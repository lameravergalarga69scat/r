...
bool func_72(var uParam0)
{
	...
	{
		case 8:
			__LIB_7__::func_45(uParam0, 28, 0, 0, 0);
			break;
		default:
			return false;
	}
	...
	__LIB_7__::func_159(uParam0, -1.4f, 0.55f, 0.5f, 0f, 0.5f, 0.5f, 3f, joaat("VOLCYLINDER"), 1);
	__LIB_6__::func_958(uParam0, joaat("P_BASKET06X"), 0f, 0f, 0f, "BASKET", 0, 0, 1);
	__LIB_6__::func_958(uParam0, joaat("P_CS_BOOK03X"), 0f, 0f, 0f, "BOOK", 0, 0, 1);
	__LIB_6__::func_958(uParam0, joaat("P_CS_KNITTING01X"), 0f, 0f, 0f, "KNITTING", 0, 1, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@beecher@abigail_and_jack_1@base", 1, 1, 0, 0);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@beecher@abigail_and_jack_1@action_a", 2, 0, 1, 0);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@beecher@abigail_and_jack_1@action_b", 2, 0, 0, 0);
	iLocal_18 = __LIB_6__::func_959(uParam0, "script@vignette@beecher@abigail_and_jack_1@action_b_front", 2, 0, 0, 1);
	iLocal_19 = __LIB_6__::func_959(uParam0, "script@vignette@beecher@abigail_and_jack_1@action_b_left", 2, 0, 0, 1);
	iLocal_21 = __LIB_6__::func_959(uParam0, "script@vignette@beecher@abigail_and_jack_1@action_b_seated", 2, 0, 0, 1);
	iLocal_20 = __LIB_6__::func_959(uParam0, "script@vignette@beecher@abigail_and_jack_1@action_b_right", 2, 0, 0, 1);
	iLocal_23 = __LIB_6__::func_959(uParam0, "script@vignette@beecher@abigail_and_jack_1@JACK_EXIT_STAND", 0, 0, 0, 0);
	__LIB_7__::func_146(uParam0, "BANJ1AU");
	__LIB_7__::func_149(uParam0, joaat("COMP_BCANJCNV1"), joaat("PLAYER_BCANJCNV1"));
	__LIB_7__::func_107(uParam0, iLocal_14, 2, joaat("PROP_HUMAN_SEAT_CHAIR_KNITTING"), "PROP_HUMAN_SEAT_CHAIR_KNITTING_FEMALE_A", -1, 1);
	__LIB_7__::func_127(uParam0, iLocal_14, 2, joaat("PROP_HUMAN_SEAT_CHAIR_KNITTING"), "PROP_HUMAN_SEAT_CHAIR_KNITTING_FEMALE_A", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_151(uParam0, iLocal_14, 1, -1);
	__LIB_7__::func_151(uParam0, iLocal_15, 1, -1);
	__LIB_7__::func_145(uParam0, 2f, 5f);
	Local_24 = { __LIB_7__::func_160(uParam0, -0.365f, 1.782f, 0.982f, 180f, 4.455f, 0.125f, 0.5075f) };
	Local_34 = { __LIB_7__::func_160(uParam0, -0.365f, 1.782f, 0.982f, -164.75f, 5.2275f, 0.405f, 0.04f) };
	Local_44 = { __LIB_7__::func_160(uParam0, -0.365f, 1.782f, 0.982f, -107.5f, 5.2275f, 0.205f, 0.228f) };
	Local_54 = { __LIB_7__::func_160(uParam0, -0.365f, 1.782f, 0.982f, 97.75f, 3.4875f, 0.4025f, 0.0875f) };
	return true;
}
