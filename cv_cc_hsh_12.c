...
bool func_72(var uParam0)
{
	...
	__LIB_7__::func_47(uParam0, -3.3384f, -3.0037f, 1.156f, 17.0847f, 1.5f, 1.5f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_HOSEA"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, -0.7301f, 0.5311f, 0.5295f, -0.2848f, 2.2f, 2f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_JOHN"), 1, 1, 1);
	__LIB_7__::func_159(uParam0, -1.0257f, 0.9388f, 1.0341f, 0f, 0.72f, 0.72f, 3f, joaat("VOLCYLINDER"), 1);
	iLocal_21 = __LIB_6__::func_958(uParam0, joaat("P_CS_RAG02X"), 0f, 0f, 0f, "RAG", 0, 1, 1);
	iLocal_22 = __LIB_6__::func_958(uParam0, joaat("P_STOOLFOLDING01X"), 0.0114404f, 1.02168f, 0.0306778f, 0, 1, 0, 1);
	__LIB_7__::func_271(uParam0, iLocal_14, joaat("WEAPON_REVOLVER_CATTLEMAN_JOHN"), "REVOLVER");
	__LIB_6__::func_959(uParam0, "script@vignette@hosea_12@base", 1, 1, 0, 0);
	iLocal_15 = __LIB_6__::func_959(uParam0, "script@vignette@hosea_12@action_a", 2, 0, 1, 0);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@hosea_12@action_a_int", 2, 0, 0, 0);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@hosea_12@action_b", 2, 0, 0, 0);
	iLocal_18 = __LIB_6__::func_959(uParam0, "script@vignette@hosea_12@action_c", 0, 0, 0, 0);
	iLocal_19 = __LIB_6__::func_959(uParam0, "script@vignette@hosea_12@action_c_alt", 0, 0, 0, 1);
	__LIB_7__::func_146(uParam0, "CH12AUD");
	__LIB_7__::func_127(uParam0, iLocal_14, 3, joaat("PROP_HUMAN_SEAT_CHAIR_TABLE_CLEAN_PISTOL"), "PROP_HUMAN_SEAT_CHAIR_TABLE_CLEAN_PISTOL_MALE_A", iLocal_22, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_139(uParam0, iLocal_14, iLocal_21, "p_cs_rag02x_PH_L_HAND", 0, 0);
	__LIB_7__::func_147(uParam0, iLocal_14, 1, 2, 0, 0, 0);
	Local_23 = { __LIB_7__::func_160(uParam0, -1.5559f, 0.4947f, 1.0665f, -3.96f, 7f, 0.6f, 0.6f) };
	return true;
}
...
bool func_93(var uParam0)
{
	...
	if (__LIB_7__::func_148(uParam0, iLocal_17))
	{
		if (__LIB_7__::func_163(uParam0, Local_23, 1, 0))
		{
			...
			__LIB_7__::func_149(uParam0, joaat("COMP_HSHCNV12"), joaat("PLAYER_HSHCNV12"));
...
{
	if (!bLocal_20 && TASK::PED_HAS_USE_SCENARIO_TASK(__LIB_6__::func_952(uParam0, iLocal_14)))
	{
		PED::_0xEC6935EBE0847B90(__LIB_6__::func_952(uParam0, iLocal_14), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(__LIB_6__::func_952(uParam0, iLocal_14), 1f, 0f, 0f));
		bLocal_20 = true;
	}
	return true;
}
