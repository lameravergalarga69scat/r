...
bool func_72(var uParam0)
{
	...
	__LIB_7__::func_47(uParam0, 2.5206f, -3.032f, 0.4558f, 10.44f, 1.5f, 1.5f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_ABIGAIL"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, 1.0272f, -3.2717f, 0.5389f, 10.68f, 1.5f, 1.5f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_UNCLE"), 1, 1, 1);
	__LIB_7__::func_159(uParam0, 1.75f, -3.35f, 0.5f, 12f, 1f, 0.56f, 3f, joaat("VOLCYLINDER"), 1);
	__LIB_6__::func_958(uParam0, joaat("P_CHAIR05X"), 0f, 0f, 0f, "CHAIR_0", 0, 0, 1);
	iLocal_21 = __LIB_6__::func_958(uParam0, joaat("P_CHAIR05X"), 0f, 0f, 0f, "CHAIR_1", 0, 0, 1);
	__LIB_6__::func_958(uParam0, joaat("P_CS_SOCK01X"), 0f, 0f, 0f, "SOCK", 0, 0, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@beecher@abigail_and_uncle_1@base", 1, 1, 0, 0);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@beecher@abigail_and_uncle_1@action_a", 2, 0, 1, 0);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@beecher@abigail_and_uncle_1@action_b", 0, 0, 0, 0);
	iLocal_18 = __LIB_6__::func_959(uParam0, "script@vignette@beecher@abigail_and_uncle_1@action_b_alt_front", 0, 0, 0, 1);
	iLocal_19 = __LIB_6__::func_959(uParam0, "script@vignette@beecher@abigail_and_uncle_1@action_b_alt_left", 0, 0, 0, 1);
	iLocal_20 = __LIB_6__::func_959(uParam0, "script@vignette@beecher@abigail_and_uncle_1@action_b_alt_right", 0, 0, 0, 1);
	__LIB_7__::func_146(uParam0, "BANU1AU");
	__LIB_7__::func_149(uParam0, joaat("COMP_BCANUCNV1"), joaat("PLAYER_BCANUCNV1"));
	__LIB_7__::func_127(uParam0, iLocal_14, 2, joaat("PROP_HUMAN_SEAT_CHAIR_SEWING"), "PROP_HUMAN_SEAT_CHAIR_SEWING_FEMALE_A", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_151(uParam0, iLocal_14, 1, -1);
	__LIB_7__::func_127(uParam0, iLocal_15, 3, joaat("PROP_HUMAN_SEAT_CHAIR_PORCH"), "PROP_HUMAN_SEAT_CHAIR_PORCH_MALE_A", iLocal_21, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_151(uParam0, iLocal_15, 1, -1);
	Local_22 = { __LIB_7__::func_160(uParam0, 1.027f, -3.272f, 0.539f, -165.24f, 7f, 0.5f, 0.5f) };
	Local_32 = { __LIB_7__::func_160(uParam0, 1.027f, -3.272f, 0.539f, 96.02f, 7f, 0.597f, 0.4f) };
	Local_42 = { __LIB_7__::func_160(uParam0, 1.027f, -3.272f, 0.539f, -84.23f, 7f, 0.597f, 0.4f) };
	return true;
}
...
bool func_93(var uParam0)
{
	if (__LIB_7__::func_148(uParam0, iLocal_16))
	{
		if (__LIB_7__::func_163(uParam0, Local_22, 1, 0))
		{
			...
			__LIB_7__::func_365(uParam0, iLocal_14, 1);
		}
