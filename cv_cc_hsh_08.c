...
bool func_72(var uParam0)
{
	...
	iLocal_16 = __LIB_7__::func_48(uParam0, 5, 0);
	iLocal_14 = __LIB_7__::func_48(uParam0, 1, 0);
	iLocal_17 = __LIB_7__::func_48(uParam0, 3, "KEY_MALE");
	iLocal_15 = __LIB_7__::func_48(uParam0, 20, "KEY_FEMALE");
	__LIB_7__::func_47(uParam0, 1.1084f, -1.7496f, 0.5579f, 34.7662f, 1.5f, 1.5f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_HOSEA"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, -1.3f, 1.5f, 0.558f, 35.28f, 3f, 1.5f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_JOHN"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, -1.37f, -1.14f, 0.558f, 34.2f, 1.5f, 2.3f, 3f, joaat("VOLBOX"), -1, 1, 1, 1);
	iLocal_18 = __LIB_6__::func_958(uParam0, joaat("P_BOTTLEJD01X"), 0f, 0f, 0f, "BOTTLE", 0, 0, 1);
	__LIB_6__::func_958(uParam0, joaat("P_CS_RAG02X"), 0f, 0f, 0f, "RAG", 0, 0, 1);
	__LIB_7__::func_271(uParam0, iLocal_14, joaat("WEAPON_REVOLVER_CATTLEMAN_JOHN"), "REVOLVER");
	__LIB_6__::func_959(uParam0, "script@vignette@hosea_8@intro_base", 1, 1, 0, 0);
	iLocal_19 = __LIB_6__::func_959(uParam0, "script@vignette@hosea_8@action_a", 2, 0, 1, 0);
	iLocal_20 = __LIB_6__::func_959(uParam0, "script@vignette@hosea_8@action_b", 0, 0, 0, 0);
	iLocal_21 = __LIB_6__::func_959(uParam0, "script@vignette@hosea_8@action_b_alt", 0, 0, 0, 1);
	__LIB_7__::func_146(uParam0, "HSH8AUD");
	__LIB_7__::func_107(uParam0, iLocal_16, 3, joaat("PROP_HUMAN_SEAT_CHAIR"), "PROP_HUMAN_SEAT_CHAIR_GENERIC_MALE_D", -1, 0);
	__LIB_7__::func_127(uParam0, iLocal_14, 2, joaat("PROP_CAMP_FIRE_SEAT_BENCH"), "PROP_CAMP_FIRE_SEAT_BENCH_MALE_B", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_127(uParam0, iLocal_17, 2, joaat("PROP_HUMAN_SEAT_BENCH_PORCH"), "PROP_HUMAN_SEAT_BENCH_PORCH_DRINKING_MALE_A", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_139(uParam0, iLocal_17, iLocal_18, "p_bottleJD01x_ph_r_hand", 0, 0);
	__LIB_7__::func_107(uParam0, iLocal_15, 3, joaat("PROP_HUMAN_SEAT_CHAIR_PORCH"), "PROP_HUMAN_SEAT_CHAIR_PORCH_FEMALE_B", -1, 0);
	__LIB_7__::func_127(uParam0, iLocal_15, 2, joaat("PROP_HUMAN_SEAT_CHAIR_PORCH"), "PROP_HUMAN_SEAT_CHAIR_PORCH_FEMALE_B", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	Local_22 = { __LIB_7__::func_160(uParam0, 1.2084f, -1.8996f, 0.5579f, 34.7662f, 8f, 0.7f, 0.7f) };
	return true;
}
...
bool func_93(var uParam0)
{
	if (__LIB_7__::func_148(uParam0, iLocal_19))
	{
		...
		else
		{
			...
			__LIB_7__::func_127(uParam0, iLocal_15, 1, 0, 0, -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
		}
	}
	return true;
}
