...
{
	__LIB_2__::func_851(uParam0, 10803, 10868, 11561);
}

void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	int iVar0;
	__LIB_2__::func_853(uParam0, "AV_GET_DIRECTIONS", "script@ambient@town@get_directions@Action", vParam1, vParam4);
	...
	__LIB_2__::func_855(uParam0, 0, "IG_GenStoryMale", iVar0, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	__LIB_2__::func_855(uParam0, 1, "IG_GenStoryMale^1", iVar0, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
}
...
int func_31(var uParam0)
{
	...
	if (!uParam0->f_469[2])
	{
		if (__LIB_2__::func_892(uParam0, 0.3f, 40f, 4, 15f, 1112014848 /* Float: 50f */))
		{
			__LIB_2__::func_881(*uParam0, 0);
	...
	if (uParam0->f_469[2])
	{
		...
		if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]) && ENTITY::DOES_ENTITY_EXIST(uParam0->f_20[1 /*14*/]))
		{
			if (ANIMSCENE::_0x005E6F28DD7ED58D(uParam0->f_3.f_1, uParam0->f_20[1 /*14*/].f_1))
			{
				...
				{
					__LIB_2__::func_915(uParam0->f_20[1 /*14*/], joaat("WORLD_HUMAN_LEAN_FENCE_FWD_CHECK_OUT_LIVESTOCK"), -227.1f, 668.65f, 112.31f, 137.565f, 48000, 1, 0, 0, -1082130432 /* Float: -1f */);
				}
		...
		if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]) && ENTITY::DOES_ENTITY_EXIST(uParam0->f_20[0 /*14*/]))
		{
			if (ANIMSCENE::_0x005E6F28DD7ED58D(uParam0->f_3.f_1, uParam0->f_20[0 /*14*/].f_1))
			{
				...
				{
					__LIB_2__::func_915(uParam0->f_20[0 /*14*/], joaat("WORLD_HUMAN_SMOKE"), -180.37f, 617.68f, 113.03f, -158.689f, 35000, 1, 0, 0, -1082130432 /* Float: -1f */);
				}
