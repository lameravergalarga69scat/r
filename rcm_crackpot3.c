...
{
	int iVar0;
	if (!__LIB_0__::func_75(&(uParam0->f_2585)) || IntToFloat(__LIB_1__::func_871(&(uParam0->f_2585))) > __LIB_2__::func_18(uParam0))
	{
...
void func_34(var uParam0)
{
	...
	vLocal_18 = { 2519.42f, 2283.89f, 176.35f };
	fLocal_21 = 148.3069f;
	iLocal_16 = VOLUME::_CREATE_VOLUME_BOX(2515.784f, 2285.247f, 178.5215f, 0f, 0f, 162.7959f, 17.67798f, 8.769043f, 4.339996f);
	PED::_REQUEST_PED_EMOTIONAL_PRESET(Global_35, "Default_Shocked");
	__LIB_4__::func_212(iLocal_16, 1, 0, 0, 0);
	PED::_0x9851DE7AEC10B4E1(vLocal_18, 20f, 1, 1);
}

void func_40(var uParam0)
{
	__LIB_12__::func_867(uParam0, joaat("CS_CRACKPOTINVENTOR"), 7);
...
int func_83(var uParam0)
{
	...
	if (!bLocal_44)
	{
		if (__LIB_0__::func_265(&uLocal_28) > 2f)
		{
			if (OBJECT::DOES_PICKUP_EXIST(iLocal_15))
			{
				if (ENTITY::DOES_ENTITY_EXIST(OBJECT::GET_PICKUP_OBJECT(iLocal_15)))
				{
					ENTITY::FREEZE_ENTITY_POSITION(OBJECT::GET_PICKUP_OBJECT(iLocal_15), true);
					bLocal_44 = true;
				}
			}
		}
	...
	if (!bLocal_42)
	{
		if (TASK::_DOES_SCENARIO_POINT_EXIST(iLocal_38))
		{
			if (!ENTITY::DOES_ENTITY_EXIST(iLocal_40))
			{
				...
				iLocal_40 = TASK::_GET_SCENARIO_POINT_ENTITY(iLocal_38, "PrimaryItem");
			}
			else if (TXD::_HAS_STREAMED_TXD_LOADED(joaat("UI_NOTE_DRAGIC1")))
			{
				DECORATOR::DECOR_SET_INT(iLocal_40, "letter_item", joaat("DOCUMENT_NOTE_DRAGIC1"));
				OBJECT::_SET_APPLY_OBJECT_TXD(ENTITY::GET_OBJECT_INDEX_FROM_ENTITY_INDEX(iLocal_40), joaat("UI_NOTE_DRAGIC1"), 0, 0);
				bLocal_42 = true;
			}
		}
	}
	if (!bLocal_43)
	{
		if (TASK::_DOES_SCENARIO_POINT_EXIST(iLocal_39))
		{
			if (!ENTITY::DOES_ENTITY_EXIST(iLocal_41))
			{
				...
				iLocal_41 = TASK::_GET_SCENARIO_POINT_ENTITY(iLocal_39, "PrimaryItem");
			}
			else if (TXD::_HAS_STREAMED_TXD_LOADED(joaat("UI_NOTE_DRAGIC2")))
			{
				DECORATOR::DECOR_SET_INT(iLocal_41, "letter_item", joaat("DOCUMENT_NOTE_DRAGIC2"));
				OBJECT::_SET_APPLY_OBJECT_TXD(ENTITY::GET_OBJECT_INDEX_FROM_ENTITY_INDEX(iLocal_41), joaat("UI_NOTE_DRAGIC2"), 0, 0);
				bLocal_43 = true;
			}
		}
	}
	...
	if (!bLocal_37)
	{
		if (AUDIO::PREPARE_MUSIC_EVENT("CKPT3_OS1"))
		{
			if (iLocal_46 > 3)
			{
				AUDIO::TRIGGER_MUSIC_EVENT("CKPT3_OS1");
				bLocal_37 = true;
			}
		}
	}
	...
	{
		case 0:
			__LIB_1__::func_148(&uLocal_25);
			iLocal_46 = 1;
			break;
		case 1:
			if (__LIB_0__::func_265(&uLocal_25) > 2f)
			{
				PERSISTENCE::_0xE225CEF1901F6108(iLocal_14, 0);
				GRAPHICS::_ADD_BLOOD_POOL_2(ENTITY::GET_ENTITY_COORDS(iLocal_14, true, false), 1f, 2f, 1f, true, NaNf, false);
				iLocal_46 = 2;
			}
			break;
		case 2:
			if (func_267(Global_36))
			{
				iLocal_46 = 3;
			}
			break;
		case 3:
			...
			{
				bVar0 = false;
				TASK::TASK_LOOK_AT_ENTITY(Global_35, iLocal_14, 6000, 0, 51, 1);
				CAM::SET_GAMEPLAY_ENTITY_HINT(iLocal_14, 0f, 0f, 0f, true, 2000, 2000, 2000, 0);
				TASK::TASK_REACT(Global_35, iLocal_14, 0f, 0f, 0f, "Default_Shocked", 2f, 10f, 4);
				if (__LIB_0__::func_181())
				{
					bVar0 = __LIB_12__::func_876(uParam0, "CKPT3_DDEADJ", 0);
				}
				else
				{
					bVar0 = __LIB_12__::func_876(uParam0, "CKPT3_DDEAD", 0);
				}
				__LIB_1__::func_148(&uLocal_25);
			...
			break;
		case 4:
			if ((__LIB_0__::func_265(&uLocal_25) > 5f && !__LIB_6__::func_903("CKPT3_DDEAD")) && !__LIB_6__::func_903("CKPT3_DDEADJ"))
			{
				bVar1 = false;
				if (__LIB_0__::func_181())
				{
					bVar1 = __LIB_12__::func_876(uParam0, "CKPT3_WHEREJ", 0);
				}
				else
				{
					bVar1 = __LIB_12__::func_876(uParam0, "CKPT3_WHERE", 0);
				}
				if (__LIB_8__::func_684("CKPT3_WHERE") || __LIB_8__::func_684("CKPT3_WHEREJ"))
				{
					bVar1 = true;
				}
				__LIB_1__::func_148(&uLocal_25);
		...
		case 5:
			...
			else if (__LIB_0__::func_265(&uLocal_25) > 2f)
			{
				iLocal_46 = 6;
				return 8;
			}
...
void func_127()
{
	...
	__LIB_0__::func_320(6);
	vVar2 = { func_339(Global_2621440[0 /*12066*/].f_9.f_7, &uVar0, &uVar1, 0, 1, 1, 0, 0, 0) };
...
bool func_143(var uParam0)
{
	if (__LIB_12__::func_644(uParam0) == 0)
	{
		if (BUILTIN::VDIST(vLocal_18, Global_36) < 100f)
		{
			return false;
		}
	}
...
int func_246(var uParam0)
{
	...
	{
		iLocal_14 = __LIB_12__::func_885(uParam0, joaat("CS_CRACKPOTINVENTOR"), vLocal_18, 0, 1, 1, 0, 1, 1, 1, 1, 0);
		PED::_SET_PED_BODY_COMPONENT(iLocal_14, 806280085);
		PED::_UPDATE_PED_VARIATION(iLocal_14, false, true, true, true, true);
		ENTITY::SET_ENTITY_VISIBLE(iLocal_14, false);
		__LIB_1__::func_148(&uLocal_22);
		return 0;
	}
	if (!TASK::_DOES_SCENARIO_POINT_EXIST(iLocal_38))
	{
		iLocal_38 = TASK::CREATE_SCENARIO_POINT(joaat("WORLD_PLAYER_INSPECT_LETTER_NOTE_80CM_PAPER_W10_16_H15_24_P_CS_NOTE01X"), 2517.44f, 2281.32f, 176.3516f, 178.2706f, 0, 0, 0);
	}
	if (!TASK::_DOES_SCENARIO_POINT_EXIST(iLocal_39))
	{
		iLocal_39 = TASK::CREATE_SCENARIO_POINT(joaat("WORLD_PLAYER_INSPECT_LETTER_NOTE_80CM_PAPER_W10_16_H15_24_P_CS_NOTE01X"), 2508.1f, 2287.19f, 176.3515f, 80.738f, 0, 0, 0);
	}
	ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iLocal_14, vLocal_18, fLocal_21, true, true, true);
	__LIB_13__::func_12(iLocal_14, 0);
	ENTITY::_0x18FF3110CF47115D(iLocal_14, 7, 0);
	PED::SET_RAGDOLL_BLOCKING_FLAGS(iLocal_14, 847952);
	PED::SET_PED_CONFIG_FLAG(iLocal_14, 38, true);
	PED::SET_PED_CONFIG_FLAG(iLocal_14, 223, true);
	PED::SET_PED_CONFIG_FLAG(iLocal_14, 186, true);
	if (!ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_14, "AI_DAMAGE@DEAD@BASE", "dead_c", 1))
	{
		TASK::TASK_PLAY_ANIM(iLocal_14, "AI_DAMAGE@DEAD@BASE", "dead_c", 1000f, -1000f, -1, 180224, 0f, false, 0, false, 0, false);
		PED::_0x2208438012482A1A(iLocal_14, false, false);
	}
	if (__LIB_3__::func_135(&uLocal_22) < 2000)
	{
		return 0;
	}
	if (!OBJECT::DOES_PICKUP_EXIST(iLocal_15))
	{
		iLocal_15 = OBJECT::CREATE_PICKUP(joaat("PICKUP_WEAPON_MELEE_LANTERN_ELECTRIC"), 2518.45f, 2284.35f, 176.35f, 0, 1, true, 0, 0, 0f, 0);
		__LIB_1__::func_148(&uLocal_28);
	}
	if (!ENTITY::IS_ENTITY_VISIBLE(iLocal_14))
	{
		ENTITY::SET_ENTITY_VISIBLE(iLocal_14, true);
		PED::SET_PED_CLOTH_PACKAGE_INDEX(iLocal_14, 1);
	}
	if (PED::_0xA0BC8FAED8CFEB3C(iLocal_14))
	{
		GRAPHICS::_0x41F88A85A579A61D(1f);
		GRAPHICS::_0xDD9DC1AB63D513CE(2519.59f, 2283.74f, 176.35f);
		GRAPHICS::_0xDD9DC1AB63D513CE(2519.97f, 2283.65f, 176.35f);
		GRAPHICS::_0x812C1563185C6FB2();
		GRAPHICS::_0x41F88A85A579A61D(0.8f);
		GRAPHICS::_0xDD9DC1AB63D513CE(2522.47f, 2282.95f, 176.35f);
		GRAPHICS::_0xDD9DC1AB63D513CE(2523.18f, 2282.7f, 176.35f);
		GRAPHICS::_0x812C1563185C6FB2();
		GRAPHICS::_0x41F88A85A579A61D(0.6f);
		GRAPHICS::_0xDD9DC1AB63D513CE(2538.74f, 2280.23f, 175.04f);
		GRAPHICS::_0xDD9DC1AB63D513CE(2540.21f, 2280.05f, 174.79f);
		GRAPHICS::_0x812C1563185C6FB2();
		MISC::_0x1096603B519C905F("RCKPT3");
		bLocal_36 = true;
		PED::APPLY_PED_DAMAGE_PACK(iLocal_14, "PD_Crackpot_Inventor_Dead", 0f, 1f);
		if (__LIB_0__::func_181())
		{
...
void func_264()
{
	if (!INTERIOR::IS_VALID_INTERIOR(iLocal_17))
	{
		iLocal_17 = INTERIOR::GET_INTERIOR_AT_COORDS(vLocal_18);
	}
	else
	{
		if (INTERIOR::_IS_INTERIOR_ENTITY_SET_VALID(iLocal_17, "Normal_Cage_Door") && INTERIOR::IS_INTERIOR_ENTITY_SET_ACTIVE(iLocal_17, "Normal_Cage_Door"))
		{
			INTERIOR::DEACTIVATE_INTERIOR_ENTITY_SET(iLocal_17, "Normal_Cage_Door", true);
		}
		if (INTERIOR::_IS_INTERIOR_ENTITY_SET_VALID(iLocal_17, "Damaged_Cage_Door") && !INTERIOR::IS_INTERIOR_ENTITY_SET_ACTIVE(iLocal_17, "Damaged_Cage_Door"))
		{
			INTERIOR::ACTIVATE_INTERIOR_ENTITY_SET(iLocal_17, "Damaged_Cage_Door", 0);
		}
	}
}
...
{
	int iVar0;
	iLocal_31[0] = -227771192;
	iLocal_31[1] = -522528347;
	iLocal_31[2] = 1416977006;
	iLocal_31[3] = 1731133409;
	iVar0 = 0;
	while (iVar0 < 4)
	{
		if (!__LIB_0__::func_724(iLocal_31[iVar0]))
		{
			__LIB_0__::func_68(iLocal_31[iVar0], 0, 0);
		}
		else if (__LIB_2__::func_769(iLocal_31[iVar0]))
		{
			__LIB_1__::func_948(iLocal_31[iVar0], 0, 0, 0, 1, 0, 0, 0);
		}
		iVar0++;
	}
}
...
void func_266()
{
	...
	if (!OBJECT::HAS_PICKUP_BEEN_COLLECTED(iLocal_15))
	{
		return;
	}
	if (!__LIB_0__::func_214(joaat("WEAPON_MELEE_LANTERN_ELECTRIC")))
	{
		__LIB_0__::func_915(joaat("WEAPON_MELEE_LANTERN_ELECTRIC"));
	}
	bLocal_45 = true;
}

bool func_267(vector3 vParam0)
{
	return VOLUME::_IS_POSITION_INSIDE_VOLUME(iLocal_16, vParam0);
}
			...
			case 1:
				switch (__LIB_0__::func_76(iParam0))
				{
					...
					case 1:
						...
						break;
					case 4:
						func_630(joaat("CONSUMABLE_HERB_SAGE"), 3, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_630(joaat("CONSUMABLE_HERB_GINSENG"), 4, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_630(joaat("CONSUMABLE_HERB_INDIAN_TOBACCO"), 3, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_630(joaat("CONSUMABLE_HERB_YARROW"), 2, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_630(joaat("PROVISION_GRITTY_FISH_MEAT"), 2, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_630(joaat("PROVISION_STRINGY_MEAT"), 3, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_630(joaat("PROVISION_ANIMAL_FAT"), 2, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_630(joaat("PROVISION_BIRD_FEATHER_FLIGHT"), 3, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_630(joaat("CONSUMABLE_COFFEE_GNDS_REG"), 2, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_630(joaat("DOCUMENT_PAMPHLET_HORSE_OINTMENT"), 1, 1, 0, 0, 752097756, 0, 0, 0, 0);
						__LIB_1__::func_692(joaat("DOCUMENT_PAMPHLET_HORSE_OINTMENT"));
						func_630(joaat("DOCUMENT_PAMPHLET_FIRE_ARROW"), 1, 1, 0, 0, 752097756, 0, 0, 0, 0);
						__LIB_1__::func_692(joaat("DOCUMENT_PAMPHLET_FIRE_ARROW"));
						func_630(joaat("DOCUMENT_PAMPHLET_IMPROVED_ARROW"), 1, 1, 0, 0, 752097756, 0, 0, 0, 0);
						__LIB_1__::func_692(joaat("DOCUMENT_PAMPHLET_IMPROVED_ARROW"));
						func_630(joaat("DOCUMENT_PAMPHLET_SML_GM_ARROW"), 1, 1, 0, 0, 752097756, 0, 0, 0, 0);
						__LIB_1__::func_692(joaat("DOCUMENT_PAMPHLET_SML_GM_ARROW"));
						func_630(joaat("DOCUMENT_PAMPHLET_IMPROVED_TOMAHAWK"), 1, 1, 0, 0, 752097756, 0, 0, 0, 0);
						__LIB_1__::func_692(joaat("DOCUMENT_PAMPHLET_IMPROVED_TOMAHAWK"));
						func_630(joaat("DOCUMENT_PAMPHLET_IMPROVED_THROW_KNIFE"), 1, 1, 0, 0, 752097756, 0, 0, 0, 0);
						__LIB_1__::func_692(joaat("DOCUMENT_PAMPHLET_IMPROVED_THROW_KNIFE"));
						func_630(joaat("DOCUMENT_PAMPHLET_SPLIT_POINT_AMMO"), 1, 1, 0, 0, 752097756, 0, 0, 0, 0);
						__LIB_1__::func_692(joaat("DOCUMENT_PAMPHLET_SPLIT_POINT_AMMO"));
						func_630(joaat("DOCUMENT_PAMPHLET_MOLOTOV"), 1, 1, 0, 0, 752097756, 0, 0, 0, 0);
						__LIB_1__::func_692(joaat("DOCUMENT_PAMPHLET_MOLOTOV"));
						func_630(joaat("DOCUMENT_PAMPHLET_EXPRESS_EXPLOSIVE_AMMO"), 1, 1, 0, 0, 752097756, 0, 0, 0, 0);
						__LIB_1__::func_692(joaat("DOCUMENT_PAMPHLET_EXPRESS_EXPLOSIVE_AMMO"));
						func_630(joaat("DOCUMENT_PAMPHLET_POTENT_HERBIVORE_BAIT"), 1, 1, 0, 0, 752097756, 0, 0, 0, 0);
						__LIB_1__::func_692(joaat("DOCUMENT_PAMPHLET_POTENT_HERBIVORE_BAIT"));
						func_630(joaat("DOCUMENT_PAMPHLET_POTENT_PREDATOR_BAIT"), 1, 1, 0, 0, 752097756, 0, 0, 0, 0);
						__LIB_1__::func_692(joaat("DOCUMENT_PAMPHLET_POTENT_PREDATOR_BAIT"));
						func_630(joaat("DOCUMENT_PAMPHLET_COVER_SCENT"), 1, 1, 0, 0, 752097756, 0, 0, 0, 0);
						__LIB_1__::func_692(joaat("DOCUMENT_PAMPHLET_COVER_SCENT"));
						func_630(joaat("WEAPON_KIT_CAMERA"), 1, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_630(joaat("KIT_CAMP"), 1, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_630(-1448210800 /* GXTEntry: "Crafting Tools" */, 1, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_630(joaat("CLOTHING_ITEM_PZ_LOADOUT_BANDOLIER_01"), 1, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_632();
						func_633(joaat("CLOTHING_SP_COAT_WINTER01_VARIATION_01"));
						__LIB_1__::func_101();
						__LIB_0__::func_874();
						break;
					case 5:
					...
					case 8:
						...
						break;
					case 15:
						func_630(joaat("DOCUMENT_MAP_LEGENDARY_ANIMALS"), 1, 0, 0, 0, 752097756, 0, 0, 0, 0);
					...
					case 67:
						...
						func_630(1224687176 /* GXTEntry: "John\'s Pistol Belt" */, 1, 1, 0, 0, 752097756, 0, 0, 0, 0);
						func_630(-4440804 /* GXTEntry: "John\'s Holster" */, 1, 1, 0, 0, 752097756, 0, 0, 0, 0);
						break;
					case 74:
			...
			case 1:
				switch (__LIB_0__::func_76(iParam0))
				{
					...
					case 34:
						...
						{
							func_630(joaat("PROVISION_POCKET_WATCH_REUTLINGE"), 1, 0, 0, 0, 752097756, 0, 0, 0, 0);
						}
						break;
					case 29:
...
Vector3 func_339(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10)
{
	vector3 vVar0;
	vVar0 = { func_675(vParam0, iParam3, iParam4, iParam5, iParam6, 1, iParam7, bParam8, bParam9, bParam10, -1, 1103626240 /* Float: 25f */) };
	if (__LIB_0__::func_86(vVar0))
	{
		vVar0 = { func_675(vParam0, iParam3, iParam4, 0, 1, 1, iParam7, bParam8, 0, 0, -1, 1103626240 /* Float: 25f */) };
	}
	return vVar0;
}
...
void func_358()
{
	...
	while (iVar0 < 4)
	{
		if (__LIB_0__::func_724(iLocal_31[iVar0]))
		{
			__LIB_1__::func_941(iLocal_31[iVar0]);
		}
		iVar0++;
	}
...
void func_548(var uParam0)
{
	...
	if (!__LIB_0__::func_84(uParam0, 4))
	{
		...
		func_866(&(uParam0->f_404), 0, 2, vVar0.x, vVar0.y, vVar0.z, 0);
...
bool func_630(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, float fParam6, int iParam7, int iParam8, bool bParam9)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (__LIB_1__::func_614(iParam0, 0, 0) == 0)
	{
		if (__LIB_1__::func_153(iParam0))
		{
			...
			{
				func_630(__LIB_0__::func_354(iVar6), 1, 0, 0, 0, 752097756, 0, 0, 0, 0);
	...
	if (!bVar3)
	{
		...
		else if (__LIB_0__::func_192(iParam0, 1192444843))
		{
			switch (iParam0)
			{
				case joaat("UPGRADE_FSH_BAIT_LEG_LURE_LAKE"):
					...
					{
						func_630(215778062 /* GXTEntry: "Special Lake Lure Handbill" */, 1, 0, 0, 0, 752097756, 0, 0, 0, 0);
					}
					break;
				case joaat("UPGRADE_FSH_BAIT_LEG_LURE_RIVER"):
					if (!__LIB_1__::func_707(670273567 /* GXTEntry: "Special River Lure Handbill" */, 1, 0))
					{
						func_630(670273567 /* GXTEntry: "Special River Lure Handbill" */, 1, 0, 0, 0, 752097756, 0, 0, 0, 0);
					}
					break;
				case joaat("UPGRADE_FSH_BAIT_LEG_LURE_SWAMP"):
					if (!__LIB_1__::func_707(-967317137 /* GXTEntry: "Special Swamp Lure Handbill" */, 1, 0))
					{
						func_630(-967317137 /* GXTEntry: "Special Swamp Lure Handbill" */, 1, 0, 0, 0, 752097756, 0, 0, 0, 0);
					}
					break;
				case joaat("UPGRADE_FSH_BAIT_LURE_LAKE"):
					if (!__LIB_1__::func_707(526074061 /* GXTEntry: "Lake Lure Handbill" */, 1, 0))
					{
						func_630(526074061 /* GXTEntry: "Lake Lure Handbill" */, 1, 0, 0, 0, 752097756, 0, 0, 0, 0);
					}
					break;
				case joaat("UPGRADE_FSH_BAIT_LURE_RIVER"):
					if (!__LIB_1__::func_707(-1045488665 /* GXTEntry: "River Lure Handbill" */, 1, 0))
					{
						func_630(-1045488665 /* GXTEntry: "River Lure Handbill" */, 1, 0, 0, 0, 752097756, 0, 0, 0, 0);
					}
					break;
				case joaat("UPGRADE_FSH_BAIT_LURE_SWAMP"):
					if (!__LIB_1__::func_707(471514780 /* GXTEntry: "Swamp Lure Handbill" */, 1, 0))
					{
						func_630(471514780 /* GXTEntry: "Swamp Lure Handbill" */, 1, 0, 0, 0, 752097756, 0, 0, 0, 0);
					}
					break;
			}
		}
		...
		else if (__LIB_0__::func_192(iParam0, 1248798204))
		{
			...
			if (iVar8 != 0)
			{
				func_630(iVar8, 1, 1, 0, 0, 752097756, 0, 0, 0, 0);
			}
		}
		switch (iParam0)
		{
    ...
    " Cores." */, 1, 1);
			...
			case joaat("CONSUMABLE_CIGARETTE_BOX"):
				...
				{
					func_630(__LIB_1__::func_156(), 1, 0, 0, 0, 752097756, 0, 0, 0, 0);
				}
				else
				{
					func_630(__LIB_0__::func_920(), 1, 0, 0, 0, 752097756, 0, 0, 0, 0);
				}
				break;
	...
	else if (iVar2 != 0)
	{
		if (__LIB_0__::func_708(0))
		{
			...
			while (iVar34 < Var11)
			{
				func_630(Var11.f_1[iVar34], Var11.f_12[iVar34], 0, 0, 0, -897553835, 0, 0, 0, 0);
				iVar34++;
			}
		}
		else
...
void func_633(int iParam0)
{
	...
	int iVar8;
	var uVar9;
	func_1056(iParam0, 1, 1, -142743235, 1);
...
void func_668()
{
	...
	{
		if (!SPACTIONPROXY::_SPACTIONPROXY_PROCESS_ACTION(uVar4, func_1090(&uVar4, &iVar1, &iVar2, &iVar3)))
		{
		}
	else
	{
...
Vector3 func_675(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10, bool bParam11, int iParam12, bool bParam13)
{
	int iVar0;
	int iVar1;
	float fVar2;
	...
	if (!func_1105(Global_1310720.f_21))
	{
		bParam10 = bParam11;
	}
	Var15.f_2 = 723128514;
...
void func_866(var uParam0, int iParam1, int iParam2, var uParam3, var uParam4, var uParam5, bool bParam6)
{
	int iVar0;
	bool bVar1;
	int iVar2;
...
void func_868(var uParam0)
{
	...
	if (__LIB_0__::func_84(uParam0, 2048) && !__LIB_0__::func_86(__LIB_12__::func_720(uParam0)))
	{
		...
		if ((!ENTITY::IS_ENTITY_DEAD(iVar1) && ((bVar0 && ENTITY::IS_ENTITY_IN_VOLUME(iVar1, uParam0->f_4, true, 0)) || __LIB_0__::func_84(uParam0, -2147483648))) && PED::GET_MOUNT(Global_35) != iVar1)
		{
			...
			func_1235(iVar1, __LIB_12__::func_720(uParam0), __LIB_12__::func_721(uParam0), iVar2, 1073741824 /* Float: 2f */);
		}
		iVar3 = PLAYER::GET_PLAYERS_LAST_VEHICLE();
		if ((!ENTITY::IS_ENTITY_DEAD(iVar3) && ((bVar0 && ENTITY::IS_ENTITY_IN_VOLUME(iVar3, uParam0->f_4, true, 0)) || __LIB_0__::func_84(uParam0, -2147483648))) && !PED::IS_PED_IN_VEHICLE(Global_35, iVar3, true))
		{
			func_1235(iVar3, __LIB_12__::func_720(uParam0), __LIB_12__::func_721(uParam0), 2, 1073741824 /* Float: 2f */);
		}
	}
}
...
void func_869(var uParam0)
{
	...
	if ((__LIB_0__::func_84(uParam0, 268435456) && !__LIB_0__::func_86(__LIB_12__::func_720(uParam0))) && PED::IS_PED_IN_ANY_VEHICLE(Global_35, false))
	{
		...
		if (!ENTITY::IS_ENTITY_DEAD(iVar0))
		{
			...
			func_1235(iVar0, vVar1, __LIB_0__::func_152(vVar1, Global_36, 1), 2, 1073741824 /* Float: 2f */);
...
void func_1050()
{
	...
	func_630(1351927599 /* GXTEntry: "The Grizzlies Outlaw" */, 1, 0, 0, 0, 752097756, 0, 0, 0, 0);
...
void func_1053()
{
	...
	if (bVar0)
	{
		if (COLLECTION::_0xF83D3DDA4D3C8169(joaat("TREASURE_HUNT_LOOT_13")) > 0)
		{
			...
			{
				func_630(joaat("DOCUMENT_TREASURE_MAP_10"), 1, 1, 0, 0, 752097756, 0, 0, 0, 0);
			}
		...
		if (COLLECTION::_0xF83D3DDA4D3C8169(joaat("TREASURE_HUNT_LOOT_14")) > 0)
		{
			...
			{
				func_630(joaat("DOCUMENT_TREASURE_MAP_11"), 1, 1, 0, 0, 752097756, 0, 0, 0, 0);
			}
	...
	else
	{
		if (COLLECTION::_0xF83D3DDA4D3C8169(joaat("TREASURE_HUNT_LOOT_13")) > 0)
		{
			...
			{
				func_1056(joaat("DOCUMENT_TREASURE_MAP_10"), 1, 1, -142743235, 0);
			}
		}
		if (COLLECTION::_0xF83D3DDA4D3C8169(joaat("TREASURE_HUNT_LOOT_14")) > 0)
		{
			...
			{
				func_1056(joaat("DOCUMENT_TREASURE_MAP_11"), 1, 1, -142743235, 0);
			}
		}
		if (__LIB_0__::func_458(1))
		{
...
int func_1056(int iParam0, int iParam1, bool bParam2, int iParam3, bool bParam4)
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	if (STATS::_STAT_ID_IS_VALID(&Var5))
	{
		...
		{
			func_1056(iParam0, __LIB_1__::func_614(iParam0, 0, 0), bParam2, iParam3, bParam4);
			return 0;
		}
	}
...
int func_1090(var uParam0, int iParam1, int iParam2, int iParam3)
{
	...
	iVar11 = (func_1461(iVar0, iVar1, 1, 0, 0) * iVar2);
	if (iVar11 <= 0)
	{
		return 0;
	}
	...
	if (!func_630(iVar0, iVar4, 1, 0, 0, 1248274121, 0, 0, 0, 0))
	{
		*iParam2 = (*iParam2 + iVar2);
		return 0;
	}
...
bool func_1105(int iParam0)
{
	...
	return ((Global_1888801[iParam0 /*35*/].f_20 == 1 || Global_1888801[iParam0 /*35*/].f_20 == 2) && !func_1471(iParam0));
}
...
void func_1235(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (__LIB_0__::func_27(iParam5, 4) && ENTITY::IS_ENTITY_A_PED(iParam0))
	{
		...
		if (PED::IS_PED_ON_VEHICLE(iVar1, false))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(iVar0) && !ENTITY::IS_ENTITY_DEAD(iVar0))
			{
				...
				func_1235(iVar0, vParam1, fParam4, iParam5, iParam6);
			}
			return;
		}
		else if (PED::IS_PED_ON_MOUNT(iVar1))
		{
			...
			{
				iParam5 = (iParam5 - iParam5 & 4);
				func_1235(iVar2, vParam1, fParam4, iParam5, iParam6);
			}
			return;
		}
	}
...
void func_1419(bool bParam0)
{
	...
	if (bParam0)
	{
		func_630(2032023096 /* GXTEntry: "The Nuevo Paraiso" */, 1, 0, 0, 0, 752097756, 0, 0, 0, 0);
		func_630(joaat("PROVISION_TALISMAN_EAGLE_TALON"), 1, 1, 0, 0, 752097756, 0, 0, 0, 0);
		func_630(joaat("PROVISION_TRINKET_IGUANA_SCALE"), 1, 1, 0, 0, 752097756, 0, 0, 0, 0);
		__LIB_1__::func_851();
		UNLOCK::_UNLOCK_SET_UNLOCKED(joaat("SP_GAME_CONTENT_EDITION_SPECIAL_REDEEMED"), true);
	}
	else
	{
		func_1660(2032023096 /* GXTEntry: "The Nuevo Paraiso" */);
		func_633(joaat("PROVISION_TALISMAN_EAGLE_TALON"));
		func_1056(joaat("PROVISION_TRINKET_IGUANA_SCALE"), 1, 1, -142743235, 1);
...
void func_1422(bool bParam0)
{
	...
	if (bParam0)
	{
		...
		func_630(joaat("CONSUMABLE_SPECIAL_MEDICINE_CRAFTED"), 3, 0, 0, 0, 752097756, 0, 0, 0, 0);
		func_630(joaat("CONSUMABLE_SPECIAL_SNAKE_OIL_CRAFTED"), 3, 0, 0, 0, 752097756, 0, 0, 0, 0);
		func_630(joaat("CONSUMABLE_SPECIAL_RESTORATIVE_CRAFTED"), 3, 0, 0, 0, 752097756, 0, 0, 0, 0);
		func_630(joaat("CONSUMABLE_TENDER_PORK_WILD_MINT_COOKED"), 5, 0, 0, 0, 752097756, 0, 0, 0, 0);
		func_630(joaat("CONSUMABLE_PRIME_BEEF_OREGANO_COOKED"), 5, 0, 0, 0, 752097756, 0, 0, 0, 0);
		func_630(joaat("CONSUMABLE_GAME_MEAT_THYME_COOKED"), 5, 0, 0, 0, 752097756, 0, 0, 0, 0);
		func_630(joaat("CONSUMABLE_HERB_OLEANDER_SAGE"), 5, 0, 0, 0, 752097756, 0, 0, 0, 0);
		func_630(joaat("PROVISION_ANIMAL_FAT"), 5, 0, 0, 0, 752097756, 0, 0, 0, 0);
		func_630(joaat("CONSUMABLE_SPECIAL_HORSE_REVIVER_CRAFTED"), 3, 0, 0, 0, 752097756, 0, 0, 0, 0);
		func_630(joaat("CONSUMABLE_CRAFTED_SUPER_MEAL"), 3, 0, 0, 0, 752097756, 0, 0, 0, 0);
		func_630(joaat("CONSUMABLE_OAT_CAKES"), 3, 0, 0, 0, 752097756, 0, 0, 0, 0);
	...
	else
	{
		...
		func_1056(joaat("CONSUMABLE_SPECIAL_MEDICINE_CRAFTED"), 3, 1, -142743235, 1);
		func_1056(joaat("CONSUMABLE_SPECIAL_SNAKE_OIL_CRAFTED"), 3, 1, -142743235, 1);
		func_1056(joaat("CONSUMABLE_SPECIAL_RESTORATIVE_CRAFTED"), 3, 1, -142743235, 1);
		func_1056(joaat("CONSUMABLE_TENDER_PORK_WILD_MINT_COOKED"), 5, 1, -142743235, 1);
		func_1056(joaat("CONSUMABLE_PRIME_BEEF_OREGANO_COOKED"), 5, 1, -142743235, 1);
		func_1056(joaat("CONSUMABLE_GAME_MEAT_THYME_COOKED"), 5, 1, -142743235, 1);
		func_1056(joaat("CONSUMABLE_HERB_OLEANDER_SAGE"), 5, 1, -142743235, 1);
		func_1056(joaat("PROVISION_ANIMAL_FAT"), 5, 1, -142743235, 1);
		func_1056(joaat("CONSUMABLE_SPECIAL_HORSE_REVIVER_CRAFTED"), 3, 1, -142743235, 1);
		func_1056(joaat("CONSUMABLE_CRAFTED_SUPER_MEAL"), 3, 1, -142743235, 1);
		func_1056(joaat("CONSUMABLE_OAT_CAKES"), 10, 1, -142743235, 1);
...
int func_1461(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	struct<2> Var0[15];
	int iVar31;
	int iVar32;
			...
			if (iVar61 != -1)
			{
				...
				while (iVar62 < iVar60)
				{
					...
					if (__LIB_0__::func_144(iVar63, 0) && iVar63 != iParam0)
					{
						if (bParam4)
						{
							iVar49 = (iVar49 + func_1461(iVar63, -915411861, 1, 0, 0));
						}
						else
						{
							Var35 = iVar63;
...
{
	var uVar0;
	return func_1716(&uVar0, iParam0, iParam1);
}

void func_1660(int iParam0)
{
	int iVar0[15];
	bool bVar16;
	bool bVar17;
	...
	while (iVar36 < iVar34)
	{
		func_1056(uVar18[iVar36], 1, 1, -142743235, 1);
...
{
	if (!func_1790(Param0.f_4, 1))
	{
	}
	if (!func_1790(Param0, 1))
	{
	}
	if (!func_1790(Param0.f_2, 1))
	{
	}
	if (!func_1790(Param0.f_5, 1))
	{
	}
	if (!func_1790(Param0.f_3, 1))
	{
	}
	if (!func_1790(Param0.f_1, 1))
	{
	}
}

int func_1716(var uParam0, int iParam1, int iParam2)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	{
		iParam1 |= 512;
		return func_1716(uParam0, iParam1, iParam2);
	}
...
bool func_1790(int iParam0, int iParam1)
{
	...
	if (__LIB_1__::func_556(Var14, iParam1))
	{
		...
		else if (__LIB_0__::func_848(iParam0))
		{
			...
			{
				if (func_1790(iVar19, 0))
				{
				}
			}
			if (__LIB_1__::func_439(joaat("SLOTID_HORSE_STIRRUP"), &iVar20))
			{
				if (func_1790(iVar20, 0))
				{
				}
			}
