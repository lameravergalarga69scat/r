...
bool func_72(var uParam0)
{
	...
	__LIB_6__::func_959(uParam0, "script@vignette@dutch_24@base", 65, 1, 0, 0);
	iLocal_15 = __LIB_6__::func_959(uParam0, "script@vignette@dutch_24@action_a", 66, 0, 1, 0);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@dutch_24@action_a_int", 66, 0, 0, 0);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@dutch_24@action_b", 0, 0, 0, 0);
	__LIB_7__::func_127(uParam0, iLocal_14, 2, joaat("WORLD_HUMAN_SIT_GROUND_READING"), "WORLD_HUMAN_SIT_GROUND_READING_BOOK_FEMALE_A", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_146(uParam0, "CDT24AU");
	Local_18 = { __LIB_7__::func_160(uParam0, 1.8823f, -0.2919f, 1.0249f, -144.72f, 8f, 0.63f, 0.63f) };
	return true;
}
