...
bool func_72(var uParam0)
{
	...
	iLocal_17 = __LIB_6__::func_958(uParam0, joaat("P_STOOLFOLDING01X"), 0.0114404f, 1.02168f, 0.0306778f, 0, 1, 0, 1);
	__LIB_7__::func_47(uParam0, -2.2725f, -3.645f, 0.85f, -65.75f, 1f, 1f, 3.2075f, joaat("VOLBOX"), joaat("APMS_COMP_JOHN"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, -0.725f, 0.625f, 0.85f, 0f, 2.25f, 2.4f, 3.2075f, joaat("VOLBOX"), joaat("APMS_COMP_HOSEA"), 1, 1, 1);
	__LIB_7__::func_159(uParam0, -0.793745f, 0.924917f, 1.03457f, 0f, 1.1f, 1.1f, 3.2075f, joaat("VOLCYLINDER"), 1);
	__LIB_6__::func_959(uParam0, "script@vignette@john_8@base", 65, 1, 0, 0);
	__LIB_6__::func_959(uParam0, "script@vignette@john_8@Action", 64, 0, 1, 0);
	__LIB_7__::func_146(uParam0, "CJHN8AU");
	...
	__LIB_7__::func_107(uParam0, iLocal_15, 3, joaat("PROP_HUMAN_SEAT_CHAIR_READ_NEWSPAPER"), "PROP_HUMAN_SEAT_CHAIR_READ_NEWSPAPER_MALE_B", iLocal_17, 0);
