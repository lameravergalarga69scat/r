...
bool func_72(var uParam0)
{
	...
	{
		case 8:
			__LIB_7__::func_45(uParam0, 26, 0, 0, 0);
			break;
		default:
			return false;
	}
	...
	__LIB_6__::func_958(uParam0, joaat("P_HAMMER03X"), 0f, 0f, 0f, "HAMMER", 0, 0, 1);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@beecher@charles_and_uncle_5@base", 1, 1, 0, 0);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@beecher@charles_and_uncle_5@action", 0, 0, 1, 0);
	__LIB_7__::func_146(uParam0, "BCNU5AU");
	__LIB_7__::func_149(uParam0, joaat("COMP_BCCNUCNV5"), joaat("PLAYER_BCCNUCNV5"));
	__LIB_7__::func_107(uParam0, iLocal_14, 3, joaat("PROP_HUMAN_REPAIR_WAGON_WHEEL_ON_LARGE"), "PROP_HUMAN_REPAIR_WAGON_WHEEL_ON_LARGE_MALE_A", -1, 0);
	__LIB_7__::func_151(uParam0, iLocal_14, 1, -1);
	__LIB_7__::func_107(uParam0, iLocal_15, 3, joaat("WORLD_HUMAN_SIT_FALL_ASLEEP"), "WORLD_HUMAN_SIT_GROUND_TIRED_MALE_A", -1, 0);
	__LIB_7__::func_151(uParam0, iLocal_15, 1, -1);
	__LIB_7__::func_127(uParam0, iLocal_15, 2, joaat("WORLD_HUMAN_SIT_FALL_ASLEEP"), "WORLD_HUMAN_SIT_GROUND_TIRED_MALE_A", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
...
bool func_83(var uParam0)
{
	if (ENTITY::DOES_ENTITY_EXIST(Global_36603))
	{
		...
		if (!bLocal_18)
		{
			...
			bLocal_18 = true;
			__LIB_6__::func_986(Global_36603, uParam0->f_1984[iLocal_16], "CART");
			__LIB_6__::func_986(Global_36603, uParam0->f_1984[iLocal_17], "CART");
		}
	}
	return bLocal_18;
}
