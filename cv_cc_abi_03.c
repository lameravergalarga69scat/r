...
bool func_72(var uParam0)
{
	...
	{
		case 1:
			__LIB_7__::func_45(uParam0, 138, 0, 0, 0);
			__LIB_7__::func_116(uParam0, -117.931f, -36.6001f, 94.5263f, 0f, 0f, -121.59f);
			break;
		case 2:
			__LIB_7__::func_45(uParam0, 75, 0, 0, 0);
			__LIB_7__::func_116(uParam0, 660.3477f, -1257.321f, 42.5046f, 0f, 0f, 165.73f);
			break;
		default:
			return false;
	}
	...
	__LIB_7__::func_47(uParam0, 0f, -1.6f, 0f, -2.75f, 3.9f, 6.5f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_ABIGAIL"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, 6.1735f, 1.7607f, 0.9346f, 153.9932f, 1f, 1f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_JOHN"), 1, 1, 1);
	iLocal_16 = __LIB_6__::func_958(uParam0, joaat("P_BROOM02X"), 0f, 0f, 0f, "BROOM", 0, 0, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@abigail_3@base", 1, 1, 0, 0);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@abigail_3@action", 0, 0, 1, 0);
	iLocal_18 = __LIB_6__::func_959(uParam0, "script@vignette@abigail_3@base_exit", 1, 0, 0, 0);
	__LIB_7__::func_146(uParam0, "CAB3AUD");
	...
	__LIB_7__::func_139(uParam0, iLocal_14, iLocal_16, "p_broom02x_PH_R_HAND", 0, 0);
	__LIB_7__::func_147(uParam0, iLocal_14, 2, 2, 0, 0, 0);
	__LIB_7__::func_147(uParam0, iLocal_15, 2, 1, 0, 0, 0);
	__LIB_7__::func_145(uParam0, 30f, 70f);
	return true;
}
...
bool func_93(var uParam0)
{
	if (__LIB_7__::func_148(uParam0, iLocal_17))
	{
		...
		__LIB_1__::func_148(&uLocal_19);
	}
	if (__LIB_0__::func_264(&uLocal_19) > fLocal_22 && __LIB_7__::func_40(uParam0, iLocal_18, 0.995f))
	{
