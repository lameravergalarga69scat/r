...
{
	__LIB_2__::func_851(uParam0, 10800, 10851, 11489);
}

void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	__LIB_2__::func_853(uParam0, "DOG_CHASE_TAIL", "script@ambient@animal@dog_chase_tail@action", vParam1, vParam4);
	uParam0->f_16 = 1;
	__LIB_2__::func_854(uParam0, 1, "pbl_action", "", 0);
	__LIB_2__::func_855(uParam0, 0, "DOG", iLocal_9, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
}
...
int func_31(var uParam0)
{
	...
	if (!uParam0->f_469[0])
	{
		if (ANIMSCENE::_DOES_ANIM_SCENE_EXIST(uParam0->f_3.f_1))
		{
			...
			{
				if (__LIB_2__::func_908(uParam0, &uLocal_10, 1))
				{
					__LIB_2__::func_945(uParam0);
					if (!uParam0->f_469[5])
					{
