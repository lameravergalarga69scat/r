...
{
	PED::_0xDE7B2B4144906CDF(585448480, __LIB_6__::func_952(uParam0, iLocal_14));
	return true;
}
...
bool func_72(var uParam0)
{
	...
	{
		case 1:
			__LIB_7__::func_116(uParam0, -131.863f, -35.25f, 94.905f, 0f, 0f, 172.8f);
			break;
		case 2:
			__LIB_7__::func_116(uParam0, 661.739f, -1270.398f, 42.87f, 0f, 0f, -79.56f);
			break;
		case 3:
			__LIB_7__::func_116(uParam0, 1868.65f, -1857.04f, 42f, 0f, 0f, -74.52f);
			break;
		case 6:
			__LIB_7__::func_116(uParam0, 2366.237f, 1362.755f, 105.113f, 0f, 0f, 44.64f);
			break;
		default:
			return false;
	}
	iLocal_14 = __LIB_7__::func_48(uParam0, 20, 0);
	__LIB_7__::func_47(uParam0, 0f, 0f, 0.6f, 0f, 2f, 2f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_KAREN"), 1, 1, 1);
	iLocal_17 = __LIB_6__::func_958(uParam0, joaat("P_BOTTLEJD01X"), 0f, 0f, 0f, "BOTTLE", 0, 0, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@karen_4@base", 1, 1, 0, 0);
	iLocal_15 = __LIB_6__::func_959(uParam0, "script@vignette@karen_4@action", 2, 0, 1, 1);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@karen_4@exit", 0, 0, 0, 0);
	__LIB_7__::func_146(uParam0, "CKAR4AU");
	__LIB_7__::func_226(uParam0, iLocal_14, 1061142135 /* Float: 0.749f */);
	__LIB_7__::func_151(uParam0, iLocal_14, 2, -1);
	__LIB_7__::func_127(uParam0, iLocal_14, 3, joaat("WORLD_HUMAN_LEAN_BACK_WALL"), "WORLD_HUMAN_LEAN_WALL_DRINKING_FEMALE_B", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_171(uParam0, iLocal_14, 3, 0);
	Local_19 = { __LIB_7__::func_160(uParam0, 0f, 0f, 0.7f, 0f, 6f, 0.5f, 0.5f) };
...
{
	return __LIB_7__::func_236(uParam0, Local_19, 1, 0);
}
...
bool func_93(var uParam0)
{
	...
	if (!bLocal_18 && __LIB_7__::func_40(uParam0, iLocal_16, 0.985f))
	{
		PED::_0x3BBDD6143FF16F98(__LIB_6__::func_952(uParam0, iLocal_14), __LIB_7__::func_30(uParam0, iLocal_17), "p_bottleJD01x_ph_r_hand", "WORLD_HUMAN_LEAN_BACK_WALL", 0, 1);
		bLocal_18 = true;
	}
	if (bLocal_18)
	{
		PED::SET_PED_RESET_FLAG(__LIB_6__::func_952(uParam0, iLocal_14), 202, true);
	}
	return true;
}
