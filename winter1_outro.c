...
{
	return (ANIMSCENE::_IS_ANIM_SCENE_LOADED(uParam0->f_2, true, false) && HUD::_TEXT_DATABASE_HAS_LOADED("WNT2AUD"));
}
...
int func_21(var uParam0)
{
	...
	{
		if (ENTITY::DOES_ENTITY_EXIST(__LIB_0__::func_271(13)))
		{
			ANIMSCENE::SET_ANIM_SCENE_ENTITY(uParam0->f_2, __LIB_0__::func_731(__LIB_0__::func_271(13)), __LIB_0__::func_271(13), 0);
		}
