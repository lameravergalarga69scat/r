...
{
	func_9(uParam0);
	SCRIPTS::_0xE7282390542F570D(uLocal_42);
...
bool func_3(var uParam0)
{
	...
	if (Local_43 == 0)
	{
		...
		Local_43 = __LIB_7__::func_454(iVar0);
		return false;
	}
	if (__LIB_7__::func_497(Local_43, 4) || Global_40.f_8863.f_156)
	{
		func_1(uParam0);
		return false;
	}
...
void func_8(var uParam0)
{
	...
	switch (Local_24)
	{
		case 0:
			...
			Local_24.f_1 = __LIB_2__::func_954();
		...
		case 2:
			...
			if (func_53(&Local_24))
			{
				__LIB_1__::func_649(&Local_24, 5);
			}
			else if (ENTITY::IS_ENTITY_IN_VOLUME(Global_35, Local_24.f_12[1], true, 0))
			{
				__LIB_1__::func_649(&Local_24, 8);
			}
			break;
		case 7:
			MISC::_SET_WEATHER_TYPE(Local_24.f_1, false, false, true, 60f, false);
			if (__LIB_0__::func_1(Local_24.f_11, 1))
			{
				if (__LIB_0__::func_1(Local_24.f_11, 2))
				{
					AUDIO::_STOP_SOUND_WITH_NAME(func_54(1), func_54(0));
					__LIB_1__::func_993(&(Local_24.f_11), 2);
				}
				AUDIO::_0x531A78D6BF27014B(func_54(0));
				__LIB_1__::func_993(&(Local_24.f_11), 1);
			}
			__LIB_1__::func_148(&(Local_24.f_2));
			__LIB_1__::func_649(&Local_24, 8);
			break;
		case 8:
			if (!__LIB_7__::func_530(*uParam0))
			...
			{
				if (__LIB_0__::func_265(&(Local_24.f_2)) > 10f)
				{
					__LIB_1__::func_649(&Local_24, 9);
				}
			}
		...
		case 3:
			...
			__LIB_1__::func_148(&(Local_24.f_8));
			__LIB_1__::func_148(&(Local_24.f_2));
			__LIB_1__::func_649(&Local_24, 4);
			break;
		case 4:
			if (!__LIB_7__::func_530(*uParam0))
			{
			...
			if (!__LIB_0__::func_1(Local_24.f_11, 1))
			{
				...
				{
					__LIB_1__::func_581(&(Local_24.f_11), 1);
				}
			}
			else if (__LIB_0__::func_265(&(Local_24.f_8)) > 5f)
			{
				if (!__LIB_0__::func_1(Local_24.f_11, 2))
				{
					AUDIO::_PLAY_SOUND_FROM_POSITION(func_54(1), -2587.967f, -93.59087f, 167.5787f, func_54(0), false, 0, true, 0);
					__LIB_1__::func_581(&(Local_24.f_11), 2);
				}
			}
			break;
		case 5:
			__LIB_1__::func_148(&(Local_24.f_5));
			if (__LIB_0__::func_75(&(Local_24.f_2)))
			{
				__LIB_0__::func_37(&(Local_24.f_2));
			}
			MISC::_SET_WEATHER_TYPE(joaat("THUNDERSTORM"), false, true, true, 60f, false);
			__LIB_1__::func_148(&(Local_24.f_2));
			__LIB_1__::func_148(&uLocal_21);
			__LIB_1__::func_649(&Local_24, 6);
			break;
		case 6:
			if (!bLocal_20)
			{
				if (__LIB_0__::func_265(&uLocal_21) > 5f)
				{
					bLocal_20 = true;
					func_56();
				}
...
void func_9(var uParam0)
{
	...
	while (iVar0 <= 3)
	{
		__LIB_7__::func_458(&(Local_24.f_12[iVar0]));
		iVar0++;
	}
}
...
void func_37(bool bParam0, int iParam1)
{
	...
	if (!__LIB_0__::func_28() || func_63() != -1)
	{
		return;
	}
...
bool func_53(int iParam0)
{
	...
	{
		if (VOLUME::_IS_POSITION_INSIDE_VOLUME(iParam0->f_12[1], vVar11))
		{
			return true;
		}
	}
...
int func_189(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		__LIB_0__::func_524(&Var0, func_196(0));
	}
...
{
	return func_202(joaat("CHARACTER"), __LIB_0__::func_217(), -1591664384, bParam0);
}
