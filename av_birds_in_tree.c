...
{
	__LIB_2__::func_851(uParam0, 11287, 11345, 11808);
}

void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	__LIB_2__::func_853(uParam0, "BIRDS_IN_TREE", "", vParam1, vParam4);
	__LIB_2__::func_902(uParam0, 0, "BLS_BIRD_1", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0f, 0f, -1f), (0f + vParam4.z), 0, 1, 1, 1, joaat("META_OUTFIT_ANIMAL_SONGBIRDTANAGER"), 1);
	__LIB_2__::func_902(uParam0, 1, "BLS_BIRD_2", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, -0.5f, 0.5f, -1f), (135f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	__LIB_2__::func_902(uParam0, 2, "BLS_BIRD_3", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0.5f, 0.5f, -1f), (-45f + vParam4.z), 0, 1, 1, 1, joaat("META_OUTFIT_ANIMAL_SONGBIRDTANAGER"), 1);
	__LIB_2__::func_902(uParam0, 3, "BLS_BIRD_4", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0.5f, 0f, -1f), (45f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	__LIB_2__::func_902(uParam0, 4, "BLS_BIRD_5", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, -0.75f, 0f, -1f), (-100f + vParam4.z), 0, 1, 1, 1, joaat("META_OUTFIT_ANIMAL_SONGBIRDTANAGER"), 1);
	__LIB_2__::func_902(uParam0, 5, "BLS_BIRD_6", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, -0.45f, -0.5f, -1f), (-135f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	__LIB_2__::func_902(uParam0, 6, "BLS_BIRD_7", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, -0.5f, -0.25f, -1f), (-145f + vParam4.z), 0, 1, 1, 1, joaat("META_OUTFIT_ANIMAL_SONGBIRDTANAGER"), 1);
	__LIB_2__::func_902(uParam0, 7, "BLS_BIRD_8", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0.5f, -0.5f, -1f), (-15f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	__LIB_2__::func_902(uParam0, 8, "BLS_BIRD_9", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0.5f, -0.5f, -1f), (-45f + vParam4.z), 0, 1, 1, 1, joaat("META_OUTFIT_ANIMAL_SONGBIRDTANAGER"), 1);
	__LIB_2__::func_902(uParam0, 9, "BLS_BIRD_10", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0f, -0.75f, -1f), (50f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	__LIB_2__::func_902(uParam0, 10, "BLS_BIRD_11", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0f, 0.5f, -1f), (0f + vParam4.z), 0, 1, 1, 1, joaat("META_OUTFIT_ANIMAL_SONGBIRDTANAGER"), 1);
	__LIB_2__::func_902(uParam0, 11, "BLS_BIRD_12", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, -0.75f, 0.5f, -1f), (35f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
}
...
int func_31(var uParam0)
{
	...
	if (!uParam0->f_469[1])
	{
		if (__LIB_2__::func_908(uParam0, &uLocal_11, 0))
		{
			__LIB_2__::func_993(uParam0);
			uParam0->f_469[1] = 1;
		}
	...
	switch (iLocal_10)
	{
		...
		case 2:
			...
			break;
		case 3:
			if (__LIB_1__::func_285(&uLocal_39, 7f))
			{
				return 1;
			}
			break;
