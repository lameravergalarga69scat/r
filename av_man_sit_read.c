...
{
	__LIB_2__::func_851(uParam0, 10772, 10844, 11400);
}
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	int iVar0;
	int iVar1;
	__LIB_2__::func_853(uParam0, "MAN_SIT_READ", "", vParam1, vParam4);
	iVar0 = __LIB_2__::func_900(__LIB_1__::func_898(), 1, 0, 1, 0, 0, 1);
	iVar1 = __LIB_2__::func_44(joaat("HORSE_CLASS_RIDING"), 1);
	__LIB_2__::func_902(uParam0, 0, "MSRP_HORSE", iVar1, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 2f, 2.2f, 0f), (60f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	__LIB_2__::func_902(uParam0, 1, "MSRP_MAN", iVar0, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0f, 0f, 0f), vParam4.z, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
}
...
int func_30(var uParam0)
{
	...
	__LIB_2__::func_903(&uLocal_10, 1);
	return 1;
}
...
int func_31(var uParam0)
{
	if (!uParam0->f_469[0])
	{
		if (__LIB_2__::func_989(uParam0, &uLocal_10, 0))
		{
	...
	if (!bLocal_40)
	{
		iLocal_41 = __LIB_2__::func_954();
		if (__LIB_2__::func_988(4) || __LIB_7__::func_893(iLocal_41))
		{
	...
	switch (iLocal_9)
	{
		case 0:
			...
			{
				__LIB_0__::func_634(&(uParam0->f_20[1 /*14*/].f_5), 1, 10, 0);
				PED::_0x931B241409216C1F(uParam0->f_20[1 /*14*/], uParam0->f_20[0 /*14*/], 0);
				PED::_0xED1C764997A86D5A(uParam0->f_20[1 /*14*/], uParam0->f_20[0 /*14*/]);
				__LIB_2__::func_967(&uLocal_10, uParam0->f_20[1 /*14*/], uParam0->f_20[0 /*14*/], 0);
				__LIB_2__::func_915(uParam0->f_20[1 /*14*/], joaat("WORLD_HUMAN_SIT_GROUND_READING_BOOK_STOW"), uParam0->f_20[1 /*14*/].f_5, uParam0->f_20[1 /*14*/].f_8, 0, 0, 1, 0, -1082130432 /* Float: -1f */);
			...
			{
				__LIB_0__::func_634(&(uParam0->f_20[0 /*14*/].f_5), 1, 10, 0);
				TASK::TASK_START_SCENARIO_AT_POSITION(uParam0->f_20[0 /*14*/], joaat("WORLD_ANIMAL_HORSE_GRAZING"), uParam0->f_20[0 /*14*/].f_5, uParam0->f_20[0 /*14*/].f_8, 0, false, true, 0, -1f, false);
			...
			break;
		case 1:
			if (__LIB_2__::func_975(uParam0, uParam0->f_493, uParam0->f_494, 4, uParam0->f_495, 1112014848 /* Float: 50f */))
			{
				__LIB_2__::func_974(uParam0);
				iLocal_9 = 2;
			}
