...
void __EntryFunction__()
{
	...
	fLocal_7 = 1f;
	fLocal_8 = 1f;
	iLocal_17 = joaat("W_REPEATER_CARBINE01");
	Var0 = -1;
	Var0.f_1 = -1;
	Var0.f_2 = -1;
	Var0.f_17 = 10;
...
bool func_72(var uParam0)
{
	...
	__LIB_7__::func_48(uParam0, 19, 0);
	__LIB_7__::func_47(uParam0, 3.6829f, -3.9259f, 1f, -88.92f, 1.5f, 1.5f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_MICAH"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, 0.0376f, -0.1f, 1f, -88.92f, 3.2f, 1.5f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_GRIMSHAW"), 1, 1, 1);
	__LIB_6__::func_958(uParam0, joaat("P_CIGARETTE_CS02X"), 0f, 0f, 0f, "CIGARETTE", 0, 1, 1);
	__LIB_6__::func_958(uParam0, joaat("P_CS_RAG01X"), 0f, 0f, 0f, "RAG", 0, 0, 1);
	STREAMING::REQUEST_MODEL(iLocal_17, false);
	__LIB_6__::func_959(uParam0, "script@vignette@micah_24@base", 1, 1, 0, 0);
	iLocal_15 = __LIB_6__::func_959(uParam0, "script@vignette@micah_24@action", 2, 0, 1, 0);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@micah_24@exit", 0, 0, 0, 0);
	__LIB_7__::func_146(uParam0, "CCM24AU");
...
{
	return STREAMING::HAS_MODEL_LOADED(iLocal_17);
}
...
{
	iLocal_18 = WEAPON::_CREATE_WEAPON_OBJECT(joaat("WEAPON_REPEATER_CARBINE"), 1, uParam0->f_23, true, 1f);
	return true;
}

bool func_87(var uParam0)
{
	if (!bLocal_19 && ENTITY::DOES_ENTITY_EXIST(iLocal_18))
	{
		__LIB_7__::func_346(uParam0, iLocal_18, "rifle");
		bLocal_19 = true;
		return false;
	}
	return true;
	...
	switch (Global_1360165[iParam0 /*1157*/].f_11)
	{
		...
		case 3:
			if (!ENTITY::IS_ENTITY_DEAD(Global_1360165[iParam0 /*1157*/]) && !ANIMSCENE::_0x3AB6C7B0BB0DF4B1(Global_1360165[iParam0 /*1157*/], -1))
			{
				...
				func_387(Global_1360165[iParam0 /*1157*/], vVar0, iParam6, 2, 1073741824 /* Float: 2f */);
			}
			else if (bParam16)
			{
	...
	switch (Global_1360165[iParam0 /*1157*/].f_70.f_12)
	{
		...
		case 3:
			...
			if ((bParam2 && !__LIB_0__::func_86(vVar0)) && !__LIB_0__::func_175(vVar0, ENTITY::GET_ENTITY_COORDS(Global_1360165[iParam0 /*1157*/].f_124, true, false), 1056964608 /* Float: 0.5f */, 1))
			{
				...
				func_387(Global_1360165[iParam0 /*1157*/].f_124, vVar0, iParam6, 2, 1073741824 /* Float: 2f */);
			}
			if (bParam1)
			{
