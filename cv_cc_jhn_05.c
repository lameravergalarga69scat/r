...
bool func_72(var uParam0)
{
	...
	{
		case 1:
			__LIB_7__::func_45(uParam0, 172, 0, 0, 0);
			break;
	}
	iLocal_14 = __LIB_7__::func_48(uParam0, 1, "JohnMarston");
	iLocal_15 = __LIB_7__::func_48(uParam0, 5, "HoseaMatthews");
	__LIB_7__::func_47(uParam0, -0.225f, -0.0125f, 0.85f, 0f, 4.4575f, 3.4825f, 3.2075f, joaat("VOLBOX"), joaat("APMS_COMP_JOHN"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, 7.215f, 7.4175f, 0.85f, -65.75f, 1f, 1f, 3.2075f, joaat("VOLBOX"), joaat("APMS_COMP_HOSEA"), 1, 1, 1);
	iLocal_16 = __LIB_6__::func_958(uParam0, joaat("P_CS_BOOK04X"), 0f, 0f, 0f, "p_cs_book02x", 0, 0, 1);
	if (!__LIB_6__::func_206(10))
	{
		__LIB_6__::func_959(uParam0, "script@vignette@john_5@base", 1, 1, 0, 0);
	}
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@john_5@Action_A", 2, 0, 1, 0);
	iLocal_18 = __LIB_6__::func_959(uParam0, "script@vignette@john_5@Action_A_Int_Front", 2, 0, 0, 1);
	iLocal_19 = __LIB_6__::func_959(uParam0, "script@vignette@john_5@Action_A_Int_Left", 2, 0, 0, 1);
	iLocal_20 = __LIB_6__::func_959(uParam0, "script@vignette@john_5@Action_A_Int_Right", 2, 0, 0, 1);
	iLocal_21 = __LIB_6__::func_959(uParam0, "script@vignette@john_5@Action_B", 0, 0, 0, 0);
	__LIB_7__::func_146(uParam0, "CCJN5AU");
	__LIB_7__::func_127(uParam0, iLocal_14, 3, joaat("PROP_HUMAN_SEAT_CHAIR_READING"), "PROP_HUMAN_SEAT_CHAIR_READING_MALE_A", -1, 0, 45f, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_139(uParam0, iLocal_14, iLocal_16, "p_cs_book04x_PH_R_HAND", 0, 0);
	__LIB_7__::func_127(uParam0, iLocal_15, 3, joaat("WORLD_HUMAN_SMOKE"), "WORLD_HUMAN_SMOKE_MALE_A", -1, 1, 30f, 1065353216 /* Float: 1f */, 1);
	func_158(uParam0, iLocal_15, 3, 0);
	__LIB_7__::func_149(uParam0, joaat("COMP_JHNCNV5"), joaat("PLAYER_JHNCNV5"));
	__LIB_7__::func_151(uParam0, iLocal_14, 1, -1);
	__LIB_7__::func_151(uParam0, iLocal_15, 1, -1);
	Local_22 = { __LIB_7__::func_160(uParam0, 0.2525f, 0.2975f, 1.4354f, 141.75f, 7f, 0.1475f, 0.54f) };
	Local_32 = { __LIB_7__::func_160(uParam0, 0.253f, 0.2775f, 1.4354f, -168.82f, 6.9775f, 0.33f, 0.4025f) };
	Local_42 = { __LIB_7__::func_160(uParam0, 0.253f, 0.278f, 1.4354f, 56.92f, 7f, 0.4f, 0.22f) };
	if (__LIB_6__::func_206(10))
	{
		__LIB_7__::func_167(uParam0);
		__LIB_7__::func_280(uParam0, iLocal_14, 1);
		__LIB_7__::func_303(uParam0, iLocal_15, 4, joaat("STAND"), 0, -1, 0);
		__LIB_7__::func_233(uParam0, iLocal_15, -136.664f, -49.042f, 94.214f, 138.234f, 0, 0);
...
void func_158(var uParam0, int iParam1, int iParam2, int iParam3)
{
	...
	switch (iParam2)
	{
		case 4:
			...
			break;
		default:
			Var0 = { func_265(__LIB_0__::func_78(uParam0), __LIB_7__::func_120(uParam0, iParam1), __LIB_4__::func_576(uParam0), 1) };
