...
bool func_72(var uParam0)
{
	...
	{
		case 3:
			__LIB_7__::func_45(uParam0, 227, 0, 0, 0);
			break;
		default:
			return true;
	}
	...
	__LIB_6__::func_958(uParam0, joaat("P_WOODWHITTLE01X"), 0f, 0f, 0f, "WOOD", 0, 1, 1);
	__LIB_6__::func_958(uParam0, joaat("P_CRATE15X"), 0f, 0f, 0f, "CRATE", 0, 0, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@sadie_1@base", 1, 1, 0, 0);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@sadie_1@action_a", 2, 0, 1, 0);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@sadie_1@action_b", 2, 0, 0, 0);
	iLocal_18 = __LIB_6__::func_959(uParam0, "script@vignette@sadie_1@action_b_alt", 2, 0, 0, 1);
	iLocal_19 = __LIB_6__::func_959(uParam0, "script@vignette@sadie_1@exit", 0, 0, 0, 0);
	__LIB_7__::func_146(uParam0, "CSA1AUD");
	__LIB_7__::func_149(uParam0, joaat("COMP_SADCNV1"), joaat("PLAYER_SADCNV1"));
	__LIB_7__::func_143(uParam0, iLocal_14, -138.4f, 0);
	__LIB_7__::func_151(uParam0, iLocal_15, 1, -1);
	Local_20 = { __LIB_7__::func_160(uParam0, 2.3575f, 0.5175f, 1.099f, -155.25f, 6.06f, 0.77f, 0.4875f) };
	return true;
}
