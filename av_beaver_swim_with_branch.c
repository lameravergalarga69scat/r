...
{
	__LIB_2__::func_851(uParam0, 10784, 10856, 11614);
}

void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	__LIB_2__::func_853(uParam0, "BEAVER_SWIM_WITH_BRANCH", "script@ambient@animal@beaver_swim_with_branch@action", vParam1, vParam4);
	__LIB_2__::func_854(uParam0, 1, "pbl_action", "", 0);
	__LIB_2__::func_905(uParam0, 0, "beaver", iLocal_9, vParam1, vParam4.z, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
...
int func_31(var uParam0)
{
	...
	if (!uParam0->f_469[0])
	{
		if (!bLocal_38 == 1)
		{
			if (__LIB_2__::func_908(uParam0, &uLocal_10, 1) || __LIB_0__::func_232(Global_35, uParam0->f_20[0 /*14*/], 1) <= 64f)
			{
				bLocal_38 = true;
			}
		}
	...
	if (uParam0->f_469[0])
	{
		if (__LIB_1__::func_285(&uLocal_39, 2f))
		{
	...
	if (!uParam0->f_469[0])
	{
					...
					if (ANIMSCENE::_DOES_ANIM_SCENE_EXIST(uParam0->f_3.f_1))
					{
						if (ANIMSCENE::_IS_ANIM_SCENE_LOADED(uParam0->f_3.f_1, true, false))
						{
							if (ANIMSCENE::_0x1F0E401031E20146(uParam0->f_3.f_1, "pbl_action"))
							{
								...
								ENTITY::ATTACH_ENTITY_TO_ENTITY(uParam0->f_372[0 /*8*/], uParam0->f_20[0 /*14*/], PED::GET_PED_BONE_INDEX(uParam0->f_20[0 /*14*/], 61276), vVar0, vVar3, true, false, false, false, 2, true, true, false);
		...
		if (uParam0->f_469[2])
		{
			if (!uParam0->f_469[4])
			{
				if (__LIB_2__::func_889(uParam0, 0.5f, 40f, 4, joaat("ACTION"), 1))
				{
					__LIB_2__::func_890(*uParam0, uParam0->f_483, 0);
					uParam0->f_469[4] = 1;
				}
