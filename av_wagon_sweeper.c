...
bool func_3(var uParam0)
{
	...
	switch (uParam0->f_464)
	{
		...
		case 2:
			...
			break;
		case 3:
			if (__LIB_2__::func_996(uParam0) && func_18(uParam0))
			{
				uParam0->f_464 = 5;
			}
			else
...
{
	__LIB_2__::func_851(uParam0, 10949, 11007, 11697);
}
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	switch (uParam0->f_489)
	{
		case 0:
			...
			break;
		case 1:
			iVar0 = __LIB_2__::func_997(__LIB_0__::func_12());
			break;
		case 2:
			iVar0 = joaat("A_M_M_RHDTOWNFOLK_01");
			break;
	}
	__LIB_2__::func_853(uParam0, "WAGON_SWEEPER", "script@ambient@town@wagon_sweeper@action", vParam1, vParam4);
	__LIB_2__::func_854(uParam0, 1, "pbl_action", "", 0);
	__LIB_2__::func_855(uParam0, 0, "male", iVar0, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	__LIB_2__::func_928(uParam0, 0, "Broom", joaat("P_BROOM02X"), 0f, 0f, 0f, 0f, 1);
}
...
int func_31(var uParam0)
{
	...
	if (!uParam0->f_469[2])
	{
		if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
		{
			if (__LIB_2__::func_892(uParam0, 1065353216 /* Float: 1f */, 55f, 4, 15f, 1112014848 /* Float: 50f */))
			{
	...
	if (uParam0->f_469[2])
	{
		if (!uParam0->f_469[6])
		{
			if (__LIB_2__::func_889(uParam0, 1065353216 /* Float: 1f */, 1116471296 /* Float: 70f */, 4, joaat("ACTION"), 1))
			{
				__LIB_2__::func_890(*uParam0, uParam0->f_483, 0);
				uParam0->f_469[6] = 1;
			}
			...
			if (ANIMSCENE::_DOES_ANIM_SCENE_EXIST(uParam0->f_3.f_1))
			{
				if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
				{
					if (ANIMSCENE::_0x005E6F28DD7ED58D(uParam0->f_3.f_1, uParam0->f_20[0 /*14*/].f_1))
					{
						...
						if (TASK::DOES_SCENARIO_EXIST_IN_AREA(vVar0, 0.5f, true, 0, false) && !TASK::_0xEA31F199A73801D3(TASK::_FIND_CLOSEST_ACTIVE_SCENARIO_POINT_OF_TYPE(vVar0, joaat("WORLD_HUMAN_BROOM_PUTDOWN"), 0.5f, 0, false)))
						{
							TASK::_TASK_USE_NEAREST_SCENARIO_TO_COORD(uParam0->f_20[0 /*14*/], vVar0, 0.5f, 1000, false, false, false, false);
						}
						else
						{
...
int func_32(var uParam0, var uParam1)
{
	...
	__LIB_2__::func_858(uParam0, 1, 1, 1);
	return 1;
}
...
Vector3 func_73(var uParam0)
{
	...
	{
		if (!__LIB_0__::func_86(vVar4[iVar14 /*3*/]))
		{
