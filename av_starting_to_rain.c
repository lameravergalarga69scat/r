...
{
	__LIB_2__::func_851(uParam0, 10977, 11086, 11403);
}
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	{
		case 21:
			__LIB_2__::func_853(uParam0, "AV_STARTING_TO_RAIN_FEMALE", "script@ambient@generic@startingtorain@female01", vParam1, vParam4);
			iVar0 = __LIB_2__::func_992(__LIB_1__::func_898());
			break;
		case 22:
			__LIB_2__::func_853(uParam0, "AV_STARTING_TO_RAIN_MALE", "script@ambient@generic@startingtorain@male01", vParam1, vParam4);
...
bool func_28(var uParam0)
{
	if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
	{
		...
		if (TASK::_0x02EBBB3989B7E695(uParam0->f_20[0 /*14*/]) && __LIB_2__::func_920(uParam0, 1065353216 /* Float: 1f */, 40f, 4, 15f, 15f))
		{
...
int func_31(var uParam0)
{
	...
	if (!uParam0->f_469[3])
	{
		if (!uParam0->f_469[4])
		{
			if (__LIB_2__::func_889(uParam0, fLocal_39, 1116471296 /* Float: 70f */, 4, joaat("ACTION"), 1))
			{
				__LIB_2__::func_890(*uParam0, uParam0->f_483, 1);
				uParam0->f_469[4] = 1;
			}
