...
{
	__LIB_2__::func_851(uParam0, 10833, 10897, 11352);
}

void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	__LIB_2__::func_853(uParam0, "SCAVENGER_ON_ANIMAL", "", vParam1, vParam4);
	switch (*uParam0)
	{
		case 208:
	...
	__LIB_2__::func_902(uParam0, 1, "SOAP_BIRD_1", iLocal_10, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0.25f, -1f, 0f), vParam4.z, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	__LIB_2__::func_902(uParam0, 0, "SOAP_ANIMAL_1", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0f, 0f, 0f), vParam4.z, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
}
