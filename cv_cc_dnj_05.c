...
bool func_72(var uParam0)
{
	...
	{
		case 6:
			__LIB_7__::func_45(uParam0, 5, 0, 0, 0);
			break;
		default:
			return false;
	}
	...
	__LIB_7__::func_47(uParam0, -1.04f, -1.28f, 0.4194f, 0f, 3f, 3.84f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_DUTCH"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, -4.131f, -7.1027f, 0.1523f, 0f, 1.2f, 1.2f, 4f, joaat("VOLBOX"), joaat("APMS_COMP_JOHN"), 1, 1, 1);
	iLocal_32 = __LIB_7__::func_159(uParam0, -1.68f, -1.44f, 0.9987f, 0f, 1f, 1f, 2f, joaat("VOLCYLINDER"), 1);
	iLocal_16 = __LIB_6__::func_958(uParam0, joaat("P_CS_BOOKEVELYNMILLER"), 0f, 0f, 0f, "BOOK", 0, 1, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@dutch_and_john_5@base", 1, 1, 0, 0);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@dutch_and_john_5@action_a", 2, 0, 1, 0);
	iLocal_18 = __LIB_6__::func_959(uParam0, "script@vignette@dutch_and_john_5@action_a_int", 2, 0, 0, 1);
	iLocal_19 = __LIB_6__::func_959(uParam0, "script@vignette@dutch_and_john_5@action_b", 2, 0, 0, 0);
	iLocal_20 = __LIB_6__::func_959(uParam0, "script@vignette@dutch_and_john_5@action_c", 0, 0, 0, 0);
	iLocal_21 = __LIB_6__::func_959(uParam0, "script@vignette@dutch_and_john_5@action_c_alt", 0, 0, 0, 1);
	__LIB_7__::func_146(uParam0, "CDNJ5AU");
	...
	__LIB_7__::func_147(uParam0, iLocal_14, 2, 4, 0, 0, 0);
	__LIB_7__::func_151(uParam0, iLocal_14, 1, -1);
	__LIB_7__::func_150(uParam0, iLocal_21, iLocal_14, 0.35f);
	__LIB_7__::func_147(uParam0, iLocal_15, 2, 4, 0, 0, 0);
	__LIB_7__::func_151(uParam0, iLocal_15, 1, -1);
	__LIB_7__::func_232(uParam0, iLocal_15, 1.2f, 1065353216 /* Float: 1f */, 5f);
	Local_22 = { __LIB_7__::func_160(uParam0, -1.6682f, -0.3787f, 0.9199f, 180f, 7.5f, 0.4f, 0.4f) };
	__LIB_7__::func_149(uParam0, joaat("COMP_DNJCNV5"), joaat("PLAYER_DNJCNV5"));
	return true;
}
...
bool func_93(var uParam0)
{
	...
	{
		__LIB_6__::func_985(uParam0, iLocal_32, 0);
		if (__LIB_7__::func_163(uParam0, Local_22, 1, 0))
		{
	...
	if (__LIB_6__::func_943(__LIB_4__::func_576(uParam0)) && __LIB_7__::func_40(uParam0, iLocal_21, 0.35f))
	{
		__LIB_6__::func_944();
		__LIB_7__::func_5(uParam0, "Unreserved the player early for ILO", 1, -1);
	}
	return true;
}
