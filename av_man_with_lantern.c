...
{
	__LIB_2__::func_851(uParam0, 10767, 10825, 11244);
}
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	int iVar1;
	float fVar2;
	__LIB_2__::func_853(uParam0, "MAN_WITH_LANTERN", "", vParam1, vParam4);
	iVar0 = __LIB_2__::func_900(__LIB_1__::func_898(), 1, 1, 1, 1, 0, 1);
	iVar1 = __LIB_2__::func_44(joaat("HORSE_CLASS_RIDING"), 1);
	fVar2 = __LIB_2__::func_990(vParam1);
	__LIB_2__::func_855(uParam0, 0, "MWLP_MAN", iVar0, vParam1, fVar2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	__LIB_2__::func_855(uParam0, 1, "MWLP_HORSE", iVar1, vParam1, fVar2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	__LIB_2__::func_928(uParam0, 0, "MWLO_LANTERN", joaat("S_INTERACT_LANTERN02X"), vParam1, 0f, 0);
}
