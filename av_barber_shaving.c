...
{
	__LIB_2__::func_851(uParam0, 10897, 10948, 11591);
}
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	int iVar0;
	int iVar1;
	iLocal_38 = func_47(__LIB_1__::func_898());
	if (!__LIB_2__::func_767(iLocal_38, 1))
	{
		uParam0->f_499 = 1;
		return;
	}
	...
	iVar1 = func_50();
	__LIB_2__::func_853(uParam0, "BARBER_SHAVING", "script@ambient@town@barber_shave@action", vParam1, vParam4);
	__LIB_2__::func_854(uParam0, 1, "pl_action", "", 0);
	__LIB_2__::func_905(uParam0, 0, "BARBER", iVar1, vParam1, vParam4.z, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	__LIB_2__::func_905(uParam0, 1, "CUSTOMER", iVar0, vParam1, vParam4.z, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	__LIB_2__::func_928(uParam0, 0, "RAZOR", joaat("P_STRAIGHTRAZOR01X"), 0f, 0f, 0f, 0f, 1);
}
...
int func_18(var uParam0)
{
	...
	{
		if (!ENTITY::IS_ENTITY_DEAD(__LIB_2__::func_963(iLocal_38)))
		{
			uParam0->f_20[0 /*14*/] = __LIB_2__::func_965(iLocal_38, 0, 0, 1, 1, 1);
		}
		else
		{
			__LIB_2__::func_935(iLocal_38, 0, 0, 0, 0, 0);
		}
		return 0;
	}
	if (!__LIB_2__::func_931(8, 524288))
	{
		__LIB_2__::func_932(8, 524288);
		bLocal_37 = true;
	}
	return 1;
}
...
int func_31(var uParam0)
{
	...
	if (!uParam0->f_469[0])
	{
		...
		while (iVar1 < 2)
		{
			...
			{
				if (__LIB_2__::func_904(uParam0->f_20[iVar1 /*14*/], 0, &uLocal_9, &uVar0, 0, 0))
				{
					__LIB_2__::func_948(uParam0);
					if (!uParam0->f_469[2])
					{
				...
				if (!uParam0->f_469[1])
				{
					if (__LIB_2__::func_892(uParam0, 2f, 15f, 4, 5f, 1112014848 /* Float: 50f */))
					{
						__LIB_2__::func_948(uParam0);
				...
				if (uParam0->f_469[1])
				{
					if (!uParam0->f_469[2])
					{
						if (__LIB_2__::func_889(uParam0, 1f, 15f, 4, joaat("ACTION"), 0))
						{
							__LIB_2__::func_890(*uParam0, uParam0->f_483, 1);
							uParam0->f_469[2] = 1;
						}
				...
				if (uParam0->f_469[1])
				{
					if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_20[0 /*14*/]))
					{
						if (ANIMSCENE::_0x005E6F28DD7ED58D(uParam0->f_3.f_1, uParam0->f_20[0 /*14*/].f_1))
						{
							...
							if (iLocal_38 != -1)
							{
								if (__LIB_0__::func_122(iLocal_38))
								{
