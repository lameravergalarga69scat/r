...
bool func_72(var uParam0)
{
	...
	{
		case 1:
			__LIB_7__::func_116(uParam0, -107.733f, -42.169f, 94.652f, -0.541f, 1.972f, -23.429f);
			break;
		case 2:
			__LIB_7__::func_45(uParam0, 76, 0, 0, 0);
			break;
		case 3:
			__LIB_7__::func_45(uParam0, 199, 0, 0, 0);
			break;
		default:
			return false;
	}
	...
	__LIB_7__::func_47(uParam0, -4.6948f, -6.0379f, 0.5953f, 0f, 1.5f, 1.5f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_JACK"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, -0.6181f, -4.9017f, 1.0264f, 0f, 2f, 2.5f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_JOHN"), 1, 1, 1);
	__LIB_6__::func_958(uParam0, joaat("P_HAMMER02X"), 0f, 0f, 0f, "HAMMER", 0, 0, 1);
	__LIB_6__::func_958(uParam0, joaat("P_NAILSINGLE01X"), 0f, 0f, 0f, "NAIL", 0, 0, 1);
	__LIB_6__::func_958(uParam0, joaat("P_NAILBOX01X"), 0f, 0f, 0f, "NAILBOX", 0, 0, 1);
	__LIB_6__::func_958(uParam0, joaat("P_STICKFIREPOKER01X"), 0f, 0f, 0f, "STICK", 0, 0, 1);
	if (__LIB_0__::func_78(uParam0) == 1)
	{
		__LIB_6__::func_958(uParam0, joaat("P_NAILSINGLE01X"), 0f, 0f, 0f, "NAIL1", 0, 0, 1);
		__LIB_6__::func_958(uParam0, joaat("P_NAILSINGLE01X"), 0f, 0f, 0f, "NAIL2", 0, 0, 1);
		__LIB_6__::func_959(uParam0, "script@vignette@jack_1@hso@base", 1, 1, 0, 0);
		iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@jack_1@hso@action_a", 2, 0, 1, 0);
		iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@jack_1@hso@action_b_alt_left", 2, 0, 0, 1);
		iLocal_18 = __LIB_6__::func_959(uParam0, "script@vignette@jack_1@hso@action_b_alt_right", 2, 0, 0, 1);
	}
	else
	{
		__LIB_6__::func_959(uParam0, "script@vignette@jack_1@base", 1, 1, 0, 0);
		iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@jack_1@action_a", 2, 0, 1, 0);
		iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@jack_1@action_b_alt_left", 2, 0, 0, 1);
		iLocal_18 = __LIB_6__::func_959(uParam0, "script@vignette@jack_1@action_b_alt_right", 2, 0, 0, 1);
	}
	iLocal_19 = __LIB_6__::func_959(uParam0, "script@vignette@jack_1@exit", 64, 0, 0, 0);
	__LIB_7__::func_146(uParam0, "CJCK1AU");
	__LIB_7__::func_147(uParam0, iLocal_14, 1, 6, 0, 0, 0);
	Local_20 = { __LIB_7__::func_160(uParam0, -0.5328f, -4.6082f, 1.0467f, 115.92f, 7f, 0.5f, 0.5f) };
	Local_30 = { __LIB_7__::func_160(uParam0, -0.533f, -4.608f, 1.047f, -100.44f, 7f, 0.3f, 0.3f) };
	return true;
}
...
bool func_93(var uParam0)
{
	if (__LIB_7__::func_148(uParam0, iLocal_16))
	{
		...
		{
			__LIB_7__::func_147(uParam0, iLocal_15, 2, 4, 0, 0, 0);
			__LIB_7__::func_151(uParam0, iLocal_15, 2, -1);
			PLAYER::_0x3946FC742AC305CD(PLAYER::GET_PLAYER_INDEX(), __LIB_6__::func_952(uParam0, iLocal_15), "CCJCK_CNV_1", 0f, 0f, 0f, 0, 0);
...
bool func_96(var uParam0)
{
	if (__LIB_0__::func_78(uParam0) == 1)
	{
		if (!TASK::_IS_SCENARIO_GROUP_ENABLED_HASH(570969137))
		{
			...
			{
				if (__LIB_0__::func_75(&uLocal_40))
				{
					__LIB_0__::func_37(&uLocal_40);
				}
			}
			else if (!__LIB_0__::func_75(&uLocal_40))
			{
				__LIB_0__::func_268(&uLocal_40, 0f);
			}
			if (__LIB_0__::func_264(&uLocal_40) >= 3f)
			{
