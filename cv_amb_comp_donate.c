...
{
	__LIB_7__::func_423(7, MISC::GET_RANDOM_INT_IN_RANGE(10, 31) * 10);
	return true;
}
...
bool func_7(var uParam0)
{
	...
	switch (__LIB_6__::func_949(uParam0))
	{
		...
		case 3:
			...
			{
				if (__LIB_17__::func_986(uParam0))
				{
...
bool func_76(var uParam0)
{
	...
	iLocal_14 = __LIB_6__::func_959(uParam0, "script@ambient@generic@companion_donate@donate_coins@male_a@action", 0, 1, 0, 0);
	iLocal_16 = __LIB_6__::func_958(uParam0, joaat("S_LOOTABLECAMPCASE"), 0f, 0f, 0f, "CASE", 1, 0, 1);
	__LIB_6__::func_958(uParam0, joaat("P_COIN01X"), 0f, 0f, 0f, "COIN01", 0, 1, 1);
	__LIB_6__::func_958(uParam0, joaat("P_COIN02X"), 0f, 0f, 0f, "COIN02", 0, 1, 1);
	__LIB_7__::func_46(uParam0, 0.5875f, -0.3f, 0f, -16.25f, 0.75f, 0.75f, 3f, joaat("VOLCYLINDER"), 1);
	__LIB_7__::func_47(uParam0, 0.7f, -0.375f, 0f, 64.5f, 1.0225f, 1.775f, 5f, joaat("VOLBOX"), -1, 1, 1, 1);
	iLocal_15 = __LIB_7__::func_32(uParam0, iLocal_14, "PL_ACTION", 1);
