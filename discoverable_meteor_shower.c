...
bool func_3(var uParam0)
{
	...
	if (Local_24 == 0)
	{
		...
		Local_24 = __LIB_7__::func_454(iVar0);
		return false;
	}
	if (__LIB_7__::func_497(Local_24, 4) || Global_40.f_8863.f_156)
	{
		func_1(uParam0);
		return false;
	}
...
void func_8(var uParam0)
{
	...
	switch (Local_14)
	{
		case 0:
			...
			while (iVar2 <= 0)
			{
				if (!__LIB_7__::func_574(&(Local_14.f_5[iVar2]), func_53(iVar2)))
				{
					return;
				}
				iVar2++;
			...
			break;
		case 1:
			if (!__LIB_1__::func_205(Global_35, Local_14.f_5[0], 1, 0))
			{
				return;
			}
			if (!__LIB_0__::func_252(iVar1, 2, 4))
			{
				return;
			}
		...
		case 3:
			...
			__LIB_1__::func_148(&(Local_14.f_1));
			__LIB_1__::func_649(&Local_14, 4);
			break;
		case 4:
			if (__LIB_0__::func_265(&(Local_14.f_1)) > 60f)
			{
...
void func_9(var uParam0)
{
	...
	while (iVar0 <= 0)
	{
		__LIB_7__::func_458(&(Local_14.f_5[iVar0]));
		iVar0++;
	}
...
void func_36(var uParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		iVar0 = __LIB_7__::func_463(*uParam0, func_89(), uParam0->f_4);
	}
	else
	{
...
void func_37(bool bParam0, int iParam1)
{
	...
	if (!__LIB_0__::func_28() || func_67() != -1)
	{
		return;
	}
...
int func_192(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		__LIB_0__::func_524(&Var0, func_199(0));
	}
...
{
	return func_205(joaat("CHARACTER"), __LIB_0__::func_217(), -1591664384, bParam0);
}
