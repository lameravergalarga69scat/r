...
bool func_77(var uParam0)
{
	...
	{
		case 3:
			__LIB_7__::func_45(uParam0, 195, 0, 0, 0);
			break;
		default:
			return false;
	}
	iLocal_92 = __LIB_7__::func_48(uParam0, 0, 0);
	iLocal_93 = __LIB_7__::func_48(uParam0, 1, 0);
	__LIB_7__::func_47(uParam0, -0.32f, -0.16f, 0.95f, 0f, 0.8f, 0.8f, 1f, joaat("VOLBOX"), joaat("APMS_COMP_DUTCH"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, 1.34f, -9.37f, 0.52f, 0f, 0.8f, 0.8f, 1f, joaat("VOLBOX"), joaat("APMS_COMP_JOHN"), 1, 1, 1);
	iLocal_96 = __LIB_6__::func_958(uParam0, joaat("P_CS_BOOKEVELYNMILLER"), -0.53f, -0.29f, 0.7f, "BOOK", 0, 0, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@dutch_and_john_7@base", 1, 1, 0, 0);
	iLocal_94 = __LIB_6__::func_959(uParam0, "script@vignette@dutch_and_john_7@action_a", 0, 0, 1, 0);
	iLocal_95 = __LIB_6__::func_959(uParam0, "script@vignette@dutch_and_john_7@action_b_wnt", 0, 0, 0, 1);
	Local_97 = { __LIB_7__::func_160(uParam0, -3.303f, -3.6f, 0.75f, 80f, 8f, 0.875f, 1f) };
	__LIB_7__::func_146(uParam0, "CDNJ7AU");
	__LIB_7__::func_107(uParam0, iLocal_92, 3, joaat("SC_PROP_CAMP_DUTCH_SEAT_CHAIR_READING"), "SC_PROP_CAMP_DUTCH_SEAT_CHAIR_READING_MALE_A", -1, 0);
	__LIB_7__::func_127(uParam0, iLocal_92, 3, joaat("SC_PROP_CAMP_DUTCH_SEAT_CHAIR_READING"), "SC_PROP_CAMP_DUTCH_SEAT_CHAIR_READING_MALE_A", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_139(uParam0, iLocal_92, iLocal_96, "p_cs_bookEvelynMiller_PH_R_HAND", 0, 0);
	__LIB_7__::func_107(uParam0, iLocal_93, 3, joaat("WORLD_HUMAN_LEAN_WALL_RIGHT"), "WORLD_HUMAN_LEAN_WALL_RIGHT_MALE_B", -1, 0);
	return true;
}
...
bool func_98(var uParam0)
{
	...
	else if (__LIB_7__::func_169(uParam0, iLocal_95))
	{
		__LIB_7__::func_276(uParam0, &uLocal_18);
	}
	else if (__LIB_7__::func_74(uParam0, iLocal_93))
	{
		if (__LIB_7__::func_163(uParam0, Local_97, 1, 0) && __LIB_0__::func_665(Global_35, __LIB_6__::func_952(uParam0, iLocal_92), 0, 1) > 5f)
		{
			__LIB_0__::func_19(&uLocal_18, iLocal_93);
			__LIB_18__::func_4(uParam0, &uLocal_18);
			__LIB_7__::func_310(uParam0, &uLocal_18);
			__LIB_7__::func_173(uParam0, iLocal_95, 0);
		}
		else
		{
			__LIB_7__::func_113(uParam0, iLocal_93, 1, 1);
