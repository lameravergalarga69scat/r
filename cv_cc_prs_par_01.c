...
bool func_72(var uParam0)
{
	...
	{
		case 3:
			__LIB_7__::func_116(uParam0, 1870.751f, -1866.893f, 41.811f, 0f, 0f, -127.8f);
			break;
		default:
			return false;
	}
	iLocal_14 = __LIB_7__::func_48(uParam0, 17, 0);
	__LIB_7__::func_47(uParam0, 0f, 0f, 1f, 0f, 1.5f, 1.5f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_PEARSON"), 1, 1, 1);
	__LIB_6__::func_958(uParam0, joaat("P_BOTTLEBEER01X"), 0f, 0f, 0f, "BEER", 0, 1, 1);
	if (!__LIB_6__::func_206(15))
	{
		__LIB_6__::func_959(uParam0, "script@vignette@pearson_par_1@base", 65, 1, 0, 0);
	}
	__LIB_6__::func_959(uParam0, "script@vignette@pearson_par_1@action", 64, 0, 1, 0);
	__LIB_7__::func_107(uParam0, iLocal_14, 3, joaat("WORLD_HUMAN_DRINKING_DRUNK"), "WORLD_HUMAN_DRINKING_DRUNK_MALE_B", -1, 1);
