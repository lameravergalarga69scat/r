...
{
	__LIB_2__::func_851(uParam0, 12050, 12115, 12500);
}
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	int iVar8;
	iVar7 = 1;
	iVar8 = __LIB_1__::func_898();
	switch (*uParam0)
	{
		case 230:
			__LIB_2__::func_853(uParam0, "VULTURES_EATING_CARCASS", "script@ambient@animal@scavengers@vulture_eating_carcass_a@action", vParam1, vParam4);
			iLocal_11 = joaat("A_C_DEER_01");
			...
			break;
		case 231:
			__LIB_2__::func_853(uParam0, "VULTURES_EATING_CARCASS", "script@ambient@animal@scavengers@vulture_eating_human@action", vParam1, vParam4);
		...
		case 142:
			...
			__LIB_2__::func_853(uParam0, "VULTURE_EAT_CARCASS", "script@ambient@animal@scavengers@crows_eating_deer@action", vVar0, vVar3);
			iLocal_11 = joaat("A_C_DEER_01");
			sLocal_13 = "CREATURES_MAMMAL@DEER@NORMAL@DEAD";
			sLocal_14 = "dead_left";
			fVar6 = 180f;
			break;
		case 143:
			__LIB_2__::func_853(uParam0, "VULTURE_EAT_CARCASS", "script@ambient@animal@scavengers@crows_eating_human@action", vParam1, vParam4);
			iLocal_11 = joaat("A_M_M_UNICORPSE_01");
			sLocal_13 = "SCRIPT_AMB@ANIMAL@SCAVENGERS@CROWS_AND_VULTURES_EATING_HUMAN_CARCASS";
			sLocal_14 = "LOOP_HUMAN";
			fVar6 = 0f;
	...
	else
	{
		uParam0->f_19 = 10;
		iLocal_15 = 6;
		__LIB_2__::func_855(uParam0, 0, "VULTURE_1", iLocal_10, 0f, 0f, 0f, 0f, iVar7, 1, 1, 1, iLocal_17, 1);
		__LIB_2__::func_855(uParam0, 1, "VULTURE_2", iLocal_10, 0f, 0f, 0f, 0f, iVar7, 1, 1, 1, iLocal_17, 1);
		__LIB_2__::func_855(uParam0, 2, "VULTURE_3", iLocal_10, 0f, 0f, 0f, 0f, iVar7, 1, 1, 1, iLocal_17, 1);
		__LIB_2__::func_855(uParam0, 3, "VULTURE_4", iLocal_10, 0f, 0f, 0f, 0f, iVar7, 1, 1, 1, iLocal_17, 1);
		__LIB_2__::func_855(uParam0, 4, "VULTURE_5", iLocal_10, 0f, 0f, 0f, 0f, iVar7, 1, 1, 1, iLocal_17, 1);
		__LIB_2__::func_855(uParam0, 5, "VULTURE_6", iLocal_10, 0f, 0f, 0f, 0f, iVar7, 1, 1, 1, iLocal_17, 1);
	}
	__LIB_2__::func_855(uParam0, 9, "DEER", iLocal_11, vParam1, (fVar6 + vParam4.z), 1, 0, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
}
...
int func_18(var uParam0)
{
	...
	return __LIB_2__::func_907(uParam0, uParam0->f_20[9 /*14*/].f_5);
}
...
bool func_28(var uParam0)
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[9 /*14*/]))
	{
		...
		__LIB_2__::func_857(&(uParam0->f_20[9 /*14*/]), 1, 1);
...
void func_74(var uParam0, int iParam1)
{
	if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[iParam1 /*14*/]))
	{
		if (ANIMSCENE::_0x005E6F28DD7ED58D(uParam0->f_3.f_1, uParam0->f_20[iParam1 /*14*/].f_1))
		{
			...
			__LIB_2__::func_857(&(uParam0->f_20[iParam1 /*14*/]), 0, 1);
