...
bool func_72(var uParam0)
{
	...
	{
		case 6:
			__LIB_7__::func_45(uParam0, 9, 0, 0, 0);
	...
	iLocal_19 = __LIB_6__::func_958(uParam0, joaat("P_BOTTLEBEER01X"), 0f, 0f, 0f, "BOTTLEBEER", 0, 0, 1);
	iLocal_17 = __LIB_6__::func_958(uParam0, joaat("P_CS_RAG02X"), 0f, 0f, 0f, "RAG", 0, 1, 1);
	iLocal_18 = __LIB_6__::func_958(uParam0, joaat("P_WASHBOARD01X"), 0f, 0f, 0f, "WashBoard", 0, 1, 1);
	__LIB_6__::func_958(uParam0, joaat("P_BASINWATER01X"), 0f, 0f, 0f, "BASIN", 0, 1, 1);
	__LIB_6__::func_958(uParam0, joaat("P_CIGARETTE_CS01X"), 0f, 0f, 0f, "CIGARETTE", 0, 0, 1);
	__LIB_7__::func_47(uParam0, -0.875f, -3.4125f, 0.9f, 2f, 1.7725f, 1.54f, 2.685f, joaat("VOLBOX"), joaat("APMS_COMP_ABIGAIL"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, 4.3625f, -1.225f, 0.7625f, 2f, 1.7725f, 1.54f, 2.685f, joaat("VOLBOX"), joaat("APMS_COMP_UNCLE"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, 13.3375f, -6.3875f, 1.075f, -24.25f, 1.7725f, 1.54f, 2.685f, joaat("VOLBOX"), joaat("APMS_COMP_JAVIER"), 1, 1, 1);
	__LIB_7__::func_159(uParam0, 3.6f, -2.56f, 1.0889f, 16.2f, 2f, 1.2f, 2f, joaat("VOLCYLINDER"), 1);
	__LIB_6__::func_959(uParam0, "script@vignette@javier_9@base", 1, 1, 0, 0);
	iLocal_20 = __LIB_6__::func_959(uParam0, "script@vignette@javier_9@action", 0, 0, 1, 0);
	__LIB_7__::func_146(uParam0, "CJAV9AU");
	__LIB_7__::func_151(uParam0, iLocal_16, 1, -1);
	__LIB_7__::func_149(uParam0, joaat("COMP_JAVCNV9"), joaat("PLAYER_JAVCNV9"));
	__LIB_7__::func_107(uParam0, iLocal_14, 3, joaat("WORLD_HUMAN_SIT_DRINK"), "WORLD_HUMAN_SIT_DRINK_MALE_A", -1, 1);
	__LIB_7__::func_127(uParam0, iLocal_14, 2, joaat("WORLD_HUMAN_SIT_DRINK"), "WORLD_HUMAN_SIT_DRINK_MALE_A", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_139(uParam0, iLocal_14, iLocal_19, "p_bottleBeer01x_PH_R_HAND", 0, 0);
	__LIB_7__::func_127(uParam0, iLocal_15, 3, joaat("WORLD_HUMAN_WASHBOARD"), "WORLD_HUMAN_WASHBOARD_FEMALE_A", -1, 1, 20f, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_139(uParam0, iLocal_15, iLocal_18, "p_washboard01x_PH_L_HAND", 1, "p_washboard01x_PH_L_HAND");
	__LIB_7__::func_139(uParam0, iLocal_15, iLocal_17, "p_cs_rag02x_PH_R_HAND", 0, 0);
	__LIB_7__::func_147(uParam0, iLocal_15, 1, 1, 0, 0, 0);
	__LIB_7__::func_150(uParam0, iLocal_20, -1, 0.85f);
	return true;
}
