...
bool func_72(var uParam0)
{
	...
	iLocal_16 = __LIB_7__::func_48(uParam0, 19, 0);
	__LIB_7__::func_47(uParam0, -1.4436f, 1.4525f, 0f, 129f, 1.3475f, 2.5425f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_SWANSON"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, -1.6811f, -0.8475f, 0f, 103.5f, 1.1f, 1.1f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_MICAH"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, 4.3064f, 2.9775f, 0f, 0f, 1.2f, 1.2f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_GRIMSHAW"), 1, 1, 1);
	__LIB_6__::func_958(uParam0, joaat("P_CIGARETTE_CS02X"), 0f, 0f, 0f, "CIGARETTE", 0, 1, 1);
	iLocal_18 = __LIB_6__::func_958(uParam0, joaat("P_MUGCOFFEE01X"), 0f, 0f, 0f, "MUG", 0, 0, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@swanson_13@base", 1, 1, 0, 0);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@swanson_13@action", 2, 0, 1, 0);
	__LIB_7__::func_146(uParam0, "CSW13AU");
	__LIB_7__::func_149(uParam0, joaat("COMP_SWNCNV13"), joaat("PLAYER_SWNCNV13"));
	__LIB_7__::func_150(uParam0, iLocal_17, -1, 0.87f);
	__LIB_7__::func_107(uParam0, iLocal_14, 3, joaat("WORLD_HUMAN_DRUNK_BAR_SLUMPED"), "WORLD_HUMAN_DRUNK_BAR_SLUMPED_MALE_A", -1, 1);
	__LIB_7__::func_323(uParam0, iLocal_14, 0.625f);
	__LIB_7__::func_151(uParam0, iLocal_14, 3, -1);
	__LIB_7__::func_107(uParam0, iLocal_15, 3, joaat("PROP_HUMAN_SEAT_BENCH_PORCH"), "PROP_HUMAN_SEAT_BENCH_PORCH_SMOKING_MALE_A", -1, 0);
	__LIB_7__::func_107(uParam0, iLocal_16, 3, joaat("WORLD_HUMAN_COFFEE_DRINK"), "WORLD_HUMAN_COFFEE_DRINK_FEMALE_C", -1, 1);
	__LIB_7__::func_153(uParam0, iLocal_16, 1, joaat("WORLD_HUMAN_COFFEE_DRINK"), 0, -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_139(uParam0, iLocal_16, iLocal_18, "p_mugCoffee01x_ph_r_hand", 0, 0);
	__LIB_7__::func_147(uParam0, iLocal_16, 2, 0, 30, 0, 0);
