...
bool func_72(var uParam0)
{
	...
	{
		case 8:
			__LIB_7__::func_45(uParam0, 35, 0, 0, 0);
			break;
		default:
			return false;
	}
	iLocal_14 = __LIB_7__::func_48(uParam0, 4, "Uncle");
	iLocal_15 = __LIB_7__::func_48(uParam0, 14, "JACK");
	__LIB_7__::func_47(uParam0, 37.025f, -10.025f, -2.675f, -2.75f, 3.005f, 5.265f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_ABIGAIL"), 1, 1, 1);
	__LIB_6__::func_958(uParam0, joaat("P_FEATHER01X"), 3f, 3f, 0f, "Feather", 0, 0, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@beecher@uncle_and_jack_1@base", 1, 1, 0, 0);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@beecher@uncle_and_jack_1@action", 2, 0, 1, 1);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@beecher@uncle_and_jack_1@exit_stand", 0, 0, 0, 0);
	iLocal_18 = __LIB_6__::func_959(uParam0, "script@vignette@beecher@uncle_and_jack_1@laugh", 0, 0, 0, 1);
	iLocal_19 = __LIB_7__::func_32(uParam0, iLocal_18, "PL_LAUGH_A", 1);
	__LIB_7__::func_32(uParam0, iLocal_18, "PL_LAUGH_B", 1);
	__LIB_7__::func_32(uParam0, iLocal_18, "PL_LAUGH_C", 1);
	__LIB_7__::func_32(uParam0, iLocal_18, "PL_LAUGH_D", 1);
	iLocal_20 = __LIB_7__::func_32(uParam0, iLocal_18, "PL_LAUGH_E", 1);
	__LIB_7__::func_146(uParam0, "BUNJ1AU");
	__LIB_7__::func_149(uParam0, joaat("COMP_BCUNJCNV1"), joaat("PLAYER_BCUNJCNV1"));
	__LIB_7__::func_150(uParam0, iLocal_16, -1, 0.59f);
	__LIB_7__::func_107(uParam0, iLocal_14, 3, joaat("WORLD_HUMAN_SIT_FALL_ASLEEP"), "WORLD_HUMAN_SIT_GROUND_SLEEPING_MALE_A", -1, 0);
	__LIB_7__::func_127(uParam0, iLocal_14, 2, joaat("WORLD_HUMAN_SIT_FALL_ASLEEP"), "WORLD_HUMAN_SIT_GROUND_SLEEPING_MALE_A", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_151(uParam0, iLocal_15, 1, -1);
	Local_21 = { __LIB_7__::func_160(uParam0, 36.715f, -10.1275f, -3.975f, 180f, 7f, 0.7f, 0.744f) };
...
{
	return __LIB_7__::func_236(uParam0, Local_21, 1, 0);
}
...
bool func_93(var uParam0)
{
	...
	if (__LIB_7__::func_148(uParam0, iLocal_16))
	{
		...
		if (__LIB_0__::func_665(iVar0, Global_35, 1, 1) < 15f)
		{
			iVar1 = MISC::GET_RANDOM_INT_IN_RANGE(iLocal_19, iLocal_20 + 1);
			if (__LIB_7__::func_183(uParam0, iVar1, 1))
			{
