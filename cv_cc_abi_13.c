...
bool func_73(var uParam0)
{
	...
	{
		case 1:
			__LIB_7__::func_45(uParam0, 112, 0, 0, 0);
			break;
		case 2:
	...
	__LIB_7__::func_47(uParam0, 0.64f, -0.72f, 0f, 31.68f, 3f, 3f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_ABIGAIL"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, -0.3586f, 2.5571f, 0.9955f, 76.6025f, 1f, 1f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_TILLY"), 1, 1, 1);
	__LIB_6__::func_958(uParam0, joaat("P_CS_SOCK01X"), 0f, 0f, 0f, "SOCK", 0, 0, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@abigail_13@base", 1, 1, 0, 0);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@abigail_13@action_a", 2, 0, 1, 0);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@abigail_13@action_b", 2, 0, 0, 0);
	iLocal_18 = __LIB_6__::func_959(uParam0, "script@vignette@abigail_13@action_b_alt", 2, 0, 0, 1);
	iLocal_19 = __LIB_6__::func_959(uParam0, "script@vignette@abigail_13@action_c", 2, 0, 0, 0);
	iLocal_20 = __LIB_6__::func_959(uParam0, "script@vignette@abigail_13@action_d", 0, 0, 0, 0);
	__LIB_7__::func_146(uParam0, "CAB13AU");
	__LIB_7__::func_149(uParam0, joaat("COMP_ABICNV13"), joaat("PLAYER_ABICNV13"));
	__LIB_7__::func_153(uParam0, iLocal_14, 2, joaat("WORLD_HUMAN_SIT_GROUND"), 0, -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	...
	Local_22 = { __LIB_7__::func_160(uParam0, 1.2363f, -0.1641f, 1.0444f, 120.96f, 7f, 0.629f, 0.5f) };
	iLocal_32 = __LIB_7__::func_166(uParam0, 0.5875f, -1.025f, 0.95f, 0f, 0f, 80.98939f, 1.1f, 1.1f, 1.38f, "Grief", joaat("VOLCYLINDER"));
	return true;
}
