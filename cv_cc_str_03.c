...
bool func_72(var uParam0)
{
	...
	iLocal_14 = __LIB_7__::func_48(uParam0, 18, 0);
	__LIB_7__::func_47(uParam0, -1.8601f, -0.8196f, 0.4797f, 14.4f, 1.2f, 1.2f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_STRAUSS"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, 1.1969f, -1.8503f, 0.9725f, 30.6f, 1.5f, 1.5f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_MICAH"), 1, 1, 1);
	iLocal_17 = __LIB_6__::func_958(uParam0, joaat("P_BOWL04X_STEW"), 0f, 0f, 0f, "BOWL", 0, 0, 1);
	iLocal_18 = __LIB_6__::func_958(uParam0, joaat("P_SPOON01X"), 0f, 0f, 0f, "SPOON", 0, 0, 1);
	__LIB_6__::func_958(uParam0, joaat("P_CIGARETTE_CS01X"), 0f, 0f, 0f, "CIGARETTE", 0, 1, 1);
	iLocal_19 = __LIB_6__::func_958(uParam0, joaat("P_CS_RAG02X"), 0f, 0f, 0f, "RAG", 0, 1, 1);
	__LIB_7__::func_271(uParam0, iLocal_15, joaat("WEAPON_REVOLVER_DOUBLEACTION"), "GUN");
	__LIB_6__::func_959(uParam0, "script@vignette@strauss_3@base_intro", 1, 1, 0, 0);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@strauss_3@action", 0, 0, 1, 0);
	__LIB_7__::func_146(uParam0, "CSTR3AU");
	__LIB_7__::func_149(uParam0, joaat("COMP_STRCNV3"), joaat("PLAYER_STRCNV3"));
	__LIB_7__::func_150(uParam0, iLocal_16, -1, 0.96f);
	__LIB_7__::func_107(uParam0, iLocal_15, 3, joaat("WORLD_HUMAN_SMOKE"), "WORLD_HUMAN_SMOKE_MALE_C", -1, 1);
	__LIB_7__::func_127(uParam0, iLocal_15, 2, joaat("PROP_CAMP_MICAH_SEAT_CHAIR_CLEAN_GUN"), "PROP_CAMP_MICAH_SEAT_CHAIR_CLEAN_GUN_MALE_A", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_151(uParam0, iLocal_15, 1, -1);
	__LIB_7__::func_277(uParam0, iLocal_15, "GREET_MICAH_STRCNV3", 60000, 1);
	__LIB_7__::func_139(uParam0, iLocal_15, iLocal_19, "p_cs_rag02x_PH_L_HAND", 0, 0);
	__LIB_7__::func_147(uParam0, iLocal_14, 1, 5, 0, 0, 0);
	func_164(uParam0, iLocal_14, 3, 0);
	__LIB_7__::func_127(uParam0, iLocal_14, 3, joaat("PROP_CAMP_SEAT_CHAIR_STEW"), "PROP_CAMP_SEAT_CHAIR_STEW_EATING_MALE_A", -1, 0, 120f, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_139(uParam0, iLocal_14, iLocal_17, "p_bowl04x_stew_PH_L_HAND", 0, 0);
	__LIB_7__::func_139(uParam0, iLocal_14, iLocal_18, "p_spoon01x_XH_L_HAND00", 0, 0);
	return true;
}
...
int func_416(int iParam0, bool bParam1, bool bParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7, bool bParam8, bool bParam9, int iParam10)
{
	...
	switch (Global_1360165[iParam0 /*1157*/].f_70.f_12)
	{
		case 0:
			...
			{
				if (!__LIB_0__::func_851(iParam0) && func_442(iParam0, &uVar4))
				{
