...
int func_17(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		else if (__LIB_0__::func_31(uParam0->f_107[iVar0 /*113*/].f_7))
		{
			...
			{
				__LIB_19__::func_309(uParam0->f_107[iVar0 /*113*/].f_5, uParam0->f_107[iVar0 /*113*/].f_7, 1, 0, 0);
				Jump @294; //curOff = 110
				if (__LIB_0__::func_31(uParam0->f_107[iVar0 /*113*/].f_1))
				{
					...
					else if (TASK::_0x9FF5F9B24E870748(uParam0->f_107[iVar0 /*113*/].f_5) && !__LIB_6__::func_951(uParam0))
					{
						...
						__LIB_19__::func_479(uParam0->f_107[iVar0 /*113*/].f_1, 0, 0, 0, fVar1, 1, 1, 0, 0, 0, 0);
					}
					else
					{
						__LIB_19__::func_479(uParam0->f_107[iVar0 /*113*/].f_1, 0, 0, 1, -1082130432 /* Float: -1f */, 1, 1, 0, 0, 0, 0);
					}
				}
			}
			iVar0++;
...
bool func_72(var uParam0)
{
	...
	{
		case 8:
			__LIB_7__::func_116(uParam0, -1591.96f, -1424.587f, 80.51f, 0f, 0f, 92.16f);
			break;
		default:
			return false;
	}
	iLocal_14 = __LIB_7__::func_48(uParam0, 4, 0);
	iLocal_15 = __LIB_6__::func_958(uParam0, joaat("P_PITCHFORK01X"), 0f, 0f, 0f, "PITCHFORK", 0, 0, 1);
	__LIB_6__::func_958(uParam0, joaat("S_HORSEPOOP01X"), 0f, 0f, 0f, "POOP_01", 0, 0, 1);
	__LIB_6__::func_958(uParam0, joaat("S_HORSEPOOP02X"), 0f, 0f, 0f, "POOP_02", 0, 0, 1);
	__LIB_6__::func_958(uParam0, joaat("S_HORSEPOOP02X"), 0f, 0f, 0f, "POOP_02^1", 0, 0, 1);
	__LIB_6__::func_958(uParam0, joaat("S_HORSEPOOP03X"), 0f, 0f, 0f, "POOP_03", 0, 0, 1);
	__LIB_6__::func_958(uParam0, joaat("P_WHEELBARROW01X"), 0f, 0f, 0f, "WHEELBARROW", 0, 0, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@beecher@uncle_4@base", 1, 1, 0, 0);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@beecher@uncle_4@action", 2, 0, 1, 1);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@beecher@uncle_4@base", 1, 0, 0, 0);
	__LIB_7__::func_146(uParam0, "BUNC4AU");
	iLocal_18 = __LIB_7__::func_156(uParam0, -0.18f, 3.03f, 1.9f, 0f, 0f, 136.28f, 10.12f, 9.24f, 4f, "volTriggerBeecherUncle4", joaat("VOLBOX"));
	...
	__LIB_7__::func_127(uParam0, iLocal_14, 3, joaat("WORLD_HUMAN_PITCH_FORK_PUT_DOWN"), "WORLD_HUMAN_PITCH_FORK_PUT_DOWN_MALE_A", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_139(uParam0, iLocal_14, iLocal_15, "p_pitchfork01x_PH_R_HAND", 0, 0);
	__LIB_7__::func_171(uParam0, iLocal_14, 3, 0);
	__LIB_7__::func_150(uParam0, iLocal_16, iLocal_14, 0.9f);
	return true;
}
...
bool func_93(var uParam0)
{
	...
	if (((__LIB_7__::func_169(uParam0, iLocal_17) && MISC::GET_GAME_TIMER() > iLocal_19) && !__LIB_7__::func_358(uParam0, &iLocal_18, 1)) && !ENTITY::IS_ENTITY_ON_SCREEN(__LIB_6__::func_952(uParam0, iLocal_14)))
	{
	...
	while (iVar12 < uParam0->f_106)
	{
		...
		else
		{
			if (!STREAMING::IS_MODEL_VALID(uParam0->f_107[iVar12 /*113*/].f_3))
			{
				...
				{
					uParam0->f_107[iVar12 /*113*/].f_3 = PERSCHAR::_0xA00DF706C60173D1(__LIB_13__::func_838(uParam0->f_107[iVar12 /*113*/].f_7, 1));
				}
			}
...
void func_202(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam2)
	{
		...
		{
			__LIB_19__::func_479(uParam0->f_107[iParam1 /*113*/].f_1, 0, 0, 0, uParam0->f_107[iParam1 /*113*/].f_32.f_4, 1, 1, 0, 0, 1, 0);
		}
		else
		{
			__LIB_19__::func_479(uParam0->f_107[iParam1 /*113*/].f_1, 0, 0, 1, -1082130432 /* Float: -1f */, 1, 1, 0, 0, 0, 0);
		}
	}
}
...
int func_368(var uParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, int iParam5, int iParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, int iParam11, int iParam12, bool bParam13, bool bParam14, bool bParam15, bool bParam16, int iParam17)
{
	...
	if ((!ENTITY::DOES_ENTITY_EXIST(iVar0) || !__LIB_0__::func_272(iVar0, 0)) || (bParam3 && !__LIB_0__::func_212(iParam1)))
	{
		if (bParam2)
		{
			if (__LIB_13__::func_838(iParam1, 1) != 0)
			{
...
int func_395(int iParam0, bool bParam1, bool bParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7, bool bParam8, bool bParam9, int iParam10)
{
	...
	iVar3 = __LIB_18__::func_704(iParam0, 1);
	switch (Global_1360165[iParam0 /*1157*/].f_70.f_12)
	{
		case 0:
			...
			else
			{
				...
				{
					PERSCHAR::_0x187D65F3AEC5D679(__LIB_13__::func_838(iParam0, 1), &uVar4);
				}
		...
		case 3:
			...
			{
				PERSCHAR::_0x63AA2B8EB087886A(__LIB_13__::func_838(iParam0, 1), MISC::GET_HASH_KEY(sVar12));
			}
...
void func_397(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	if (__LIB_13__::func_838(iParam0, 1) == 0)
	{
		return;
	}
	if (bParam3)
...
bool func_423(int iParam0, vector3 vParam1, int iParam4, bool bParam5)
{
	...
	if ((!bParam5 && !Global_1359489.f_12) || (bParam5 && Global_1359489.f_13 < 8))
	{
		...
		{
			iVar0 = PERSCHAR::_0xA00DF706C60173D1(__LIB_13__::func_838(iParam0, 1));
...
void func_425(int iParam0, int iParam1)
{
	...
	func_397(iParam1, __LIB_0__::func_858(iParam1, 8192), __LIB_0__::func_858(iParam1, 16384), 1);
}
