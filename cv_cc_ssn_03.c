...
bool func_72(var uParam0)
{
	...
	__LIB_7__::func_47(uParam0, 5.1653f, 3.3586f, 0f, -10f, 1f, 1f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_GRIMSHAW"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, 0.6339f, -2.4567f, 0f, 3.7983f, 1f, 1f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_TILLY"), 1, 1, 1);
	...
	__LIB_6__::func_958(uParam0, joaat("P_CHAIR_CRATE02X"), 0f, 0f, 0f, "SEAT", 0, 1, 1);
	__LIB_7__::func_147(uParam0, iLocal_14, 2, 0, 30, "Default_Angry", 0);
	...
	__LIB_7__::func_144(uParam0, iLocal_15, 1.8f, 1065353216 /* Float: 1f */, 1092616192 /* Float: 10f */);
	__LIB_7__::func_147(uParam0, iLocal_15, 1, 3, 0, 0, 0);
	__LIB_7__::func_151(uParam0, iLocal_15, 3, -1);
	__LIB_6__::func_959(uParam0, "script@vignette@susan_3@base", 1, 1, 0, 0);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@susan_3@action_a", 2, 0, 1, 0);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@susan_3@action_b", 0, 0, 0, 0);
	iLocal_18 = __LIB_6__::func_959(uParam0, "script@vignette@susan_3@action_b_alt_front", 0, 0, 0, 1);
	iLocal_19 = __LIB_6__::func_959(uParam0, "script@vignette@susan_3@action_b_alt_back", 0, 0, 0, 1);
	__LIB_7__::func_146(uParam0, "CSSN3AU");
	Local_20 = { __LIB_7__::func_160(uParam0, -0.0669f, 1.7103f, 1.0237f, -10.08f, 8f, 0.7f, 0.5f) };
	Local_30 = { __LIB_7__::func_160(uParam0, -0.2437f, 1.4726f, 1.0087f, 97.0791f, 8f, 0.8f, 0.5f) };
	return true;
}
...
bool func_93(var uParam0)
{
	...
	{
		PED::FORCE_PED_MOTION_STATE(__LIB_6__::func_952(uParam0, iLocal_15), joaat("MOTIONSTATE_RUN"), false, 0, false);
		TASK::TASK_LOOK_AT_ENTITY(__LIB_6__::func_952(uParam0, iLocal_15), __LIB_6__::func_952(uParam0, iLocal_14), 2500, 16, 51, 1);
	}
	return true;
}
