...
bool func_72(var uParam0)
{
	...
	{
		case 2:
			__LIB_7__::func_116(uParam0, 657.1169f, -1238.681f, 42.8372f, 0f, 0f, 110.52f);
			break;
		case 3:
			__LIB_7__::func_116(uParam0, 1868.76f, -1869.224f, 39.7553f, 0f, 0f, -67.32f);
			break;
	}
	iLocal_14 = __LIB_7__::func_48(uParam0, 12, "Dog");
	__LIB_7__::func_48(uParam0, 3, "Male");
	iLocal_15 = __LIB_6__::func_959(uParam0, "script@ambient@campfiregeneral@DOG_JUMP_AND_LICK@action", 64, 0, 0, 0);
	__LIB_7__::func_47(uParam0, -0.1235f, 0.2914f, 1.0827f, -76.75f, 1.9375f, 1.5675f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_BILL"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, -1.086f, 8.8789f, 1.0827f, -76.75f, 1.2975f, 1.0125f, 3f, joaat("VOLBOX"), -1, 1, 1, 1);
	iVar0 = MISC::GET_RANDOM_INT_IN_RANGE(0, 2);
	__LIB_7__::func_107(uParam0, iLocal_14, 3, joaat("WORLD_ANIMAL_DOG_SITTING"), "WORLD_ANIMAL_DOG_SITTING", -1, 0);
	__LIB_7__::func_229(uParam0, iLocal_14);
	switch (iVar0)
	{
		case 0:
			iLocal_16 = __LIB_7__::func_32(uParam0, iLocal_15, "PL_kneelAction", 1);
			break;
		case 1:
			iLocal_16 = __LIB_7__::func_32(uParam0, iLocal_15, "PL_standAction", 1);
			break;
		default:
			return false;
	}
