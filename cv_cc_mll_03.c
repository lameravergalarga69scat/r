...
bool func_7(var uParam0)
{
	...
	switch (__LIB_6__::func_949(uParam0))
	{
		...
		case 4:
			...
			break;
		case 5:
			if (__LIB_19__::func_131(uParam0))
			{
				__LIB_6__::func_936(uParam0, 6);
			}
			break;
		case 6:
			if (__LIB_7__::func_335(uParam0))
			{
				uParam0->f_2267 = 1;
...
bool func_72(var uParam0)
{
	...
	__LIB_7__::func_47(uParam0, -4.5205f, 0.2751f, 0.8299f, 0f, 1.5f, 1.5f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_MOLLY"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, -0.0006f, -0.0029f, 0.5041f, 0f, 1.5f, 2.02f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_DUTCH"), 1, 1, 1);
	__LIB_6__::func_958(uParam0, joaat("P_POCKETMIRROR01X"), 0f, 0f, 0f, "MIRROR", 0, 1, 1);
	__LIB_6__::func_958(uParam0, joaat("P_CS_PILLOW01X"), 0f, 0f, 0f, "PILLOW", 0, 0, 1);
	iLocal_19 = __LIB_6__::func_958(uParam0, joaat("S_CARAVANCOT01X"), 0f, 0f, 0f, 0, 1, 0, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@molly_3@base", 1, 1, 0, 0);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@molly_3@action_a", 2, 0, 1, 0);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@molly_3@action_b", 0, 0, 0, 0);
	iLocal_18 = __LIB_6__::func_959(uParam0, "script@vignette@molly_3@action_b_alt", 0, 0, 0, 1);
	__LIB_7__::func_146(uParam0, "CCML3AU");
	__LIB_7__::func_149(uParam0, joaat("COMP_MLLCNV3"), joaat("PLAYER_MLLCNV3"));
	...
	__LIB_7__::func_127(uParam0, iLocal_15, 3, joaat("PROP_HUMAN_SLEEP_BED_PILLOW_RIGHT"), "PROP_HUMAN_SLEEP_BED_PILLOW_MALE_B", iLocal_19, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_328(uParam0, iLocal_15, 0);
	Local_20 = { __LIB_7__::func_160(uParam0, 0f, 0f, 0.8f, 158.4f, 8f, 0.35f, 0.35f) };
	return true;
}
