...
bool func_72(var uParam0)
{
	...
	__LIB_7__::func_47(uParam0, -0.0061f, -1.935f, 0f, -2.5f, 3.205f, 1.5f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_SWANSON"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, 4.1189f, 2.365f, 0f, 0f, 1.2f, 1.2f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_MICAH"), 1, 1, 1);
	iLocal_20 = __LIB_6__::func_958(uParam0, joaat("P_CS_BOOK04X"), 0f, 0f, 0f, "BOOK", 0, 1, 1);
	__LIB_6__::func_958(uParam0, joaat("P_CIGARLIT01X"), 0f, 0f, 0f, "CIGAR", 0, 1, 1);
	iLocal_16 = __LIB_6__::func_958(uParam0, joaat("P_CHAIRFOLDING02X"), 1.198f, -1.869f, 0.472f, "CHAIR", 1, 0, 1);
	iLocal_17 = __LIB_6__::func_958(uParam0, joaat("S_CRATESEAT03X"), -1.167f, -1.683f, 0.477f, 0, 1, 0, 1);
	iLocal_18 = __LIB_6__::func_958(uParam0, joaat("P_JAVIERKNIFE_TEMP"), 0f, 0f, 0f, "Knife", 0, 0, 1);
	iLocal_19 = __LIB_6__::func_958(uParam0, joaat("P_WOODWHITTLE01X"), 0f, 0f, 0f, "Whittle", 0, 0, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@swanson_11@base", 1, 1, 0, 0);
	__LIB_6__::func_959(uParam0, "script@vignette@swanson_11@action", 0, 0, 1, 0);
	__LIB_7__::func_146(uParam0, "CSW11AU");
	__LIB_7__::func_107(uParam0, iLocal_14, 3, joaat("PROP_HUMAN_SEAT_CHAIR_READING"), "PROP_HUMAN_SEAT_CHAIR_READING_MALE_A", iLocal_16, 0);
	__LIB_7__::func_127(uParam0, iLocal_14, 3, joaat("WORLD_HUMAN_BOOK_TABLE_PUTDOWN"), "WORLD_HUMAN_BOOK_TABLE_PUTDOWN_MALE_A", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_171(uParam0, iLocal_14, 3, 0);
	__LIB_7__::func_139(uParam0, iLocal_14, iLocal_20, "p_cs_book04x_PH_R_HAND", 0, 0);
	__LIB_7__::func_147(uParam0, iLocal_14, 2, 0, 30, 0, 0);
	__LIB_7__::func_151(uParam0, iLocal_14, 3, -1);
	__LIB_7__::func_107(uParam0, iLocal_15, 3, joaat("WORLD_CAMP_DUTCH_SMOKE_CIGAR"), "WORLD_CAMP_DUTCH_SMOKE_CIGAR_MALE_A", -1, 1);
	__LIB_7__::func_127(uParam0, iLocal_15, 3, joaat("PROP_HUMAN_SEAT_CHAIR_WHITTLE"), "PROP_HUMAN_SEAT_CHAIR_WHITTLE_MALE_C", iLocal_17, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_139(uParam0, iLocal_15, iLocal_18, "p_Javierknife_temp_PH_R_Hand", 0, 0);
	__LIB_7__::func_139(uParam0, iLocal_15, iLocal_19, "p_woodWhittle01x_PH_L_HAND", 0, 0);
	return true;
}
	...
	switch (Global_1360165[iParam0 /*1157*/].f_3)
	{
		...
		case 1:
			...
			if (iParam4 == 0)
			{
				...
				else if ((Global_1360165[iParam0 /*1157*/].f_4.f_2 != 0 && Global_1360165[iParam0 /*1157*/].f_4.f_2 == Global_40.f_4942[iParam0 /*60*/].f_59) && (func_428(Global_1360165[iParam0 /*1157*/].f_4.f_2) || __LIB_1__::func_44(Global_1360165[iParam0 /*1157*/].f_4.f_2)))
				{
