...
bool func_72(var uParam0)
{
	...
	__LIB_7__::func_47(uParam0, -1.36f, -0.02f, 0.5f, 0f, 1.4f, 1.4f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_MICAH"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, -0.2379f, -1.0318f, 0.5f, 0f, 1.4f, 1.4f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_SWANSON"), 1, 1, 1);
	__LIB_6__::func_958(uParam0, joaat("P_SPOON01X"), 0f, 0f, 0f, "SPOON", 0, 1, 1);
	iLocal_17 = __LIB_6__::func_958(uParam0, joaat("P_BOWL04X_STEW"), 0f, 0f, 0f, "BOWL", 0, 1, 1);
	STREAMING::REQUEST_MODEL(iLocal_19, false);
	__LIB_6__::func_959(uParam0, "script@vignette@swanson_9@base", 1, 1, 0, 0);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@swanson_9@action", 0, 0, 1, 0);
	__LIB_7__::func_146(uParam0, "CSWN9AU");
	__LIB_7__::func_149(uParam0, joaat("COMP_SWNCNV9"), joaat("PLAYER_SWNCNV9"));
	__LIB_7__::func_150(uParam0, iLocal_16, -1, 0.92f);
	...
	__LIB_7__::func_277(uParam0, iLocal_15, "GREET_MICAH_SWNCNV9", 60000, 1);
	return true;
}
...
{
	iLocal_18 = WEAPON::_CREATE_WEAPON_OBJECT(joaat("WEAPON_MELEE_KNIFE"), 1, uParam0->f_23, true, 1f);
...
{
	if (!bLocal_20 && ENTITY::DOES_ENTITY_EXIST(iLocal_18))
	{
		__LIB_7__::func_346(uParam0, iLocal_18, "KNIFE");
		bLocal_20 = true;
		return false;
	}
	return true;
...
void func_425(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_466(iParam1, joaat("WEAPON_REVOLVER_CATTLEMAN_SADIE"), 0, 0, 2, 1, 0, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 0, 0, 0);
				func_466(iParam1, joaat("WEAPON_REVOLVER_CATTLEMAN_SADIE_DUALWIELD"), 0, 0, 3, 1, 1, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 1, 0, 0);
			}
			break;
	}
}
