...
bool func_72(var uParam0)
{
	...
	{
		case 1:
			__LIB_7__::func_45(uParam0, 165, 0, 0, 0);
			break;
		case 2:
			__LIB_7__::func_45(uParam0, 92, 0, 0, 0);
			break;
		case 3:
			__LIB_7__::func_45(uParam0, 223, 0, 0, 0);
			break;
		default:
			return false;
	}
	...
	{
		__LIB_7__::func_47(uParam0, 8.88f, 3.18f, 1.2f, 7.068f, 1.5f, 1.5f, 2f, joaat("VOLBOX"), joaat("APMS_COMP_DUTCH"), 1, 1, 1);
		__LIB_7__::func_47(uParam0, 0.6f, -0.8f, 1f, 2f, 1.75f, 2.5f, 2f, joaat("VOLBOX"), 2076113919, 1, 1, 1);
		__LIB_7__::func_159(uParam0, 0.625f, -0.0377f, 1.15f, 38.56f, 1f, 1f, 2.685f, joaat("VOLCYLINDER"), 1);
	}
	iLocal_17 = __LIB_6__::func_958(uParam0, joaat("P_CIGARLIT01X"), 0f, 0f, 0f, "CIGAR", 0, 0, 1);
	__LIB_6__::func_958(uParam0, joaat("P_CHAIRFOLDING02X"), 1.20486f, -1.61288f, 0.00105286f, "CHAIR", 1, 0, 1);
	iLocal_16 = __LIB_6__::func_958(uParam0, joaat("P_STOOLFOLDING01X"), 0f, 0f, 0f, 0, 1, 0, 1);
	if (!__LIB_6__::func_206(14))
	{
		__LIB_6__::func_959(uParam0, "script@vignette@dutch_and_hosea_5@base", 1, 1, 0, 0);
	}
	iLocal_18 = __LIB_6__::func_959(uParam0, "script@vignette@dutch_and_hosea_5@action_a", 2, 0, 1, 0);
	iLocal_19 = __LIB_6__::func_959(uParam0, "script@vignette@dutch_and_hosea_5@action_a_int_right", 2, 0, 0, 1);
	iLocal_20 = __LIB_6__::func_959(uParam0, "script@vignette@dutch_and_hosea_5@action_b", 2, 0, 0, 0);
	iLocal_21 = __LIB_6__::func_959(uParam0, "script@vignette@dutch_and_hosea_5@action_b_int_front", 2, 0, 0, 1);
	iLocal_23 = __LIB_6__::func_959(uParam0, "script@vignette@dutch_and_hosea_5@action_b_int_left", 2, 0, 0, 1);
	iLocal_22 = __LIB_6__::func_959(uParam0, "script@vignette@dutch_and_hosea_5@action_b_int_right", 2, 0, 0, 1);
	iLocal_24 = __LIB_6__::func_959(uParam0, "script@vignette@dutch_and_hosea_5@action_c", 0, 0, 0, 0);
	__LIB_7__::func_146(uParam0, "CCDH5AU");
	__LIB_7__::func_149(uParam0, joaat("COMP_DNHCNV5"), joaat("PLAYER_DNHCNV5"));
	__LIB_7__::func_150(uParam0, iLocal_24, -1, 0.81f);
	__LIB_7__::func_107(uParam0, iLocal_14, 3, joaat("WORLD_CAMP_DUTCH_SMOKE_CIGAR"), "WORLD_CAMP_DUTCH_SMOKE_CIGAR_MALE_A", -1, 1);
	__LIB_7__::func_127(uParam0, iLocal_14, 1, joaat("WORLD_CAMP_DUTCH_SMOKE_CIGAR"), "WORLD_CAMP_DUTCH_SMOKE_CIGAR_MALE_A", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_139(uParam0, iLocal_14, iLocal_17, "p_cigar02x_PH_R_HAND", 0, 0);
	__LIB_7__::func_147(uParam0, iLocal_14, 1, 1, 0, 0, 0);
	__LIB_7__::func_107(uParam0, iLocal_15, 3, joaat("PROP_HUMAN_SEAT_CHAIR"), "PROP_HUMAN_SEAT_CHAIR_GENERIC_MALE_D", iLocal_16, 0);
	__LIB_7__::func_127(uParam0, iLocal_15, 3, joaat("PROP_HUMAN_SEAT_CHAIR"), "PROP_HUMAN_SEAT_CHAIR_GENERIC_MALE_D", iLocal_16, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_147(uParam0, iLocal_15, 1, 1, 0, 0, 0);
	__LIB_7__::func_151(uParam0, iLocal_15, 1, -1);
	Local_25 = { __LIB_7__::func_160(uParam0, 1.0669f, -0.7771f, 0.5984f, 100.44f, 8f, 0.5f, 0.5f) };
	Local_35 = { __LIB_7__::func_160(uParam0, 1.067f, -0.777f, 0.598f, 172.44f, 8f, 0.3f, 0.3f) };
	Local_45 = { __LIB_7__::func_160(uParam0, 1.067f, -0.777f, 0.598f, 10.44f, 8f, 0.5f, 0.5f) };
	if (__LIB_6__::func_206(14))
	{
		__LIB_7__::func_282(uParam0, iLocal_14, 4);
...
bool func_93(var uParam0)
{
	...
	{
		if (__LIB_7__::func_163(uParam0, Local_45, 1, 0))
		{
	...
	if ((__LIB_7__::func_148(uParam0, iLocal_22) || __LIB_7__::func_148(uParam0, iLocal_21)) || __LIB_7__::func_148(uParam0, iLocal_23))
	{
		__LIB_7__::func_154(uParam0, iLocal_24, 1);
	}
	return true;
