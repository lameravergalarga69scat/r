...
bool func_72(var uParam0)
{
	...
	{
		case 1:
			__LIB_7__::func_45(uParam0, 132, 0, 0, 0);
			break;
		case 2:
			__LIB_7__::func_116(uParam0, 663.0867f, -1231.747f, 43.2655f, 0f, 0f, 168.12f);
			break;
		default:
			return false;
	}
	...
	iLocal_16 = __LIB_7__::func_165(uParam0, 10, 0, 1);
	__LIB_7__::func_47(uParam0, -0.105f, 1.0775f, 0.85f, -78.25f, 4.325f, 4.3875f, 3.2075f, joaat("VOLBOX"), joaat("APMS_COMP_KIERAN"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, -4.5875f, 6.7625f, 0.85f, -65.75f, 1.5f, 1.5f, 3.2075f, joaat("VOLBOX"), joaat("APMS_COMP_JAVIER"), 1, 1, 1);
	...
	__LIB_6__::func_959(uParam0, "script@vignette@kieran_11@base", 1, 1, 0, 0);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@kieran_11@Action", 0, 0, 1, 0);
	__LIB_7__::func_303(uParam0, iLocal_16, 3, joaat("STAND"), 0, -1, 1);
	__LIB_7__::func_153(uParam0, iLocal_16, 2, joaat("STAND"), 0, -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_153(uParam0, iLocal_14, 3, joaat("WORLD_HUMAN_HORSE_TEND_BRUSH_LINK"), "WORLD_HUMAN_HORSE_TEND_BRUSH_LINK_MALE_A", -1, 1, 2f, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_147(uParam0, iLocal_14, 1, 1, 0, 0, 0);
	__LIB_7__::func_151(uParam0, iLocal_14, 1, -1);
	__LIB_7__::func_303(uParam0, iLocal_15, 3, joaat("WORLD_HUMAN_SMOKE"), "WORLD_HUMAN_SMOKE_MALE_C", -1, 1);
	__LIB_7__::func_149(uParam0, joaat("COMP_KIECNV11"), joaat("PLAYER_KIECNV11"));
	__LIB_7__::func_150(uParam0, iLocal_17, -1, 0.86f);
	__LIB_7__::func_280(uParam0, iLocal_14, 1);
	__LIB_7__::func_280(uParam0, iLocal_15, 1);
	__LIB_7__::func_146(uParam0, "KE11AUD");
	return true;
}
...
bool func_93(var uParam0)
{
	...
	if (__LIB_7__::func_169(uParam0, iLocal_17))
	{
		...
		if (ANIMSCENE::_GET_ANIM_SCENE_PROGRESS(iVar0) > 0.85f)
		{
			if (bLocal_18)
			{
				__LIB_6__::func_985(uParam0, iLocal_20, 0);
				bLocal_18 = false;
			}
		}
		else if (ANIMSCENE::_GET_ANIM_SCENE_PROGRESS(iVar0) > 0.23f)
		{
			if (!bLocal_18)
			{
				iLocal_20 = __LIB_7__::func_159(uParam0, 1.075f, 1.014f, 0.6f, 0f, 2f, 2f, 2.5f, joaat("VOLCYLINDER"), 1);
				__LIB_6__::func_985(uParam0, iLocal_20, 1);
				bLocal_18 = true;
			}
		}
	}
	if (__LIB_6__::func_997(uParam0, iLocal_16))
	{
		TASK::_TASK_START_SCENARIO_IN_PLACE(__LIB_6__::func_952(uParam0, iLocal_16), joaat("STAND"), 45000, false, 0, 1f, false);
	}
	return true;
}
