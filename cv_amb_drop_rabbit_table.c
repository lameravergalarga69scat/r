...
bool func_73(var uParam0)
{
	switch (__LIB_0__::func_78(uParam0))
	{
		...
		case 2:
			...
			break;
		case 3:
			__LIB_7__::func_45(uParam0, 208, 0.0498f, 0.5496f, 0);
			break;
		case 6:
			__LIB_7__::func_45(uParam0, 14, 0, 0, 0);
			break;
	}
	__LIB_7__::func_46(uParam0, 0f, 0f, 0.625f, 0f, 2f, 2f, 2f, joaat("VOLCYLINDER"), 1);
	__LIB_7__::func_47(uParam0, -1.5f, -0.075f, 0.85f, 0f, 1.2025f, 1.8925f, 2.0875f, joaat("VOLBOX"), -1, 1, 1, 1);
	__LIB_7__::func_48(uParam0, 7, "MALE");
	iLocal_14 = __LIB_7__::func_31(uParam0, joaat("A_C_RABBIT_01"), "RABBIT");
	iLocal_15 = __LIB_6__::func_959(uParam0, "script@ambient@campfireGeneral@Drop_Rabbit_Table@Action", 0, 1, 0, 0);
	iLocal_16 = __LIB_7__::func_32(uParam0, iLocal_15, "Pl_Drop_Exit_Back", 1);
	iLocal_17 = __LIB_7__::func_32(uParam0, iLocal_15, "PL_DROP_ADDRESS_EXIT", 1);
	iLocal_18 = __LIB_7__::func_156(uParam0, 1.3375f, -0.4125f, 0.85f, 0f, 0f, 0f, 2.2825f, 2.6175f, 2.0875f, "Pearson Volume", joaat("VOLBOX"));
	return true;
}
...
{
	int iVar0;
	iVar0 = __LIB_0__::func_167(17);
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		if (__LIB_1__::func_205(iVar0, iLocal_18, 1, 0))
		{
			__LIB_7__::func_33(uParam0, iLocal_17, 1);
		}
	}
	__LIB_7__::func_83(uParam0, iLocal_15, "BOOL_BASE_LOOP", 1);
	return true;
}
...
bool func_94(var uParam0)
{
	...
	{
		PED::SET_PED_TO_RAGDOLL(__LIB_6__::func_952(uParam0, iLocal_14), 1000, 5000, 0, false, true, false);
		__LIB_7__::func_351(uParam0, iLocal_14);
	}
	return true;
}
