...
{
	STREAMING::_0x66BC28E50E85270E(uLocal_20);
	if (OBJECT::IS_DOOR_REGISTERED_WITH_SYSTEM(1309495497))
	{
		__LIB_1__::func_941(1309495497);
	}
	return true;
}
...
bool func_75(var uParam0)
{
	...
	{
		case 8:
			__LIB_7__::func_116(uParam0, -1639.005f, -1361.768f, 83.403f, 0f, 0f, 148.5f);
			break;
		default:
			return false;
	}
	iLocal_14 = __LIB_7__::func_48(uParam0, 13, "ABIGAIL");
	iLocal_15 = __LIB_7__::func_48(uParam0, 14, "JACK");
	__LIB_7__::func_47(uParam0, 36.4401f, -18.1472f, -0.0375f, -33.25f, 1f, 1f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_JACK"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, 34.2901f, -18.2597f, -0.0375f, -33.25f, 1f, 1f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_ABIGAIL"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, 32.8901f, -19.1347f, -0.0375f, -31.75f, 2.59f, 1.0825f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_JACK"), 1, 1, 1);
	iLocal_18 = __LIB_6__::func_958(uParam0, joaat("P_CS_KNITTING01X"), 3f, 3f, 0f, "Knitting", 0, 0, 1);
	__LIB_6__::func_958(uParam0, joaat("P_CS_BOOK03X"), 1.17084f, -0.0235534f, 0.7491f, "BOOK", 0, 0, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@beecher@abigail_and_jack_3@base", 1, 1, 0, 0);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@beecher@abigail_and_jack_3@action_a", 2, 0, 1, 0);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@beecher@abigail_and_jack_3@action_b_small_bed", 0, 0, 0, 0);
	__LIB_7__::func_146(uParam0, "BANJ3AU");
	__LIB_7__::func_149(uParam0, joaat("COMP_BCANJCNV3"), joaat("PLAYER_BCANJCNV3"));
	__LIB_7__::func_107(uParam0, iLocal_14, 3, joaat("PROP_HUMAN_SEAT_CHAIR_KNITTING"), "PROP_HUMAN_SEAT_CHAIR_KNITTING_FEMALE_A", -1, 0);
	__LIB_7__::func_296(uParam0, iLocal_14, 2, joaat("PROP_HUMAN_SEAT_CHAIR_KNITTING"), "PROP_HUMAN_SEAT_CHAIR_KNITTING_FEMALE_A", -1, 0, -1073741824 /* Float: -2f */, 2f, 1);
	__LIB_7__::func_139(uParam0, iLocal_14, iLocal_18, "p_cs_knitting01x_PH_R_HAND", 0, 0);
	__LIB_7__::func_151(uParam0, iLocal_14, 1, -1);
	__LIB_7__::func_172(uParam0, iLocal_15, 1);
	__LIB_7__::func_151(uParam0, iLocal_15, 3, -1);
	__LIB_7__::func_296(uParam0, iLocal_15, 2, joaat("PROP_CAMP_JACK_ES_SLEEP_BED_PILLOW_LEFT"), "PROP_CAMP_JACK_ES_SLEEP_BED_PILLOW_MALE_A", -1, 0, 640f, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_328(uParam0, iLocal_15, 0);
	__LIB_7__::func_145(uParam0, 3f, 5f);
	return true;
}
...
{
	__LIB_0__::func_68(1309495497, 0, 0);
	if (OBJECT::IS_DOOR_REGISTERED_WITH_SYSTEM(1309495497))
	{
		iLocal_19 = ENTITY::GET_OBJECT_INDEX_FROM_ENTITY_INDEX(__LIB_3__::func_659(1309495497, 1, 0));
	}
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_19))
	{
		__LIB_6__::func_986(iLocal_19, uParam0->f_1984[iLocal_16], "DOOR");
		__LIB_6__::func_986(iLocal_19, uParam0->f_1984[iLocal_17], "DOOR");
	}
	return true;
}
...
{
	uLocal_20 = STREAMING::_0xB223249B7798EEED(__LIB_6__::func_952(uParam0, iLocal_15), joaat("PROP_CAMP_JACK_ES_SLEEP_BED_PILLOW_LEFT"), 17, joaat("PROP_CAMP_JACK_ES_SLEEP_BED_PILLOW_MALE_A"));
	return true;
}
...
bool func_96(var uParam0)
{
	...
	{
		if (ANIMSCENE::_0x005E6F28DD7ED58D(uParam0->f_1984[iLocal_16], "DOOR"))
		{
			if (OBJECT::IS_DOOR_REGISTERED_WITH_SYSTEM(1309495497))
			{
				__LIB_1__::func_941(1309495497);
	...
	if (__LIB_7__::func_169(uParam0, iLocal_17))
	{
		if (__LIB_7__::func_40(uParam0, iLocal_17, 0.98f))
		{
