...
bool func_72(var uParam0)
{
	...
	iLocal_14 = __LIB_6__::func_959(uParam0, "script@ambient@campfiregeneral@world_camp_jack_av_poke_fire@action", 0, 1, 0, 0);
	__LIB_6__::func_958(uParam0, joaat("P_STICKFIREPOKER01X"), 0f, 0f, 0f, "STICK", 0, 1, 1);
	__LIB_7__::func_47(uParam0, 0f, 0f, 0f, 64.5f, 1.105f, 1.1625f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_JACK"), 1, 1, 1);
	iLocal_16 = __LIB_7__::func_32(uParam0, iLocal_14, "PL_ACTION", 1);
	__LIB_7__::func_143(uParam0, iLocal_15, 90f, 1);
	uParam0->f_2266 = 120;
	return true;
}
