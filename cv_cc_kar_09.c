...
bool func_72(var uParam0)
{
	...
	iLocal_14 = __LIB_7__::func_48(uParam0, 20, "karen");
	iLocal_15 = __LIB_7__::func_48(uParam0, 6, "MicahBell");
	__LIB_7__::func_47(uParam0, -7.00118f, 1.43711f, 1.36878f, -22f, 1.1f, 1.1f, 2.75f, joaat("VOLBOX"), joaat("APMS_COMP_KAREN"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, -1.707f, -0.7557f, 1f, 0f, 1.1f, 1.1f, 2.75f, joaat("VOLBOX"), joaat("APMS_COMP_KAREN"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, 1.127f, -1.80836f, 0.57637f, -22f, 1.1f, 1.1f, 2.75f, joaat("VOLBOX"), joaat("APMS_COMP_MICAH"), 1, 1, 1);
	Local_19 = { __LIB_7__::func_160(uParam0, -1.707f, -0.8182f, 0.5048f, -53f, 8f, 0.3f, 0.3f) };
	Local_29 = { __LIB_7__::func_160(uParam0, -1.707f, -0.818f, 0.505f, 1f, 8f, 0.3f, 0.3f) };
	Local_39 = { __LIB_7__::func_160(uParam0, -1.707f, -0.818f, 0.505f, -107f, fVar0, 0.3f, 0.45f) };
	iLocal_16 = __LIB_6__::func_958(uParam0, joaat("P_BOWL04X_STEW"), 0f, 0f, 0f, "BOWL", 0, 0, 1);
	iLocal_17 = __LIB_6__::func_958(uParam0, joaat("P_SPOON01X"), 0f, 0f, 0f, "SPOON", 0, 0, 1);
	__LIB_6__::func_958(uParam0, joaat("P_CS_NEWSPAPER_03X"), 0f, 0f, 0f, "NEWSPAPER", 0, 0, 1);
	iLocal_18 = __LIB_6__::func_958(uParam0, joaat("P_CHAIR_CRATE02X"), -1.86282f, -0.829392f, -0.0207748f, 0, 1, 0, 1);
	__LIB_7__::func_149(uParam0, joaat("COMP_KARCNV9"), joaat("PLAYER_KARCNV9"));
	__LIB_7__::func_151(uParam0, iLocal_14, 1, -1);
	__LIB_7__::func_147(uParam0, iLocal_14, 2, 1, 0, 0, 0);
	__LIB_7__::func_127(uParam0, iLocal_14, 3, joaat("PROP_CAMP_SEAT_CHAIR_STEW"), "PROP_CAMP_SEAT_CHAIR_STEW_EATING_FEMALE_B", iLocal_18, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_139(uParam0, iLocal_14, iLocal_16, "p_bowl04x_stew_PH_L_HAND", 0, 0);
	__LIB_7__::func_139(uParam0, iLocal_14, iLocal_17, "p_spoon01x_PH_R_HAND", 0, 0);
	__LIB_7__::func_107(uParam0, iLocal_15, 3, joaat("PROP_HUMAN_SEAT_CHAIR_READ_NEWSPAPER"), "PROP_HUMAN_SEAT_CHAIR_READ_NEWSPAPER_MALE_B", -1, 0);
	__LIB_7__::func_233(uParam0, iLocal_15, 1.127f, -1.80836f, 0.475f, 38.74377f, 1, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@karen_9@base", 1, 1, 0, 0);
	iLocal_49 = __LIB_6__::func_959(uParam0, "script@vignette@karen_9@action", 2, 0, 1, 0);
	iLocal_50 = __LIB_6__::func_959(uParam0, "script@vignette@karen_9@Action_B_Alt_Front", 0, 0, 0, 1);
	iLocal_51 = __LIB_6__::func_959(uParam0, "script@vignette@karen_9@Action_B_Alt_Left", 0, 0, 0, 1);
	iLocal_52 = __LIB_6__::func_959(uParam0, "script@vignette@karen_9@Action_B_Alt_Right", 0, 0, 0, 1);
	__LIB_7__::func_146(uParam0, "CKAR9AU");
	return true;
}
...
{
	ENTITY::_0x669655FFB29EF1A9(__LIB_7__::func_30(uParam0, iLocal_16), 0, "Stew_Fill", 1f);
	return true;
}

bool func_93(var uParam0)
{
	if (__LIB_7__::func_148(uParam0, iLocal_49))
	{
		if (__LIB_7__::func_163(uParam0, Local_19, 1, 0))
		{
			__LIB_7__::func_154(uParam0, iLocal_50, 1);
		}
		else if (__LIB_7__::func_163(uParam0, Local_29, 1, 0))
		{
			__LIB_7__::func_154(uParam0, iLocal_51, 1);
		}
		else if (__LIB_7__::func_163(uParam0, Local_39, 1, 0))
		{
			__LIB_7__::func_154(uParam0, iLocal_52, 1);
		}
		else
		{
