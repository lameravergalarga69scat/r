...
{
	__LIB_1__::func_281(&iLocal_64, 1, 1);
...
bool func_76(var uParam0)
{
	...
	{
		case 1:
			__LIB_7__::func_45(uParam0, 116, 0, 0, 0);
			break;
		case 2:
			__LIB_7__::func_45(uParam0, 53, 0, 0, 0);
			break;
		case 3:
			__LIB_7__::func_45(uParam0, 185, 0, 0, 0);
			break;
		default:
			return false;
	}
	iLocal_14 = __LIB_7__::func_48(uParam0, 3, 0);
	__LIB_7__::func_47(uParam0, 0f, 0f, 1.4875f, 0f, 1.2f, 1.2f, 3.2075f, joaat("VOLBOX"), joaat("APMS_COMP_BILL"), 1, 1, 1);
	iLocal_15 = __LIB_7__::func_142(uParam0, joaat("P_CHAIRFOLDING02X"), 0f, 0f, 0f, 0, 1, 0, 1);
	iLocal_20 = __LIB_6__::func_959(uParam0, "script@vignette@ITM@bill_item_1@base", 1, 0, 0, 0);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@ITM@bill_item_1@CALLOVER_LEFT", 2, 0, 0, 0);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@ITM@bill_item_1@CALLOVER_RIGHT", 2, 0, 0, 0);
	iLocal_18 = __LIB_6__::func_959(uParam0, "script@vignette@ITM@bill_item_1@CALLOVER_FRONT", 2, 0, 0, 0);
	iLocal_21 = __LIB_6__::func_959(uParam0, "script@vignette@ITM@bill_item_1@ACTION_A", 0, 0, 0, 1);
	__LIB_7__::func_146(uParam0, "CBIT1AU");
	__LIB_7__::func_107(uParam0, iLocal_14, 3, joaat("PROP_HUMAN_SEAT_CHAIR_GROOMING_GROSS"), "PROP_HUMAN_SEAT_CHAIR_GROOMING_GROSS_MALE_B", iLocal_15, 0);
	__LIB_7__::func_127(uParam0, iLocal_14, 3, joaat("PROP_HUMAN_SEAT_CHAIR_GROOMING_GROSS"), "PROP_HUMAN_SEAT_CHAIR_GROOMING_GROSS_MALE_B", iLocal_15, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_151(uParam0, iLocal_14, 2, -1);
	Local_22 = { __LIB_7__::func_160(uParam0, 0f, 0f, 1.4354f, -135.72f, 12f, 0.535f, 0.07f) };
	Local_32 = { __LIB_7__::func_160(uParam0, 0f, 0f, 1.4354f, 128.52f, 12f, 0.118f, 0.473f) };
	Local_42 = { __LIB_7__::func_160(uParam0, 0f, 0f, 1.4354f, 174.5f, 12f, 0.4825f, 0.3925f) };
	Local_52 = { __LIB_7__::func_160(uParam0, -0.0725f, 0.2775f, 1.4354f, 178.25f, 5.875f, 1f, 1f) };
...
bool func_93(var uParam0)
{
	...
	else if (__LIB_7__::func_163(uParam0, Local_22, 1, 0))
	{
		iLocal_19 = iLocal_16;
		return true;
	}
...
{
	return __LIB_7__::func_173(uParam0, iLocal_19, 1);
}

bool func_97(var uParam0)
{
	if (__LIB_3__::func_135(&uLocal_67) >= 40000)
	{
		__LIB_7__::func_113(uParam0, iLocal_14, 1, 1);
		__LIB_7__::func_55(491, 0);
		__LIB_7__::func_17(491, 5000);
		return true;
	}
	...
	if (bLocal_62)
	{
		if (func_209(uParam0))
		{
			...
			{
				MISC::_0xE98D55C5983F2509(__LIB_6__::func_952(uParam0, iLocal_14));
				PLAYER::_0x3946FC742AC305CD(PLAYER::PLAYER_ID(), __LIB_6__::func_952(uParam0, iLocal_14), sLocal_66, 0f, 0f, 0f, 0, sLocal_66);
			}
			__LIB_7__::func_173(uParam0, iLocal_21, 1);
			__LIB_0__::func_37(&uLocal_67);
			bLocal_62 = false;
		}
	}
	return true;
...
{
	if (!__LIB_7__::func_163(uParam0, Local_52, 1, 0))
	{
		__LIB_1__::func_281(&iLocal_64, 1, 1);
		if (!ENTITY::IS_ENTITY_DEAD(__LIB_6__::func_952(uParam0, iLocal_14)))
		{
	...
	if (ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(iLocal_65) != __LIB_6__::func_952(uParam0, iLocal_14))
	{
		__LIB_1__::func_281(&iLocal_64, 1, 1);
		return false;
	}
	...
	{
		iLocal_64 = __LIB_2__::func_403("INTERACT_GREET", joaat("INPUT_INTERACT_LOCKON_POS"), __LIB_6__::func_952(uParam0, iLocal_14), 3, 0, 0, 0, 0, 6f, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, joaat("SHORT_TIMED_EVENT"), 0, 0);
		__LIB_4__::func_12(iLocal_64, HUD::_UIPROMPT_GET_GROUP_ID_FOR_TARGET_ENTITY(__LIB_6__::func_952(uParam0, iLocal_14)), 0, 1);
	}
