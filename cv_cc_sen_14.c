...
bool func_72(var uParam0)
{
	...
	__LIB_7__::func_47(uParam0, 12.3f, 4.5f, 1.612f, 123.25f, 2f, 3.1425f, 3.2075f, joaat("VOLBOX"), joaat("APMS_COMP_SEAN"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, -1.1475f, -1.4025f, 1.4875f, -44f, 1.0975f, 1.145f, 3.2075f, joaat("VOLBOX"), joaat("APMS_COMP_MICAH"), 1, 1, 1);
	iLocal_16 = __LIB_7__::func_142(uParam0, joaat("S_CRATESEAT03X"), -1.16311f, -1.68532f, -0.0235901f, 0, 1, 0, 1);
	__LIB_7__::func_142(uParam0, joaat("P_CIGARETTE_CS01X"), 0f, 0f, 0f, "p_cigarette_cs01x", 0, 1, 1);
	__LIB_7__::func_142(uParam0, joaat("P_CS_RAG02X"), 0f, 0f, 0f, "p_cs_rag02x", 0, 1, 1);
	__LIB_7__::func_271(uParam0, iLocal_14, joaat("WEAPON_REPEATER_CARBINE"), "w_repeater_carbine01");
	__LIB_7__::func_271(uParam0, iLocal_15, joaat("WEAPON_REVOLVER_DOUBLEACTION"), "w_revolver_cattleman01");
	__LIB_6__::func_959(uParam0, "script@vignette@sean_14@base", 1, 1, 0, 0);
	__LIB_6__::func_959(uParam0, "script@vignette@sean_14@Action", 0, 0, 1, 0);
	__LIB_7__::func_146(uParam0, "CSE14AU");
	__LIB_7__::func_107(uParam0, iLocal_14, 3, joaat("WORLD_HUMAN_SMOKE"), "WORLD_HUMAN_SMOKE_MALE_C", -1, 1);
	__LIB_7__::func_127(uParam0, iLocal_14, 3, joaat("WORLD_HUMAN_GUARD_SCOUT"), "WORLD_HUMAN_GUARD_SCOUT_MALE_C", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_158(uParam0, iLocal_14, 3, 0);
	__LIB_7__::func_107(uParam0, iLocal_15, 3, joaat("PROP_CAMP_MICAH_SEAT_CHAIR_CLEAN_GUN"), "PROP_CAMP_MICAH_SEAT_CHAIR_CLEAN_GUN_MALE_A", iLocal_16, 0);
	__LIB_7__::func_127(uParam0, iLocal_15, 3, joaat("PROP_CAMP_MICAH_SEAT_CHAIR_CLEAN_GUN"), "PROP_CAMP_MICAH_SEAT_CHAIR_CLEAN_GUN_MALE_A", iLocal_16, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	return true;
}
