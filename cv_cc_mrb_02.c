...
bool func_73(var uParam0)
{
	...
	{
		case 0:
			__LIB_7__::func_45(uParam0, 107, 0, 0, 0);
			break;
		default:
			return false;
	}
	...
	__LIB_7__::func_47(uParam0, 0.87499f, 0.291573f, 0.481659f, 3f, 0.9f, 0.9f, 2.5f, joaat("VOLBOX"), joaat("APMS_COMP_MARYBETH"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, -0.00493374f, -0.044972f, 0.582031f, 3f, 0.8f, 2f, 2f, joaat("VOLBOX"), joaat("APMS_COMP_JOHN"), 1, 1, 1);
	__LIB_6__::func_958(uParam0, joaat("P_CS_RAG02X"), 0f, 0f, 0f, "RAG", 0, 1, 1);
	if (!__LIB_6__::func_206(1) && !__LIB_6__::func_206(2))
	{
		__LIB_6__::func_958(uParam0, joaat("P_STOOL03X"), 0f, 0f, 0f, "STOOL", 0, 0, 1);
	}
	if (!__LIB_6__::func_206(1) && !__LIB_6__::func_206(2))
	{
		__LIB_6__::func_959(uParam0, "script@vignette@marybeth_2@base", 1, 1, 0, 0);
	}
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@marybeth_2@action_a_left", 2, 0, 0, 1);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@marybeth_2@action_a_right", 2, 0, 0, 1);
	iLocal_18 = __LIB_6__::func_959(uParam0, "script@vignette@marybeth_2@action_b_left", 0, 0, 0, 1);
	iLocal_19 = __LIB_6__::func_959(uParam0, "script@vignette@marybeth_2@action_b_right", 0, 0, 0, 1);
	__LIB_7__::func_146(uParam0, "CMRB2AU");
	iLocal_21 = __LIB_7__::func_156(uParam0, 2.82f, -0.137f, 1f, 0f, 0f, 90f, 5f, 6f, 3f, "TRIGGER", joaat("VOLBOX"));
	__LIB_7__::func_107(uParam0, iLocal_14, 2, joaat("PROP_HUMAN_SEAT_BENCH"), "PROP_HUMAN_SEAT_BENCH_FEMALE_A", -1, 0);
	__LIB_7__::func_127(uParam0, iLocal_14, 2, joaat("PROP_HUMAN_SEAT_BENCH"), "PROP_HUMAN_SEAT_BENCH_FEMALE_A", -1, 0, -1f, 1065353216 /* Float: 1f */, 1);
	...
	__LIB_7__::func_149(uParam0, joaat("COMP_MRBCNV2"), joaat("PLAYER_MRBCNV2"));
	if (__LIB_6__::func_206(1) || __LIB_6__::func_206(2))
	{
		__LIB_7__::func_167(uParam0);
		__LIB_7__::func_168(uParam0);
		__LIB_7__::func_282(uParam0, iLocal_14, 4);
		__LIB_7__::func_365(uParam0, iLocal_14, 4);
...
{
	if (__LIB_7__::func_358(uParam0, &iLocal_21, 1))
	{
		if (__LIB_0__::func_195(-1326.562f, 2441.137f, 309.765f, -1316.062f, 2435.343f, 309.3513f, Global_36))
		{
			iLocal_20 = iLocal_16;
			return true;
		}
...
bool func_94(var uParam0)
{
	if (__LIB_7__::func_148(uParam0, iLocal_20))
	{
		if (__LIB_7__::func_358(uParam0, &iLocal_21, 1))
		{
			if (__LIB_0__::func_195(-1326.562f, 2441.137f, 309.765f, -1316.062f, 2435.343f, 309.3513f, Global_36))
			{
				__LIB_7__::func_150(uParam0, iLocal_18, -1, 0.5f);
				__LIB_7__::func_173(uParam0, iLocal_18, 1);
			}
			else
			{
				__LIB_7__::func_150(uParam0, iLocal_19, -1, 0.5f);
