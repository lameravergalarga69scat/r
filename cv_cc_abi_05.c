...
bool func_72(var uParam0)
{
	...
	{
		case 1:
			__LIB_7__::func_45(uParam0, 136, 0, 0, 0);
			iLocal_37 = joaat("WORLD_CAMP_JACK_TOY_PLAY");
			break;
		case 2:
			__LIB_7__::func_45(uParam0, 73, 0, 0, 0);
	...
	__LIB_7__::func_47(uParam0, -0.95f, -1.85f, 0f, 0f, 5f, 8f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_ABIGAIL"), 1, 1, 1);
	__LIB_6__::func_958(uParam0, joaat("P_CS_BOOK02X"), 0f, 0f, 0f, "BOOK", 0, 1, 1);
	iLocal_25 = __LIB_6__::func_958(uParam0, joaat("P_CHAIR_CRATE15X"), 0f, 0f, 0f, 0, 0, 0, 1);
	iLocal_26 = __LIB_6__::func_958(uParam0, joaat("P_CHAIR_CRATE02X"), 0.77388f, 0.119436f, 0.00186157f, 0, 0, 0, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@abigail_5@base", 1, 1, 0, 0);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@abigail_5@action_a", 2, 0, 1, 0);
	iLocal_18 = __LIB_6__::func_959(uParam0, "script@vignette@abigail_5@action_b", 2, 0, 0, 0);
	iLocal_19 = __LIB_6__::func_959(uParam0, "script@vignette@abigail_5@action_b_alt", 2, 0, 0, 1);
	iLocal_20 = __LIB_6__::func_959(uParam0, "script@vignette@abigail_5@action_c", 2, 0, 0, 0);
	iLocal_21 = __LIB_6__::func_959(uParam0, "script@vignette@abigail_5@action_d", 2, 0, 0, 0);
	iLocal_22 = __LIB_6__::func_959(uParam0, "script@vignette@abigail_5@action_d_alt", 2, 0, 0, 1);
	iLocal_23 = __LIB_6__::func_959(uParam0, "script@vignette@abigail_5@exit_loop", 2, 0, 0, 0);
	iLocal_24 = __LIB_6__::func_959(uParam0, "script@vignette@abigail_5@exit", 0, 0, 0, 0);
	__LIB_7__::func_146(uParam0, "ABI5AUD");
	__LIB_7__::func_149(uParam0, joaat("COMP_ABICNV5"), joaat("PLAYER_ABICNV5"));
	__LIB_7__::func_147(uParam0, iLocal_14, 1, 12, 0, 0, 0);
	__LIB_7__::func_151(uParam0, iLocal_14, 1, -1);
	__LIB_7__::func_147(uParam0, iLocal_15, 1, 2, 0, 0, 0);
	__LIB_7__::func_151(uParam0, iLocal_16, 1, -1);
	__LIB_7__::func_153(uParam0, iLocal_16, 3, iLocal_37, 0, -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_159(uParam0, iLocal_16, 3, 0);
	__LIB_7__::func_145(uParam0, 10f, 13f);
	Local_27 = { __LIB_7__::func_160(uParam0, 1.15f, -1.02f, 1.3f, 36.36f, 6.5f, 0.6f, 0.6f) };
	return true;
}
...
bool func_86(var uParam0)
{
	int iVar0;
	int iVar1;
	iVar0 = __LIB_7__::func_30(uParam0, iLocal_25);
	iVar1 = __LIB_7__::func_30(uParam0, iLocal_26);
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		ENTITY::SET_ENTITY_ROTATION(iVar0, 0f, 0f, __LIB_6__::func_973(uParam0, -172.98f), 2, true);
		ENTITY::FREEZE_ENTITY_POSITION(iVar0, true);
	}
	if (ENTITY::DOES_ENTITY_EXIST(iVar1))
	{
		ENTITY::SET_ENTITY_ROTATION(iVar1, 0f, 0f, __LIB_6__::func_973(uParam0, -153.48f), 2, true);
...
bool func_93(var uParam0)
{
	...
	if (__LIB_7__::func_148(uParam0, iLocal_20))
	{
		if (__LIB_7__::func_163(uParam0, Local_27, 1, 0))
		{
			__LIB_7__::func_150(uParam0, iLocal_22, iLocal_14, 0.77f);
			__LIB_7__::func_154(uParam0, iLocal_22, 1);
		}
		else
		{
			__LIB_7__::func_150(uParam0, iLocal_21, iLocal_14, 0.77f);
...
void func_159(var uParam0, int iParam1, int iParam2, int iParam3)
{
	...
	switch (iParam2)
	{
		case 4:
			...
			break;
		default:
			Var0 = { func_260(__LIB_0__::func_78(uParam0), __LIB_7__::func_120(uParam0, iParam1), __LIB_4__::func_576(uParam0), 1) };
