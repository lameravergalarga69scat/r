...
{
	__LIB_2__::func_851(uParam0, 10870, 10921, 11624);
}
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	int iVar0;
	bool bVar1;
	__LIB_2__::func_853(uParam0, "MOOSE_SLIPPING", "script@ambient@animal@moose_fall_on_ice@action", vParam1, vParam4);
	...
	iLocal_9 = joaat("A_C_MOOSE_01");
	__LIB_2__::func_855(uParam0, 0, "MOOSE", iLocal_9, 0f, 0f, 0f, 0f, iVar0, 1, 1, 1, iLocal_41, 1);
}
...
int func_31(var uParam0)
{
	...
	if (!uParam0->f_469[0])
	{
		if (!bLocal_42 == 1)
		{
			if (__LIB_2__::func_908(uParam0, &uLocal_10, 0) || __LIB_0__::func_232(Global_35, uParam0->f_20[0 /*14*/], 1) <= 225f)
			{
				bLocal_42 = true;
			}
		}
