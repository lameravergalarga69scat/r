...
bool func_1(var uParam0)
{
	...
	if (!bLocal_47)
	{
		ENTITY::SET_ENTITY_COORDS(__LIB_7__::func_30(uParam0, iLocal_23), vLocal_38, true, false, true, true);
		bLocal_47 = true;
	}
	return true;
}
...
bool func_73(var uParam0)
{
	...
	__LIB_7__::func_47(uParam0, -0.9083f, 7.1176f, 1f, 0f, 1.5f, 1.5f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_MOLLY"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, 1.5425f, 2.3927f, 1f, 67.68f, 3f, 2f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_TILLY"), 1, 1, 1);
	__LIB_7__::func_159(uParam0, 1.5425f, 2.3927f, 1f, 67.68f, 3f, 2f, 3f, joaat("VOLBOX"), 1);
	iLocal_24 = __LIB_6__::func_958(uParam0, joaat("P_POCKETMIRROR01X"), 0f, 0f, 0f, "MIRROR", 0, 1, 1);
	iLocal_21 = __LIB_6__::func_958(uParam0, joaat("P_CS_RAG02X"), 0f, 0f, 0f, "RAG", 0, 1, 1);
	iLocal_22 = __LIB_6__::func_958(uParam0, joaat("P_WASHBOARD01X"), 0f, 0f, 0f, "WASHBOARD", 0, 1, 1);
	iLocal_23 = __LIB_6__::func_958(uParam0, joaat("P_BASINWATER01X"), 2.00448f, 2.79416f, 0.00851059f, 0, 1, 0, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@molly_1@base", 1, 1, 0, 0);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@molly_1@action_a", 2, 0, 1, 0);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@molly_1@action_a_int", 2, 0, 0, 1);
	iLocal_19 = __LIB_6__::func_959(uParam0, "script@vignette@molly_1@wait_idle_loop", 1, 0, 0, 0);
	iLocal_20 = __LIB_6__::func_959(uParam0, "script@vignette@molly_1@wait_idle_exit", 2, 0, 0, 1);
	iLocal_18 = __LIB_6__::func_959(uParam0, "script@vignette@molly_1@action_b", 0, 0, 0, 0);
	__LIB_7__::func_146(uParam0, "CML1AUD");
	__LIB_7__::func_107(uParam0, iLocal_14, 3, joaat("WORLD_HUMAN_POCKET_MIRROR"), "WORLD_HUMAN_POCKET_MIRROR_FEMALE_A", -1, 1);
	__LIB_7__::func_127(uParam0, iLocal_15, 3, joaat("WORLD_HUMAN_WASHBOARD"), "WORLD_HUMAN_WASHBOARD_FEMALE_A", -1, 1, 10f, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_259(uParam0, iLocal_15, iLocal_22, "p_washboard01x_PH_L_HAND", 1, "p_washboard01x_PH_L_HAND");
	__LIB_7__::func_259(uParam0, iLocal_15, iLocal_21, "p_cs_rag02x_PH_R_HAND", 0, 0);
	Local_25 = { __LIB_7__::func_160(uParam0, 0.9128f, 2.0361f, 1.1128f, 59.76f, 5f, 0.7f, 0.7f) };
	return true;
}
...
{
	int iVar0;
	iVar0 = __LIB_7__::func_30(uParam0, iLocal_23);
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		vLocal_38 = { ENTITY::GET_ENTITY_COORDS(iVar0, false, false) };
		ENTITY::SET_ENTITY_COORDS(iVar0, __LIB_6__::func_972(uParam0, vLocal_41), true, false, true, true);
	}
	return true;
}
...
bool func_94(var uParam0)
{
	if (!bLocal_45)
	{
		if (__LIB_7__::func_148(uParam0, iLocal_16))
		{
			...
			__LIB_7__::func_305(uParam0, iLocal_24);
		}
		if (!__LIB_7__::func_163(uParam0, Local_25, 1, 0) && __LIB_7__::func_169(uParam0, iLocal_19))
		{
