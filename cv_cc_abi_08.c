...
bool func_72(var uParam0)
{
	...
	{
		case 3:
			__LIB_7__::func_45(uParam0, 204, 0, 0, 0);
			break;
		default:
			return false;
	}
	...
	__LIB_7__::func_47(uParam0, 0.275f, -0.1f, 0f, -16f, 5.855f, 3f, 5f, joaat("VOLBOX"), -1, 1, 1, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@abigail_8@base", 1, 1, 0, 0);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@abigail_8@action_a", 2, 0, 1, 0);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@abigail_8@action_b", 0, 0, 0, 0);
	iLocal_18 = __LIB_6__::func_959(uParam0, "script@vignette@abigail_8@action_b_alt_front", 0, 0, 0, 1);
	iLocal_19 = __LIB_6__::func_959(uParam0, "script@vignette@abigail_8@action_b_alt_left", 0, 0, 0, 1);
	iLocal_20 = __LIB_6__::func_959(uParam0, "script@vignette@abigail_8@action_b_alt_right", 0, 0, 0, 1);
	__LIB_7__::func_146(uParam0, "CABI8AU");
	__LIB_7__::func_149(uParam0, joaat("COMP_ABICNV8"), joaat("PLAYER_ABICNV8"));
	__LIB_7__::func_147(uParam0, iLocal_14, 2, 6, 0, "Default_Angry", 0);
	__LIB_7__::func_151(uParam0, iLocal_14, 1, 600);
	__LIB_7__::func_153(uParam0, iLocal_14, 1, joaat("WORLD_HUMAN_STAND_WAITING"), 0, -1, 0, 90f, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_330(uParam0, iLocal_14, 1.5f, 1f, 10f);
	__LIB_7__::func_147(uParam0, iLocal_15, 1, 6, 0, 0, 0);
	__LIB_7__::func_151(uParam0, iLocal_15, 1, 600);
	__LIB_7__::func_153(uParam0, iLocal_15, 1, joaat("WORLD_HUMAN_STARE_STOIC"), 0, -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	Local_21 = { __LIB_7__::func_160(uParam0, 2.9764f, -0.9499f, 1.2095f, 167.1853f, 8f, 0.56f, 0.21f) };
	Local_31 = { __LIB_7__::func_160(uParam0, 2.3222f, -1.1977f, 1.1786f, 110.1719f, 8f, 0.46f, 0.22f) };
	Local_41 = { __LIB_7__::func_160(uParam0, 3.6042f, -0.3755f, 1.2095f, -129.6687f, 8f, 0.4f, 0.21f) };
	return true;
}
...
{
	return !__LIB_3__::func_291(Global_35, 1);
}
