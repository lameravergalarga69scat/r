...
void __EntryFunction__()
{
	...
	fLocal_7 = 1f;
	fLocal_8 = 1f;
	iLocal_80 = joaat("DEAD_CARRIABLE_RABBIT");
	Var0 = -1;
	Var0.f_1 = -1;
	Var0.f_2 = -1;
	Var0.f_17 = 10;
...
bool func_1(var uParam0)
{
	...
	ENTITY::_0x18FF3110CF47115D(__LIB_6__::func_952(uParam0, iLocal_24), 7, 0);
	return true;
}
...
bool func_72(var uParam0)
{
	...
	{
		case 1:
			__LIB_7__::func_45(uParam0, 161, 0, 0, 0);
			vLocal_75 = { -144.0518f, -20.42944f, 95.08838f };
			break;
		case 2:
			__LIB_7__::func_116(uParam0, 701.3178f, -1234.53f, 43.9689f, 0f, 0f, -38.88f);
			vLocal_75 = { 678.2941f, -1248.784f, 43.00787f };
			break;
		default:
			return false;
	}
	iLocal_14 = __LIB_7__::func_48(uParam0, 8, 0);
	iLocal_15 = __LIB_7__::func_48(uParam0, 14, 0);
	iLocal_24 = __LIB_7__::func_31(uParam0, joaat("A_C_RABBIT_01"), "RABBIT");
	__LIB_7__::func_47(uParam0, 4.5375f, 3.1625f, 1f, 80f, 2.5f, 2.5f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_SEAN"), 1, 1, 1);
	__LIB_6__::func_958(uParam0, joaat("P_STICKFIREPOKER01X"), 0f, 0f, 0f, "Stick", 0, 1, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@sean_9@base", 1, 1, 0, 0);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@sean_9@action_a", 2, 0, 1, 0);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@sean_9@ACTION_A_INT_BACK_LEFT", 2, 0, 0, 1);
	iLocal_18 = __LIB_6__::func_959(uParam0, "script@vignette@sean_9@ACTION_A_INT_BACK_RIGHT", 2, 0, 0, 1);
	iLocal_19 = __LIB_6__::func_959(uParam0, "script@vignette@sean_9@ACTION_A_INT_FRONT", 2, 0, 0, 1);
	iLocal_20 = __LIB_6__::func_959(uParam0, "script@vignette@sean_9@ACTION_A_INT_LEFT", 2, 0, 0, 1);
	iLocal_21 = __LIB_6__::func_959(uParam0, "script@vignette@sean_9@ACTION_A_INT_RIGHT", 2, 0, 0, 1);
	iLocal_22 = __LIB_6__::func_959(uParam0, "script@vignette@sean_9@action_b", 0, 0, 0, 0);
	__LIB_7__::func_146(uParam0, "CSEN9AU");
	__LIB_7__::func_107(uParam0, iLocal_14, 3, joaat("WORLD_HUMAN_INSPECT"), "WORLD_HUMAN_INSPECT_MALE_B", -1, 1);
	__LIB_7__::func_172(uParam0, iLocal_14, 1);
	__LIB_7__::func_107(uParam0, iLocal_15, 3, joaat("WORLD_CAMP_JACK_POKE_GROUND_STICK"), "WORLD_CAMP_JACK_POKE_GROUND_STICK_MALE_A", -1, 1);
	Local_45 = { __LIB_7__::func_160(uParam0, 4.618f, 3.518f, 1.07f, 80.88f, 6.5f, 0.345f, 0.4175f) };
	Local_25 = { __LIB_7__::func_160(uParam0, 4.618f, 3.518f, 1.07f, -122.78f, 6.09f, 0.075f, 0.66f) };
	Local_35 = { __LIB_7__::func_160(uParam0, 4.618f, 3.518f, 1.07f, -47.16f, 6.5f, 0.21f, 0.301f) };
	Local_55 = { __LIB_7__::func_160(uParam0, 4.618f, 3.518f, 1.07f, 164f, 6.5f, 0.1525f, 0.58f) };
	Local_65 = { __LIB_7__::func_160(uParam0, 4.618f, 3.518f, 1.07f, 44f, 6.5f, 0f, 0.7925f) };
...
{
	if (ENTITY::DOES_ENTITY_EXIST(__LIB_6__::func_952(uParam0, iLocal_24)))
	{
		__LIB_3__::func_459(__LIB_6__::func_952(uParam0, iLocal_24), 0);
		ENTITY::_0x18FF3110CF47115D(__LIB_6__::func_952(uParam0, iLocal_24), 7, 0);
		PED::SET_PED_CONFIG_FLAG(__LIB_6__::func_952(uParam0, iLocal_24), 243, true);
		PED::_SET_PED_BODY_COMPONENT(__LIB_6__::func_952(uParam0, iLocal_24), -1153495004);
		PED::_UPDATE_PED_VARIATION(__LIB_6__::func_952(uParam0, iLocal_24), false, true, true, true, false);
		return true;
	}
	return false;
}
...
bool func_93(var uParam0)
{
	...
	{
		if (__LIB_7__::func_163(uParam0, Local_25, 1, 0))
		{
			iLocal_23 = iLocal_17;
			__LIB_7__::func_173(uParam0, iLocal_23, 1);
		}
		else if (__LIB_7__::func_163(uParam0, Local_35, 1, 0))
		{
			iLocal_23 = iLocal_18;
			__LIB_7__::func_173(uParam0, iLocal_23, 1);
		}
	...
	if (__LIB_6__::func_997(uParam0, iLocal_24))
	{
		ENTITY::_0x18FF3110CF47115D(__LIB_6__::func_952(uParam0, iLocal_24), 7, 1);
		TASK::TASK_CARRIABLE(__LIB_6__::func_952(uParam0, iLocal_24), iLocal_80, __LIB_6__::func_952(uParam0, iLocal_14), 0, 0);
	}
	if (!bLocal_78)
	{
		if (__LIB_7__::func_74(uParam0, iLocal_14))
		{
			if (ENTITY::_0x61914209C36EFDDB(__LIB_6__::func_952(uParam0, iLocal_24)) == 5)
			{
				TASK::TASK_PLACE_CARRIED_ENTITY_AT_COORD(__LIB_6__::func_952(uParam0, iLocal_14), __LIB_6__::func_952(uParam0, iLocal_24), vLocal_75, 1f, 0);
				bLocal_78 = true;
			}
		}
	}
	if (bLocal_78)
	{
		if (TASK::GET_SCRIPT_TASK_STATUS(__LIB_6__::func_952(uParam0, iLocal_14), -208384378, true) == 8 && !ENTITY::_0x61914209C36EFDDB(__LIB_6__::func_952(uParam0, iLocal_24)) == 5)
		{
			__LIB_7__::func_113(uParam0, iLocal_14, 1, 1);
		}
		else if (!__LIB_0__::func_163(__LIB_6__::func_952(uParam0, iLocal_14), -208384378))
		{
			TASK::TASK_PLACE_CARRIED_ENTITY_AT_COORD(__LIB_6__::func_952(uParam0, iLocal_14), __LIB_6__::func_952(uParam0, iLocal_24), vLocal_75, 1f, 0);
		}
	}
