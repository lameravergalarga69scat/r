...
bool func_72(var uParam0)
{
	...
	__LIB_7__::func_47(uParam0, 0.846151f, 0.412679f, 1.05988f, 3f, 0.9f, 0.9f, 2.5f, joaat("VOLBOX"), joaat("APMS_COMP_GRIMSHAW"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, -0.0243275f, 0.117172f, 0.549988f, 3f, 0.8f, 2f, 2f, joaat("VOLBOX"), joaat("APMS_COMP_JOHN"), 1, 1, 1);
	iLocal_19 = __LIB_6__::func_958(uParam0, joaat("P_STOOL03X"), 0f, 0f, 0f, "p_stool03x", 0, 0, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@susan_2@base", 1, 1, 0, 0);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@susan_2@action_Left", 0, 0, 0, 1);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@susan_2@action_Right", 0, 0, 0, 1);
	__LIB_7__::func_146(uParam0, "CSSN2AU");
	__LIB_7__::func_149(uParam0, joaat("COMP_SSNCNV2"), joaat("PLAYER_SSNCNV2"));
	Local_20 = { __LIB_7__::func_160(uParam0, 0.952f, 0.3487f, 0.6824f, -109.5f, 10f, 0.189f, 0.625f) };
	Local_30 = { __LIB_7__::func_160(uParam0, 0.952f, 0.3487f, 0.6824f, -49.75f, 10f, 0.8f, 0.475f) };
	__LIB_7__::func_296(uParam0, iLocal_14, 2, joaat("PROP_HUMAN_SEAT_BENCH"), "PROP_HUMAN_SEAT_BENCH_FEMALE_A", iLocal_19, 0, 20f, 0f, 1);
	__LIB_7__::func_172(uParam0, iLocal_14, 1);
	__LIB_7__::func_151(uParam0, iLocal_14, 1, -1);
	__LIB_7__::func_296(uParam0, iLocal_15, 4, joaat("WORLD_CAMP_JOHN_RECOVER"), "WORLD_CAMP_JOHN_RECOVER_MALE_A", -1, 0, -1f, 0f, 1);
	__LIB_7__::func_171(uParam0, iLocal_15, 4, 1);
	__LIB_7__::func_151(uParam0, iLocal_15, 1, -1);
	iLocal_40 = __LIB_7__::func_156(uParam0, 5.1001f, 1.0375f, 0f, 0f, 0f, 0f, 11.6375f, 3.7475f, 3f, "InitialTrigger", joaat("VOLBOX"));
	return true;
}
...
{
	if (__LIB_1__::func_205(Global_35, iLocal_40, 1, 0))
	{
		return true;
	}
	return false;
...
bool func_90(var uParam0)
{
	...
	__LIB_7__::func_99(uParam0, iLocal_18, 1);
	return true;
}
...
bool func_93(var uParam0)
{
	...
	if (bLocal_41)
	{
		if (ENTITY::IS_ENTITY_OCCLUDED(__LIB_6__::func_952(uParam0, iLocal_14)))
		{
			...
			TASK::CLEAR_PED_TASKS_IMMEDIATELY(__LIB_6__::func_952(uParam0, iLocal_14), false, true);
			TASK::_TASK_USE_SCENARIO_POINT(__LIB_6__::func_952(uParam0, iLocal_14), iLocal_42, "PROP_HUMAN_SEAT_BENCH_FEMALE_A", 0, false, true, 0, false, -1f, false);
...
{
	if (!PED::_IS_PED_USING_SCENARIO_POINT(__LIB_6__::func_952(uParam0, iLocal_14), iLocal_42))
	{
		return true;
	}
	return false;
