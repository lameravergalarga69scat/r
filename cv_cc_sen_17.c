...
bool func_72(var uParam0)
{
	...
	__LIB_7__::func_47(uParam0, -6.4125f, 0.55f, 0.782f, 80f, 1f, 1f, 2.2325f, joaat("VOLBOX"), joaat("APMS_COMP_SEAN"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, 1.99f, 1.61f, 1.1875f, -23.75f, 1.0175f, 0.9225f, 3.2075f, joaat("VOLBOX"), joaat("APMS_COMP_MARYBETH"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, 1.59f, 0.8225f, 1.1875f, -28f, 1.12f, 0.9225f, 3.2075f, joaat("VOLBOX"), joaat("APMS_COMP_TILLY"), 1, 1, 1);
	iLocal_17 = __LIB_6__::func_958(uParam0, joaat("P_CS_LEDGERSMALL01X"), 0f, 0f, 0f, "BOOK", 0, 0, 1);
	...
	__LIB_7__::func_107(uParam0, iLocal_14, 3, joaat("WORLD_HUMAN_SIT_GROUND"), "WORLD_HUMAN_SIT_GROUND_FEMALE_A", -1, 1);
	...
	__LIB_7__::func_107(uParam0, iLocal_15, 3, joaat("WORLD_HUMAN_SIT_GROUND_READING"), "WORLD_HUMAN_SIT_GROUND_READING_JOURNAL_FEMALE_A", -1, 1);
	__LIB_7__::func_127(uParam0, iLocal_15, 2, joaat("WORLD_HUMAN_SIT_GROUND_READING"), "WORLD_HUMAN_SIT_GROUND_READING_JOURNAL_FEMALE_A", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_139(uParam0, iLocal_15, iLocal_17, "p_cs_ledgerSmall01x_PH_L_HAND", 0, 0);
	__LIB_7__::func_147(uParam0, iLocal_15, 4, 2, 0, 0, 0);
	__LIB_6__::func_959(uParam0, "script@vignette@sean_17@base", 1, 1, 0, 0);
	__LIB_6__::func_959(uParam0, "script@vignette@sean_17@action", 0, 0, 1, 0);
	__LIB_7__::func_146(uParam0, "CSE17AU");
	return true;
}
