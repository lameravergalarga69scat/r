...
bool func_72(var uParam0)
{
	...
	iLocal_14 = __LIB_7__::func_48(uParam0, 7, "IG_CharlesSmith");
	iLocal_15 = __LIB_7__::func_48(uParam0, 4, "IG_UNCLE");
	__LIB_7__::func_47(uParam0, -0.5001f, 1.2125f, 0f, 0f, 1f, 1f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_UNCLE"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, -0.0251f, -1.175f, 0f, 0f, 1f, 1f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_CHARLES"), 1, 1, 1);
	__LIB_7__::func_159(uParam0, -0.15f, 0f, 0f, 12f, 0.94f, 1.57f, 3f, joaat("VOLCYLINDER"), 1);
	iLocal_16 = __LIB_6__::func_958(uParam0, joaat("P_BOTTLEBEER01X"), 0f, 0f, 0f, "S_INV_WHISKEY01X", 0, 0, 1);
	iLocal_17 = __LIB_6__::func_958(uParam0, joaat("P_JAVIERKNIFE_TEMP"), 0f, 0f, 0f, "w_melee_knife06", 0, 0, 1);
	iLocal_18 = __LIB_6__::func_958(uParam0, joaat("P_WOODWHITTLE01X"), 0f, 0f, 0f, "p_woodWhittle01x", 0, 0, 1);
	iLocal_19 = __LIB_6__::func_958(uParam0, joaat("P_CHAIR_BARREL04B"), -0.434831f, 1.30266f, -0.00206757f, "p_chair_barrel04b", 1, 0, 1);
	iLocal_20 = __LIB_6__::func_958(uParam0, joaat("P_CHAIR_CRATE15X"), 0f, 0f, 0f, "p_chair_crate15x", 0, 0, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@beecher@charles_and_uncle_1@base", 1, 1, 0, 0);
	__LIB_6__::func_959(uParam0, "script@vignette@beecher@charles_and_uncle_1@action", 0, 0, 1, 0);
	__LIB_7__::func_146(uParam0, "BCCU1AU");
	__LIB_7__::func_127(uParam0, iLocal_14, 2, joaat("PROP_HUMAN_SEAT_CHAIR_WHITTLE"), "PROP_HUMAN_SEAT_CHAIR_WHITTLE_MALE_C", iLocal_20, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_139(uParam0, iLocal_14, iLocal_17, "p_Javierknife_temp_PH_R_Hand", 0, 0);
	__LIB_7__::func_139(uParam0, iLocal_14, iLocal_18, "p_woodWhittle01x_PH_L_HAND", 0, 0);
	__LIB_7__::func_107(uParam0, iLocal_15, 3, joaat("CC_PROP_CAMP_FIRE_SEATED_DRINKING"), "PROP_CAMP_FIRE_SEATED_DRINKING_BEER_MALE_B", iLocal_19, 0);
	__LIB_7__::func_127(uParam0, iLocal_15, 2, joaat("CC_PROP_CAMP_FIRE_SEATED_DRINKING"), "PROP_CAMP_FIRE_SEATED_DRINKING_BEER_MALE_B", iLocal_19, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_139(uParam0, iLocal_15, iLocal_16, "p_bottleBeer01x_PH_R_HAND", 0, 0);
	__LIB_7__::func_137(uParam0, iLocal_15, "START_SEATED_DRINKING_BEER_MALE_B_TO_SEAT_BENCH_MALE_A");
...
{
	return __LIB_9__::func_429(Global_35, uParam0->f_23, 60f, 1, 0);
}
