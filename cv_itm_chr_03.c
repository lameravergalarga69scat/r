...
{
	__LIB_1__::func_281(&iLocal_30, 1, 1);
...
{
	__LIB_7__::func_45(uParam0, 36, 0, 0, 0);
	iLocal_14 = __LIB_7__::func_48(uParam0, 7, 0);
	__LIB_7__::func_47(uParam0, -3.0885f, 0.0336f, 0f, 0f, 1f, 1f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_CHARLES"), 1, 1, 1);
	iLocal_16 = __LIB_6__::func_958(uParam0, joaat("P_HAMMERCLAW01X"), 0f, 0f, 0f, "HAMMER", 0, 0, 1);
	iLocal_17 = __LIB_6__::func_958(uParam0, joaat("P_NAILSINGLE01X"), 0f, 0f, 0f, "NAIL", 0, 0, 1);
	iLocal_18 = __LIB_6__::func_958(uParam0, joaat("SCRIPTEDBALL"), -3.16997f, 0.0431389f, 1.01684f, 0, 0, 1, 1);
	iLocal_15 = __LIB_6__::func_959(uParam0, "script@vignette@itm@charles_item_3@action", 0, 0, 0, 1);
	__LIB_7__::func_146(uParam0, "CCHI3");
	__LIB_7__::func_107(uParam0, iLocal_14, 3, joaat("WORLD_HUMAN_HAMMER_WALL"), "WORLD_HUMAN_HAMMER_WALL_MALE_A", -1, 1);
	__LIB_7__::func_127(uParam0, iLocal_14, 3, joaat("WORLD_HUMAN_HAMMER_WALL"), "WORLD_HUMAN_HAMMER_WALL_MALE_A", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_139(uParam0, iLocal_14, iLocal_16, "p_hammerClaw01x_PH_R_HAND", 0, 0);
	__LIB_7__::func_139(uParam0, iLocal_14, iLocal_17, "p_nailSingle01x_PH_L_HAND", 0, 0);
	__LIB_7__::func_147(uParam0, iLocal_14, 4, 2, 0, 0, 0);
	__LIB_7__::func_151(uParam0, iLocal_14, 2, -1);
	Local_19 = { __LIB_7__::func_160(uParam0, -3.17f, 0.0431f, 1.1559f, -180f, 5.3f, 0.65f, 0.65f) };
...
{
	if (ENTITY::DOES_ENTITY_EXIST(__LIB_7__::func_30(uParam0, iLocal_18)))
	{
		ENTITY::SET_ENTITY_HEADING(__LIB_7__::func_30(uParam0, iLocal_18), 65.69f);
		ENTITY::SET_ENTITY_VISIBLE(__LIB_7__::func_30(uParam0, iLocal_18), false);
	}
	return true;
}
...
bool func_94(var uParam0)
{
	if (!ENTITY::IS_ENTITY_DEAD(__LIB_6__::func_952(uParam0, iLocal_14)))
	{
		PLAYER::_0x3946FC742AC305CD(PLAYER::PLAYER_ID(), __LIB_6__::func_952(uParam0, iLocal_14), sLocal_32, 0f, 0f, 0f, __LIB_7__::func_30(uParam0, iLocal_18), sLocal_32);
		MISC::_0xE98D55C5983F2509(__LIB_6__::func_952(uParam0, iLocal_14));
	}
	__LIB_1__::func_281(&iLocal_30, 1, 1);
...
int func_198(var uParam0)
{
	...
	if (ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(iLocal_31) != __LIB_6__::func_952(uParam0, iLocal_14))
	{
		__LIB_1__::func_281(&iLocal_30, 1, 1);
		return 0;
	}
	if (!__LIB_0__::func_139(iLocal_30))
	{
		iLocal_30 = __LIB_2__::func_403("INTERACT_GREET", joaat("INPUT_INTERACT_LOCKON_POS"), __LIB_6__::func_952(uParam0, iLocal_14), 3, 0, 0, 0, 0, 6f, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, joaat("SHORT_TIMED_EVENT"), 0, 0);
		__LIB_4__::func_12(iLocal_30, HUD::_UIPROMPT_GET_GROUP_ID_FOR_TARGET_ENTITY(__LIB_6__::func_952(uParam0, iLocal_14)), 0, 1);
	}
	if (__LIB_1__::func_732(iLocal_30, 1))
	{
		return 1;
	}
	return 0;
...
int func_255()
{
	...
	if (func_346(joaat("CSTAG_PLAYER_DONATED_FOOD"), 1))
	{
		return 1;
	}
	return 0;
...
int func_256()
{
	...
	if (func_346(joaat("CSTAG_PLAYER_DONATED_MONEY"), 1))
	{
		return 1;
	}
	return 0;
...
char* func_383(int iParam0, bool bParam1)
{
	switch (iParam0)
	{
		...
		case 12:
			...
			else if (func_346(joaat("CSTAG_FLOW_DOG_IN_CAMP_POST"), 1))
			{
				return "COMP_CAIN";
			}
			return "COMP_DOG";
	...
	switch (Global_1360165[iParam0 /*1157*/].f_11)
	{
		...
		case 3:
			if (!ENTITY::IS_ENTITY_DEAD(Global_1360165[iParam0 /*1157*/]) && !ANIMSCENE::_0x3AB6C7B0BB0DF4B1(Global_1360165[iParam0 /*1157*/], -1))
			{
				...
				func_458(Global_1360165[iParam0 /*1157*/], vVar0, iParam6, 2, 1073741824 /* Float: 2f */);
			}
			else if (bParam16)
			{
...
int func_448(int iParam0, bool bParam1, bool bParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7, bool bParam8, bool bParam9, int iParam10)
{
	...
	switch (Global_1360165[iParam0 /*1157*/].f_70.f_12)
	{
		case 0:
			...
			{
				if (!func_484(iParam0) && __LIB_0__::func_852(iParam0, &uVar4))
				{
		...
		case 3:
			...
			if ((bParam2 && !__LIB_0__::func_86(vVar0)) && !__LIB_0__::func_175(vVar0, ENTITY::GET_ENTITY_COORDS(Global_1360165[iParam0 /*1157*/].f_124, true, false), 1056964608 /* Float: 0.5f */, 1))
			{
				...
				func_458(Global_1360165[iParam0 /*1157*/].f_124, vVar0, iParam6, 2, 1073741824 /* Float: 2f */);
			}
			if (bParam1)
			{
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_346(joaat("CSTAG_FLOW_MAR8_POST"), 1) && !__LIB_1__::func_25(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
