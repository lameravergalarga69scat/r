...
bool func_72(var uParam0)
{
	...
	{
		case 8:
			__LIB_7__::func_45(uParam0, 27, 0, 0, 0);
			break;
		default:
			return false;
	}
	iLocal_14 = __LIB_7__::func_48(uParam0, 7, 0);
	__LIB_7__::func_271(uParam0, iLocal_14, joaat("WEAPON_REPEATER_WINCHESTER"), "GUN");
	__LIB_6__::func_959(uParam0, "script@vignette@beecher@charles_5@base", 1, 1, 0, 0);
	__LIB_6__::func_959(uParam0, "script@vignette@beecher@charles_5@action", 0, 0, 1, 1);
	__LIB_7__::func_146(uParam0, "BCHR5AU");
	__LIB_7__::func_107(uParam0, iLocal_14, 3, joaat("WORLD_HUMAN_GUARD_SCOUT"), "WORLD_HUMAN_GUARD_SCOUT_MALE_C", -1, 1);
...
void func_157(var uParam0, int iParam1, int iParam2, int iParam3)
{
	...
	switch (iParam2)
	{
		case 4:
			...
			break;
		default:
			Var0 = { func_252(__LIB_0__::func_78(uParam0), __LIB_7__::func_120(uParam0, iParam1), __LIB_4__::func_576(uParam0), 1) };
