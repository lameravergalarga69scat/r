...
bool func_7(var uParam0)
{
	...
	switch (__LIB_6__::func_949(uParam0))
	{
		...
		case 4:
			...
			break;
		case 5:
			if (__LIB_19__::func_127(uParam0))
			{
				__LIB_6__::func_936(uParam0, 6);
			}
			break;
...
bool func_72(var uParam0)
{
	...
	{
		case 3:
			__LIB_7__::func_116(uParam0, 1891.641f, -1870.441f, 42.1457f, 0f, 0f, -31.88f);
			break;
		default:
			return false;
	}
	...
	__LIB_7__::func_47(uParam0, -0.45f, 0f, 1.1367f, -12.5f, 1f, 1f, 3.395f, joaat("VOLBOX"), joaat("APMS_COMP_DUTCH"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, 4.3f, -7.2f, 1.0599f, -29f, 1f, 1f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_ABIGAIL"), 1, 1, 1);
	__LIB_6__::func_958(uParam0, joaat("P_CHAIRFOLDING02X"), 0f, 0f, 0f, "CHAIR", 1, 0, 1);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@dutch_and_abigail_1@base", 2, 1, 0, 0);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@dutch_and_abigail_1@action", 0, 0, 0, 0);
	iLocal_19 = __LIB_7__::func_32(uParam0, iLocal_16, "pl_base", 1);
	iLocal_18 = __LIB_7__::func_32(uParam0, iLocal_16, "pl_idles", 1);
	__LIB_7__::func_146(uParam0, "CDNA1AU");
	__LIB_7__::func_149(uParam0, joaat("COMP_DNACNV1"), joaat("PLAYER_DNACNV1"));
	...
	__LIB_7__::func_107(uParam0, iLocal_14, 3, joaat("WORLD_HUMAN_LEAN_BACK_WALL_NO_PROPS"), "WORLD_HUMAN_LEAN_BACK_WALL_FEMALE_B", -1, 1);
	__LIB_7__::func_145(uParam0, 10f, 25f);
	return true;
}
...
{
	__LIB_7__::func_33(uParam0, iLocal_18, 1);
	__LIB_7__::func_284(uParam0, iLocal_18);
	return true;
}
...
bool func_87(var uParam0)
{
	if (bLocal_20)
	{
		__LIB_7__::func_83(uParam0, iLocal_16, "b_breakout", 1);
	}
	return true;
}
...
bool func_89(var uParam0)
{
	...
	{
		__LIB_7__::func_33(uParam0, iLocal_19, 1);
		__LIB_7__::func_284(uParam0, iLocal_19);
		return true;
	}
	return false;
}
