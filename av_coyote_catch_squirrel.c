...
{
	__LIB_2__::func_851(uParam0, 10845, 10897, 12049);
}

void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	__LIB_2__::func_853(uParam0, "COYOTE_CATCH_SQUIRREL", "script@ambient@animal@COYOTE_CATCH_SQUIRREL@action", vParam1, vParam4);
	uParam0->f_16 = 1;
	__LIB_2__::func_854(uParam0, 1, "pbl_action", "", 0);
	__LIB_2__::func_855(uParam0, 0, "COYOTE", iLocal_37, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 0);
	__LIB_2__::func_855(uParam0, 1, "SQUIRREL", iLocal_38, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 0);
}
...
int func_30(var uParam0)
{
	...
	__LIB_2__::func_906(&uLocal_9, 80);
	return 1;
}
...
int func_31(var uParam0)
{
	...
	if (!uParam0->f_469[0])
	{
		if (!bLocal_39)
		{
			if (__LIB_2__::func_908(uParam0, &uLocal_9, 1) || __LIB_0__::func_232(Global_35, uParam0->f_20[0 /*14*/], 1) <= 625f)
			{
				bLocal_39 = true;
			}
		}
	...
	if (uParam0->f_469[0])
	{
		if (__LIB_1__::func_285(&uLocal_40, 3f))
		{
			return 1;
		}
	}
						...
						if (ANIMSCENE::_0x1F0E401031E20146(uParam0->f_3.f_1, "pbl_action"))
						{
							if (ENTITY::HAS_ANIM_EVENT_FIRED(uParam0->f_20[0 /*14*/], joaat("ENDSINRUN")))
							{
								if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
								{
									...
									{
										TASK::_TASK_SMART_FLEE_STYLE_COORD(uParam0->f_20[0 /*14*/], uParam0->f_20[0 /*14*/].f_5, 3, 256, -1082130432 /* Float: -1f */, -1, 0);
...
int func_32(var uParam0, bool bParam1)
{
	...
	{
		if ((!bVar0 || MISC::HAS_BULLET_IMPACTED_IN_AREA(ENTITY::GET_ENTITY_COORDS(uParam0->f_20[1 /*14*/], false, false), 0.5f, true, true)) || MISC::_0x7A76104CC2CC69E8(uParam0->f_20[0 /*14*/], 1, 1))
		{
