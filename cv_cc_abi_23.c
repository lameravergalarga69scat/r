...
bool func_72(var uParam0)
{
	...
	__LIB_7__::func_47(uParam0, 0.0875f, 0.1625f, 1.4875f, 0f, 3.345f, 3.06f, 3.2075f, joaat("VOLBOX"), joaat("APMS_COMP_ABIGAIL"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, -2.2875f, -5.8625f, 1.4875f, 0f, 1.2f, 1.2f, 3.2075f, joaat("VOLBOX"), joaat("APMS_COMP_KIERAN"), 1, 1, 1);
	iLocal_17 = __LIB_7__::func_142(uParam0, joaat("S_CRATESEAT03X"), -1.28962f, 0.762005f, -0.0126915f, 0, 1, 0, 1);
	__LIB_7__::func_142(uParam0, joaat("P_CS_SADDLE02X"), 0f, 0f, 0f, "p_cs_saddle02x", 0, 1, 1);
	__LIB_7__::func_142(uParam0, joaat("P_BRUSHHORSE01X"), 0f, 0f, 0f, "BRUSH", 0, 1, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@abigail_23@base", 1, 1, 0, 0);
	iLocal_18 = __LIB_6__::func_959(uParam0, "script@vignette@abigail_23@action_a", 0, 0, 1, 0);
	__LIB_7__::func_146(uParam0, "CAB23AU");
	__LIB_7__::func_149(uParam0, joaat("COMP_ABICNV23"), joaat("PLAYER_ABICNV23"));
	__LIB_7__::func_150(uParam0, iLocal_18, -1, 0.95f);
	__LIB_7__::func_296(uParam0, iLocal_14, 3, joaat("GENERIC_SEAT_CHAIR_TABLE_SCENARIO"), "GENERIC_SEAT_CHAIR_TABLE_SCENARIO_LF_FWD_FEMALE_A", iLocal_17, 0, 0.1f, 1.75f, 0);
	...
	__LIB_7__::func_296(uParam0, iLocal_16, 3, joaat("WORLD_HUMAN_STARE_STOIC"), 0, -1, 1, 55f, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_171(uParam0, iLocal_16, 3, 0);
	__LIB_7__::func_147(uParam0, iLocal_16, 1, 2, 0, 0, 0);
	return true;
}
