...
bool func_72(var uParam0)
{
	...
	{
		case 8:
			__LIB_7__::func_116(uParam0, -1606.384f, -1422.841f, 80.727f, 0f, 0f, 0f);
			__LIB_7__::func_116(uParam0, -1596.284f, -1436.341f, 80.275f, -0.1f, 1.3f, -30.26f);
			break;
		default:
			return false;
	}
	...
	__LIB_7__::func_159(uParam0, 0.65f, 1.1f, 0f, -120f, 0.5f, 0.35f, 3f, joaat("VOLCYLINDER"), 1);
	__LIB_6__::func_958(uParam0, joaat("P_HAYBALE03X"), 0f, 0f, 0f, "HAYBALE", 0, 0, 1);
	__LIB_7__::func_31(uParam0, joaat("A_C_HORSE_MORGAN_FLAXENCHESTNUT"), "HORSE");
	__LIB_6__::func_959(uParam0, "script@vignette@beecher@jack_1@base", 1, 1, 0, 0);
	iLocal_15 = __LIB_6__::func_959(uParam0, "script@vignette@beecher@jack_1@action_a", 2, 0, 1, 0);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@beecher@jack_1@action_b", 2, 0, 0, 1);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@beecher@jack_1@action_c", 0, 0, 0, 1);
	__LIB_7__::func_146(uParam0, "BJCK1AU");
	__LIB_7__::func_149(uParam0, joaat("COMP_BCJCKCNV1"), joaat("PLAYER_BCJCKCNV1"));
	__LIB_7__::func_150(uParam0, iLocal_17, -1, 0.61f);
	__LIB_7__::func_151(uParam0, iLocal_14, 1, -1);
	iLocal_18 = __LIB_7__::func_156(uParam0, -0.07f, -0.35f, 1f, 0f, 0f, -27f, 9.84f, 10.52f, 5f, "volTrigger", joaat("VOLBOX"));
...
bool func_93(var uParam0)
{
	...
	{
		if (__LIB_7__::func_358(uParam0, &iLocal_18, 1))
		{
