...
bool func_72(var uParam0)
{
	...
	{
		case 3:
			__LIB_7__::func_45(uParam0, 183, 0, 0, 0);
			break;
		default:
			return false;
	}
	...
	iLocal_18 = __LIB_7__::func_47(uParam0, 17.59f, 0.12f, 0.9632f, 20.88f, 6.5f, 3.5f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_KAREN"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, 1.015f, 0.616f, 0.9977f, 23.04f, 2f, 1.5f, 3f, joaat("VOLBOX"), -1, 1, 1, 1);
	__LIB_6__::func_958(uParam0, joaat("P_BOTTLEJD01X"), 0f, 0f, 0f, "BOTTLEJD", 0, 0, 1);
	__LIB_6__::func_958(uParam0, joaat("P_BOTTLEBEER01X"), 0f, 0f, 0f, "BOTTLEBEER", 0, 1, 1);
	if (!__LIB_6__::func_206(15))
	{
		__LIB_6__::func_959(uParam0, "script@vignette@party@karen_2@base", 1, 1, 0, 0);
	}
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@party@karen_2@action", 2, 0, 1, 0);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@party@karen_2@sleep_loops", 0, 0, 0, 0);
	__LIB_7__::func_146(uParam0, "CKRP2AU");
	__LIB_7__::func_149(uParam0, joaat("COMP_KARPARCNV2"), joaat("PLAYER_KARPARCNV2"));
	__LIB_7__::func_150(uParam0, iLocal_16, -1, 0.55f);
	__LIB_7__::func_107(uParam0, iLocal_14, 3, joaat("WORLD_HUMAN_LEAN_BACK_WALL_DRINKING"), "WORLD_HUMAN_LEAN_WALL_DRINKING_FEMALE_B", -1, 1);
...
bool func_93(var uParam0)
{
	if (!bLocal_19)
	{
		if (__LIB_7__::func_40(uParam0, iLocal_16, 0.25f))
		{
