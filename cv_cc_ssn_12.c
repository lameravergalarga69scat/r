...
bool func_72(var uParam0)
{
	...
	__LIB_7__::func_47(uParam0, -6.2125f, 1.65f, 1.4875f, 0f, 0.8675f, 0.8925f, 3.2075f, joaat("VOLBOX"), joaat("APMS_COMP_DUTCH"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, 0.2875f, 5.2875f, 1.4875f, 0f, 1.125f, 1.1f, 3.2075f, joaat("VOLBOX"), joaat("APMS_COMP_GRIMSHAW"), 1, 1, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@susan_12@base", 1, 1, 0, 0);
	__LIB_6__::func_959(uParam0, "script@vignette@susan_12@Action", 0, 0, 1, 0);
	__LIB_7__::func_146(uParam0, "CSN12AU");
	__LIB_7__::func_149(uParam0, joaat("COMP_SSNCNV12"), joaat("PLAYER_SSNCNV12"));
...
void func_411(int iParam0, int iParam1)
{
	...
	func_379(iParam1, __LIB_0__::func_858(iParam1, 8192), __LIB_0__::func_858(iParam1, 16384), 1);
}
