...
bool func_72(var uParam0)
{
	...
	iLocal_14 = __LIB_7__::func_48(uParam0, 5, "IG_HoseaMatthews");
	iLocal_15 = __LIB_7__::func_48(uParam0, 20, "IG_Karen");
	iLocal_17 = __LIB_7__::func_48(uParam0, 17, "IG_MrPearson");
	iLocal_16 = __LIB_7__::func_48(uParam0, 8, "IG_Sean");
	iLocal_21 = __LIB_6__::func_958(uParam0, joaat("P_BOTTLEBEER01X"), 0f, 0f, 0f, "p_bottleJD01x", 0, 0, 1);
	iLocal_18 = __LIB_6__::func_958(uParam0, joaat("P_BOTTLEBEER01X"), 0f, 0f, 0f, "p_bottleJD01x^1", 0, 0, 1);
	iLocal_20 = __LIB_6__::func_958(uParam0, joaat("P_BOTTLEJD01X"), 0f, 0f, 0f, "p_bottleJD01x^2", 0, 0, 1);
	iLocal_19 = __LIB_6__::func_958(uParam0, joaat("P_BOTTLEBEER01X"), 0f, 0f, 0f, "p_bottleJD01x^3", 0, 0, 1);
	iLocal_22 = __LIB_6__::func_958(uParam0, joaat("P_BOTTLECRATE02X"), 0f, 0f, 0f, "p_bottlecrate02x", 0, 0, 1);
	iLocal_23 = __LIB_6__::func_958(uParam0, joaat("P_CHAIR_BARREL04B"), 0f, 0f, 0f, "p_chair_barrel04b", 1, 0, 1);
	iLocal_24 = __LIB_6__::func_958(uParam0, joaat("P_CHAIR_CRATE02X"), 0f, 0f, 0f, "p_chair_crate02x", 1, 0, 1);
	iLocal_25 = __LIB_6__::func_958(uParam0, joaat("P_CHAIR_CRATE15X"), 0f, 0f, 0f, "p_chair_crate15x", 1, 0, 1);
	iLocal_26 = __LIB_6__::func_958(uParam0, joaat("S_CRATESEAT03X"), 0f, 0f, 0f, "s_crateseat03x", 1, 0, 1);
	__LIB_7__::func_47(uParam0, -0.0375f, 0f, 0.8695f, 90.75f, 3.1375f, 3.5075f, 2.045f, joaat("VOLBOX"), -1, 1, 1, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@wrk@hosea_work_2@intro_base", 1, 1, 0, 0);
	iLocal_31 = __LIB_6__::func_959(uParam0, "script@vignette@wrk@hosea_work_2@action", 0, 0, 1, 0);
	__LIB_7__::func_146(uParam0, "CHWK2AU");
	__LIB_7__::func_149(uParam0, joaat("COMP_HSHWRKCNV2"), joaat("PLAYER_HSHWRKCNV2"));
	__LIB_7__::func_150(uParam0, iLocal_31, -1, 0.93f);
	__LIB_7__::func_127(uParam0, iLocal_16, 3, joaat("PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS"), "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_MALE_D", iLocal_24, 0, 25f, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_139(uParam0, iLocal_16, iLocal_20, "p_bottleJD01x_ph_r_hand", 0, 0);
	__LIB_7__::func_147(uParam0, iLocal_16, 4, 2, 0, 0, 0);
	__LIB_7__::func_127(uParam0, iLocal_17, 3, joaat("PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS"), "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_MALE_A", iLocal_23, 0, 47f, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_139(uParam0, iLocal_17, iLocal_21, "p_bottleBeer01x_PH_R_HAND", 0, 0);
	__LIB_7__::func_147(uParam0, iLocal_17, 4, 2, 0, 0, 0);
	__LIB_7__::func_127(uParam0, iLocal_14, 3, joaat("PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING"), "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_MALE_B", iLocal_25, 0, 38f, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_139(uParam0, iLocal_14, iLocal_18, "p_bottleBeer01x_PH_R_HAND", 0, 0);
	__LIB_7__::func_147(uParam0, iLocal_14, 4, 2, 0, 0, 0);
	__LIB_7__::func_151(uParam0, iLocal_14, 1, -1);
	__LIB_7__::func_149(uParam0, joaat("COMP_HSHWRKCNV2"), joaat("PLAYER_HSHWRKCNV2"));
	__LIB_7__::func_107(uParam0, iLocal_15, 3, joaat("WORLD_HUMAN_SIT_GROUND_READING"), "WORLD_HUMAN_SIT_GROUND_READING_JOURNAL_FEMALE_A", -1, 0);
	__LIB_7__::func_127(uParam0, iLocal_15, 3, joaat("PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING"), "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_FEMALE_A", iLocal_26, 0, 55f, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_139(uParam0, iLocal_15, iLocal_19, "p_bottleBeer01x_PH_R_HAND", 0, 0);
...
bool func_93(var uParam0)
{
	...
	if (bLocal_27)
	{
		fVar0 = ANIMSCENE::_GET_ANIM_SCENE_PROGRESS(uParam0->f_2046);
		if (fVar0 <= 0.135f)
		{
			if (fVar0 > 0.109f && __LIB_1__::func_992(Global_35, uParam0->f_29, 1) >= 625f)
			{
				__LIB_7__::func_151(uParam0, iLocal_14, 1, -1);
				bLocal_27 = false;
			}
...
{
	if (!ENTITY::DOES_ENTITY_EXIST(__LIB_7__::func_30(uParam0, iLocal_22)))
	{
		return true;
	}
	if (__LIB_1__::func_313(&uLocal_28, 15f))
	{
		__LIB_7__::func_305(uParam0, iLocal_22);
		return true;
	}
