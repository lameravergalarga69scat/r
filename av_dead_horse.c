...
bool func_3(var uParam0)
{
	...
	switch (uParam0->f_464)
	{
		...
		case 2:
			...
			break;
		case 3:
			if (__LIB_2__::func_844(uParam0) && __LIB_17__::func_810(uParam0))
			{
				uParam0->f_464 = 5;
			}
			else
...
{
	__LIB_2__::func_851(uParam0, 10824, 10881, 11314);
}

void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	__LIB_2__::func_853(uParam0, "DEAD_HORSE", "", vParam1, vParam4);
	__LIB_0__::func_634(&vParam1, 50, 10, 0);
	iLocal_9 = __LIB_2__::func_44(joaat("HORSE_CLASS_RIDING"), 1);
	__LIB_2__::func_905(uParam0, 0, "DHP_HORSE", iLocal_9, vParam1, vParam4.z, 1, 1, 0, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	if (*uParam0 == 150)
	{
		__LIB_2__::func_905(uParam0, 1, "RDED1_DOG_1", iLocal_10, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 1.25f, 0.2f, 0f), (90f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	}
}
...
int func_30(var uParam0)
{
	...
	__LIB_2__::func_887(&uLocal_20, 0);
	__LIB_1__::func_398(&uLocal_20, 1);
	__LIB_1__::func_401(&uLocal_20, 1);
	__LIB_2__::func_828(&uLocal_20, 1);
	__LIB_2__::func_829(&uLocal_20, 1);
	__LIB_2__::func_830(&uLocal_20, 1);
	return 1;
}
...
int func_31(var uParam0)
{
	if (!uParam0->f_469[1])
	{
		if (__LIB_2__::func_908(uParam0, &uLocal_20, 0))
		{
	...
	switch (iLocal_11)
	{
		case 0:
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
			{
				...
				iLocal_15 = GRAPHICS::_0xFA50F79257745E74(uParam0->f_20[0 /*14*/].f_5, 1f, 1, 36, 0);
				iLocal_16 = GRAPHICS::_0xFA50F79257745E74(uParam0->f_20[0 /*14*/].f_5, 1.5f, 2, -1, 0);
			}
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
			{
				__LIB_0__::func_634(&(uParam0->f_20[1 /*14*/].f_5), 50, 10, 0);
				TASK::TASK_START_SCENARIO_AT_POSITION(uParam0->f_20[1 /*14*/], joaat("WORLD_ANIMAL_DOG_SNIFFING_GROUND"), uParam0->f_20[1 /*14*/].f_5, uParam0->f_20[1 /*14*/].f_8, 0, false, true, 0, -1f, false);
...
int func_32(var uParam0, var uParam1)
{
	...
	if (iLocal_15 != -1)
	{
		GRAPHICS::_0x9CF1836C03FB67A2(&iLocal_15, 1);
	}
	if (iLocal_16 != -1)
	{
