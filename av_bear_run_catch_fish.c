...
{
	__LIB_2__::func_851(uParam0, 10807, 10866, 11671);
}

void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	__LIB_2__::func_853(uParam0, "BEAR_RUN_CATCH_FISH", "script@ambient@animal@BEAR_RUN_CATCH_FISH@action", vParam1, vParam4);
	uParam0->f_16 = 1;
	__LIB_2__::func_854(uParam0, 1, "pbl_action", "", 0);
	__LIB_2__::func_855(uParam0, 0, "BEAR", iLocal_9, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	__LIB_2__::func_855(uParam0, 1, "FISH", iLocal_10, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
}
...
int func_30(var uParam0)
{
	...
	__LIB_2__::func_906(&uLocal_11, 85);
	return 1;
}
...
int func_31(var uParam0)
{
	...
	if (!uParam0->f_469[0])
	{
		if (!bLocal_39 == 1)
		{
			if (__LIB_2__::func_908(uParam0, &uLocal_11, 1) || __LIB_0__::func_232(uParam0->f_20[0 /*14*/], Global_35, 1) <= 400f)
			{
				bLocal_39 = true;
			}
		}
	...
	if (uParam0->f_469[0])
	{
		...
		{
			if (__LIB_1__::func_285(&uLocal_40, 2f))
			{
				return 1;
			}
		}
