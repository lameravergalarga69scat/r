...
bool func_72(var uParam0)
{
	...
	iLocal_15 = __LIB_6__::func_959(uParam0, "script@ambient@campfiregeneral@DOG_LICK_TABLE@action", 64, 0, 0, 0);
	__LIB_7__::func_47(uParam0, -0.7125f, 0.0289f, 1.4625f, -90.5f, 1.2125f, 1.1975f, 3f, joaat("VOLBOX"), -1, 1, 1, 1);
	__LIB_7__::func_47(uParam0, -7.986f, 0.6039f, 1.0827f, -113.25f, 1.3f, 1.3f, 3f, joaat("VOLBOX"), -1, 1, 1, 1);
	iVar0 = MISC::GET_RANDOM_INT_IN_RANGE(0, 2);
	switch (iVar0)
	{
		case 0:
			iLocal_16 = __LIB_7__::func_32(uParam0, iLocal_15, "PL_idleAction", 1);
			__LIB_7__::func_127(uParam0, iLocal_14, 3, joaat("WORLD_ANIMAL_DOG_DIGGING"), "WORLD_ANIMAL_DOG_DIGGING", -1, 0, 55f, 1065353216 /* Float: 1f */, 1);
			func_155(uParam0, iLocal_14, 3, 0);
			break;
		case 1:
			iLocal_16 = __LIB_7__::func_32(uParam0, iLocal_15, "PL_runAction", 1);
			__LIB_7__::func_127(uParam0, iLocal_14, 3, joaat("WORLD_ANIMAL_DOG_DIGGING"), "WORLD_ANIMAL_DOG_DIGGING", -1, 0, 55f, 1065353216 /* Float: 1f */, 1);
			func_155(uParam0, iLocal_14, 3, 0);
			__LIB_7__::func_232(uParam0, iLocal_14, 1.6f, 1065353216 /* Float: 1f */, 5f);
			break;
		default:
			return false;
	}
