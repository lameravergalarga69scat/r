...
bool func_72(var uParam0)
{
	...
	{
		case 1:
			__LIB_7__::func_45(uParam0, 143, 0, 0, 0);
			break;
		default:
			return false;
	}
	...
	__LIB_7__::func_165(uParam0, 1, 0, 1);
	__LIB_7__::func_47(uParam0, -2.6485f, -2.2086f, 1.0827f, -80f, 1f, 1f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_ABIGAIL"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, 7.5515f, -5.4211f, 0.7952f, -80f, 1f, 1f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_JOHN"), 1, 1, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@abigail_2@base", 1, 1, 0, 0);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@abigail_2@action", 2, 0, 1, 0);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@abigail_2@exit", 0, 0, 0, 0);
	__LIB_7__::func_146(uParam0, "CAB2AUD");
