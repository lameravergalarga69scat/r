...
{
	__LIB_2__::func_851(uParam0, 10732, 10769, 11858);
}

void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	__LIB_2__::func_853(uParam0, "EAGLE_DIVE_CATCH_FISH", "script@ambient@animal@eagle_dive_catch_fish@action", vParam1, vParam4);
...
int func_31(var uParam0)
{
	...
	{
		if (__LIB_1__::func_285(&uLocal_40, 5f))
		{
			return 1;
		}
	}
