...
bool func_72(var uParam0)
{
	...
	__LIB_7__::func_47(uParam0, -1.0725f, 0.6225f, 1.1875f, -36f, 1.1f, 1.0875f, 3.2075f, joaat("VOLBOX"), joaat("APMS_COMP_BILL"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, -0.485f, -1.1775f, 1.1875f, -36f, 1.1f, 1.0875f, 3.2075f, joaat("VOLBOX"), joaat("APMS_COMP_JAVIER"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, 1.19f, -0.4525f, 1.1875f, -19.25f, 1.305f, 1.0875f, 3.2075f, joaat("VOLBOX"), joaat("APMS_COMP_SEAN"), 1, 1, 1);
	iLocal_20 = __LIB_6__::func_958(uParam0, joaat("P_BOTTLEJD01X"), 0f, 0f, 0f, "BOTTLE0", 0, 0, 1);
	iLocal_22 = __LIB_6__::func_958(uParam0, joaat("P_BOTTLEJD01X"), 0f, 0f, 0f, "BOTTLE1", 0, 0, 1);
	iLocal_21 = __LIB_6__::func_958(uParam0, joaat("P_BOTTLEJD01X"), 0f, 0f, 0f, "BOTTLE2", 0, 0, 1);
	iLocal_17 = __LIB_6__::func_958(uParam0, joaat("S_CRATESEAT03X"), -1.2888f, 0.763619f, -0.00258636f, 0, 1, 0, 1);
	iLocal_18 = __LIB_6__::func_958(uParam0, joaat("P_CHAIR_CRATE02X"), 1.42062f, -0.462748f, 0.00315094f, 0, 1, 0, 1);
	iLocal_19 = __LIB_6__::func_958(uParam0, joaat("P_CHAIR_BARREL04B"), -0.584697f, -1.37147f, -0.0016098f, 0, 1, 0, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@sean_15@base", 1, 1, 0, 0);
	__LIB_6__::func_959(uParam0, "script@vignette@sean_15@action", 0, 0, 1, 0);
	__LIB_7__::func_146(uParam0, "CSE15AU");
	__LIB_7__::func_127(uParam0, iLocal_15, 3, joaat("PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS"), "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_MALE_D", iLocal_18, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	...
	__LIB_7__::func_127(uParam0, iLocal_16, 3, joaat("WORLD_HUMAN_DRINK_PUT_DOWN_TABLE"), "WORLD_HUMAN_DRINK_PUT_DOWN_TABLE_WHISKEY_MALE_A", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_157(uParam0, iLocal_16, 3, 0);
	__LIB_7__::func_139(uParam0, iLocal_16, iLocal_22, "p_bottleJD01x_ph_r_hand", 0, 0);
	return true;
}
...
{
	ENTITY::SET_ENTITY_COORDS(__LIB_7__::func_30(uParam0, iLocal_19), __LIB_6__::func_972(uParam0, -0.402f, -1.251f, 0.03f), false, false, true, true);
	return true;
}
...
void func_157(var uParam0, int iParam1, int iParam2, int iParam3)
{
	...
	switch (iParam2)
	{
		case 4:
			...
			break;
		default:
			Var0 = { func_253(__LIB_0__::func_78(uParam0), __LIB_7__::func_120(uParam0, iParam1), __LIB_4__::func_576(uParam0), 1) };
