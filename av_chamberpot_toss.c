...
{
	__LIB_2__::func_851(uParam0, 10826, 10916, 11311);
}
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	__LIB_2__::func_853(uParam0, "AV_CHAMBERPOT_TOSS", "", vParam1, vParam4);
	__LIB_2__::func_902(uParam0, 0, "Ped", iVar0, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0f, -6f, 0f), vParam4.z, 1, 0, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
}
...
int func_18(var uParam0)
{
	...
	{
		iLocal_37 = __LIB_2__::func_488(joaat("WORLD_HUMAN_CHAMBERPOT_EMPTY_RAILING"), uParam0->f_483, uParam0->f_486.f_2, 0, 1000f, 0);
	}
	return 0;
}
...
int func_31(var uParam0)
{
	if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
	{
		...
		if (!uParam0->f_469[2])
		{
			if (__LIB_2__::func_892(uParam0, 0.1f, 60f, 4, 33f, 1112014848 /* Float: 50f */))
			{
				__LIB_2__::func_939(uParam0);
		...
		if (uParam0->f_469[2])
		{
			if (__LIB_0__::func_163(uParam0->f_20[0 /*14*/], -76381094))
			{
				if (!uParam0->f_469[4])
				{
					if (__LIB_2__::func_889(uParam0, 1065353216 /* Float: 1f */, 1116471296 /* Float: 70f */, 4, joaat("ACTION"), 0))
					{
						__LIB_2__::func_890(*uParam0, uParam0->f_483, 0);
						uParam0->f_469[4] = 1;
					}
