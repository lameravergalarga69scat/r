...
{
	__LIB_2__::func_851(uParam0, 11201, 11328, 11879);
}
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	int iVar1;
	int iVar2;
	__LIB_2__::func_853(uParam0, "FOX_SIT", "", vParam1, vParam4);
	iVar0 = 1;
	...
	__LIB_2__::func_855(uParam0, 0, "FS_ANIMAL", iLocal_9, vParam1, (0f + vParam4.z), iVar0, 1, 1, 1, iLocal_12, 1);
}
...
int func_30(var uParam0)
{
	...
	__LIB_1__::func_402(&uLocal_17, 1);
	__LIB_2__::func_906(&uLocal_17, 65);
	__LIB_1__::func_975(&uLocal_17, 5f);
	Local_45 = { 0f, 0f, 0f };
	Local_45.f_8 = 4;
	Local_45.f_4 = 21030;
	Local_45.f_21 = 3;
...
int func_31(var uParam0)
{
	if (!uParam0->f_469[1])
	{
		if (__LIB_2__::func_989(uParam0, &uLocal_17, 1))
		{
			if (*uParam0 == 172)
			{
	...
	switch (iLocal_10)
	{
		case 0:
			...
			__LIB_1__::func_148(&uLocal_13);
			iLocal_10 = 1;
			break;
		case 1:
			if (__LIB_2__::func_975(uParam0, uParam0->f_493, uParam0->f_494, 4, uParam0->f_495, 1112014848 /* Float: 50f */) || __LIB_1__::func_285(&uLocal_13, 20f))
			{
				if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
				{
			...
			break;
		case 2:
			if (__LIB_1__::func_285(&uLocal_13, 5f))
			{
				if (*uParam0 != 172)
				{
