...
void __EntryFunction__()
{
	...
	iLocal_13 = joaat("WORLD_ANIMAL_DOG_RESTING");
	iLocal_14 = 5500;
	Var0.f_1 = -1;
	Var0.f_3.f_9 = 3;
	Var0.f_20 = 25;
...
{
	__LIB_2__::func_851(uParam0, 10766, 10824, 11722);
}

void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	__LIB_2__::func_853(uParam0, "DOG_CHASE_CAT", "", vParam1, vParam4);
	__LIB_2__::func_905(uParam0, 0, "DCCP_CAT", iLocal_10, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 4f, 3.5f, 0f), (90f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	__LIB_2__::func_905(uParam0, 1, "DCCP_DOG", iLocal_11, vParam1, vParam4.z, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
}
	...
	switch (iLocal_9)
	{
		case 0:
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
			{
				...
				uLocal_15[0] = __LIB_2__::func_944(iLocal_12, uParam0->f_20[0 /*14*/].f_5, uParam0->f_20[0 /*14*/].f_8, 0, 0, 0);
				TASK::_TASK_USE_SCENARIO_POINT(uParam0->f_20[0 /*14*/], uLocal_15[0], 0, 0, false, true, 0, false, -1f, false);
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
			{
				...
				uLocal_15[1] = __LIB_2__::func_944(iLocal_13, uParam0->f_20[1 /*14*/].f_5, uParam0->f_20[1 /*14*/].f_8, 0, 0, 0);
				TASK::_TASK_USE_SCENARIO_POINT(uParam0->f_20[1 /*14*/], uLocal_15[1], 0, 0, false, true, 0, false, -1f, false);
		...
		case 1:
			...
			break;
		case 2:
			if (!__LIB_0__::func_163(uParam0->f_20[0 /*14*/], 713668775))
			{
			...
			break;
		case 3:
			if (__LIB_0__::func_232(uParam0->f_20[1 /*14*/], uParam0->f_20[0 /*14*/], 1) < 16f && __LIB_1__::func_285(&uLocal_18, 2f))
			{
				if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]) && !ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
				{
					...
					__LIB_3__::func_10(uParam0->f_20[0 /*14*/]);
					TASK::_TASK_SMART_FLEE_STYLE_PED(uParam0->f_20[0 /*14*/], uParam0->f_20[1 /*14*/], 0, 256, -1082130432 /* Float: -1f */, -1, 0);
					TASK::OPEN_SEQUENCE_TASK(&iVar0);
					TASK::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(0, uParam0->f_20[0 /*14*/], 0f, 3.5f, 0f, 1.2f, iLocal_14, 1036831949 /* Float: 0.1f */, 1, 1, 1, 1, 1);
					__LIB_2__::func_915(0, iLocal_13, uParam0->f_20[1 /*14*/].f_5, uParam0->f_20[1 /*14*/].f_8, 0, 1, 0, 0, -1082130432 /* Float: -1f */);
...
int func_32(var uParam0, var uParam1)
{
	...
	{
		if (TASK::_DOES_SCENARIO_POINT_EXIST(uLocal_15[iVar0]))
		{
			TASK::_DELETE_SCENARIO_POINT(uLocal_15[iVar0]);
		}
		iVar0++;
	}
	return 1;
