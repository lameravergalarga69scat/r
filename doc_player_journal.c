...
bool func_7(var uParam0)
{
	...
	if ((iVar0 < 15 && !__LIB_11__::func_217()) || !__LIB_7__::func_481(16))
	{
		if (TASK::_GET_ITEM_INTERACTION_FROM_PED(Global_35) != -372193721)
		{
			TASK::_0xB35370D5353995CB(Global_35, -372193721, 1048576000 /* Float: 0.25f */);
		}
	...
	switch (iVar0)
	{
		...
		case 1:
			if (func_25(uParam0))
			{
				if (__LIB_0__::func_153(PLAYER::PLAYER_PED_ID(), 0, 1, 0) != joaat("WEAPON_UNARMED") || __LIB_0__::func_153(PLAYER::PLAYER_PED_ID(), 1, 1, 0) != joaat("WEAPON_UNARMED"))
				{
		...
		case 3:
			...
			if (TASK::_GET_ITEM_INTERACTION_FROM_PED(Global_35) == 336776976)
			{
				if (__LIB_0__::func_139(uParam0->f_6))
				{
					...
					{
						func_34(1, uParam0);
						if (__LIB_1__::func_732(uParam0->f_6, 1))
						{
			...
			{
				PED::_SET_PED_BLACKBOARD_BOOL(Global_35, "JOURNAL_BLOCK_PAGE_NEXT", true, 1);
				PED::_SET_PED_BLACKBOARD_BOOL(Global_35, "JOURNAL_BLOCK_CHAPTER_NEXT", true, 1);
			}
			...
			{
				PED::_SET_PED_BLACKBOARD_BOOL(Global_35, "JOURNAL_BLOCK_PAGE_PREV", true, 1);
				PED::_SET_PED_BLACKBOARD_BOOL(Global_35, "JOURNAL_BLOCK_CHAPTER_PREV", true, 1);
			}
			...
			if (TASK::_GET_ITEM_INTERACTION_FROM_PED(Global_35) == 336776976)
			{
				if (uParam0->f_32.f_86 != -1 && uParam0->f_7 == 0)
				{
					if (uParam0->f_32.f_87 != -1)
					{
						...
						{
							if (__LIB_1__::func_732(uParam0->f_4, 1))
							{
		...
		case 12:
			...
			else if (__LIB_0__::func_264(&(uParam0->f_8)) > 10f || iVar8 == 336776976)
			{
				if (iVar8 != 336776976)
				{
					TASK::_0xB35370D5353995CB(Global_35, 336776976, 1048576000 /* Float: 0.25f */);
				}
				Global_1357519 = { 0f, 0f, 0f };
				__LIB_0__::func_37(&(uParam0->f_8));
				__LIB_0__::func_19(uParam0, 3);
			}
			else if (__LIB_0__::func_264(&(uParam0->f_8)) > 2f || ENTITY::HAS_ANIM_EVENT_FIRED(Global_35, -1300963384))
			{
				if (uParam0->f_11 != 0)
				{
					uParam0->f_11 = 0;
		...
		case 11:
			...
			break;
		case 15:
			if (__LIB_0__::func_255(Global_35, 0) || !TASK::_0xEC7E480FF8BD0BED(Global_35))
			{
...
{
	if (__LIB_0__::func_139(uParam1->f_6))
	{
		__LIB_1__::func_221(uParam1->f_6, bParam0, 0);
	}
}
...
void func_36(var uParam0)
{
	if (!__LIB_0__::func_139(uParam0->f_6))
	{
		uParam0->f_6 = __LIB_2__::func_403("VI_READ", joaat("INPUT_GAME_MENU_OPTION"), Global_35, 2, 0, 0, 1, 0, 1070386381 /* Float: 1.6f */, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, joaat("SHORT_TIMED_EVENT"), 0, 0);
		__LIB_4__::func_12(uParam0->f_6, 1310260484, 0, 1);
	}
}
...
{
	if (__LIB_0__::func_139(uParam1->f_4))
	{
		__LIB_1__::func_221(uParam1->f_4, bParam0, 0);
	}
}
...
void func_40(int iParam0, var uParam1)
{
	...
	if (uParam1->f_5 == iVar0 && __LIB_0__::func_139(uParam1->f_4))
	{
		func_38(1, uParam1);
	}
	else
...
{
	func_99(uParam2);
	HUD::_JOURNAL_GET_TEXTURE_WITH_LAYOUT(iParam0, iParam1, uParam2);
}
...
void func_84(int iParam0, var uParam1)
{
	...
	if (!__LIB_0__::func_139(uParam1->f_4))
	{
		...
		uParam1->f_5 = iParam0;
		uParam1->f_4 = __LIB_2__::func_403(sVar0, joaat("INPUT_GAME_MENU_EXTRA_OPTION"), Global_35, 2, 0, 0, 1, 0, 1070386381 /* Float: 1.6f */, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, joaat("SHORT_TIMED_EVENT"), 0, 0);
		__LIB_4__::func_12(uParam1->f_4, 1310260484, 0, 1);
	}
}
