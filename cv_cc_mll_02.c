...
bool func_72(var uParam0)
{
	...
	{
		case 2:
			__LIB_7__::func_45(uParam0, 49, 0, 0, 0);
			break;
		default:
			return false;
	}
	...
	__LIB_7__::func_47(uParam0, -8.4183f, -1.1202f, 0.8f, 0f, 1.5f, 1.5f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_MOLLY"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, 0.72f, -1.1f, 0.8f, 32.76f, 2.3f, 2.68f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_ABIGAIL"), 1, 1, 1);
	__LIB_6__::func_958(uParam0, joaat("P_CS_LEDGERSMALL01X"), 0f, 0f, 0f, "BOOK", 0, 1, 1);
	__LIB_6__::func_958(uParam0, joaat("P_MUGCOFFEE01X"), 0f, 0f, 0f, "MUG", 0, 1, 1);
	__LIB_6__::func_958(uParam0, joaat("P_CHAIR02X"), 0f, 0f, 0f, "CHAIR", 0, 1, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@molly_2@base", 1, 1, 0, 0);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@molly_2@action_a", 2, 0, 1, 0);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@molly_2@action_a_int", 2, 0, 0, 1);
	iLocal_18 = __LIB_6__::func_959(uParam0, "script@vignette@molly_2@action_b", 2, 0, 0, 0);
	iLocal_19 = __LIB_6__::func_959(uParam0, "script@vignette@molly_2@action_b_int", 2, 0, 0, 1);
	iLocal_20 = __LIB_6__::func_959(uParam0, "script@vignette@molly_2@action_c", 0, 0, 0, 0);
	__LIB_7__::func_146(uParam0, "CML2AUD");
	__LIB_7__::func_149(uParam0, joaat("COMP_MLLCNV2"), joaat("PLAYER_MLLCNV2"));
	...
	__LIB_7__::func_127(uParam0, iLocal_15, 2, joaat("WORLD_HUMAN_SIT_GROUND_READING"), "WORLD_HUMAN_SIT_GROUND_READING_JOURNAL_FEMALE_A", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_151(uParam0, iLocal_15, 1, -1);
	Local_21 = { __LIB_7__::func_160(uParam0, 0.4312f, -1.0244f, 0.9771f, 120.96f, 7f, 0.6f, 0.382f) };
	return true;
}
