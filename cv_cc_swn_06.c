...
bool func_72(var uParam0)
{
	...
	{
		case 1:
			__LIB_7__::func_116(uParam0, -131.1133f, -48.6322f, 94.0621f, 0f, 0f, 20.18f);
			break;
		case 2:
			__LIB_7__::func_116(uParam0, 673.5499f, -1284.22f, 42.6521f, 0f, 0f, 9.72f);
			break;
		case 3:
			__LIB_7__::func_116(uParam0, 1857f, -1870.4f, 41.95f, 0f, 0f, -88.56f);
			break;
		case 6:
			__LIB_7__::func_116(uParam0, 2337.624f, 1351.263f, 105.3253f, 0f, 0f, 33.665f);
			break;
		default:
			return false;
	}
	__LIB_7__::func_47(uParam0, -8.5033f, 0.7498f, 0.8457f, 0f, 1.1f, 1.1f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_SWANSON"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, 0.4922f, -0.8577f, 1.0179f, 0f, 1.1f, 1.1f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_JAVIER"), 1, 1, 1);
	__LIB_7__::func_48(uParam0, 21, 0);
	iLocal_14 = __LIB_7__::func_48(uParam0, 2, 0);
	__LIB_6__::func_958(uParam0, joaat("P_CS_BIBLE01X"), 0f, 0f, 0f, "BOOK", 0, 1, 1);
	__LIB_6__::func_958(uParam0, joaat("P_CHAIRFOLDING02X"), 0f, 0f, 0f, "Chair", 0, 0, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@swanson_6@base", 65, 1, 0, 0);
	iLocal_15 = __LIB_6__::func_959(uParam0, "script@vignette@swanson_6@action_a", 66, 0, 1, 0);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@swanson_6@action_b", 64, 0, 0, 0);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@swanson_6@action_b_alt", 64, 0, 0, 1);
	__LIB_7__::func_146(uParam0, "CSW6AUD");
	__LIB_7__::func_127(uParam0, iLocal_14, 2, joaat("WORLD_HUMAN_CROUCH_INSPECT"), "WORLD_HUMAN_CROUCH_INSPECT_MALE_A", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	Local_18 = { __LIB_7__::func_160(uParam0, 0.3915f, 0.6373f, 1.5f, -53.25f, 6f, 0.4f, 0.4f) };
	return true;
}
