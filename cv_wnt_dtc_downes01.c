...
bool func_77(var uParam0)
{
	...
	{
		case 1:
			__LIB_7__::func_116(uParam0, -123.9f, -30.2f, 95.8f, 0f, 0f, 0f);
			break;
		default:
			return false;
	}
	iLocal_92 = __LIB_7__::func_48(uParam0, 0, "CS_DUTCH");
	iLocal_93 = __LIB_6__::func_959(uParam0, "script@rcm@rdown@ig@ig1_walk_talk@ig1_walk_talk_arthur_dutch", 2, 0, 1, 0);
	iLocal_94 = __LIB_7__::func_32(uParam0, iLocal_93, "pbl_action", 1);
	iLocal_95 = __LIB_7__::func_32(uParam0, iLocal_93, "pbl_action_p2", 1);
	__LIB_7__::func_151(uParam0, iLocal_92, 2, -1);
	__LIB_7__::func_146(uParam0, "DOWNAUD");
...
bool func_95(var uParam0)
{
	...
	__LIB_7__::func_33(uParam0, iLocal_94, 1);
	return true;
}
...
bool func_98(var uParam0)
{
	...
	if (__LIB_7__::func_148(uParam0, iLocal_93))
	{
		if (!bLocal_96)
		{
			if (__LIB_1__::func_992(Global_35, vLocal_97, 1) <= 64f)
			{
				__LIB_7__::func_33(uParam0, iLocal_95, 1);
				bLocal_96 = true;
			}
			else
			{
	...
	switch (Global_1360165[iParam0 /*1157*/].f_3)
	{
		...
		case 1:
			...
			if (iParam4 == 0)
			{
				...
				else if ((Global_1360165[iParam0 /*1157*/].f_4.f_2 != 0 && Global_1360165[iParam0 /*1157*/].f_4.f_2 == Global_40.f_4942[iParam0 /*60*/].f_59) && (func_513(Global_1360165[iParam0 /*1157*/].f_4.f_2) || __LIB_1__::func_44(Global_1360165[iParam0 /*1157*/].f_4.f_2)))
				{
