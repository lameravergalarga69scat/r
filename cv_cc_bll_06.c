...
bool func_72(var uParam0)
{
	...
	{
		case 1:
			__LIB_7__::func_45(uParam0, 146, 0, 0, 0);
			break;
		case 2:
	...
	iLocal_16 = __LIB_7__::func_165(uParam0, 7, 0, 1);
	__LIB_7__::func_47(uParam0, -0.2875f, 0.475f, 1f, 0f, 1.1f, 1.1f, 2.5f, joaat("VOLBOX"), joaat("APMS_COMP_BILL"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, 0f, 5.0125f, 1f, 20f, 3f, 3.5f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_LENNY"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, -3.6869f, -0.1059f, 1f, 20f, 2.7225f, 1.5425f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_LENNY"), 1, 1, 1);
	iLocal_30 = __LIB_6__::func_958(uParam0, joaat("P_CS_HAYPIECE01X"), 0f, 0f, 0f, "HAY", 0, 0, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@bill_6@base", 1, 1, 0, 0);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@bill_6@action_a", 2, 0, 1, 0);
	iLocal_18 = __LIB_6__::func_959(uParam0, "script@vignette@bill_6@action_b", 0, 0, 0, 0);
	iLocal_19 = __LIB_6__::func_959(uParam0, "script@vignette@bill_6@action_b_alt", 0, 0, 0, 1);
	__LIB_7__::func_146(uParam0, "CBLL6AU");
	__LIB_7__::func_149(uParam0, joaat("COMP_BLLCNV6"), joaat("PLAYER_BLLCNV6"));
	...
	Local_20 = { __LIB_7__::func_160(uParam0, -2.8481f, -0.1114f, 0.8927f, 163.75f, 7f, 0.332f, 0.457f) };
	return true;
}
...
bool func_93(var uParam0)
{
	...
	if (__LIB_7__::func_148(uParam0, iLocal_17))
	{
		...
		iVar0 = __LIB_7__::func_30(uParam0, iLocal_30);
		if (ENTITY::DOES_ENTITY_EXIST(iVar0))
		{
			OBJECT::DELETE_OBJECT(&iVar0);
		}
		TASK::TASK_STAND_STILL(__LIB_6__::func_952(uParam0, iLocal_16), -1);
	}
	return true;
}
...
void func_198(var uParam0, int iParam1)
{
	...
	if (__LIB_0__::func_31(uParam0->f_107[iParam1 /*113*/].f_7))
	{
		if (!__LIB_0__::func_212(uParam0->f_107[iParam1 /*113*/].f_7))
		{
			return;
		}
		__LIB_1__::func_463(uParam0->f_107[iParam1 /*113*/].f_5, uParam0->f_107[iParam1 /*113*/].f_7, 1, 0, 0);
	}
}
