...
bool func_72(var uParam0)
{
	...
	{
		case 1:
			__LIB_7__::func_45(uParam0, 169, 0, 0, 0);
			break;
		case 2:
			__LIB_7__::func_116(uParam0, 684.807f, -1216.703f, 44.22f, 0f, 0f, -42.84f);
			break;
		default:
			return false;
	}
	...
	__LIB_7__::func_47(uParam0, 0f, 0f, 1f, 0f, 1.5f, 1.5f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_SEAN"), 1, 1, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@sean_8@base", 1, 1, 0, 0);
	iLocal_15 = __LIB_6__::func_959(uParam0, "script@vignette@sean_8@action_a", 2, 0, 1, 1);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@sean_8@action_b_front", 0, 0, 0, 1);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@sean_8@action_b_back", 0, 0, 0, 1);
	__LIB_7__::func_146(uParam0, "CSEN8");
	__LIB_7__::func_151(uParam0, iLocal_14, 2, -1);
	Local_38 = { __LIB_7__::func_160(uParam0, 0f, 0f, 1f, 0f, 7f, 0.5f, 0.5f) };
	Local_18 = { __LIB_7__::func_160(uParam0, 0f, 0f, 1f, 0f, 10f, 1f, 1f) };
	Local_28 = { __LIB_7__::func_160(uParam0, 0f, 0f, 1f, 180f, 10f, 1f, 1f) };
	...
	__LIB_7__::func_308(uParam0, iLocal_14, 15f, 15f);
	return true;
}
...
{
	return __LIB_7__::func_163(uParam0, Local_38, 1, 0);
}
...
bool func_93(var uParam0)
{
	if (__LIB_7__::func_148(uParam0, iLocal_15))
	{
		...
		else if (__LIB_7__::func_163(uParam0, Local_28, 1, 0))
		{
