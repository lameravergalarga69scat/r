...
bool func_72(var uParam0)
{
	...
	__LIB_7__::func_47(uParam0, 0.95049f, 0.327781f, 1.00836f, 3f, 0.9f, 0.9f, 2.5f, joaat("VOLBOX"), joaat("APMS_COMP_MARYBETH"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, 0.048638f, 0.0721679f, 0.778168f, 3f, 0.8f, 2f, 2f, joaat("VOLBOX"), joaat("APMS_COMP_JOHN"), 1, 1, 1);
	...
	__LIB_6__::func_959(uParam0, "script@vignette@marybeth_1@base", 1, 1, 0, 0);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@marybeth_1@action_a", 2, 0, 1, 0);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@marybeth_1@action_b", 0, 0, 0, 1);
	iLocal_18 = __LIB_6__::func_959(uParam0, "script@vignette@marybeth_1@action_b_alt_right", 0, 0, 0, 1);
	iLocal_19 = __LIB_6__::func_959(uParam0, "script@vignette@marybeth_1@exit_to_base", 0, 0, 0, 0);
	__LIB_7__::func_146(uParam0, "CMRB1AU");
	__LIB_7__::func_107(uParam0, iLocal_14, 4, joaat("PROP_HUMAN_SEAT_BENCH"), "PROP_HUMAN_SEAT_BENCH_FEMALE_A", -1, 0);
	__LIB_7__::func_296(uParam0, iLocal_14, 4, joaat("PROP_HUMAN_SEAT_BENCH"), "PROP_HUMAN_SEAT_BENCH_FEMALE_A", -1, 0, -1f, 0f, 1);
	__LIB_7__::func_107(uParam0, iLocal_15, 4, joaat("WORLD_CAMP_JOHN_RECOVER"), "WORLD_CAMP_JOHN_RECOVER_MALE_A", -1, 0);
	__LIB_7__::func_296(uParam0, iLocal_15, 4, joaat("WORLD_CAMP_JOHN_RECOVER"), "WORLD_CAMP_JOHN_RECOVER_MALE_A", -1, 0, -1f, 1065353216 /* Float: 1f */, 1);
	Local_30 = { __LIB_7__::func_160(uParam0, 0.952f, 0.3487f, 0.6824f, -109.5f, 10f, 0.189f, 0.625f) };
	Local_20 = { __LIB_7__::func_160(uParam0, 0.952f, 0.3487f, 0.6824f, -49.75f, 10f, 0.8f, 0.475f) };
	iLocal_40 = __LIB_7__::func_156(uParam0, 5.9125f, 1.0375f, 0f, 0f, 0f, 0f, 13.625f, 7.3375f, 3f, "InitialTrigger", joaat("VOLBOX"));
	iLocal_41 = __LIB_7__::func_156(uParam0, 5.5249f, -0.05f, 0f, 0f, 0f, 3.75f, 10.345f, 5.505f, 3f, "ActionTrigger", joaat("VOLBOX"));
...
{
	return __LIB_1__::func_205(Global_35, iLocal_40, 1, 0);
}
...
bool func_93(var uParam0)
{
	if (__LIB_7__::func_148(uParam0, iLocal_16))
	{
		if (__LIB_1__::func_205(Global_35, iLocal_41, 1, 0))
		{
			...
			else if (__LIB_7__::func_163(uParam0, Local_20, 1, 0))
			{
