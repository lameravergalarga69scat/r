...
{
	__LIB_2__::func_851(uParam0, 10741, 10792, 11606);
}

void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	__LIB_2__::func_853(uParam0, "SWIM_WOLF_CHASE_MOOSE", "", vParam1, vParam4);
	__LIB_2__::func_905(uParam0, 0, "SWCMP_WOLF", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0f, -18.5f, 0f), vParam4.z, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	__LIB_2__::func_905(uParam0, 1, "SWCMP_ANIMAL", iLocal_10, vParam1, vParam4.z, 0, 1, 1, 1, joaat("META_OUTFIT_ANIMAL_MOOSE_M_001"), 1);
}
...
int func_31(var uParam0)
{
	...
	switch (iLocal_11)
	{
		case 0:
			...
			{
				uLocal_12[0] = __LIB_2__::func_944(joaat("STAND"), uParam0->f_20[0 /*14*/].f_5, uParam0->f_20[0 /*14*/].f_8, 0, 0, 0);
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
			{
				...
				uLocal_12[1] = __LIB_2__::func_944(joaat("STAND"), uParam0->f_20[1 /*14*/].f_5, uParam0->f_20[1 /*14*/].f_8, 0, 0, 0);
		...
		case 1:
			if (__LIB_2__::func_892(uParam0, uParam0->f_493, uParam0->f_494, 4, uParam0->f_495, 1112014848 /* Float: 50f */))
			{
				...
				if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
				{
					...
					__LIB_2__::func_915(0, joaat("WORLD_ANIMAL_WOLF_RESTING"), vLocal_15, uParam0->f_20[1 /*14*/].f_8, 45000, 1, 0, 0, -1082130432 /* Float: -1f */);
					TASK::CLOSE_SEQUENCE_TASK(iVar0);
		...
		case 4:
			if (!bLocal_18)
			{
				if (__LIB_0__::func_232(uParam0->f_20[0 /*14*/], Global_35, 1) < 225f)
				{
					__LIB_2__::func_857(&(uParam0->f_20[0 /*14*/]), 0, 1);
					bLocal_18 = true;
				}
			}
			if (!__LIB_0__::func_163(uParam0->f_20[0 /*14*/], 242628503))
			{
				return 1;
			}
			break;
