...
bool func_72(var uParam0)
{
	...
	__LIB_7__::func_47(uParam0, 1.33949f, 0.232226f, 1.00873f, 3f, 0.9f, 0.9f, 2.5f, joaat("VOLBOX"), joaat("APMS_COMP_GRIMSHAW"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, 0.476543f, -0.0842055f, 0.549286f, 3f, 0.8f, 2f, 2f, joaat("VOLBOX"), joaat("APMS_COMP_JOHN"), 1, 1, 1);
	__LIB_6__::func_958(uParam0, joaat("P_CS_RAG02X"), 0f, 0f, 0f, "RAG", 0, 1, 1);
	iLocal_16 = __LIB_6__::func_958(uParam0, joaat("P_STOOL03X"), 0f, 0f, 0f, "stool", 0, 0, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@susan_1@base", 1, 1, 0, 0);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@susan_1@action_a_left", 2, 0, 0, 1);
	iLocal_18 = __LIB_6__::func_959(uParam0, "script@vignette@susan_1@action_a_right", 2, 0, 0, 1);
	iLocal_19 = __LIB_6__::func_959(uParam0, "script@vignette@susan_1@action_b_left", 0, 0, 0, 1);
	iLocal_20 = __LIB_6__::func_959(uParam0, "script@vignette@susan_1@action_b_right", 0, 0, 0, 1);
	__LIB_7__::func_146(uParam0, "CSSN1AU");
	__LIB_7__::func_149(uParam0, joaat("COMP_SSNCNV1"), joaat("PLAYER_SSNCNV1"));
	__LIB_7__::func_296(uParam0, iLocal_14, 3, joaat("PROP_HUMAN_SEAT_BENCH"), "PROP_HUMAN_SEAT_BENCH_FEMALE_A", iLocal_16, 0, -1073741824 /* Float: -2f */, 0f, 1);
	...
	Local_22 = { __LIB_7__::func_160(uParam0, 0.8462f, 0.4096f, 1.0084f, -151f, 3.555f, 0.4f, 0.4f) };
	Local_32 = { __LIB_7__::func_160(uParam0, 0.8462f, 0.4096f, 1.0084f, -9.75f, 2.41f, 0.4f, 0.745f) };
...
{
	if (__LIB_7__::func_84(uParam0, iLocal_17) || __LIB_7__::func_84(uParam0, iLocal_18))
	{
		if (__LIB_7__::func_163(uParam0, Local_22, 1, 0))
		{
			__LIB_7__::func_99(uParam0, iLocal_19, 1);
		}
		else if (__LIB_7__::func_163(uParam0, Local_32, 1, 0))
		{
			__LIB_7__::func_99(uParam0, iLocal_20, 1);
		}
		else
		{
			__LIB_7__::func_99(uParam0, iLocal_21, 1);
		}
	}
	return true;
}
