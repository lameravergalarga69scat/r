...
bool func_1(var uParam0)
{
	...
	if (!bLocal_31)
	{
		if (TASK::_DOES_SCENARIO_POINT_EXIST(uParam0->f_107[iLocal_14 /*113*/].f_8.f_23))
		{
			if (TASK::IS_PED_ACTIVE_IN_SCENARIO(__LIB_6__::func_952(uParam0, iLocal_14), 0))
			{
				iVar0 = PED::_0x4D0D2E3D8BC000EB(__LIB_6__::func_952(uParam0, iLocal_14), "p_bottleJD01x_ph_r_hand", 0);
...
bool func_76(var uParam0)
{
	...
	__LIB_7__::func_47(uParam0, 1.1615f, -1.954f, 0f, 86.75f, 1f, 1f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_PEARSON"), 1, 1, 1);
	iLocal_16 = __LIB_6__::func_958(uParam0, joaat("P_BOTTLEJD01X"), 0f, 0f, 0f, "BOTTLE", 0, 0, 1);
	iLocal_15 = __LIB_6__::func_959(uParam0, "script@vignette@itm@pearson_item_1@action", 0, 0, 1, 1);
	__LIB_7__::func_146(uParam0, "CPRI1AU");
	__LIB_7__::func_107(uParam0, iLocal_14, 4, joaat("PROP_HUMAN_FOODPREP_STEW"), "PROP_HUMAN_FOODPREP_STEW_RESTING_MALE_D", -1, 1);
	__LIB_7__::func_233(uParam0, iLocal_14, vLocal_32, 0, 1, 0);
	__LIB_7__::func_127(uParam0, iLocal_14, 4, joaat("PROP_HUMAN_FOODPREP_STEW"), "PROP_HUMAN_FOODPREP_STEW_RESTING_MALE_D", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	...
	Local_17 = { __LIB_7__::func_160(uParam0, 0.88f, -1.7917f, 1.1559f, 86.69f, 5.5f, 0.65f, 0.2475f) };
...
bool func_91(var uParam0)
{
	if (!ENTITY::IS_ENTITY_DEAD(__LIB_6__::func_952(uParam0, iLocal_14)))
	{
		PED::SET_PED_RESET_FLAG(__LIB_6__::func_952(uParam0, iLocal_14), 256, true);
	}
	return true;
}
...
bool func_94(var uParam0)
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(__LIB_6__::func_952(uParam0, iLocal_14)))
	{
		PLAYER::_0x3946FC742AC305CD(PLAYER::PLAYER_ID(), __LIB_6__::func_952(uParam0, iLocal_14), sLocal_30, 0f, 0f, 0f, 0, sLocal_30);
		MISC::_0xE98D55C5983F2509(__LIB_6__::func_952(uParam0, iLocal_14));
	}
...
bool func_97(var uParam0)
{
	...
	{
		PLAYER::_0xC67A4910425F11F1(PLAYER::PLAYER_ID(), sLocal_30);
		__LIB_7__::func_393(15, 17, 1);
	}
	if (__LIB_7__::func_74(uParam0, iLocal_14))
	{
		iVar0 = __LIB_7__::func_30(uParam0, iLocal_16);
...
void func_163(var uParam0, int iParam1, int iParam2, int iParam3)
{
	...
	switch (iParam2)
	{
		case 4:
			...
			break;
		default:
			Var0 = { func_272(__LIB_0__::func_78(uParam0), __LIB_7__::func_120(uParam0, iParam1), __LIB_4__::func_576(uParam0), 1) };
	...
	switch (Global_1360165[iParam0 /*1157*/].f_11)
	{
		...
		case 3:
			if (!ENTITY::IS_ENTITY_DEAD(Global_1360165[iParam0 /*1157*/]) && !ANIMSCENE::_0x3AB6C7B0BB0DF4B1(Global_1360165[iParam0 /*1157*/], -1))
			{
				...
				func_462(Global_1360165[iParam0 /*1157*/], vVar0, iParam6, 2, 1073741824 /* Float: 2f */);
			}
			else if (bParam16)
			{
	...
	switch (Global_1360165[iParam0 /*1157*/].f_70.f_12)
	{
		...
		case 3:
			...
			if ((bParam2 && !__LIB_0__::func_86(vVar0)) && !__LIB_0__::func_175(vVar0, ENTITY::GET_ENTITY_COORDS(Global_1360165[iParam0 /*1157*/].f_124, true, false), 1056964608 /* Float: 0.5f */, 1))
			{
				...
				func_462(Global_1360165[iParam0 /*1157*/].f_124, vVar0, iParam6, 2, 1073741824 /* Float: 2f */);
			}
			if (bParam1)
			{
