...
{
	__LIB_2__::func_851(uParam0, 10699, 10736, 11383);
}

void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	__LIB_2__::func_853(uParam0, "SEAGULL_CATCH_FISH", "script@ambient@animal@seagull_catch_fish@action", vParam1, vParam4);
	__LIB_2__::func_854(uParam0, 1, "pbl_action", "", 0);
	__LIB_2__::func_855(uParam0, 0, "SEAGULL", iLocal_9, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
}
...
int func_31(var uParam0)
{
	if (!uParam0->f_469[0])
	{
		...
		if (!bLocal_38 == 1)
		{
			if (__LIB_2__::func_908(uParam0, &uLocal_10, 0) || __LIB_1__::func_992(Global_35, uParam0->f_483, 1) < 100f)
			{
				bLocal_38 = true;
			}
		}
	...
	{
		if (__LIB_1__::func_285(&uLocal_39, 3f))
		{
			return 1;
		}
	}
