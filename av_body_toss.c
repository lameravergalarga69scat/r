...
{
	__LIB_2__::func_851(uParam0, 10786, 10844, 11622);
}

void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	int iVar0;
	__LIB_2__::func_853(uParam0, "AV_BODY_TOSS", "script@ambient@generic@Body_Toss@Action", vParam1, vParam4);
	__LIB_2__::func_854(uParam0, 1, "pl_Action", "", 0);
	iVar0 = __LIB_2__::func_921(__LIB_1__::func_898());
	__LIB_2__::func_855(uParam0, 0, "MALE_A", iVar0, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	__LIB_2__::func_855(uParam0, 1, "MALE_B", iVar0, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	__LIB_2__::func_855(uParam0, 2, "MALE_DEAD", iVar0, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
}
...
int func_31(var uParam0)
{
	...
	if (!uParam0->f_469[2])
	{
		if (__LIB_2__::func_892(uParam0, 1065353216 /* Float: 1f */, 50f, 4, 25f, 1112014848 /* Float: 50f */))
		{
			func_66(uParam0);
	...
	if (uParam0->f_469[2])
	{
		if (!uParam0->f_469[7])
		{
			if (__LIB_2__::func_889(uParam0, fLocal_37, 50f, 4, joaat("ACTION"), 1))
			{
				__LIB_2__::func_890(*uParam0, uParam0->f_483, 1);
				uParam0->f_469[7] = 1;
			}
