...
{
	__LIB_2__::func_851(uParam0, 10947, 11013, 11772);
}

void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	int iVar0;
	__LIB_2__::func_853(uParam0, "RAMS_HEADBUTT", "script@ambient@animal@RAMS_HEADBUTT@action", vParam1, vParam4);
	...
	__LIB_2__::func_855(uParam0, 0, "RAM1", iLocal_9, 0f, 0f, 0f, 0f, 0, 1, 1, 1, iLocal_10, 0);
	__LIB_2__::func_855(uParam0, 1, "RAM2", iLocal_9, 0f, 0f, 0f, 0f, 0, 1, 1, 1, iLocal_10, 0);
}
...
int func_31(var uParam0)
{
	...
	if (!uParam0->f_469[0])
	{
		if (!bLocal_39)
		{
			if ((__LIB_2__::func_908(uParam0, &uLocal_11, 1) || __LIB_0__::func_232(Global_35, uParam0->f_20[0 /*14*/], 1) <= 400f) || __LIB_0__::func_232(Global_35, uParam0->f_20[1 /*14*/], 1) <= 400f)
			{
				bLocal_39 = true;
			}
		}
