...
bool func_75(var uParam0)
{
	...
	{
		case 8:
			__LIB_7__::func_116(uParam0, -1649.057f, -1373.154f, 86.166f, 0f, 0.6f, 0f);
	...
	__LIB_7__::func_47(uParam0, 6.1551f, 11.532f, -1.7f, -2.75f, 0.75f, 0.75f, 2.265f, joaat("VOLBOX"), joaat("APMS_COMP_JACK"), 1, 1, 1);
	__LIB_6__::func_958(uParam0, joaat("P_BROOM02X"), 0f, 0f, 0f, "BROOM", 0, 1, 1);
	__LIB_6__::func_958(uParam0, joaat("P_CS_BOOK04X"), 1.17084f, -0.0235534f, 0.7491f, "BOOK", 0, 0, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@abigail_and_jack_2@base", 1, 1, 0, 0);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@abigail_and_jack_2@action_a", 2, 0, 1, 0);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@abigail_and_jack_2@action_b_alt", 0, 0, 0, 1);
	__LIB_7__::func_146(uParam0, "BANJ2AU");
	__LIB_7__::func_149(uParam0, joaat("COMP_BCANJCNV2"), joaat("PLAYER_BCANJCNV2"));
	__LIB_7__::func_107(uParam0, iLocal_14, 3, joaat("WORLD_HUMAN_BROOM"), "WORLD_HUMAN_BROOM_WORKING_FEMALE_B", -1, 1);
	__LIB_7__::func_127(uParam0, iLocal_14, 4, joaat("PROP_HUMAN_SEAT_BENCH"), "PROP_HUMAN_SEAT_BENCH_FEMALE_A", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_171(uParam0, iLocal_14, 4, 0);
	__LIB_7__::func_151(uParam0, iLocal_14, 1, -1);
	__LIB_7__::func_172(uParam0, iLocal_14, 1);
	Local_18 = { __LIB_7__::func_160(uParam0, 4.8675f, 8.865f, -1.68f, -30.6f, 7.4275f, 0.32f, 0.313f) };
	__LIB_7__::func_107(uParam0, iLocal_15, 3, joaat("WORLD_HUMAN_SIT_GROUND_READING_BOOK"), "WORLD_HUMAN_SIT_GROUND_READING_BOOK_MALE_A", -1, 0);
	__LIB_7__::func_127(uParam0, iLocal_15, 2, joaat("PROP_CAMP_JACK_ES_SLEEP_BED_PILLOW_LEFT"), "PROP_CAMP_JACK_ES_SLEEP_BED_PILLOW_MALE_A", -1, 0, 640f, 0f, 1);
...
bool func_86(var uParam0)
{
	if (!bLocal_31)
	{
		uLocal_32 = STREAMING::_0xB223249B7798EEED(__LIB_6__::func_952(uParam0, iLocal_15), joaat("PROP_CAMP_JACK_ES_SLEEP_BED_PILLOW_LEFT"), 1, joaat("PROP_CAMP_JACK_ES_SLEEP_BED_PILLOW_MALE_A"));
		bLocal_31 = true;
		return false;
	}
	return STREAMING::_0xA0AE7653E8181725(uLocal_32);
}
...
bool func_87(var uParam0)
{
	...
	if (OBJECT::IS_DOOR_REGISTERED_WITH_SYSTEM(1309495497))
	{
		iLocal_33 = ENTITY::GET_OBJECT_INDEX_FROM_ENTITY_INDEX(__LIB_3__::func_659(1309495497, 1, 0));
	}
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_33))
	{
		__LIB_6__::func_986(iLocal_33, uParam0->f_1984[iLocal_16], "DOOR");
	}
...
bool func_96(var uParam0)
{
	...
	if (!bLocal_34)
	{
		if (__LIB_7__::func_169(uParam0, iLocal_16))
		{
			if (__LIB_6__::func_997(uParam0, iLocal_14))
			{
				if (__LIB_7__::func_163(uParam0, Local_18, 1, 0))
				{
					__LIB_7__::func_173(uParam0, iLocal_17, 1);
					__LIB_7__::func_113(uParam0, iLocal_14, 0, 1);
				}
				else
				{
...
{
	if (!CAM::IS_SPHERE_VISIBLE(vLocal_28, 2f))
	{
		TASK::SET_SCENARIO_GROUP_ENABLED("CAMP_CONVO_BEECHERS_BROOM", true);
		return true;
	}
