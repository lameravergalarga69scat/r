...
bool func_72(var uParam0)
{
	...
	{
		case 8:
			__LIB_7__::func_116(uParam0, -1651.532f, -1364.943f, 82.957f, -0.412f, 0.03f, 152.954f);
			break;
		default:
			return false;
	}
	iLocal_18 = __LIB_7__::func_48(uParam0, 7, 0);
	iLocal_19 = __LIB_7__::func_48(uParam0, 14, 0);
	iLocal_20 = __LIB_6__::func_958(uParam0, joaat("P_WOLFPOOP03X"), 9.191689f, 38.85237f, 1.644012f, "Poop", 0, 0, 1);
	__LIB_7__::func_47(uParam0, 8.9325f, 38.97f, 0.2375f, 0f, 2f, 2f, 5f, joaat("VOLBOX"), -1, 1, 1, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@beecher@charles_and_jack_1@base", 1, 1, 0, 0);
	iLocal_14 = __LIB_6__::func_959(uParam0, "script@vignette@beecher@charles_and_jack_1@action_a", 2, 0, 1, 0);
	iLocal_15 = __LIB_6__::func_959(uParam0, "script@vignette@beecher@charles_and_jack_1@action_b", 0, 0, 0, 0);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@beecher@charles_and_jack_1@ACTION_B_ALT_FRONT", 0, 0, 0, 1);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@beecher@charles_and_jack_1@ACTION_B_ALT_BACK", 0, 0, 0, 1);
	__LIB_7__::func_149(uParam0, joaat("COMP_BCCNJCNV1"), joaat("PLAYER_BCCNJCNV1"));
	__LIB_7__::func_151(uParam0, iLocal_18, 1, -1);
	__LIB_7__::func_151(uParam0, iLocal_19, 1, -1);
	__LIB_7__::func_146(uParam0, "BCJA1AU");
	Local_21 = { __LIB_7__::func_160(uParam0, 8.405f, 38.97f, 1.7755f, 0f, 6f, 1f, 1f) };
	Local_31 = { __LIB_7__::func_160(uParam0, 8.405f, 38.97f, 1.7755f, -180f, 6f, 1f, 1f) };
	return true;
}
...
bool func_93(var uParam0)
{
	if (__LIB_7__::func_148(uParam0, iLocal_14))
	{
		...
		{
			__LIB_7__::func_150(uParam0, iLocal_16, -1, 0.42f);
			__LIB_7__::func_154(uParam0, iLocal_16, 1);
		}
		else if (__LIB_7__::func_163(uParam0, Local_31, 1, 0))
		{
			__LIB_7__::func_150(uParam0, iLocal_17, -1, 0.42f);
	...
	if ((__LIB_7__::func_40(uParam0, iLocal_15, 0.503f) || __LIB_7__::func_40(uParam0, iLocal_17, 0.636f)) || __LIB_7__::func_40(uParam0, iLocal_16, 0.637f))
	{
