...
bool func_72(var uParam0)
{
	...
	iLocal_15 = __LIB_7__::func_48(uParam0, 10, 0);
	__LIB_7__::func_47(uParam0, -5.1875f, -2.2f, 0f, 2f, 1.2f, 1.2f, 2.685f, joaat("VOLBOX"), joaat("APMS_COMP_KIERAN"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, 0f, 0f, 0.6f, 2f, 3.665f, 3.37f, 2.685f, joaat("VOLBOX"), joaat("APMS_COMP_KAREN"), 1, 1, 1);
	...
	iLocal_21 = __LIB_6__::func_958(uParam0, joaat("P_CHAIR_CRATE02X"), 1.42059f, -0.462698f, 0.000679016f, 0, 1, 0, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@kieran_14@base", 1, 1, 0, 0);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@kieran_14@action_a", 2, 0, 1, 0);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@kieran_14@action_a_int_left", 2, 0, 0, 1);
	iLocal_18 = __LIB_6__::func_959(uParam0, "script@vignette@kieran_14@action_a_int_front", 2, 0, 0, 1);
	iLocal_19 = __LIB_6__::func_959(uParam0, "script@vignette@kieran_14@action_a_int_right", 2, 0, 0, 1);
	iLocal_20 = __LIB_6__::func_959(uParam0, "script@vignette@kieran_14@action_b", 0, 0, 0, 0);
	__LIB_7__::func_146(uParam0, "CKI14AU");
	__LIB_7__::func_107(uParam0, iLocal_15, 3, joaat("WORLD_HUMAN_COFFEE_DRINK"), "WORLD_HUMAN_COFFEE_DRINK_MALE_A", -1, 1);
	__LIB_7__::func_127(uParam0, iLocal_14, 3, joaat("GENERIC_SEAT_CHAIR_TABLE_SCENARIO"), "GENERIC_SEAT_CHAIR_TABLE_SCENARIO_RF_FWD_FEMALE_A", iLocal_21, 0, 25f, 1065353216 /* Float: 1f */, 1);
	Local_22 = { __LIB_7__::func_160(uParam0, 1.298f, -0.52f, 1.07f, 100.25f, 6.5f, 0.065f, 0.6375f) };
	Local_32 = { __LIB_7__::func_160(uParam0, 1.298f, -0.52f, 1.07f, 165.54f, 6.5f, 0.22f, 0.66f) };
	Local_42 = { __LIB_7__::func_160(uParam0, 1.298f, -0.52f, 1.07f, 9.84f, 6.5f, 0.3675f, 0.3175f) };
	return true;
}
...
bool func_93(var uParam0)
{
	...
	if ((__LIB_7__::func_148(uParam0, iLocal_18) || __LIB_7__::func_148(uParam0, iLocal_17)) || __LIB_7__::func_148(uParam0, iLocal_19))
	{
		__LIB_7__::func_154(uParam0, iLocal_20, 1);
	}
	return true;
