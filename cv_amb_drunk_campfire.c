...
bool func_72(var uParam0)
{
	...
	__LIB_7__::func_46(uParam0, 0f, 0f, 0f, 0f, 3f, 3f, 5f, joaat("VOLCYLINDER"), 1);
	__LIB_7__::func_47(uParam0, 0.7058f, 2.1098f, 0f, 49.32f, 1.2f, 1.26f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_JOHN"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, -1.59f, -0.7f, 0f, 14.4f, 1.2f, 1.2f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_SEAN"), 1, 1, 1);
	iLocal_14 = __LIB_7__::func_48(uParam0, 1, "MALE_A");
	iLocal_15 = __LIB_7__::func_48(uParam0, 8, "MALE_B");
	iLocal_16 = __LIB_7__::func_142(uParam0, joaat("P_CHAIR_CRATE02X"), -1.86272f, -0.829352f, -0.0207291f, 0, 1, 0, 1);
	__LIB_7__::func_142(uParam0, joaat("P_BOTTLEJD01X"), 0f, 0f, 0f, "BOTTLE", 0, 1, 1);
	switch (__LIB_4__::func_576(uParam0))
	{
		case 11:
			__LIB_7__::func_142(uParam0, joaat("P_CS_ROLLUPCIG01X"), 0f, 0f, 0f, "CIGARETTE", 0, 1, 1);
			__LIB_6__::func_959(uParam0, "script@vignette@ambient@av_drunk_campfire@male_d@base", 1, 1, 0, 0);
			__LIB_6__::func_959(uParam0, "script@vignette@ambient@av_drunk_campfire@male_d@action", 0, 0, 1, 0);
			break;
		default:
			return false;
	}
	__LIB_7__::func_107(uParam0, iLocal_14, 3, joaat("WORLD_CAMP_FIRE_SIT_GROUND"), "WORLD_CAMP_FIRE_SIT_GROUND_MALE_C", -1, 1);
	__LIB_7__::func_127(uParam0, iLocal_14, 2, joaat("WORLD_HUMAN_SIT_GROUND_DRINK_DRUNK"), "WORLD_HUMAN_SIT_GROUND_DRINK_DRUNK_MALE_B", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_127(uParam0, iLocal_15, 3, joaat("PROP_HUMAN_SEAT_CHAIR_SMOKE_ROLL"), "PROP_HUMAN_SEAT_CHAIR_SMOKE_ROLL_MALE_A", iLocal_16, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
