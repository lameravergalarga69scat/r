...
bool func_72(var uParam0)
{
	...
	__LIB_7__::func_47(uParam0, 4.115f, 2.36f, 1.1875f, -44f, 1.0975f, 1.145f, 3.2075f, joaat("VOLBOX"), joaat("APMS_COMP_LENNY"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, -0.0675f, 2.0425f, 1.1875f, 16f, 3.4425f, 1.2525f, 3.2075f, joaat("VOLBOX"), joaat("APMS_COMP_SEAN"), 1, 1, 1);
	__LIB_6__::func_958(uParam0, joaat("P_CIGARETTE_CS02X"), 0f, 0f, 0f, "CIGARETTE", 0, 1, 1);
	iLocal_21 = __LIB_6__::func_958(uParam0, joaat("P_BENCH_LOG07X"), -1.372f, 1.604f, -0.0733f, 0, 1, 0, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@sean_13@base", 1, 1, 0, 0);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@sean_13@action_a", 2, 0, 1, 0);
	iLocal_18 = __LIB_6__::func_959(uParam0, "script@vignette@sean_13@Action_A_Int_Front", 2, 0, 0, 1);
	iLocal_19 = __LIB_6__::func_959(uParam0, "script@vignette@sean_13@Action_A_Int_Left", 2, 0, 0, 1);
	iLocal_20 = __LIB_6__::func_959(uParam0, "script@vignette@sean_13@Action_A_Int_Right", 2, 0, 0, 1);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@sean_13@action_b", 0, 0, 0, 0);
	__LIB_7__::func_146(uParam0, "CSE13AU");
	__LIB_7__::func_149(uParam0, joaat("COMP_SENCNV13"), joaat("PLAYER_SENCNV13"));
	__LIB_7__::func_107(uParam0, iLocal_14, 3, joaat("PROP_CAMP_FIRE_SEATED"), "PROP_CAMP_FIRE_SEAT_BENCH_MALE_B", iLocal_21, 0);
	...
	Local_22 = { __LIB_7__::func_160(uParam0, -0.5575f, 2.325f, 1.07f, 159f, 6.5f, 0.1725f, 0.66f) };
	Local_32 = { __LIB_7__::func_160(uParam0, -0.5575f, 2.325f, 1.07f, -126.25f, 6.5f, 0.22f, 0.6575f) };
	Local_42 = { __LIB_7__::func_160(uParam0, -0.558f, 2.325f, 1.07f, -47.16f, 6.5f, 0.22f, 0.66f) };
	return true;
}
