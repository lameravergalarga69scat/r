...
bool func_72(var uParam0)
{
	...
	__LIB_7__::func_146(uParam0, "CWRM2AU");
	iLocal_14 = __LIB_7__::func_48(uParam0, 6, 0);
	__LIB_6__::func_958(uParam0, joaat("P_FOLDEDBILLS01X"), 0f, 0f, 0f, "MONEY", 0, 1, 1);
	iLocal_15 = __LIB_6__::func_958(uParam0, joaat("S_LOOTABLECAMPCASE"), 0.158f, -0.064f, 0.979f, "CASE", 1, 0, 1);
	__LIB_7__::func_46(uParam0, 0f, 0f, 0f, 0f, 5f, 5f, 5f, joaat("VOLCYLINDER"), 1);
	__LIB_7__::func_47(uParam0, 1f, 0f, 0f, 0f, 3f, 3f, 5f, joaat("VOLBOX"), -1, 1, 1, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@wrk@micah_work_2@base", 1, 1, 0, 0);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@wrk@micah_work_2@action", 0, 0, 1, 0);
	__LIB_7__::func_149(uParam0, joaat("COMP_MCHWRKCNV2"), joaat("PLAYER_MCHWRKCNV2"));
	__LIB_7__::func_151(uParam0, iLocal_14, 1, -1);
	__LIB_7__::func_147(uParam0, iLocal_14, 4, 3, 0, 0, 0);
	__LIB_7__::func_277(uParam0, iLocal_14, "GREET_MICAH_MCHWRKCNV2", 60000, 1);
	return true;
}
...
{
	if (!bLocal_17 && __LIB_7__::func_40(uParam0, iLocal_16, 0.9f))
	{
		__LIB_7__::func_423(6, 2500);
		bLocal_17 = true;
	}
	if (__LIB_7__::func_268(uParam0) && func_200(uParam0))
	{
...
int func_148(var uParam0)
{
	...
	{
		case 1:
			return __LIB_7__::func_424(uParam0);
		case 2:
			return __LIB_7__::func_425(uParam0);
		default:
			break;
	}
	return 0;
	...
	switch (Global_1360165[iParam0 /*1157*/].f_11)
	{
		...
		case 3:
			if (!ENTITY::IS_ENTITY_DEAD(Global_1360165[iParam0 /*1157*/]) && !ANIMSCENE::_0x3AB6C7B0BB0DF4B1(Global_1360165[iParam0 /*1157*/], -1))
			{
				...
				func_433(Global_1360165[iParam0 /*1157*/], vVar0, iParam6, 2, 1073741824 /* Float: 2f */);
			}
			else if (bParam16)
			{
	...
	switch (Global_1360165[iParam0 /*1157*/].f_70.f_12)
	{
		...
		case 3:
			...
			if ((bParam2 && !__LIB_0__::func_86(vVar0)) && !__LIB_0__::func_175(vVar0, ENTITY::GET_ENTITY_COORDS(Global_1360165[iParam0 /*1157*/].f_124, true, false), 1056964608 /* Float: 0.5f */, 1))
			{
				...
				func_433(Global_1360165[iParam0 /*1157*/].f_124, vVar0, iParam6, 2, 1073741824 /* Float: 2f */);
			}
			if (bParam1)
			{
