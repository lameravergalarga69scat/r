...
bool func_72(var uParam0)
{
	...
	{
		case 1:
			__LIB_7__::func_116(uParam0, -139.903f, -41.345f, 93.65f, 0f, 0f, -100.97f);
			iLocal_19 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-98.0355f, -17.41405f, 96.11881f, 0f, 0f, 0f, 14f, 12f, 3f, "TRIGGER_VOL");
			break;
		case 2:
			__LIB_7__::func_116(uParam0, 682.339f, -1229.725f, 44.215f, 0f, -2f, -84.6f);
			iLocal_19 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(717.5239f, -1193.695f, 45.56543f, 0f, 0f, 20f, 14f, 12f, 3f, "TRIGGER_VOL");
			break;
		default:
			return false;
	}
	...
	__LIB_6__::func_958(uParam0, joaat("P_CS_PLATESTEW01X"), 0f, 0f, 0f, "PLATE", 0, 0, 1);
	__LIB_7__::func_271(uParam0, iLocal_14, joaat("WEAPON_SHOTGUN_DOUBLEBARREL"), "SHOTGUN");
	__LIB_6__::func_959(uParam0, "script@vignette@sean_7@base", 1, 1, 0, 0);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@sean_7@action_a", 2, 0, 1, 0);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@sean_7@action_b", 0, 0, 0, 0);
	iLocal_18 = __LIB_6__::func_959(uParam0, "script@vignette@sean_7@action_b_alt", 0, 0, 0, 1);
	__LIB_7__::func_146(uParam0, "CSEN7");
	__LIB_7__::func_149(uParam0, joaat("COMP_SENCNV7"), joaat("PLAYER_SENCNV7"));
...
bool func_93(var uParam0)
{
	...
	{
		if (__LIB_1__::func_205(Global_35, iLocal_19, 1, 0))
		{
			__LIB_7__::func_150(uParam0, iLocal_18, -1, 0.64f);
			__LIB_7__::func_154(uParam0, iLocal_18, 1);
		}
		else
		{
			__LIB_7__::func_150(uParam0, iLocal_17, -1, 0.64f);
