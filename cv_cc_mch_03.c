...
bool func_72(var uParam0)
{
	...
	{
		case 1:
			__LIB_7__::func_45(uParam0, 114, 0, 0, 0);
			Local_19 = { __LIB_7__::func_160(uParam0, 0.5409f, -1.327f, 0.974f, 142f, 6f, 1f, 0.4f) };
			Local_29 = { __LIB_7__::func_160(uParam0, 0.5409f, -1.327f, 0.974f, 47f, 6f, 0.655f, 1f) };
			Local_39 = { __LIB_7__::func_160(uParam0, 0.24f, -0.3f, 0.974f, -91.8f, 8f, 0.4f, 0.51f) };
			break;
		default:
			return false;
	}
	...
	__LIB_7__::func_47(uParam0, 0.15f, -0.72f, 1f, 38.88f, 2.5f, 2.5f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_BILL"), 1, 1, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@micah_3@base", 1, 1, 0, 0);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@micah_3@action_a", 2, 0, 1, 0);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@micah_3@action_b", 0, 0, 0, 0);
	iLocal_18 = __LIB_6__::func_959(uParam0, "script@vignette@micah_3@action_b_int", 0, 0, 0, 1);
	__LIB_7__::func_146(uParam0, "CCMCAUD");
	...
	__LIB_7__::func_145(uParam0, 8f, 15f);
	return true;
}
...
bool func_75(var uParam0)
{
	if (__LIB_0__::func_78(uParam0) == 3)
	{
		if (!ENTITY::DOES_ENTITY_EXIST(iLocal_70))
		{
			...
			{
				iLocal_70 = OBJECT::CREATE_OBJECT(joaat("P_CRATE02X"), __LIB_6__::func_972(uParam0, 0.778003f, -0.256235f, -0.0359992f), true, true, false, false, true);
				ENTITY::SET_ENTITY_HEADING(iLocal_70, __LIB_6__::func_973(uParam0, -98.95381f));
			}
			return false;
		}
		if (!ENTITY::DOES_ENTITY_EXIST(iLocal_69))
		{
			...
			{
				iLocal_69 = OBJECT::CREATE_OBJECT(joaat("P_BARREL05X"), __LIB_6__::func_972(uParam0, -0.0861425f, 0.136672f, -0.00999832f), true, true, false, false, true);
				ENTITY::SET_ENTITY_HEADING(iLocal_69, __LIB_6__::func_973(uParam0, -19.09583f));
			}
			return false;
		}
	}
...
bool func_86(var uParam0)
{
	...
	{
		if (WEAPON::HAS_PED_GOT_WEAPON(__LIB_6__::func_952(uParam0, iLocal_14), joaat("WEAPON_REVOLVER_SCHOFIELD_BILL"), 0, false))
		{
			WEAPON::SET_CURRENT_PED_WEAPON(__LIB_6__::func_952(uParam0, iLocal_14), joaat("WEAPON_REVOLVER_SCHOFIELD_BILL"), true, 0, false, false);
		}
	}
	return true;
}
...
{
	return (((PED::_0x7F9B9791D4CB71F6(Global_35, __LIB_6__::func_952(uParam0, iLocal_14), 0, 0) == 1 || PED::_0x7F9B9791D4CB71F6(Global_35, __LIB_6__::func_952(uParam0, iLocal_15), 0, 0) == 1) || __LIB_0__::func_48(Global_35, __LIB_6__::func_952(uParam0, iLocal_14), 8f, 1)) && ((!__LIB_7__::func_163(uParam0, Local_39, 1, 0) && !__LIB_7__::func_163(uParam0, Local_49, 1, 0)) && !__LIB_7__::func_163(uParam0, Local_59, 1, 0)));
}
...
bool func_93(var uParam0)
{
	...
	{
		if (__LIB_7__::func_163(uParam0, Local_19, 1, 0) || __LIB_7__::func_163(uParam0, Local_29, 1, 0))
		{
