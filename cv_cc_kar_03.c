...
bool func_72(var uParam0)
{
	...
	{
		case 1:
			__LIB_7__::func_116(uParam0, -113.895f, -8.009f, 95.635f, 0f, 0f, -83.126f);
			break;
		case 2:
			__LIB_7__::func_116(uParam0, 684.807f, -1216.703f, 45.22f, 0f, 0f, -42.84f);
			break;
		case 3:
			__LIB_7__::func_116(uParam0, 1819.4f, -1805.4f, 48.35f, 0f, 0f, 90f);
			break;
		default:
			return false;
	}
	iLocal_14 = __LIB_7__::func_48(uParam0, 20, 0);
	__LIB_7__::func_47(uParam0, 0f, 0f, 0f, 102.24f, 1.5f, 1.5f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_KAREN"), 1, 1, 1);
	__LIB_7__::func_271(uParam0, iLocal_14, joaat("WEAPON_REPEATER_CARBINE"), "SHOTGUN");
	__LIB_6__::func_959(uParam0, "script@vignette@karen_3@base", 1, 1, 0, 0);
	__LIB_6__::func_959(uParam0, "script@vignette@karen_3@action", 0, 0, 1, 1);
	__LIB_7__::func_146(uParam0, "CKAR3AU");
	__LIB_7__::func_147(uParam0, iLocal_14, 4, 1, 0, 0, 0);
	__LIB_7__::func_151(uParam0, iLocal_14, 2, -1);
	__LIB_7__::func_127(uParam0, iLocal_14, 2, joaat("WORLD_HUMAN_GUARD_SCOUT"), "WORLD_HUMAN_GUARD_SCOUT_FEMALE_A", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	Local_15 = { __LIB_7__::func_160(uParam0, 0f, 0f, 0f, 0f, 8f, 0.6f, 0.6f) };
