...
{
	__LIB_2__::func_851(uParam0, 11056, 11114, 11619);
}
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	int iVar1;
	int iVar2;
	__LIB_2__::func_853(uParam0, "TRAVELLER_GALLOP_PAST", "", vParam1, vParam4);
	iVar1 = 1;
	switch (*uParam0)
	{
		case 37:
			iLocal_39 = __LIB_2__::func_900(__LIB_1__::func_898(), 0, 0, 1, 0, 0, 1);
			iVar0 = __LIB_2__::func_44(joaat("HORSE_CLASS_RIDING"), 1);
			break;
		case 49:
			iLocal_39 = func_50(__LIB_1__::func_898());
			iVar0 = joaat("A_C_DONKEY_01");
			iVar1 = 0;
			break;
		case 61:
			switch (uParam0->f_489)
			{
				case 0:
				case default:
					iLocal_39 = __LIB_2__::func_900(__LIB_1__::func_898(), 1, 0, 1, 1, 1, 1);
					iVar0 = 0;
					iLocal_38 = func_51();
					__LIB_2__::func_946(uParam0, "CART", iLocal_38, vParam1, vParam4.z, 0, 0, 0, 0);
					break;
				case 1:
				...
				case 2:
					...
					iVar0 = 0;
					iVar2 = 1;
					iLocal_38 = func_54(__LIB_0__::func_12(), &iVar2);
					__LIB_2__::func_946(uParam0, "CART", iLocal_38, vParam1, vParam4.z, 0, 0, 0, 0);
					break;
			}
			break;
		case 64:
			iLocal_39 = __LIB_2__::func_900(__LIB_1__::func_898(), 1, 1, 1, 1, 0, 1);
			iVar0 = __LIB_2__::func_44(joaat("HORSE_CLASS_RIDING"), 1);
			break;
	}
	__LIB_2__::func_905(uParam0, 0, "TGPP_MAN", iLocal_39, vParam1, vParam4.z, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	__LIB_2__::func_905(uParam0, 1, "TGPP_HORSE", iVar0, vParam1, vParam4.z, 1, 1, 1, iVar1, joaat("META_OUTFIT_DEFAULT"), 1);
	if (iVar2 == 2)
	{
		__LIB_2__::func_905(uParam0, 2, "TGPP_HORSE_2", iVar0, vParam1, vParam4.z, 1, 1, 1, iVar1, joaat("META_OUTFIT_DEFAULT"), 1);
	}
}
...
int func_31(var uParam0)
{
	...
	switch (iLocal_9)
	{
		case 0:
			...
			{
				fVar0 = __LIB_2__::func_990(uParam0->f_20[0 /*14*/].f_5);
				...
				if (__LIB_0__::func_272(uParam0->f_20[1 /*14*/], 0))
				{
					func_75(uParam0->f_20[1 /*14*/], uParam0->f_20[0 /*14*/].f_5, fVar0, 2, 1073741824 /* Float: 2f */);
					__LIB_1__::func_571(uParam0->f_20[0 /*14*/], uParam0->f_20[1 /*14*/], 1, -1, 1);
				}
				else if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_453))
				{
					func_75(uParam0->f_453, uParam0->f_20[0 /*14*/].f_5, fVar0, 2, 1073741824 /* Float: 2f */);
				...
				{
					TASK::_TASK_MOVE_IN_TRAFFIC(uParam0->f_20[0 /*14*/], 2.001f, 256, 0);
				}
...
int func_32(var uParam0, var uParam1)
{
	...
	{
		VEHICLE::_0xC399CC89FBA05DA0(uParam0->f_453, 1);
...
{
	int iVar0;
	iVar0 = joaat("U_M_M_RIODONKEYRIDER_01");
	switch (iParam0)
	{
		case 14:
			iVar0 = joaat("U_M_M_RIODONKEYRIDER_01");
			break;
		case 10:
			iVar0 = joaat("U_M_M_RKRDONKEYRIDER_01");
			break;
	}
	return iVar0;
}
