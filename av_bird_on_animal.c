...
{
	__LIB_2__::func_851(uParam0, 11068, 11127, 11681);
}
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	bool bVar1;
	int iVar2;
	__LIB_2__::func_853(uParam0, "BIRD_ON_ANIMAL", "", vParam1, vParam4);
	iVar0 = 1;
	bVar1 = __LIB_2__::func_918();
	switch (*uParam0)
	{
		case 116:
	...
	__LIB_2__::func_902(uParam0, 1, "BOA_BIRD_1", iLocal_10, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0.25f, -1f, 1f), (0f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	__LIB_2__::func_902(uParam0, 0, "BOA_ANIMAL_1", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0f, 0f, 1f), (0f + vParam4.z), iVar0, 1, 1, 1, iLocal_12, 1);
}
...
int func_30(var uParam0)
{
	...
	__LIB_2__::func_906(&uLocal_17, 65);
	return 1;
}
...
int func_31(var uParam0)
{
	...
	if (!uParam0->f_469[1])
	{
		...
		while (iVar1 < 2)
		{
			if (ENTITY::IS_ENTITY_DEAD(uParam0->f_20[iVar1 /*14*/]) || __LIB_2__::func_904(uParam0->f_20[iVar1 /*14*/], 0, &uLocal_17, &uVar0, 0, 0))
			{
				iLocal_13 = 1;
				uParam0->f_469[1] = 1;
			}
	...
	switch (iLocal_13)
	{
		case 0:
			...
			break;
		case 1:
			if (uParam0->f_469[1] || __LIB_2__::func_920(uParam0, uParam0->f_493, uParam0->f_494, 4, uParam0->f_495, 1112014848 /* Float: 50f */))
			{
				func_70(uParam0);
				PED::_0xEEED8FAFEC331A70(uParam0->f_20[0 /*14*/], Global_36, 0);
				__LIB_2__::func_919(uParam0->f_20[1 /*14*/], 1, 1);
		...
		case 2:
			...
			break;
		case 3:
			if (__LIB_1__::func_285(&uLocal_14, 5f))
			{
				return 1;
			}
			break;
