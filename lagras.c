...
bool func_11()
{
	iLocal_14 = Global_1888801[3 /*35*/].f_4;
	VOLUME::_0xB469CFD9E065EB99(iLocal_14, 1);
	iLocal_15 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(2162.926f, -618.1368f, 42.473f, 0f, 0f, 44.5f, 10.521f, 13f, 4f, "Lagras - m_volBaitShop");
	...
	VOLUME::_0xB469CFD9E065EB99(iLocal_15, 10000);
	return true;
}
...
void func_27(int iParam0)
{
	...
	__LIB_2__::func_775(17, 2168.851f, -622.9775f, 41.8217f, 332.7766f);
}

void func_28(int iParam0)
{
	__LIB_2__::func_812(644, iLocal_15, 1);
}
				...
				if (VOLUME::_DOES_VOLUME_EXIST((*uParam0)[iVar3 /*3*/]))
				{
					if (VOLUME::_IS_POSITION_INSIDE_VOLUME((*uParam0)[iVar3 /*3*/], Global_36))
					{
						if (!bVar1 && !bVar2)
						{
							...
							{
								func_64(iParam1, __LIB_1__::func_898(), -1, 0, -1, 0);
...
char* func_113(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, var uParam6)
{
	...
	{
		sVar0 = __LIB_1__::func_911(func_174(Global_36));
	}
