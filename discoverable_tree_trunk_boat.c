...
bool func_3(var uParam0)
{
	...
	if (Local_19 == 0)
	{
		...
		Local_19 = __LIB_7__::func_454(iVar0);
		return false;
	}
	if (__LIB_7__::func_497(Local_19, 4) || Global_40.f_8863.f_156)
	{
		func_1(uParam0);
		return false;
	}
...
void func_8(var uParam0)
{
	...
	switch (vLocal_14.x)
	{
		case 0:
			...
			{
				__LIB_1__::func_649(&vLocal_14, 4);
				return;
			}
			...
			__LIB_1__::func_649(&vLocal_14, 1);
			break;
		case 1:
			...
			__LIB_1__::func_649(&vLocal_14, 2);
			break;
		case 2:
			if (ENTITY::DOES_ENTITY_EXIST(vLocal_14.y))
			{
			...
			__LIB_1__::func_649(&vLocal_14, 3);
			break;
		case 3:
			if (!__LIB_7__::func_530(func_48()))
			{
...
void func_36(var uParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		iVar0 = __LIB_7__::func_463(*uParam0, func_83(), uParam0->f_4);
	}
	else
	{
...
void func_37(bool bParam0, int iParam1)
{
	...
	if (!__LIB_0__::func_28() || func_61() != -1)
	{
		return;
	}
...
bool func_69(var uParam0)
{
	...
	{
		case -1300082860:
			if (__LIB_0__::func_266(Global_35, func_101(uParam0, 0), 3f, 1, 1))
			{
				return true;
			}
			break;
...
int func_190(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		__LIB_0__::func_524(&Var0, func_197(0));
	}
...
{
	return func_203(joaat("CHARACTER"), __LIB_0__::func_217(), -1591664384, bParam0);
}
