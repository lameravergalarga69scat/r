...
bool func_72(var uParam0)
{
	...
	__LIB_7__::func_47(uParam0, 1.0585f, -0.4757f, 0.5633f, 0f, 1.1f, 1.1f, 4f, joaat("VOLBOX"), joaat("APMS_COMP_BILL"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, 8.6959f, -2.0924f, 0.8267f, 0f, 2f, 2f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_KIERAN"), 1, 1, 1);
	iLocal_20 = __LIB_6__::func_958(uParam0, joaat("P_CHAIR_CRATE02X"), 1.42062f, -0.462748f, 0.00315094f, "CRATE", 1, 0, 1);
	iLocal_21 = __LIB_6__::func_958(uParam0, joaat("P_BOTTLEJD01X"), 0f, 0f, 0f, "BOTTLE", 0, 0, 1);
	__LIB_6__::func_958(uParam0, joaat("P_BRUSHHORSE02X"), 0f, 0f, 0f, "BRUSH", 0, 1, 1);
	__LIB_6__::func_958(uParam0, joaat("P_CS_SADDLE02X"), 0f, 0f, 0f, "SADDLE", 0, 1, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@bill_4@base", 1, 1, 0, 0);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@bill_4@action_a", 2, 0, 1, 0);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@bill_4@action_b", 0, 0, 0, 0);
	iLocal_18 = __LIB_6__::func_959(uParam0, "script@vignette@bill_4@action_b_alt_left", 0, 0, 0, 0);
	iLocal_19 = __LIB_6__::func_959(uParam0, "script@vignette@bill_4@action_b_alt_right", 0, 0, 0, 0);
	__LIB_7__::func_146(uParam0, "CBLL4AU");
	__LIB_7__::func_127(uParam0, iLocal_14, 3, joaat("PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS"), "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_MALE_D", iLocal_20, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	...
	Local_22 = { __LIB_7__::func_160(uParam0, 1.0585f, -0.4757f, 0.5633f, 75.25f, 6f, 0.35f, 0.35f) };
	Local_32 = { __LIB_7__::func_160(uParam0, 1.0952f, -0.4301f, 0.5478f, -66.75f, 6f, 0.6f, 0.4f) };
...
bool func_84(var uParam0)
{
	...
	__LIB_1__::func_206(vVar0, 1.5f, 2);
	return true;
}
...
bool func_95(var uParam0)
{
	...
	{
		if (!__LIB_0__::func_75(&uLocal_46))
		{
	...
	{
		__LIB_0__::func_37(&uLocal_46);
	}
	if (__LIB_0__::func_264(&uLocal_46) > 1.5f)
	{
		return true;
	}
	return false;
