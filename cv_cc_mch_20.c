...
bool func_72(var uParam0)
{
	...
	{
		case 1:
			__LIB_7__::func_45(uParam0, 174, 0, 0, 0);
			break;
		case 2:
			__LIB_7__::func_45(uParam0, 83, 0, 0, 0);
			break;
		case 3:
			__LIB_7__::func_116(uParam0, 1879.725f, -1860.865f, 41.78f, 0f, 0f, -27.02f);
			break;
		default:
			return false;
	}
	iLocal_14 = __LIB_7__::func_48(uParam0, 6, 0);
	iLocal_15 = __LIB_7__::func_48(uParam0, 13, 0);
	__LIB_7__::func_47(uParam0, -1.64f, 0.39f, 1f, 0f, 1.7f, 3.7f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_MICAH"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, 1.3438f, -1.4897f, 1f, 0f, 2.5f, 2f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_ABIGAIL"), 1, 1, 1);
	iLocal_22 = __LIB_6__::func_958(uParam0, joaat("P_CS_RAG02X"), 0f, 0f, 0f, "RAG", 0, 1, 1);
	__LIB_6__::func_958(uParam0, joaat("P_BOTTLEBEER01X"), 0f, 0f, 0f, "BEER", 0, 1, 1);
	iLocal_23 = __LIB_6__::func_958(uParam0, joaat("P_BOTTLEBEER01X"), 0f, 0f, 0f, "BOTTLECRATE", 0, 0, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@micah_20@base", 1, 1, 0, 0);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@micah_20@action_a", 2, 0, 1, 0);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@micah_20@action_b", 0, 0, 0, 0);
	iLocal_18 = __LIB_6__::func_959(uParam0, "script@vignette@micah_20@action_b_alt_front", 0, 0, 0, 1);
	iLocal_19 = __LIB_6__::func_959(uParam0, "script@vignette@micah_20@action_b_alt_right", 0, 0, 0, 1);
	iLocal_20 = __LIB_6__::func_959(uParam0, "script@vignette@micah_20@action_b_alt_back_left", 0, 0, 0, 1);
	iLocal_21 = __LIB_6__::func_959(uParam0, "script@vignette@micah_20@action_b_alt_back_right", 0, 0, 0, 1);
	__LIB_7__::func_146(uParam0, "CCM20AU");
	__LIB_7__::func_107(uParam0, iLocal_14, 3, joaat("WORLD_HUMAN_DRINKING"), "WORLD_HUMAN_STAND_DRINK_MALE_A", -1, 1);
	__LIB_7__::func_127(uParam0, iLocal_14, 3, joaat("WORLD_HUMAN_DRINKING"), "WORLD_HUMAN_STAND_DRINK_MALE_A", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_171(uParam0, iLocal_14, 3, 0);
	__LIB_7__::func_139(uParam0, iLocal_14, iLocal_23, "p_bottleBeer01x_PH_R_HAND", 0, 0);
	__LIB_7__::func_151(uParam0, iLocal_14, 1, -1);
	__LIB_7__::func_107(uParam0, iLocal_15, 2, joaat("WORLD_HUMAN_CLEAN_TABLE"), "WORLD_HUMAN_CLEAN_TABLE_FEMALE_B", -1, 1);
	__LIB_7__::func_127(uParam0, iLocal_15, 2, joaat("WORLD_HUMAN_CLEAN_TABLE"), "WORLD_HUMAN_CLEAN_TABLE_FEMALE_B", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_139(uParam0, iLocal_15, iLocal_22, "p_cs_rag02x_PH_R_HAND", 0, 0);
	__LIB_7__::func_151(uParam0, iLocal_15, 1, -1);
	__LIB_7__::func_149(uParam0, joaat("COMP_MCHCNV20"), joaat("PLAYER_MCHCNV20"));
	Local_24 = { __LIB_7__::func_160(uParam0, 0.4727f, -2.4763f, 1.004f, -45.72f, 8f, 0.337f, 0.5f) };
	Local_34 = { __LIB_7__::func_160(uParam0, 0.473f, -2.476f, 1.004f, -135.73f, 8f, 0.5f, 0.5f) };
	Local_44 = { __LIB_7__::func_160(uParam0, 0.473f, -2.476f, 1.004f, 134.24f, 8f, 0.5f, 0.5f) };
	Local_54 = { __LIB_7__::func_160(uParam0, 0.473f, -2.476f, 1.004f, 44.24f, 8f, 0.5f, 0.081f) };
	return true;
}
