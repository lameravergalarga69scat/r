...
{
	__LIB_4__::func_389(560870147, 0, 1);
...
bool func_78(var uParam0)
{
	...
	{
		case 3:
			__LIB_7__::func_45(uParam0, 212, 0, 0, 0);
			break;
		default:
			return false;
	}
	__LIB_7__::func_48(uParam0, 13, 0);
	__LIB_7__::func_48(uParam0, 1, 0);
	iLocal_14 = __LIB_7__::func_48(uParam0, 0, 0);
	iLocal_15 = __LIB_6__::func_958(uParam0, joaat("P_CS_BOOKEVELYNMILLER"), 0f, 0f, 0f, "BOOK", 0, 1, 1);
	iLocal_16 = __LIB_6__::func_958(uParam0, joaat("S_CHAIR04X"), 3.388f, -3.688f, 0f, "CHAIR", 1, 0, 1);
	__LIB_7__::func_47(uParam0, 1.575f, -2.975f, 1.15f, 43.56f, 5.738f, 4f, 4f, joaat("VOLBOX"), joaat("APMS_COMP_DUTCH"), 1, 1, 1);
	__LIB_7__::func_159(uParam0, 2.7376f, -2.875f, 0f, -46.75f, 2.2275f, 1.5775f, 6f, joaat("VOLBOX"), 1);
	__LIB_6__::func_959(uParam0, "script@vignette@dutch_23@base", 1, 1, 0, 0);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@dutch_23@action_a", 2, 0, 1, 0);
	iLocal_18 = __LIB_6__::func_959(uParam0, "script@vignette@dutch_23@action_b", 2, 0, 0, 0);
	iLocal_19 = __LIB_6__::func_959(uParam0, "script@vignette@dutch_23@action_c", 0, 0, 0, 0);
	iLocal_20 = __LIB_6__::func_959(uParam0, "script@vignette@dutch_23@action_c_alt_front", 0, 0, 0, 1);
	iLocal_21 = __LIB_6__::func_959(uParam0, "script@vignette@dutch_23@action_c_alt_left", 0, 0, 0, 1);
	iLocal_22 = __LIB_6__::func_959(uParam0, "script@vignette@dutch_23@action_c_alt_right", 0, 0, 0, 1);
	__LIB_7__::func_146(uParam0, "CDT23AU");
	__LIB_7__::func_107(uParam0, iLocal_14, 3, joaat("SC_PROP_CAMP_DUTCH_SEAT_CHAIR_READING"), "SC_PROP_CAMP_DUTCH_SEAT_CHAIR_READING_MALE_A", iLocal_16, 0);
	__LIB_7__::func_127(uParam0, iLocal_14, 3, joaat("SC_PROP_CAMP_DUTCH_SEAT_CHAIR_READING"), "SC_PROP_CAMP_DUTCH_SEAT_CHAIR_READING_MALE_A", iLocal_16, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_139(uParam0, iLocal_14, iLocal_15, "p_cs_bookEvelynMiller_PH_R_HAND", 0, 0);
	Local_23 = { __LIB_7__::func_160(uParam0, 3.4201f, -3.2064f, 0.4939f, 146.88f, 8f, 0.37f, 0.16f) };
	Local_33 = { __LIB_7__::func_160(uParam0, 3.4201f, -3.2064f, 0.4939f, -154.25f, 8f, 0.205f, 0.175f) };
	Local_43 = { __LIB_7__::func_160(uParam0, 3.4201f, -3.2064f, 0.4939f, 44.75f, 8f, 0.8375f, 0.025f) };
	iLocal_53 = __LIB_7__::func_166(uParam0, 2.7376f, -2.875f, 0f, 0f, 0f, -46.75f, 2.2275f, 1.5775f, 6f, "GRIEF", joaat("VOLBOX"));
	return true;
}
...
bool func_90(var uParam0)
{
	...
	if (OBJECT::IS_DOOR_REGISTERED_WITH_SYSTEM(867489680))
	{
		iLocal_54 = ENTITY::GET_OBJECT_INDEX_FROM_ENTITY_INDEX(__LIB_3__::func_659(867489680, 1, 0));
	}
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_54))
	{
		__LIB_4__::func_389(560870147, 1, 1);
		__LIB_6__::func_986(iLocal_54, uParam0->f_1984[iLocal_17], "DOOR");
	}
	return true;
}
...
bool func_99(var uParam0)
{
	...
	{
		if (__LIB_7__::func_163(uParam0, Local_23, 1, 1))
		{
			__LIB_7__::func_173(uParam0, iLocal_20, 1);
			__LIB_7__::func_149(uParam0, joaat("COMP_DTCCNV23"), joaat("PLAYER_DTCCNV23"));
			__LIB_7__::func_151(uParam0, iLocal_14, 1, -1);
		}
		else if (__LIB_7__::func_163(uParam0, Local_33, 1, 1))
		{
			__LIB_7__::func_173(uParam0, iLocal_21, 1);
			__LIB_7__::func_149(uParam0, joaat("COMP_DTCCNV23"), joaat("PLAYER_DTCCNV23"));
			__LIB_7__::func_151(uParam0, iLocal_14, 1, -1);
		}
		else if (__LIB_7__::func_163(uParam0, Local_43, 1, 1))
		{
