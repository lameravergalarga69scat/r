...
bool func_72(var uParam0)
{
	...
	__LIB_7__::func_47(uParam0, 2.475f, 2.75f, 0.5445f, 80f, 1.7f, 1.7f, 1.5f, joaat("VOLCYLINDER"), joaat("APMS_COMP_PEARSON"), 1, 1, 1);
	iLocal_15 = __LIB_6__::func_958(uParam0, joaat("P_BOTTLEJD01X"), 0f, 0f, 0f, "BOTTLE", 0, 0, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@pearson_14@base", 1, 1, 0, 0);
	__LIB_6__::func_959(uParam0, "script@vignette@pearson_14@action", 0, 0, 1, 1);
	__LIB_7__::func_146(uParam0, "CPR14AU");
	__LIB_7__::func_139(uParam0, iLocal_14, iLocal_15, "p_bottleJD01x_PH_R_HAND", 0, 0);
	__LIB_7__::func_127(uParam0, iLocal_14, 2, joaat("WORLD_HUMAN_SIT_GROUND_DRINKING_DRUNK_PASSED_OUT"), "WORLD_HUMAN_SIT_GROUND_DRINKING_DRUNK_PASSED_OUT_MALE_B", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_147(uParam0, iLocal_14, 1, 6, 0, 0, 0);
	__LIB_7__::func_151(uParam0, iLocal_14, 3, -1);
	Local_16 = { __LIB_7__::func_160(uParam0, 2.3925f, 3.045f, 0.564f, 51.75f, 6.6675f, 0.905f, 0.43f) };
...
{
	if (__LIB_7__::func_272(__LIB_6__::func_952(uParam0, iLocal_14), 1838113450))
	{
		__LIB_6__::func_944();
	}
	return true;
