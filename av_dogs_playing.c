...
{
	__LIB_2__::func_851(uParam0, 10911, 10983, 11995);
}

void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	__LIB_2__::func_853(uParam0, "DOGS_PLAYING_TOGETHER", "script@ambient@animal@DOGS_PLAYING_TOGETHER@action", vParam1, vParam4);
	uParam0->f_16 = 1;
	__LIB_2__::func_854(uParam0, 1, "pbl_action", "", 0);
	__LIB_2__::func_855(uParam0, 0, "DOG1", joaat("A_C_DOGAMERICANFOXHOUND_01"), 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	__LIB_2__::func_855(uParam0, 1, "DOG2", joaat("A_C_DOGBLUETICKCOONHOUND_01"), 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
}
...
int func_30(var uParam0)
{
	...
	__LIB_2__::func_906(&uLocal_9, 50);
	return 1;
}
...
int func_31(var uParam0)
{
	...
	if (!uParam0->f_469[0])
	{
		if (!bLocal_37 == 1)
		{
			if (__LIB_2__::func_908(uParam0, &uLocal_9, 1))
			{
				bLocal_37 = true;
			}
		}
	...
	if (uParam0->f_469[0])
	{
		if (__LIB_1__::func_285(&uLocal_38, 2f))
		{
			return 1;
		}
	}
							...
							if (!uParam0->f_469[4])
							{
								if (ANIMSCENE::_0x005E6F28DD7ED58D(uParam0->f_3.f_1, uParam0->f_20[0 /*14*/].f_1))
								{
									if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
									{
										...
										TASK::TASK_WANDER_IN_AREA(uParam0->f_20[0 /*14*/], uParam0->f_20[0 /*14*/].f_5, 10f, 1077936128 /* Float: 3f */, 1086324736 /* Float: 6f */, 0);
