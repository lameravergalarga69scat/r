...
bool func_3(var uParam0)
{
	...
	{
		OBJECT::_0xCAAF2BCCFEF37F77(__LIB_7__::func_30(uParam0, iLocal_17), 32);
	}
	if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_107[iLocal_14 /*113*/].f_5))
	{
...
bool func_73(var uParam0)
{
	...
	__LIB_7__::func_47(uParam0, 0f, -0.5f, 1f, 0f, 2f, 2f, 3f, joaat("VOLBOX"), -1, 1, 1, 1);
	__LIB_6__::func_958(uParam0, joaat("P_KNIFE03X"), 0f, 0f, 0f, "p_knife03x", 0, 1, 1);
	iLocal_17 = __LIB_6__::func_958(uParam0, joaat("P_CS_MEATHANGER01X"), 0f, 0f, 0f, "HANGER", 0, 0, 1);
	iLocal_15 = __LIB_6__::func_959(uParam0, "script@ambient@campfiregeneral@BUTCHER_BLEED_HANGING_CARCASS@action", 0, 1, 0, 0);
	iLocal_16 = __LIB_7__::func_32(uParam0, iLocal_15, "PL_ACTION", 1);
	return true;
}
...
{
	__LIB_7__::func_83(uParam0, iLocal_15, "BOOL_BASE", 1);
	return true;
}
...
void func_198(var uParam0)
{
	...
	iVar2 = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(__LIB_7__::func_30(uParam0, iLocal_17), "bottomHookInd02");
	iVar3 = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(__LIB_7__::func_30(uParam0, iLocal_17), "bottomHookInd01");
	vVar4 = { ENTITY::GET_WORLD_POSITION_OF_ENTITY_BONE(__LIB_7__::func_30(uParam0, iLocal_17), iVar2) };
	vVar7 = { ENTITY::GET_WORLD_POSITION_OF_ENTITY_BONE(__LIB_7__::func_30(uParam0, iLocal_17), iVar3) };
	PED::SET_PED_TO_RAGDOLL(__LIB_6__::func_952(uParam0, iLocal_14), 10000, 15000, 0, false, true, false);
	PED::_0xE1AADD0055D76603(__LIB_6__::func_952(uParam0, iLocal_14), __LIB_7__::func_30(uParam0, iLocal_17), iVar0, iVar2, vVar4, -1f, 0, 0, 0);
	PED::_0xE1AADD0055D76603(__LIB_6__::func_952(uParam0, iLocal_14), __LIB_7__::func_30(uParam0, iLocal_17), iVar1, iVar3, vVar7, -1f, 0, 0, 0);
}
