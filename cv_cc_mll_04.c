...
bool func_72(var uParam0)
{
	...
	__LIB_7__::func_47(uParam0, -6.2199f, -0.4333f, 0.8367f, 0f, 1.5f, 1.5f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_MOLLY"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, -0.0006f, -0.0029f, 0.5041f, 0f, 1.5f, 2.02f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_DUTCH"), 1, 1, 1);
	iLocal_19 = __LIB_7__::func_142(uParam0, joaat("S_CARAVANCOT01X"), 0f, 0f, 0f, 0, 1, 0, 1);
	__LIB_7__::func_142(uParam0, joaat("P_CS_PILLOW01X"), 0f, 0f, 0f, "PILLOW", 0, 0, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@molly_4@base", 1, 1, 0, 0);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@molly_4@action_a", 2, 0, 1, 0);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@molly_4@action_b", 0, 0, 0, 0);
	iLocal_18 = __LIB_6__::func_959(uParam0, "script@vignette@molly_4@action_b_alt", 0, 0, 0, 1);
	__LIB_7__::func_146(uParam0, "CCML4AU");
	...
	Local_20 = { __LIB_7__::func_160(uParam0, -2.6633f, -1.8669f, 1.0082f, -162.72f, 8f, 0.5f, 0.5f) };
	return true;
}
