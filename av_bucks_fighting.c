...
{
	__LIB_2__::func_851(uParam0, 10809, 10868, 11772);
}

void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	__LIB_2__::func_853(uParam0, "BUCKS_FIGHTING", "script@ambient@animal@BUCKS_FIGHTING@action", vParam1, vParam4);
	uParam0->f_16 = 1;
	__LIB_2__::func_854(uParam0, 1, "pbl_action", "", 0);
	__LIB_2__::func_855(uParam0, 0, "BUCK1", iLocal_9, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 0);
	__LIB_2__::func_855(uParam0, 1, "BUCK2", iLocal_9, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 0);
}
...
int func_31(var uParam0)
{
	if (!uParam0->f_469[0])
	{
		...
		if (__LIB_2__::func_908(uParam0, &uLocal_10, 1) || __LIB_1__::func_992(Global_35, uParam0->f_483, 1) <= 900f)
		{
	...
	if (uParam0->f_469[0])
	{
		if (__LIB_1__::func_285(&uLocal_38, 4f))
		{
			return 1;
		}
	}
					...
					if (ANIMSCENE::_0x1F0E401031E20146(uParam0->f_3.f_1, "pbl_action"))
					{
						if (!uParam0->f_469[4])
						{
							if (ENTITY::HAS_ANIM_EVENT_FIRED(uParam0->f_20[0 /*14*/], joaat("ENDSINRUN")))
							{
								...
								TASK::_TASK_SMART_FLEE_STYLE_COORD(uParam0->f_20[0 /*14*/], uParam0->f_483, 3, 0, -1082130432 /* Float: -1f */, -1, 0);
						...
						if (!uParam0->f_469[5])
						{
							if (ENTITY::HAS_ANIM_EVENT_FIRED(uParam0->f_20[1 /*14*/], joaat("ENDSINRUN")))
							{
								...
								TASK::_TASK_SMART_FLEE_STYLE_COORD(uParam0->f_20[1 /*14*/], uParam0->f_483, 3, 0, -1082130432 /* Float: -1f */, -1, 0);
