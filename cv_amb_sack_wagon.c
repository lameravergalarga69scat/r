...
bool func_72(var uParam0)
{
	...
	{
		case 1:
			__LIB_7__::func_45(uParam0, 173, 0, 0, 0);
			break;
		case 2:
			__LIB_7__::func_45(uParam0, 98, 0, 0, 0);
			break;
		default:
			return false;
	}
	__LIB_7__::func_48(uParam0, 9, "MALE_A");
	__LIB_7__::func_48(uParam0, 8, "MALE_B");
	__LIB_7__::func_47(uParam0, 0f, -1.4f, 1f, 0f, 6f, 10f, 3f, joaat("VOLBOX"), -1, 1, 1, 1);
	__LIB_6__::func_958(uParam0, joaat("WAGON02X"), 0f, 0f, 0f, "WAGON", 0, 1, 1);
	__LIB_6__::func_958(uParam0, joaat("P_SACKCORN01X"), 0f, 0f, 0f, "SACK_A", 0, 1, 1);
	__LIB_6__::func_958(uParam0, joaat("P_SACKCORN01X"), 0f, 0f, 0f, "SACK_B", 0, 1, 1);
	iLocal_14 = __LIB_6__::func_959(uParam0, "script@vignette@ambient@av_wagon@sack_unload@base", 1, 1, 0, 0);
	iLocal_15 = __LIB_6__::func_959(uParam0, "script@vignette@ambient@av_wagon@sack_unload@action", 0, 0, 1, 0);
...
bool func_83(var uParam0)
{
	...
	else
	{
		...
		__LIB_6__::func_986(iLocal_16, uParam0->f_1984[iLocal_14], "WAGON");
		__LIB_6__::func_986(iLocal_16, uParam0->f_1984[iLocal_15], "WAGON");
		return true;
	}
	return false;
}
	...
	switch (Global_1360165[iParam0 /*1157*/].f_11)
	{
		...
		case 3:
			if (!ENTITY::IS_ENTITY_DEAD(Global_1360165[iParam0 /*1157*/]) && !ANIMSCENE::_0x3AB6C7B0BB0DF4B1(Global_1360165[iParam0 /*1157*/], -1))
			{
				...
				func_385(Global_1360165[iParam0 /*1157*/], vVar0, iParam6, 2, 1073741824 /* Float: 2f */);
			}
			else if (bParam16)
			{
	...
	switch (Global_1360165[iParam0 /*1157*/].f_70.f_12)
	{
		...
		case 3:
			...
			if ((bParam2 && !__LIB_0__::func_86(vVar0)) && !__LIB_0__::func_175(vVar0, ENTITY::GET_ENTITY_COORDS(Global_1360165[iParam0 /*1157*/].f_124, true, false), 1056964608 /* Float: 0.5f */, 1))
			{
				...
				func_385(Global_1360165[iParam0 /*1157*/].f_124, vVar0, iParam6, 2, 1073741824 /* Float: 2f */);
			}
			if (bParam1)
			{
