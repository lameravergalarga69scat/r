...
bool func_72(var uParam0)
{
	...
	iLocal_15 = __LIB_7__::func_48(uParam0, 21, "IG_RevSwanson");
	iLocal_14 = __LIB_7__::func_48(uParam0, 22, "IG_Tilly");
	__LIB_7__::func_47(uParam0, -13.0561f, 9.7196f, 0f, 53f, 2.49f, 2.2825f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_TILLY"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, -17.3311f, 17.0071f, 0f, 53f, 1.1f, 1.1f, 5f, joaat("VOLBOX"), -1, 1, 1, 1);
	iLocal_16 = __LIB_6__::func_958(uParam0, joaat("P_MUGCOFFEE01X"), 0f, 0f, 0f, "p_mugCoffee01x", 0, 0, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@swanson_17@base", 1, 1, 0, 0);
	__LIB_6__::func_959(uParam0, "script@vignette@swanson_17@action", 0, 0, 1, 0);
	__LIB_7__::func_146(uParam0, "CSW17AU");
	__LIB_7__::func_149(uParam0, joaat("COMP_SWNCNV17"), joaat("PLAYER_SWNCNV17"));
