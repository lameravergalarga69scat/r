#region Local Var
	...
	int iLocal_38 = 0;
	struct<23> Local_39 = { 0, 0, 0, 0, -1, 0, 0, 0, 2, 1, 1, 1, 0, 1, 2, 2, 3, 0, 0, 3, 1, 3, 3 } ;
	var uLocal_62 = 0;
	var uLocal_63 = 0;
...
{
	__LIB_2__::func_851(uParam0, 10745, 10864, 11206);
}

void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	__LIB_2__::func_853(uParam0, "MAN_STAND_AT_WAGON", "", vParam1, vParam4);
	__LIB_2__::func_902(uParam0, 0, "MSAWP_MAN", __LIB_2__::func_900(__LIB_1__::func_898(), 0, 0, 0, 0, 0, 1), OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0f, -2.5f, 0f), (179f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	__LIB_2__::func_946(uParam0, "WAGON", iLocal_38, vParam1, vParam4.z, 0, 0, 1, 0);
}
	...
	switch (iLocal_9)
	{
		case 0:
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
			{
				...
				WEAPON::_GIVE_WEAPON_TO_PED_2(uParam0->f_20[0 /*14*/], joaat("WEAPON_REPEATER_CARBINE"), 500, true, false, 0, false, 0.5f, 1f, 752097756, true, 0f, false);
				TASK::TASK_START_SCENARIO_AT_POSITION(uParam0->f_20[0 /*14*/], joaat("WORLD_HUMAN_GUARD_LEAN_WALL"), uParam0->f_20[0 /*14*/].f_5, uParam0->f_20[0 /*14*/].f_8, 0, false, true, "WORLD_HUMAN_GUARD_LEAN_WALL_MALE_E", -1f, false);
		...
		case 1:
			...
			break;
		case 2:
			_NAMESPACE29::_0x66F9EB44342BB4C5(uParam0->f_20[0 /*14*/], &Local_39);
			break;
	}
	return 0;
}
