...
bool func_11()
{
	iLocal_0 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(1880f, -1860f, 35f, 0f, 0f, 0f, 75f, 75f, 20f, "Shady Belle - volTown");
	return true;
}
...
bool func_15(int iParam0)
{
	...
	{
		iLocal_1 = AUDIO::_0x0556C784FA056628("shady_belle", "es_camp_memory_sounds");
