...
bool func_72(var uParam0)
{
	...
	{
		case 1:
			__LIB_7__::func_116(uParam0, -118.0872f, -27.6725f, 94.7f, 0f, 0f, -103.99f);
			break;
		case 2:
			__LIB_7__::func_116(uParam0, 665.5107f, -1243.862f, 43.04f, 0f, 0f, 134.74f);
			break;
		case 3:
			__LIB_7__::func_116(uParam0, 1881.7f, -1874.126f, 41.705f, 0f, 0f, -103.99f);
			break;
		default:
			return false;
	}
	...
	__LIB_7__::func_47(uParam0, -0.738f, -0.7181f, 0.5044f, 0f, 2.44f, 1.89f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_MICAH"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, -2.9678f, -4.3495f, 1.1403f, 0f, 1.5f, 1.5f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_GRIMSHAW"), 1, 1, 1);
	__LIB_6__::func_958(uParam0, joaat("P_CHAIRFOLDING02X"), 0f, 0f, 0f, "CHAIR", 1, 0, 1);
	__LIB_6__::func_958(uParam0, joaat("P_BOTTLEBEER01X"), 0f, 0f, 0f, "BOTTLE", 0, 0, 1);
	if (__LIB_0__::func_78(uParam0) == 1)
	{
		__LIB_6__::func_958(uParam0, joaat("P_BASKET02X"), 0f, 0f, 0f, "BASKET", 0, 0, 1);
	}
	__LIB_6__::func_959(uParam0, "script@vignette@micah_13@base", 1, 1, 0, 0);
	iLocal_15 = __LIB_6__::func_959(uParam0, "script@vignette@micah_13@action_a", 2, 0, 1, 0);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@micah_13@action_b", 2, 0, 0, 0);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@micah_13@action_b_int", 2, 0, 0, 1);
	iLocal_18 = __LIB_6__::func_959(uParam0, "script@vignette@micah_13@exit", 0, 0, 0, 0);
	__LIB_7__::func_146(uParam0, "CM13AUD");
	__LIB_7__::func_147(uParam0, iLocal_14, 2, 2, 0, 0, 0);
	__LIB_7__::func_144(uParam0, iLocal_14, 1.3f, 1065353216 /* Float: 1f */, 1092616192 /* Float: 10f */);
	__LIB_7__::func_151(uParam0, iLocal_14, 3, -1);
	Local_19 = { __LIB_7__::func_160(uParam0, 0.1821f, -1.2983f, 0.5878f, 78.84f, 8f, 0.75f, 0.7f) };
	return true;
}
...
int func_381(int iParam0, bool bParam1, bool bParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7, bool bParam8, bool bParam9, int iParam10)
{
	...
	switch (Global_1360165[iParam0 /*1157*/].f_70.f_12)
	{
		case 0:
			...
			{
				if (!__LIB_0__::func_851(iParam0) && func_411(iParam0, &uVar4))
				{
