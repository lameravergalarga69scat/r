...
{
	func_9(uParam0);
	SCRIPTS::_0xE7282390542F570D(uLocal_57);
...
bool func_3(var uParam0)
{
	...
	if (Local_58 == 0)
	{
		...
		Local_58 = __LIB_7__::func_454(iVar0);
		return false;
	}
	if (__LIB_7__::func_497(Local_58, 4) || Global_40.f_8863.f_156)
	{
		func_1(uParam0);
		return false;
	}
...
void func_8(var uParam0)
{
	...
	while (iVar0 <= 2)
	{
		...
		if (__LIB_1__::func_205(Global_35, Local_14[iVar0 /*13*/].f_1[2], 1, 0))
		{
			iVar2 = 3;
			while (iVar2 <= 5)
			{
				if (__LIB_1__::func_205(Global_35, Local_14[iVar0 /*13*/].f_1[iVar2], 1, 0))
				{
					func_50(uParam0);
					Local_14.f_40 = iVar2;
		...
		if ((((VOLUME::_DOES_VOLUME_EXIST(Local_14[iVar0 /*13*/].f_1[1]) && ENTITY::IS_ENTITY_IN_VOLUME(Global_35, Local_14[iVar0 /*13*/].f_1[1], true, 0)) && !CAM::IS_SCREEN_FADED_OUT()) && !CAM::IS_SCREEN_FADING_OUT()) && !__LIB_1__::func_927())
		{
		...
		{
			case 0:
				__LIB_0__::func_19(&(Local_14[iVar0 /*13*/]), 1);
				break;
			case 1:
				...
				__LIB_0__::func_19(&(Local_14[iVar0 /*13*/]), 2);
				break;
			case 2:
				iVar5 = 0;
				while (iVar5 <= 5)
				{
					if (!__LIB_7__::func_574(&(Local_14[iVar0 /*13*/].f_1[iVar5]), func_54(iVar1, iVar5)))
					{
						return;
					}
					iVar5++;
				...
				{
					__LIB_1__::func_148(&(Local_14[iVar0 /*13*/].f_8));
					GRAPHICS::SET_PARTICLE_FX_LOOPED_EVOLUTION(Local_14[iVar0 /*13*/].f_11, "Steam", 0.25f, false);
				}
				__LIB_0__::func_19(&(Local_14[iVar0 /*13*/]), 3);
				break;
			case 3:
				if (GRAPHICS::DOES_PARTICLE_FX_LOOPED_EXIST(Local_14[iVar0 /*13*/].f_11))
				{
					if (__LIB_0__::func_75(&(Local_14[iVar0 /*13*/].f_8)))
					{
						if (__LIB_0__::func_265(&(Local_14[iVar0 /*13*/].f_8)) > func_58(iVar1))
						{
							__LIB_1__::func_148(&(Local_14[iVar0 /*13*/].f_8));
							GRAPHICS::SET_PARTICLE_FX_LOOPED_EVOLUTION(Local_14[iVar0 /*13*/].f_11, "Steam", 1f, false);
							Local_14[iVar0 /*13*/].f_12 = 0;
							__LIB_0__::func_19(&(Local_14[iVar0 /*13*/]), 4);
						}
					}
				}
				break;
			case 4:
				if (GRAPHICS::DOES_PARTICLE_FX_LOOPED_EXIST(Local_14[iVar0 /*13*/].f_11))
				{
					if (__LIB_0__::func_75(&(Local_14[iVar0 /*13*/].f_8)))
					{
						if (__LIB_0__::func_265(&(Local_14[iVar0 /*13*/].f_8)) > func_59(iVar1))
						{
							__LIB_1__::func_148(&(Local_14[iVar0 /*13*/].f_8));
							__LIB_0__::func_19(&(Local_14[iVar0 /*13*/]), 5);
						}
					}
				}
				break;
			case 5:
				if (GRAPHICS::DOES_PARTICLE_FX_LOOPED_EXIST(Local_14[iVar0 /*13*/].f_11))
				{
					if (__LIB_0__::func_265(&(Local_14[iVar0 /*13*/].f_8)) > func_60(iVar1))
					{
						__LIB_1__::func_148(&(Local_14[iVar0 /*13*/].f_8));
						...
						__LIB_0__::func_19(&(Local_14[iVar0 /*13*/]), 6);
					}
				}
				break;
			case 6:
				if (!VOLUME::_DOES_VOLUME_EXIST(Local_14[iVar0 /*13*/].f_1[0]))
				{
					return;
				}
				...
				if (GRAPHICS::DOES_PARTICLE_FX_LOOPED_EXIST(Local_14[iVar0 /*13*/].f_11))
				{
					if (__LIB_0__::func_265(&(Local_14[iVar0 /*13*/].f_8)) > func_62(iVar1))
					{
						__LIB_1__::func_148(&(Local_14[iVar0 /*13*/].f_8));
						GRAPHICS::SET_PARTICLE_FX_LOOPED_EVOLUTION(Local_14[iVar0 /*13*/].f_11, "Steam", 0.25f, false);
...
void func_9(var uParam0)
{
	...
	while (iVar0 <= 2)
	{
		...
		while (iVar1 <= 5)
		{
			__LIB_7__::func_458(&(Local_14[iVar0 /*13*/].f_1[iVar1]));
			iVar1++;
		}
		iVar0++;
	}
...
void func_36(var uParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		iVar0 = __LIB_7__::func_463(*uParam0, func_92(), uParam0->f_4);
	}
	else
	{
...
void func_37(bool bParam0, int iParam1)
{
	...
	if (!__LIB_0__::func_28() || func_69() != -1)
	{
		return;
	}
...
{
	int iVar0;
	if (!func_132(joaat("DOCUMENT_PLAYER_JOURNAL"), 1, 0))
	{
...
int func_169(int iParam0, bool bParam1, bool bParam2)
{
	...
	uVar2 = INVENTORY::_0xE787F05DFC977BDE(func_134(bParam2), iParam0, 0);
	return uVar2;
}
...
int func_196(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		__LIB_0__::func_524(&Var0, func_203(0));
	}
...
{
	return func_209(joaat("CHARACTER"), __LIB_0__::func_217(), -1591664384, bParam0);
}
