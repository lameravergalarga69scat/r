...
bool func_72(var uParam0)
{
	...
	{
		case 2:
			__LIB_7__::func_45(uParam0, 88, 0, 0, 0);
			break;
		case 3:
			__LIB_7__::func_116(uParam0, 1886.526f, -1883.668f, 41.675f, 0f, 0f, 130.415f);
	}
	iLocal_14 = __LIB_7__::func_48(uParam0, 12, "DOG");
	iLocal_15 = __LIB_7__::func_48(uParam0, 6, "MicahBell");
	__LIB_6__::func_958(uParam0, joaat("P_CIGARETTE_CS01X"), 0f, 0f, 0f, "p_cigarette_cs01x", 0, 0, 1);
	__LIB_7__::func_47(uParam0, 5.3689f, 1.39f, 0f, 0f, 1.2f, 1.2f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_MICAH"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, -1.2936f, 1.19f, 0f, 0f, 1.2f, 1.2f, 5f, joaat("VOLBOX"), -1, 1, 1, 1);
	__LIB_7__::func_159(uParam0, -0.311109f, 1.6829f, 1.13478f, 0f, 1f, 1f, 5f, joaat("VOLCYLINDER"), 1);
	__LIB_6__::func_959(uParam0, "script@vignette@dog_4@base", 1, 1, 0, 0);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@dog_4@action", 0, 0, 1, 0);
	__LIB_7__::func_146(uParam0, "CCDG4AU");
	__LIB_7__::func_150(uParam0, iLocal_16, -1, 0.75f);
	...
	__LIB_7__::func_153(uParam0, iLocal_14, 0, 0, 0, -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_107(uParam0, iLocal_15, 3, joaat("WORLD_HUMAN_SMOKE"), "WORLD_HUMAN_SMOKE_MALE_D", -1, 1);
	__LIB_7__::func_151(uParam0, iLocal_15, 1, -1);
	__LIB_7__::func_149(uParam0, joaat("COMP_DOGCNV4"), joaat("PLAYER_DOGCNV4"));
	__LIB_7__::func_277(uParam0, iLocal_15, "GREET_MICAH_DOGCNV4", 60000, 1);
	return true;
}
...
bool func_93(var uParam0)
{
	...
	if (bLocal_18)
	{
		if (!ENTITY::IS_ENTITY_DEAD(__LIB_6__::func_952(uParam0, iLocal_14)))
		{
			...
			if (!bLocal_19 && !__LIB_0__::func_163(__LIB_6__::func_952(uParam0, iLocal_14), 242628503))
			{
	...
	switch (Global_1360165[iParam0 /*1157*/].f_11)
	{
		...
		case 3:
			if (!ENTITY::IS_ENTITY_DEAD(Global_1360165[iParam0 /*1157*/]) && !ANIMSCENE::_0x3AB6C7B0BB0DF4B1(Global_1360165[iParam0 /*1157*/], -1))
			{
				...
				func_420(Global_1360165[iParam0 /*1157*/], vVar0, iParam6, 2, 1073741824 /* Float: 2f */);
			}
			else if (bParam16)
			{
	...
	switch (Global_1360165[iParam0 /*1157*/].f_70.f_12)
	{
		...
		case 3:
			...
			if ((bParam2 && !__LIB_0__::func_86(vVar0)) && !__LIB_0__::func_175(vVar0, ENTITY::GET_ENTITY_COORDS(Global_1360165[iParam0 /*1157*/].f_124, true, false), 1056964608 /* Float: 0.5f */, 1))
			{
				...
				func_420(Global_1360165[iParam0 /*1157*/].f_124, vVar0, iParam6, 2, 1073741824 /* Float: 2f */);
			}
			if (bParam1)
			{
