...
bool func_72(var uParam0)
{
	...
	{
		case 1:
			__LIB_7__::func_45(uParam0, 175, 0, 0, 0);
			break;
		case 2:
			__LIB_7__::func_45(uParam0, 99, 0, 0, 0);
			break;
		default:
			return false;
	}
	...
	__LIB_7__::func_47(uParam0, 1.62f, -1.09f, 1f, 0f, 3f, 4f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_MICAH"), 1, 1, 1);
	iLocal_15 = __LIB_6__::func_958(uParam0, joaat("P_HAMMER03X"), 0f, 0f, 0f, "HAMMER", 0, 1, 1);
	__LIB_6__::func_958(uParam0, joaat("P_CIGARTHIN01X"), 0f, 0f, 0f, "CIGAR", 0, 1, 1);
	if (iVar0 == 1)
	{
		iLocal_16 = __LIB_6__::func_958(uParam0, joaat("P_CRATE03C"), 0.335795f, 0.233134f, 0.478706f, 0, 1, 0, 1);
	}
	__LIB_6__::func_959(uParam0, "script@vignette@micah_19@base", 1, 1, 0, 0);
	__LIB_6__::func_959(uParam0, "script@vignette@micah_19@action", 0, 0, 1, 0);
	__LIB_7__::func_146(uParam0, "CCM19AU");
	__LIB_7__::func_127(uParam0, iLocal_14, 2, joaat("PROP_HUMAN_REPAIR_WAGON_WHEEL_ON_SMALL"), "PROP_HUMAN_REPAIR_WAGON_WHEEL_ON_SMALL_MALE_A", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_139(uParam0, iLocal_14, iLocal_15, "p_hammer02x_PH_R_HAND", 0, 0);
...
bool func_86(var uParam0)
{
	...
	if (iLocal_16 != -1)
	{
		...
		{
			ENTITY::SET_ENTITY_COORDS(iVar0, __LIB_6__::func_972(uParam0, 0.762663f, 0.177343f, 0.465f), true, false, true, true);
		}
	}
	return true;
}
