...
bool func_72(var uParam0)
{
	...
	{
		case 3:
			__LIB_7__::func_116(uParam0, 1917.588f, -1822.075f, 40.777f, 0f, 0f, 0f);
			break;
		default:
			return false;
	}
	iLocal_14 = __LIB_7__::func_48(uParam0, 16, 0);
	iLocal_15 = __LIB_7__::func_48(uParam0, 20, 0);
	__LIB_7__::func_47(uParam0, -10.695f, 2.2941f, 1.1367f, -29f, 5f, 5f, 4f, joaat("VOLBOX"), joaat("APMS_COMP_MOLLY"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, -14.0653f, -8.1077f, 1.3223f, -29f, 1.5f, 1.5f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_KAREN"), 1, 1, 1);
	__LIB_6__::func_958(uParam0, joaat("P_CIGARETTE01X"), 0f, 0f, 0f, "CIGARETTE", 0, 1, 1);
	__LIB_6__::func_958(uParam0, joaat("P_CIGARETTE01X"), 0f, 0f, 0f, "CIGARETTE^1", 0, 1, 1);
	__LIB_6__::func_958(uParam0, joaat("P_MATCHSTICK01X"), 0f, 0f, 0f, "MATCHSTICK", 0, 1, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@molly_8@base", 1, 1, 0, 0);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@molly_8@action", 0, 0, 1, 0);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@molly_8@idle", 2, 0, 0, 0);
	iLocal_18 = __LIB_7__::func_32(uParam0, iLocal_16, "PL_IDLE_A", 1);
	__LIB_7__::func_32(uParam0, iLocal_16, "PL_IDLE_B", 1);
	__LIB_7__::func_32(uParam0, iLocal_16, "PL_IDLE_C", 1);
	__LIB_7__::func_32(uParam0, iLocal_16, "PL_IDLE_D", 1);
	__LIB_7__::func_32(uParam0, iLocal_16, "PL_IDLE_E", 1);
	__LIB_7__::func_32(uParam0, iLocal_16, "PL_IDLE_F", 1);
	__LIB_7__::func_32(uParam0, iLocal_16, "PL_IDLE_G", 1);
	__LIB_7__::func_32(uParam0, iLocal_16, "PL_IDLE_H", 1);
	__LIB_7__::func_32(uParam0, iLocal_16, "PL_IDLE_I", 1);
	__LIB_7__::func_32(uParam0, iLocal_16, "PL_FLINCH_LEFT", 1);
	iLocal_19 = __LIB_7__::func_32(uParam0, iLocal_16, "PL_FLINCH_RIGHT", 1);
	__LIB_7__::func_32(uParam0, iLocal_16, "PL_EXIT_BACK_DOCKS", 1);
	__LIB_7__::func_32(uParam0, iLocal_16, "PL_EXIT_BACK_LAND", 1);
	__LIB_7__::func_146(uParam0, "CMLL8AU");
	__LIB_7__::func_149(uParam0, joaat("COMP_MLLCNV8"), joaat("PLAYER_MLLCNV8"));
	__LIB_7__::func_150(uParam0, iLocal_17, -1, 0.87f);
	__LIB_7__::func_107(uParam0, iLocal_15, 3, joaat("WORLD_HUMAN_SMOKE"), "WORLD_HUMAN_SMOKE_FEMALE_A", -1, 1);
	__LIB_7__::func_151(uParam0, iLocal_15, 1, -1);
	__LIB_7__::func_147(uParam0, iLocal_14, 2, 2, 0, 0, 0);
	__LIB_7__::func_330(uParam0, iLocal_14, 1.6f, 1.3f, 20f);
	__LIB_7__::func_151(uParam0, iLocal_14, 3, -1);
	__LIB_7__::func_145(uParam0, 40f, 50f);
	return true;
}
...
{
	uParam0->f_107[iLocal_14 /*113*/].f_96 = { 1908.732f, -1818.967f, 41.9121f };
	return true;
}
...
{
	int iVar0;
	iVar0 = MISC::GET_RANDOM_INT_IN_RANGE(iLocal_18, iLocal_19 + 1);
	__LIB_7__::func_33(uParam0, iVar0, 1);
	__LIB_7__::func_284(uParam0, iVar0);
	__LIB_7__::func_154(uParam0, iLocal_16, 0);
	return true;
}
...
int func_383(int iParam0, bool bParam1, bool bParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7, bool bParam8, bool bParam9, int iParam10)
{
	...
	switch (Global_1360165[iParam0 /*1157*/].f_70.f_12)
	{
		case 0:
			...
			{
				if (!__LIB_0__::func_851(iParam0) && func_413(iParam0, &uVar4))
				{
