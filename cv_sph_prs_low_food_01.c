...
bool func_72(var uParam0)
{
	...
	switch (__LIB_0__::func_78(uParam0))
	{
		...
		case 3:
			...
			break;
		case 6:
			__LIB_7__::func_45(uParam0, 14, 0, 0, 0);
			iVar0 = 0;
			break;
	}
	iLocal_15 = __LIB_7__::func_48(uParam0, 17, 0);
	__LIB_7__::func_47(uParam0, 0.7063f, 0.0071f, 0f, 1.5f, 2f, 2f, 5f, joaat("VOLBOX"), -1, 1, 1, 1);
	__LIB_6__::func_958(uParam0, joaat("P_CRATE22X_SMALL"), 0f, 0f, 0f, "CRATE", iVar0, 0, 1);
	__LIB_6__::func_958(uParam0, joaat("P_CIGARETTE_CS02X"), 0f, 0f, 0f, "CIGARETTE", 0, 1, 1);
	__LIB_7__::func_107(uParam0, iLocal_15, 3, joaat("WORLD_HUMAN_SMOKE"), "WORLD_HUMAN_SMOKE_MALE_A", -1, 1);
	__LIB_7__::func_172(uParam0, iLocal_15, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@pearson_speech_low_food_1@base_intro", 1, 1, 0, 0);
	iLocal_14 = __LIB_6__::func_959(uParam0, "script@vignette@pearson_speech_low_food_1@action", 2, 0, 1, 0);
	StringCopy(&(uParam0->f_2236[0 /*8*/]), sLocal_20, 64);
	__LIB_7__::func_146(uParam0, "CPLF1AU");
	__LIB_7__::func_149(uParam0, joaat("COMP_PRSSPEECHLOWFOODCNV1"), joaat("PLAYER_PRSSPEECHLOWFOODCNV1"));
	__LIB_7__::func_150(uParam0, iLocal_14, -1, 0.85f);
...
bool func_93(var uParam0)
{
	if (__LIB_7__::func_148(uParam0, iLocal_14))
	{
		if (!bLocal_19)
		{
			...
			bLocal_19 = true;
			TASK::TASK_PLAY_ANIM(__LIB_6__::func_952(uParam0, iLocal_15), &(uParam0->f_2236[0 /*8*/]), "exit_back", 1000f, -8f, -1, 8192, 0f, false, 0, false, 0, false);
			PED::_0x2208438012482A1A(__LIB_6__::func_952(uParam0, iLocal_15), true, false);
		}
	}
	if (__LIB_1__::func_313(&uLocal_16, 2.5f))
	{
