...
bool func_6(var uParam0)
{
	switch (uParam0->f_11)
	{
		...
		case 2:
			if (uParam0->f_623)
			{
				PED::_0xED9582B3DA8F02B4(__LIB_9__::func_873(0) + 1);
			}
			else
			{
...
bool func_48(var uParam0)
{
	...
	{
		iVar1 = 0;
		while (iVar1 < __LIB_9__::func_873(iVar0))
		{
...
{
	int iVar0;
	iVar0 = __LIB_9__::func_844(0, __LIB_9__::func_762(), uParam0->f_616);
	uParam0->f_616 = iVar0;
...
Vector3 func_160()
{
	return __LIB_1__::func_344("ATZ_INS_EXC_MO");
}

Vector3 func_161()
{
	return __LIB_1__::func_344("ATZ_INS_FUR_MO");
}

Vector3 func_165()
{
	return __LIB_1__::func_344("ATZ_INS_TRB_MO");
}
...
int func_171()
{
	return 1337731811 /* GXTEntry: "Legendary Moose" */;
}
