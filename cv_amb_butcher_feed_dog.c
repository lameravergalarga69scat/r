...
bool func_72(var uParam0)
{
	...
	__LIB_7__::func_46(uParam0, 1.1f, -0.0125f, 0f, -16.25f, 2f, 2f, 3f, joaat("VOLCYLINDER"), 1);
	__LIB_7__::func_47(uParam0, 0.4499f, 0.2499f, 0f, 86.5f, 3.06f, 3.405f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_PEARSON"), 1, 1, 1);
	iLocal_15 = __LIB_7__::func_48(uParam0, 12, "Dog");
	iLocal_14 = __LIB_7__::func_48(uParam0, 17, "Butcher");
	iLocal_16 = __LIB_6__::func_958(uParam0, joaat("P_KNIFE03X"), 0f, 0f, 0f, "KNIFE", 0, 0, 1);
	__LIB_6__::func_958(uParam0, joaat("P_MEATCHUNKS01X"), 0f, 0f, 0f, "MEAT", 0, 0, 1);
	iLocal_17 = __LIB_6__::func_958(uParam0, joaat("P_CS_DEERCARCASSARM"), 5f, 5f, 5f, 0, 0, 0, 0);
	__LIB_7__::func_127(uParam0, iLocal_14, 4, joaat("PROP_HUMAN_BUTCHER_DEER"), "PROP_HUMAN_BUTCHER_DEER_MALE_A_LEG_GRAB", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_139(uParam0, iLocal_14, iLocal_16, "KNIFE", 0, 0);
	__LIB_7__::func_139(uParam0, iLocal_14, iLocal_17, "LEG", 0, 0);
	func_156(uParam0, iLocal_14, 4, 1);
	STREAMING::_REQUEST_SCENARIO_TYPE(joaat("PROP_HUMAN_BUTCHER_DEER"), 1, 0, 0);
	__LIB_7__::func_107(uParam0, iLocal_15, 3, joaat("WORLD_ANIMAL_DOG_BEGGING"), "WORLD_ANIMAL_DOG_BEGGING", -1, 1);
	__LIB_7__::func_237(uParam0, iLocal_15);
	iLocal_18 = __LIB_6__::func_959(uParam0, "script@ambient@campfireGeneral@BUTCHER_FEED_DOG@action", 0, 0, 0, 0);
	__LIB_7__::func_166(uParam0, 0.3125f, -0.5625f, 0f, 0f, 0f, 86.5f, 1.9525f, 2.7325f, 5f, "GRIEF VOL", joaat("VOLBOX"));
...
{
	uLocal_19 = STREAMING::_0xB223249B7798EEED(__LIB_6__::func_952(uParam0, iLocal_14), joaat("PROP_HUMAN_BUTCHER_DEER"), 262145, joaat("PROP_HUMAN_BUTCHER_DEER_MALE_A_LEG_GRAB"));
	return true;
}
...
void func_156(var uParam0, int iParam1, int iParam2, int iParam3)
{
	...
	switch (iParam2)
	{
		case 4:
			...
			break;
		default:
			Var0 = { func_256(__LIB_0__::func_78(uParam0), __LIB_7__::func_120(uParam0, iParam1), __LIB_4__::func_576(uParam0), 1) };
	...
	switch (Global_1360165[iParam0 /*1157*/].f_3)
	{
		...
		case 1:
			...
			if (iParam4 == 0)
			{
				...
				else if ((Global_1360165[iParam0 /*1157*/].f_4.f_2 != 0 && Global_1360165[iParam0 /*1157*/].f_4.f_2 == Global_40.f_4942[iParam0 /*60*/].f_59) && (func_429(Global_1360165[iParam0 /*1157*/].f_4.f_2) || __LIB_1__::func_44(Global_1360165[iParam0 /*1157*/].f_4.f_2)))
				{
