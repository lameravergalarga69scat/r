...
bool func_72(var uParam0)
{
	...
	__LIB_7__::func_47(uParam0, 0.3564f, 5.0196f, 1f, 0f, 1f, 1f, 2.75f, joaat("VOLBOX"), joaat("APMS_COMP_MICAH"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, 0.6975f, -2.325f, 0f, -9f, 2.765f, 1.745f, 4f, joaat("VOLBOX"), joaat("APMS_COMP_MARYBETH"), 1, 1, 1);
	iLocal_16 = __LIB_6__::func_958(uParam0, joaat("P_CS_LEDGERSMALL01X"), 0f, 0f, 0f, "BOOK", 0, 0, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@micah_30@base", 1, 1, 0, 0);
	__LIB_6__::func_959(uParam0, "script@vignette@micah_30@action", 0, 0, 1, 0);
	__LIB_7__::func_146(uParam0, "CCM30AU");
	__LIB_7__::func_107(uParam0, iLocal_15, 3, joaat("WORLD_HUMAN_BADASS"), "WORLD_HUMAN_BADASS_MALE_A", -1, 1);
	...
	__LIB_7__::func_127(uParam0, iLocal_14, 2, joaat("WORLD_HUMAN_SIT_GROUND_READING"), "WORLD_HUMAN_SIT_GROUND_READING_JOURNAL_FEMALE_A", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_139(uParam0, iLocal_14, iLocal_16, "p_cs_ledgerSmall01x_PH_L_HAND", 0, 0);
	return true;
}
