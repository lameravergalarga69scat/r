...
bool func_72(var uParam0)
{
	...
	{
		case 1:
			__LIB_7__::func_45(uParam0, 140, 0, 0, 0);
			break;
		default:
			return false;
	}
	...
	__LIB_7__::func_47(uParam0, 2.925f, -4.5625f, 0f, -35f, 1f, 1f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_KAREN"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, -0.125f, -0.4125f, 0f, -35f, 1f, 1f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_KIERAN"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, -6.55f, 2.7375f, 0f, -35f, 1f, 1f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_MARYBETH"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, -4.45f, -4.475f, 0f, -35f, 1f, 1f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_MARYBETH"), 1, 1, 1);
	__LIB_7__::func_159(uParam0, -0.325f, -0.736f, 0.6f, -35f, 1f, 1f, 2.5f, joaat("VOLCYLINDER"), 1);
	__LIB_6__::func_958(uParam0, joaat("P_BUCKET06X"), 0f, 0f, 0f, "BUCKET", 0, 0, 1);
	...
	iLocal_19 = __LIB_6__::func_958(uParam0, joaat("P_CS_ROPE03BX"), 0f, 0f, 0f, "ROPE", 0, 0, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@kieran_15@base", 1, 1, 0, 0);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@kieran_15@action_a", 2, 0, 1, 0);
	iLocal_18 = __LIB_6__::func_959(uParam0, "script@vignette@kieran_15@action_b", 0, 0, 0, 0);
	__LIB_7__::func_146(uParam0, "CKE15AU");
	__LIB_7__::func_127(uParam0, iLocal_14, 2, joaat("WORLD_CAMP_KIERAN_TREE_TIED"), "WORLD_CAMP_KIERAN_TIED_TREE_MALE_A", -1, 1, -1f, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_139(uParam0, iLocal_14, iLocal_19, "p_cs_rope03bx_PH_R_HAND", 0, 0);
	...
	__LIB_7__::func_107(uParam0, iLocal_16, 3, joaat("WORLD_HUMAN_DRINKING"), "WORLD_HUMAN_STAND_DRINK_FEMALE_D", -1, 1);
	return true;
}
...
bool func_93(var uParam0)
{
	...
	if (bLocal_20)
	{
		if (ENTITY::IS_ENTITY_OCCLUDED(__LIB_6__::func_952(uParam0, iLocal_14)))
		{
			...
			PERSCHAR::_0x631CD2D77FDC0316(PERSCHAR::_0x32A1E3B83D501096(__LIB_6__::func_952(uParam0, iLocal_14)));
			PERSCHAR::_0xD4B614179BCD0654(PERSCHAR::_0x32A1E3B83D501096(__LIB_6__::func_952(uParam0, iLocal_14)));
