...
bool func_72(var uParam0)
{
	switch (__LIB_0__::func_78(uParam0))
	{
		...
		case 2:
			...
			break;
		case 3:
			__LIB_7__::func_116(uParam0, 1895.533f, -1869.434f, 46.35f, 0f, 0f, 18f);
			break;
		default:
			return false;
	}
	...
	__LIB_7__::func_47(uParam0, 0.75f, -0.2f, 0f, 0f, 2f, 2f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_ABIGAIL"), 1, 1, 1);
	__LIB_7__::func_159(uParam0, 0f, -0.8f, 0.95f, 80.98939f, 1.512f, 1.512f, 1.38f, joaat("VOLCYLINDER"), 1);
	__LIB_6__::func_959(uParam0, "script@vignette@abigail_11@base", 1, 1, 0, 0);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@abigail_11@action_a", 2, 0, 1, 0);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@abigail_11@action_a_int", 2, 0, 0, 1);
	iLocal_18 = __LIB_6__::func_959(uParam0, "script@vignette@abigail_11@action_b", 2, 0, 0, 0);
	iLocal_19 = __LIB_6__::func_959(uParam0, "script@vignette@abigail_11@action_b_int", 2, 0, 0, 1);
	iLocal_20 = __LIB_6__::func_959(uParam0, "script@vignette@abigail_11@action_c", 2, 0, 0, 0);
	iLocal_21 = __LIB_6__::func_959(uParam0, "script@vignette@abigail_11@exit", 0, 0, 0, 0);
	__LIB_7__::func_146(uParam0, "CAB11AU");
	__LIB_7__::func_149(uParam0, joaat("COMP_ABICNV11"), joaat("PLAYER_ABICNV11"));
	__LIB_7__::func_150(uParam0, iLocal_21, -1, 0.9f);
	__LIB_7__::func_147(uParam0, iLocal_14, 1, 24, 0, 0, 0);
	__LIB_7__::func_151(uParam0, iLocal_14, 1, 180);
	__LIB_7__::func_147(uParam0, iLocal_15, 1, 12, 0, 0, 0);
	__LIB_7__::func_151(uParam0, iLocal_15, 1, -1);
	Local_22 = { __LIB_7__::func_160(uParam0, 1.0013f, 0.4609f, 1.0444f, 137.88f, 7f, 0.766f, 0.007f) };
	return true;
}
