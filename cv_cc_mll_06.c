...
bool func_72(var uParam0)
{
	...
	iLocal_17 = __LIB_6__::func_958(uParam0, joaat("P_CS_LEDGERSMALL01X"), 0f, 0f, 0f, "BOOK", 0, 1, 1);
	__LIB_6__::func_958(uParam0, joaat("P_CAMP_CUP_01X"), 0f, 0f, 0f, "CUP", 0, 1, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@molly_6@base", 1, 1, 0, 0);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@molly_6@action", 0, 0, 1, 0);
	__LIB_7__::func_146(uParam0, "CMLL6AU");
	__LIB_7__::func_149(uParam0, joaat("COMP_MLLCNV6"), joaat("PLAYER_MLLCNV6"));
	__LIB_7__::func_150(uParam0, iLocal_16, -1, 0.88f);
	...
	__LIB_7__::func_151(uParam0, iLocal_15, 1, 180);
	return true;
}
