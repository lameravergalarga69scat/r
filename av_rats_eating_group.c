...
{
	__LIB_2__::func_851(uParam0, 11185, 11236, 11690);
}

void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	__LIB_2__::func_853(uParam0, "RATS_EATING_GROUP", "", vParam1, vParam4);
	__LIB_2__::func_902(uParam0, 0, "REG_RAT_1", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0f, 0f, 0f), (0f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	__LIB_2__::func_902(uParam0, 1, "REG_RAT_2", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, -0.25f, 0.25f, 0f), (135f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	__LIB_2__::func_902(uParam0, 2, "REG_RAT_3", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0.25f, 0.25f, 0f), (-45f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	__LIB_2__::func_902(uParam0, 3, "REG_RAT_4", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0.25f, 0f, 0f), (45f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	__LIB_2__::func_902(uParam0, 4, "REG_RAT_5", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, -0.5f, 0f, 0f), (-100f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	__LIB_2__::func_902(uParam0, 5, "REG_RAT_6", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, -0.5f, -0.25f, 0f), (-135f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	__LIB_2__::func_902(uParam0, 6, "REG_RAT_7", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0f, -0.5f, 0f), (-145f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	__LIB_2__::func_902(uParam0, 7, "REG_RAT_8", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0.25f, -0.5f, 0f), (-15f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	__LIB_2__::func_902(uParam0, 8, "REG_RAT_9", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0.5f, -0.25f, 0f), (-45f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	__LIB_2__::func_902(uParam0, 9, "REG_RAT_10", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0.25f, -0.75f, 0f), (50f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
}
	...
	switch (iLocal_10)
	{
		case 0:
			...
			while (iVar1 < 10)
			{
				...
				{
					__LIB_0__::func_634(&(uParam0->f_20[iVar1 /*14*/].f_5), 1, 5, 0);
					...
					__LIB_2__::func_857(&(uParam0->f_20[iVar1 /*14*/]), 1, 1);
				}
				iVar1++;
			}
			iLocal_10 = 1;
		...
		case 1:
			...
			else
			{
				...
				while (iVar1 < 10)
				{
					if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[iVar1 /*14*/]))
					{
						if (__LIB_2__::func_904(uParam0->f_20[iVar1 /*14*/], 0, &uLocal_11, &uVar0, 0, 0))
						{
							bVar2 = true;
						}
						else
						...
						if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_20[iLocal_42 /*14*/]))
						{
							...
							{
								__LIB_2__::func_857(&(uParam0->f_20[iLocal_42 /*14*/]), 0, 1);
								TASK::_TASK_SMART_FLEE_STYLE_PED(uParam0->f_20[iLocal_42 /*14*/], Global_35, 3, 0, -1082130432 /* Float: -1f */, -1, 0);
						...
						Jump @450; //curOff = 426
						if (__LIB_1__::func_285(&uLocal_39, 10f))
						{
							return 1;
						}
						return 0;
