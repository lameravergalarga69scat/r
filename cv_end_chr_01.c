...
bool func_72(var uParam0)
{
	...
	{
		case 8:
			__LIB_7__::func_116(uParam0, -1597.175f, -1407.71f, 80.955f, 0f, 0f, -24.82f);
			break;
		default:
			return false;
	}
	iLocal_14 = __LIB_7__::func_48(uParam0, 7, 0);
	__LIB_6__::func_958(uParam0, joaat("P_PITCHFORK01X"), 0f, 0f, 0f, "PITCHFORK", 0, 1, 1);
	__LIB_6__::func_958(uParam0, joaat("P_WHEELBARROW01X"), 0f, 0f, 0f, "WHEELBARROW", 0, 0, 1);
	__LIB_6__::func_958(uParam0, joaat("P_HAYPILE02X"), 0f, 0f, 0f, "HAYPILE", 0, 0, 1);
	__LIB_6__::func_958(uParam0, joaat("S_HORSEPOOP01X"), 0f, 0f, 0f, "HORSEPOOP01", 0, 0, 1);
	__LIB_6__::func_958(uParam0, joaat("S_HORSEPOOP02X"), 0f, 0f, 0f, "HORSEPOOP02", 0, 0, 1);
	__LIB_6__::func_958(uParam0, joaat("S_HORSEPOOP02X"), 0f, 0f, 0f, "HORSEPOOP02^1", 0, 0, 1);
	__LIB_6__::func_958(uParam0, joaat("S_HORSEPOOP02X"), 0f, 0f, 0f, "HORSEPOOP02^2", 0, 0, 1);
	__LIB_6__::func_958(uParam0, joaat("S_HORSEPOOP02X"), 0f, 0f, 0f, "HORSEPOOP02^3", 0, 0, 1);
	__LIB_6__::func_958(uParam0, joaat("S_HORSEPOOP02X"), 0f, 0f, 0f, "HORSEPOOP02^4", 0, 0, 1);
	__LIB_6__::func_958(uParam0, joaat("S_HORSEPOOP03X"), 0f, 0f, 0f, "HORSEPOOP03", 0, 0, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@beecher@charles_1@base", 1, 1, 0, 0);
	iLocal_15 = __LIB_6__::func_959(uParam0, "script@vignette@beecher@charles_1@action", 2, 0, 1, 1);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@beecher@charles_1@EXIT_LOOP", 1, 0, 0, 0);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@beecher@charles_1@EXIT_ACTION", 0, 0, 0, 0);
	__LIB_7__::func_146(uParam0, "BCHR1AU");
	__LIB_7__::func_149(uParam0, joaat("COMP_BCCHRCNV1"), joaat("PLAYER_BCCHRCNV1"));
	__LIB_7__::func_151(uParam0, iLocal_14, 1, -1);
	iLocal_18 = __LIB_7__::func_156(uParam0, 0f, 5.38f, 1.95f, 0f, 0f, -1f, 8.64f, 8.12f, 4f, "volTriggerBeecherCharles1", joaat("VOLBOX"));
...
bool func_93(var uParam0)
{
	...
	{
		if (__LIB_1__::func_992(Global_35, uParam0->f_29, 0) > (25f * 25f) && !CAM::IS_SPHERE_VISIBLE(uParam0->f_23, 5f))
		{
