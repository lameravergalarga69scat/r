...
bool func_72(var uParam0)
{
	...
	{
		case 1:
			__LIB_7__::func_45(uParam0, 159, 0, 0, 0);
			break;
		case 2:
			__LIB_7__::func_116(uParam0, 675.5f, -1204.7f, 45.7f, 0f, 0f, -180f);
			break;
		default:
			return false;
	}
	...
	__LIB_6__::func_958(uParam0, WEAPON::_GET_WEAPONTYPE_MODEL(joaat("WEAPON_SHOTGUN_DOUBLEBARREL")), 0f, 0f, 0f, "SHOTGUN", 0, 1, 1);
	__LIB_7__::func_47(uParam0, -7.13439f, -11.6913f, 0.418625f, 0f, 1.5f, 1.5f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_SEAN"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, -9.14886f, -2.50338f, 0.186272f, 0f, 1.5f, 1.5f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_HOSEA"), 1, 1, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@sean_5@base", 1, 1, 0, 0);
	iLocal_15 = __LIB_6__::func_959(uParam0, "script@vignette@sean_5@action_a", 2, 0, 1, 0);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@sean_5@action_b", 0, 0, 0, 0);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@sean_5@action_b_alt_front", 0, 0, 0, 1);
	iLocal_18 = __LIB_6__::func_959(uParam0, "script@vignette@sean_5@action_b_alt_back", 0, 0, 0, 1);
	__LIB_7__::func_146(uParam0, "CSEN5AU");
	__LIB_7__::func_149(uParam0, joaat("COMP_SENCNV5"), joaat("PLAYER_SENCNV5"));
	__LIB_7__::func_127(uParam0, iLocal_14, 2, joaat("WORLD_HUMAN_GUARD_SCOUT"), "WORLD_HUMAN_GUARD_SCOUT_MALE_C", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_147(uParam0, iLocal_14, 4, 4, 0, 0, 0);
	__LIB_7__::func_151(uParam0, iLocal_14, 1, -1);
	Local_19 = { __LIB_7__::func_160(uParam0, -7.912f, -10.5553f, 0.3967f, -176.76f, 7f, 0.5f, 0.5f) };
	Local_29 = { __LIB_7__::func_160(uParam0, -7.912f, -10.555f, 0.397f, 0f, 7f, 0.5f, 0.5f) };
	return true;
}
