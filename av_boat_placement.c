...
{
	__LIB_2__::func_851(uParam0, 10780, 10789, 10966);
}
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	__LIB_2__::func_946(uParam0, "VEH_BOAT", iLocal_9, vParam1, vParam4.z, 0, 0, 1, 0);
}
	...
	switch (iLocal_10)
	{
		case 0:
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_453))
			{
				...
				__LIB_3__::func_712(uParam0->f_453, &uLocal_11);
			}
			iLocal_10 = 1;
			break;
		case 1:
			if (ENTITY::_0xC8CCDB712FBCBA92(uParam0->f_453) || __LIB_0__::func_232(Global_35, uParam0->f_453, 1) < 400f)
			{
			...
			break;
		case 2:
			if (__LIB_0__::func_232(Global_35, uParam0->f_453, 1) > 10000f)
			{
				return 1;
			}
			break;
