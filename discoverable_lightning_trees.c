...
void func_8(var uParam0)
{
	...
	switch (Local_14)
	{
		...
		case 2:
			...
			{
				__LIB_1__::func_649(&Local_14, 0);
			}
			if (VOLUME::_DOES_VOLUME_EXIST(Local_14.f_2[0]) && ENTITY::IS_ENTITY_IN_VOLUME(Global_35, Local_14.f_2[0], true, 0))
			{
				if (!__LIB_0__::func_1(Local_14.f_7, 2) && AUDIO::_0xE368E8422C860BA7("LIGHTENING_STRIKE", "DSLIT_Sounds", -2))
				{
					__LIB_1__::func_581(&(Local_14.f_7), 2);
				}
				if (!__LIB_0__::func_75(&(Local_14.f_4)))
				{
					__LIB_1__::func_148(&(Local_14.f_4));
					STREAMING::REQUEST_ANIM_DICT(func_55(func_15()));
				}
				if (__LIB_1__::func_871(&(Local_14.f_4)) > 3000 && STREAMING::HAS_ANIM_DICT_LOADED(func_55(func_15())))
				{
					__LIB_1__::func_649(&Local_14, 3);
				}
			}
			else if (__LIB_0__::func_75(&(Local_14.f_4)))
			{
				__LIB_0__::func_37(&(Local_14.f_4));
			}
			break;
		case 3:
			Local_14.f_1 = 0;
			__LIB_1__::func_581(&(Local_14.f_7), 1);
			__LIB_1__::func_148(&(Local_14.f_4));
		...
		case 4:
			...
			if (__LIB_0__::func_1(Local_14.f_7, 2) && !__LIB_0__::func_1(Local_14.f_7, 4))
			{
				...
				__LIB_1__::func_581(&(Local_14.f_7), 4);
			}
			if (__LIB_0__::func_1(Local_14.f_7, 1) && __LIB_1__::func_871(&(Local_14.f_4)) > 500)
			{
				...
				__LIB_1__::func_993(&(Local_14.f_7), 1);
				TASK::TASK_PLAY_ANIM(Global_35, func_55(func_15()), func_56(0), 8f, -8f, -1, 2, 0f, false, 0, false, 0, false);
				ENTITY::_SET_ENTITY_HEALTH(Global_35, 1, 0);
			}
			if (__LIB_1__::func_871(&(Local_14.f_4)) > 2000)
			{
				__LIB_0__::func_37(&(Local_14.f_4));
				func_57(uParam0);
...
{
	if (VOLUME::_DOES_VOLUME_EXIST(Local_14.f_2[0]))
	{
		VOLUME::_DELETE_VOLUME(Local_14.f_2[0]);
	}
}
...
void func_36(var uParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		iVar0 = __LIB_7__::func_463(*uParam0, func_86(), uParam0->f_4);
	}
	else
	{
...
bool func_51()
{
	if (__LIB_4__::func_503(0, 4) || __LIB_4__::func_503(22, 24))
	{
		return true;
	}
	return false;
...
bool func_72(var uParam0)
{
	...
	{
		case -1300082860:
			if (__LIB_0__::func_266(Global_35, func_105(uParam0, 0), 3f, 1, 1))
			{
				return true;
			}
			break;
...
{
	int iVar0;
	if (!func_127(joaat("DOCUMENT_PLAYER_JOURNAL"), 1, 0))
	{
...
int func_165(int iParam0, bool bParam1, bool bParam2)
{
	...
	uVar2 = INVENTORY::_0xE787F05DFC977BDE(func_129(bParam2), iParam0, 0);
	return uVar2;
}

bool func_188(char* sParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	*iParam1 = INVENTORY::_0x80D78BDC9D88EF07(func_129(bParam4), sParam0, iParam3, iParam2);
	if (*iParam1 >= 0)
	{
		return true;
	}
...
{
	*iParam1 = INVENTORY::_0x640F890C3E5A3FFD(func_129(bParam3), uParam0, uParam2);
	if (*iParam1 >= 0)
	{
		return true;
	}
