...
bool func_72(var uParam0)
{
	...
	__LIB_7__::func_47(uParam0, -1.5312f, -2.9055f, 0f, 0f, 2f, 2f, 5f, joaat("VOLBOX"), -1, 1, 1, 1);
	iLocal_15 = __LIB_6__::func_958(uParam0, joaat("P_CS_BOOKEVELYNMILLER"), 0f, 0f, 0f, "BOOK", 0, 0, 1);
	iLocal_16 = __LIB_6__::func_958(uParam0, joaat("S_CARAVANCOT01X"), 0.821093f, -0.152114f, 0.244499f, 0, 1, 0, 1);
	__LIB_7__::func_107(uParam0, iLocal_14, 3, joaat("WORLD_HUMAN_STAND_WAITING"), "WORLD_HUMAN_STAND_WAITING_MALE_B", -1, 1);
	__LIB_7__::func_149(uParam0, joaat("COMP_DTCSPEECHBVHCNV1"), joaat("PLAYER_DTCSPEECHBVHCNV1"));
	__LIB_7__::func_127(uParam0, iLocal_14, 2, joaat("WORLD_HUMAN_STAND_WAITING"), "WORLD_HUMAN_STAND_WAITING_MALE_B", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	...
	__LIB_6__::func_959(uParam0, "script@vignette@dutch_speech_beaver_1@base_intro", 1, 1, 0, 0);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@dutch_speech_beaver_1@action", 0, 0, 1, 0);
	__LIB_7__::func_146(uParam0, "CDSB1AU");
	__LIB_7__::func_150(uParam0, iLocal_17, -1, 0.91f);
	return true;
}
