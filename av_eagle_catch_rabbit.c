...
{
	__LIB_2__::func_851(uParam0, 10737, 10782, 12072);
}

void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	__LIB_2__::func_853(uParam0, "EAGLE_CATCH_RABBIT", "script@ambient@animal@EAGLE_CATCH_RABBIT@action", vParam1, vParam4);
	uParam0->f_16 = 1;
	__LIB_2__::func_854(uParam0, 1, "pbl_action", "", 0);
	__LIB_2__::func_855(uParam0, 0, "EAGLE", iLocal_9, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	__LIB_2__::func_855(uParam0, 1, "RABBIT", iLocal_10, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
}
...
int func_30(var uParam0)
{
	...
	__LIB_2__::func_906(&uLocal_11, 65);
	return 1;
}
...
int func_31(var uParam0)
{
	...
	if (!uParam0->f_469[0])
	{
		...
		if (!bLocal_39 == 1)
		{
			if (((__LIB_2__::func_908(uParam0, &uLocal_11, 0) || __LIB_0__::func_232(uParam0->f_20[0 /*14*/], Global_35, 1) < 225f) || __LIB_0__::func_232(uParam0->f_20[1 /*14*/], Global_35, 1) < 225f) || MISC::HAS_BULLET_IMPACTED_IN_AREA(ENTITY::GET_ENTITY_COORDS(uParam0->f_20[1 /*14*/], true, false), 2f, true, true))
			{
				bLocal_39 = true;
			}
		}
	...
	if (!uParam0->f_469[0] && !bLocal_39)
	{
		...
		if (uParam0->f_469[2])
		{
			if (!uParam0->f_469[6])
			{
				if (__LIB_2__::func_889(uParam0, 1065353216 /* Float: 1f */, 100f, 4, joaat("ACTION"), 1))
				{
					__LIB_2__::func_890(*uParam0, uParam0->f_483, 1);
					uParam0->f_469[6] = 1;
				}
