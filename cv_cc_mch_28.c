...
{
	ENTITY::FREEZE_ENTITY_POSITION(__LIB_7__::func_30(uParam0, iLocal_18), false);
	return true;
}
...
bool func_73(var uParam0)
{
	...
	iLocal_18 = __LIB_7__::func_142(uParam0, joaat("P_CHAIRFOLDING02X"), -0.171797f, -1.1855f, 0.00361633f, 0, 1, 0, 1);
	iLocal_19 = __LIB_7__::func_142(uParam0, joaat("P_STOOLFOLDING01X"), 1.37471f, -0.0501516f, -0.011795f, 0, 1, 0, 1);
	__LIB_7__::func_142(uParam0, joaat("P_JAVIERKNIFE_TEMP"), 0f, 0f, 0f, "Knife", 0, 1, 1);
	__LIB_7__::func_142(uParam0, joaat("P_SHARPENINGSTONE01X"), 0f, 0f, 0f, "Sharpenningstone", 0, 1, 1);
	iLocal_20 = __LIB_7__::func_142(uParam0, joaat("P_BOTTLEBEER01X"), 0f, 0f, 0f, "BottleBeer", 0, 0, 1);
	iLocal_21 = __LIB_7__::func_142(uParam0, joaat("P_BOTTLEJD01X"), 0f, 0f, 0f, "BottleJD", 0, 0, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@micah_28@base", 1, 1, 0, 0);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@micah_28@Action_A", 0, 0, 1, 1);
	__LIB_7__::func_146(uParam0, "CCM28AU");
	__LIB_7__::func_127(uParam0, iLocal_14, 3, joaat("PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS"), "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_MALE_D", iLocal_18, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_151(uParam0, iLocal_14, 1, -1);
	__LIB_7__::func_147(uParam0, iLocal_14, 4, 1, 0, 0, 0);
	__LIB_7__::func_277(uParam0, iLocal_14, "GREET_MICAH_MCHCNV28", 60000, 1);
	__LIB_7__::func_139(uParam0, iLocal_14, iLocal_21, "p_bottleJD01x_ph_r_hand", 0, 0);
	__LIB_7__::func_127(uParam0, iLocal_15, 2, joaat("WORLD_CAMP_JAVIER_KNIFE"), "WORLD_CAMP_JAVIER_KNIFE", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_127(uParam0, iLocal_16, 3, joaat("PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS"), "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_MALE_A", iLocal_19, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_139(uParam0, iLocal_16, iLocal_20, "p_bottleBeer01x_PH_R_HAND", 0, 0);
	STREAMING::_REQUEST_SCENARIO_TYPE(joaat("PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS"), 1, 0, 0);
	__LIB_7__::func_149(uParam0, joaat("COMP_MCHCNV28"), joaat("PLAYER_MCHCNV28"));
	__LIB_7__::func_150(uParam0, iLocal_17, -1, 0.9f);
	Local_22 = { __LIB_7__::func_160(uParam0, 0f, -1.51f, 1f, -5.76f, 9f, 0.7f, 0.7f) };
...
bool func_88(var uParam0)
{
	if (!bLocal_32)
	{
		ENTITY::SET_ENTITY_COORDS(__LIB_7__::func_30(uParam0, iLocal_18), 2353.812f, 1373.031f, 105.1306f, true, false, true, true);
		ENTITY::SET_ENTITY_ROTATION(__LIB_7__::func_30(uParam0, iLocal_18), 0f, 0f, 17.51f, 2, true);
		ENTITY::FREEZE_ENTITY_POSITION(__LIB_7__::func_30(uParam0, iLocal_18), true);
		bLocal_32 = true;
	}
	return __LIB_7__::func_236(uParam0, Local_22, 1, 0);
}

bool func_94(var uParam0)
{
	if (__LIB_7__::func_272(__LIB_6__::func_952(uParam0, iLocal_14), 855438608))
	{
		__LIB_7__::func_324();
	}
