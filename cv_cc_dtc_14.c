...
bool func_72(var uParam0)
{
	...
	{
		case 1:
			__LIB_7__::func_116(uParam0, -122.349f, -8.52f, 95.134f, 0f, 0f, 0f);
			break;
		case 2:
			__LIB_7__::func_116(uParam0, 669.6f, -1250.3f, 42.96f, 0f, 0f, -165f);
			break;
		case 3:
			__LIB_7__::func_116(uParam0, 1867.925f, -1850.425f, 41.775f, 0f, 0f, 123.48f);
			break;
		default:
			return false;
	}
	iLocal_14 = __LIB_7__::func_48(uParam0, 0, 0);
	__LIB_7__::func_47(uParam0, -0.048f, -0.6479f, 1.1058f, 164.7765f, 1.5f, 1.5f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_DUTCH"), 1, 1, 1);
	__LIB_6__::func_975(uParam0, iLocal_14, 1.1f);
	iLocal_17 = __LIB_6__::func_958(uParam0, joaat("P_CS_BOOK04X"), 0f, 0f, 0f, "BOOK", 0, 0, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@dutch_14@base", 1, 1, 0, 0);
	iLocal_15 = __LIB_6__::func_959(uParam0, "script@vignette@dutch_14@action_a", 2, 0, 1, 1);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@dutch_14@action_b", 0, 0, 0, 1);
	__LIB_7__::func_146(uParam0, "CDT14AU");
	__LIB_7__::func_127(uParam0, iLocal_14, 2, joaat("WORLD_HUMAN_SIT_GROUND_READING_BOOK"), "WORLD_HUMAN_SIT_GROUND_READING_BOOK_MALE_A", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	...
	Local_18 = { __LIB_7__::func_160(uParam0, -0.048f, -0.6479f, 1.1058f, 164.7765f, 8f, 0.8f, 0.8f) };
...
{
	return __LIB_7__::func_163(uParam0, Local_18, 1, 0);
}
...
int func_391(int iParam0, bool bParam1, bool bParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7, bool bParam8, bool bParam9, int iParam10)
{
	...
	switch (Global_1360165[iParam0 /*1157*/].f_70.f_12)
	{
		case 0:
			...
			{
				if (!__LIB_0__::func_851(iParam0) && func_417(iParam0, &uVar4))
				{
