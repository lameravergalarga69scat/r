...
bool func_72(var uParam0)
{
	...
	iLocal_18 = __LIB_7__::func_48(uParam0, 21, 0);
	iLocal_19 = __LIB_7__::func_48(uParam0, 18, 0);
	__LIB_7__::func_47(uParam0, 2.6814f, 4.64f, 0f, 0f, 1.2f, 1.2f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_SWANSON"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, 0.0064f, 0.7775f, 0f, 0f, 1.2f, 1.2f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_STRAUSS"), 1, 1, 1);
	iLocal_21 = __LIB_6__::func_958(uParam0, joaat("P_CS_LEDGER01X"), 0f, 0f, 0f, "BOOK", 0, 1, 1);
	iLocal_22 = __LIB_6__::func_958(uParam0, joaat("P_PEN01X"), 0f, 0f, 0f, "PEN", 0, 1, 1);
	iLocal_20 = __LIB_6__::func_958(uParam0, joaat("P_CHAIRFOLDING02X"), -0.0286035f, 1.09429f, 0.00270844f, "CHAIR", 1, 0, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@swanson_8@base", 1, 1, 0, 0);
	iLocal_14 = __LIB_6__::func_959(uParam0, "script@vignette@swanson_8@action_a", 2, 0, 1, 0);
	iLocal_15 = __LIB_6__::func_959(uParam0, "script@vignette@swanson_8@action_b_alt_front", 0, 0, 0, 1);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@swanson_8@action_b_alt_left", 0, 0, 0, 1);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@swanson_8@action_b_alt_right", 0, 0, 0, 1);
	__LIB_7__::func_146(uParam0, "CSWN8AU");
	Local_27 = { __LIB_7__::func_160(uParam0, -0.38f, 0.692f, 0.988f, 178.8701f, 6.5f, 0.57f, 0.45f) };
	Local_37 = { __LIB_7__::func_160(uParam0, -0.38f, 0.6924f, 0.988f, -91.6299f, 5.685f, 0.2875f, 0.42f) };
	Local_47 = { __LIB_7__::func_160(uParam0, -0.38f, 0.692f, 0.988f, 92.1201f, 6.5f, 0.5125f, 0.42f) };
	__LIB_7__::func_107(uParam0, iLocal_18, 3, joaat("WORLD_HUMAN_LEAN_WALL_RIGHT"), "WORLD_HUMAN_LEAN_WALL_RIGHT_MALE_B", -1, 1);
	__LIB_7__::func_147(uParam0, iLocal_18, 2, 2, 0, 0, 0);
	__LIB_7__::func_151(uParam0, iLocal_18, 3, -1);
	__LIB_7__::func_127(uParam0, iLocal_19, 3, joaat("PROP_HUMAN_SEAT_CHAIR_DESK_WRITING"), "PROP_HUMAN_SEAT_CHAIR_DESK_WRITING_MALE_A", iLocal_20, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_259(uParam0, iLocal_19, iLocal_22, "", 1, "p_pen01x_PH_R_HAND");
	__LIB_7__::func_259(uParam0, iLocal_19, iLocal_21, "", 1, "p_cs_ledger01x_PH_L_HAND");
	return true;
}
...
{
	if (!bLocal_26 && __LIB_7__::func_148(uParam0, iLocal_14))
	{
		...
		{
			__LIB_7__::func_113(uParam0, iLocal_19, 1, 1);
			bLocal_26 = true;
		}
	}
	return true;
...
bool func_95(var uParam0)
{
	...
	iVar1 = __LIB_6__::func_952(uParam0, iLocal_19);
