...
{
	if (ENTITY::DOES_ENTITY_EXIST(__LIB_7__::func_30(uParam0, iLocal_20)))
	{
		ENTITY::FREEZE_ENTITY_POSITION(__LIB_7__::func_30(uParam0, iLocal_20), false);
		ENTITY::SET_ENTITY_COORDS(__LIB_7__::func_30(uParam0, iLocal_20), vLocal_56, true, false, true, true);
		ENTITY::SET_ENTITY_HEADING(__LIB_7__::func_30(uParam0, iLocal_20), fLocal_59);
		ENTITY::SET_ENTITY_COLLISION(__LIB_7__::func_30(uParam0, iLocal_20), true, false);
	}
	return true;
}
...
bool func_73(var uParam0)
{
	...
	__LIB_7__::func_47(uParam0, -5.8f, 6.8f, 0f, 0f, 2f, 2f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_BILL"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, 0f, 1f, 0f, 0f, 1.5f, 1.5f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_HOSEA"), 1, 1, 1);
	vLocal_53 = { __LIB_6__::func_972(uParam0, -0.039f, 1.165f, 0.0346f) };
	__LIB_6__::func_958(uParam0, joaat("P_BARREL05X"), 0f, 0f, 0f, "BARREL", 0, 0, 1);
	iLocal_21 = __LIB_6__::func_958(uParam0, joaat("P_PEN01X"), 0f, 0f, 0f, "PEN", 0, 1, 1);
	iLocal_22 = __LIB_6__::func_958(uParam0, joaat("P_CS_LEDGER01X"), 0f, 0f, 0f, "BOOK", 0, 1, 1);
	__LIB_6__::func_958(uParam0, joaat("P_BOTTLEJD01X"), 0f, 0f, 0f, "BOTTLE", 0, 1, 1);
	iLocal_20 = __LIB_6__::func_958(uParam0, joaat("P_STOOLFOLDING01X"), -0.039f, 1.165f, 0.0346f, 0, 1, 0, 1);
	__LIB_7__::func_271(uParam0, iLocal_15, joaat("WEAPON_REVOLVER_CATTLEMAN_HOSEA_DUALWIELD"), "GUN");
	__LIB_6__::func_959(uParam0, "script@vignette@bill_5@base", 1, 1, 0, 0);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@bill_5@action_a", 2, 0, 1, 0);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@bill_5@action_b_int_front", 0, 0, 0, 1);
	iLocal_18 = __LIB_6__::func_959(uParam0, "script@vignette@bill_5@action_b_int_left", 0, 0, 0, 1);
	iLocal_19 = __LIB_6__::func_959(uParam0, "script@vignette@bill_5@action_b_int_right", 0, 0, 0, 1);
	__LIB_7__::func_146(uParam0, "CBLL5AU");
	__LIB_7__::func_226(uParam0, iLocal_14, 1061142135 /* Float: 0.749f */);
	__LIB_7__::func_127(uParam0, iLocal_15, 3, joaat("PROP_HUMAN_SEAT_CHAIR_DESK_WRITING"), "PROP_HUMAN_SEAT_CHAIR_DESK_WRITING_MALE_A", iLocal_20, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_147(uParam0, iLocal_15, 2, 1, 0, 0, 0);
	__LIB_7__::func_259(uParam0, iLocal_15, iLocal_21, "", 1, "p_pen01x_PH_R_HAND");
	__LIB_7__::func_259(uParam0, iLocal_15, iLocal_22, "", 1, "p_cs_ledger01x_PH_L_HAND");
	Local_23 = { __LIB_7__::func_160(uParam0, 0.1564f, 1.1727f, 0.5404f, 138f, 7f, 0.4f, 0.4f) };
	Local_33 = { __LIB_7__::func_160(uParam0, 0.156f, 1.173f, 0.54f, -150f, 7f, 0.4f, 0.4f) };
	Local_43 = { __LIB_7__::func_160(uParam0, 0.156f, 1.173f, 0.54f, 66f, 7f, 0.4f, 0.4f) };
	return true;
}
...
bool func_87(var uParam0)
{
	if (ENTITY::DOES_ENTITY_EXIST(__LIB_7__::func_30(uParam0, iLocal_20)))
	{
		vLocal_56 = { ENTITY::GET_ENTITY_COORDS(__LIB_7__::func_30(uParam0, iLocal_20), true, false) };
		fLocal_59 = ENTITY::GET_ENTITY_HEADING(__LIB_7__::func_30(uParam0, iLocal_20));
		ENTITY::SET_ENTITY_COORDS(__LIB_7__::func_30(uParam0, iLocal_20), vLocal_53, true, false, true, true);
		ENTITY::SET_ENTITY_HEADING(__LIB_7__::func_30(uParam0, iLocal_20), func_193(uParam0, 67.22716f));
		ENTITY::FREEZE_ENTITY_POSITION(__LIB_7__::func_30(uParam0, iLocal_20), true);
		ENTITY::SET_ENTITY_COLLISION(__LIB_7__::func_30(uParam0, iLocal_20), false, false);
	}
	return true;
}
...
bool func_96(var uParam0)
{
	...
	iVar1 = __LIB_6__::func_952(uParam0, iLocal_15);
