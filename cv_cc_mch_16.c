...
bool func_72(var uParam0)
{
	...
	{
		case 2:
			__LIB_7__::func_116(uParam0, 663.15f, -1266.61f, 42.867f, 0f, 0f, -50.603f);
			break;
		default:
			return false;
	}
	...
	__LIB_6__::func_958(uParam0, joaat("P_CS_RAG01X"), 0f, 0f, 0f, "RAG", 0, 1, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@micah_16@base", 1, 1, 0, 0);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@micah_16@action_a", 2, 0, 1, 0);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@micah_16@action_b_front", 0, 0, 0, 1);
	iLocal_18 = __LIB_6__::func_959(uParam0, "script@vignette@micah_16@action_b_left", 0, 0, 0, 1);
	iLocal_19 = __LIB_6__::func_959(uParam0, "script@vignette@micah_16@action_b_right", 0, 0, 0, 1);
	__LIB_7__::func_146(uParam0, "CM16AUD");
	__LIB_7__::func_107(uParam0, iLocal_15, 3, joaat("WORLD_CAMP_LENNY_GUARD_CROUCH_TRACKS"), "WORLD_CAMP_LENNY_GUARD_CROUCH_TRACKS_MALE_A", -1, 1);
	__LIB_7__::func_127(uParam0, iLocal_15, 3, joaat("WORLD_HUMAN_GUARD_SCOUT"), "WORLD_HUMAN_GUARD_SCOUT_MALE_C", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	...
	__LIB_7__::func_127(uParam0, iLocal_14, 2, joaat("WORLD_HUMAN_LEAN_CHECK_PISTOL"), "WORLD_HUMAN_LEAN_CHECK_PISTOL_MALE_A", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_151(uParam0, iLocal_14, 1, -1);
	__LIB_7__::func_277(uParam0, iLocal_14, "GREET_MICAH_MCHCNV16", 60000, 1);
	__LIB_7__::func_149(uParam0, joaat("COMP_MCHCNV16"), joaat("PLAYER_MCHCNV16"));
	Local_22 = { __LIB_7__::func_160(uParam0, 1.6238f, -3.4005f, 1.0029f, 0f, 7f, 0.5f, 0.5f) };
	Local_32 = { __LIB_7__::func_160(uParam0, 1.624f, -3.401f, 1.003f, 90.72f, 7f, 0f, 0.5f) };
	Local_42 = { __LIB_7__::func_160(uParam0, 1.624f, -3.401f, 1.003f, -90.72f, 7f, 0.5f, 0f) };
	return true;
}
...
int func_175(var uParam0, int iParam1, int iParam2)
{
	...
	{
		if (!WEAPON::HAS_PED_GOT_WEAPON(__LIB_6__::func_952(uParam0, iParam1), iParam2, 0, false))
		{
			__LIB_2__::func_272(__LIB_6__::func_952(uParam0, iParam1), iParam2, 1, 1, 0, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, 0);
		}
		else
		{
			WEAPON::SET_CURRENT_PED_WEAPON(__LIB_6__::func_952(uParam0, iParam1), iParam2, true, 0, false, false);
		}
	}
	if (__LIB_0__::func_153(__LIB_6__::func_952(uParam0, iParam1), 0, 1, 0) == iParam2)
	{
		return 1;
	}
	return 0;
	...
	switch (Global_1360165[iParam0 /*1157*/].f_11)
	{
		...
		case 3:
			if (!ENTITY::IS_ENTITY_DEAD(Global_1360165[iParam0 /*1157*/]) && !ANIMSCENE::_0x3AB6C7B0BB0DF4B1(Global_1360165[iParam0 /*1157*/], -1))
			{
				...
				func_437(Global_1360165[iParam0 /*1157*/], vVar0, iParam6, 2, 1073741824 /* Float: 2f */);
			}
			else if (bParam16)
			{
	...
	switch (Global_1360165[iParam0 /*1157*/].f_70.f_12)
	{
		...
		case 3:
			...
			if ((bParam2 && !__LIB_0__::func_86(vVar0)) && !__LIB_0__::func_175(vVar0, ENTITY::GET_ENTITY_COORDS(Global_1360165[iParam0 /*1157*/].f_124, true, false), 1056964608 /* Float: 0.5f */, 1))
			{
				...
				func_437(Global_1360165[iParam0 /*1157*/].f_124, vVar0, iParam6, 2, 1073741824 /* Float: 2f */);
			}
			if (bParam1)
			{
