...
{
	__LIB_2__::func_851(uParam0, 11160, 11316, 11712);
}
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	{
		case 23:
			__LIB_2__::func_853(uParam0, "VOMIT_SIT_FEMALE", "script@ambient@town@wall_vomit_sit@female01", vParam1, vParam4);
			iVar0 = __LIB_2__::func_992(__LIB_1__::func_898());
			__LIB_2__::func_928(uParam0, 0, "BUCKET", joaat("P_CS_BUCKET01BX"), 0f, 0f, 0f, 0f, 1);
			break;
		case 24:
			__LIB_2__::func_853(uParam0, "VOMIT_SIT_MALE", "script@ambient@town@wall_vomit_sit@male01", vParam1, vParam4);
			iVar0 = __LIB_2__::func_921(__LIB_1__::func_898());
			__LIB_2__::func_928(uParam0, 0, "BUCKET", joaat("P_CS_BUCKET01BX"), 0f, 0f, 0f, 0f, 1);
			bLocal_37 = true;
			break;
		case 25:
			__LIB_2__::func_853(uParam0, "VOMIT_WALL_FEMALE", "script@ambient@town@wall_vomit@female01", vParam1, vParam4);
			...
			break;
		case 26:
			__LIB_2__::func_853(uParam0, "VOMIT_WALL_MALE", "script@ambient@town@wall_vomit@male01", vParam1, vParam4);
			if (__LIB_0__::func_272(uParam0->f_20[0 /*14*/], 0))
			{
				iVar0 = ENTITY::GET_ENTITY_MODEL(uParam0->f_20[0 /*14*/]);
			}
	...
	__LIB_2__::func_855(uParam0, 0, "ped", iVar0, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
}

int func_18(var uParam0)
{
	if (!__LIB_2__::func_313(iLocal_39))
	{
		return 0;
	}
	return 1;
...
bool func_28(var uParam0)
{
	...
	{
		if (!TASK::IS_PED_ACTIVE_IN_SCENARIO(uParam0->f_20[0 /*14*/], 1) && !__LIB_0__::func_491(uParam0->f_20[0 /*14*/], 993674639))
		{
			__LIB_1__::func_473(uParam0->f_20[0 /*14*/], iLocal_39, 0, 0, 0, -1082130432 /* Float: -1f */);
		}
		if (__LIB_2__::func_908(uParam0, &uLocal_9, 0))
		{
			uParam0->f_499 = 1;
			return false;
		}
		...
		{
			if (__LIB_2__::func_892(uParam0, 1065353216 /* Float: 1f */, 1116471296 /* Float: 70f */, 4, 10f, 1112014848 /* Float: 50f */))
			{
				PED::_0x406CCF555B04FAD3(uParam0->f_20[0 /*14*/], 1, 0.7f);
				__LIB_2__::func_913(uParam0);
				return true;
			}
		}
	}
...
int func_30(var uParam0)
{
	if (bLocal_38)
	{
		iLocal_39 = joaat("WORLD_HUMAN_DRUNK_BRACE_WALL");
		if (bLocal_37)
		{
			__LIB_2__::func_312(iLocal_39, 15, 0, joaat("WORLD_HUMAN_DRUNK_BRACE_WALL_MALE_A"));
		}
		else
		{
			__LIB_2__::func_312(iLocal_39, 15, 0, joaat("WORLD_HUMAN_DRUNK_BRACE_WALL_FEMALE_A"));
		}
	}
	else
	{
		iLocal_39 = joaat("WORLD_HUMAN_SIT_BACK_EXHAUSTED");
		if (bLocal_37)
		{
			__LIB_2__::func_312(iLocal_39, 15, 0, joaat("WORLD_HUMAN_SIT_BACK_EXHAUSTED_MALE_A"));
		}
		else
		{
			__LIB_2__::func_312(iLocal_39, 15, 0, joaat("WORLD_HUMAN_SIT_BACK_EXHAUSTED_FEMALE_A"));
		}
	}
...
int func_31(var uParam0)
{
	...
	if (!uParam0->f_469[3])
	{
		if (!uParam0->f_469[4])
		{
			...
			if (__LIB_2__::func_889(uParam0, fLocal_40, 1116471296 /* Float: 70f */, 4, joaat("ACTION"), 1))
			{
				__LIB_2__::func_890(*uParam0, uParam0->f_483, 1);
				uParam0->f_469[4] = 1;
			}
		...
		if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_20[0 /*14*/]))
		{
			if (ANIMSCENE::_0x005E6F28DD7ED58D(uParam0->f_3.f_1, uParam0->f_20[0 /*14*/].f_1))
			{
				...
				if (!uParam0->f_500)
				{
					...
					{
						__LIB_1__::func_473(uParam0->f_20[0 /*14*/], iLocal_39, 45000, 0, 0, -1082130432 /* Float: -1f */);
					}
...
{
	__LIB_2__::func_858(uParam0, 0, 1, 0);
	if (iLocal_39 != -1)
	{
		if (__LIB_2__::func_313(iLocal_39))
		{
			__LIB_4__::func_321(iLocal_39);
		}
	}
	return 1;
}
