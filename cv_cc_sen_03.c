...
bool func_72(var uParam0)
{
	...
	__LIB_6__::func_958(uParam0, joaat("P_BOTTLEBEER01X"), 0f, 0f, 0f, "BOTTLE1", 0, 0, 1);
	__LIB_6__::func_958(uParam0, joaat("P_BOTTLEBEER01X"), 0f, 0f, 0f, "BOTTLE2", 0, 0, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@sean_3@base", 1, 1, 0, 0);
	__LIB_6__::func_959(uParam0, "script@vignette@sean_3@action", 0, 1, 0, 0);
	__LIB_7__::func_146(uParam0, "CSEN3AU");
	__LIB_7__::func_323(uParam0, iLocal_14, 1f);
	__LIB_7__::func_147(uParam0, iLocal_15, 4, 1, 0, 0, 0);
	__LIB_7__::func_323(uParam0, iLocal_15, 1f);
	return true;
}
