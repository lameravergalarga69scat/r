...
bool func_72(var uParam0)
{
	...
	{
		case 1:
			__LIB_7__::func_45(uParam0, 129, 0, 0, 0);
			break;
		case 2:
	...
	__LIB_7__::func_47(uParam0, -1.45f, -0.5f, 0.45f, 0f, 4f, 4f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_DUTCH"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, -4.9099f, 2.8865f, 0.9954f, -26.7944f, 1.5f, 1.5f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_HOSEA"), 1, 1, 1);
	__LIB_7__::func_159(uParam0, -2.575f, -1.3752f, 1.15f, 38.56f, 1f, 1f, 2.685f, joaat("VOLCYLINDER"), 1);
	iLocal_17 = __LIB_6__::func_958(uParam0, joaat("P_SKETCHBOOK02X"), 0f, 0f, 0f, "BOOK", 0, 0, 1);
	iLocal_16 = __LIB_6__::func_958(uParam0, joaat("P_PENCIL01X"), 0f, 0f, 0f, "PEN", 0, 0, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@dutch_and_hosea_3@base", 1, 1, 0, 0);
	iLocal_18 = __LIB_6__::func_959(uParam0, "script@vignette@dutch_and_hosea_3@action_a", 2, 0, 1, 0);
	iLocal_19 = __LIB_6__::func_959(uParam0, "script@vignette@dutch_and_hosea_3@action_b", 0, 0, 0, 0);
	iLocal_20 = __LIB_6__::func_959(uParam0, "script@vignette@dutch_and_hosea_3@action_b_alt", 0, 0, 0, 1);
	__LIB_7__::func_146(uParam0, "CDH3AUD");
	__LIB_7__::func_149(uParam0, joaat("COMP_DNHCNV3"), joaat("PLAYER_DNHCNV3"));
	__LIB_7__::func_127(uParam0, iLocal_14, 3, joaat("PROP_HUMAN_SEAT_CHAIR_SKETCHING"), "PROP_HUMAN_SEAT_CHAIR_SKETCHING_MALE_A", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_139(uParam0, iLocal_14, iLocal_16, "p_pencil01x_XH_R_HAND00", 0, 0);
	...
	Local_21 = { __LIB_7__::func_160(uParam0, -3.8632f, -3.4077f, 0.8889f, -128.88f, 8f, 0.5f, 0.5f) };
	return true;
}
