...
bool func_72(var uParam0)
{
	...
	__LIB_7__::func_47(uParam0, -0.225f, -1.15f, 0.782f, 93.5f, 1.055f, 1.05f, 1.925f, joaat("VOLBOX"), joaat("APMS_COMP_MICAH"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, -4.6375f, -7.4f, 0.907f, 80f, 1.7975f, 3.355f, 2.025f, joaat("VOLBOX"), joaat("APMS_COMP_JACK"), 1, 1, 1);
	iLocal_16 = __LIB_6__::func_958(uParam0, joaat("P_CS_NEWSPAPER_03X"), 0f, 0f, 0f, "NEWSPAPER", 0, 0, 1);
	iLocal_17 = __LIB_6__::func_958(uParam0, joaat("P_CHAIRFOLDING02X"), -0.258237f, -1.19728f, 0f, "Chair", 1, 0, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@dog_8@base", 1, 1, 0, 0);
	__LIB_6__::func_959(uParam0, "script@vignette@dog_8@action", 0, 0, 1, 0);
	__LIB_7__::func_146(uParam0, "CCDG8AU");
	...
	__LIB_7__::func_127(uParam0, iLocal_15, 3, joaat("PROP_HUMAN_SEAT_CHAIR_READ_NEWSPAPER"), "PROP_HUMAN_SEAT_CHAIR_READ_NEWSPAPER_MALE_B", iLocal_17, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_139(uParam0, iLocal_15, iLocal_16, "p_cs_newspaper_03x_PH_R_HAND", 0, 0);
	__LIB_7__::func_151(uParam0, iLocal_15, 1, -1);
	__LIB_7__::func_277(uParam0, iLocal_15, "GREET_MICAH_DOGCNV8", 60000, 1);
	__LIB_7__::func_149(uParam0, joaat("COMP_DOGCNV8"), joaat("PLAYER_DOGCNV8"));
	__LIB_7__::func_145(uParam0, 8f, 15f);
	__LIB_7__::func_295(uParam0, iLocal_14, 1.7f, 1.7f, 1092616192 /* Float: 10f */);
	return true;
}
...
bool func_93(var uParam0)
{
	...
	{
		iLocal_18 = TASK::_FIND_CLOSEST_ACTIVE_SCENARIO_POINT_OF_TYPE(2315.74f, 1295.19f, 94.66f, joaat("WORLD_CAMP_JACK_THROWS_ROCKS_CASUAL"), 1.5f, 0, false);
	}
	if (__LIB_7__::func_74(uParam0, iLocal_14))
	{
		PED::FORCE_PED_MOTION_STATE(__LIB_6__::func_952(uParam0, iLocal_14), joaat("MOTIONSTATE_RUN"), false, 1, false);
		if (TASK::_DOES_SCENARIO_POINT_EXIST(iLocal_18))
		{
			TASK::OPEN_SEQUENCE_TASK(&iVar0);
			TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, 2315.863f, 1300.093f, 94.8669f, 1.7f, -1, 0.25f, 8193, 40000f);
			TASK::_TASK_USE_SCENARIO_POINT(0, iLocal_18, 0, 250000, true, false, 0, false, -1f, false);
			TASK::CLOSE_SEQUENCE_TASK(iVar0);
			TASK::TASK_PERFORM_SEQUENCE(__LIB_6__::func_952(uParam0, iLocal_14), iVar0);
			TASK::CLEAR_SEQUENCE_TASK(&iVar0);
		}
		__LIB_7__::func_68(uParam0, iLocal_14, 0);
		__LIB_1__::func_774(uParam0->f_107[iLocal_14 /*113*/].f_1, 0, 0, 0, 60f, 1, 1, 0, 0, 0, 0);
	}
