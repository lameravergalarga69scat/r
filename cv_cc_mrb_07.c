...
bool func_72(var uParam0)
{
	...
	__LIB_7__::func_47(uParam0, -0.175f, -7.0875f, 0.85f, -65.75f, 1f, 1f, 3.2075f, joaat("VOLBOX"), joaat("APMS_COMP_MARYBETH"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, 0.85f, -1.3375f, 0.85f, 0f, 4.4575f, 3.4825f, 3.2075f, joaat("VOLBOX"), joaat("APMS_COMP_GRIMSHAW"), 1, 1, 1);
	__LIB_7__::func_159(uParam0, -0.207769f, -1.05733f, 1.00032f, 0f, 1.1f, 1.1f, 3.2f, joaat("VOLCYLINDER"), 1);
	iLocal_16 = __LIB_6__::func_958(uParam0, joaat("P_CS_KNITTING01X"), 0f, 0f, 0f, "KNITTING", 0, 0, 1);
	iLocal_17 = __LIB_6__::func_958(uParam0, joaat("P_CHAIR_CRATE02X"), 0f, 0f, 0f, 0, 1, 0, 1);
	__LIB_7__::func_107(uParam0, iLocal_14, 3, joaat("PROP_HUMAN_SEAT_CHAIR_KNITTING"), "PROP_HUMAN_SEAT_CHAIR_KNITTING_FEMALE_A", iLocal_17, 0);
	__LIB_7__::func_127(uParam0, iLocal_14, 3, joaat("PROP_HUMAN_SEAT_CHAIR_KNITTING"), "PROP_HUMAN_SEAT_CHAIR_KNITTING_FEMALE_A", iLocal_17, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_139(uParam0, iLocal_14, iLocal_16, "p_cs_knitting01x_PH_R_HAND", 0, 0);
	...
	__LIB_7__::func_149(uParam0, joaat("COMP_MRBCNV7"), joaat("PLAYER_MRBCNV7"));
	__LIB_6__::func_959(uParam0, "script@vignette@marybeth_7@base", 1, 1, 0, 0);
	__LIB_6__::func_959(uParam0, "script@vignette@marybeth_7@Action", 0, 0, 1, 0);
	__LIB_7__::func_146(uParam0, "CCMB7AU");
	return true;
}
