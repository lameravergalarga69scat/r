...
bool func_72(var uParam0)
{
	...
	{
		case 1:
			__LIB_7__::func_45(uParam0, 151, 0, 0, 0);
			break;
		case 2:
			__LIB_7__::func_45(uParam0, 84, 0, 0, 0);
			bVar0 = true;
			break;
		case 3:
			__LIB_7__::func_45(uParam0, 211, 0, 0, 0);
			break;
		default:
			return false;
	}
	...
	{
		__LIB_6__::func_959(uParam0, "script@ambient@campfiregeneral@start_music_cylinder@table@base", 1, 1, 0, 0);
		iLocal_16 = __LIB_6__::func_959(uParam0, "script@ambient@campfiregeneral@start_music_cylinder@table@action", 0, 0, 1, 0);
	}
	else
	{
		__LIB_6__::func_959(uParam0, "script@ambient@campfiregeneral@start_music_cylinder@tent@base", 1, 1, 0, 0);
		iLocal_16 = __LIB_6__::func_959(uParam0, "script@ambient@campfiregeneral@start_music_cylinder@tent@action", 0, 0, 1, 0);
	}
	iLocal_14 = __LIB_7__::func_48(uParam0, 0, 0);
	__LIB_7__::func_47(uParam0, -0.45f, 1.21f, 0f, 0f, 2.5f, 2f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_DUTCH"), 1, 1, 1);
	iLocal_15 = __LIB_6__::func_958(uParam0, joaat("P_CIGAR02X"), 0f, 0f, 0f, "p_cigar01x_PH_R_HAND", 0, 0, 1);
	__LIB_6__::func_958(uParam0, joaat("P_PHONOGRAPH01X"), 0f, 0f, 0f, "p_phonograph01x", 1, 0, 1);
	if (bVar0)
	{
		__LIB_7__::func_127(uParam0, iLocal_14, 2, joaat("WORLD_CAMP_DUTCH_SMOKE_CIGAR"), "WORLD_CAMP_DUTCH_SMOKE_CIGAR_MALE_A", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 0);
	}
	else
	{
	...
	__LIB_7__::func_139(uParam0, iLocal_14, iLocal_15, "p_cigar02x_PH_R_HAND", 0, 0);
	return true;
}
...
bool func_93(var uParam0)
{
	if (!bLocal_17)
	{
		if (__LIB_7__::func_40(uParam0, iLocal_16, 0.52f))
		{
