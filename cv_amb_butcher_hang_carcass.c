...
{
	if (ENTITY::DOES_ENTITY_EXIST(__LIB_7__::func_30(uParam0, iLocal_15)))
	{
		OBJECT::_0xCAAF2BCCFEF37F77(__LIB_7__::func_30(uParam0, iLocal_15), 32);
	}
...
bool func_73(var uParam0)
{
	...
	{
		case 1:
			__LIB_7__::func_45(uParam0, 147, 0, 0, 0);
			break;
		case 2:
			__LIB_7__::func_45(uParam0, 80, 0, 0, 0);
			break;
		case 3:
			__LIB_7__::func_45(uParam0, 207, 0, 0, 0);
			break;
		case 6:
			__LIB_7__::func_45(uParam0, 15, 0, 0, 0);
			break;
	}
	__LIB_7__::func_46(uParam0, 0f, 0f, 0f, 0f, 1f, 1f, 2f, joaat("VOLCYLINDER"), 1);
	__LIB_7__::func_47(uParam0, 0f, 0f, 0f, 0f, 1f, 1f, 2f, joaat("VOLBOX"), joaat("APMS_COMP_PEARSON"), 1, 1, 1);
	__LIB_7__::func_48(uParam0, 17, "MALE");
	iLocal_14 = __LIB_7__::func_31(uParam0, joaat("A_C_DEER_01"), "DEER");
	iLocal_15 = __LIB_6__::func_958(uParam0, joaat("P_CS_MEATHANGER01X"), 0f, 0f, 0f, "HANGER", 0, 0, 1);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@ambient@campfiregeneral@butcher_hang_carcass@action", 0, 1, 0, 0);
	iLocal_17 = __LIB_7__::func_32(uParam0, iLocal_16, "PL_ACTION", 1);
	return true;
}
...
{
	__LIB_17__::func_985(uParam0, iLocal_14);
...
{
	__LIB_7__::func_83(uParam0, iLocal_16, "BOOL_BASE", 1);
	return true;
}
...
void func_199(var uParam0)
{
	...
	vector3 vVar4;
	vector3 vVar7;
	ENTITY::FREEZE_ENTITY_POSITION(__LIB_7__::func_30(uParam0, iLocal_15), true);
	iVar0 = PED::GET_PED_BONE_INDEX(__LIB_6__::func_952(uParam0, iLocal_14), 53081);
	iVar1 = PED::GET_PED_BONE_INDEX(__LIB_6__::func_952(uParam0, iLocal_14), 41273);
	iVar2 = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(__LIB_7__::func_30(uParam0, iLocal_15), "bottomHookInd02");
	iVar3 = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(__LIB_7__::func_30(uParam0, iLocal_15), "bottomHookInd01");
	vVar4 = { ENTITY::GET_WORLD_POSITION_OF_ENTITY_BONE(__LIB_7__::func_30(uParam0, iLocal_15), iVar2) };
	vVar7 = { ENTITY::GET_WORLD_POSITION_OF_ENTITY_BONE(__LIB_7__::func_30(uParam0, iLocal_15), iVar3) };
	PED::SET_PED_TO_RAGDOLL(__LIB_6__::func_952(uParam0, iLocal_14), 10000, 15000, 0, false, true, false);
	PED::_0xE1AADD0055D76603(__LIB_6__::func_952(uParam0, iLocal_14), __LIB_7__::func_30(uParam0, iLocal_15), iVar0, iVar2, vVar4, -1f, 0, 0, 0);
	PED::_0xE1AADD0055D76603(__LIB_6__::func_952(uParam0, iLocal_14), __LIB_7__::func_30(uParam0, iLocal_15), iVar1, iVar3, vVar7, -1f, 0, 0, 0);
}
