...
void __EntryFunction__()
{
	...
	iLocal_25 = func_2();
	iLocal_26 = __LIB_1__::func_898();
	func_4(iLocal_25, &iLocal_33);
	if (__LIB_0__::func_314(func_2()))
	{
		func_1(&Local_3);
	}
	if ((__LIB_0__::func_28() && !__LIB_1__::func_187(39)) && __LIB_0__::func_942() >= 29)
	{
		func_1(&Local_3);
	}
	while (func_9())
...
void func_1(var uParam0)
{
	...
	__LIB_2__::func_353(&(uParam0->f_14), 1);
	__LIB_2__::func_353(&(uParam0->f_15), 1);
...
bool func_11(var uParam0)
{
	...
	switch (__LIB_0__::func_81(uParam0))
	{
		case 0:
			...
			__LIB_3__::func_414(&(uParam0->f_14), vLocal_20, 2f, 1, -1, 0);
			if (iLocal_25 == joaat("BONE_25"))
			{
		...
		case 4:
			func_26();
			if (__LIB_3__::func_510(&uLocal_27, &iLocal_29, 1, vLocal_20, 5f) > 0)
			{
		...
		case 5:
			...
			{
				if (__LIB_0__::func_94(Global_35, vLocal_20, 1) < 2.5f)
				{
					func_31(uParam0);
					func_32(uParam0, "COLLECTIBLE_DINO_BONE_CONTEXT");
				}
				if (__LIB_2__::func_694(&(Local_3.f_1), "DISCO_EXAMINE", vLocal_20, 0, joaat("INPUT_CONTEXT_Y"), 2.5f, 0, 1, 0, 0, 0, 0, 0, 0, 1, 0, joaat("SHORT_TIMED_EVENT"), 0))
				{
					if (PED::_GET_PED_CROUCH_MOVEMENT(Global_35))
					{
						PED::_SET_PED_CROUCH_MOVEMENT(Global_35, false, 0, false);
					}
					__LIB_0__::func_442(iLocal_25);
		...
		case 6:
			...
			else if (!__LIB_0__::func_491(Global_35, 716706914))
			{
				WEAPON::_0x94A3C1B804D291EC(Global_35, 0, 0, 1, 0);
				TASK::TASK_SWAP_WEAPON(Global_35, 1, 0, 0, 0);
			}
		...
		case 11:
			...
			if (func_39(uParam0))
			{
				...
				if (!__LIB_1__::func_707(__LIB_1__::func_35(iLocal_25, 5), 1, 0))
				{
					func_42(__LIB_1__::func_35(iLocal_25, 5), 1, 0, 0, 0, 752097756, 0, 0, 0, 0);
				}
				MAP::_0xD8C7162AB2E2AF45(__LIB_10__::func_766(iLocal_25));
...
void func_26()
{
	...
	while (iVar0 < 1)
	{
		iLocal_29[iVar0] = __LIB_1__::func_35(iLocal_25, 0);
		iVar0++;
	}
}
...
int func_42(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, float fParam6, int iParam7, int iParam8, bool bParam9)
{
	...
	if (__LIB_1__::func_614(iParam0, 0, 0) == 0)
	{
		if (__LIB_1__::func_153(iParam0))
		{
			...
			{
				func_42(__LIB_0__::func_354(iVar6), 1, 0, 0, 0, 752097756, 0, 0, 0, 0);
    ...
    " Cores." */, 1, 1);
			...
			case joaat("CONSUMABLE_CIGARETTE_BOX"):
				...
				{
					func_42(__LIB_1__::func_156(), 1, 0, 0, 0, 752097756, 0, 0, 0, 0);
				}
				else
				{
					func_42(__LIB_0__::func_920(), 1, 0, 0, 0, 752097756, 0, 0, 0, 0);
				}
				break;
