...
bool func_72(var uParam0)
{
	...
	__LIB_7__::func_47(uParam0, 1.8f, -0.9125f, 0f, -14.75f, 2.5f, 2.2f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_JAVIER"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, 4.0517f, -7.6652f, 0.9548f, -14.75f, 1.5f, 1.5f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_BILL"), 1, 1, 1);
	__LIB_7__::func_159(uParam0, 1.25383f, -1.02793f, 1.00041f, 0f, 1.5f, 1.5f, 2f, joaat("VOLCYLINDER"), 1);
	iLocal_20 = __LIB_7__::func_142(uParam0, joaat("P_CHAIR_CRATE02X"), 1.42059f, -0.462698f, 0f, 0, 1, 0, 1);
	iLocal_21 = __LIB_7__::func_142(uParam0, joaat("P_JAVIERKNIFE_TEMP"), 0f, 0f, 0f, "KNIFE", 0, 0, 1);
	__LIB_7__::func_142(uParam0, joaat("P_BOTTLEBEER01X"), 0f, 0f, 0f, "BOTTLE", 0, 0, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@javier_3@base", 1, 1, 0, 0);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@javier_3@action_a", 2, 0, 1, 0);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@javier_3@action_b", 0, 0, 0, 0);
	iLocal_18 = __LIB_6__::func_959(uParam0, "script@vignette@javier_3@action_b_alt", 0, 0, 0, 1);
	__LIB_7__::func_146(uParam0, "CJAV3AU");
	__LIB_7__::func_107(uParam0, iLocal_14, 3, joaat("WORLD_CAMP_JAVIER_KNIFE"), "WORLD_CAMP_JAVIER_KNIFE", iLocal_20, 0);
	__LIB_7__::func_127(uParam0, iLocal_14, 3, joaat("WORLD_CAMP_JAVIER_KNIFE"), "WORLD_CAMP_JAVIER_KNIFE", iLocal_20, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_139(uParam0, iLocal_14, iLocal_21, "p_Javierknife_temp_PH_R_Hand", 0, 0);
	__LIB_7__::func_226(uParam0, iLocal_15, 1061142135 /* Float: 0.749f */);
	__LIB_7__::func_151(uParam0, iLocal_15, 1, -1);
	__LIB_7__::func_149(uParam0, joaat("COMP_JAVCNV3"), joaat("PLAYER_JAVCNV3"));
	Local_22 = { __LIB_7__::func_160(uParam0, 2.405f, -0.9825f, 1.07f, -5.17f, 6.5f, 0.1725f, 0.66f) };
	return true;
}
...
bool func_93(var uParam0)
{
	if (__LIB_7__::func_148(uParam0, iLocal_16))
	{
		...
		{
			__LIB_7__::func_150(uParam0, iLocal_18, -1, 0.47f);
			iLocal_19 = iLocal_18;
			fLocal_33 = 0.275f;
			fLocal_34 = 0.45f;
		}
		...
		{
			__LIB_7__::func_150(uParam0, iLocal_17, -1, 0.57f);
			iLocal_19 = iLocal_17;
			fLocal_33 = 0.29f;
			fLocal_34 = 0.6f;
		}
	...
	{
		if (__LIB_7__::func_40(uParam0, iLocal_19, fLocal_34))
		{
			if (bLocal_32)
			{
				__LIB_6__::func_985(uParam0, iLocal_35, 0);
				bLocal_32 = false;
			}
		}
		else if (__LIB_7__::func_40(uParam0, iLocal_19, fLocal_33))
		{
			if (!bLocal_32)
			{
				iLocal_35 = __LIB_7__::func_159(uParam0, 3.52364f, 0.804585f, 1.00197f, 0f, 1.5f, 1.5f, 2f, joaat("VOLCYLINDER"), 1);
				__LIB_6__::func_985(uParam0, iLocal_35, 1);
				bLocal_32 = true;
			}
		}
	}
