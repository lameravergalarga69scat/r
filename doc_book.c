...
int func_4(var uParam0, var uParam1)
{
	if (*uParam0 > 0)
	{
		__LIB_19__::func_441(uParam0, uParam1);
	}
	switch (*uParam0)
	{
		case 0:
		...
		case 4:
			if (__LIB_7__::func_645((*uParam1)[0 /*9*/], uParam0->f_130))
			{
				...
				__LIB_19__::func_134(uParam0, uParam1, 1);
				__LIB_0__::func_19(uParam0, 6);
			}
			break;
		case 6:
			__LIB_19__::func_442(uParam0, uParam1[0 /*9*/]);
...
void func_21(var uParam0, var uParam1)
{
	...
	switch (TASK::_0x804425C4BBD00883(Global_35))
	{
		case joaat("DOCUMENT_MARY_BETH_JOURNAL"):
			...
			else if (__LIB_0__::func_317() == 6 || __LIB_0__::func_317() == 3)
			{
		...
		if (__LIB_0__::func_192(iParam0, -1588156645))
		{
			...
			if (__LIB_0__::func_357(iParam0) == -1447088266)
			{
				...
				if (WEAPON::IS_WEAPON_VALID(iVar1))
				{
					...
					if (__LIB_0__::func_708(0) && func_116(iVar1, 0, 0, 1, 0, 0, iParam5, 0))
					{
			...
			else
			{
				...
				if (WEAPON::_IS_AMMO_VALID(iVar1))
				{
					...
					if (__LIB_0__::func_708(0) && func_116(iParam0, 0, 0, 1, 0, 0, iParam5, 0))
					{
...
bool func_86(int iParam0, int iParam1, bool bParam2, int iParam3)
{
	if (__LIB_0__::func_2() == -1)
	{
		if (__LIB_0__::func_787(iParam0) && func_205(iParam0))
		{
...
int func_141(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)
{
	...
	if (!func_295(iParam1, iParam2, __LIB_0__::func_161(iParam3, 1), bParam4, bParam9))
	{
		return 0;
	}
	...
	switch (iParam1)
	{
		...
		case 0:
			if (!__LIB_4__::func_807(0))
			{
				...
				if ((((((((((func_477(iParam0, -1559802791, 1) || func_477(iParam0, -1268291907, 1)) || func_477(iParam0, -96974025, 1)) || func_477(iParam0, -1666604090, 1)) || func_477(iParam0, 1561961676, 1)) || func_477(iParam0, -156634416, 1)) || func_477(iParam0, 1061777683, 1)) || func_477(iParam0, -2074770370, 1)) || func_477(iParam0, -693134279, 1)) || func_477(iParam0, -182626652, 1)) || __LIB_7__::func_630(iParam0))
				{
					return true;
				}
			}
	...
	if (iParam0 != 0)
	{
		if (__LIB_0__::func_774(iParam0, 8388608))
		{
			...
			if (iVar0 != 0 && __LIB_1__::func_707(iVar0, 1, 0))
			{
				...
				return func_647(__LIB_7__::func_635(iParam0), iParam0);
			}
			...
			else if (__LIB_7__::func_638(iParam0))
			{
				...
				{
					return func_652(__LIB_7__::func_639(iParam0), 5, 0);
				}
			}
...
void func_617(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	if (iParam0 == __LIB_0__::func_856(0))
	{
		...
		if (__LIB_0__::func_241() == 1160113249)
		{
			func_677(__LIB_0__::func_856(-2125499975), 0);
		}
		else
		{
			func_677(__LIB_0__::func_856(1160113249), 0);
		}
	}
	__LIB_0__::func_460();
...
int func_695(int iParam0, int iParam1, bool bParam2, int iParam3, bool bParam4)
{
	...
	if (STATS::_STAT_ID_IS_VALID(&Var5))
	{
		...
		{
			func_695(iParam0, __LIB_1__::func_614(iParam0, 0, 0), bParam2, iParam3, bParam4);
			return 0;
		}
	}
...
void func_701(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)
{
	...
	if (iParam2 == -1)
	{
		uParam0->f_1 = __LIB_0__::func_161(func_409(iParam1), 1);
		if (uParam0->f_1 == -1)
		{
		}
	}
...
int func_742(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)
{
	...
	if (STATS::_STAT_ID_IS_VALID(&Var3))
	{
		...
		{
			func_742(iParam0, iParam1, __LIB_1__::func_614(iParam1, 0, 0), bParam3, iParam4);
			return 0;
		}
	}
