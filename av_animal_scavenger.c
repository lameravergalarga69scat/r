...
{
	__LIB_2__::func_851(uParam0, 10816, 10880, 11391);
}

void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	__LIB_2__::func_853(uParam0, "ANIMAL_SCAVENGER", "", vParam1, vParam4);
	__LIB_2__::func_902(uParam0, 1, "AS_ANIMAL", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, -0.8f, 0f, 0f), (-90f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	__LIB_2__::func_902(uParam0, 0, "AS_CORPSE", iLocal_10, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0f, 0f, 0f), (0f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
}

int func_30(var uParam0)
{
	STREAMING::REQUEST_ANIM_DICT(sLocal_12);
	__LIB_2__::func_887(&uLocal_16, 0);
	__LIB_1__::func_398(&uLocal_16, 1);
	__LIB_1__::func_401(&uLocal_16, 1);
	__LIB_1__::func_397(&uLocal_16, 1);
	__LIB_2__::func_828(&uLocal_16, 1);
	__LIB_2__::func_829(&uLocal_16, 1);
	__LIB_2__::func_830(&uLocal_16, 1);
	return 1;
}
...
int func_31(var uParam0)
{
	if (!uParam0->f_469[0])
	{
		if (__LIB_2__::func_908(uParam0, &uLocal_16, 0) || __LIB_0__::func_232(uParam0->f_20[1 /*14*/], Global_35, 1) < 225f)
		{
			__LIB_2__::func_857(&(uParam0->f_20[1 /*14*/]), 0, 1);
			PED::_0xEEED8FAFEC331A70(uParam0->f_20[1 /*14*/], Global_36, 0);
			__LIB_3__::func_5(uParam0);
			iLocal_11 = 2;
			uParam0->f_469[0] = 1;
		}
	}
