...
{
	__LIB_2__::func_851(uParam0, 10910, 10947, 11891);
}
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	switch (*uParam0)
	{
		case 174:
			...
			sLocal_38 = "hawk_exit_a";
			sLocal_39 = "snake_exit_a";
			__LIB_2__::func_853(uParam0, "HAWK_CATCH_SNAKE", "script@ambient@animal@HAWK_CATCH_SNAKE@action", vParam1, vParam4);
			break;
		case 175:
			sVar0 = "SQUIRREL";
			...
			__LIB_2__::func_853(uParam0, "HAWK_CATCH_SQUIRREL", "script@ambient@animal@HAWK_CATCH_SQUIRREL@action", vParam1, vParam4);
			break;
		case 177:
			sVar0 = "SNAKE";
			...
			__LIB_2__::func_853(uParam0, "HAWK_VS_SNAKE", "script@ambient@animal@HAWK_VS_SNAKE@action", vParam1, vParam4);
			break;
	}
	__LIB_2__::func_854(uParam0, 1, "pbl_action", "", 0);
	__LIB_2__::func_855(uParam0, 0, "HAWK", iLocal_46, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	__LIB_2__::func_855(uParam0, 1, sVar0, iLocal_47, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
}
...
int func_31(var uParam0)
{
	if (!uParam0->f_469[0])
	{
		...
		if (!bLocal_51 == 1)
		{
			if ((__LIB_2__::func_908(uParam0, &uLocal_9, 0) || __LIB_0__::func_232(uParam0->f_20[0 /*14*/], Global_35, 1) < 225f) || __LIB_1__::func_992(Global_35, uParam0->f_483, 1) < 100f)
			{
				bLocal_51 = true;
			}
		}
		if (bLocal_51)
		{
			...
			{
				if (!__LIB_0__::func_75(&uLocal_48))
				{
	...
	{
		if (__LIB_1__::func_285(&uLocal_48, 5f))
		{
			return 1;
		}
	}
	if (!uParam0->f_469[0] && !bLocal_51)
	{
		...
		if (uParam0->f_469[2])
		{
			if (!uParam0->f_469[6])
			{
				if (__LIB_2__::func_889(uParam0, 0.75f, 1116471296 /* Float: 70f */, 4, joaat("ACTION"), 1))
				{
					__LIB_2__::func_890(*uParam0, uParam0->f_483, 1);
					uParam0->f_469[6] = 1;
				}
