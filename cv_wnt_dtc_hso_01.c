...
bool func_1(var uParam0)
{
	...
	if (bLocal_95)
	{
		__LIB_7__::func_293(uParam0, &uLocal_20);
		bLocal_95 = false;
	}
	return true;
}
...
bool func_77(var uParam0)
{
	...
	{
		case 1:
			__LIB_7__::func_116(uParam0, -116.747f, -31.713f, 94.788f, 0f, 0f, 0f);
			break;
		default:
			return false;
	}
	iLocal_18 = __LIB_7__::func_48(uParam0, 0, 0);
	iLocal_19 = __LIB_6__::func_959(uParam0, "script@vignette@wnt@dutch_horseshoe_1@action", 0, 0, 0, 0);
	__LIB_7__::func_146(uParam0, "CDHS1AU");
	__LIB_7__::func_235(uParam0, iLocal_18, "HorseShoeOverlook/hso_postmud1_dutch");
	__LIB_7__::func_147(uParam0, iLocal_18, 4, 2, 0, 0, 0);
	__LIB_7__::func_108(uParam0, iLocal_18, -1f);
	if (__LIB_6__::func_206(10))
	{
		uParam0->f_14 = 1;
	}
	__LIB_0__::func_19(&uLocal_20, iLocal_18);
	__LIB_7__::func_406(&uLocal_20, 0.5f);
	__LIB_3__::func_675(&uLocal_20, 1024);
	__LIB_7__::func_397(uParam0, &uLocal_20);
...
bool func_92(var uParam0)
{
	...
	if (!bLocal_94)
	{
		if (!__LIB_12__::func_487(__LIB_5__::func_824(__LIB_9__::func_842())))
		{
			if (!ENTITY::IS_ENTITY_DEAD(__LIB_6__::func_952(uParam0, iLocal_18)))
			{
				PED::_0xF1C03A5352243A30(__LIB_6__::func_952(uParam0, iLocal_18));
				TASK::TASK_GO_TO_ENTITY(__LIB_6__::func_952(uParam0, iLocal_18), Global_35, -1, 0.5f, 1f, 2f, 0);
				bLocal_94 = true;
			}
		}
	}
	if (bLocal_94)
	{
		if (__LIB_0__::func_665(Global_35, __LIB_6__::func_952(uParam0, iLocal_18), 1, 1) <= 9f)
		{
			if (PED::_0x7F9B9791D4CB71F6(__LIB_6__::func_952(uParam0, iLocal_18), Global_35, 0, 0) == 1 && !PED::IS_PED_USING_ANY_SCENARIO(__LIB_6__::func_952(uParam0, iLocal_18)))
			{
				__LIB_7__::func_310(uParam0, &uLocal_20);
				iLocal_96 = __LIB_6__::func_952(uParam0, iLocal_18);
...
bool func_98(var uParam0)
{
	if (bLocal_95)
	{
		if (__LIB_7__::func_404(uParam0, &uLocal_20))
		{
			__LIB_7__::func_274(uParam0, &uLocal_20);
			__LIB_7__::func_113(uParam0, iLocal_18, 0, 1);
			bLocal_95 = false;
		}
	}
	if (bLocal_95)
	{
		__LIB_7__::func_276(uParam0, &uLocal_20);
