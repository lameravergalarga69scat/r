...
bool func_72(var uParam0)
{
	...
	__LIB_7__::func_47(uParam0, 1.0616f, -0.3636f, 0.5329f, -19.8f, 1.5f, 1.5f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_SEAN"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, 0.4272f, 1.0817f, 0.5567f, -23.76f, 1.5f, 1.5f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_LENNY"), 1, 1, 1);
	__LIB_6__::func_958(uParam0, joaat("P_BOTTLEJD01X"), 0f, 0f, 0f, "BOTTLE_0", 0, 1, 1);
	...
	__LIB_7__::func_271(uParam0, iLocal_15, joaat("WEAPON_REPEATER_CARBINE"), "RIFLE");
	__LIB_6__::func_959(uParam0, "script@vignette@sean_1@base", 1, 1, 0, 0);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@sean_1@action_a", 2, 0, 1, 0);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@sean_1@action_a_int_front", 2, 0, 0, 1);
	iLocal_18 = __LIB_6__::func_959(uParam0, "script@vignette@sean_1@action_a_int_left", 2, 0, 0, 1);
	iLocal_19 = __LIB_6__::func_959(uParam0, "script@vignette@sean_1@action_a_int_right", 2, 0, 0, 1);
	iLocal_20 = __LIB_6__::func_959(uParam0, "script@vignette@sean_1@action_b", 0, 0, 0, 0);
	__LIB_7__::func_146(uParam0, "CSEN1AU");
	__LIB_7__::func_127(uParam0, iLocal_14, 3, joaat("PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS"), "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_MALE_D", iLocal_21, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	Local_22 = { __LIB_7__::func_160(uParam0, 0.4272f, 1.0817f, 0.5567f, 156.96f, 7f, 0.5f, 0.5f) };
	Local_32 = { __LIB_7__::func_160(uParam0, 0.427f, 1.082f, 0.557f, -113.04f, 7f, 0.5f, 0.5f) };
	Local_42 = { __LIB_7__::func_160(uParam0, 0.427f, 1.082f, 0.557f, 66.96f, 7f, 0.5f, 0.5f) };
	return true;
}
