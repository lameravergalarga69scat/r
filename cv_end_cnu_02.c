...
bool func_72(var uParam0)
{
	...
	__LIB_7__::func_159(uParam0, -0.3f, 0.1f, 0f, -27f, 1.03f, 0.7f, 3f, joaat("VOLCYLINDER"), 1);
	iLocal_16 = __LIB_6__::func_958(uParam0, joaat("P_BOTTLEBEER01X"), 0f, 0f, 0f, "S_INV_WHISKEY01X", 0, 0, 1);
	__LIB_6__::func_958(uParam0, joaat("P_BOTTLEBEER01X"), 0f, 0f, 0f, "P_BOTTLEBEER01X", 0, 0, 1);
	iLocal_17 = __LIB_6__::func_958(uParam0, joaat("P_CHAIR_BARREL04B"), -0.434831f, 1.30266f, -0.00206757f, 0, 1, 0, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@beecher@charles_and_uncle_2@base", 1, 1, 0, 0);
	__LIB_6__::func_959(uParam0, "script@vignette@beecher@charles_and_uncle_2@action", 0, 0, 1, 0);
	__LIB_7__::func_146(uParam0, "BCCU2AU");
	__LIB_7__::func_149(uParam0, joaat("COMP_BCCCNUCNV2"), joaat("PLAYER_BCCCNUCNV2"));
	__LIB_7__::func_107(uParam0, iLocal_14, 3, joaat("WORLD_CAMP_FIRE_SEATED_GROUND"), "WORLD_CAMP_FIRE_SIT_GROUND_MALE_A", -1, 1);
	__LIB_7__::func_127(uParam0, iLocal_14, 2, joaat("WORLD_CAMP_FIRE_SEATED_GROUND"), "WORLD_CAMP_FIRE_SIT_GROUND_MALE_A", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_151(uParam0, iLocal_14, 1, -1);
	__LIB_7__::func_107(uParam0, iLocal_15, 3, joaat("CC_PROP_CAMP_FIRE_SEATED_DRINKING"), "PROP_CAMP_FIRE_SEATED_DRINKING_BEER_MALE_B", iLocal_17, 0);
	__LIB_7__::func_127(uParam0, iLocal_15, 3, joaat("CC_PROP_CAMP_FIRE_SEATED_DRINKING"), "PROP_CAMP_FIRE_SEATED_DRINKING_BEER_MALE_B", iLocal_17, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
