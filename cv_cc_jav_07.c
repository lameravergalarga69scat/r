...
bool func_72(var uParam0)
{
	...
	iLocal_18 = __LIB_7__::func_48(uParam0, 3, 0);
	__LIB_7__::func_47(uParam0, -1.4375f, -0.4375f, 0.993f, -46.8f, 3f, 3f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_JAVIER"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, -2.8108f, -2.6885f, 0.9931f, 134.1287f, 1.5f, 1.5f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_BILL"), 1, 1, 1);
	Local_21 = { __LIB_7__::func_160(uParam0, -0.925f, -0.76f, 1.07f, -32.5f, 6.5f, 0.4725f, 0.96f) };
	iLocal_20 = __LIB_6__::func_958(uParam0, joaat("P_BOTTLEBEER01X"), 0f, 0f, 0f, "BOTTLE", 0, 1, 1);
	iLocal_19 = __LIB_6__::func_958(uParam0, joaat("P_CHAIR_BARREL04B"), -0.584473f, -1.37158f, 0f, 0, 1, 0, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@javier_7@base", 1, 1, 0, 0);
	iLocal_14 = __LIB_6__::func_959(uParam0, "script@vignette@javier_7@action_a", 2, 0, 1, 0);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@javier_7@Action_A_Int", 2, 0, 0, 1);
	iLocal_15 = __LIB_6__::func_959(uParam0, "script@vignette@javier_7@Action_B", 0, 0, 0, 0);
	__LIB_7__::func_146(uParam0, "CJAV7AU");
	__LIB_7__::func_107(uParam0, iLocal_17, 3, joaat("PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS"), "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_MALE_A", iLocal_19, 0);
	__LIB_7__::func_127(uParam0, iLocal_17, 3, joaat("PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS"), "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_MALE_A", iLocal_19, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_139(uParam0, iLocal_17, iLocal_20, "p_bottleBeer01x_PH_R_HAND", 0, 0);
	__LIB_7__::func_151(uParam0, iLocal_17, 1, -1);
	__LIB_7__::func_151(uParam0, iLocal_18, 1, -1);
	__LIB_7__::func_295(uParam0, iLocal_18, 1.5f, 1.5f, 1092616192 /* Float: 10f */);
	__LIB_7__::func_149(uParam0, joaat("COMP_JAVCNV7"), joaat("PLAYER_JAVCNV7"));
	__LIB_7__::func_150(uParam0, iLocal_15, -1, 0.21f);
	return true;
}
...
bool func_93(var uParam0)
{
	...
	if (__LIB_6__::func_997(uParam0, iLocal_18))
	{
		PED::FORCE_PED_MOTION_STATE(__LIB_6__::func_952(uParam0, iLocal_18), -1415276238, false, 1, false);
	}
	return true;
}
