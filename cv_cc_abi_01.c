...
bool func_89(var uParam0)
{
	...
	__LIB_7__::func_142(uParam0, joaat("P_MATTRESS04X"), 1.17084f, -0.0235534f, 0.7491f, 0, 1, 0, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@abigail_1@base", 1, 1, 0, 0);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@abigail_1@action", 0, 0, 1, 0);
	__LIB_7__::func_146(uParam0, "CCABAUD");
	__LIB_7__::func_149(uParam0, joaat("COMP_ABICNV1"), joaat("PLAYER_ABICNV1"));
	...
	__LIB_7__::func_127(uParam0, iLocal_15, 1, joaat("WORLD_HUMAN_STARE_STOIC"), 0, -1, 0, 90f, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_143(uParam0, iLocal_15, -130f, 1);
