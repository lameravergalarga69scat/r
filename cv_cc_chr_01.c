...
bool func_72(var uParam0)
{
	...
	__LIB_7__::func_47(uParam0, -0.64f, 1.2f, 0f, -142.2f, 5f, 1.5f, 5f, joaat("VOLBOX"), -1, 1, 1, 1);
	__LIB_6__::func_958(uParam0, joaat("P_CS_ARROW01X"), 0f, 0f, 0f, "ARROW", 0, 1, 1);
	iLocal_19 = __LIB_6__::func_958(uParam0, joaat("P_CHAIR_CRATE02X"), -1.85942f, -0.832704f, -0.0209045f, 0, 1, 0, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@charles_1@base", 1, 1, 0, 0);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@charles_1@action_a", 2, 0, 1, 0);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@charles_1@action_b", 0, 0, 0, 0);
	iLocal_18 = __LIB_6__::func_959(uParam0, "script@vignette@charles_1@action_b_alt", 0, 0, 0, 1);
	__LIB_7__::func_146(uParam0, "CCHR1AU");
	...
	__LIB_7__::func_107(uParam0, iLocal_15, 3, joaat("WORLD_HUMAN_INSPECT"), "WORLD_HUMAN_INSPECT_MALE_B", -1, 1);
	Local_20 = { __LIB_7__::func_160(uParam0, -1.8125f, -1.5801f, 0.988f, -55.8799f, 8f, 0.47f, 0.42f) };
	return true;
}
