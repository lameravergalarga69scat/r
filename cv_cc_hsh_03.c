...
bool func_72(var uParam0)
{
	...
	__LIB_7__::func_47(uParam0, -0.0193f, 0.0081f, 0.5071f, 0f, 1.5f, 1.5f, 3f, joaat("VOLBOX"), -1, 1, 1, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@hosea_3@base", 1, 1, 0, 0);
	iLocal_15 = __LIB_6__::func_959(uParam0, "script@vignette@hosea_3@actiona", 2, 0, 1, 1);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@hosea_3@actionb", 2, 0, 0, 1);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@hosea_3@actionc", 0, 0, 0, 1);
	iLocal_18 = __LIB_6__::func_959(uParam0, "script@vignette@hosea_3@base", 1, 0, 0, 0);
	iLocal_19 = __LIB_6__::func_959(uParam0, "script@vignette@hosea_3@base", 1, 0, 0, 0);
	iLocal_20 = iLocal_16;
	__LIB_7__::func_146(uParam0, "CHS3AUD");
	__LIB_7__::func_107(uParam0, iLocal_14, 2, joaat("PROP_HUMAN_SEAT_CHAIR"), "PROP_HUMAN_SEAT_CHAIR_GENERIC_MALE_D", -1, 0);
	__LIB_7__::func_151(uParam0, iLocal_14, 1, -1);
	__LIB_7__::func_149(uParam0, joaat("COMP_HSHCNV3"), joaat("PLAYER_HSHCNV3"));
	Local_24 = { __LIB_7__::func_160(uParam0, -0.0193f, 0.0081f, 0.5071f, 93.2119f, 6f, 0.7f, 0.7f) };
	Local_34 = { __LIB_7__::func_160(uParam0, 1.68f, 0.0081f, 0.5071f, 93.2119f, 9f, 0.8f, 0.8f) };
...
bool func_93(var uParam0)
{
	...
	if (__LIB_7__::func_38(uParam0, iLocal_18) || __LIB_7__::func_38(uParam0, iLocal_19))
	{
		if (__LIB_0__::func_264(&uLocal_21) < 40f)
		{
			if (__LIB_7__::func_163(uParam0, Local_34, 1, 0))
			{
		...
		else if (!ENTITY::IS_ENTITY_ON_SCREEN(__LIB_6__::func_952(uParam0, iLocal_14)))
		{
