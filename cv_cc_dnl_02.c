...
bool func_72(var uParam0)
{
	...
	__LIB_7__::func_47(uParam0, -0.9875f, 0.2625f, 0.832f, 87.12f, 2f, 4.45f, 2.135f, joaat("VOLBOX"), joaat("APMS_COMP_DUTCH"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, -3.775f, -1.1375f, 0.8945f, 80f, 1f, 1f, 2.2325f, joaat("VOLBOX"), joaat("APMS_COMP_LENNY"), 1, 1, 1);
	__LIB_7__::func_159(uParam0, -1.04f, 0.88f, 0.9787f, 0f, 0.8f, 0.8f, 2.2325f, joaat("VOLCYLINDER"), 1);
	iLocal_16 = __LIB_6__::func_958(uParam0, joaat("P_CS_BOOKEVELYNMILLER"), 0f, 0f, 0f, "BOOK", 0, 0, 1);
	iLocal_17 = __LIB_6__::func_958(uParam0, joaat("P_CHAIRFOLDING02X"), 0.167566f, 1.04268f, -0.0225601f, 0, 1, 0, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@dutch_and_lenny_2@base", 1, 1, 0, 0);
	__LIB_6__::func_959(uParam0, "script@vignette@dutch_and_lenny_2@action", 0, 0, 1, 0);
	__LIB_7__::func_146(uParam0, "CDNL2AU");
	...
	__LIB_7__::func_149(uParam0, joaat("COMP_DNLCNV2"), joaat("PLAYER_DNLCNV2"));
	return true;
}
