...
bool func_72(var uParam0)
{
	...
	__LIB_7__::func_47(uParam0, 0f, 0f, 0f, 102.24f, 1.5f, 1.5f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_LENNY"), 1, 1, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@lenny_2@base", 1, 1, 0, 0);
	__LIB_6__::func_959(uParam0, "script@vignette@lenny_2@action", 0, 0, 1, 1);
	__LIB_7__::func_146(uParam0, "LEN2AUD");
	__LIB_7__::func_107(uParam0, iLocal_14, 2, joaat("WORLD_HUMAN_GUARD_SCOUT"), "WORLD_HUMAN_GUARD_SCOUT_MALE_C", -1, 1);
