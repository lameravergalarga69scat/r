...
bool func_72(var uParam0)
{
	...
	__LIB_7__::func_47(uParam0, 0.0501f, -2.8875f, 1.4875f, 0f, 1.1f, 1.1f, 3.2075f, joaat("VOLBOX"), joaat("APMS_COMP_DUTCH"), 1, 1, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@dutch_31@base", 1, 1, 0, 0);
	iLocal_15 = __LIB_6__::func_959(uParam0, "script@vignette@dutch_31@action", 0, 0, 1, 1);
	__LIB_7__::func_146(uParam0, "CDT31AU");
	__LIB_7__::func_153(uParam0, iLocal_14, 3, joaat("WORLD_HUMAN_STERNGUY_IDLES"), 0, -1, 0, MISC::GET_RANDOM_FLOAT_IN_RANGE(30f, 50f), 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_171(uParam0, iLocal_14, 3, 0);
	__LIB_7__::func_172(uParam0, iLocal_14, 1);
	__LIB_7__::func_151(uParam0, iLocal_14, 3, -1);
	Local_16 = { __LIB_7__::func_160(uParam0, 0.0775f, -2.3185f, 0.9877f, 169f, 6.5f, 0.705f, 0.4425f) };
...
bool func_93(var uParam0)
{
	...
	{
		if (__LIB_7__::func_84(uParam0, iLocal_15) || __LIB_6__::func_997(uParam0, iLocal_14))
		{
			__LIB_1__::func_148(&uLocal_26);
			TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(__LIB_6__::func_952(uParam0, iLocal_14), 2357.7f, 1396.42f, 104.98f, 1.2f, -1, 0.25f, 1, 40000f);
			PED::FORCE_PED_MOTION_STATE(__LIB_6__::func_952(uParam0, iLocal_14), joaat("MOTIONSTATE_WALK"), false, 0, false);
		}
	}
	else if (__LIB_0__::func_264(&uLocal_26) < 5f)
	{
		return false;
	}
	else
