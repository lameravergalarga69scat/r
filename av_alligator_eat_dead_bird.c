...
{
	__LIB_2__::func_851(uParam0, 10761, 10805, 11208);
}

void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	__LIB_2__::func_853(uParam0, "GATOR_EAT_DEAD_BIRD", "script@ambient@animal@alligator_eat_dead_bird@action", vParam1, vParam4);
	...
	__LIB_2__::func_855(uParam0, 1, "EGRET", iLocal_10, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 0);
}
