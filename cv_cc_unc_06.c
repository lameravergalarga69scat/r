...
bool func_72(var uParam0)
{
	...
	__LIB_7__::func_47(uParam0, -4.375f, -2.275f, 0.807f, 89f, 1f, 1f, 3.1425f, joaat("VOLBOX"), joaat("APMS_COMP_UNCLE"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, -0.8625f, -3.225f, 0.807f, 89f, 2.13f, 2.1625f, 3.1425f, joaat("VOLBOX"), joaat("APMS_COMP_ABIGAIL"), 1, 1, 1);
	__LIB_6__::func_958(uParam0, joaat("P_CS_SOCK01X"), 0f, 0f, 0f, "SOCK", 0, 1, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@uncle_6@base", 1, 1, 0, 0);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@uncle_6@action", 0, 0, 1, 0);
	__LIB_7__::func_146(uParam0, "CUNC6AU");
	__LIB_7__::func_149(uParam0, joaat("COMP_UNCCNV6"), joaat("PLAYER_UNCCNV6"));
	__LIB_7__::func_150(uParam0, iLocal_16, -1, 0.91f);
	__LIB_7__::func_107(uParam0, iLocal_15, 3, joaat("WORLD_HUMAN_PEE"), "WORLD_HUMAN_PEE_MALE_A", -1, 1);
