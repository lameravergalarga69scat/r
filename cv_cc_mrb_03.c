...
bool func_72(var uParam0)
{
	...
	__LIB_7__::func_47(uParam0, -1.2548f, -4.3769f, 1.2774f, 137.8534f, 1.5f, 1.5f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_MARYBETH"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, 0.72f, -0.97f, 1f, 90f, 3f, 3f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_KAREN"), 1, 1, 1);
	__LIB_6__::func_958(uParam0, joaat("P_CS_RAG02X"), 0f, 0f, 0f, "RAG", 0, 1, 1);
	__LIB_6__::func_958(uParam0, joaat("P_PLATE03X"), 0f, 0f, 0f, "PLATE", 0, 1, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@marybeth_3@base", 1, 1, 0, 0);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@marybeth_3@action_a", 2, 0, 1, 0);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@marybeth_3@action_b", 0, 0, 0, 0);
	iLocal_18 = __LIB_6__::func_959(uParam0, "script@vignette@marybeth_3@action_b_alt_left", 0, 0, 0, 1);
	iLocal_19 = __LIB_6__::func_959(uParam0, "script@vignette@marybeth_3@action_b_alt_right", 0, 0, 0, 1);
	__LIB_7__::func_146(uParam0, "CCMB3AU");
	__LIB_7__::func_147(uParam0, iLocal_14, 1, 3, 0, 0, 0);
	__LIB_7__::func_127(uParam0, iLocal_15, 2, joaat("WORLD_HUMAN_CROUCH_INSPECT"), "WORLD_HUMAN_CROUCH_INSPECT_FEMALE_A", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_147(uParam0, iLocal_15, 1, 3, 0, 0, 0);
	Local_20 = { __LIB_7__::func_160(uParam0, 0.6414f, -0.9792f, 1.061f, -60.9f, 8f, 0.385f, 0.385f) };
	Local_30 = { __LIB_7__::func_160(uParam0, 0.641f, -0.979f, 1.061f, -122.56f, 8f, 0.3f, 0.3f) };
	return true;
}
