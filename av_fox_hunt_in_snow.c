...
{
	__LIB_2__::func_851(uParam0, 10772, 10823, 11561);
}

void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	__LIB_2__::func_853(uParam0, "FOX_HUNT_IN_SNOW", "script@ambient@animal@fox_hunt_in_snow@action", vParam1, vParam4);
	uParam0->f_16 = 1;
	__LIB_2__::func_854(uParam0, 1, "pbl_action", "", 0);
	__LIB_2__::func_855(uParam0, 0, "FOX", iLocal_9, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
}
...
int func_31(var uParam0)
{
	...
	if (!uParam0->f_469[0])
	{
		if (!bLocal_38)
		{
			if ((!bLocal_40 || __LIB_2__::func_908(uParam0, &uLocal_10, 1)) || __LIB_0__::func_232(uParam0->f_20[0 /*14*/], Global_35, 1) <= 400f)
			{
	...
	if (uParam0->f_469[0])
	{
		...
		if (!bLocal_40)
		{
			if (__LIB_1__::func_285(&uLocal_41, 2f))
			{
				return 1;
			}
		}
