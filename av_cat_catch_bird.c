...
{
	__LIB_2__::func_851(uParam0, 10777, 10821, 12011);
}

void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	__LIB_2__::func_853(uParam0, "CAT_CATCH_BIRD", "script@ambient@animal@cat_catch_bird@action", vParam1, vParam4);
	uParam0->f_16 = 1;
	__LIB_2__::func_854(uParam0, 1, "pbl_action", "", 0);
	__LIB_2__::func_855(uParam0, 0, "CAT", iLocal_37, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 0);
	__LIB_2__::func_855(uParam0, 1, "PIGEON", iLocal_38, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 0);
}
...
int func_31(var uParam0)
{
	...
	if (!uParam0->f_469[0])
	{
		if (!bLocal_42 == 1)
		{
			if (__LIB_2__::func_908(uParam0, &uLocal_9, 1) || __LIB_0__::func_232(Global_35, uParam0->f_20[0 /*14*/], 1) <= 100f)
			{
				bLocal_42 = true;
			}
		}
	...
	if (uParam0->f_469[0])
	{
		...
		{
			if (__LIB_1__::func_285(&uLocal_44, 4f))
			{
				return 1;
			}
		}
						...
						if (ANIMSCENE::_0x1F0E401031E20146(uParam0->f_3.f_1, "pbl_action"))
						{
							if (ENTITY::HAS_ANIM_EVENT_FIRED(uParam0->f_20[0 /*14*/], joaat("ENDSINWALK")))
							{
								if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
								{
									...
									__LIB_2__::func_915(uParam0->f_20[0 /*14*/], joaat("WORLD_ANIMAL_CAT_RESTING"), vLocal_39, 0f, 60000, 1, 0, 0, -1082130432 /* Float: -1f */);
