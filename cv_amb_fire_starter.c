...
bool func_72(var uParam0)
{
	...
	__LIB_7__::func_46(uParam0, 0f, 0f, 0f, 0f, 3f, 3f, 2f, joaat("VOLCYLINDER"), 1);
	__LIB_7__::func_48(uParam0, 7, "MALE_A");
	__LIB_6__::func_958(uParam0, joaat("P_MATCHSTICK01X"), 0f, 0f, 0f, "MATCH", 0, 0, 1);
	__LIB_6__::func_958(uParam0, joaat("P_MATCHES01X"), 0f, 0f, 0f, "MATCHBOX", 0, 0, 1);
	__LIB_6__::func_958(uParam0, joaat("P_STICKFIREPOKER01X"), 0f, 0f, 0f, "STICK", 0, 0, 1);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@ambient@av_fire_starter@pl_action", 0, 1, 0, 0);
	switch (__LIB_4__::func_576(uParam0))
	{
		case 12:
			__LIB_7__::func_47(uParam0, -1.2418f, 0.5081f, 1.0429f, 180f, 1f, 1f, 2f, joaat("VOLCYLINDER"), -1, 1, 1, 1);
			iLocal_17 = __LIB_7__::func_32(uParam0, iLocal_16, "PL_BLOW_ACTION", 1);
			iLocal_15 = __LIB_6__::func_958(uParam0, joaat("P_CHAIRFOLDING02X"), 1.198f, -1.869f, 0.472f, 0, 1, 0, 1);
			__LIB_7__::func_127(uParam0, iLocal_14, 3, joaat("PROP_CAMP_FIRE_SEATED"), "PROP_CAMP_FIRE_SEATED_MALE_Q", iLocal_15, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
			break;
		case 13:
			__LIB_7__::func_47(uParam0, 1.3582f, -0.1544f, 1.0429f, 180f, 1.115f, 1.115f, 2f, joaat("VOLCYLINDER"), -1, 1, 1, 1);
			iLocal_17 = __LIB_7__::func_32(uParam0, iLocal_16, "PL_POKE_ACTION", 1);
			__LIB_7__::func_127(uParam0, iLocal_14, 2, joaat("WORLD_HUMAN_STAND_WAITING"), "WORLD_HUMAN_STAND_WAITING_MALE_A", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
			break;
		case 14:
			switch (__LIB_0__::func_78(uParam0))
			{
				case 1:
					iVar0 = __LIB_6__::func_958(uParam0, joaat("P_BEDROLLOPEN01X"), 2.07f, -0.78f, 0f, 0, 1, 0, 1);
					break;
				case 2:
					iVar0 = __LIB_6__::func_958(uParam0, joaat("P_BEDROLLOPEN03X"), 2.07f, -0.78f, 0f, 0, 1, 0, 1);
					break;
				case 3:
					iVar0 = __LIB_6__::func_958(uParam0, joaat("S_BEDROLLOPEN01X"), 2.07f, -0.78f, 0f, 0, 1, 0, 1);
					break;
				case 6:
					iVar0 = __LIB_6__::func_958(uParam0, joaat("S_BEDROLLOPEN01X"), 2.07f, -0.78f, 0f, 0, 1, 0, 1);
					break;
			...
			__LIB_7__::func_47(uParam0, 1.3582f, -0.1544f, 1.0429f, 180f, 1.115f, 1.115f, 2f, joaat("VOLCYLINDER"), -1, 1, 1, 1);
			iLocal_17 = __LIB_7__::func_32(uParam0, iLocal_16, "PL_START_ACTION", 1);
			__LIB_7__::func_127(uParam0, iLocal_14, 2, joaat("WORLD_CAMP_FIRE_SIT_GROUND"), "WORLD_CAMP_FIRE_SIT_GROUND_MALE_C", iVar0, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
			break;
		default:
			return false;
	}
