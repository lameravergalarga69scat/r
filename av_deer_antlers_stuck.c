...
{
	__LIB_2__::func_851(uParam0, 10912, 10964, 11913);
}

void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	__LIB_2__::func_853(uParam0, "ANTLERS_STUCK", "script@ambient@animal@DEER_ANTLERS_STUCK@action", vParam1, vParam4);
	uParam0->f_16 = 1;
	__LIB_2__::func_854(uParam0, 1, "pbl_action", "", 0);
	__LIB_2__::func_855(uParam0, 0, "DEER1", iLocal_9, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 0);
	__LIB_2__::func_855(uParam0, 1, "DEER2", iLocal_9, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 0);
}
...
{
	__LIB_2__::func_887(&uLocal_15, 0);
	__LIB_1__::func_398(&uLocal_15, 1);
	__LIB_1__::func_401(&uLocal_15, 1);
	__LIB_2__::func_828(&uLocal_15, 1);
	__LIB_2__::func_830(&uLocal_15, 1);
	__LIB_2__::func_906(&uLocal_15, 60);
	return 1;
}
...
int func_31(var uParam0)
{
	...
	if (!uParam0->f_469[0])
	{
		if (!bLocal_43 == 1)
		{
			if ((__LIB_2__::func_908(uParam0, &uLocal_15, 1) || __LIB_1__::func_992(Global_35, uParam0->f_483, 1) <= 400f) || ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
			{
				bLocal_43 = true;
			}
		}
		if (bLocal_43)
		{
			if (((!ENTITY::HAS_ANIM_EVENT_FIRED(uParam0->f_20[0 /*14*/], 725039534) || PED::IS_PED_FLEEING(uParam0->f_20[0 /*14*/])) || __LIB_0__::func_163(uParam0->f_20[0 /*14*/], 518218985)) || ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
			{
				if (!__LIB_0__::func_75(&uLocal_45))
				{
					__LIB_1__::func_148(&uLocal_45);
				}
				__LIB_2__::func_943(uParam0);
				if (!uParam0->f_469[5])
				{
	...
	if (uParam0->f_469[0])
	{
		if (__LIB_1__::func_285(&uLocal_45, 4f))
		{
			return 1;
		}
	}
	if (!uParam0->f_469[0] && !bLocal_43)
	{
		...
		if (uParam0->f_469[2])
		{
			if (!uParam0->f_469[5])
			{
				if (__LIB_2__::func_889(uParam0, 3f, 60f, 4, joaat("ACTION"), 1))
				{
					__LIB_2__::func_890(*uParam0, uParam0->f_483, 1);
					uParam0->f_469[5] = 1;
				}
