...
bool func_72(var uParam0)
{
	...
	{
		case 8:
			__LIB_7__::func_45(uParam0, 38, 0, 0, 0);
			break;
		default:
			return false;
	}
	iLocal_14 = __LIB_7__::func_48(uParam0, 13, 0);
	__LIB_6__::func_958(uParam0, joaat("P_BUCKET03X"), 0f, 0f, 0f, "BUCKET", 0, 0, 1);
	__LIB_7__::func_47(uParam0, -13.2467f, 14.6741f, 0.375f, 0f, 1.5f, 1.5f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_ABIGAIL"), 1, 1, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@beecher@abigail_2@base", 1, 1, 0, 0);
	iLocal_15 = __LIB_6__::func_959(uParam0, "script@vignette@beecher@abigail_2@Action_A_Backleft", 2, 0, 0, 1);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@beecher@abigail_2@Action_A_Backright", 2, 0, 0, 1);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@beecher@abigail_2@Action_A_Front", 2, 0, 0, 1);
	iLocal_18 = __LIB_6__::func_959(uParam0, "script@vignette@beecher@abigail_2@Action_A_Left", 2, 0, 0, 1);
	iLocal_19 = __LIB_6__::func_959(uParam0, "script@vignette@beecher@abigail_2@Action_A_Right", 2, 0, 0, 1);
	iLocal_20 = __LIB_6__::func_959(uParam0, "script@vignette@beecher@abigail_2@Action_B_Backleft", 2, 0, 0, 1);
	iLocal_21 = __LIB_6__::func_959(uParam0, "script@vignette@beecher@abigail_2@Action_B_Backright", 2, 0, 0, 1);
	iLocal_22 = __LIB_6__::func_959(uParam0, "script@vignette@beecher@abigail_2@Action_B_Front", 2, 0, 0, 1);
	iLocal_23 = __LIB_6__::func_959(uParam0, "script@vignette@beecher@abigail_2@Action_B_Left", 2, 0, 0, 1);
	iLocal_24 = __LIB_6__::func_959(uParam0, "script@vignette@beecher@abigail_2@Action_B_Right", 2, 0, 0, 1);
	iLocal_26 = __LIB_6__::func_959(uParam0, "script@vignette@beecher@abigail_2@Exit_Action", 0, 0, 0, 0);
	__LIB_7__::func_146(uParam0, "BABI2AU");
	__LIB_7__::func_149(uParam0, joaat("COMP_BCABICNV2"), joaat("PLAYER_BCABICNV2"));
	__LIB_7__::func_151(uParam0, iLocal_14, 1, -1);
	Local_27 = { __LIB_7__::func_160(uParam0, -13.2325f, 14.8475f, 1.07f, 176.4f, 6.5f, 0.22f, 0.415f) };
	Local_37 = { __LIB_7__::func_160(uParam0, -13.233f, 14.848f, 1.07f, -144.42f, 6.5f, 0.3525f, 0.215f) };
	Local_47 = { __LIB_7__::func_160(uParam0, -13.233f, 14.848f, 1.07f, 44.58f, 6.5f, 0.1725f, 0.66f) };
	Local_57 = { __LIB_7__::func_160(uParam0, -13.233f, 14.848f, 1.07f, 119.16f, 6.5f, 0.22f, 0.6575f) };
	Local_67 = { __LIB_7__::func_160(uParam0, -13.233f, 14.848f, 1.07f, -34.66f, 6.5f, 0.22f, 0.8675f) };
...
bool func_87(var uParam0)
{
	...
	else if (__LIB_7__::func_163(uParam0, Local_67, 1, 0))
	{
		iLocal_25 = iLocal_19;
		return true;
	}
...
bool func_93(var uParam0)
{
	...
	if ((((__LIB_7__::func_148(uParam0, iLocal_20) || __LIB_7__::func_148(uParam0, iLocal_21)) || __LIB_7__::func_148(uParam0, iLocal_22)) || __LIB_7__::func_148(uParam0, iLocal_23)) || __LIB_7__::func_148(uParam0, iLocal_24))
	{
