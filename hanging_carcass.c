...
{
	struct<44> Var0;
	if (!TASK::_DOES_SCENARIO_POINT_EXIST(ScriptParam_0.f_1) || __LIB_0__::func_2() != -1)
	{
...
int func_3(var uParam0)
{
	...
	while (iVar0 < 10)
	{
		if (__LIB_0__::func_175(uParam0->f_1, Global_1425196[iVar0 /*3*/], 0.1f, 0))
		{
			return 1;
		}
		iVar0++;
...
int func_4(var uParam0)
{
	...
	while (iVar0 < 5)
	{
		if (__LIB_0__::func_175(vVar1[iVar0 /*3*/], uParam0->f_1, 5f, 1))
		{
			return 1;
		}
		iVar0++;
...
{
	if ((SCRIPTS::_0x9E4EF615E307FBBE() || !TASK::_DOES_SCENARIO_POINT_EXIST(*uParam0)) || __LIB_2__::func_776())
	{
		return true;
	}
	return false;
...
bool func_10(var uParam0)
{
	...
	if (__LIB_0__::func_175(uParam0->f_1, vVar3, 60f, 1))
	{
		func_22(uParam0, 128);
		func_22(uParam0, 64);
	}
	if (__LIB_0__::func_175(uParam0->f_1, vVar6, 10f, 1))
	{
		func_22(uParam0, 64);
	}
	switch (uParam0->f_39)
	{
		case joaat("P_CARCASSHANGLRG01X"):
			...
			switch (__LIB_0__::func_979(uParam0->f_1))
			{
				case 0:
				case 2:
				case 4:
			...
			if (__LIB_0__::func_175(uParam0->f_1, vVar0, 10f, 1))
			{
				iVar9 = 1;
			}
...
bool func_14(var uParam0)
{
	...
	uParam0->f_42 = __LIB_1__::func_545(uParam0->f_38, vVar1, (uParam0->f_4 + fVar0), 0, 1, 0, 1, 1, 1, 0, 0, 0, 0);
	...
	if (func_15(3, uParam0))
	{
		__LIB_1__::func_864(uParam0->f_42, 1, 1);
...
bool func_17(var uParam0)
{
	...
	{
		__LIB_1__::func_148(&(uParam0->f_52));
		uParam0->f_5 = MISC::GET_RANDOM_FLOAT_IN_RANGE(1f, 2f);
	}
	if (__LIB_1__::func_285(&(uParam0->f_52), uParam0->f_5))
	{
		...
		while (iVar1 < SCRIPTS::GET_NUMBER_OF_EVENTS(0))
		{
			if (SCRIPTS::GET_EVENT_AT_INDEX(0, iVar1) == 1376140891)
			{
				...
				if (vVar2.x == Global_35 && ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(vVar2.y) == uParam0->f_42)
				{
					if (vVar2.z)
					{
						__LIB_4__::func_268(2, joaat("HONOR_EVENT_THEFT"), 0, 0, 0, 0, 1065353216 /* Float: 1f */, 0);
						return true;
					}
					else
					{
...
void func_35(var uParam0)
{
	...
	while (iVar0 < 10)
	{
		if (__LIB_0__::func_175(Global_1425196[iVar0 /*3*/], uParam0->f_1, 0.1f, 0))
		{
			return;
		}
		iVar0++;
