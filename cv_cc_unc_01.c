...
bool func_72(var uParam0)
{
	...
	__LIB_7__::func_47(uParam0, -2.4573f, -0.9856f, 0.0289f, 100.97f, 1.5f, 1.9f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_UNCLE"), 1, 1, 1);
	__LIB_7__::func_142(uParam0, joaat("P_BOTTLEJD01X"), -2.486f, -1.599f, 0f, 0, 0, 0, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@uncle_1@base", 1, 1, 0, 0);
	iLocal_15 = __LIB_6__::func_959(uParam0, "script@vignette@uncle_1@action", 2, 0, 1, 1);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@uncle_1@idle", 2, 0, 0, 0);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@uncle_1@exit_stand", 0, 0, 0, 0);
	Local_18 = { __LIB_7__::func_160(uParam0, -2.4332f, -1.0036f, 0.6719f, 101.3764f, 7.5f, 0.75f, 0.75f) };
	__LIB_7__::func_146(uParam0, "CUN1AUD");
	__LIB_7__::func_149(uParam0, joaat("COMP_UNCCNV1"), joaat("PLAYER_UNCCNV1"));
	__LIB_7__::func_150(uParam0, iLocal_15, -1, 0.82f);
