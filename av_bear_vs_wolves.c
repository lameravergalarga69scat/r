...
{
	__LIB_2__::func_851(uParam0, 11241, 11330, 12637);
}

void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	__LIB_2__::func_853(uParam0, "BEAR_VS_WOLVES", "script@ambient@animal@bear_vs_wolves@action", vParam1, vParam4);
	uParam0->f_16 = 1;
	__LIB_2__::func_854(uParam0, 1, "pbl_action", "", 0);
	__LIB_2__::func_855(uParam0, 0, "WOLF1", iLocal_9, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 0);
	__LIB_2__::func_855(uParam0, 1, "WOLF2", iLocal_9, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 0);
	__LIB_2__::func_855(uParam0, 2, "WOLF3", iLocal_9, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 0);
	__LIB_2__::func_855(uParam0, 3, "BEAR", iLocal_10, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 0);
	__LIB_2__::func_855(uParam0, 4, "carcass", joaat("A_C_DEER_01"), vParam1, vParam4.z, 1, 0, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
}
...
int func_30(var uParam0)
{
	...
	__LIB_2__::func_906(&uLocal_11, 55);
	return 1;
}
...
int func_31(var uParam0)
{
	...
	if (!uParam0->f_469[0])
	{
		if (!bLocal_41 == 1)
		{
			if (__LIB_2__::func_908(uParam0, &uLocal_11, 1) || __LIB_1__::func_992(Global_35, uParam0->f_483, 1) <= 625f)
			{
				bLocal_41 = true;
			}
		}
		if (bLocal_41)
		{
			...
			__LIB_2__::func_909(uParam0);
			__LIB_2__::func_857(&(uParam0->f_20[3 /*14*/]), 0, 1);
			func_73(uParam0);
			uParam0->f_469[0] = 1;
		}
	}
							...
							if (!uParam0->f_469[5])
							{
								if (ANIMSCENE::_0x005E6F28DD7ED58D(uParam0->f_3.f_1, uParam0->f_20[2 /*14*/].f_1))
								{
									if (ENTITY::HAS_ANIM_EVENT_FIRED(uParam0->f_20[2 /*14*/], joaat("ENDSINRUN")))
									{
										...
										__LIB_2__::func_857(&(uParam0->f_20[2 /*14*/]), 0, 1);
...
void func_73(var uParam0)
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[3 /*14*/]))
	{
		if (!__LIB_0__::func_163(uParam0->f_20[3 /*14*/], 780511057))
		{
