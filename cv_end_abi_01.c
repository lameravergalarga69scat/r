...
bool func_72(var uParam0)
{
	...
	{
		case 8:
			__LIB_7__::func_45(uParam0, 42, 0, 0, 0);
			break;
		default:
			return false;
	}
	iLocal_14 = __LIB_7__::func_48(uParam0, 13, 0);
	iLocal_17 = __LIB_7__::func_31(uParam0, joaat("A_C_COW"), "COW");
	__LIB_7__::func_47(uParam0, 1.3527f, 1.6955f, 1.0578f, -94.52f, 2.8f, 2.8f, 3f, joaat("VOLBOX"), -1, 1, 1, 1);
	__LIB_7__::func_159(uParam0, 1.35f, 1.65f, 0f, 0f, 1.5f, 1.5f, 3f, joaat("VOLCYLINDER"), 1);
	__LIB_6__::func_958(uParam0, joaat("P_CS_BUCKET01BX"), 0f, 0f, 0f, "BUCKET", 0, 0, 1);
	__LIB_6__::func_958(uParam0, joaat("P_STOOL02X"), 0f, 0f, 0f, "STOOL", 0, 0, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@beecher@abigail_1@base", 1, 1, 0, 0);
	iLocal_15 = __LIB_6__::func_959(uParam0, "script@vignette@beecher@abigail_1@action", 2, 0, 1, 1);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@beecher@abigail_1@exit_action", 0, 0, 0, 0);
	__LIB_7__::func_146(uParam0, "BABI1AU");
	__LIB_7__::func_149(uParam0, joaat("COMP_BCABICNV1"), joaat("PLAYER_BCABICNV1"));
	__LIB_7__::func_151(uParam0, iLocal_14, 1, -1);
	iLocal_18 = __LIB_7__::func_156(uParam0, -2.25f, 2.1f, 1.95f, 0f, 0f, -4f, 10.75f, 7.48f, 4f, "volTrigger", joaat("VOLBOX"));
...
{
	if (ANIMSCENE::_0x005E6F28DD7ED58D(uParam0->f_1984[iLocal_16], "COW") && !__LIB_0__::func_75(&uLocal_19))
	{
		TASK::_TASK_START_SCENARIO_IN_PLACE(__LIB_6__::func_952(uParam0, iLocal_17), joaat("STAND"), 0, false, 0, -1f, false);
		PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(__LIB_6__::func_952(uParam0, iLocal_17), true);
...
{
	if (__LIB_0__::func_264(&uLocal_19) < 10f)
	{
		PED::SET_PED_CAN_PLAY_AMBIENT_ANIMS(__LIB_6__::func_952(uParam0, iLocal_17), false);
		PED::SET_PED_CAN_PLAY_AMBIENT_BASE_ANIMS(__LIB_6__::func_952(uParam0, iLocal_17), false);
	}
	if (ENTITY::IS_ENTITY_OCCLUDED(__LIB_6__::func_952(uParam0, iLocal_17)) && __LIB_0__::func_232(__LIB_6__::func_952(uParam0, iLocal_17), Global_35, 1) >= 144f)
	{
		__LIB_7__::func_370(uParam0, iLocal_17);
		return true;
	}
	return false;
}
