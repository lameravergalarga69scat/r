...
bool func_72(var uParam0)
{
	...
	{
		case 8:
			__LIB_7__::func_116(uParam0, -1660.994f, -1362.774f, 83.275f, 0f, 0f, 92.26f);
			break;
		default:
			return false;
	}
	...
	__LIB_7__::func_47(uParam0, -31.1981f, 3.29326f, 0.868729f, 0f, 1f, 1f, 2.75f, joaat("VOLBOX"), joaat("APMS_COMP_ABIGAIL"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, -33.4896f, -4.24883f, 0.369225f, 0f, 2.275f, 1.11f, 2.75f, joaat("VOLBOX"), joaat("APMS_COMP_JACK"), 1, 1, 1);
	Local_24 = { __LIB_7__::func_160(uParam0, -33.4896f, -4.24883f, 0.369225f, -60f, 6.5f, 0.2825f, 0.7275f) };
	Local_34 = { __LIB_7__::func_160(uParam0, -33.4896f, -4.24883f, 0.369225f, 26.4f, 6.5f, 0.2775f, 0.6775f) };
	Local_44 = { __LIB_7__::func_160(uParam0, -33.4896f, -4.24883f, 0.369225f, -151f, 6.5f, 0.285f, 0.66f) };
	iLocal_23 = __LIB_6__::func_958(uParam0, joaat("P_CS_BOOK04X"), 0f, 0f, 0f, "BOOK", 0, 0, 1);
	__LIB_6__::func_958(uParam0, joaat("P_TEACUP"), 0f, 0f, 0f, "TEACUP", 0, 0, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@beecher@jack_6@Base", 1, 1, 0, 0);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@beecher@jack_6@ACTION_A", 2, 0, 1, 0);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@beecher@jack_6@ACTION_B", 2, 0, 0, 0);
	iLocal_18 = __LIB_6__::func_959(uParam0, "script@vignette@beecher@jack_6@ACTION_B_ALT_FRONT", 2, 0, 0, 0);
	iLocal_19 = __LIB_6__::func_959(uParam0, "script@vignette@beecher@jack_6@ACTION_B_ALT_LEFT", 2, 0, 0, 0);
	iLocal_20 = __LIB_6__::func_959(uParam0, "script@vignette@beecher@jack_6@ACTION_B_ALT_RIGHT", 2, 0, 0, 0);
	iLocal_22 = __LIB_6__::func_959(uParam0, "script@vignette@beecher@jack_6@EXIT", 0, 0, 0, 0);
	__LIB_7__::func_149(uParam0, joaat("COMP_BCJCKCNV6"), joaat("PLAYER_BCJCKCNV6"));
	__LIB_7__::func_146(uParam0, "BJCK6AU");
	__LIB_7__::func_107(uParam0, iLocal_14, 3, joaat("WORLD_HUMAN_SIT_GROUND_READING"), "WORLD_HUMAN_SIT_GROUND_READING_BOOK_MALE_A", -1, 1);
	__LIB_7__::func_127(uParam0, iLocal_14, 2, joaat("WORLD_HUMAN_SIT_GROUND_READING"), "WORLD_HUMAN_SIT_GROUND_READING_BOOK_MALE_A", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_139(uParam0, iLocal_14, iLocal_23, "p_cs_book04x_PH_R_HAND", 0, 0);
	__LIB_7__::func_151(uParam0, iLocal_14, 1, -1);
	__LIB_7__::func_107(uParam0, iLocal_15, 3, joaat("WORLD_HUMAN_COFFEE_DRINK"), "WORLD_HUMAN_COFFEE_DRINK_FEMALE_C", -1, 1);
	__LIB_7__::func_151(uParam0, iLocal_14, 1, -1);
	return true;
}
