...
bool func_72(var uParam0)
{
	...
	{
		case 8:
			__LIB_7__::func_45(uParam0, 34, 0, 0, 0);
			break;
		default:
			return false;
	}
	iLocal_14 = __LIB_7__::func_48(uParam0, 13, 0);
	__LIB_7__::func_165(uParam0, 13, "HORSE", 1);
	__LIB_7__::func_47(uParam0, 4.8749f, -5.075f, 0.5f, -89.64f, 4f, 3f, 2.7425f, joaat("VOLBOX"), -1, 1, 1, 1);
	__LIB_6__::func_958(uParam0, joaat("P_HAYBALE03X"), 0f, 0f, 0f, "HAYBALE", 0, 0, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@beecher@abigail_4@base", 1, 1, 0, 0);
	iLocal_15 = __LIB_6__::func_959(uParam0, "script@vignette@beecher@abigail_4@action_a_left", 2, 0, 0, 1);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@beecher@abigail_4@action_a_right", 2, 0, 0, 1);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@beecher@abigail_4@action_b_left", 0, 0, 0, 1);
	iLocal_18 = __LIB_6__::func_959(uParam0, "script@vignette@beecher@abigail_4@action_b_right", 0, 0, 0, 1);
	__LIB_7__::func_146(uParam0, "BABI4AU");
	__LIB_7__::func_149(uParam0, joaat("COMP_BCABICNV4"), joaat("PLAYER_BCABICNV4"));
	__LIB_7__::func_151(uParam0, iLocal_14, 1, -1);
	Local_20 = { __LIB_7__::func_160(uParam0, 4.998f, -6.248f, 1.07f, 78.575f, 7f, 0.3103f, 0.6927f) };
	Local_30 = { __LIB_7__::func_160(uParam0, 4.9975f, -6.2475f, 1.07f, -36.72f, 7f, 0.2282f, 0.735f) };
