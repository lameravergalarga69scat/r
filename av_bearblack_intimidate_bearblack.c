...
{
	__LIB_2__::func_851(uParam0, 11170, 11259, 12125);
}

void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	__LIB_2__::func_853(uParam0, "BEARBLACK_INTIMIDATE_BEARBLACK", "script@ambient@animal@bearblack_intimidate_bearblack_backdown@action", vParam1, vParam4);
	uParam0->f_16 = 1;
	__LIB_2__::func_854(uParam0, 1, "pbl_action", "", 0);
	__LIB_2__::func_855(uParam0, 0, "bear_a", iLocal_9, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 0);
	__LIB_2__::func_855(uParam0, 1, "bear_b", iLocal_9, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 0);
	__LIB_2__::func_855(uParam0, 2, "carcass", joaat("A_C_DEER_01"), OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0f, 0f, 0f), (vParam4.z - 90f), 1, 0, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
}
...
int func_30(var uParam0)
{
	...
	__LIB_2__::func_906(&uLocal_10, 75);
	return 1;
}
...
int func_31(var uParam0)
{
	...
	if (!uParam0->f_469[0])
	{
		if (!bLocal_44 == 1)
		{
			if (__LIB_2__::func_908(uParam0, &uLocal_10, 1) || __LIB_1__::func_992(Global_35, uParam0->f_483, 1) <= 400f)
			{
				bLocal_44 = true;
			}
		}
	...
	if (uParam0->f_469[0])
	{
		if (__LIB_1__::func_285(&uLocal_41, 3f))
		{
			return 1;
		}
	}
					...
					if (ANIMSCENE::_IS_ANIM_SCENE_LOADED(uParam0->f_3.f_1, true, false))
					{
						if (ANIMSCENE::_0x1F0E401031E20146(uParam0->f_3.f_1, "pbl_action"))
						{
							if (!uParam0->f_469[3])
							{
								...
								{
									TASK::_TASK_START_SCENARIO_IN_PLACE(uParam0->f_20[0 /*14*/], joaat("WORLD_ANIMAL_BEARBLACK_EAT_CARCASS"), 35000, false, 0, -1f, false);
							...
							if (!uParam0->f_469[4])
							{
								...
								{
									TASK::_TASK_SMART_FLEE_STYLE_PED(uParam0->f_20[1 /*14*/], uParam0->f_20[0 /*14*/], 3, 256, -1082130432 /* Float: -1f */, -1, 0);
