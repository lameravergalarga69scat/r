...
bool func_72(var uParam0)
{
	...
	{
		case 6:
			__LIB_7__::func_45(uParam0, 20, 0, 0, 0);
			break;
		default:
			return false;
	}
	iLocal_14 = __LIB_7__::func_48(uParam0, 6, "MicahBell");
	iLocal_15 = __LIB_7__::func_48(uParam0, 24, "CLEET");
	iLocal_16 = __LIB_7__::func_48(uParam0, 25, "JOE");
	__LIB_7__::func_47(uParam0, -0.15f, -0.25f, 1f, 0f, 4f, 3f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_MICAH"), 1, 1, 1);
	iLocal_17 = __LIB_7__::func_142(uParam0, joaat("P_CHAIRFOLDING02X"), -0.171797f, -1.1855f, 0.00361633f, 0, 1, 0, 1);
	iLocal_18 = __LIB_7__::func_142(uParam0, joaat("P_STOOLFOLDING01X"), 1.37471f, -0.0501516f, -0.011795f, 0, 1, 0, 1);
	__LIB_7__::func_142(uParam0, joaat("P_CIGARETTE_CS02X"), 0f, 0f, 0f, "p_cigarette_cs02x", 0, 0, 1);
	__LIB_7__::func_142(uParam0, joaat("P_CIGARETTE_CS02X"), 0f, 0f, 0f, "p_cigarette_cs02x^1", 0, 0, 1);
	iLocal_20 = __LIB_7__::func_142(uParam0, joaat("P_BOTTLEJD01X"), 0f, 0f, 0f, "p_bottleJD01x", 0, 0, 1);
	iLocal_19 = __LIB_7__::func_142(uParam0, joaat("P_BOTTLEJD01X"), 0f, 0f, 0f, "p_bottleJD01x^1", 0, 0, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@micah_27@base", 1, 1, 0, 0);
	iLocal_21 = __LIB_6__::func_959(uParam0, "script@vignette@micah_27@Action_A", 2, 0, 1, 0);
	iLocal_22 = __LIB_6__::func_959(uParam0, "script@vignette@micah_27@Action_B", 0, 0, 0, 1);
	__LIB_7__::func_146(uParam0, "CCM27AU");
	__LIB_7__::func_127(uParam0, iLocal_14, 3, joaat("PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS"), "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_MALE_D", iLocal_17, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_139(uParam0, iLocal_14, iLocal_20, "p_bottleJD01x_ph_r_hand", 0, 0);
	__LIB_7__::func_151(uParam0, iLocal_14, 1, -1);
	__LIB_7__::func_277(uParam0, iLocal_14, "GREET_MICAH_MCHCNV27", 60000, 1);
	__LIB_7__::func_127(uParam0, iLocal_15, 2, joaat("GENERIC_SEAT_CHAIR_TABLE_SCENARIO"), "GENERIC_SEAT_CHAIR_TABLE_SCENARIO_LF_FWD_MALE_A", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_127(uParam0, iLocal_16, 3, joaat("PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS"), "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_MALE_D", iLocal_18, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_139(uParam0, iLocal_16, iLocal_19, "p_bottleJD01x_ph_r_hand", 0, 0);
	__LIB_7__::func_149(uParam0, joaat("COMP_MCHCNV27"), joaat("PLAYER_MCHCNV27"));
	Local_23 = { __LIB_7__::func_160(uParam0, 0f, -1.51f, 1f, -5.76f, 9f, 0.7f, 0.7f) };
...
{
	return __LIB_7__::func_163(uParam0, Local_23, 1, 0);
}
	...
	switch (Global_1360165[iParam0 /*1157*/].f_11)
	{
		...
		case 3:
			if (!ENTITY::IS_ENTITY_DEAD(Global_1360165[iParam0 /*1157*/]) && !ANIMSCENE::_0x3AB6C7B0BB0DF4B1(Global_1360165[iParam0 /*1157*/], -1))
			{
				...
				func_425(Global_1360165[iParam0 /*1157*/], vVar0, iParam6, 2, 1073741824 /* Float: 2f */);
			}
			else if (bParam16)
			{
	...
	switch (Global_1360165[iParam0 /*1157*/].f_70.f_12)
	{
		...
		case 3:
			...
			if ((bParam2 && !__LIB_0__::func_86(vVar0)) && !__LIB_0__::func_175(vVar0, ENTITY::GET_ENTITY_COORDS(Global_1360165[iParam0 /*1157*/].f_124, true, false), 1056964608 /* Float: 0.5f */, 1))
			{
				...
				func_425(Global_1360165[iParam0 /*1157*/].f_124, vVar0, iParam6, 2, 1073741824 /* Float: 2f */);
			}
			if (bParam1)
			{
	...
	switch (Global_1360165[iParam0 /*1157*/].f_3)
	{
		...
		case 1:
			...
			if (iParam4 == 0)
			{
				...
				else if ((Global_1360165[iParam0 /*1157*/].f_4.f_2 != 0 && Global_1360165[iParam0 /*1157*/].f_4.f_2 == Global_40.f_4942[iParam0 /*60*/].f_59) && (func_453(Global_1360165[iParam0 /*1157*/].f_4.f_2) || __LIB_1__::func_44(Global_1360165[iParam0 /*1157*/].f_4.f_2)))
				{
