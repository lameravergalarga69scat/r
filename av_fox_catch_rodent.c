...
{
	__LIB_2__::func_851(uParam0, 10772, 10830, 11503);
}

void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	__LIB_2__::func_853(uParam0, "FOX_CATCH_RODENT", "script@ambient@animal@fox_catch_rodent@action", vParam1, vParam4);
	uParam0->f_16 = 1;
...
int func_31(var uParam0)
{
	...
	if (!uParam0->f_469[0])
	{
		if ((__LIB_2__::func_908(uParam0, &uLocal_10, 1) || __LIB_0__::func_232(uParam0->f_20[0 /*14*/], Global_35, 1) <= 400f) || ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
		{
