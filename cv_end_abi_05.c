...
bool func_72(var uParam0)
{
	...
	{
		case 8:
			__LIB_7__::func_45(uParam0, 37, 0, 0, 0);
			__LIB_7__::func_116(uParam0, -1584.307f, -1431.238f, 80.333f, 0f, -2f, -64.54f);
			break;
		default:
			return false;
	}
	...
	__LIB_7__::func_47(uParam0, -3.1201f, 0.72f, 1.1079f, -6.33f, 2.5f, 2.5f, 2.5f, joaat("VOLCYLINDER"), -1, 1, 1, 1);
	__LIB_6__::func_958(uParam0, joaat("P_BRUSHHORSE02X"), 0f, 0f, 0f, "BRUSH", 0, 0, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@beecher@abigail_5@base", 1, 1, 0, 0);
	__LIB_6__::func_959(uParam0, "script@vignette@beecher@abigail_5@action", 0, 0, 1, 1);
	__LIB_7__::func_146(uParam0, "BABI5AU");
	__LIB_7__::func_149(uParam0, joaat("COMP_BCABICNV5"), joaat("PLAYER_BCABICNV5"));
	__LIB_7__::func_151(uParam0, iLocal_14, 1, -1);
	iLocal_15 = __LIB_7__::func_156(uParam0, -2.19f, 3.84f, 0f, 0f, 0f, -32.72f, 8f, 8f, 5f, "volTrigger", joaat("VOLBOX"));
...
{
	return __LIB_7__::func_358(uParam0, &iLocal_15, 1);
}
