...
{
	__LIB_2__::func_851(uParam0, 10822, 10954, 11513);
}
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	int iVar0;
	uParam0->f_16 = 1;
	__LIB_2__::func_853(uParam0, "DROP_RABBIT_TABLE", "script@ambient@campfireGeneral@Drop_Rabbit_Table@Action", vParam1, vParam4);
	__LIB_2__::func_854(uParam0, 2, "Pl_Drop_Exit_Back", "PL_DROP_ADDRESS_EXIT", 0);
	...
	__LIB_2__::func_855(uParam0, 1, "RABBIT", joaat("A_C_RABBIT_01"), 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
}
...
int func_31(var uParam0)
{
	...
	if (!uParam0->f_469[0])
	{
		...
		{
			if (__LIB_2__::func_904(uParam0->f_20[0 /*14*/], 0, &uLocal_9, &uVar0, 0, 0))
			{
	...
	if (!uParam0->f_469[1])
	{
		if (__LIB_2__::func_892(uParam0, 1065353216 /* Float: 1f */, 90f, 4, 1109393408 /* Float: 40f */, 1112014848 /* Float: 50f */))
		{
			__LIB_2__::func_948(uParam0);
			if (func_69())
			{
	...
	if (uParam0->f_469[1])
	{
		if (!uParam0->f_469[2])
		{
			if (__LIB_2__::func_889(uParam0, 1.2f, 1116471296 /* Float: 70f */, 4, joaat("ACTION"), 1))
			{
				__LIB_2__::func_890(*uParam0, uParam0->f_483, 1);
				uParam0->f_469[2] = 1;
			}
...
{
	int iVar0;
	iVar0 = __LIB_1__::func_334(__LIB_2__::func_947(__LIB_0__::func_12()));
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		if (__LIB_1__::func_205(iVar0, iLocal_37, 1, 0))
		{
			return true;
		}
	}
