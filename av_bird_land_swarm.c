...
{
	__LIB_2__::func_851(uParam0, 11364, 11422, 11942);
}

void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	__LIB_2__::func_853(uParam0, "BIRD_LAND_SWARM", "", vParam1, vParam4);
	switch (*uParam0)
	{
		case 114:
			if (uParam0->f_489 == 1)
	...
	__LIB_2__::func_902(uParam0, 0, "BLS_BIRD_1", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0f, 0f, 12f), (0f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	__LIB_2__::func_902(uParam0, 1, "BLS_BIRD_2", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, -1f, 1f, 12f), (135f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	__LIB_2__::func_902(uParam0, 2, "BLS_BIRD_3", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 1f, 1f, 12f), (-45f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	__LIB_2__::func_902(uParam0, 3, "BLS_BIRD_4", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 1f, 0f, 12f), (45f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	__LIB_2__::func_902(uParam0, 4, "BLS_BIRD_5", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, -2f, 0f, 12f), (-100f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	__LIB_2__::func_902(uParam0, 5, "BLS_BIRD_6", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, -1.75f, -1f, 12f), (-135f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	__LIB_2__::func_902(uParam0, 6, "BLS_BIRD_7", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, -1f, -0.25f, 12f), (-145f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	__LIB_2__::func_902(uParam0, 7, "BLS_BIRD_8", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 1f, -1f, 12f), (-15f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	__LIB_2__::func_902(uParam0, 8, "BLS_BIRD_9", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 1f, -0.5f, 15f), (-45f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	__LIB_2__::func_902(uParam0, 9, "BLS_BIRD_10", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0f, -0.75f, 15f), (50f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	__LIB_2__::func_902(uParam0, 10, "BLS_BIRD_11", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0f, 0.5f, 15f), (0f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	__LIB_2__::func_902(uParam0, 11, "BLS_BIRD_12", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, -1.5f, 1f, 15f), (35f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
}
...
int func_31(var uParam0)
{
	...
	if (uParam0->f_489 != 1)
	{
		if (!uParam0->f_469[1])
		{
			if (__LIB_2__::func_908(uParam0, &uLocal_11, 0) || __LIB_1__::func_992(Global_35, uParam0->f_483, 1) < 4f)
			{
				__LIB_2__::func_925(uParam0);
				uParam0->f_469[1] = 1;
			}
	...
	switch (iLocal_10)
	{
		case 0:
			...
			{
				__LIB_2__::func_857(&(uParam0->f_20[iLocal_42 /*14*/]), 1, 1);
				if (uParam0->f_489 != 1)
				{
			...
			if (__LIB_2__::func_892(uParam0, uParam0->f_493, uParam0->f_494, 4, uParam0->f_495, 1112014848 /* Float: 50f */))
			{
				...
				while (iVar2 <= 11)
				{
					if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[iVar2 /*14*/]))
					{
						...
						__LIB_0__::func_634(&(uParam0->f_20[iVar2 /*14*/].f_5), 50, 10, 0);
		...
		case 3:
			...
			else if (__LIB_1__::func_285(&uLocal_39, 25f))
			{
				return 1;
			}
			break;
