...
bool func_72(var uParam0)
{
	...
	{
		case 1:
			__LIB_7__::func_45(uParam0, 155, 0, 0, 0);
			iLocal_42 = joaat("P_CHAIR_BARREL04B");
			break;
		case 2:
			__LIB_7__::func_45(uParam0, 86, 0, 0, 0);
			iLocal_42 = joaat("P_CHAIR_CRATE15X");
			break;
		case 3:
			__LIB_7__::func_45(uParam0, 214, 0, 0, 0);
			iLocal_42 = joaat("P_CHAIR_CRATE15X");
			break;
		default:
			return false;
	...
	iLocal_19 = __LIB_7__::func_48(uParam0, 3, 0);
	__LIB_7__::func_47(uParam0, -9.1875f, 4f, 0f, 18.5f, 1.8875f, 1.0825f, 4f, joaat("VOLBOX"), joaat("APMS_COMP_JAVIER"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, 0f, 0f, 0f, 0f, 1.2f, 1.2f, 4f, joaat("VOLBOX"), joaat("APMS_COMP_BILL"), 1, 1, 1);
	__LIB_7__::func_159(uParam0, 0.382276f, 0.59386f, 1.00287f, 0f, 1.1f, 1.1f, 4f, joaat("VOLCYLINDER"), 1);
	iLocal_20 = __LIB_7__::func_142(uParam0, iLocal_42, 0f, 0f, 0f, 0, 1, 0, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@javier_1@base", 1, 1, 0, 0);
	iLocal_14 = __LIB_6__::func_959(uParam0, "script@vignette@javier_1@action_a", 2, 0, 1, 0);
	iLocal_15 = __LIB_6__::func_959(uParam0, "script@vignette@javier_1@action_b", 0, 0, 0, 0);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@javier_1@action_b_alt_front", 2, 0, 0, 1);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@javier_1@action_b_alt_left", 2, 0, 0, 1);
	iLocal_18 = __LIB_6__::func_959(uParam0, "script@vignette@javier_1@action_c_alt", 0, 0, 0, 1);
	__LIB_7__::func_146(uParam0, "CJA1AUD");
	__LIB_7__::func_107(uParam0, iLocal_19, 3, joaat("PROP_HUMAN_CAMP_FIRE_SEAT_BOX"), "PROP_HUMAN_CAMP_FIRE_SEAT_BOX_MALE_A", iLocal_20, 0);
	__LIB_7__::func_127(uParam0, iLocal_19, 3, joaat("PROP_HUMAN_CAMP_FIRE_SEAT_BOX"), "PROP_HUMAN_CAMP_FIRE_SEAT_BOX_MALE_A", iLocal_20, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	Local_21 = { __LIB_7__::func_160(uParam0, 0.215f, -0.26f, 0.988f, 0.88f, 6.5f, 0.625f, 0.375f) };
	Local_31 = { __LIB_7__::func_160(uParam0, 0.215f, -0.26f, 0.988f, 95f, 6.5f, 0.2575f, 0.42f) };
	return true;
}
...
bool func_93(var uParam0)
{
	if (__LIB_7__::func_148(uParam0, iLocal_14))
	{
		...
		else
		{
			...
			__LIB_7__::func_147(uParam0, iLocal_19, 2, 5, 0, 0, 0);
		}
	}
	if (__LIB_7__::func_148(uParam0, iLocal_16) || __LIB_7__::func_148(uParam0, iLocal_17))
	{
