...
bool func_72(var uParam0)
{
	...
	{
		case 2:
			__LIB_7__::func_45(uParam0, 72, 0, 0, 0);
			break;
		case 6:
			__LIB_7__::func_45(uParam0, 8, 0, 0, 0);
			break;
		default:
			return false;
	}
	...
	__LIB_7__::func_159(uParam0, 1.3f, 0.8f, 0.4f, -12f, 3.75f, 2.5f, 2f, joaat("VOLBOX"), 1);
	__LIB_7__::func_47(uParam0, -0.95f, -1.85f, 0f, 0f, 3.8f, 7f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_ABIGAIL"), 1, 1, 1);
	iLocal_16 = __LIB_6__::func_958(uParam0, joaat("P_CHAIRFOLDING02X"), 0f, 0f, 0f, "CHAIR", 0, 0, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@abigail_7@base_intro", 1, 1, 0, 0);
	iLocal_20 = __LIB_6__::func_959(uParam0, "script@vignette@abigail_7@trans_from", 2, 0, 1, 0);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@abigail_7@action_a", 2, 0, 0, 0);
	iLocal_18 = __LIB_6__::func_959(uParam0, "script@vignette@abigail_7@action_b", 2, 0, 0, 0);
	iLocal_19 = __LIB_6__::func_959(uParam0, "script@vignette@abigail_7@action_b_alt", 2, 0, 0, 1);
	iLocal_21 = __LIB_6__::func_959(uParam0, "script@vignette@abigail_7@abigail_trans_to", 0, 0, 0, 0);
	__LIB_7__::func_147(uParam0, iLocal_14, 1, 6, 0, 0, 0);
	__LIB_7__::func_147(uParam0, iLocal_15, 1, 4, 0, 0, 0);
	__LIB_7__::func_107(uParam0, iLocal_14, 3, joaat("PROP_HUMAN_SEAT_BENCH"), "PROP_HUMAN_SEAT_BENCH_FEMALE_A", iLocal_16, 0);
	__LIB_7__::func_127(uParam0, iLocal_14, 2, joaat("PROP_HUMAN_SEAT_BENCH"), "PROP_HUMAN_SEAT_BENCH_FEMALE_A", iLocal_16, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_107(uParam0, iLocal_15, 2, joaat("PROP_HUMAN_SLEEP_BED_PILLOW"), "PROP_HUMAN_SLEEP_BED_PILLOW_MALE_B", -1, 0);
	__LIB_7__::func_146(uParam0, "CABI7AU");
	__LIB_7__::func_145(uParam0, 15f, 20f);
	Local_22 = { __LIB_7__::func_160(uParam0, 1f, -1.2f, 0.84f, -11f, 6f, 0.2f, 0.2f) };
	return true;
}
...
{
	return __LIB_0__::func_195(631.607f, -1249.651f, 40.66633f, 694.4416f, -1262.602f, 43.64066f, Global_36);
}
...
bool func_93(var uParam0)
{
	...
	{
		PED::_0xF60165E1D2C5370B(Global_35, &fVar0, &fVar1);
		if (__LIB_7__::func_163(uParam0, Local_22, 1, 0) && (fVar0 < 0.8f && fVar1 < 0.8f))
		{
			__LIB_7__::func_154(uParam0, iLocal_19, 1);
			__LIB_7__::func_149(uParam0, joaat("COMP_ABICNV7"), joaat("PLAYER_ABICNV7"));
