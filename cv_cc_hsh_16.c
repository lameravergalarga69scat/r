...
bool func_72(var uParam0)
{
	...
	__LIB_7__::func_47(uParam0, -0.2233f, -1.6019f, 1.2509f, 0f, 1.5f, 1.5f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_HOSEA"), 1, 1, 1);
	...
	__LIB_6__::func_959(uParam0, "script@vignette@hosea_16@base", 1, 1, 0, 0);
	iLocal_15 = __LIB_6__::func_959(uParam0, "script@vignette@hosea_16@action_a", 2, 0, 1, 1);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@hosea_16@wait_idle", 1, 0, 0, 0);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@hosea_16@wait_idle_to_base", 2, 0, 0, 0);
	iLocal_18 = __LIB_6__::func_959(uParam0, "script@vignette@hosea_16@action_b", 2, 0, 0, 1);
	iLocal_19 = __LIB_6__::func_959(uParam0, "script@vignette@hosea_16@exit", 0, 0, 0, 0);
	__LIB_7__::func_146(uParam0, "CH16AUD");
	__LIB_7__::func_151(uParam0, iLocal_14, 2, -1);
	Local_20 = { __LIB_7__::func_160(uParam0, -0.2675f, -1.8369f, 1.1388f, -9.72f, 6.5f, 0.9377f, 0.7505f) };
...
bool func_93(var uParam0)
{
	...
	{
		if (__LIB_0__::func_264(&uLocal_30) >= 5f)
		{
