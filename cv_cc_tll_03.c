...
bool func_72(var uParam0)
{
	...
	__LIB_7__::func_47(uParam0, 0.475f, -0.795f, 0.85f, -35.5f, 3.475f, 2.56f, 3.2075f, joaat("VOLBOX"), -1, 1, 1, 1);
	__LIB_7__::func_159(uParam0, 0.9f, -1.1f, 0f, 0f, 0.75f, 0.75f, 3f, joaat("VOLCYLINDER"), 1);
	iLocal_23 = __LIB_6__::func_958(uParam0, joaat("P_CS_LEDGERSMALL01X"), 0f, 0f, 0f, "BOOK", 0, 0, 1);
	iLocal_22 = __LIB_6__::func_958(uParam0, joaat("P_CIGARETTE01X"), 0f, 0f, 0f, "CIGARETTE", 0, 0, 1);
	__LIB_6__::func_958(uParam0, joaat("P_MUGCOFFEE01X"), 0f, 0f, 0f, "MUG", 0, 1, 1);
	iLocal_25 = __LIB_6__::func_958(uParam0, joaat("P_CHAIR_CRATE02X"), 1.67959f, -0.624872f, 0.00317383f, 0, 1, 0, 1);
	iLocal_24 = __LIB_6__::func_958(uParam0, joaat("P_CHAIR_CRATE15X"), 0f, 0f, 0f, 0, 1, 0, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@tilly_3@base", 1, 1, 0, 0);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@tilly_3@Action_A", 2, 0, 1, 0);
	iLocal_18 = __LIB_6__::func_959(uParam0, "script@vignette@tilly_3@Action_A_Int_Front", 2, 0, 0, 1);
	iLocal_19 = __LIB_6__::func_959(uParam0, "script@vignette@tilly_3@Action_A_Int_Left", 2, 0, 0, 1);
	iLocal_20 = __LIB_6__::func_959(uParam0, "script@vignette@tilly_3@Action_A_Int_Right", 2, 0, 0, 1);
	iLocal_21 = __LIB_6__::func_959(uParam0, "script@vignette@tilly_3@Action_B", 0, 0, 0, 0);
	__LIB_7__::func_146(uParam0, "CCTL3AU");
	__LIB_7__::func_127(uParam0, iLocal_14, 3, joaat("PROP_HUMAN_SEAT_CHAIR"), "PROP_HUMAN_SEAT_CHAIR_GENERIC_FEMALE_C", iLocal_25, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_107(uParam0, iLocal_16, 3, joaat("PROP_HUMAN_SEAT_CHAIR_SMOKING"), "PROP_HUMAN_SEAT_CHAIR_SMOKING_FEMALE_A", iLocal_24, 0);
	__LIB_7__::func_127(uParam0, iLocal_16, 3, joaat("PROP_HUMAN_SEAT_CHAIR_SMOKING"), "PROP_HUMAN_SEAT_CHAIR_SMOKING_FEMALE_A", iLocal_24, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_139(uParam0, iLocal_16, iLocal_22, "p_cigarette_cs01x_PH_R_HAND", 0, 0);
	__LIB_7__::func_107(uParam0, iLocal_15, 3, joaat("WORLD_HUMAN_SIT_GROUND_READING_JOURNAL"), "WORLD_HUMAN_SIT_GROUND_READING_JOURNAL_FEMALE_A", -1, 1);
	__LIB_7__::func_127(uParam0, iLocal_15, 2, joaat("WORLD_HUMAN_SIT_GROUND_READING_JOURNAL"), "WORLD_HUMAN_SIT_GROUND_READING_JOURNAL_FEMALE_A", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_139(uParam0, iLocal_15, iLocal_23, "p_cs_ledgerSmall01x_PH_L_HAND", 0, 0);
	Local_26 = { __LIB_7__::func_160(uParam0, 1.551f, -0.518f, 1.223f, 109.8f, 6f, 0.025f, 0.715f) };
	Local_36 = { __LIB_7__::func_160(uParam0, 1.5505f, -0.518f, 1.223f, -180f, 6f, 0.0075f, 0.7575f) };
	Local_46 = { __LIB_7__::func_160(uParam0, 1.551f, -0.518f, 1.2229f, 45f, 6f, 0f, 0.7475f) };
	return true;
}
