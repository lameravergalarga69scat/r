...
bool func_72(var uParam0)
{
	...
	__LIB_7__::func_47(uParam0, 0.1503f, -0.2019f, 0.9451f, 0f, 1.5f, 1.5f, 2f, joaat("VOLCYLINDER"), joaat("APMS_COMP_KIERAN"), 1, 1, 1);
	iLocal_21 = __LIB_6__::func_958(uParam0, joaat("P_CS_ROPE03BX"), 0f, 0f, 0f, "ROPE", 0, 1, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@kieran_8@base", 1, 1, 0, 0);
	iLocal_15 = __LIB_6__::func_959(uParam0, "script@vignette@kieran_8@wait", 1, 0, 0, 0);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@kieran_8@wait", 1, 0, 0, 0);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@kieran_8@action_a", 2, 0, 1, 1);
	iLocal_18 = __LIB_6__::func_959(uParam0, "script@vignette@kieran_8@action_b", 2, 0, 0, 1);
	iLocal_19 = __LIB_6__::func_959(uParam0, "script@vignette@kieran_8@action_c", 2, 0, 0, 1);
	iLocal_20 = __LIB_6__::func_959(uParam0, "script@vignette@kieran_8@action_d", 0, 0, 0, 0);
	__LIB_7__::func_146(uParam0, "CKIE8AU");
	Local_22 = { __LIB_7__::func_160(uParam0, 0.165f, -0.113f, 0.979f, -156.5f, 8f, 0.7f, 0.7f) };
...
{
	return __LIB_7__::func_163(uParam0, Local_22, 1, 0);
}
...
bool func_93(var uParam0)
{
	if (__LIB_7__::func_148(uParam0, iLocal_17))
	{
		...
		{
			__LIB_0__::func_268(&uLocal_32, 0f);
			__LIB_7__::func_173(uParam0, iLocal_15, 1);
		}
	}
	if (__LIB_7__::func_169(uParam0, iLocal_15))
	{
		if (__LIB_0__::func_264(&uLocal_32) > 6f)
		{
	...
	if (!bLocal_35)
	{
		if (__LIB_7__::func_74(uParam0, iLocal_14))
		{
			...
			__LIB_7__::func_305(uParam0, iLocal_21);
			bLocal_35 = true;
		}
	}
	if (bLocal_35)
