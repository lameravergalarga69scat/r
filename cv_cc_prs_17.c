...
bool func_72(var uParam0)
{
	...
	{
		case 6:
			__LIB_7__::func_116(uParam0, 2354.913f, 1342.611f, 104.554f, -1.499f, 4.26f, -135.542f);
			break;
		default:
			return false;
	}
	iLocal_14 = __LIB_7__::func_48(uParam0, 17, 0);
	__LIB_7__::func_47(uParam0, -21.2825f, 2.0475f, 0.825f, 0f, 1.5f, 1.5f, 3.2075f, joaat("VOLBOX"), joaat("APMS_COMP_PEARSON"), 1, 1, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@pearson_17@base", 1, 1, 0, 0);
	__LIB_6__::func_959(uParam0, "script@vignette@pearson_17@Action", 0, 0, 1, 1);
	__LIB_7__::func_146(uParam0, "CPS17AU");
	__LIB_7__::func_149(uParam0, joaat("COMP_PRSCNV17"), joaat("PLAYER_PRSCNV17"));
	__LIB_7__::func_303(uParam0, iLocal_14, 3, joaat("PROP_HUMAN_SEAT_BENCH_TIRED"), 0, -1, 0);
	__LIB_7__::func_153(uParam0, iLocal_14, 3, joaat("PROP_HUMAN_SEAT_BENCH_TIRED"), 0, -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_147(uParam0, iLocal_14, 1, 4, 0, 0, 0);
	__LIB_7__::func_151(uParam0, iLocal_14, 1, -1);
	Local_15 = { __LIB_7__::func_160(uParam0, -21.3805f, 2.265f, 1.8965f, -13.5f, 6.6675f, 1f, 1f) };
...
int func_329(int iParam0, bool bParam1)
{
	...
	if (!func_365(iParam0) && __LIB_0__::func_2() == -1)
	{
		return 0;
	}
