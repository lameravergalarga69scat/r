...
bool func_72(var uParam0)
{
	switch (__LIB_0__::func_78(uParam0))
	{
		...
		case 3:
			...
			break;
		case 6:
			__LIB_7__::func_116(uParam0, 2354.204f, 1347.875f, 104.8036f, 0f, 0f, -119.51f);
			break;
		default:
			return false;
	}
	...
	__LIB_7__::func_47(uParam0, 1.4424f, -0.6369f, 0.6758f, 0f, 1.1f, 1.1f, 2f, joaat("VOLBOX"), joaat("APMS_COMP_GRIMSHAW"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, -0.053f, -0.2284f, 0.5413f, 0f, 1.1f, 1.1f, 2f, joaat("VOLBOX"), joaat("APMS_COMP_MARYBETH"), 1, 1, 1);
	__LIB_7__::func_159(uParam0, 0.759933f, -0.612731f, 1.00159f, 0f, 1.1f, 1.1f, 2f, joaat("VOLCYLINDER"), 1);
	iLocal_19 = __LIB_6__::func_958(uParam0, joaat("P_BOWL04X_STEW"), 0f, 0f, 0f, "BOWL0", 0, 1, 1);
	iLocal_17 = __LIB_6__::func_958(uParam0, joaat("P_BOWL04X_STEW"), 0f, 0f, 0f, "BOWL1", 0, 0, 1);
	...
	iLocal_16 = __LIB_6__::func_958(uParam0, joaat("P_CHAIR_CRATE15X"), 0f, 0f, 0f, 0, 1, 0, 1);
	__LIB_7__::func_107(uParam0, iLocal_14, 3, joaat("PROP_CAMP_SEAT_CHAIR_STEW"), "PROP_CAMP_SEAT_CHAIR_STEW_EATING_FEMALE_B", iLocal_16, 0);
	__LIB_7__::func_127(uParam0, iLocal_14, 3, joaat("PROP_CAMP_FIRE_SEATED"), "PROP_CAMP_FIRE_SEATED_FEMALE_A", iLocal_16, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_147(uParam0, iLocal_14, 1, 2, 0, 0, 0);
	...
	__LIB_7__::func_139(uParam0, iLocal_15, iLocal_19, "p_bowl04x_stew_PH_L_HAND", 0, 0);
	__LIB_7__::func_139(uParam0, iLocal_15, iLocal_20, "p_spoon01x_XH_L_HAND00", 0, 0);
	__LIB_7__::func_147(uParam0, iLocal_15, 1, 2, 0, 0, 0);
	__LIB_7__::func_144(uParam0, iLocal_15, 1.3f, 1065353216 /* Float: 1f */, 1092616192 /* Float: 10f */);
	__LIB_6__::func_959(uParam0, "script@vignette@marybeth_12@base", 1, 1, 0, 0);
	__LIB_6__::func_959(uParam0, "script@vignette@marybeth_12@Action", 0, 0, 1, 0);
	__LIB_7__::func_146(uParam0, "CMB12AU");
...
{
	ENTITY::FREEZE_ENTITY_POSITION(__LIB_7__::func_30(uParam0, iLocal_17), true);
	...
	switch (Global_1360165[iParam0 /*1157*/].f_3)
	{
		...
		case 1:
			...
			if (iParam4 == 0)
			{
				...
				else if ((Global_1360165[iParam0 /*1157*/].f_4.f_2 != 0 && Global_1360165[iParam0 /*1157*/].f_4.f_2 == Global_40.f_4942[iParam0 /*60*/].f_59) && (func_433(Global_1360165[iParam0 /*1157*/].f_4.f_2) || __LIB_1__::func_44(Global_1360165[iParam0 /*1157*/].f_4.f_2)))
				{
