...
bool func_72(var uParam0)
{
	...
	__LIB_7__::func_47(uParam0, -1.5459f, 1.3948f, 0f, 0f, 1f, 1f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_SEAN"), 1, 1, 1);
	iLocal_15 = __LIB_6__::func_958(uParam0, joaat("P_RAG02X"), 0f, 0f, 0f, "RAG", 0, 0, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@sean_2@base", 1, 1, 0, 0);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@sean_2@action_a_front", 2, 0, 1, 1);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@sean_2@action_a_left", 2, 0, 0, 1);
	iLocal_18 = __LIB_6__::func_959(uParam0, "script@vignette@sean_2@action_b_left", 0, 0, 0, 1);
	iLocal_19 = __LIB_6__::func_959(uParam0, "script@vignette@sean_2@action_b_front", 0, 0, 0, 1);
	__LIB_7__::func_146(uParam0, "CSEN2AU");
	__LIB_7__::func_149(uParam0, joaat("COMP_SENCNV2"), joaat("PLAYER_SENCNV2"));
	...
	__LIB_7__::func_139(uParam0, iLocal_14, iLocal_15, "p_cs_rag02x_PH_R_HAND", 0, 0);
	__LIB_7__::func_151(uParam0, iLocal_14, 1, -1);
	Local_21 = { __LIB_7__::func_160(uParam0, -1.5459f, 1.3948f, 0.9959f, 87.5f, 7f, 0.4f, 0.4f) };
	Local_31 = { __LIB_7__::func_160(uParam0, -1.5459f, 1.3948f, 0.9959f, 6.48f, 7f, 0.5f, 0.4f) };
