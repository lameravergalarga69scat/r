...
bool func_72(var uParam0)
{
	...
	__LIB_7__::func_47(uParam0, -1.245f, -6.2275f, 1.15f, -33.44f, 1.1f, 1f, 2.685f, joaat("VOLBOX"), joaat("APMS_COMP_GRIMSHAW"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, 0.875f, -1.25f, 1.15f, -38.44f, 3.51f, 4.1475f, 2.685f, joaat("VOLBOX"), joaat("APMS_COMP_MARYBETH"), 1, 1, 1);
	Local_23 = { __LIB_7__::func_160(uParam0, 0.8825f, -2.01f, 1.07f, 159f, 6.5f, 0.065f, 0.6375f) };
	Local_33 = { __LIB_7__::func_160(uParam0, 0.883f, -2.01f, 1.07f, -135.75f, 6.5f, 0.22f, 0.66f) };
	iLocal_22 = __LIB_6__::func_958(uParam0, joaat("P_CS_LEDGERSMALL01X"), 0f, 0f, 0f, "BOOK", 0, 0, 1);
	iLocal_21 = __LIB_6__::func_958(uParam0, joaat("P_CS_SOCK01X"), 0f, 0f, 0f, "SOCK", 0, 0, 1);
	iLocal_20 = __LIB_6__::func_958(uParam0, joaat("P_CHAIR_CRATE02X"), 0f, 0f, 0f, 0, 1, 0, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@marybeth_4@base", 1, 1, 0, 0);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@marybeth_4@action_a", 2, 0, 1, 0);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@marybeth_4@action_b", 0, 0, 0, 0);
	iLocal_18 = __LIB_6__::func_959(uParam0, "script@vignette@marybeth_4@action_b_alt_front", 0, 0, 0, 1);
	iLocal_19 = __LIB_6__::func_959(uParam0, "script@vignette@marybeth_4@action_b_alt_left", 0, 0, 0, 1);
	__LIB_7__::func_146(uParam0, "CCMB4AU");
	__LIB_7__::func_107(uParam0, iLocal_15, 3, joaat("WORLD_HUMAN_STAND_WAITING"), "WORLD_HUMAN_STAND_WAITING_FEMALE_A", -1, 1);
	__LIB_7__::func_151(uParam0, iLocal_15, 3, -1);
	__LIB_7__::func_107(uParam0, iLocal_14, 3, joaat("WORLD_HUMAN_SIT_GROUND_READING"), "WORLD_HUMAN_SIT_GROUND_READING_JOURNAL_FEMALE_A", -1, 1);
	__LIB_7__::func_127(uParam0, iLocal_14, 3, joaat("PROP_HUMAN_SEAT_CHAIR_SEWING"), "PROP_HUMAN_SEAT_CHAIR_SEWING_FEMALE_A", iLocal_20, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_139(uParam0, iLocal_14, iLocal_21, "p_cs_sock01x_PH_L_HAND", 0, 0);
	__LIB_7__::func_147(uParam0, iLocal_14, 1, 3, 0, 0, 0);
	__LIB_7__::func_151(uParam0, iLocal_14, 1, -1);
	__LIB_7__::func_149(uParam0, joaat("COMP_MRBCNV4"), joaat("PLAYER_MRBCNV4"));
	return true;
}
...
{
	ENTITY::FREEZE_ENTITY_POSITION(__LIB_7__::func_30(uParam0, iLocal_22), true);
	return true;
}
