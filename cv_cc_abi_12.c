...
bool func_72(var uParam0)
{
	...
	{
		case 1:
			__LIB_7__::func_45(uParam0, 110, 0, 0, 0);
			vLocal_17 = { -138.41f, -6.94f, 95.25f };
			fLocal_20 = -28.238f;
			break;
		case 2:
			__LIB_7__::func_116(uParam0, 690.4313f, -1259.154f, 43.645f, 0f, 0f, -128.67f);
	...
	iLocal_16 = __LIB_7__::func_165(uParam0, 1, 0, 1);
	__LIB_7__::func_47(uParam0, 0.0763f, -1.44f, 0.1559f, -176.4356f, 2.56f, 3.53f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_ABIGAIL"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, 4.4707f, -1.4952f, 0.8447f, -17.4529f, 2.8f, 1.96f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_JOHN"), 1, 1, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@abigail_12@base", 1, 1, 0, 0);
	__LIB_6__::func_959(uParam0, "script@vignette@abigail_12@action", 0, 0, 1, 0);
	__LIB_7__::func_146(uParam0, "CAB12AU");
	__LIB_7__::func_153(uParam0, iLocal_14, 1, joaat("WORLD_HUMAN_STAND_WAITING"), 0, -1, 0, 90f, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_147(uParam0, iLocal_14, 2, 1, 0, "Default_Angry", 0);
	__LIB_7__::func_151(uParam0, iLocal_14, 3, -1);
	__LIB_7__::func_144(uParam0, iLocal_14, 1.45f, 1065353216 /* Float: 1f */, 1092616192 /* Float: 10f */);
...
bool func_93(var uParam0)
{
	...
	{
		TASK::TASK_START_SCENARIO_AT_POSITION(__LIB_6__::func_952(uParam0, iLocal_16), joaat("WORLD_ANIMAL_HORSE_GRAZING_CAMP"), vLocal_17, fLocal_20, 15000, true, false, 0, -1f, false);
		PED::SET_PED_KEEP_TASK(__LIB_6__::func_952(uParam0, iLocal_16), true);
	}
	return true;
}
