...
bool func_72(var uParam0)
{
	...
	{
		case 3:
			__LIB_7__::func_45(uParam0, 192, 0, 0, 0);
			break;
		default:
			return false;
	}
	iLocal_14 = __LIB_7__::func_48(uParam0, 13, "AbigailRoberts");
	iLocal_15 = __LIB_7__::func_48(uParam0, 17, "MrPearson");
	__LIB_7__::func_47(uParam0, -5.2375f, -15.9001f, 2.56f, -5.76f, 6.48f, 8.135f, 3.885f, joaat("VOLBOX"), joaat("APMS_COMP_ABIGAIL"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, -0.55f, -2.7625f, 2.8f, -32.04f, 4.155f, 7.955f, 2.585f, joaat("VOLBOX"), joaat("APMS_COMP_PEARSON"), 1, 1, 1);
	iLocal_16 = __LIB_6__::func_958(uParam0, joaat("P_CIGARETTE_CS02X"), 0f, 0f, 0f, "p_cigarette_cs02x", 0, 1, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@abigail_20@base", 1, 1, 0, 0);
	__LIB_6__::func_959(uParam0, "script@vignette@abigail_20@action_a", 0, 0, 1, 0);
	__LIB_7__::func_146(uParam0, "CAB20AU");
	__LIB_7__::func_149(uParam0, joaat("COMP_ABICNV20"), joaat("PLAYER_ABICNV20"));
	__LIB_7__::func_107(uParam0, iLocal_14, 3, joaat("WORLD_HUMAN_STARE_STOIC"), "WORLD_HUMAN_STARE_STOIC_FEMALE_A", -1, 1);
	__LIB_7__::func_127(uParam0, iLocal_14, 3, joaat("WORLD_HUMAN_INSPECT"), "WORLD_HUMAN_INSPECT_FEMALE_D", -1, 0, 40f, 1065353216 /* Float: 1f */, 1);
	...
	__LIB_7__::func_127(uParam0, iLocal_15, 2, joaat("WORLD_HUMAN_SMOKE"), "WORLD_HUMAN_SMOKE_MALE_D", -1, 0, 20f, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_139(uParam0, iLocal_15, iLocal_16, "p_cigarette_cs01x_PH_R_HAND", 0, 0);
...
bool func_93(var uParam0)
{
	if (__LIB_6__::func_997(uParam0, iLocal_14))
	{
		...
		__LIB_0__::func_268(&uLocal_17, 0f);
	}
	if (__LIB_0__::func_75(&uLocal_17) && !ENTITY::IS_ENTITY_DEAD(__LIB_6__::func_952(uParam0, iLocal_14)))
	{
		PED::SET_PED_MIN_MOVE_BLEND_RATIO(__LIB_6__::func_952(uParam0, iLocal_14), 1.4f);
		if (__LIB_0__::func_264(&uLocal_17) > 5f)
		{
			__LIB_1__::func_774(uParam0->f_107[iLocal_14 /*113*/].f_1, 0, 0, 0, uParam0->f_107[iLocal_14 /*113*/].f_32.f_4, 1, 1, 0, 0, 0, 0);
		}
	}
	return true;
}
