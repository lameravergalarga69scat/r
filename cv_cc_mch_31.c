...
bool func_72(var uParam0)
{
	...
	{
		case 2:
			__LIB_7__::func_45(uParam0, 58, 0, 0, 0);
			break;
		default:
			return false;
	}
	...
	__LIB_7__::func_47(uParam0, -3.175f, 0.3875f, 0.8695f, 109.25f, 6f, 2.5f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_MICAH"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, 0.3708f, 1.3727f, 1.06f, 101.2207f, 1.5f, 1.5f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_HOSEA"), 1, 1, 1);
	iLocal_51 = __LIB_7__::func_159(uParam0, -2.8292f, -0.1273f, 1.06f, 120.24f, 2.5f, 1.5f, 3f, joaat("VOLCYLINDER"), 1);
	__LIB_6__::func_958(uParam0, joaat("P_CS_BOOK02X"), 0f, 0f, 0f, "BOOK", 0, 0, 1);
	__LIB_6__::func_958(uParam0, joaat("P_CIGARETTE_CS01X"), 0f, 0f, 0f, "CIGARETTE", 0, 0, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@micah_31@base", 1, 1, 0, 0);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@micah_31@action_a", 2, 0, 1, 0);
	iLocal_18 = __LIB_6__::func_959(uParam0, "script@vignette@micah_31@Action_A_Int_Front", 2, 0, 0, 1);
	iLocal_19 = __LIB_6__::func_959(uParam0, "script@vignette@micah_31@Action_A_Int_Right", 2, 0, 0, 1);
	iLocal_20 = __LIB_6__::func_959(uParam0, "script@vignette@micah_31@Action_A_Int_Back", 2, 0, 0, 1);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@micah_31@action_b", 0, 0, 0, 0);
	__LIB_7__::func_146(uParam0, "CCM31AU");
	__LIB_7__::func_107(uParam0, iLocal_14, 3, joaat("WORLD_HUMAN_SMOKE"), "WORLD_HUMAN_SMOKE_MALE_C", -1, 1);
	__LIB_7__::func_151(uParam0, iLocal_14, 3, -1);
	__LIB_7__::func_107(uParam0, iLocal_15, 3, joaat("WORLD_HUMAN_SIT_GROUND_READING"), "WORLD_HUMAN_SIT_GROUND_READING_BOOK_MALE_A", -1, 1);
	Local_21 = { __LIB_7__::func_160(uParam0, -2.908f, 2.195f, 1.07f, 158.75f, 6.5f, 0f, 0.5325f) };
	Local_31 = { __LIB_7__::func_160(uParam0, -2.9075f, 2.195f, 1.07f, 110.84f, 6.5f, 0f, 0.467f) };
	Local_41 = { __LIB_7__::func_160(uParam0, -2.908f, 2.195f, 1.07f, 49.5f, 6.5f, 0.22f, 0.5075f) };
	return true;
}
...
bool func_93(var uParam0)
{
	if (!bLocal_53)
	{
		if (__LIB_7__::func_40(uParam0, iLocal_16, 0.75f))
		{
			iLocal_52 = __LIB_7__::func_159(uParam0, -3.4692f, 1.9827f, 1.06f, 91.44f, 1.5f, 1.5f, 3f, joaat("VOLCYLINDER"), 1);
			__LIB_6__::func_985(uParam0, iLocal_52, 1);
			__LIB_6__::func_985(uParam0, iLocal_51, 0);
			bLocal_53 = true;
		}
	}
