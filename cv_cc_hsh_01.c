...
bool func_72(var uParam0)
{
	...
	{
		case 0:
			__LIB_7__::func_116(uParam0, -1347.485f, 2407.773f, 306.0743f, 0f, 0f, 162.8f);
			break;
		default:
			return false;
	}
	__LIB_7__::func_47(uParam0, -0.5962f, 0.1022f, 1.0076f, 84.6f, 1f, 1f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_HOSEA"), 1, 1, 1);
	iLocal_14 = __LIB_7__::func_48(uParam0, 5, 0);
	__LIB_6__::func_959(uParam0, "script@vignette@hosea_1@base", 1, 1, 0, 0);
	iLocal_15 = __LIB_6__::func_959(uParam0, "script@vignette@hosea_1@action_a", 2, 0, 1, 1);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@hosea_1@action_b", 0, 0, 0, 1);
	__LIB_7__::func_146(uParam0, "CCHSAUD");
	Local_17 = { __LIB_7__::func_160(uParam0, -0.4469f, -0.1258f, 1.1107f, 150.84f, 7f, 0.6f, 0.6f) };
	Local_27 = { __LIB_7__::func_160(uParam0, -0.4469f, -0.1258f, 1.1107f, 166.32f, 10f, 0.8f, 0.8f) };
	__LIB_7__::func_107(uParam0, iLocal_14, 3, joaat("WORLD_HUMAN_LEAN_BACK_WALL"), "WORLD_HUMAN_LEAN_BACK_WALL_MALE_D", -1, 1);
