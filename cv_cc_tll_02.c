...
bool func_72(var uParam0)
{
	switch (__LIB_0__::func_78(uParam0))
	{
		case 1:
			...
			__LIB_7__::func_45(uParam0, 145, 0, 0, 0);
			break;
		case 2:
			vLocal_56 = { 678.39f, -1265.06f, 42.98f };
			__LIB_7__::func_45(uParam0, 78, 0, 0, 0);
			break;
		case 3:
			vLocal_56 = { 1882.42f, -1882.1f, 41.81f };
			__LIB_7__::func_45(uParam0, 201, 0, 0, 0);
			break;
		default:
			return false;
	}
	...
	__LIB_7__::func_47(uParam0, -3.675f, 0.855f, 0.85f, -51.5f, 1.2975f, 1.285f, 3.2075f, joaat("VOLBOX"), joaat("APMS_COMP_TILLY"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, 2.15f, -0.75f, 0.85f, -50.5f, 3.2175f, 1.8725f, 3.2075f, joaat("VOLBOX"), joaat("APMS_COMP_MARYBETH"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, -0.425f, -0.8875f, 0.85f, -27.25f, 1.2175f, 2.805f, 3.2075f, joaat("VOLBOX"), -1, 1, 1, 1);
	__LIB_7__::func_159(uParam0, 0.45f, -0.6f, 0f, 0f, 1.15f, 1.18f, 3f, joaat("VOLCYLINDER"), 1);
	iLocal_24 = __LIB_7__::func_142(uParam0, joaat("P_CHAIR_CRATE15X"), -0.938435f, -1.52674f, -0.00881958f, 0, 1, 0, 1);
	iLocal_23 = __LIB_7__::func_142(uParam0, joaat("P_CS_BOOK04X"), 0f, 0f, 0f, "BOOK", 0, 0, 1);
	iLocal_21 = __LIB_7__::func_142(uParam0, joaat("P_CS_RAG02X"), 0f, 0f, 0f, "RAG", 0, 1, 1);
	iLocal_22 = __LIB_7__::func_142(uParam0, joaat("P_WASHBOARD01X"), 0f, 0f, 0f, "WASHBOARD", 0, 1, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@tilly_2@base", 1, 1, 0, 0);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@tilly_2@Action_A", 2, 0, 1, 0);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@tilly_2@Action_A_Int_Front", 2, 0, 0, 1);
	iLocal_18 = __LIB_6__::func_959(uParam0, "script@vignette@tilly_2@Action_A_Int_Left", 2, 0, 0, 1);
	iLocal_19 = __LIB_6__::func_959(uParam0, "script@vignette@tilly_2@Action_A_Int_Right", 2, 0, 0, 1);
	iLocal_20 = __LIB_6__::func_959(uParam0, "script@vignette@tilly_2@Action_B", 0, 0, 0, 0);
	__LIB_7__::func_147(uParam0, iLocal_15, 4, 3, 0, 0, 0);
	__LIB_7__::func_146(uParam0, "CCTL2AU");
	...
	__LIB_7__::func_139(uParam0, iLocal_14, iLocal_21, "p_cs_rag02x_PH_R_HAND", 0, 0);
	__LIB_7__::func_139(uParam0, iLocal_14, iLocal_22, "p_washboard01x_PH_L_HAND", 1, "p_washboard01x_PH_L_HAND");
	__LIB_7__::func_107(uParam0, iLocal_15, 3, joaat("WORLD_HUMAN_SIT_GROUND_READING_BOOK"), "WORLD_HUMAN_SIT_GROUND_READING_BOOK_FEMALE_A", -1, 1);
	__LIB_7__::func_127(uParam0, iLocal_15, 3, joaat("PROP_HUMAN_SEAT_CHAIR_READING"), "PROP_HUMAN_SEAT_CHAIR_READING_FEMALE_A", iLocal_24, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_139(uParam0, iLocal_15, iLocal_23, "p_cs_book04x_PH_R_HAND", 0, 0);
	Local_26 = { __LIB_7__::func_160(uParam0, -0.1395f, -0.423f, 1.8254f, -172.6f, 6.5f, 0f, 0.715f) };
	Local_36 = { __LIB_7__::func_160(uParam0, -0.14f, -0.423f, 1.8254f, -104.5f, 6.5f, 0.0075f, 0.7575f) };
	Local_46 = { __LIB_7__::func_160(uParam0, -0.14f, -0.423f, 1.8254f, 116f, 6f, 0.078f, 0.6825f) };
	return true;
}
...
bool func_93(var uParam0)
{
	if (!bLocal_25)
	{
		...
		{
			if (__LIB_7__::func_163(uParam0, Local_26, 1, 0))
			{
				__LIB_7__::func_154(uParam0, iLocal_17, 1);
			}
			else if (__LIB_7__::func_163(uParam0, Local_36, 1, 0))
			{
				__LIB_7__::func_154(uParam0, iLocal_18, 1);
			}
			else if (__LIB_7__::func_163(uParam0, Local_46, 1, 0))
			{
