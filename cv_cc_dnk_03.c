...
bool func_72(var uParam0)
{
	...
	iLocal_17 = __LIB_6__::func_958(uParam0, joaat("P_CIGARETTE_CS01X"), 0f, 0f, 0f, "CIGARETTE", 0, 0, 1);
	iLocal_18 = __LIB_6__::func_958(uParam0, joaat("P_CIGARLIT01X"), 0f, 0f, 0f, "CIGAR", 0, 1, 1);
	iLocal_16 = __LIB_6__::func_958(uParam0, joaat("P_BENCH_LOG07X"), -1.372f, 1.604f, -0.0733f, 0, 1, 0, 1);
	__LIB_7__::func_47(uParam0, -7.594311f, 1.704786f, 1.4875f, 0f, 1.1f, 1.1f, 3.2075f, joaat("VOLBOX"), joaat("APMS_COMP_DUTCH"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, -1.9018f, 0.9755f, 1.4875f, 42.75f, 2.92f, 1.1025f, 3.2075f, joaat("VOLBOX"), joaat("APMS_COMP_MICAH"), 1, 1, 1);
	__LIB_7__::func_159(uParam0, -2.08831f, 1.13359f, 0.50013f, 0f, 0.8f, 0.8f, 3.2075f, joaat("VOLCYLINDER"), 1);
	__LIB_6__::func_959(uParam0, "script@vignette@dutch_and_micah_3@base", 1, 1, 0, 0);
	__LIB_6__::func_959(uParam0, "script@vignette@dutch_and_micah_3@action", 0, 0, 1, 0);
	__LIB_7__::func_146(uParam0, "CDNK3AU");
	__LIB_7__::func_127(uParam0, iLocal_15, 1, joaat("WORLD_CAMP_DUTCH_SMOKE_CIGAR"), "WORLD_CAMP_DUTCH_SMOKE_CIGAR_MALE_A", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_139(uParam0, iLocal_15, iLocal_18, "p_cigar02x_PH_R_HAND", 0, 0);
	__LIB_7__::func_107(uParam0, iLocal_14, 3, joaat("PROP_HUMAN_SEAT_CHAIR_SMOKING"), "PROP_HUMAN_SEAT_CHAIR_SMOKING_MALE_D", iLocal_16, 0);
	__LIB_7__::func_127(uParam0, iLocal_14, 2, joaat("PROP_HUMAN_SEAT_CHAIR_SMOKING"), "PROP_HUMAN_SEAT_CHAIR_SMOKING_MALE_D", iLocal_16, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_139(uParam0, iLocal_14, iLocal_17, "p_cigarette_cs01x_PH_R_HAND", 0, 0);
	__LIB_7__::func_151(uParam0, iLocal_14, 1, -1);
	__LIB_7__::func_149(uParam0, joaat("COMP_DNKCNV3"), joaat("PLAYER_DNKCNV3"));
	return true;
}
