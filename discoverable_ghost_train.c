...
bool func_3(var uParam0)
{
	...
	if (Local_30 == 0)
	{
		...
		Local_30 = __LIB_7__::func_454(iVar0);
		return false;
	}
	if (__LIB_7__::func_497(Local_30, 4) || Global_40.f_8863.f_156)
	{
		func_1(uParam0);
		return false;
	}
...
void func_8(var uParam0)
{
	...
	{
		case 0:
			if (!__LIB_2__::func_410(43))
			{
				__LIB_1__::func_649(&Local_14, 9);
				return;
			}
			if (__LIB_7__::func_530(func_50()))
			{
				__LIB_1__::func_649(&Local_14, 9);
			}
			else
		...
		case 1:
			...
			while (iVar0 <= 0)
			{
				if (!__LIB_7__::func_574(&(Local_14.f_7[iVar0]), func_52(iVar0)))
				{
					return;
				}
				iVar0++;
			...
			break;
		case 2:
			if (__LIB_0__::func_296(70, 0, 1))
			{
				__LIB_1__::func_649(&Local_14, 9);
				return;
			}
			iVar1 = __LIB_0__::func_41(__LIB_0__::func_23());
			if (!__LIB_0__::func_252(iVar1, 3, 5))
			{
				return;
			}
			...
			if (!__LIB_1__::func_205(Global_35, Local_14.f_7[0], 1, 0))
			{
				return;
			}
		...
		case 7:
			...
			if (ENTITY::IS_ENTITY_ON_SCREEN(Local_14.f_1))
			{
				...
				if (!__LIB_7__::func_530(func_50()))
				{
					__LIB_7__::func_556(func_50());
				}
			}
			fVar27 = __LIB_0__::func_94(Local_14.f_1, func_64(), 1);
			if (fVar27 < 1f)
			{
...
void func_9(var uParam0)
{
	...
	if (__LIB_0__::func_75(&(Local_14.f_11)))
	{
		__LIB_0__::func_37(&(Local_14.f_11));
	}
}
...
void func_36(var uParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		iVar0 = __LIB_7__::func_463(*uParam0, func_94(), uParam0->f_4);
	}
	else
	{
...
void func_37(bool bParam0, int iParam1)
{
	...
	if (!__LIB_0__::func_28() || func_72() != -1)
	{
		return;
	}
...
bool func_62(int iParam0, float fParam1, float fParam2)
{
	...
	float fVar1;
	float fVar2;
	if (!__LIB_0__::func_75(&(iParam0->f_11)))
	{
		__LIB_1__::func_148(&(iParam0->f_11));
	}
	fVar1 = __LIB_0__::func_265(&(iParam0->f_11));
	fVar2 = (fVar1 / fParam2);
	iParam0->f_9 = BUILTIN::FLOOR(__LIB_0__::func_667(0f, fParam1, fVar2));
	...
	if (fVar1 >= fParam2)
	{
		__LIB_0__::func_37(&(iParam0->f_11));
		return true;
	}
	return false;
}
...
bool func_65(int iParam0, float fParam1, float fParam2)
{
	...
	fVar3 = (fParam2 - fVar1);
	fVar2 = (fVar3 / fParam2);
	iParam0->f_9 = BUILTIN::FLOOR(__LIB_0__::func_667(fParam1, 200f, fVar2));
	if (IntToFloat(iParam0->f_9) > fParam1)
	{
		iVar0 = 0;
		while (iVar0 <= 3)
...
int func_205(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		__LIB_0__::func_524(&Var0, func_212(0));
	}
...
{
	return func_218(joaat("CHARACTER"), __LIB_0__::func_217(), -1591664384, bParam0);
}
