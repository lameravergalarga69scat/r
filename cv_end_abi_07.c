...
bool func_72(var uParam0)
{
	...
	__LIB_7__::func_47(uParam0, 3.25f, 6.55f, 1.1379f, 11.6f, 1.28f, 2.22f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_ABIGAIL"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, 1.22f, -0.5099f, 1.0675f, -167.4f, 1.5f, 1.5f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_UNCLE"), 1, 1, 1);
	__LIB_6__::func_958(uParam0, joaat("P_BOTTLEBEER01X"), 0f, 0f, 0f, "p_bottlebeer01x", 0, 1, 1);
	__LIB_6__::func_958(uParam0, joaat("P_CHAIR02X"), 0f, 0f, 0f, "p_chair02x^1", 0, 0, 1);
	iLocal_18 = __LIB_6__::func_958(uParam0, joaat("P_CHAIR02X"), 0f, 0f, 0f, "p_chair02x", 0, 0, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@beecher@abigail_7@base", 1, 1, 0, 0);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@beecher@abigail_7@action_a", 2, 0, 1, 0);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@beecher@abigail_7@action_b", 2, 0, 0, 1);
	__LIB_7__::func_146(uParam0, "BABI7AU");
	__LIB_7__::func_149(uParam0, joaat("COMP_BCABICNV7"), joaat("PLAYER_BCABICNV7"));
	__LIB_7__::func_151(uParam0, iLocal_14, 1, -1);
	__LIB_7__::func_107(uParam0, iLocal_15, 3, joaat("WORLD_HUMAN_DRINKING"), "WORLD_HUMAN_STAND_DRINK_MALE_A", -1, 1);
	__LIB_7__::func_127(uParam0, iLocal_15, 3, joaat("PROP_HUMAN_SEAT_CHAIR"), "PROP_HUMAN_SEAT_CHAIR_GENERIC_MALE_D", iLocal_18, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_151(uParam0, iLocal_15, 1, -1);
	Local_19 = { __LIB_7__::func_160(uParam0, 2.7225f, 6.545f, 0.988f, -76.6299f, 7.4275f, 1f, 0.9975f) };
	return true;
}
