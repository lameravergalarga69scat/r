...
{
	func_9(uParam0);
	SCRIPTS::_0xE7282390542F570D(uLocal_128);
...
bool func_3(var uParam0)
{
	...
	if (Local_129 == 0)
	{
		...
		Local_129 = __LIB_7__::func_454(iVar0);
		return false;
	}
	if (__LIB_7__::func_497(Local_129, 4) || Global_40.f_8863.f_156)
	{
		func_1(uParam0);
		return false;
	}
...
void func_8(var uParam0)
{
	...
	if (__LIB_7__::func_530(1091556515))
	{
		__LIB_7__::func_585(&Local_14, 5);
		return;
	}
	if (__LIB_0__::func_296(0, 0, 1) && Local_14 < 3)
	{
		__LIB_7__::func_585(&Local_14, 4);
	}
	switch (Local_14)
	{
		case 0:
			if (HUD::_DOES_TEXT_DATABASE_EXIST(func_51(0)))
			{
				HUD::_TEXT_DATABASE_REQUEST(func_51(0));
			}
			PED::_0xF008E0BA1FE1D644(1);
			STREAMING::REQUEST_MODEL(func_52(0), false);
			__LIB_7__::func_585(&Local_14, 1);
			break;
		case 1:
			...
			else if (!__LIB_7__::func_584(&(Local_14.f_103[0]), func_52(0), func_53(1), func_54(1), 0))
			{
				return;
			}
			else if (!__LIB_7__::func_574(&(Local_14.f_105[0]), func_56(0)))
			{
				return;
			}
			else if (!__LIB_7__::func_586(&(Local_14.f_107[0]), &(Local_14.f_110), func_58(0), func_59(0), 1, 0))
			{
				return;
			}
			if (!ENTITY::IS_ENTITY_DEAD(Local_14.f_103[0]))
			{
				__LIB_0__::func_928(&(Local_14.f_2), Local_14.f_103[0], func_51(2), 0);
				PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_14.f_103[0], true);
				__LIB_0__::func_862(Local_14.f_103[0], 2131255687);
			}
			if (ANIMSCENE::_DOES_ANIM_SCENE_EXIST(Local_14.f_107[0]))
			{
				ANIMSCENE::SET_ANIM_SCENE_ENTITY(Local_14.f_107[0], "Cougarman", Local_14.f_103[0], 0);
				ANIMSCENE::START_ANIM_SCENE(Local_14.f_107[0]);
				__LIB_7__::func_564(&(Local_14.f_107[0]), func_59(0));
			}
			__LIB_7__::func_563(&(Local_14.f_107[0]), func_59(1));
			__LIB_7__::func_585(&Local_14, 2);
			break;
		case 2:
			if (!VOLUME::_DOES_VOLUME_EXIST(Local_14.f_105[0]))
			{
				return;
			}
			else if (ENTITY::IS_ENTITY_IN_VOLUME(Global_35, Local_14.f_105[0], true, 0))
			{
				__LIB_6__::func_618(&(Local_14.f_1), 1);
				__LIB_7__::func_585(&Local_14, 3);
			}
			break;
		case 3:
			if (!__LIB_7__::func_497(*uParam0, 32))
			{
				if (VOLUME::_DOES_VOLUME_EXIST(Local_14.f_105[0]) && ENTITY::IS_ENTITY_IN_VOLUME(Global_35, Local_14.f_105[0], true, 0))
				{
...
void func_36(var uParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		iVar0 = __LIB_7__::func_463(*uParam0, func_96(), uParam0->f_4);
	}
	else
	{
...
void func_37(bool bParam0, int iParam1)
{
	...
	if (!__LIB_0__::func_28() || func_74() != -1)
	{
		return;
	}
...
bool func_67(int iParam0)
{
	if (iParam0->f_1 < 3)
	{
		if (func_126())
		{
			__LIB_6__::func_618(&(iParam0->f_1), 3);
		}
	}
	if (iParam0->f_1 < 5)
	{
		if (func_127())
		{
			if (ENTITY::DOES_ENTITY_EXIST(iParam0->f_103[0]))
			{
				PED::SET_PED_CONFIG_FLAG(iParam0->f_103[0], 88, true);
				ENTITY::SET_ENTITY_PROOFS(iParam0->f_103[0], 4, false);
			}
			FIRE::ADD_EXPLOSION(func_53(2), 12, 2f, false, true, 0f);
			__LIB_7__::func_564(&(iParam0->f_107[0]), func_59(1));
			__LIB_6__::func_618(&(iParam0->f_1), 5);
		}
	}
	switch (iParam0->f_1)
	{
		...
		case 1:
			...
			else if (func_128(iParam0, 3))
			{
				if (iParam0->f_109 < 1)
				{
					...
					MAP::_TRIGGER_SONAR_BLIP_2(1715123483, iParam0->f_103[0]);
				}
				iParam0->f_111 = 0;
				__LIB_6__::func_618(&(iParam0->f_1), 2);
			}
			break;
		case 2:
			if (__LIB_1__::func_285(&(iParam0->f_100), 8f))
			{
				if (func_128(iParam0, 4))
				{
					...
					if (iParam0->f_111 > 3)
					{
						...
						iParam0->f_111 = 0;
						__LIB_6__::func_618(&(iParam0->f_1), 0);
					}
				}
			}
			break;
		case 3:
			if (iParam0->f_111 == 0)
			{
				__LIB_6__::func_618(&(iParam0->f_1), 4);
			}
			else if (func_126())
			{
				if (__LIB_0__::func_75(&(iParam0->f_100)))
				{
					if (__LIB_1__::func_285(&(iParam0->f_100), 5f))
					{
						__LIB_6__::func_618(&(iParam0->f_1), 4);
					}
				}
		...
		case 4:
			...
			break;
		case 5:
			if (ENTITY::DOES_ENTITY_EXIST(iParam0->f_103[0]) && ENTITY::IS_ENTITY_DEAD(iParam0->f_103[0]))
			{
				if (ANIMSCENE::_DOES_ANIM_SCENE_EXIST(iParam0->f_107[0]))
				{
					ANIMSCENE::_DELETE_ANIM_SCENE(iParam0->f_107[0]);
				}
				__LIB_6__::func_618(&(iParam0->f_1), 6);
			}
			break;
		case 6:
			__LIB_7__::func_587(&(iParam0->f_103[0]), 0);
			PED::SET_PED_CONFIG_FLAG(iParam0->f_103[0], 26, true);
			PED::_0xAE6004120C18DF97(iParam0->f_103[0], 1, 0);
			__LIB_7__::func_588(&(iParam0->f_103[0]), 0);
			__LIB_6__::func_618(&(iParam0->f_1), 7);
			break;
		case 7:
			return true;
	}
...
{
	int iVar0;
	if (!func_156(joaat("DOCUMENT_PLAYER_JOURNAL"), 1, 0))
	{
...
{
	return __LIB_2__::func_813(&(iParam0->f_2), __LIB_1__::func_344(func_51(iParam1)), 1, -1, 0, 0);
}
...
int func_195(int iParam0, bool bParam1, bool bParam2)
{
	...
	uVar2 = INVENTORY::_0xE787F05DFC977BDE(func_158(bParam2), iParam0, 0);
	return uVar2;
}
...
int func_226(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		__LIB_0__::func_524(&Var0, func_233(0));
	}
...
{
	*iParam1 = INVENTORY::_0x640F890C3E5A3FFD(func_158(bParam3), uParam0, uParam2);
	if (*iParam1 >= 0)
	{
		return true;
	}
...
{
	return func_239(joaat("CHARACTER"), __LIB_0__::func_217(), -1591664384, bParam0);
}
