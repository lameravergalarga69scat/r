...
bool func_72(var uParam0)
{
	...
	__LIB_7__::func_47(uParam0, 0.2f, -3.325f, 0.832f, 87.12f, 2.81f, 5.97f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_DUTCH"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, 2.6625f, 1.2125f, 0.8945f, 80f, 1f, 1f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_DUTCH"), 1, 1, 1);
	iLocal_16 = __LIB_6__::func_958(uParam0, joaat("P_CS_BOOKEVELYNMILLER"), 0f, 0f, 0f, "BOOK", 0, 0, 1);
	iLocal_17 = __LIB_6__::func_958(uParam0, joaat("P_CIGAR02X"), 0f, 0f, 0f, "CIGAR", 0, 1, 1);
	iLocal_15 = __LIB_6__::func_958(uParam0, joaat("P_CHAIRFOLDING02X"), 2.08997f, 1.19411f, 0.162041f, 0, 1, 0, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@dutch_29@base", 1, 1, 0, 0);
	iLocal_18 = __LIB_6__::func_959(uParam0, "script@vignette@dutch_29@action", 0, 0, 1, 0);
	__LIB_7__::func_146(uParam0, "CDT29AU");
	__LIB_7__::func_149(uParam0, joaat("COMP_DTCCNV29"), joaat("PLAYER_DTCCNV29"));
	__LIB_7__::func_150(uParam0, iLocal_18, -1, 0.88f);
	__LIB_7__::func_107(uParam0, iLocal_14, 3, joaat("WORLD_CAMP_DUTCH_SMOKE_CIGAR"), "WORLD_CAMP_DUTCH_SMOKE_CIGAR_MALE_A", -1, 1);
	__LIB_7__::func_127(uParam0, iLocal_14, 3, joaat("SC_PROP_CAMP_DUTCH_SEAT_CHAIR_READING"), "SC_PROP_CAMP_DUTCH_SEAT_CHAIR_READING_MALE_A", iLocal_15, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
...
{
	__LIB_3__::func_459(__LIB_7__::func_30(uParam0, iLocal_17), 0);
	return true;
}
