...
bool func_72(var uParam0)
{
	...
	{
		case 1:
			__LIB_7__::func_116(uParam0, -131.08f, -30.6f, 94.925f, 0f, 0f, 85f);
			break;
		default:
			return false;
	}
	...
	__LIB_7__::func_48(uParam0, 9, 0);
	__LIB_7__::func_47(uParam0, 5.2264f, -6.6722f, 0.5193f, 170.3144f, 1.5f, 1.5f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_BILL"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, 0.4954f, -2.8251f, 0.6547f, -90.36f, 1.5f, 1.8f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_DUTCH"), 1, 1, 1);
	iLocal_16 = __LIB_6__::func_958(uParam0, joaat("P_CS_BOOKEVELYNMILLER"), 0f, 0f, 0f, "BOOK", 0, 0, 1);
	__LIB_6__::func_958(uParam0, joaat("S_INTERACT_LANTERN01X"), 0f, 0f, 0f, "LANTERN", 0, 0, 1);
	__LIB_6__::func_958(uParam0, joaat("P_CHAIRFOLDING02X"), 0f, 0f, 0f, "CHAIR", 0, 0, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@bill_8@base", 1, 1, 0, 0);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@bill_8@action_a", 2, 0, 1, 0);
	iLocal_18 = __LIB_6__::func_959(uParam0, "script@vignette@bill_8@action_a_int", 0, 0, 0, 1);
	iLocal_19 = __LIB_6__::func_959(uParam0, "script@vignette@bill_8@action_exit", 0, 0, 0, 0);
	__LIB_7__::func_146(uParam0, "CBLL8AU");
	__LIB_7__::func_147(uParam0, iLocal_14, 1, 12, 0, 0, 0);
	__LIB_7__::func_107(uParam0, iLocal_15, 3, joaat("SC_PROP_CAMP_DUTCH_SEAT_CHAIR_READING"), "SC_PROP_CAMP_DUTCH_SEAT_CHAIR_READING_MALE_A", -1, 0);
	__LIB_7__::func_127(uParam0, iLocal_15, 3, joaat("SC_PROP_CAMP_DUTCH_SEAT_CHAIR_READING"), "SC_PROP_CAMP_DUTCH_SEAT_CHAIR_READING_MALE_A", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_139(uParam0, iLocal_15, iLocal_16, "p_cs_bookEvelynMiller_PH_R_HAND", 0, 0);
	Local_20 = { __LIB_7__::func_160(uParam0, 0.0939f, -2.8236f, 0.6519f, -145.319f, 7f, 0.8f, 0.8f) };
	return true;
}
