...
bool func_72(var uParam0)
{
	...
	__LIB_7__::func_47(uParam0, -3.7325f, -0.49f, 1.15f, 6.81f, 1.1f, 1f, 2.685f, joaat("VOLBOX"), joaat("APMS_COMP_GRIMSHAW"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, 0.425f, -1.2375f, 1.15f, -102.84f, 4.24f, 3.205f, 2.685f, joaat("VOLBOX"), joaat("APMS_COMP_MARYBETH"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, 2.175f, 3.0875f, 1.15f, 79.25f, 1.7175f, 1f, 2.685f, joaat("VOLBOX"), joaat("APMS_COMP_MARYBETH"), 1, 1, 1);
	iLocal_16 = __LIB_6__::func_958(uParam0, joaat("P_CS_RAG02X"), 0f, 0f, 0f, "RAG", 0, 1, 1);
	iLocal_17 = __LIB_6__::func_958(uParam0, joaat("P_WASHBOARD01X"), 0f, 0f, 0f, "WASHBOARD", 0, 1, 1);
	__LIB_6__::func_958(uParam0, joaat("P_CS_BOOK02X"), 0f, 0f, 0f, "BOOK", 0, 0, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@susan_8@base", 1, 1, 0, 0);
	__LIB_6__::func_959(uParam0, "script@vignette@susan_8@action", 0, 0, 1, 0);
	__LIB_7__::func_146(uParam0, "CSSN8AU");
	...
	__LIB_7__::func_259(uParam0, iLocal_14, iLocal_17, "p_washboard01x_PH_L_HAND", 1, "p_washboard01x_PH_L_HAND");
	__LIB_7__::func_259(uParam0, iLocal_14, iLocal_16, "p_cs_rag02x_PH_R_HAND", 0, 0);
