...
bool func_1(var uParam0)
{
	...
	{
		PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(__LIB_6__::func_952(uParam0, iLocal_14), false);
	}
	return true;
}
...
bool func_72(var uParam0)
{
	...
	__LIB_7__::func_47(uParam0, -4f, 0f, 0f, -155f, 4f, 4f, 2.5f, joaat("VOLCYLINDER"), -1, 1, 1, 1);
	__LIB_6__::func_958(uParam0, joaat("P_SHEEPSHEERS01X"), 0f, 0f, 0f, "SHEERS", 0, 1, 1);
	iLocal_14 = __LIB_7__::func_31(uParam0, joaat("A_C_SHEEP_01"), "SHEEP");
	__LIB_6__::func_959(uParam0, "script@vignette@beecher@uncle_1@base", 1, 1, 0, 0);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@beecher@uncle_1@action", 2, 0, 1, 1);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@beecher@uncle_1@idle_a", 1, 0, 0, 0);
	iLocal_18 = __LIB_6__::func_959(uParam0, "script@vignette@beecher@uncle_1@exit", 0, 0, 0, 0);
	__LIB_7__::func_149(uParam0, joaat("COMP_BCUNCCNV1"), joaat("PLAYER_BCUNCCNV1"));
	Local_29 = { __LIB_7__::func_160(uParam0, -1.0025f, -1.4119f, 1.1388f, 57.2941f, 6.5f, 0.5f, 0.5f) };
	__LIB_7__::func_146(uParam0, "BUNC1AU");
	__LIB_7__::func_145(uParam0, 3f, 20f);
...
bool func_89(var uParam0)
{
	...
	return __LIB_7__::func_236(uParam0, Local_29, 1, 0);
}
...
bool func_93(var uParam0)
{
	...
	{
		__LIB_0__::func_268(&uLocal_23, 0f);
		PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(__LIB_6__::func_952(uParam0, iLocal_14), true);
		...
		__LIB_1__::func_283(&uLocal_26, 0);
		PED::_0x2208438012482A1A(__LIB_6__::func_952(uParam0, iLocal_14), true, false);
	}
	return true;
}
...
{
	if (__LIB_0__::func_264(&uLocal_23) < fLocal_20)
	{
		TASK::SET_PED_DESIRED_MOVE_BLEND_RATIO(__LIB_6__::func_952(uParam0, iLocal_14), func_207());
	}
	if (PED::_IS_PED_USING_SCENARIO_HASH(__LIB_6__::func_952(uParam0, iLocal_14), joaat("WORLD_ANIMAL_SHEEP_EATING_GROUND")) && TASK::IS_PED_ACTIVE_IN_SCENARIO(__LIB_6__::func_952(uParam0, iLocal_14), 0))
	{
		PED::SET_PED_KEEP_TASK(__LIB_6__::func_952(uParam0, iLocal_14), true);
		return true;
	}
	else if (__LIB_0__::func_264(&uLocal_23) > 15f)
	{
		return true;
	}
	return false;
...
float func_207()
{
	return (fLocal_21 - ((__LIB_0__::func_264(&uLocal_23) / fLocal_20) * (fLocal_21 - fLocal_22)));
}
