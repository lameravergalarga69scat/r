...
bool func_72(var uParam0)
{
	switch (__LIB_0__::func_78(uParam0))
	{
		...
		case 2:
			...
			break;
		case 3:
			__LIB_7__::func_116(uParam0, 1887.9f, -1866.2f, 41.8f, 0f, 0f, -42.48f);
			break;
		default:
			return false;
	}
	...
	__LIB_7__::func_47(uParam0, 0.5494f, -2.8561f, 0.6563f, -89.64f, 2f, 2f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_DUTCH"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, -3.5423f, -1.2882f, 1.0731f, -85f, 1.2f, 1.2f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_MICAH"), 1, 1, 1);
	iLocal_16 = __LIB_6__::func_958(uParam0, joaat("P_CHAIRFOLDING02X"), 0f, 0f, 0f, "CHAIR", 0, 0, 1);
	__LIB_6__::func_958(uParam0, joaat("P_CIGARTHIN01X"), 0f, 0f, 0f, "CIGAR", 0, 1, 1);
	iLocal_17 = __LIB_6__::func_958(uParam0, joaat("P_CS_BOOKEVELYNMILLER"), 0f, 0f, 0f, "BOOK", 0, 1, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@dutch_and_micah_2@base", 1, 1, 0, 0);
	iLocal_18 = __LIB_6__::func_959(uParam0, "script@vignette@dutch_and_micah_2@action_a", 2, 0, 1, 0);
	iLocal_19 = __LIB_6__::func_959(uParam0, "script@vignette@dutch_and_micah_2@action_a_int_front", 2, 0, 0, 1);
	iLocal_20 = __LIB_6__::func_959(uParam0, "script@vignette@dutch_and_micah_2@action_a_int_left", 2, 0, 0, 1);
	iLocal_21 = __LIB_6__::func_959(uParam0, "script@vignette@dutch_and_micah_2@action_b", 0, 0, 0, 0);
	__LIB_7__::func_146(uParam0, "CDNK2AU");
	...
	__LIB_7__::func_139(uParam0, iLocal_14, iLocal_17, "p_cs_bookEvelynMiller_PH_R_HAND", 0, 0);
	...
	__LIB_7__::func_149(uParam0, joaat("COMP_DNKCNV2"), joaat("PLAYER_DNKCNV2"));
	__LIB_7__::func_150(uParam0, iLocal_21, -1, 0.85f);
	Local_22 = { __LIB_7__::func_160(uParam0, 0.099f, -2.656f, 0.656f, 151.2f, 6f, 0.4f, 0.4f) };
	Local_32 = { __LIB_7__::func_160(uParam0, 0.099f, -2.656f, 0.656f, -136.75f, 6f, 0.4f, 0.4f) };
	return true;
}
...
bool func_93(var uParam0)
{
	...
	{
		if (__LIB_7__::func_163(uParam0, Local_22, 1, 1))
		{
			__LIB_7__::func_154(uParam0, iLocal_19, 1);
		}
		else if (__LIB_7__::func_163(uParam0, Local_32, 1, 1))
		{
