...
bool func_72(var uParam0)
{
	...
	iLocal_16 = __LIB_7__::func_48(uParam0, 17, 0);
	__LIB_7__::func_47(uParam0, 0.6875f, 1.2375f, 0f, -26f, 1f, 1f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_ABIGAIL"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, -0.6f, -1.2125f, 0f, -26f, 1f, 1f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_PEARSON"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, -3.59344f, 10.879f, 0.830566f, 0f, 1.1f, 1.1f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_MICAH"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, -14.461f, -2.763f, -0.136f, 84.35f, 1.5f, 1.5f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_MICAH"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, -1.25f, 0.7875f, 0f, -26f, 1f, 1f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_MICAH"), 1, 1, 1);
	vVar0 = { -14.345f, -2.16691f, 0.826759f };
	iLocal_18 = __LIB_6__::func_958(uParam0, joaat("S_LOOTABLECAMPCASE"), vVar0, "LOOTBOX", 1, 0, 1);
	iLocal_19 = __LIB_6__::func_958(uParam0, joaat("P_CHAIR_BARREL04B"), -0.584518f, -1.37169f, -0.000602722f, 0, 1, 0, 1);
	__LIB_6__::func_958(uParam0, joaat("P_BOTTLEJD01X"), 0f, 0f, 0f, "BOTTLEJD", 0, 0, 1);
	__LIB_6__::func_958(uParam0, joaat("P_MONEYSTACK01X"), 0f, 0f, 0f, "MONEYSTACK", 0, 1, 1);
	__LIB_6__::func_958(uParam0, joaat("P_MONEYSTACK01X"), 0f, 0f, 0f, "MONEYSTACK^1", 0, 1, 1);
	__LIB_6__::func_958(uParam0, joaat("P_MUGCOFFEE01X"), 0f, 0f, 0f, "MUG", 0, 1, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@wrk@micah_work_1@base", 1, 1, 0, 0);
	__LIB_6__::func_959(uParam0, "script@vignette@wrk@micah_work_1@action_a", 0, 0, 1, 0);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@wrk@micah_work_1@action_b", 0, 0, 0, 0);
	__LIB_7__::func_146(uParam0, "CWRM1AU");
	__LIB_7__::func_107(uParam0, iLocal_16, 3, joaat("PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING"), "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_MALE_A", iLocal_19, 0);
	__LIB_7__::func_147(uParam0, iLocal_16, 1, 0, 30, 0, 0);
	__LIB_7__::func_127(uParam0, iLocal_15, 3, joaat("GENERIC_SEAT_CHAIR_TABLE_SCENARIO"), "GENERIC_SEAT_CHAIR_TABLE_SCENARIO_LF_FWD_FEMALE_A", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
...
bool func_93(var uParam0)
{
	...
	if (!bLocal_20)
	{
		if (__LIB_7__::func_74(uParam0, iLocal_14))
		{
			...
			TASK::TASK_START_SCENARIO_AT_POSITION(__LIB_6__::func_952(uParam0, iLocal_14), joaat("STAND"), vVar1, fVar0, 0, true, false, 0, -1f, false);
			bLocal_20 = true;
		}
	}
	if (bLocal_20 && !bLocal_21)
	{
		...
		{
			__LIB_7__::func_5(uParam0, "Player is near the tithing box", 1, -1);
			__LIB_7__::func_113(uParam0, iLocal_14, 1, 1);
			bLocal_21 = true;
			return true;
		}
		if (TASK::IS_PED_ACTIVE_IN_SCENARIO(__LIB_6__::func_952(uParam0, iLocal_14), 0))
		{
...
int func_149(var uParam0)
{
	...
	vLocal_22 = { __LIB_6__::func_970(96) };
	vLocal_25 = { __LIB_6__::func_971(96) };
	return 1;
}
