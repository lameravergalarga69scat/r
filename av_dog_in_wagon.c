...
{
	__LIB_2__::func_851(uParam0, 10859, 10924, 11628);
}

void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	int iVar0;
	__LIB_2__::func_853(uParam0, "DOG_IN_WAGON", "", vParam1, vParam4);
	iVar0 = __LIB_2__::func_921(__LIB_1__::func_898());
	__LIB_2__::func_905(uParam0, 0, "DIWP_MAN", iVar0, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, -3f, -2f, 0f), (94f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	__LIB_2__::func_905(uParam0, 1, "DIWP_DOG", joaat("A_C_DOGBLUETICKCOONHOUND_01"), OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, -5f, -2f, 0f), (-85f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	__LIB_2__::func_905(uParam0, 2, "DIWP_HORSE_1", 0, vParam1, vParam4.z, 0, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	__LIB_2__::func_905(uParam0, 3, "DIWP_HORSE_2", 0, vParam1, vParam4.z, 0, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	__LIB_2__::func_946(uParam0, "WAGON", joaat("WAGON02X"), vParam1, vParam4.z, 0, 0, 0, 0);
}
...
int func_30(var uParam0)
{
	...
	__LIB_1__::func_406(&uLocal_10, 1);
	return 1;
}
	...
	switch (iLocal_9)
	{
		case 0:
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
			{
				...
				__LIB_1__::func_473(uParam0->f_20[0 /*14*/], joaat("WORLD_HUMAN_CROUCH_INSPECT"), 0, 0, 0, -1082130432 /* Float: -1f */);
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
			{
				...
				__LIB_1__::func_473(uParam0->f_20[1 /*14*/], joaat("WORLD_ANIMAL_DOG_SITTING"), 0, 0, 0, -1082130432 /* Float: -1f */);
		...
		case 1:
			...
			break;
		case 2:
			bVar0 = __LIB_2__::func_343(uParam0->f_20[0 /*14*/], uParam0->f_453, 0);
			bVar1 = __LIB_2__::func_343(uParam0->f_20[1 /*14*/], uParam0->f_453, 0);
			if (bVar0 && bVar1)
			{
			...
			else
			{
				if (!bVar1)
				{
					if (!__LIB_0__::func_163(uParam0->f_20[1 /*14*/], -1794415470))
					{
						TASK::TASK_ENTER_VEHICLE(uParam0->f_20[1 /*14*/], uParam0->f_453, -1, 3, 1f, 1, 0);
					}
				}
				if (!bVar0)
				{
					if (!__LIB_0__::func_163(uParam0->f_20[0 /*14*/], -1794415470))
					{
						TASK::TASK_ENTER_VEHICLE(uParam0->f_20[0 /*14*/], uParam0->f_453, -1, -1, 1f, 131072, 0);
					}
				}
			...
			break;
		case 3:
			if (__LIB_1__::func_285(&uLocal_38, 6f))
			{
