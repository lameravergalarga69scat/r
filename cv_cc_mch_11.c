...
bool func_72(var uParam0)
{
	...
	__LIB_7__::func_47(uParam0, -0.228f, -1.1382f, 0.5044f, 0f, 1.5f, 1.5f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_MICAH"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, -2.9678f, -4.3495f, 1.1403f, 0f, 1.5f, 1.5f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_GRIMSHAW"), 1, 1, 1);
	__LIB_7__::func_159(uParam0, -0.4f, -2.05f, 1.1403f, 0f, 1.25f, 1.25f, 3f, joaat("VOLCYLINDER"), 1);
	...
	__LIB_6__::func_958(uParam0, joaat("P_CHAIRFOLDING02X"), -0.258326f, -1.19728f, 0.0322266f, "CHAIR", 1, 0, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@micah_11@base", 1, 1, 0, 0);
	iLocal_15 = __LIB_6__::func_959(uParam0, "script@vignette@micah_11@action_a", 2, 0, 1, 0);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@micah_11@exit", 0, 0, 0, 0);
	__LIB_7__::func_146(uParam0, "CM11AUD");
