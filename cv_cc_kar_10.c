...
bool func_72(var uParam0)
{
	...
	__LIB_7__::func_47(uParam0, -3.625f, -0.875f, 0.6695f, 168.75f, 2f, 2f, 2.015f, joaat("VOLBOX"), joaat("APMS_COMP_KAREN"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, -0.775f, -5.5626f, 1.182f, 85.5f, 1.1f, 1.1f, 2.365f, joaat("VOLBOX"), joaat("APMS_COMP_MARYBETH"), 1, 1, 1);
	__LIB_7__::func_159(uParam0, -3.87134f, -1.09542f, 1.00508f, 0f, 1f, 1f, 2f, joaat("VOLCYLINDER"), 1);
	__LIB_6__::func_958(uParam0, joaat("P_CHAIR24X"), -4.62596f, -1.37365f, -0.000255585f, "Chair", 1, 0, 1);
	__LIB_6__::func_958(uParam0, joaat("P_CIGARETTE01X"), 0f, 0f, 0f, "CIGARETTE", 0, 1, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@karen_10@base", 1, 1, 0, 0);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@karen_10@action", 0, 0, 1, 0);
	__LIB_7__::func_146(uParam0, "CKR10AU");
	...
	__LIB_7__::func_127(uParam0, iLocal_15, 2, joaat("WORLD_HUMAN_STAND_WAITING"), "WORLD_HUMAN_STAND_WAITING_FEMALE_A", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_151(uParam0, iLocal_15, 1, -1);
	iLocal_17 = __LIB_7__::func_156(uParam0, 3.3625f, 1.3387f, 2.4264f, 0f, 0f, 174.515f, 16.4725f, 16.24f, 5f, "Start_Trigger", joaat("VOLBOX"));
	__LIB_7__::func_149(uParam0, joaat("COMP_KARCNV10"), joaat("PLAYER_KARCNV10"));
	__LIB_7__::func_150(uParam0, iLocal_16, -1, 0.93f);
