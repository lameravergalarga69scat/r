...
void __EntryFunction__()
{
	...
	iLocal_40 = joaat("WORLD_ANIMAL_DEER_GRAZING");
	Var0.f_1 = -1;
	Var0.f_3.f_9 = 3;
	Var0.f_20 = 25;
...
{
	__LIB_2__::func_851(uParam0, 11167, 11226, 11793);
}
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	int iVar0;
	int iVar1;
	__LIB_2__::func_853(uParam0, "RIDGELINE_ANIMAL", "", vParam1, vParam4);
	iVar0 = 1;
	iVar1 = __LIB_1__::func_898();
	switch (*uParam0)
	{
		case 129:
			iLocal_9 = joaat("A_C_BUFFALO_01");
			iLocal_40 = joaat("WORLD_ANIMAL_BUFFALO_WALLOW");
			break;
		case 178:
			iLocal_9 = joaat("A_C_HORSE_MORGAN_BAY");
			iLocal_40 = joaat("WORLD_ANIMAL_HORSE_WALLOW");
			break;
		case 194:
			iLocal_9 = joaat("A_C_RACCOON_01");
			iLocal_40 = joaat("WORLD_ANIMAL_RACCOON_EATING_GROUND");
			break;
		case 202:
			iLocal_9 = joaat("A_C_BUCK_01");
			iLocal_40 = joaat("WORLD_ANIMAL_DEER_GRAZING");
		...
		case 203:
			...
			iLocal_40 = joaat("WORLD_ANIMAL_ELK_GRAZING");
			iVar0 = 0;
		...
		case 206:
			...
			iLocal_40 = joaat("WORLD_ANIMAL_RAM_GRAZING");
			iVar0 = 0;
			if (iVar1 == 12 || iVar1 == 1)
			{
		...
		case 204:
			...
			iLocal_40 = joaat("WORLD_ANIMAL_MOOSE_GRAZING");
			iVar0 = 0;
		...
		case 207:
			...
			iLocal_40 = joaat("WORLD_ANIMAL_WOLF_SNIFFING_GROUND");
			break;
		case 240:
			iLocal_9 = joaat("A_C_WOLF_MEDIUM");
			iLocal_40 = joaat("WORLD_ANIMAL_WOLF_HOWLING_SITTING");
			break;
		case 190:
			iLocal_9 = joaat("A_C_PIG_01");
			iLocal_40 = joaat("WORLD_ANIMAL_PIG_ROLL_MUD");
			break;
	}
	__LIB_2__::func_902(uParam0, 0, "RLA_ANIMAL", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0f, 0f, 0f), (0f + vParam4.z), iVar0, 1, 0, 1, iLocal_11, 1);
}

int func_30(var uParam0)
{
	__LIB_2__::func_887(&uLocal_12, 0);
	__LIB_1__::func_398(&uLocal_12, 1);
	__LIB_1__::func_401(&uLocal_12, 1);
	__LIB_2__::func_828(&uLocal_12, 1);
	__LIB_2__::func_829(&uLocal_12, 1);
	__LIB_2__::func_830(&uLocal_12, 1);
	__LIB_2__::func_906(&uLocal_12, 65);
	return 1;
}
...
int func_31(var uParam0)
{
	if (*uParam0 == 190)
	{
		if (!uParam0->f_469[1])
		{
			if (__LIB_2__::func_908(uParam0, &uLocal_12, 0) || __LIB_0__::func_232(uParam0->f_20[0 /*14*/], Global_35, 1) <= 9f)
			{
				func_65(uParam0);
	...
	switch (iLocal_10)
	{
		case 0:
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
			{
				...
				{
					TASK::TASK_START_SCENARIO_AT_POSITION(uParam0->f_20[0 /*14*/], iLocal_40, uParam0->f_20[0 /*14*/].f_5, uParam0->f_20[0 /*14*/].f_8, 0, true, true, 0, -1f, false);
				}
				else
				{
					TASK::TASK_START_SCENARIO_AT_POSITION(uParam0->f_20[0 /*14*/], iLocal_40, uParam0->f_20[0 /*14*/].f_5, uParam0->f_20[0 /*14*/].f_8, 0, false, true, 0, -1f, false);
				}
		...
		case 1:
			...
			break;
		case 2:
			if (__LIB_1__::func_285(&uLocal_41, 25f))
			{
				if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
				{
					TASK::TASK_ANIMAL_UNALERTED(uParam0->f_20[0 /*14*/], -1, 0, 0, 0);
			...
			break;
		case 3:
			if (__LIB_1__::func_285(&uLocal_41, 5f) && !PED::IS_PED_USING_ANY_SCENARIO(uParam0->f_20[0 /*14*/]))
			{
				return 1;
			}
			break;
