...
bool func_72(var uParam0)
{
	...
	{
		case 1:
			__LIB_7__::func_116(uParam0, -118.0872f, -27.6725f, 94.67f, 0f, 0f, -103.99f);
			vLocal_45 = { -0.258326f, -1.19728f, 0.0305557f };
			vLocal_48 = { -0.375912f, -6.04206f, 0.170624f };
			break;
		case 2:
			__LIB_7__::func_116(uParam0, 665.5107f, -1243.862f, 43.03f, 0.9f, 0f, 134.74f);
			vLocal_45 = { -0.258408f, -1.19482f, 0.0288277f };
			vLocal_48 = { -0.163854f, -6.38618f, 0.0781441f };
			break;
	}
	__LIB_7__::func_48(uParam0, 6, 0);
	iLocal_14 = __LIB_7__::func_48(uParam0, 3, 0);
	__LIB_7__::func_47(uParam0, 1.4509f, -1.5456f, 1f, 0f, 4.2f, 2.365f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_MICAH"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, -0.3814f, -5.9283f, 1f, 0f, 1.2f, 1.2f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_BILL"), 1, 1, 1);
	__LIB_6__::func_958(uParam0, joaat("P_CIGARETTE_CS01X"), 0f, 0f, 0f, "CIGARETTE", 0, 0, 1);
	iLocal_23 = __LIB_6__::func_958(uParam0, joaat("P_KNIFE02X"), 0f, 0f, 0f, "Knife", 0, 0, 1);
	iLocal_24 = __LIB_6__::func_958(uParam0, joaat("P_WOODWHITTLE01X"), 0f, 0f, 0f, "WOOD", 0, 0, 1);
	iLocal_22 = __LIB_6__::func_958(uParam0, joaat("P_CHAIRFOLDING02X"), vLocal_45, "Chair", 1, 0, 1);
	iLocal_21 = __LIB_6__::func_958(uParam0, joaat("P_CHAIRFOLDING02X"), vLocal_48, 0, 1, 0, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@micah_8@base", 1, 1, 0, 0);
	iLocal_15 = __LIB_6__::func_959(uParam0, "script@vignette@micah_8@action_a", 2, 0, 1, 0);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@micah_8@action_b", 2, 0, 0, 0);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@micah_8@action_b_alt_front", 2, 0, 0, 1);
	iLocal_18 = __LIB_6__::func_959(uParam0, "script@vignette@micah_8@action_b_alt_back", 2, 0, 0, 1);
	iLocal_19 = __LIB_6__::func_959(uParam0, "script@vignette@micah_8@base", 1, 0, 0, 0);
	iLocal_20 = __LIB_6__::func_959(uParam0, "script@vignette@micah_8@exit_stand", 0, 0, 0, 0);
	__LIB_7__::func_146(uParam0, "CMCH8AU");
	Local_25 = { __LIB_7__::func_160(uParam0, -0.1116f, -0.8931f, 0.6617f, 0f, 6f, 1f, 1f) };
	Local_35 = { __LIB_7__::func_160(uParam0, -0.1116f, -0.8931f, 0.6617f, 180f, 6f, 1f, 0f) };
	return true;
}
...
{
	vLocal_51 = { ENTITY::GET_ENTITY_COORDS(__LIB_7__::func_30(uParam0, iLocal_21), true, false) };
	vLocal_54 = { ENTITY::GET_ENTITY_ROTATION(__LIB_7__::func_30(uParam0, iLocal_21), 2) };
	vLocal_57 = { ENTITY::GET_ENTITY_COORDS(__LIB_7__::func_30(uParam0, iLocal_22), true, false) };
	vLocal_60 = { ENTITY::GET_ENTITY_ROTATION(__LIB_7__::func_30(uParam0, iLocal_22), 2) };
	return true;
}
...
{
	int iVar0;
	if (__LIB_0__::func_78(uParam0) == 2)
	{
		iVar0 = __LIB_7__::func_30(uParam0, iLocal_21);
		if (ENTITY::DOES_ENTITY_EXIST(iVar0))
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iVar0, __LIB_6__::func_972(uParam0, -0.380632f, -6.0838f, 0.155003f), __LIB_6__::func_973(uParam0, 179.14f), true, false, true);
		}
	}
	return true;
}
...
bool func_93(var uParam0)
{
	...
	{
		__LIB_1__::func_148(&uLocal_65);
		iLocal_68 = MISC::GET_RANDOM_INT_IN_RANGE(8, 15);
		ANIMSCENE::REMOVE_ANIM_SCENE_ENTITY(uParam0->f_1984[iLocal_19], "Bill", __LIB_6__::func_952(uParam0, iLocal_14));
		ANIMSCENE::REMOVE_ANIM_SCENE_ENTITY(uParam0->f_1984[iLocal_19], "Knife", __LIB_7__::func_30(uParam0, iLocal_23));
		ANIMSCENE::REMOVE_ANIM_SCENE_ENTITY(uParam0->f_1984[iLocal_19], "WOOD", __LIB_7__::func_30(uParam0, iLocal_24));
		__LIB_7__::func_173(uParam0, iLocal_19, 1);
	}
	if (__LIB_7__::func_40(uParam0, iLocal_19, 0.99f) && __LIB_0__::func_264(&uLocal_65) > IntToFloat(iLocal_68))
	{
...
bool func_95(var uParam0)
{
	if (!bLocal_63)
	{
		if (ENTITY::IS_ENTITY_OCCLUDED(__LIB_7__::func_30(uParam0, iLocal_21)))
		{
			ENTITY::SET_ENTITY_COORDS(__LIB_7__::func_30(uParam0, iLocal_21), vLocal_51, true, false, true, true);
			ENTITY::SET_ENTITY_ROTATION(__LIB_7__::func_30(uParam0, iLocal_21), vLocal_54, 2, true);
			bLocal_63 = true;
		}
	}
	if (!bLocal_64)
	{
		if (ENTITY::IS_ENTITY_OCCLUDED(__LIB_7__::func_30(uParam0, iLocal_22)))
		{
			ENTITY::SET_ENTITY_COORDS(__LIB_7__::func_30(uParam0, iLocal_22), vLocal_57, true, false, true, true);
			ENTITY::SET_ENTITY_ROTATION(__LIB_7__::func_30(uParam0, iLocal_22), vLocal_60, 2, true);
			bLocal_64 = true;
		}
	}
...
int func_379(int iParam0, bool bParam1, bool bParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7, bool bParam8, bool bParam9, int iParam10)
{
	...
	switch (Global_1360165[iParam0 /*1157*/].f_70.f_12)
	{
		case 0:
			...
			{
				if (!__LIB_0__::func_851(iParam0) && func_409(iParam0, &uVar4))
				{
