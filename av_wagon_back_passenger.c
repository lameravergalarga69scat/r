...
void __EntryFunction__()
{
	...
	iLocal_94 = joaat("PG_RE_CHECKPOINT01X");
	Var0.f_1 = -1;
	Var0.f_3.f_9 = 3;
	Var0.f_20 = 25;
...
{
	__LIB_2__::func_851(uParam0, 11013, 11229, 12240);
}
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	int iVar0;
	int iVar1;
	__LIB_2__::func_853(uParam0, "WAGON_BACK_PASSENGER", "", vParam1, vParam4);
	switch (uParam0->f_489)
	{
		case 0:
			iVar0 = __LIB_2__::func_900(__LIB_1__::func_898(), 0, 0, 1, 0, 0, 1);
			iVar1 = __LIB_2__::func_900(__LIB_1__::func_898(), 1, 0, 0, 0, 0, 1);
			iLocal_40 = __LIB_2__::func_995(__LIB_1__::func_898(), 1, 0, 0);
			break;
		case 1:
	...
	__LIB_2__::func_905(uParam0, 0, "WBPP_MAN_1", iVar0, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, -8f, 0f, 0f), vParam4.z, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	__LIB_2__::func_905(uParam0, 1, "WBPP_MAN_2", iLocal_40, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 8f, 0f, 0f), vParam4.z, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	__LIB_2__::func_905(uParam0, 2, "WBPP_MAN_3", iVar1, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 2f, -2.5f, 0f), (-90f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	__LIB_2__::func_905(uParam0, 3, "WBPP_HORSE_1", 0, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	__LIB_2__::func_905(uParam0, 4, "WBPP_HORSE_2", 0, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	__LIB_2__::func_946(uParam0, "WAGON", iLocal_38, vParam1, vParam4.z, 0, 0, 0, 0);
}
...
int func_31(var uParam0)
{
	...
	if (!uParam0->f_469[1])
	{
		if (__LIB_2__::func_908(uParam0, &uLocal_10, 0))
		{
			uParam0->f_469[1] = 1;
		}
	...
	switch (iLocal_9)
	{
		case 0:
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[2 /*14*/]))
			{
				...
				TASK::TASK_START_SCENARIO_AT_POSITION(uParam0->f_20[2 /*14*/], iLocal_96, uParam0->f_20[2 /*14*/].f_5, uParam0->f_20[2 /*14*/].f_8, 0, false, true, 0, -1f, false);
		...
		case 3:
			...
			if (__LIB_2__::func_892(uParam0, uParam0->f_493, uParam0->f_494, 4, uParam0->f_495, 1112014848 /* Float: 50f */) || __LIB_1__::func_285(&uLocal_41, 15f))
			{
				__LIB_2__::func_925(uParam0);
				if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
				{
					__LIB_1__::func_326(uParam0->f_20[0 /*14*/], 869278708, joaat("UNSPECIFIED"));
					PED::SET_PED_KEEP_TASK(uParam0->f_20[0 /*14*/], true);
				}
				if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[2 /*14*/]))
				{
		...
		case 1:
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
			{
				TASK::TASK_SMART_FLEE_PED(uParam0->f_20[1 /*14*/], Global_35, -1f, -1, 0, 1077936128 /* Float: 3f */, 0);
				PED::SET_PED_KEEP_TASK(uParam0->f_20[1 /*14*/], true);
			}
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[2 /*14*/]))
			{
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[iVar0 /*14*/]))
			{
				if (!uParam0->f_469[1])
				{
					if (iVar0 == 0)
					{
						if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[iVar0 /*14*/]))
						{
							if (!__LIB_0__::func_163(uParam0->f_20[iVar0 /*14*/], -258271821))
							{
					...
					if (iVar0 == 2)
					{
						if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[iVar0 /*14*/]))
						{
							if (!__LIB_0__::func_163(uParam0->f_20[iVar0 /*14*/], -1794415470))
							{
