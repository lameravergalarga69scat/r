...
bool func_3(var uParam0)
{
	...
	switch (uParam0->f_464)
	{
		...
		case 2:
			...
			break;
		case 3:
			if (__LIB_2__::func_844(uParam0) && __LIB_2__::func_911(uParam0))
			{
				uParam0->f_464 = 5;
			}
			else
...
{
	__LIB_2__::func_851(uParam0, 10825, 10889, 11738);
}

void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	__LIB_2__::func_853(uParam0, "BIG_CAT_KILL_RACCOON", "script@ambient@animal@BIG_CAT_KILL_RACCOON@action", vParam1, vParam4);
	uParam0->f_16 = 1;
	__LIB_2__::func_854(uParam0, 1, "pbl_action", "", 0);
	__LIB_2__::func_855(uParam0, 0, "COUGAR", iLocal_9, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 0);
	__LIB_2__::func_855(uParam0, 1, "RACCOON", iLocal_10, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 0);
}
...
int func_31(var uParam0)
{
	...
	if (uParam0->f_469[0])
	{
		if (__LIB_1__::func_285(&uLocal_42, 8f))
		{
			if (!bLocal_46)
			{
				if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
					...
					if (ANIMSCENE::_DOES_ANIM_SCENE_EXIST(uParam0->f_3.f_1))
					{
						if (ANIMSCENE::_IS_ANIM_SCENE_LOADED(uParam0->f_3.f_1, true, false))
						{
							if (ANIMSCENE::_0x1F0E401031E20146(uParam0->f_3.f_1, "pbl_action"))
							{
								...
								{
									__LIB_0__::func_634(&(Local_48.f_6), 50, 10, 0);
								}
								uParam0->f_469[1] = 1;
								uParam0->f_469[2] = 1;
								return 0;
