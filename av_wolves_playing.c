...
{
	__LIB_2__::func_851(uParam0, 10920, 10986, 11855);
}
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	{
		case 243:
			__LIB_2__::func_853(uParam0, "WOLVES_PLAYING_TOGETHER", "script@ambient@animal@WOLVES_PLAYING_TOGETHER@action", vParam1, vParam4);
			iLocal_37 = joaat("A_C_WOLF");
			sLocal_38 = "WOLF1";
			sLocal_39 = "WOLF2";
			break;
		case 244:
			__LIB_2__::func_853(uParam0, "WOLVES_PLAYING_TOGETHER_B", "script@ambient@animal@wolves_playing_together_b@wolf_small@action", vParam1, vParam4);
			iLocal_37 = joaat("A_C_WOLF_SMALL");
			sLocal_38 = "WOLF_SMALL_1";
			sLocal_39 = "WOLF_SMALL_2";
			break;
		case 245:
			__LIB_2__::func_853(uParam0, "WOLVES_PLAYING_TOGETHER_C", "script@ambient@animal@wolves_playing_together_c@wolf_small@action", vParam1, vParam4);
			iLocal_37 = joaat("A_C_WOLF_SMALL");
			sLocal_38 = "WOLF_SMALL_1";
			sLocal_39 = "WOLF_SMALL_2";
			break;
	...
	__LIB_2__::func_855(uParam0, 0, sLocal_38, iLocal_37, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 0);
	__LIB_2__::func_855(uParam0, 1, sLocal_39, iLocal_37, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 0);
}
...
int func_30(var uParam0)
{
	...
	__LIB_1__::func_413(&uLocal_9, 1);
	__LIB_2__::func_906(&uLocal_9, 85);
	return 1;
}
...
int func_31(var uParam0)
{
	...
	if (!uParam0->f_469[0])
	{
		if (!bLocal_40 == 1)
		{
			if (__LIB_2__::func_908(uParam0, &uLocal_9, 1) || __LIB_1__::func_992(Global_35, uParam0->f_483, 1) < 625f)
			{
				bLocal_40 = true;
			}
		}
	...
	if (uParam0->f_469[0])
	{
		if (__LIB_1__::func_285(&uLocal_43, 3f))
		{
			return 1;
		}
	}
	if (!uParam0->f_469[0] && !bLocal_40)
	{
		...
		if (uParam0->f_469[2])
		{
			if (!uParam0->f_469[6])
			{
				if (__LIB_2__::func_889(uParam0, 3f, 50f, 4, joaat("ACTION"), 1))
				{
					__LIB_2__::func_890(*uParam0, uParam0->f_483, 1);
					uParam0->f_469[6] = 1;
				}
...
{
	if (__LIB_1__::func_992(Global_35, uParam0->f_483, 1) <= 2500f)
	{
		if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
		{
		...
		if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
		{
			if (!__LIB_0__::func_163(uParam0->f_20[1 /*14*/], 780511057))
			{
