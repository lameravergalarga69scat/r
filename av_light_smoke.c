...
void __EntryFunction__()
{
	...
	fLocal_7 = 1f;
	fLocal_8 = 1f;
	iLocal_37 = __LIB_2__::func_921(__LIB_1__::func_898());
	Var0.f_1 = -1;
	Var0.f_3.f_9 = 3;
	Var0.f_20 = 25;
...
bool func_5(var uParam0)
{
	...
	switch (uParam0->f_464)
	{
		...
		case 2:
			...
			break;
		case 3:
			if (__LIB_2__::func_996(uParam0) && __LIB_7__::func_134(uParam0))
			{
				uParam0->f_464 = 5;
			}
			else
...
{
	__LIB_2__::func_851(uParam0, 11213, 11284, 12077);
}

void func_17(var uParam0, vector3 vParam1, vector3 vParam4)
{
	__LIB_2__::func_853(uParam0, "LIGHT_SMOKE", "script@ambient@town@LIGHT_SMOKE@action", vParam1, vParam4);
	...
	__LIB_2__::func_855(uParam0, 0, "MALE_A", iLocal_37, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	__LIB_2__::func_855(uParam0, 1, "MALE_B", iLocal_37, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	__LIB_2__::func_928(uParam0, 0, "CIGARETTE_A", joaat("P_CIGARETTE01X"), 0f, 0f, 0f, 0f, 1);
	__LIB_2__::func_928(uParam0, 1, "CIGARETTE_B", joaat("P_CIGARETTE01X"), 0f, 0f, 0f, 0f, 1);
	__LIB_2__::func_928(uParam0, 3, "MATCHES", joaat("P_MATCHES01X"), 0f, 0f, 0f, 0f, 1);
	__LIB_2__::func_928(uParam0, 2, "MATCH", joaat("P_MATCHSTICK01X"), 0f, 0f, 0f, 0f, 1);
}
...
int func_34(var uParam0)
{
	...
	if (!uParam0->f_469[0])
	{
		if (!uParam0->f_469[1])
		{
			...
			{
				if (__LIB_2__::func_892(uParam0, 0.5f, 80f, 4, 1109393408 /* Float: 40f */, 1112014848 /* Float: 50f */))
				{
		...
		if (uParam0->f_469[2] && !uParam0->f_469[3])
		{
			if (!uParam0->f_469[6])
			{
				if (__LIB_2__::func_889(uParam0, 1.5f, 1116471296 /* Float: 70f */, 4, joaat("ACTION"), 1))
				{
					__LIB_2__::func_890(*uParam0, uParam0->f_483, 0);
					uParam0->f_469[6] = 1;
				}
					...
					if (ANIMSCENE::_0x1F0E401031E20146(uParam0->f_3.f_1, "pbl_action"))
					{
						...
						if (!uParam0->f_469[5])
						{
							if (ANIMSCENE::_0x005E6F28DD7ED58D(uParam0->f_3.f_1, uParam0->f_20[1 /*14*/].f_1))
							{
								...
								__LIB_1__::func_473(uParam0->f_20[1 /*14*/], joaat("WORLD_HUMAN_SMOKE"), 60000, 0, joaat("WORLD_HUMAN_SMOKE_MALE_C"), 0.7f);
