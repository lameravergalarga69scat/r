...
bool func_72(var uParam0)
{
	...
	__LIB_7__::func_47(uParam0, 1.6482f, -2.2638f, 0.5445f, 80f, 1.7f, 1.7f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_JACK"), 1, 1, 1);
	__LIB_6__::func_958(uParam0, joaat("P_JAVIERKNIFE_TEMP"), 0f, 0f, 0f, "KNIFE", 0, 1, 1);
	__LIB_6__::func_958(uParam0, joaat("P_WOODWHITTLE01X"), 0f, 0f, 0f, "STICK", 0, 1, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@jack_2@base", 1, 1, 0, 0);
	iLocal_15 = __LIB_6__::func_959(uParam0, "script@vignette@jack_2@action_a", 2, 0, 1, 0);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@jack_2@action_b", 2, 0, 0, 0);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@jack_2@action_b_alt_left", 2, 0, 0, 1);
	iLocal_18 = __LIB_6__::func_959(uParam0, "script@vignette@jack_2@action_b_alt_right", 2, 0, 0, 1);
	iLocal_19 = __LIB_6__::func_959(uParam0, "script@vignette@jack_2@exit_jack", 0, 0, 0, 0);
	iVar0 = MISC::GET_RANDOM_INT_IN_RANGE(0, 2);
	if (iVar0 == 0)
	{
		iLocal_20 = __LIB_6__::func_959(uParam0, "script@vignette@jack_2@exit_left", 0, 0, 0, 0);
	}
	else
	{
		iLocal_20 = __LIB_6__::func_959(uParam0, "script@vignette@jack_2@exit_right", 0, 0, 0, 0);
	}
	__LIB_7__::func_146(uParam0, "CJCK2AU");
	func_155(uParam0, iLocal_14, 3, 0);
	func_156(uParam0, iLocal_14, 3, joaat("WORLD_CAMP_JACK_SKY"), 0, -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_147(uParam0, iLocal_14, 4, 4, 0, 0, 0);
	Local_21 = { __LIB_7__::func_160(uParam0, 1.975f, -2.385f, 1.0875f, -40f, 6.03f, 0.5775f, 0.398f) };
	Local_31 = { __LIB_7__::func_160(uParam0, 1.975f, -2.385f, 1.0875f, -95f, 6.03f, 0.2125f, 0.25f) };
	return true;
}
...
bool func_93(var uParam0)
{
	...
	if (__LIB_7__::func_40(uParam0, iLocal_20, 0.995f))
	{
		__LIB_7__::func_154(uParam0, iLocal_19, 1);
	}
	return true;
...
void func_155(var uParam0, int iParam1, int iParam2, int iParam3)
{
	...
	switch (iParam2)
	{
		case 4:
			...
			break;
		default:
			Var0 = { func_255(__LIB_0__::func_78(uParam0), __LIB_7__::func_120(uParam0, iParam1), __LIB_4__::func_576(uParam0), 1) };
