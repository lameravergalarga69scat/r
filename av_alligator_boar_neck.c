...
{
	__LIB_2__::func_851(uParam0, 10828, 10886, 11576);
}

void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	__LIB_2__::func_853(uParam0, "GATOR_BOAR_NECK", "script@ambient@animal@alligator_ambush_boar_neck@action", vParam1, vParam4);
...
int func_31(var uParam0)
{
	...
	if (!uParam0->f_469[0])
	{
		if (!bLocal_39)
		{
			if (__LIB_2__::func_908(uParam0, &uLocal_11, 1) || __LIB_1__::func_992(Global_35, uParam0->f_483, 1) < 225f)
			{
				bLocal_39 = true;
			}
		}
	...
	if (uParam0->f_469[0])
	{
		if (__LIB_1__::func_285(&uLocal_42, 3f))
		{
			return 1;
		}
	}
	if (!uParam0->f_469[0] && !bLocal_39)
	{
		...
		if (uParam0->f_469[2])
		{
			if (!uParam0->f_469[5])
			{
				if (__LIB_2__::func_889(uParam0, 2f, 1116471296 /* Float: 70f */, 4, joaat("ACTION"), 1))
				{
					__LIB_2__::func_890(*uParam0, uParam0->f_483, 1);
					uParam0->f_469[5] = 1;
				}
