...
bool func_72(var uParam0)
{
	...
	__LIB_7__::func_47(uParam0, -0.7624f, -8.755f, 1.4875f, 0f, 1.2f, 1.2f, 3.2075f, joaat("VOLBOX"), joaat("APMS_COMP_JAVIER"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, 0.891524f, -2.01747f, 1.00526f, 0f, 1.2f, 1.2f, 3.2075f, joaat("VOLBOX"), joaat("APMS_COMP_PEARSON"), 1, 1, 1);
	__LIB_6__::func_958(uParam0, joaat("P_CIGARETTE_CS01X"), 0f, 0f, 0f, "CIGARETTE", 0, 1, 1);
	__LIB_6__::func_958(uParam0, joaat("P_KNIFE03X"), 0f, 0f, 0f, "KNIFE", 0, 1, 1);
	__LIB_6__::func_958(uParam0, joaat("P_POTATOHALF01X"), 0f, 0f, 0f, "POTATO01", 0, 1, 1);
	__LIB_6__::func_958(uParam0, joaat("P_POTATOHALF01X"), 0f, 0f, 0f, "POTATO02", 0, 1, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@pearson_13@base", 1, 1, 0, 0);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@pearson_13@action_a", 2, 0, 1, 0);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@pearson_13@action_b", 0, 0, 0, 0);
	iLocal_18 = __LIB_6__::func_959(uParam0, "script@vignette@pearson_13@action_b_alt_backright", 0, 0, 0, 1);
	iLocal_19 = __LIB_6__::func_959(uParam0, "script@vignette@pearson_13@action_b_alt_backleft", 0, 0, 0, 1);
	iLocal_20 = __LIB_6__::func_959(uParam0, "script@vignette@pearson_13@action_b_alt_front", 0, 0, 0, 1);
	iLocal_21 = __LIB_6__::func_959(uParam0, "script@vignette@pearson_13@action_b_alt_left", 0, 0, 0, 1);
	iLocal_22 = __LIB_6__::func_959(uParam0, "script@vignette@pearson_13@action_b_alt_discovered", 0, 0, 0, 1);
	iLocal_23 = __LIB_6__::func_959(uParam0, "script@vignette@pearson_13@action_b_alt_undiscovered", 0, 0, 0, 1);
	__LIB_7__::func_146(uParam0, "CPR13AU");
	__LIB_7__::func_127(uParam0, iLocal_14, 4, joaat("PROP_HUMAN_FOODPREP_STEW"), "PROP_HUMAN_FOODPREP_STEW_GRAB_POTATO_MALE_B", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_156(uParam0, iLocal_14, 4, 1);
	__LIB_7__::func_151(uParam0, iLocal_14, 2, -1);
	__LIB_7__::func_107(uParam0, iLocal_15, 3, joaat("WORLD_HUMAN_SMOKE"), "WORLD_HUMAN_SMOKE_MALE_C", -1, 1);
	Local_26 = { __LIB_7__::func_160(uParam0, 0.6f, -1.4085f, 0.9877f, 102f, 6.5f, 0.4775f, 0.3f) };
	Local_36 = { __LIB_7__::func_160(uParam0, 0.6f, -1.409f, 0.9877f, 178f, 6.5f, 0.3765f, 0.364f) };
	Local_46 = { __LIB_7__::func_160(uParam0, 0.6f, -1.4085f, 0.9877f, -120.96f, 6.5f, 0.215f, 0.3f) };
	Local_56 = { __LIB_7__::func_160(uParam0, 0.6f, -1.409f, 0.9877f, -90.25f, 6.5f, 0.095f, 0.124f) };
	if (func_160(0))
	{
		__LIB_7__::func_230(uParam0, 0f, 0f, 0f, 0f);
		__LIB_7__::func_231(uParam0, 0f, 0f, 0f, 0f);
	}
	return true;
}
...
bool func_93(var uParam0)
{
	if (__LIB_7__::func_148(uParam0, iLocal_16))
	{
		...
		else if (__LIB_7__::func_163(uParam0, Local_56, 1, 0))
		{
			iLocal_24 = iLocal_18;
		}
		else
		...
		if (iLocal_24 > 0)
		{
			...
			__LIB_7__::func_173(uParam0, iLocal_25, 0);
		}
	}
	if (__LIB_7__::func_169(uParam0, iLocal_25))
	{
		return __LIB_7__::func_148(uParam0, iLocal_25);
	}
	return true;
}
...
void func_156(var uParam0, int iParam1, int iParam2, int iParam3)
{
	...
	switch (iParam2)
	{
		case 4:
			...
			break;
		default:
			Var0 = { func_261(__LIB_0__::func_78(uParam0), __LIB_7__::func_120(uParam0, iParam1), __LIB_4__::func_576(uParam0), 1) };
...
bool func_245(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (Global_1898164.f_1[0 /*5*/].f_2 == 8)
	{
		...
		if (func_262(iVar0) && __LIB_0__::func_1(Global_1347702[iVar0 /*49*/].f_12, 131072))
		{
			return false;
		}
	}
