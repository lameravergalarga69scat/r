...
bool func_72(var uParam0)
{
	...
	{
		case 6:
			__LIB_7__::func_45(uParam0, 7, 0, 0, 0);
			break;
		default:
			return false;
	}
	iLocal_15 = __LIB_7__::func_48(uParam0, 19, "SusanGrimshaw");
	iLocal_14 = __LIB_7__::func_48(uParam0, 22, 0);
	__LIB_7__::func_47(uParam0, 4.505f, 7.6925f, 0.85f, -65.75f, 1f, 1f, 3.2075f, joaat("VOLBOX"), joaat("APMS_COMP_GRIMSHAW"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, 8.1249f, 2.6499f, 0.85f, 0f, 4.4575f, 3.4825f, 3.2075f, joaat("VOLBOX"), joaat("APMS_COMP_TILLY"), 1, 1, 1);
	__LIB_7__::func_317(uParam0, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@tilly_5@base", 1, 1, 0, 0);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@tilly_5@Action_A", 2, 0, 1, 0);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@tilly_5@Action_A_Int_Front", 2, 0, 0, 1);
	iLocal_18 = __LIB_6__::func_959(uParam0, "script@vignette@tilly_5@Action_A_Int_Left", 2, 0, 0, 1);
	iLocal_19 = __LIB_6__::func_959(uParam0, "script@vignette@tilly_5@Action_A_Int_Right", 2, 0, 0, 1);
	iLocal_20 = __LIB_6__::func_959(uParam0, "script@vignette@tilly_5@Action_B", 0, 0, 0, 0);
	__LIB_7__::func_146(uParam0, "CCTL5AU");
	__LIB_7__::func_149(uParam0, joaat("COMP_TLLCNV5"), joaat("PLAYER_TLLCNV5"));
	...
	__LIB_7__::func_127(uParam0, iLocal_15, 3, joaat("WORLD_HUMAN_SMOKE"), "WORLD_HUMAN_SMOKE_FEMALE_A", -1, 0, 50f, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_171(uParam0, iLocal_15, 3, 0);
	__LIB_7__::func_151(uParam0, iLocal_15, 1, -1);
	Local_21 = { __LIB_7__::func_160(uParam0, 8.8275f, 2.715f, 1.8254f, 176.75f, 7f, 0.21f, 0.4225f) };
	Local_41 = { __LIB_7__::func_160(uParam0, 8.7175f, 2.685f, 1.8254f, 127.5f, 7f, 0.12f, 0.415f) };
	Local_31 = { __LIB_7__::func_160(uParam0, 8.73f, 2.685f, 1.8254f, -80.64f, 7f, 0.0425f, 0.415f) };
	return true;
}
...
bool func_86(var uParam0)
{
	...
	while (iVar0 < 3)
	{
		if (__LIB_0__::func_272(Global_1357549.f_1675[iVar0 /*5*/].f_3, 0) && (__LIB_1__::func_205(Global_1357549.f_1675[iVar0 /*5*/].f_3, uParam0->f_36[0 /*5*/], 1, 0) || __LIB_1__::func_205(Global_1357549.f_1675[iVar0 /*5*/].f_3, uParam0->f_36[1 /*5*/], 1, 0)))
		{
