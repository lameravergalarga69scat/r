...
bool func_72(var uParam0)
{
	...
	{
		case 8:
			__LIB_7__::func_45(uParam0, 45, 0, 0, 0);
			__LIB_7__::func_116(uParam0, -1574.26f, -1401.787f, 80.78f, 0f, 0f, -180f);
			break;
		default:
			return false;
	}
	iLocal_14 = __LIB_7__::func_48(uParam0, 7, 0);
	iLocal_15 = __LIB_7__::func_165(uParam0, 7, "HORSE", 1);
	__LIB_6__::func_958(uParam0, joaat("P_BRUSHHORSE01X"), 0f, 0f, 0f, "BRUSH", 0, 1, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@beecher@charles_3@base", 1, 1, 0, 0);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@beecher@charles_3@action_a", 2, 0, 1, 1);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@beecher@charles_3@action_b", 0, 0, 0, 1);
	__LIB_7__::func_149(uParam0, joaat("COMP_BCCHRCNV3"), joaat("PLAYER_BCCHRCNV3"));
	__LIB_7__::func_146(uParam0, "BCHR3AU");
	__LIB_7__::func_127(uParam0, iLocal_14, 2, joaat("WORLD_HUMAN_HORSE_TEND_BRUSH_LINK"), "WORLD_HUMAN_HORSE_TEND_BRUSH_LINK_MALE_A", -1, 1, 38f, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_151(uParam0, iLocal_14, 1, -1);
	iLocal_18 = __LIB_7__::func_156(uParam0, -0.31f, 9.12f, 0f, 0f, 0f, 0f, 10f, 10f, 5f, "volTrigger", joaat("VOLBOX"));
...
bool func_83(var uParam0)
{
	if (!bLocal_19)
	{
		...
		bLocal_19 = true;
		__LIB_7__::func_391(7, __LIB_6__::func_952(uParam0, iLocal_15));
		return false;
	}
	return bLocal_19;
}
...
bool func_93(var uParam0)
{
	...
	if (__LIB_7__::func_169(uParam0, iLocal_17))
	{
		...
		{
			TASK::_TASK_START_SCENARIO_IN_PLACE(__LIB_6__::func_952(uParam0, iLocal_15), joaat("STAND"), 45000, false, 0, 1f, false);
		}
	}
	return true;
}
