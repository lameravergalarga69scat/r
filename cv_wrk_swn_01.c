...
bool func_72(var uParam0)
{
	...
	{
		case 1:
			__LIB_7__::func_424(uParam0);
			break;
		case 2:
			__LIB_7__::func_425(uParam0);
			break;
	}
	__LIB_7__::func_146(uParam0, "CSWK1AU");
	iLocal_16 = __LIB_7__::func_48(uParam0, 17, "MrPearson");
	iLocal_15 = __LIB_7__::func_48(uParam0, 21, "RevSwanson");
	__LIB_6__::func_958(uParam0, joaat("P_CIGARLIT01X"), 0f, 0f, 0f, "p_cigarlit01x", 0, 1, 1);
	__LIB_6__::func_958(uParam0, joaat("P_CIGARLIT01X"), 0f, 0f, 0f, "p_cigarlit01x^1", 0, 1, 1);
	iLocal_14 = __LIB_6__::func_958(uParam0, joaat("S_LOOTABLECAMPCASE"), 0f, 0f, 0f, "s_lootablecampcase", 1, 0, 1);
	__LIB_6__::func_958(uParam0, joaat("P_COIN01X"), 0f, 0f, 0f, "p_coin01x", 0, 1, 1);
	__LIB_7__::func_47(uParam0, 0.8625f, -0.325f, 0f, -13.5f, 1.665f, 2.31f, 5f, joaat("VOLBOX"), -1, 1, 1, 1);
	__LIB_7__::func_47(uParam0, -1.7625f, 2.9f, 0f, -13.5f, 1f, 1f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_PEARSON"), 1, 1, 1);
	__LIB_7__::func_149(uParam0, joaat("COMP_SWNWRKCNV1"), joaat("PLAYER_SWNWRKCNV1"));
	__LIB_7__::func_107(uParam0, iLocal_16, 3, joaat("WORLD_HUMAN_SMOKE"), "WORLD_HUMAN_SMOKE_MALE_A", -1, 1);
	__LIB_7__::func_151(uParam0, iLocal_16, 1, -1);
	__LIB_7__::func_107(uParam0, iLocal_15, 3, joaat("WORLD_HUMAN_SMOKE_NERVOUS_STRESSED"), "WORLD_HUMAN_SMOKE_NERVOUS_STRESSED_MALE_B", -1, 1);
	__LIB_7__::func_151(uParam0, iLocal_15, 1, -1);
	__LIB_7__::func_147(uParam0, iLocal_15, 4, 3, 0, 0, 0);
	__LIB_6__::func_959(uParam0, "script@vignette@wrk@swanson_work_1@base", 1, 1, 0, 0);
	__LIB_6__::func_959(uParam0, "script@vignette@wrk@swanson_work_1@action", 0, 0, 1, 0);
	return true;
}
...
{
	if (ENTITY::DOES_ENTITY_EXIST(__LIB_7__::func_30(uParam0, iLocal_14)))
	{
		ENTITY::FREEZE_ENTITY_POSITION(__LIB_7__::func_30(uParam0, iLocal_14), true);
	}
	return true;
}
