...
{
	__LIB_2__::func_851(uParam0, 10732, 10769, 11767);
}

void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	__LIB_2__::func_853(uParam0, "EAGLE_CATCH_SEASNAKE", "script@ambient@animal@EAGLE_CATCH_SEASNAKE@action", vParam1, vParam4);
	...
	__LIB_2__::func_855(uParam0, 1, "SNAKE", iLocal_10, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
}
...
int func_31(var uParam0)
{
	...
	if (!uParam0->f_469[0])
	{
		...
		if (__LIB_2__::func_908(uParam0, &uLocal_11, 0) || __LIB_0__::func_232(uParam0->f_20[0 /*14*/], Global_35, 1) < 225f)
		{
