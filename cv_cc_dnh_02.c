...
bool func_72(var uParam0)
{
	...
	{
		case 0:
			__LIB_7__::func_116(uParam0, -1353.042f, 2440.511f, 310.3f, 0f, 0f, -20f);
			break;
		default:
			return false;
	}
	...
	__LIB_6__::func_958(uParam0, joaat("P_CHAIR24X"), 0f, 0f, 0f, "p_chair04x", 0, 0, 1);
	__LIB_7__::func_47(uParam0, 1.73738f, -1.67007f, -1.92981f, 0f, 1.2f, 1.2f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_DUTCH"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, 1.5599f, 1.30484f, -1.93771f, 0f, 1.2f, 1.2f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_HOSEA"), 1, 1, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@dutch_and_hosea_2@base", 1, 1, 0, 0);
	__LIB_6__::func_959(uParam0, "script@vignette@dutch_and_hosea_2@action", 0, 0, 1, 0);
	__LIB_7__::func_146(uParam0, "CDH2AUD");
	__LIB_7__::func_149(uParam0, joaat("COMP_DNHCNV2"), joaat("PLAYER_DNHCNV2"));
	__LIB_7__::func_107(uParam0, iLocal_14, 3, joaat("WORLD_CAMP_FIRE_STANDING"), "WORLD_CAMP_FIRE_STANDING_MALE_E", -1, 1);
	__LIB_7__::func_235(uParam0, iLocal_14, "Colter/col_default_dutch_CCDNH_CNV2");
	__LIB_7__::func_229(uParam0, iLocal_14);
	__LIB_7__::func_144(uParam0, iLocal_14, 1.5f, 1065353216 /* Float: 1f */, 1092616192 /* Float: 10f */);
	__LIB_7__::func_151(uParam0, iLocal_14, 1, -1);
	__LIB_7__::func_107(uParam0, iLocal_15, 2, joaat("PROP_CAMP_FIRE_SEATED"), "PROP_CAMP_FIRE_SEATED_MALE_K", -1, 0);
	__LIB_7__::func_153(uParam0, iLocal_15, 2, joaat("PROP_CAMP_FIRE_SEATED"), "PROP_CAMP_FIRE_SEATED_MALE_K", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_137(uParam0, iLocal_15, "START_SEATED_MALE_K_TO_SEAT_BENCH_MALE_A");
	__LIB_7__::func_151(uParam0, iLocal_15, 1, -1);
	__LIB_7__::func_145(uParam0, 8f, 10f);
...
bool func_93(var uParam0)
{
	if (!uParam0->f_107[iLocal_14 /*113*/].f_32)
	{
		...
		{
			PED::FORCE_PED_MOTION_STATE(__LIB_6__::func_952(uParam0, iLocal_14), -1415276238, false, 1, false);
			PERSCHAR::_0x631CD2D77FDC0316(__LIB_0__::func_748(0, 0));
		}
	}
	return true;
}
...
int func_332(int iParam0, bool bParam1)
{
	...
	if (!func_364(iParam0) && __LIB_0__::func_2() == -1)
	{
		return 0;
	}
