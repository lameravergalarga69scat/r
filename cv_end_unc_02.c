...
bool func_72(var uParam0)
{
	...
	{
		case 8:
			__LIB_7__::func_116(uParam0, -1599.06f, -1407.587f, 80.9358f, 0f, 0f, 155f);
			break;
		default:
			return false;
	}
	iLocal_14 = __LIB_7__::func_48(uParam0, 4, 0);
	iLocal_15 = __LIB_7__::func_31(uParam0, joaat("A_C_COW"), "COW");
	__LIB_7__::func_159(uParam0, 0f, 1.65f, 0f, 0f, 1.5f, 1.5f, 3f, joaat("VOLCYLINDER"), 1);
	__LIB_6__::func_958(uParam0, joaat("P_STOOL02X"), 0f, 0f, 0f, "STOOL", 0, 0, 1);
	__LIB_6__::func_958(uParam0, joaat("P_CS_BUCKET01X"), 0f, 0f, 0f, "BUCKET", 0, 0, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@beecher@uncle_2@base", 1, 1, 0, 0);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@beecher@uncle_2@action_a", 2, 0, 1, 1);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@beecher@uncle_2@action_b", 2, 0, 0, 1);
	iLocal_18 = __LIB_6__::func_959(uParam0, "script@vignette@beecher@uncle_2@action_c", 2, 0, 0, 1);
	iLocal_21 = __LIB_6__::func_959(uParam0, "script@vignette@beecher@uncle_2@exit_to_base", 2, 0, 0, 0);
	iLocal_20 = __LIB_6__::func_959(uParam0, "script@vignette@beecher@uncle_2@idle_a", 1, 0, 0, 0);
	iLocal_19 = __LIB_6__::func_959(uParam0, "script@vignette@beecher@uncle_2@exit", 0, 0, 0, 0);
	__LIB_7__::func_146(uParam0, "BUNC2AU");
	Local_24 = { __LIB_7__::func_160(uParam0, 0.8885f, 2.365f, 0.938f, 32.76f, 7f, 0.7f, 0.5648f) };
	...
	__LIB_7__::func_153(uParam0, iLocal_15, 2, joaat("STAND"), 0, -1, 0, -1f, 1065353216 /* Float: 1f */, 1);
	return true;
}
...
bool func_87(var uParam0)
{
	...
	if (!bLocal_22)
	{
		iVar0 = __LIB_6__::func_952(uParam0, iLocal_14);
	...
	return __LIB_7__::func_163(uParam0, Local_24, 1, 0);
}
...
bool func_93(var uParam0)
{
	...
	if ((__LIB_7__::func_169(uParam0, iLocal_20) && MISC::GET_GAME_TIMER() > iLocal_23) && ENTITY::IS_ENTITY_OCCLUDED(__LIB_6__::func_952(uParam0, iLocal_14)))
	{
		__LIB_7__::func_173(uParam0, iLocal_19, 1);
	}
	if (ANIMSCENE::_0x005E6F28DD7ED58D(uParam0->f_1984[iLocal_20], "COW"))
	{
		TASK::TASK_STAND_STILL(__LIB_6__::func_952(uParam0, iLocal_15), -1);
	}
	return true;
}
...
{
	if (__LIB_1__::func_992(Global_35, uParam0->f_23, 1) > (50f * 50f) && !CAM::IS_SPHERE_VISIBLE(uParam0->f_23, 1f))
	{
		__LIB_7__::func_370(uParam0, iLocal_15);
		return true;
	}
	return false;
}
...
int func_386(int iParam0, bool bParam1, bool bParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7, bool bParam8, bool bParam9, int iParam10)
{
	...
	switch (Global_1360165[iParam0 /*1157*/].f_70.f_12)
	{
		case 0:
			...
			{
				if (!__LIB_0__::func_851(iParam0) && func_416(iParam0, &uVar4))
				{
