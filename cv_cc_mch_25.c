...
bool func_72(var uParam0)
{
	...
	__LIB_7__::func_47(uParam0, -0.5643f, -1.2972f, 0.5073f, -19.8f, 1.5f, 1.5f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_MICAH"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, 0.5259f, 1.1492f, 0.5633f, -23.04f, 1.5f, 1.5f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_BILL"), 1, 1, 1);
	iLocal_17 = __LIB_7__::func_142(uParam0, joaat("P_CHAIR_BARREL04B"), -0.585f, -1.372f, -0.001f, 0, 1, 0, 1);
	iLocal_16 = __LIB_7__::func_142(uParam0, joaat("P_CHAIR_CRATE15X"), 0.636f, 1.325f, -0.004f, 0, 1, 0, 1);
	__LIB_7__::func_142(uParam0, joaat("P_CIGARETTE_CS01X"), 0f, 0f, 0f, "CIGARETTE", 0, 1, 1);
	__LIB_7__::func_142(uParam0, joaat("P_MATCHSTICK01X"), 0f, 0f, 0f, "MATCH", 0, 1, 1);
	...
	__LIB_6__::func_959(uParam0, "script@vignette@micah_25@base", 1, 1, 0, 0);
	__LIB_6__::func_959(uParam0, "script@vignette@micah_25@action", 0, 0, 1, 0);
	__LIB_7__::func_146(uParam0, "CCM25AU");
	__LIB_7__::func_151(uParam0, iLocal_14, 1, -1);
	__LIB_7__::func_127(uParam0, iLocal_15, 3, joaat("PROP_CAMP_SEAT_CHAIR_TABLE_STEW"), "PROP_CAMP_SEAT_CHAIR_TABLE_STEW_EATING_MALE_A", iLocal_16, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_139(uParam0, iLocal_15, iLocal_18, "p_bowl04x_stew_PH_L_HAND", 0, 0);
	...
	__LIB_7__::func_149(uParam0, joaat("COMP_MCHCNV25"), joaat("PLAYER_MCHCNV25"));
	return true;
}
...
bool func_86(var uParam0)
{
	...
	if (iLocal_16 != -1)
	{
		...
		{
			ENTITY::SET_ENTITY_COORDS(iVar0, __LIB_6__::func_972(uParam0, 0.638596f, 1.2423f, -0.00779724f), true, false, true, true);
		}
	}
	if (iLocal_17 != -1)
	{
		iVar1 = __LIB_7__::func_30(uParam0, iLocal_17);
		if (ENTITY::DOES_ENTITY_EXIST(iVar1))
		{
			ENTITY::SET_ENTITY_COORDS(iVar1, __LIB_6__::func_972(uParam0, -0.581406f, -1.2677f, 0.00219727f), true, false, true, true);
		}
	}
