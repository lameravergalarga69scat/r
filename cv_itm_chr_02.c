...
bool func_1(var uParam0)
{
	if (!bLocal_43)
	{
		if (uParam0->f_9 && TASK::_DOES_SCENARIO_POINT_EXIST(uParam0->f_107[iLocal_14 /*113*/].f_8.f_23))
		{
			__LIB_7__::func_305(uParam0, iLocal_18);
			TASK::_TASK_USE_SCENARIO_POINT(uParam0->f_107[iLocal_14 /*113*/].f_5, uParam0->f_107[iLocal_14 /*113*/].f_8.f_23, uParam0->f_107[iLocal_14 /*113*/].f_8.f_2, 0, false, true, 0, false, 1f, false);
			PED::_0x2208438012482A1A(uParam0->f_107[iLocal_14 /*113*/].f_5, false, false);
			__LIB_1__::func_774(uParam0->f_107[iLocal_14 /*113*/].f_1, 0, 0, 0, 15f, 1, 1, 0, 0, 0, 0);
			bLocal_43 = true;
			return false;
		}
	}
...
bool func_94(var uParam0)
{
	...
	__LIB_7__::func_47(uParam0, -2.2375f, -0.5425f, 0f, 18.75f, 1.15f, 1.275f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_CHARLES"), 1, 1, 1);
	iLocal_17 = __LIB_6__::func_958(uParam0, joaat("P_CS_ARROW01X"), 0f, 0f, 0f, "ARROW", 0, 1, 1);
	__LIB_6__::func_958(uParam0, joaat("S_RC_POISONEDWATER01X"), 0f, 0f, 0f, "Poison", 0, 0, 1);
	iLocal_18 = __LIB_6__::func_958(uParam0, joaat("P_CS_MOONSHINERAG01X"), 0f, 0f, 0f, "RAG", 0, 0, 1);
	iLocal_19 = __LIB_6__::func_958(uParam0, joaat("P_CHAIR_CRATE02X"), -1.86272f, -0.829352f, -0.0207291f, 0, 1, 0, 1);
	vLocal_37 = { __LIB_6__::func_972(uParam0, vLocal_40) };
	__LIB_7__::func_385(uParam0, 1839120979, vLocal_40, -81.25f);
	iLocal_15 = __LIB_6__::func_959(uParam0, "script@vignette@itm@charles_2@base", 1, 0, 0, 0);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@itm@charles_2@action", 0, 0, 0, 1);
	__LIB_7__::func_146(uParam0, "CCHI2AU");
	__LIB_7__::func_107(uParam0, iLocal_14, 3, joaat("PROP_CAMP_CHARLES_SEAT_CHAIR_ARROW_FLETCH"), "PROP_CAMP_CHARLES_SEAT_CHAIR_ARROW_FLETCH_MALE_A", iLocal_19, 0);
	__LIB_7__::func_127(uParam0, iLocal_14, 3, joaat("PROP_CAMP_CHARLES_SEAT_CHAIR_ARROW_FLETCH"), "PROP_CAMP_CHARLES_SEAT_CHAIR_ARROW_FLETCH_MALE_A", iLocal_19, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_139(uParam0, iLocal_14, iLocal_17, "p_cs_arrow01x_PH_L_HAND", 0, 0);
	__LIB_7__::func_151(uParam0, iLocal_14, 2, -1);
	Local_20 = { __LIB_7__::func_160(uParam0, -1.7f, -0.8975f, 0.5054f, 96.5507f, 5.5f, 0.65f, 0.65f) };
...
bool func_97(var uParam0)
{
	if (!bLocal_31)
	{
		if (!CAM::IS_SPHERE_VISIBLE(vLocal_37, 1.4f))
		{
			MISC::CLEAR_AREA(vLocal_37, 1f, 2097152);
			bLocal_31 = true;
		}
	}
	return bLocal_31;
...
int func_109(var uParam0)
{
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_35))
	{
		...
		{
			iLocal_35 = __LIB_7__::func_386(uParam0->f_1976.f_6, joaat("P_MORTARPESTLE02X"), 0);
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_35))
			{
				ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iLocal_35, true, false);
			}
		}
	}
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_35) && !bLocal_32)
	{
		__LIB_7__::func_346(uParam0, iLocal_35, "MortarPestle");
		bLocal_32 = true;
	}
...
bool func_112(var uParam0)
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(__LIB_6__::func_952(uParam0, iLocal_14)))
	{
		PLAYER::_0x3946FC742AC305CD(PLAYER::PLAYER_ID(), __LIB_6__::func_952(uParam0, iLocal_14), sLocal_36, 0f, 0f, 0f, 0, sLocal_36);
		MISC::_0xE98D55C5983F2509(__LIB_6__::func_952(uParam0, iLocal_14));
	}
	__LIB_7__::func_99(uParam0, iLocal_16, 1);
	return true;
}

bool func_115(var uParam0)
{
	if (__LIB_7__::func_272(__LIB_6__::func_952(uParam0, iLocal_14), -1457502635))
	{
		PLAYER::_0xC67A4910425F11F1(PLAYER::PLAYER_ID(), sLocal_36);
		func_220(4, 7, 1);
	}
...
int func_211(var uParam0)
{
	...
	{
		iLocal_33 = __LIB_2__::func_403("INTERACT_GREET", joaat("INPUT_INTERACT_LOCKON_POS"), __LIB_6__::func_952(uParam0, iLocal_14), 3, 0, 0, 0, 0, 6f, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, joaat("SHORT_TIMED_EVENT"), 0, 0);
		__LIB_4__::func_12(iLocal_33, HUD::_UIPROMPT_GET_GROUP_ID_FOR_TARGET_ENTITY(__LIB_6__::func_952(uParam0, iLocal_14)), 0, 1);
	}
	...
	while (iVar0 < 10)
	{
		...
		else
		{
			...
			if (bParam2)
			{
				...
				func_322(&(Global_40.f_6563[iVar0 /*27*/]), 0);
			}
...
char* func_385(int iParam0, bool bParam1)
{
	switch (iParam0)
	{
		...
		case 12:
			...
			else if (func_348(joaat("CSTAG_FLOW_DOG_IN_CAMP_POST"), 1))
			{
				return "COMP_CAIN";
			}
			return "COMP_DOG";
	...
	switch (Global_1360165[iParam0 /*1157*/].f_11)
	{
		...
		case 3:
			if (!ENTITY::IS_ENTITY_DEAD(Global_1360165[iParam0 /*1157*/]) && !ANIMSCENE::_0x3AB6C7B0BB0DF4B1(Global_1360165[iParam0 /*1157*/], -1))
			{
				...
				func_459(Global_1360165[iParam0 /*1157*/], vVar0, iParam6, 2, 1073741824 /* Float: 2f */);
			}
			else if (bParam16)
			{
...
int func_449(int iParam0, bool bParam1, bool bParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7, bool bParam8, bool bParam9, int iParam10)
{
	...
	switch (Global_1360165[iParam0 /*1157*/].f_70.f_12)
	{
		case 0:
			...
			{
				if (!func_485(iParam0) && __LIB_0__::func_852(iParam0, &uVar4))
				{
		...
		case 3:
			...
			if ((bParam2 && !__LIB_0__::func_86(vVar0)) && !__LIB_0__::func_175(vVar0, ENTITY::GET_ENTITY_COORDS(Global_1360165[iParam0 /*1157*/].f_124, true, false), 1056964608 /* Float: 0.5f */, 1))
			{
				...
				func_459(Global_1360165[iParam0 /*1157*/].f_124, vVar0, iParam6, 2, 1073741824 /* Float: 2f */);
			}
			if (bParam1)
			{
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_348(joaat("CSTAG_FLOW_MAR8_POST"), 1) && !__LIB_1__::func_25(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
