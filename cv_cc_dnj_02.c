...
bool func_72(var uParam0)
{
	...
	__LIB_7__::func_47(uParam0, -1.3087f, -0.0568f, 1.08f, 0f, 4f, 5f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_DUTCH"), 1, 1, 1);
	__LIB_7__::func_159(uParam0, -1.3087f, 0.4832f, 1.08f, 0f, 4f, 2.6f, 3f, joaat("VOLBOX"), 1);
	iLocal_15 = __LIB_6__::func_958(uParam0, joaat("P_CS_BOOKEVELYNMILLER"), 0f, 0f, 0f, "BOOK", 0, 1, 1);
	iLocal_16 = __LIB_6__::func_958(uParam0, joaat("P_LOGHALF01X"), 0f, 0f, 0f, "FIREWOOD", 0, 1, 1);
	__LIB_6__::func_958(uParam0, joaat("P_WOODPILECHOPPED01X"), 0f, 0f, 0f, "WOODPILE", 0, 0, 1);
	__LIB_6__::func_958(uParam0, joaat("P_FURNACE01X"), -2.797484f, 1.318717f, -0.002501f, "FURNACE", 1, 0, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@dutch_and_john_2@base", 1, 1, 0, 0);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@dutch_and_john_2@action_a", 2, 0, 1, 0);
	iLocal_18 = __LIB_6__::func_959(uParam0, "script@vignette@dutch_and_john_2@action_b", 0, 0, 0, 0);
	iLocal_19 = __LIB_6__::func_959(uParam0, "script@vignette@dutch_and_john_2@action_b_alt", 0, 0, 0, 1);
	__LIB_7__::func_146(uParam0, "DNJ2AUD");
	Local_20 = { __LIB_7__::func_160(uParam0, -1.865f, 0.0605f, 1.0303f, 180f, 7f, 0.491f, 0.296f) };
