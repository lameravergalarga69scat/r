...
bool func_72(var uParam0)
{
	...
	__LIB_7__::func_47(uParam0, -2.2375f, -0.6f, 1.15f, -42.44f, 4.4f, 2f, 2.685f, joaat("VOLBOX"), joaat("APMS_COMP_BILL"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, -1.1621f, 0.6703f, 0.6545f, -130.68f, 1f, 1f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_PEARSON"), 1, 1, 1);
	__LIB_6__::func_958(uParam0, joaat("P_BOTTLEBEER01X"), 0f, 0f, 0f, "BOTTLE_BILL", 0, 1, 1);
	__LIB_6__::func_958(uParam0, joaat("P_BOTTLEJD01X"), 0f, 0f, 0f, "BOTTLE_PEARSON", 0, 1, 1);
	__LIB_6__::func_958(uParam0, joaat("P_CHAIR_BARREL04B"), -0.584518f, -1.37169f, -0.000602722f, "BARREL", 1, 0, 1);
	if (!__LIB_6__::func_206(15))
	{
		__LIB_6__::func_959(uParam0, "script@vignette@bill_9@base", 1, 1, 0, 0);
	}
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@bill_9@action_a", 2, 0, 1, 0);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@bill_9@action_b", 0, 0, 0, 0);
	iLocal_18 = __LIB_6__::func_959(uParam0, "script@vignette@bill_9@action_b_alt_front", 0, 0, 0, 0);
	iLocal_19 = __LIB_6__::func_959(uParam0, "script@vignette@bill_9@action_b_alt_back", 0, 0, 0, 0);
	__LIB_7__::func_146(uParam0, "CBLL9AU");
	__LIB_7__::func_149(uParam0, joaat("COMP_BLLCNV9"), joaat("PLAYER_BLLCNV9"));
	__LIB_7__::func_107(uParam0, iLocal_14, 3, joaat("PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS"), "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_MALE_A", -1, 0);
	__LIB_7__::func_147(uParam0, iLocal_14, 2, 3, 0, "Default_Angry", 0);
	__LIB_7__::func_151(uParam0, iLocal_14, 1, -1);
	if (!__LIB_6__::func_206(15))
	{
		__LIB_7__::func_107(uParam0, iLocal_15, 3, joaat("PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS"), "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_MALE_D", -1, 0);
	}
	...
	{
		__LIB_7__::func_127(uParam0, iLocal_15, 3, joaat("WORLD_HUMAN_SIT_BACK_EXHAUSTED"), "WORLD_HUMAN_SIT_BACK_EXHAUSTED_MALE_A", -1, 0, 100f, 1065353216 /* Float: 1f */, 1);
		__LIB_7__::func_171(uParam0, iLocal_15, 3, 0);
	}
	Local_20 = { __LIB_7__::func_160(uParam0, -1.081f, -1.97f, 1f, 56.8f, 7f, 0.5f, 0.5f) };
	Local_30 = { __LIB_7__::func_160(uParam0, -1.0807f, -1.9698f, 1f, 146.88f, 7f, 0.5f, 0.5f) };
	if (__LIB_6__::func_206(15))
	{
