...
bool func_72(var uParam0)
{
	...
	{
		case 6:
			__LIB_7__::func_45(uParam0, 10, 0, 0, 0);
			break;
		default:
			return false;
	}
	...
	__LIB_7__::func_47(uParam0, -1.04f, -1.28f, 0.4194f, 0f, 3f, 3.84f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_JOHN"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, -4.56f, -7.31f, 0.1523f, 0f, 1.2f, 1.2f, 4f, joaat("VOLBOX"), joaat("APMS_COMP_DUTCH"), 1, 1, 1);
	__LIB_7__::func_159(uParam0, -1.3883f, 0.7683f, 0.9968f, 0f, 0.84f, 0.84f, 4f, joaat("VOLCYLINDER"), 1);
	__LIB_6__::func_958(uParam0, joaat("P_CS_NEWSPAPER_03X"), 0f, 0f, 0f, "NEWSPAPER", 0, 0, 1);
	iLocal_16 = __LIB_6__::func_958(uParam0, joaat("P_STOOLFOLDING01X"), -0.0196864f, -0.0395289f, -0.00128174f, 0, 1, 0, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@dutch_and_john_6@base_intro", 1, 1, 0, 0);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@dutch_and_john_6@action_a", 2, 0, 1, 0);
	iLocal_18 = __LIB_6__::func_959(uParam0, "script@vignette@dutch_and_john_6@action_b", 0, 0, 0, 0);
	iLocal_19 = __LIB_6__::func_959(uParam0, "script@vignette@dutch_and_john_6@action_b_alt_left", 0, 0, 0, 1);
	iLocal_20 = __LIB_6__::func_959(uParam0, "script@vignette@dutch_and_john_6@action_b_alt_right", 0, 0, 0, 1);
	__LIB_7__::func_146(uParam0, "CDNJ6AU");
	__LIB_7__::func_153(uParam0, iLocal_14, 3, joaat("WORLD_HUMAN_SMOKE_CIGAR"), 0, -1, 1, 60f, 1065353216 /* Float: 1f */, 1);
	func_157(uParam0, iLocal_14, 3, 0);
	__LIB_7__::func_147(uParam0, iLocal_14, 2, 24, 0, 0, 0);
	__LIB_7__::func_151(uParam0, iLocal_14, 1, -1);
	__LIB_7__::func_153(uParam0, iLocal_15, 2, joaat("GENERIC_SEAT_CHAIR_TABLE_SCENARIO"), "GENERIC_SEAT_CHAIR_TABLE_SCENARIO_RF_FWD_MALE_A", iLocal_16, 0, 10f, 0f, 1);
	__LIB_7__::func_147(uParam0, iLocal_15, 2, 1, 0, 0, 0);
	__LIB_7__::func_151(uParam0, iLocal_15, 1, -1);
	__LIB_7__::func_149(uParam0, joaat("COMP_DNJCNV6"), joaat("PLAYER_DNJCNV6"));
	Local_21 = { __LIB_7__::func_160(uParam0, -1f, 1f, 0.92f, -25f, 7.5f, 0.7f, 0.7f) };
	Local_31 = { __LIB_7__::func_160(uParam0, -1f, 1f, 0.92f, -153f, 7.5f, 0.7f, 0.7f) };
	return true;
}
...
void func_157(var uParam0, int iParam1, int iParam2, int iParam3)
{
	...
	switch (iParam2)
	{
		case 4:
			...
			break;
		default:
			Var0 = { func_259(__LIB_0__::func_78(uParam0), __LIB_7__::func_120(uParam0, iParam1), __LIB_4__::func_576(uParam0), 1) };
