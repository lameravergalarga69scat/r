...
bool func_72(var uParam0)
{
	...
	__LIB_7__::func_47(uParam0, -0.0874f, 0.9197f, 1.0429f, 0f, 1.3f, 1.3f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_LENNY"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, 0.0089f, -0.9555f, 1.0423f, 0f, 1.3f, 1.3f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_HOSEA"), 1, 1, 1);
	if (__LIB_6__::func_206(10))
	{
		iLocal_16 = __LIB_6__::func_958(uParam0, joaat("P_CHAIRFOLDING02X"), -0.00632575f, -0.96194f, 0.0307617f, "CHAIR", 1, 0, 1);
	}
	else
	{
		iLocal_16 = __LIB_6__::func_958(uParam0, joaat("P_CHAIRFOLDING02X"), -0.258326f, -1.19728f, 0.0322266f, "CHAIR", 1, 0, 1);
	}
	iLocal_17 = __LIB_6__::func_958(uParam0, joaat("P_STOOLFOLDING01X"), 0.0114404f, 1.02168f, 0.0276031f, 0, 1, 0, 1);
	iLocal_21 = __LIB_6__::func_958(uParam0, joaat("P_BOWL04X_STEW"), 0f, 0f, 0f, "BOWL0", 0, 0, 1);
	iLocal_20 = __LIB_6__::func_958(uParam0, joaat("P_SPOON01X"), 0f, 0f, 0f, "SPOON0", 0, 0, 1);
	iLocal_19 = __LIB_6__::func_958(uParam0, joaat("P_BOWL04X_STEW"), 0f, 0f, 0f, "BOWL1", 0, 0, 1);
	iLocal_18 = __LIB_6__::func_958(uParam0, joaat("P_SPOON01X"), 0f, 0f, 0f, "SPOON1", 0, 0, 1);
	if (!__LIB_6__::func_206(10))
	{
		__LIB_6__::func_959(uParam0, "script@vignette@lenny_6@base", 1, 1, 0, 0);
	}
	__LIB_6__::func_959(uParam0, "script@vignette@lenny_6@Action", 0, 0, 1, 0);
	__LIB_7__::func_146(uParam0, "CLEN6AU");
	...
	if (__LIB_6__::func_206(10))
	{
		__LIB_7__::func_127(uParam0, iLocal_14, 3, joaat("PROP_CAMP_SEAT_CHAIR_TABLE_STEW"), "PROP_CAMP_SEAT_CHAIR_TABLE_STEW_EATING_MALE_A", iLocal_17, 0, -1f, 1065353216 /* Float: 1f */, 1);
	}
	else
	{
	...
	__LIB_7__::func_139(uParam0, iLocal_14, iLocal_18, "p_spoon01x_PH_R_HAND", 0, 0);
	__LIB_7__::func_139(uParam0, iLocal_14, iLocal_19, "p_bowl04x_stew_PH_L_HAND", 0, 0);
	__LIB_7__::func_147(uParam0, iLocal_14, 4, 1, 0, 0, 0);
	__LIB_7__::func_107(uParam0, iLocal_15, 3, joaat("PROP_CAMP_SEAT_CHAIR_TABLE_STEW"), "PROP_CAMP_SEAT_CHAIR_TABLE_STEW_EATING_MALE_B", iLocal_16, 0);
	__LIB_7__::func_127(uParam0, iLocal_15, 3, joaat("PROP_CAMP_SEAT_CHAIR_TABLE_STEW"), "PROP_CAMP_SEAT_CHAIR_TABLE_STEW_EATING_MALE_B", iLocal_16, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_139(uParam0, iLocal_15, iLocal_20, "p_spoon01x_PH_R_HAND", 0, 0);
	...
	if (__LIB_6__::func_206(10))
	{
		...
		__LIB_7__::func_107(uParam0, iLocal_14, 0, joaat("PROP_CAMP_SEAT_CHAIR_TABLE_STEW_LAZY"), "PROP_CAMP_SEAT_CHAIR_TABLE_STEW_EATING_LAZY_MALE_A", -1, 0);
		__LIB_7__::func_227(uParam0, iLocal_14, 1);
		__LIB_7__::func_107(uParam0, iLocal_15, 0, joaat("PROP_CAMP_SEAT_CHAIR_TABLE_STEW_LAZY"), "PROP_CAMP_SEAT_CHAIR_TABLE_STEW_EATING_LAZY_MALE_B", -1, 0);
		__LIB_7__::func_227(uParam0, iLocal_15, 1);
		__LIB_7__::func_108(uParam0, iLocal_15, 7f);
...
{
	ENTITY::_0x669655FFB29EF1A9(__LIB_7__::func_30(uParam0, iLocal_19), 0, "Stew_Fill", 1f);
