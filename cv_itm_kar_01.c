...
bool func_72(var uParam0)
{
	...
	{
		case 1:
			__LIB_7__::func_45(uParam0, 142, 0, 0, 0);
			break;
		case 2:
	...
	{
		__LIB_7__::func_47(uParam0, 1.66677f, -0.70263f, 1f, 80f, 2f, 2f, 2.5f, joaat("VOLBOX"), joaat("APMS_COMP_TILLY"), 1, 1, 1);
		__LIB_7__::func_47(uParam0, -0.07f, -5.018f, 1.0999f, 0f, 2.4f, 2.5f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_KAREN"), 1, 1, 1);
	}
	iLocal_16 = __LIB_6__::func_958(uParam0, joaat("P_BOTTLEBEER01X"), 0f, 0f, 0f, "BOTTLEBEER0", 0, 0, 1);
	iLocal_18 = __LIB_6__::func_958(uParam0, joaat("P_BOTTLEBEER01X"), 0f, 0f, 0f, "BOTTLEBEER1", 0, 0, 1);
	iLocal_17 = __LIB_6__::func_958(uParam0, joaat("P_CHAIR_CRATE02X"), -3.42434f, -0.222129f, 0.0428772f, 0, 1, 0, 1);
	if (__LIB_0__::func_78(uParam0) == 1)
	{
		if (!__LIB_6__::func_206(14))
		{
			__LIB_6__::func_959(uParam0, "script@vignette@itm@karen_item_1@horseshoe@base", 1, 1, 0, 0);
		}
		__LIB_6__::func_959(uParam0, "script@vignette@itm@karen_item_1@horseshoe@action", 0, 0, 1, 0);
	}
	else
	{
		__LIB_6__::func_959(uParam0, "script@vignette@itm@karen_item_1@base", 1, 1, 0, 0);
		__LIB_6__::func_959(uParam0, "script@vignette@itm@karen_item_1@action", 0, 0, 1, 0);
	}
	__LIB_7__::func_146(uParam0, "CKRI1AU");
	__LIB_7__::func_149(uParam0, joaat("COMP_KARITMCNV1"), joaat("PLAYER_KARITMCNV1"));
	__LIB_7__::func_107(uParam0, iLocal_15, 3, joaat("WORLD_HUMAN_DRINKING"), "WORLD_HUMAN_STAND_DRINK_FEMALE_A", -1, 1);
	__LIB_7__::func_226(uParam0, iLocal_15, 1061142135 /* Float: 0.749f */);
	__LIB_7__::func_151(uParam0, iLocal_15, 1, -1);
	__LIB_7__::func_107(uParam0, iLocal_14, 3, joaat("WORLD_HUMAN_DRINKING"), "WORLD_HUMAN_STAND_DRINK_FEMALE_B", -1, 1);
	__LIB_7__::func_127(uParam0, iLocal_14, 3, joaat("PROP_HUMAN_SEAT_CHAIR_DRINKING"), "PROP_HUMAN_SEAT_CHAIR_DRINKING_FEMALE_A", iLocal_17, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_139(uParam0, iLocal_14, iLocal_16, "p_bottleBeer01x_PH_R_HAND", 0, 0);
	__LIB_7__::func_151(uParam0, iLocal_14, 3, 180);
	if (__LIB_6__::func_206(14))
	{
		__LIB_7__::func_297(uParam0, iLocal_15, iLocal_18, "p_bottleBeer01x_PH_R_HAND");
		__LIB_7__::func_297(uParam0, iLocal_14, iLocal_16, "p_bottleBeer01x_PH_R_HAND");
