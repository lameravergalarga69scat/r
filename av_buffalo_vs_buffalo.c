...
{
	__LIB_2__::func_851(uParam0, 10809, 10875, 11718);
}

void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	__LIB_2__::func_853(uParam0, "BUFFALO_VS_BUFFALO", "script@ambient@animal@buffalo_vs_buffalo@action", vParam1, vParam4);
	uParam0->f_16 = 1;
	__LIB_2__::func_854(uParam0, 1, "pbl_action", "", 0);
	__LIB_2__::func_855(uParam0, 0, "BUFFALO1", iLocal_9, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 0);
	__LIB_2__::func_855(uParam0, 1, "BUFFALO2", iLocal_9, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 0);
}
...
int func_30(var uParam0)
{
	...
	__LIB_1__::func_404(&uLocal_10, 1);
...
int func_31(var uParam0)
{
	...
	if (uParam0->f_469[0])
	{
		if (__LIB_1__::func_313(&uLocal_39, 4f))
		{
			return 1;
		}
	}
