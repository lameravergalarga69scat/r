...
bool func_72(var uParam0)
{
	...
	__LIB_7__::func_47(uParam0, -11.581f, 7.1445f, 0f, -68.75f, 1.0625f, 1.0275f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_DUTCH"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, 1.1315f, -1.743f, 0f, -56f, 1.2f, 1.2f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_JAVIER"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, -0.4685f, 1.932f, 0f, -56f, 1.0625f, 1.0275f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_JOHN"), 1, 1, 1);
	iLocal_20 = __LIB_6__::func_958(uParam0, joaat("P_BRUSHDISH01X"), 0f, 0f, 0f, "BRUSH", 0, 0, 1);
	iLocal_17 = __LIB_6__::func_958(uParam0, joaat("P_CHAIRFOLDING02X"), 1.19747f, -1.86925f, -0.0285034f, 0, 1, 0, 1);
	iLocal_18 = __LIB_6__::func_958(uParam0, joaat("P_CHAIRFOLDING02X"), -11.5514f, 7.15822f, 0.346359f, 0, 1, 0, 1);
	iLocal_19 = __LIB_6__::func_958(uParam0, joaat("P_BENCH_LOG07X"), -1.35271f, 1.61457f, -0.0227356f, 0, 1, 0, 1);
	__LIB_7__::func_107(uParam0, iLocal_15, 3, joaat("PROP_HUMAN_SEAT_CHAIR"), "PROP_HUMAN_SEAT_CHAIR_GENERIC_MALE_D", iLocal_18, 0);
	__LIB_7__::func_296(uParam0, iLocal_15, 3, joaat("PROP_HUMAN_SEAT_CHAIR"), "PROP_HUMAN_SEAT_CHAIR_GENERIC_MALE_D", iLocal_18, 0, -1073741824 /* Float: -2f */, 0f, 1);
	__LIB_7__::func_147(uParam0, iLocal_15, 2, 4, 0, 0, 0);
	__LIB_7__::func_172(uParam0, iLocal_15, 1);
	__LIB_7__::func_107(uParam0, iLocal_16, 3, joaat("PROP_HUMAN_SEAT_CRATE_CLEAN_BOOTS"), "PROP_HUMAN_SEAT_CRATE_CLEAN_BOOTS_MALE_A", iLocal_17, 0);
	__LIB_7__::func_296(uParam0, iLocal_16, 3, joaat("PROP_HUMAN_SEAT_CRATE_CLEAN_BOOTS"), "PROP_HUMAN_SEAT_CRATE_CLEAN_BOOTS_MALE_A", iLocal_17, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_139(uParam0, iLocal_16, iLocal_20, "p_cs_rag02x_PH_R_HAND", 0, 0);
	__LIB_7__::func_147(uParam0, iLocal_16, 1, 1, 0, 0, 0);
	__LIB_7__::func_107(uParam0, iLocal_14, 3, joaat("PROP_CAMP_FIRE_SEAT_BENCH"), "PROP_CAMP_FIRE_SEAT_BENCH_MALE_B", iLocal_19, 0);
	__LIB_7__::func_296(uParam0, iLocal_14, 2, joaat("PROP_CAMP_FIRE_SEAT_BENCH"), "PROP_CAMP_FIRE_SEAT_BENCH_MALE_B", iLocal_19, 0, -1073741824 /* Float: -2f */, 0f, 1);
	__LIB_7__::func_172(uParam0, iLocal_14, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@javier_10@base", 1, 1, 0, 0);
	iLocal_21 = __LIB_6__::func_959(uParam0, "script@vignette@javier_10@action", 2, 0, 1, 0);
	iLocal_22 = __LIB_6__::func_959(uParam0, "script@vignette@javier_10@idle_a", 0, 0, 0, 0);
	__LIB_7__::func_146(uParam0, "CJV10AU");
	return true;
}
...
bool func_93(var uParam0)
{
	if (__LIB_7__::func_148(uParam0, iLocal_21))
	{
		...
		__LIB_1__::func_283(&uLocal_24, 0);
		__LIB_7__::func_113(uParam0, iLocal_15, 1, 1);
		__LIB_7__::func_113(uParam0, iLocal_14, 1, 1);
		__LIB_7__::func_173(uParam0, iLocal_22, 1);
	}
	if (__LIB_0__::func_264(&uLocal_24) > fLocal_23)
	{
		__LIB_7__::func_83(uParam0, iLocal_22, "b_LoopBool", 1);
	}
	return true;
}
