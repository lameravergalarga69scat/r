...
bool func_6(var uParam0)
{
	switch (uParam0->f_11)
	{
		...
		case 2:
			if (uParam0->f_623)
			{
				PED::_0xED9582B3DA8F02B4(__LIB_9__::func_883(0) + 1);
			}
			else
			{
...
bool func_48(var uParam0)
{
	...
	int iVar1;
	iVar0 = 0;
	while (iVar0 < __LIB_9__::func_762())
	{
		iVar1 = 0;
		while (iVar1 < __LIB_9__::func_883(iVar0))
		{
...
bool func_49(var uParam0)
{
	...
	uParam0->f_12.f_13 = { 0f, 0f, __LIB_2__::func_18(0) };
...
void func_98(var uParam0, int iParam1, int iParam2)
{
	...
	if (iParam1 + 1 < __LIB_9__::func_762())
	{
...
void func_115(var uParam0, var uParam1)
{
	...
	uParam0->f_614++;
	if (!uParam0->f_614 >= __LIB_9__::func_762())
	{
		iVar0 = 0;
		while (iVar0 < iVar1)
		{
...
void func_121(var uParam0)
{
	if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_12))
	{
		func_185(uParam0->f_12, uParam0->f_12.f_10, __LIB_2__::func_18(uParam0->f_615), 2, 1073741824 /* Float: 2f */);
...
{
	int iVar0;
	iVar0 = __LIB_9__::func_844(0, __LIB_9__::func_881(), uParam0->f_616);
	uParam0->f_616 = iVar0;
...
Vector3 func_160()
{
	return __LIB_1__::func_344("ATZ_INS_EXC_CO");
}
