...
bool func_72(var uParam0)
{
	...
	iLocal_15 = __LIB_7__::func_48(uParam0, 11, 0);
	__LIB_7__::func_47(uParam0, -0.45f, 2.2f, 0f, -35f, 5f, 4f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_ADLERS"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, -1f, 8.5f, 0f, 0f, 3.5f, 3.5f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_KIERAN"), 1, 1, 1);
	iLocal_17 = __LIB_6__::func_958(uParam0, joaat("P_STEWPLATE01X"), 0f, 0f, 0f, "PLATE", 0, 0, 1);
	__LIB_6__::func_958(uParam0, joaat("P_STEWPLATE02X"), 0f, 0f, 0f, "PLATE_EMPTY", 0, 0, 1);
	iLocal_18 = __LIB_6__::func_958(uParam0, joaat("P_CS_ROPE03BX"), 0f, 0f, 0f, "ROPE", 0, 0, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@kieran_7@base", 1, 1, 0, 0);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@kieran_7@action", 0, 0, 1, 0);
	__LIB_7__::func_146(uParam0, "KIE7AUD");
	...
	__LIB_7__::func_139(uParam0, iLocal_14, iLocal_18, "p_cs_rope03bx_PH_R_HAND", 0, 0);
	...
	__LIB_7__::func_149(uParam0, joaat("COMP_KIECNV7"), joaat("PLAYER_KIECNV7"));
...
bool func_87(var uParam0)
{
	if (__LIB_6__::func_206(10))
	{
		return (__LIB_7__::func_314() == __LIB_4__::func_576(uParam0) || __LIB_7__::func_10(uParam0, 7f, 7f));
	}
	return true;
}
...
bool func_93(var uParam0)
{
	if (!bLocal_120)
	{
		if (__LIB_7__::func_40(uParam0, iLocal_16, 0.606f))
		{
			ENTITY::SET_ENTITY_VISIBLE(__LIB_7__::func_30(uParam0, iLocal_17), false);
			bLocal_120 = true;
		}
	}
	if (!bLocal_121 && __LIB_7__::func_161(-1, 1))
	{
		if (__LIB_7__::func_40(uParam0, iLocal_16, 0.845f) && __LIB_0__::func_232(Global_35, __LIB_6__::func_952(uParam0, iLocal_14), 0) < 49f)
		{
			__LIB_0__::func_928(&uLocal_19, Global_35, "ARTHUR", 0);
			bLocal_121 = __LIB_1__::func_104(&uLocal_19, cLocal_117, 0, -1, 0, 0);
		}
	}
	if (!__LIB_1__::func_22(uParam0->f_107[iLocal_15 /*113*/].f_1) && !bLocal_123)
	{
		__LIB_7__::func_5(uParam0, "Setting Sadie's speech enabled", 1, -1);
		__LIB_0__::func_707(11, 1, 1, 0);
		bLocal_123 = true;
	}
	if (!bLocal_122)
	{
