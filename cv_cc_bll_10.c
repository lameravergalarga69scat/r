...
bool func_72(var uParam0)
{
	...
	__LIB_7__::func_47(uParam0, -0.3766f, -1.0093f, 1.0122f, -22.5144f, 1.5f, 1.5f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_BILL"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, -3.4501f, 4.1917f, 1.0412f, -108f, 1.5f, 1.5f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_JAVIER"), 1, 1, 1);
	__LIB_7__::func_159(uParam0, 0.9f, -0.6f, 0f, 0f, 1f, 1f, 2f, joaat("VOLCYLINDER"), 1);
	iLocal_19 = __LIB_6__::func_958(uParam0, joaat("P_CHAIR_BARREL04B"), -0.482346f, -1.0508f, -0.000579834f, "BARREL", 1, 0, 1);
	iLocal_16 = __LIB_6__::func_958(uParam0, joaat("P_BOTTLEJD01X"), 0f, 0f, 0f, "BOTTLE", 0, 1, 1);
	__LIB_6__::func_958(uParam0, joaat("P_CIGAR01X"), 0f, 0f, 0f, "CIGAR", 0, 1, 1);
	if (!__LIB_6__::func_206(14))
	{
		__LIB_6__::func_959(uParam0, "script@vignette@bill_10@base", 1, 1, 0, 0);
	}
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@bill_10@action", 2, 0, 1, 0);
	iLocal_18 = __LIB_6__::func_959(uParam0, "script@vignette@bill_10@exit", 0, 0, 0, 0);
	__LIB_7__::func_226(uParam0, iLocal_14, 1061142135 /* Float: 0.749f */);
	__LIB_7__::func_150(uParam0, iLocal_18, iLocal_14, 0.845f);
	if (__LIB_6__::func_206(14))
	{
		__LIB_7__::func_107(uParam0, iLocal_15, 3, joaat("WORLD_HUMAN_LEAN_BACK_WALL"), "WORLD_HUMAN_LEAN_BACK_WALL_SMOKING_MALE_D", -1, 0);
		__LIB_7__::func_233(uParam0, iLocal_15, -142.259f, -23.514f, 95.088f, 159.922f, 0, 0);
		__LIB_7__::func_107(uParam0, iLocal_14, 0, joaat("PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS"), "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_MALE_D", -1, 0);
		__LIB_7__::func_297(uParam0, iLocal_14, iLocal_16, "p_bottleJD01x_ph_r_hand");
		__LIB_7__::func_227(uParam0, iLocal_14, 1);
		__LIB_7__::func_229(uParam0, iLocal_14);
	...
	{
		__LIB_7__::func_107(uParam0, iLocal_14, 3, joaat("PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS"), "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_MALE_D", iLocal_19, 0);
	}
	__LIB_7__::func_146(uParam0, "CB10AUD");
...
{
	vLocal_20 = { ENTITY::GET_ENTITY_COORDS(__LIB_7__::func_30(uParam0, iLocal_19), true, false) };
	vLocal_23 = { ENTITY::GET_ENTITY_ROTATION(__LIB_7__::func_30(uParam0, iLocal_19), 2) };
	return true;
}
...
{
	if (ENTITY::IS_ENTITY_OCCLUDED(__LIB_7__::func_30(uParam0, iLocal_19)))
	{
		if (!__LIB_0__::func_75(&uLocal_26))
		{
			__LIB_0__::func_268(&uLocal_26, 0f);
		}
		if (__LIB_0__::func_264(&uLocal_26) > 5f)
		{
			ENTITY::SET_ENTITY_COORDS(__LIB_7__::func_30(uParam0, iLocal_19), vLocal_20, true, false, true, true);
			ENTITY::SET_ENTITY_ROTATION(__LIB_7__::func_30(uParam0, iLocal_19), vLocal_23, 2, true);
			return true;
		}
	}
	else if (__LIB_0__::func_75(&uLocal_26))
	{
		__LIB_0__::func_37(&uLocal_26);
	}
	return false;
}
