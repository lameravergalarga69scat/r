...
bool func_7(var uParam0)
{
	...
	switch (__LIB_6__::func_949(uParam0))
	{
		...
		case 4:
			...
			{
				if (__LIB_17__::func_987(uParam0))
				{
...
bool func_72(var uParam0)
{
	...
	if (uParam0->f_2 == 6)
	{
		iLocal_14 = __LIB_7__::func_48(uParam0, 13, "Female");
		iLocal_15 = __LIB_7__::func_48(uParam0, 12, "Dog");
		__LIB_7__::func_47(uParam0, 0.05f, -0.1375f, 0f, 0f, 1.17f, 1.2125f, 3.77f, joaat("VOLBOX"), joaat("APMS_COMP_ABIGAIL"), 1, 1, 1);
		__LIB_7__::func_107(uParam0, iLocal_14, 3, joaat("PROP_HUMAN_SEAT_CHAIR"), "PROP_HUMAN_SEAT_CHAIR_GENERIC_FEMALE_C", -1, 0);
		__LIB_7__::func_127(uParam0, iLocal_14, 3, joaat("PROP_HUMAN_SEAT_CHAIR"), "PROP_HUMAN_SEAT_CHAIR_GENERIC_FEMALE_C", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
		__LIB_7__::func_137(uParam0, iLocal_14, "START_SEATED_FEMALE_B_TO_SEAT_BENCH_FEMALE_A");
		iLocal_16 = __LIB_6__::func_959(uParam0, "script@ambient@campfiregeneral@seat_chair_pet_dog_sitting@female_pet_dog", 0, 1, 0, 0);
		iLocal_17 = __LIB_7__::func_32(uParam0, iLocal_16, "pl_Female_Pet_Affectionate_Left", 1);
	}
	else if (uParam0->f_2 == 7)
	{
		iLocal_14 = __LIB_7__::func_48(uParam0, 3, "Male");
		iLocal_15 = __LIB_7__::func_48(uParam0, 12, "Dog");
		__LIB_7__::func_47(uParam0, 0.05f, -0.1375f, 0f, 0f, 1.17f, 1.2125f, 3.77f, joaat("VOLBOX"), joaat("APMS_COMP_BILL"), 1, 1, 1);
		__LIB_7__::func_107(uParam0, iLocal_14, 3, joaat("PROP_CAMP_FIRE_SEATED"), "PROP_CAMP_FIRE_SEATED_MALE_F", -1, 0);
		__LIB_7__::func_127(uParam0, iLocal_14, 3, joaat("PROP_CAMP_FIRE_SEATED"), "PROP_CAMP_FIRE_SEATED_MALE_F", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
		__LIB_7__::func_137(uParam0, iLocal_14, "START_SEATED_MALE_F_TO_SEAT_BOX_MALE_A");
		iLocal_16 = __LIB_6__::func_959(uParam0, "script@ambient@campfiregeneral@seat_chair_pet_dog_sitting@male_pet_dog", 0, 1, 0, 0);
		iLocal_17 = __LIB_7__::func_32(uParam0, iLocal_16, "pl_Male_Pet_2_Right", 1);
	}
	__LIB_7__::func_107(uParam0, iLocal_15, 3, joaat("WORLD_ANIMAL_DOG_SITTING"), "WORLD_ANIMAL_DOG_SITTING", -1, 1);
	__LIB_7__::func_127(uParam0, iLocal_15, 2, joaat("WORLD_ANIMAL_DOG_SITTING"), "WORLD_ANIMAL_DOG_SITTING", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
