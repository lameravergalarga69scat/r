...
{
	__LIB_2__::func_851(uParam0, 10689, 10747, 11133);
}

void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	int iVar0;
	__LIB_2__::func_853(uParam0, "MAN_JUMP_FENCE", "", vParam1, vParam4);
	iVar0 = joaat("A_M_M_LOWERSDTOWNFOLK_01");
	__LIB_2__::func_905(uParam0, 0, "MJFP_MAN", iVar0, vParam1, vParam4.z, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
}
...
int func_31(var uParam0)
{
	...
	switch (iLocal_9)
	{
		...
		case 2:
			if (!uParam0->f_469[2])
			{
				if (__LIB_2__::func_889(uParam0, 0.1f, 1116471296 /* Float: 70f */, 4, joaat("ACTION"), 0))
				{
					__LIB_2__::func_890(*uParam0, uParam0->f_483, 0);
					uParam0->f_469[2] = 1;
				}
			}
			if (!__LIB_0__::func_163(uParam0->f_20[0 /*14*/], -1207763510))
			{
