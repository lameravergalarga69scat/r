...
bool func_72(var uParam0)
{
	...
	{
		case 6:
			__LIB_7__::func_45(uParam0, 13, 0, 0, 0);
	...
	iLocal_15 = __LIB_7__::func_48(uParam0, 15, "MARY");
	__LIB_7__::func_47(uParam0, 0f, 0f, 0.85f, 0f, 1f, 1f, 3.2075f, joaat("VOLBOX"), joaat("APMS_COMP_MARYBETH"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, -3.025f, 0.275f, 0.85f, -17f, 3.8275f, 2.9425f, 3.2075f, joaat("VOLBOX"), joaat("APMS_COMP_TILLY"), 1, 1, 1);
	__LIB_7__::func_159(uParam0, -3.15f, 0f, 0f, 24f, 1.5f, 0.76f, 3f, joaat("VOLCYLINDER"), 1);
	__LIB_6__::func_958(uParam0, joaat("P_CS_BOOK04X"), 0f, 0f, 0f, "BOOK", 0, 1, 1);
	iLocal_22 = __LIB_6__::func_958(uParam0, joaat("P_RAG02X"), 0f, 0f, 0f, "RAG", 0, 1, 1);
	iLocal_21 = __LIB_6__::func_958(uParam0, joaat("P_WASHBOARD01X"), 0f, 0f, 0f, "WASHBOARD", 0, 1, 1);
	iLocal_23 = __LIB_6__::func_958(uParam0, joaat("P_BASINWATER01X"), 2356.782f, 1345.284f, 104.8737f, 0, 0, 1, 0);
	__LIB_6__::func_959(uParam0, "script@vignette@tilly_6@base", 1, 1, 0, 0);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@tilly_6@Action_A", 2, 0, 1, 0);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@tilly_6@Action_A_Int_Left", 2, 0, 0, 1);
	iLocal_18 = __LIB_6__::func_959(uParam0, "script@vignette@tilly_6@Action_A_Int_Right", 2, 0, 0, 1);
	iLocal_19 = __LIB_6__::func_959(uParam0, "script@vignette@tilly_6@Action_A_Int_Back", 2, 0, 0, 1);
	iLocal_20 = __LIB_6__::func_959(uParam0, "script@vignette@tilly_6@Action_B", 0, 0, 0, 0);
	__LIB_7__::func_146(uParam0, "CCTL6AU");
	__LIB_7__::func_149(uParam0, joaat("COMP_TLLCNV6"), joaat("PLAYER_TLLCNV6"));
	__LIB_7__::func_150(uParam0, iLocal_20, -1, 0.81f);
	__LIB_7__::func_147(uParam0, iLocal_14, 1, 4, 0, 0, 0);
	__LIB_7__::func_147(uParam0, iLocal_15, 1, 8, 0, 0, 0);
	__LIB_7__::func_127(uParam0, iLocal_14, 3, joaat("WORLD_HUMAN_WASHBOARD"), "WORLD_HUMAN_WASHBOARD_FEMALE_A", -1, 1, 15f, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_151(uParam0, iLocal_14, 1, -1);
	__LIB_7__::func_139(uParam0, iLocal_14, iLocal_22, "p_cs_rag02x_PH_R_HAND", 0, 0);
	__LIB_7__::func_139(uParam0, iLocal_14, iLocal_21, "p_washboard01x_PH_L_HAND", 1, "p_washboard01x_PH_L_HAND");
	__LIB_7__::func_127(uParam0, iLocal_15, 2, joaat("WORLD_HUMAN_SIT_GROUND"), "WORLD_HUMAN_SIT_GROUND_FEMALE_A", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_151(uParam0, iLocal_15, 1, -1);
	Local_24 = { __LIB_7__::func_160(uParam0, -2.5775f, 0.58f, 0.9904f, 89.75f, 6.2f, 0.1825f, 0.33f) };
	Local_34 = { __LIB_7__::func_160(uParam0, -2.43f, 0.58f, 0.9904f, -119.88f, 6.2f, 0.295f, 0.395f) };
	Local_44 = { __LIB_7__::func_160(uParam0, -2.4725f, 0.6575f, 0.9904f, 148.75f, 6.285f, 0.6195f, 0.2525f) };
	return true;
}
...
bool func_86(var uParam0)
{
	...
	ENTITY::SET_ENTITY_HEADING(__LIB_7__::func_30(uParam0, iLocal_23), 138.29f);
	ENTITY::SET_ENTITY_COORDS(__LIB_7__::func_30(uParam0, iLocal_23), 2356.782f, 1345.284f, 104.8737f, true, false, true, true);
	ENTITY::FREEZE_ENTITY_POSITION(__LIB_7__::func_30(uParam0, iLocal_23), true);
	return true;
}
