...
void __EntryFunction__()
{
	...
	iLocal_10 = joaat("WORLD_ANIMAL_GOAT_GRAZING_DOMESTIC");
	Var0.f_1 = -1;
	Var0.f_3.f_9 = 3;
	Var0.f_20 = 25;
...
{
	__LIB_2__::func_851(uParam0, 10814, 10872, 11242);
}

void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	__LIB_2__::func_853(uParam0, "WILD_ANIMAL", "", vParam1, vParam4);
	switch (*uParam0)
	{
		case 233:
			iLocal_9 = joaat("A_C_BULL_01");
			iLocal_10 = joaat("WORLD_ANIMAL_BULL_GRAZING");
			break;
		case 234:
			iLocal_9 = joaat("A_C_GOAT_01");
			iLocal_10 = joaat("WORLD_ANIMAL_GOAT_GRAZING_DOMESTIC");
		...
		case 236:
			...
			iLocal_10 = joaat("STAND");
			break;
	}
	__LIB_2__::func_905(uParam0, 0, "WAP_ANIMAL_1", iLocal_9, vParam1, vParam4.z, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
}
...
int func_30(var uParam0)
{
	...
	__LIB_1__::func_397(&uLocal_12, 1);
...
int func_31(var uParam0)
{
	if (!uParam0->f_469[1])
	{
		if (__LIB_2__::func_908(uParam0, &uLocal_12, 0))
		{
			__LIB_3__::func_6(uParam0);
			func_65(uParam0);
			uParam0->f_469[1] = 1;
		}
	...
	switch (iLocal_11)
	{
		case 0:
			...
			break;
		case 2:
			if (__LIB_2__::func_892(uParam0, uParam0->f_493, uParam0->f_494, 4, uParam0->f_495, 1112014848 /* Float: 50f */) || *uParam0 == 236)
			{
				__LIB_3__::func_6(uParam0);
				if (*uParam0 != 236)
				{
		...
		case 3:
			if (*uParam0 == 236)
			{
				if (__LIB_2__::func_889(uParam0, 1f, 85f, 4, joaat("ACTION"), 0))
				{
					func_65(uParam0);
					return 1;
				}
