...
bool func_72(var uParam0)
{
	...
	{
		case 1:
			__LIB_7__::func_419(uParam0);
			break;
		case 2:
			__LIB_7__::func_420(uParam0);
			break;
		case 3:
			__LIB_7__::func_421(uParam0);
			break;
	}
	iLocal_15 = __LIB_7__::func_48(uParam0, 3, 0);
	iLocal_14 = __LIB_7__::func_48(uParam0, 17, 0);
	__LIB_7__::func_47(uParam0, 3.975f, -3.15f, 0.85f, 0f, 1f, 1f, 3.2075f, joaat("VOLBOX"), joaat("APMS_COMP_PEARSON"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, -1.475f, -3.4875f, 0.85f, 0f, 1f, 1f, 3.2075f, joaat("VOLBOX"), joaat("APMS_COMP_BILL"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, -0.2875f, 0.025f, 0.85f, 0f, 3.285f, 1.9625f, 3.2075f, joaat("VOLBOX"), joaat("APMS_COMP_BILL"), 1, 1, 1);
	iLocal_16 = __LIB_6__::func_958(uParam0, joaat("P_CS_RAG02X"), 0f, 0f, 0f, "RAG", 0, 1, 1);
	__LIB_6__::func_958(uParam0, joaat("P_CS_FISHBAG01X"), 0f, 0f, 0f, "FISHBAG", 0, 1, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@WRK@bill_work_1@base", 1, 1, 0, 0);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@WRK@bill_work_1@action_a", 2, 0, 1, 0);
	iLocal_18 = __LIB_6__::func_959(uParam0, "script@vignette@WRK@bill_work_1@Action_A_Int_Front", 2, 0, 0, 1);
	iLocal_19 = __LIB_6__::func_959(uParam0, "script@vignette@WRK@bill_work_1@Action_A_Int_Left", 2, 0, 0, 1);
	iLocal_20 = __LIB_6__::func_959(uParam0, "script@vignette@WRK@bill_work_1@Action_A_Int_Right", 2, 0, 0, 1);
	iLocal_21 = __LIB_6__::func_959(uParam0, "script@vignette@WRK@bill_work_1@action_b", 0, 0, 0, 0);
	__LIB_7__::func_146(uParam0, "CKBL1AU");
	__LIB_7__::func_149(uParam0, joaat("COMP_BLLWRKCNV1"), joaat("PLAYER_BLLWRKCNV1"));
	__LIB_7__::func_151(uParam0, iLocal_15, 1, -1);
	__LIB_7__::func_107(uParam0, iLocal_14, 3, joaat("WORLD_HUMAN_CLEAN_TABLE"), "WORLD_HUMAN_CLEAN_TABLE_MALE_A", -1, 1);
	__LIB_7__::func_127(uParam0, iLocal_14, 2, joaat("WORLD_HUMAN_CLEAN_TABLE"), "WORLD_HUMAN_CLEAN_TABLE_MALE_A", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_139(uParam0, iLocal_14, iLocal_16, "p_cs_rag02x_PH_R_HAND", 0, 0);
	Local_22 = { __LIB_7__::func_160(uParam0, -0.6925f, 0.248f, 1.38f, 123.12f, 7.5f, 0.2025f, 0.7995f) };
	Local_32 = { __LIB_7__::func_160(uParam0, -0.693f, 0.248f, 1.38f, -169.56f, 7.5f, 0.265f, 0.545f) };
	Local_42 = { __LIB_7__::func_160(uParam0, -0.693f, 0.248f, 1.38f, 0.09f, 7.5f, 0.567f, 0.2125f) };
	return true;
}
