...
bool func_72(var uParam0)
{
	...
	iLocal_14 = __LIB_7__::func_48(uParam0, 11, 0);
	__LIB_7__::func_47(uParam0, 0.5375f, -9.325f, 1.4875f, 0f, 1f, 1f, 3.2075f, joaat("VOLBOX"), joaat("APMS_COMP_ABIGAIL"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, -2.2125f, -3.875f, 1.4875f, 0f, 2f, 2f, 3.2075f, joaat("VOLBOX"), joaat("APMS_COMP_ADLERS"), 1, 1, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@sadie_3@base", 1, 1, 0, 0);
	__LIB_6__::func_959(uParam0, "script@vignette@sadie_3@Action", 0, 0, 1, 0);
	__LIB_7__::func_146(uParam0, "CSA3AUD");
	__LIB_7__::func_149(uParam0, joaat("COMP_SADCNV3"), joaat("PLAYER_SADCNV3"));
