...
bool func_72(var uParam0)
{
	...
	{
		case 2:
			__LIB_7__::func_116(uParam0, 683.0387f, -1245.425f, 43.0148f, 0f, 0.8f, 111.15f);
			break;
		case 3:
			__LIB_7__::func_45(uParam0, 186, 0, 0, 0);
			break;
		case 6:
			__LIB_7__::func_116(uParam0, 2351.282f, 1362.077f, 104.9752f, 0f, 0.3f, -100.7f);
			break;
	}
	__LIB_7__::func_47(uParam0, -1.4625f, 1.1049f, 1.0409f, 32.76f, 2.02f, 1.21f, 2.5f, joaat("VOLBOX"), joaat("APMS_COMP_MICAH"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, 1.2062f, -1.9135f, 0.4965f, 34.92f, 1f, 1f, 2.5f, joaat("VOLBOX"), joaat("APMS_COMP_JOHN"), 1, 1, 1);
	__LIB_7__::func_159(uParam0, 0f, 0f, 0.4965f, 0f, 1.75f, 1.75f, 2.5f, joaat("VOLCYLINDER"), 1);
	...
	__LIB_6__::func_958(uParam0, joaat("P_MATCHSTICK01X"), 0f, 0f, 0f, "MATCH", 0, 1, 1);
	iLocal_20 = __LIB_6__::func_958(uParam0, joaat("P_STICKFIREPOKER01X"), 0f, 0f, 0f, "POKER", 0, 1, 1);
	iLocal_21 = __LIB_6__::func_958(uParam0, joaat("P_CHAIRFOLDING02X"), 1.20082f, -1.86806f, -0.0284729f, 0, 1, 0, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@micah_5@base", 1, 1, 0, 0);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@micah_5@action_a", 2, 0, 1, 0);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@micah_5@action_b", 0, 0, 0, 0);
	iLocal_18 = __LIB_6__::func_959(uParam0, "script@vignette@micah_5@action_b_alt_left", 0, 0, 0, 1);
	iLocal_19 = __LIB_6__::func_959(uParam0, "script@vignette@micah_5@action_b_alt_right", 0, 0, 0, 1);
	__LIB_7__::func_146(uParam0, "CMCH5AU");
	__LIB_7__::func_151(uParam0, iLocal_15, 3, -1);
	__LIB_7__::func_107(uParam0, iLocal_14, 3, joaat("PROP_CAMP_FIRE_SEATED"), "PROP_CAMP_FIRE_SEAT_CHAIR_MALE_B", iLocal_21, 0);
	__LIB_7__::func_127(uParam0, iLocal_14, 3, joaat("PROP_CAMP_FIRE_SEATED"), "PROP_CAMP_FIRE_SEAT_CHAIR_MALE_B", iLocal_21, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_139(uParam0, iLocal_14, iLocal_20, "p_stickFirePoker01x_PH_R_HAND", 0, 0);
	__LIB_7__::func_151(uParam0, iLocal_14, 1, -1);
	__LIB_7__::func_149(uParam0, joaat("COMP_MCHCNV5"), joaat("PLAYER_MCHCNV5"));
	Local_22 = { __LIB_7__::func_160(uParam0, -1.3125f, 1.7049f, 1.0409f, -44.28f, 8f, 0.5f, 0.5f) };
	Local_32 = { __LIB_7__::func_160(uParam0, -1.3125f, 1.7049f, 1.0409f, 117f, 7f, 0.5f, 0.5f) };
	return true;
}
