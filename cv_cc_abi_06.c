...
bool func_72(var uParam0)
{
	...
	{
		case 1:
			__LIB_7__::func_45(uParam0, 171, 0, 0, 0);
			break;
		case 2:
			__LIB_7__::func_116(uParam0, 705.439f, -1244.025f, 44.15f, 0f, 0f, -43.56f);
			break;
		default:
			return false;
	}
	...
	__LIB_7__::func_47(uParam0, 1.15f, -0.7f, 0.22f, 0f, 4f, 4f, 5f, joaat("VOLCYLINDER"), -1, 1, 1, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@abigail_6@base", 1, 1, 0, 0);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@abigail_6@action_a", 2, 0, 1, 0);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@abigail_6@action_b", 2, 0, 0, 0);
	iLocal_18 = __LIB_6__::func_959(uParam0, "script@vignette@abigail_6@action_b_front", 2, 0, 0, 1);
	iLocal_19 = __LIB_6__::func_959(uParam0, "script@vignette@abigail_6@action_b_back", 2, 0, 0, 1);
	iLocal_20 = __LIB_6__::func_959(uParam0, "script@vignette@abigail_6@action_c_normal_no_arthur", 0, 0, 0, 0);
	iLocal_21 = __LIB_6__::func_959(uParam0, "script@vignette@abigail_6@action_c_normal_arthur_front", 0, 0, 0, 1);
	iLocal_22 = __LIB_6__::func_959(uParam0, "script@vignette@abigail_6@action_c_normal_arthur_back", 0, 0, 0, 1);
	iLocal_23 = __LIB_6__::func_959(uParam0, "script@vignette@abigail_6@action_c_front_no_arthur", 0, 0, 0, 0);
	iLocal_24 = __LIB_6__::func_959(uParam0, "script@vignette@abigail_6@action_c_front_arthur_front", 0, 0, 0, 1);
	iLocal_25 = __LIB_6__::func_959(uParam0, "script@vignette@abigail_6@action_c_front_arthur_back", 0, 0, 0, 1);
	iLocal_26 = __LIB_6__::func_959(uParam0, "script@vignette@abigail_6@action_c_back_no_arthur", 0, 0, 0, 0);
	iLocal_27 = __LIB_6__::func_959(uParam0, "script@vignette@abigail_6@action_c_back_arthur_front", 0, 0, 0, 1);
	iLocal_28 = __LIB_6__::func_959(uParam0, "script@vignette@abigail_6@action_c_back_arthur_back", 0, 0, 0, 1);
	__LIB_7__::func_147(uParam0, iLocal_14, 2, 2, 0, "Default_Angry", 0);
	__LIB_7__::func_144(uParam0, iLocal_14, 1.4f, 1065353216 /* Float: 1f */, 1092616192 /* Float: 10f */);
	__LIB_7__::func_147(uParam0, iLocal_15, 2, 1, 0, 0, 0);
	__LIB_7__::func_146(uParam0, "ABI6AUD");
	__LIB_7__::func_145(uParam0, 20f, 30f);
	iLocal_30 = __LIB_7__::func_156(uParam0, 1.6236f, 2.5306f, 1.0664f, 0f, 0f, 0f, 6f, 5f, 2f, "BackTrigger", joaat("VOLBOX"));
	iLocal_29 = __LIB_7__::func_156(uParam0, 1.6236f, -2.4694f, 1.0664f, 0f, 0f, 0f, 6f, 5f, 2f, "FrontTrigger", joaat("VOLBOX"));
	return true;
}
...
bool func_93(var uParam0)
{
	...
	{
		if (__LIB_7__::func_358(uParam0, &iLocal_29, 1))
		{
			__LIB_7__::func_154(uParam0, iLocal_18, 1);
		}
		else if (__LIB_7__::func_358(uParam0, &iLocal_30, 1))
		{
