...
bool func_72(var uParam0)
{
	switch (__LIB_0__::func_78(uParam0))
	{
		case 1:
			...
			break;
		case 2:
			__LIB_7__::func_45(uParam0, 66, 0, 0, 0);
			break;
		default:
			return false;
	}
	...
	__LIB_7__::func_47(uParam0, -1.0491f, -1.0785f, 0f, 0f, 3.5f, 3.5f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_DUTCH"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, -6.4407f, 3.7614f, 0f, 0f, 1f, 1f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_HOSEA"), 1, 1, 1);
	__LIB_7__::func_159(uParam0, -1.4875f, -0.0252f, 1.15f, 38.56f, 1.6425f, 1.335f, 2.685f, joaat("VOLCYLINDER"), 1);
	iLocal_16 = __LIB_6__::func_958(uParam0, joaat("P_CS_BOOKEVELYNMILLER"), 0f, 0f, 0f, "BOOK", 0, 0, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@dutch_and_hosea_4@base", 1, 1, 0, 0);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@dutch_and_hosea_4@action_a", 2, 0, 1, 0);
	iLocal_18 = __LIB_6__::func_959(uParam0, "script@vignette@dutch_and_hosea_4@action_b", 0, 0, 0, 0);
	iLocal_19 = __LIB_6__::func_959(uParam0, "script@vignette@dutch_and_hosea_4@action_b_alt", 0, 0, 0, 1);
	__LIB_7__::func_146(uParam0, "CCDH4AU");
	...
	Local_20 = { __LIB_7__::func_160(uParam0, -1.2233f, 0.4f, 1.0699f, 177.84f, 9f, 0.41f, 0.38f) };
	Local_30 = { __LIB_7__::func_160(uParam0, -1.2233f, 0.4f, 1.0699f, 1.8775f, 9f, 0.482f, 0.4557f) };
	return true;
}
...
bool func_93(var uParam0)
{
	...
	{
		if (__LIB_7__::func_236(uParam0, Local_20, 1, 0) || __LIB_7__::func_236(uParam0, Local_30, 1, 0))
		{
			__LIB_7__::func_149(uParam0, joaat("COMP_DNHCNV4"), joaat("PLAYER_DNHCNV4"));
