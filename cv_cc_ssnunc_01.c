...
bool func_72(var uParam0)
{
	...
	__LIB_7__::func_47(uParam0, 2.35f, 4.3625f, 0.8945f, 80f, 1f, 1f, 2.2325f, joaat("VOLBOX"), joaat("APMS_COMP_UNCLE"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, -0.2875f, -0.625f, 0.832f, 92.5f, 2f, 5.8325f, 2.135f, joaat("VOLBOX"), joaat("APMS_COMP_GRIMSHAW"), 1, 1, 1);
	iLocal_20 = __LIB_6__::func_958(uParam0, joaat("P_MUGCOFFEE01X"), 0f, 0f, 0f, "MUG", 0, 0, 1);
	__LIB_6__::func_958(uParam0, joaat("P_BOTTLEBEER01X"), 0f, 0f, 0f, "BOTTLE", 0, 1, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@susan_uncle_1@base", 1, 1, 0, 0);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@susan_uncle_1@action_a", 2, 0, 1, 0);
	iLocal_18 = __LIB_6__::func_959(uParam0, "script@vignette@susan_uncle_1@ACTION_B_ALT_LEFT", 0, 0, 0, 1);
	iLocal_19 = __LIB_6__::func_959(uParam0, "script@vignette@susan_uncle_1@ACTION_B_ALT_RIGHT", 0, 0, 0, 1);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@susan_uncle_1@action_b", 0, 0, 0, 0);
	__LIB_7__::func_146(uParam0, "CSNU1AU");
	__LIB_7__::func_149(uParam0, joaat("COMP_SSNUNCCNV1"), joaat("PLAYER_SSNUNCCNV1"));
	...
	__LIB_7__::func_153(uParam0, iLocal_14, 1, joaat("WORLD_HUMAN_COFFEE_DRINK"), 0, -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_139(uParam0, iLocal_14, iLocal_20, "p_mugCoffee01x_PH_R_HAND", 0, 0);
	__LIB_7__::func_107(uParam0, iLocal_15, 3, joaat("WORLD_HUMAN_DRINKING"), "WORLD_HUMAN_STAND_DRINK_MALE_B", -1, 1);
	__LIB_7__::func_151(uParam0, iLocal_15, 1, -1);
	Local_21 = { __LIB_7__::func_160(uParam0, 0.5875f, -1.4975f, 1.07f, 98f, 6.0475f, 0.285f, 0.6575f) };
	Local_31 = { __LIB_7__::func_160(uParam0, 0.588f, -1.498f, 1.07f, 34f, 6.0575f, 0.0525f, 0.66f) };
	return true;
}
...
bool func_93(var uParam0)
{
	if (__LIB_7__::func_148(uParam0, iLocal_16))
	{
		...
		{
			__LIB_7__::func_150(uParam0, iLocal_18, -1, 0.53f);
			__LIB_7__::func_154(uParam0, iLocal_18, 1);
		}
		else if (__LIB_7__::func_163(uParam0, Local_31, 1, 0))
		{
			__LIB_7__::func_150(uParam0, iLocal_19, -1, 0.53f);
			__LIB_7__::func_154(uParam0, iLocal_19, 1);
		}
		else
		{
			__LIB_7__::func_150(uParam0, iLocal_17, -1, 0.53f);
