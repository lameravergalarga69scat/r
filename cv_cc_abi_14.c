...
bool func_7(var uParam0)
{
	...
	switch (__LIB_6__::func_949(uParam0))
	{
		...
		case 3:
			...
			break;
		case 4:
			if (__LIB_19__::func_128(uParam0))
			{
...
bool func_73(var uParam0)
{
	...
	{
		case 1:
			__LIB_7__::func_116(uParam0, -149.1513f, -16.0276f, 95.3f, 0f, 0f, 79.21f);
			break;
		case 2:
			__LIB_7__::func_116(uParam0, 689.8932f, -1253.845f, 43.65f, 0f, 0f, -16.89f);
			break;
		default:
			return false;
	}
	...
	__LIB_7__::func_47(uParam0, 1.1566f, -0.516f, 0f, 31.68f, 2f, 3f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_ABIGAIL"), 1, 1, 1);
	if (iVar0 == 1)
	{
		iLocal_16 = __LIB_7__::func_142(uParam0, joaat("P_BEDROLLOPEN03X"), 1.62618f, 0.481654f, -0.0400009f, 0, 1, 0, 1);
		__LIB_7__::func_142(uParam0, joaat("P_PILLOW01X"), 2.21605f, 0.897485f, 0.107033f, "Pillow", 1, 0, 1);
	}
	else
	{
		__LIB_7__::func_142(uParam0, joaat("P_PILLOW01X"), 0f, 0f, 0f, "Pillow", 0, 0, 1);
	}
	__LIB_6__::func_959(uParam0, "script@vignette@abigail_14@base", 1, 1, 0, 0);
	iLocal_27 = __LIB_6__::func_959(uParam0, "script@vignette@abigail_14@action", 2, 0, 1, 1);
	iLocal_28 = __LIB_6__::func_959(uParam0, "script@vignette@abigail_14@abigail_trans", 0, 0, 0, 0);
	__LIB_7__::func_146(uParam0, "CAB14AU");
	__LIB_7__::func_149(uParam0, joaat("COMP_ABICNV14"), joaat("PLAYER_ABICNV14"));
	__LIB_7__::func_150(uParam0, iLocal_27, -1, 0.67f);
	__LIB_7__::func_127(uParam0, iLocal_14, 2, joaat("WORLD_HUMAN_SIT_GROUND"), "WORLD_HUMAN_SIT_GROUND_FEMALE_A", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_151(uParam0, iLocal_14, 1, -1);
	__LIB_7__::func_147(uParam0, iLocal_14, 1, 12, 0, 0, 0);
	__LIB_7__::func_107(uParam0, iLocal_15, 3, joaat("WORLD_CAMP_JACK_SLEEP"), "WORLD_CAMP_JACK_SLEEP", -1, 1);
	__LIB_7__::func_127(uParam0, iLocal_15, 2, joaat("WORLD_CAMP_JACK_SLEEP"), "WORLD_CAMP_JACK_SLEEP", -1, 1, 240f, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_129(uParam0, 1);
	__LIB_7__::func_279(uParam0, iLocal_14, 1094713344 /* Float: 12f */, 1092616192 /* Float: 10f */);
	Local_17 = { __LIB_7__::func_160(uParam0, 1.2363f, -0.1641f, 1.0444f, 120.96f, 7f, 0.5f, 0.5f) };
	iLocal_29 = __LIB_7__::func_166(uParam0, 0.5875f, -1.025f, 0.95f, 0f, 0f, 80.98939f, 1.1f, 1.1f, 1.38f, "Grief", joaat("VOLCYLINDER"));
	__LIB_2__::func_384(uParam0, 1);
	return true;
}
