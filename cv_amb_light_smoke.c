...
bool func_72(var uParam0)
{
	...
	{
		case 1:
			__LIB_7__::func_116(uParam0, -138.057f, -44.02f, 94.524f, 0f, 0f, 163.44f);
			break;
		default:
			return false;
	}
	iLocal_14 = __LIB_7__::func_48(uParam0, 6, "MALE_A");
	iLocal_15 = __LIB_7__::func_48(uParam0, 2, "MALE_B");
	__LIB_7__::func_47(uParam0, 0f, 0f, 1f, 0f, 2f, 2f, 3f, joaat("VOLBOX"), -1, 1, 1, 1);
	__LIB_6__::func_958(uParam0, joaat("P_CIGARETTE01X"), 0f, 0f, 0f, "CIGARETTE_A", 0, 1, 1);
	__LIB_6__::func_958(uParam0, joaat("P_CIGARETTE01X"), 0f, 0f, 0f, "CIGARETTE_B", 0, 1, 1);
	__LIB_6__::func_958(uParam0, joaat("P_MATCHSTICK01X"), 0f, 0f, 0f, "MATCH_A", 0, 1, 1);
	__LIB_6__::func_958(uParam0, joaat("P_MATCHES01X"), 0f, 0f, 0f, "MATCHES_A", 0, 1, 1);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@ambient@town@light_smoke@action", 0, 1, 0, 0);
	iLocal_17 = __LIB_7__::func_32(uParam0, iLocal_16, "pbl_action", 1);
	__LIB_7__::func_107(uParam0, iLocal_14, 3, joaat("WORLD_HUMAN_SMOKE"), "WORLD_HUMAN_SMOKE_MALE_A", -1, 1);
	__LIB_7__::func_127(uParam0, iLocal_14, 2, joaat("WORLD_HUMAN_SMOKE"), "WORLD_HUMAN_SMOKE_MALE_A", -1, 1, 3f, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_127(uParam0, iLocal_15, 2, joaat("WORLD_HUMAN_SMOKE"), "WORLD_HUMAN_SMOKE_MALE_C", -1, 1, 20f, 1065353216 /* Float: 1f */, 1);
...
{
	__LIB_7__::func_83(uParam0, iLocal_16, "Loop", 1);
	return true;
}
