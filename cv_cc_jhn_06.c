...
bool func_72(var uParam0)
{
	...
	__LIB_7__::func_47(uParam0, -1.056f, -1.5225f, 0.5926f, 43.701f, 1.2f, 1.2f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_JOHN"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, 1.2237f, -1.9219f, 0.4796f, 34.7593f, 1.5f, 1.5f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_MICAH"), 1, 1, 1);
	__LIB_7__::func_159(uParam0, 0.0925846f, -1.14187f, 0.979996f, 0f, 1.5f, 1.5f, 3f, joaat("VOLCYLINDER"), 1);
	iLocal_16 = __LIB_7__::func_142(uParam0, joaat("P_CHAIRFOLDING02X"), 1.198f, -1.869f, 0.472f, 0, 1, 0, 1);
	iLocal_18 = __LIB_7__::func_142(uParam0, joaat("P_BOWL04X_STEW"), 0f, 0f, 0f, "BOWL", 0, 0, 1);
	iLocal_17 = __LIB_7__::func_142(uParam0, joaat("P_CIGARETTE_CS02X"), 0f, 0f, 0f, "CIGARETTE", 0, 1, 1);
	iLocal_19 = __LIB_7__::func_142(uParam0, joaat("P_SPOON01X"), 0f, 0f, 0f, "SPOON", 0, 0, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@john_6@base", 1, 1, 0, 0);
	__LIB_6__::func_959(uParam0, "script@vignette@john_6@action", 0, 0, 1, 0);
	__LIB_7__::func_146(uParam0, "CCJN6AU");
	__LIB_7__::func_107(uParam0, iLocal_15, 2, joaat("PROP_CAMP_SEAT_CHAIR_STEW"), "PROP_CAMP_SEAT_CHAIR_STEW_EATING_MALE_B", -1, 0);
	__LIB_7__::func_107(uParam0, iLocal_14, 3, joaat("PROP_HUMAN_SEAT_BENCH_PORCH"), "PROP_HUMAN_SEAT_BENCH_PORCH_SMOKING_MALE_A", iLocal_16, 0);
	__LIB_7__::func_127(uParam0, iLocal_14, 3, joaat("PROP_HUMAN_SEAT_BENCH_PORCH"), "PROP_HUMAN_SEAT_BENCH_PORCH_SMOKING_MALE_A", iLocal_16, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_139(uParam0, iLocal_14, iLocal_17, "p_cigarette_cs01x_PH_R_HAND", 0, 0);
	__LIB_7__::func_147(uParam0, iLocal_14, 4, 1, 0, 0, 0);
	__LIB_7__::func_277(uParam0, iLocal_14, "GREET_MICAH_JHNCNV6", 60000, 1);
	__LIB_7__::func_151(uParam0, iLocal_14, 1, -1);
	__LIB_7__::func_149(uParam0, joaat("COMP_JHNCNV6"), joaat("PLAYER_JHNCNV6"));
	return true;
}
...
{
	if (!__LIB_0__::func_75(&uLocal_20))
	{
		__LIB_1__::func_283(&uLocal_20, 0);
	}
	if (__LIB_0__::func_264(&uLocal_20) > 5f && !CAM::IS_SPHERE_VISIBLE(uParam0->f_23, 3f))
	{
	...
	switch (Global_1360165[iParam0 /*1157*/].f_11)
	{
		...
		case 3:
			if (!ENTITY::IS_ENTITY_DEAD(Global_1360165[iParam0 /*1157*/]) && !ANIMSCENE::_0x3AB6C7B0BB0DF4B1(Global_1360165[iParam0 /*1157*/], -1))
			{
				...
				func_421(Global_1360165[iParam0 /*1157*/], vVar0, iParam6, 2, 1073741824 /* Float: 2f */);
			}
			else if (bParam16)
			{
	...
	switch (Global_1360165[iParam0 /*1157*/].f_70.f_12)
	{
		...
		case 3:
			...
			if ((bParam2 && !__LIB_0__::func_86(vVar0)) && !__LIB_0__::func_175(vVar0, ENTITY::GET_ENTITY_COORDS(Global_1360165[iParam0 /*1157*/].f_124, true, false), 1056964608 /* Float: 0.5f */, 1))
			{
				...
				func_421(Global_1360165[iParam0 /*1157*/].f_124, vVar0, iParam6, 2, 1073741824 /* Float: 2f */);
			}
			if (bParam1)
			{
