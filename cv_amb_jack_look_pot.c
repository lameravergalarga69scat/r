...
bool func_7(var uParam0)
{
	...
	switch (__LIB_6__::func_949(uParam0))
	{
		...
		case 4:
			...
			{
				if (__LIB_17__::func_988(uParam0))
				{
...
bool func_72(var uParam0)
{
	...
	{
		case 1:
			__LIB_7__::func_45(uParam0, 124, 0, 0, 0);
			break;
		case 2:
			__LIB_7__::func_45(uParam0, 61, 0, 0, 0);
			break;
		case 6:
			__LIB_7__::func_45(uParam0, 3, 0, 0, 0);
			break;
		default:
			return false;
	}
	__LIB_7__::func_48(uParam0, 14, 0);
	iLocal_14 = __LIB_6__::func_959(uParam0, "script@ambient@campfiregeneral@world_camp_jack_av_look_pot@action", 64, 1, 0, 0);
	__LIB_7__::func_47(uParam0, 1.1377f, 0.1626f, 0f, 92.75f, 0.975f, 1f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_JACK"), 1, 1, 1);
	...
	switch (Global_1360165[iParam0 /*1157*/].f_11)
	{
		...
		case 3:
			if (!ENTITY::IS_ENTITY_DEAD(Global_1360165[iParam0 /*1157*/]) && !ANIMSCENE::_0x3AB6C7B0BB0DF4B1(Global_1360165[iParam0 /*1157*/], -1))
			{
				...
				func_386(Global_1360165[iParam0 /*1157*/], vVar0, iParam6, 2, 1073741824 /* Float: 2f */);
			}
			else if (bParam16)
			{
	...
	switch (Global_1360165[iParam0 /*1157*/].f_70.f_12)
	{
		...
		case 3:
			...
			if ((bParam2 && !__LIB_0__::func_86(vVar0)) && !__LIB_0__::func_175(vVar0, ENTITY::GET_ENTITY_COORDS(Global_1360165[iParam0 /*1157*/].f_124, true, false), 1056964608 /* Float: 0.5f */, 1))
			{
				...
				func_386(Global_1360165[iParam0 /*1157*/].f_124, vVar0, iParam6, 2, 1073741824 /* Float: 2f */);
			}
			if (bParam1)
			{
