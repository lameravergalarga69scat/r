...
bool func_74(var uParam0)
{
	...
	{
		case 8:
			__LIB_7__::func_45(uParam0, 29, 0, 0, 0);
			break;
		default:
			return false;
	}
	...
	__LIB_7__::func_47(uParam0, 0.1f, -0.35f, 0.5f, 0f, 3.36f, 3f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_ABIGAIL"), 1, 1, 1);
	__LIB_7__::func_159(uParam0, 0.65f, -0.5f, 0.5f, 0f, 0.4f, 0.4f, 3f, joaat("VOLCYLINDER"), 1);
	iLocal_20 = __LIB_6__::func_958(uParam0, joaat("P_BROOM02X"), 0f, 0f, 0f, "BROOM", 0, 0, 1);
	__LIB_6__::func_958(uParam0, joaat("P_CHAIR05X"), 0.878931f, 0.51915f, 0.000312805f, "CHAIR", 1, 0, 1);
	__LIB_7__::func_271(uParam0, iLocal_14, joaat("WEAPON_REPEATER_WINCHESTER"), "REPEATER");
	__LIB_6__::func_959(uParam0, "script@vignette@beecher@abigail_and_charles_1@base", 1, 1, 0, 0);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@beecher@abigail_and_charles_1@action_a", 2, 0, 1, 0);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@beecher@abigail_and_charles_1@action_b", 0, 0, 0, 0);
	iLocal_18 = __LIB_6__::func_959(uParam0, "script@vignette@beecher@abigail_and_charles_1@action_b_alt_left", 0, 0, 0, 1);
	iLocal_19 = __LIB_6__::func_959(uParam0, "script@vignette@beecher@abigail_and_charles_1@action_b_alt_right", 0, 0, 0, 1);
	__LIB_7__::func_146(uParam0, "BANC1AU");
	__LIB_7__::func_149(uParam0, joaat("COMP_BCANCCNV1"), joaat("PLAYER_BCANCCNV1"));
	__LIB_7__::func_151(uParam0, iLocal_15, 1, -1);
	__LIB_7__::func_151(uParam0, iLocal_14, 1, -1);
	__LIB_7__::func_153(uParam0, iLocal_14, 4, joaat("PROP_CAMP_CHARLES_SEAT_CHAIR_ARROW_FLETCH"), 0, -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_162(uParam0, iLocal_14, 4, 0);
	__LIB_7__::func_107(uParam0, iLocal_15, 2, joaat("WORLD_HUMAN_BROOM"), "WORLD_HUMAN_BROOM_WORKING_FEMALE_B", -1, 1);
	__LIB_7__::func_153(uParam0, iLocal_15, 2, joaat("WORLD_HUMAN_BROOM"), "WORLD_HUMAN_BROOM_WORKING_FEMALE_B", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_139(uParam0, iLocal_15, iLocal_20, "p_broom02x_PH_R_HAND", 0, 0);
	Local_21 = { __LIB_7__::func_160(uParam0, 0.2714f, -1.4657f, 1.0383f, 128.88f, 4.25f, 0.5f, 0.5f) };
	Local_31 = { __LIB_7__::func_160(uParam0, 0.271f, -1.466f, 1.038f, -128.88f, 3.15f, 0.5f, 0.635f) };
