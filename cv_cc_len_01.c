...
bool func_73(var uParam0)
{
	...
	{
		case 1:
			__LIB_7__::func_45(uParam0, 149, 0, 0, 0);
			break;
		case 2:
			__LIB_7__::func_45(uParam0, 82, 0, 0, 0);
			break;
		case 3:
			__LIB_7__::func_45(uParam0, 209, 0, 0, 0);
			break;
		default:
			return false;
	}
	iLocal_14 = __LIB_7__::func_48(uParam0, 9, 0);
	iLocal_15 = __LIB_7__::func_48(uParam0, 6, 0);
	__LIB_7__::func_47(uParam0, -0.139043f, 4.19721f, 0.936508f, 0f, 1.1f, 1.1f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_LENNY"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, -3.04281f, 2.53789f, 0.945671f, 0f, 1.1f, 1.1f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_MICAH"), 1, 1, 1);
	__LIB_7__::func_159(uParam0, -1.22049f, 3.99844f, 0.991776f, 0f, 1.1f, 1.1f, 3f, joaat("VOLCYLINDER"), 1);
	bVar0 = __LIB_0__::func_78(uParam0) != 2;
	__LIB_7__::func_341(uParam0, joaat("P_CRATE15X"), -2.528f, 1.918f, 0.142f, "CRATE", bVar0, 0, 1);
	__LIB_7__::func_341(uParam0, joaat("P_BOTTLEBEER01X"), 0f, 0f, 0f, "BOTTLE", 0, 1, 1);
	__LIB_7__::func_341(uParam0, joaat("P_CS_LEDGER01X"), 0f, 0f, 0f, "LEDGER", 0, 1, 1);
	__LIB_7__::func_341(uParam0, joaat("P_PEN01X"), 0f, 0f, 0f, "PEN", 0, 1, 1);
	if (__LIB_0__::func_78(uParam0) == 2)
	{
		iLocal_22 = __LIB_7__::func_341(uParam0, joaat("P_CRATEBRAND03X"), -0.407827f, 3.55382f, -0.0014267f, 0, 1, 0, 1);
		iLocal_23 = __LIB_7__::func_341(uParam0, joaat("P_CRATE03X"), -0.4062f, 3.5481f, 0.519173f, 0, 0, 0, 1);
	}
	if (__LIB_0__::func_78(uParam0) == 3)
	{
		iLocal_23 = __LIB_7__::func_341(uParam0, joaat("P_CRATE03X"), -0.4062f, 3.5481f, 0.519173f, 0, 0, 0, 1);
	}
	__LIB_6__::func_959(uParam0, "script@vignette@lenny_1@base", 1, 1, 0, 0);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@lenny_1@action_a", 2, 0, 1, 0);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@lenny_1@action_b", 2, 0, 0, 0);
	iLocal_18 = __LIB_6__::func_959(uParam0, "script@vignette@lenny_1@action_b_alt_left", 2, 0, 0, 1);
	iLocal_19 = __LIB_6__::func_959(uParam0, "script@vignette@lenny_1@action_b_alt_right", 2, 0, 0, 1);
	iLocal_20 = __LIB_6__::func_959(uParam0, "script@vignette@lenny_1@action_c", 0, 0, 0, 0);
	__LIB_7__::func_146(uParam0, "LEN1AUD");
	__LIB_7__::func_147(uParam0, iLocal_14, 2, 1, 0, 0, 0);
	__LIB_7__::func_151(uParam0, iLocal_14, 1, -1);
	__LIB_7__::func_149(uParam0, joaat("COMP_LENCNV1"), joaat("PLAYER_LENCNV1"));
	__LIB_7__::func_151(uParam0, iLocal_15, 3, -1);
	Local_24 = { __LIB_7__::func_160(uParam0, -1.6866f, 5.0384f, 0.8993f, 100f, 6f, 0.3f, 0.3f) };
	Local_34 = { __LIB_7__::func_160(uParam0, -1.6866f, 5.0384f, 0.8993f, 5f, 6f, 0.3f, 0.3f) };
	return true;
}
...
bool func_87(var uParam0)
{
	if (__LIB_0__::func_78(uParam0) == 2)
	{
		...
		{
			ENTITY::SET_ENTITY_HEADING(__LIB_7__::func_30(uParam0, iLocal_22), 134.4794f);
		}
		if (ENTITY::DOES_ENTITY_EXIST(__LIB_7__::func_30(uParam0, iLocal_23)))
		{
			ENTITY::SET_ENTITY_HEADING(__LIB_7__::func_30(uParam0, iLocal_23), 131.683f);
		}
	}
	if (__LIB_0__::func_78(uParam0) == 3)
	{
...
bool func_94(var uParam0)
{
	if (__LIB_7__::func_148(uParam0, iLocal_16))
	{
		...
		{
			__LIB_7__::func_150(uParam0, iLocal_18, -1, 0.73f);
			iLocal_21 = iLocal_18;
		}
		else if (__LIB_7__::func_163(uParam0, Local_34, 1, 0))
		{
			__LIB_7__::func_150(uParam0, iLocal_19, -1, 0.73f);
			iLocal_21 = iLocal_19;
		}
		else
		{
			__LIB_7__::func_150(uParam0, iLocal_17, -1, 0.73f);
			iLocal_21 = iLocal_17;
		}
