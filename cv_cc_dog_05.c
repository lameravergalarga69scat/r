...
bool func_72(var uParam0)
{
	...
	iLocal_14 = __LIB_7__::func_48(uParam0, 12, "DOG");
	iLocal_15 = __LIB_7__::func_48(uParam0, 6, "MicahBell");
	iLocal_16 = __LIB_7__::func_48(uParam0, 3, "BillWilliamson");
	__LIB_7__::func_47(uParam0, 1.0564f, -1.585f, 0f, -46.75f, 1.2f, 1.2f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_MICAH"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, -0.6186f, 2.04f, 0f, 39.5f, 1.55f, 1.11f, 5f, joaat("VOLBOX"), -1, 1, 1, 1);
	__LIB_7__::func_159(uParam0, 0.24f, 2.24f, 0.9775f, 16.2f, 1f, 0.76f, 2f, joaat("VOLCYLINDER"), 1);
	__LIB_6__::func_958(uParam0, joaat("P_KNIFE02X"), 0f, 0f, 0f, "Knife", 0, 1, 1);
	__LIB_6__::func_958(uParam0, joaat("P_WOODWHITTLE01X"), 0f, 0f, 0f, "Woodwhittle", 0, 1, 1);
	iLocal_18 = __LIB_6__::func_958(uParam0, joaat("P_CHAIRFOLDING02X"), 1.2f, -1.868f, -0.0285f, 0, 1, 0, 1);
	iLocal_19 = __LIB_6__::func_958(uParam0, joaat("P_BENCH_LOG07X"), -1.372f, 1.604f, -0.0733f, 0, 1, 0, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@dog_5@base", 1, 1, 0, 0);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@dog_5@action", 0, 0, 1, 0);
	__LIB_7__::func_107(uParam0, iLocal_14, 3, joaat("WORLD_ANIMAL_DOG_RESTING"), "WORLD_ANIMAL_DOG_RESTING", -1, 1);
	__LIB_7__::func_172(uParam0, iLocal_14, 1);
	__LIB_7__::func_107(uParam0, iLocal_16, 3, joaat("PROP_HUMAN_SEAT_CHAIR"), "PROP_HUMAN_SEAT_CHAIR_GENERIC_MALE_A", iLocal_19, 0);
	__LIB_7__::func_127(uParam0, iLocal_16, 2, joaat("PROP_HUMAN_SEAT_CHAIR"), "PROP_HUMAN_SEAT_CHAIR_GENERIC_MALE_A", iLocal_19, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_107(uParam0, iLocal_15, 3, joaat("PROP_HUMAN_SEAT_CHAIR_WHITTLE"), "PROP_HUMAN_SEAT_CHAIR_WHITTLE_MALE_A", iLocal_18, 0);
	return true;
}
...
bool func_93(var uParam0)
{
	...
	if (!bLocal_20)
	{
		if (__LIB_7__::func_40(uParam0, iLocal_17, 0.419f))
		{
			TASK::_0x2E1D6D87346BB7D2(__LIB_6__::func_952(uParam0, iLocal_14), __LIB_6__::func_952(uParam0, iLocal_15), 0, 0);
			bLocal_20 = true;
		}
	}
	if (__LIB_7__::func_74(uParam0, iLocal_14) && !bLocal_21)
	{
		PED::SET_PED_CONFIG_FLAG(__LIB_6__::func_952(uParam0, iLocal_14), 447, true);
		TASK::OPEN_SEQUENCE_TASK(&iVar0);
		TASK::TASK_FORCE_MOTION_STATE(0, -1415276238, true);
		TASK::TASK_SMART_FLEE_PED(0, __LIB_6__::func_952(uParam0, iLocal_15), 15f, 2000, 65792, 1.6001f, 0);
		TASK::CLOSE_SEQUENCE_TASK(iVar0);
		TASK::TASK_PERFORM_SEQUENCE(__LIB_6__::func_952(uParam0, iLocal_14), iVar0);
	...
	if (bLocal_21)
	{
		...
		{
			if (__LIB_0__::func_163(__LIB_6__::func_952(uParam0, iLocal_14), 258748395))
			{
				PED::SET_PED_CONFIG_FLAG(__LIB_6__::func_952(uParam0, iLocal_14), 447, false);
				__LIB_7__::func_113(uParam0, iLocal_14, 1, 1);
			}
			if (!bLocal_22 && !__LIB_0__::func_163(__LIB_6__::func_952(uParam0, iLocal_14), 242628503))
			{
				TASK::TASK_PERSISTENT_CHARACTER(__LIB_6__::func_952(uParam0, iLocal_14));
				bLocal_22 = true;
			}
		}
	}
