...
bool func_72(var uParam0)
{
	...
	iLocal_14 = __LIB_7__::func_48(uParam0, 5, "HoseaMatthews");
	__LIB_7__::func_47(uParam0, -2.4325f, 2.2591f, 1.0716f, 0f, 1.5f, 1.5f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_HOSEA"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, -0.0125f, -1.7999f, 1.072f, 0f, 2.755f, 1.8f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_PEARSON"), 1, 1, 1);
	__LIB_7__::func_159(uParam0, -0.896063f, -1.52353f, 1.00637f, 0f, 1f, 1f, 3f, joaat("VOLCYLINDER"), 1);
	__LIB_6__::func_958(uParam0, joaat("P_CIGARETTE_CS01X"), 0f, 0f, 0f, "p_cigarette_cs01x", 0, 1, 1);
	__LIB_6__::func_958(uParam0, joaat("P_FILLETKNIFE01X"), 0f, 0f, 0f, "p_filletKnife01x", 0, 1, 1);
	__LIB_6__::func_958(uParam0, joaat("P_KNIFESHARPENER01X"), 0f, 0f, 0f, "p_knifesharpener01x", 0, 1, 1);
	__LIB_6__::func_958(uParam0, joaat("P_MATCHSTICK01X"), 0f, 0f, 0f, "p_matchstick01x", 0, 1, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@hosea_19@base", 1, 1, 0, 0);
	__LIB_6__::func_959(uParam0, "script@vignette@hosea_19@Action", 0, 0, 1, 0);
	__LIB_7__::func_146(uParam0, "CCH19AU");
	__LIB_7__::func_151(uParam0, iLocal_14, 1, -1);
	__LIB_7__::func_149(uParam0, joaat("COMP_HSHCNV19"), joaat("PLAYER_HSHCNV19"));
	__LIB_7__::func_127(uParam0, iLocal_15, 2, joaat("WORLD_HUMAN_SMOKE"), "WORLD_HUMAN_SMOKE_MALE_D", -1, 1, 45f, 1065353216 /* Float: 1f */, 1);
	return true;
}
