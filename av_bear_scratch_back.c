...
{
	__LIB_2__::func_851(uParam0, 10727, 10786, 11454);
}

void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	__LIB_2__::func_853(uParam0, "BEAR_SCRATCH_BACK", "script@ambient@animal@bear_scratch_back_on_tree@action", vParam1, vParam4);
	__LIB_2__::func_854(uParam0, 1, "pbl_action", "", 0);
	__LIB_2__::func_855(uParam0, 0, "BEAR", iLocal_9, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 0);
}
...
int func_31(var uParam0)
{
	...
	if (!uParam0->f_469[0])
	{
		if (!bLocal_38)
		{
			if (__LIB_2__::func_908(uParam0, &uLocal_10, 1) || __LIB_0__::func_232(Global_35, uParam0->f_20[0 /*14*/], 1) < 900f)
			{
				bLocal_38 = true;
			}
		}
	...
	if (!uParam0->f_469[0] && !bLocal_38)
	{
		...
		if (uParam0->f_469[2])
		{
			if (!uParam0->f_469[4])
			{
				if (__LIB_2__::func_889(uParam0, 3f, 1116471296 /* Float: 70f */, 4, joaat("ACTION"), 1))
				{
					__LIB_2__::func_890(*uParam0, uParam0->f_483, 1);
					uParam0->f_469[4] = 1;
				}
