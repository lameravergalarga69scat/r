...
bool func_77(var uParam0)
{
	...
	iLocal_92 = __LIB_7__::func_48(uParam0, 16, 0);
	iLocal_93 = __LIB_7__::func_48(uParam0, 20, 0);
	__LIB_7__::func_47(uParam0, 0.2625f, -1.4f, 1.15f, -24.94f, 2.7875f, 3.5725f, 2.685f, joaat("VOLBOX"), joaat("APMS_COMP_KAREN"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, 1.2375f, 4.9625f, 1.15f, 6.81f, 1.1f, 1f, 2.685f, joaat("VOLBOX"), joaat("APMS_COMP_MOLLY"), 1, 1, 1);
	iLocal_99 = __LIB_6__::func_958(uParam0, joaat("P_CS_LEDGERSMALL01X"), 0f, 0f, 0f, "BOOK", 0, 0, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@molly_5@base", 1, 1, 0, 0);
	iLocal_94 = __LIB_6__::func_959(uParam0, "script@vignette@molly_5@action_a", 2, 0, 1, 0);
	iLocal_95 = __LIB_6__::func_959(uParam0, "script@vignette@molly_5@action_b", 0, 0, 0, 0);
	iLocal_96 = __LIB_6__::func_959(uParam0, "script@vignette@molly_5@action_b_alt_karen_front", 0, 0, 0, 1);
	iLocal_97 = __LIB_6__::func_959(uParam0, "script@vignette@molly_5@action_b_alt_karen_left", 0, 0, 0, 1);
	iLocal_98 = __LIB_6__::func_959(uParam0, "script@vignette@molly_5@action_b_alt_molly_wnt", 0, 0, 0, 1);
	__LIB_7__::func_146(uParam0, "CMLL5AU");
	__LIB_7__::func_149(uParam0, joaat("COMP_MLLCNV5"), joaat("PLAYER_MLLCNV5"));
	__LIB_7__::func_107(uParam0, iLocal_92, 3, joaat("WORLD_HUMAN_STAND_WAITING"), "WORLD_HUMAN_STAND_WAITING_FEMALE_A", -1, 1);
	__LIB_7__::func_153(uParam0, iLocal_92, 1, joaat("WORLD_HUMAN_WAITING_IMPATIENT"), 0, -1, 0, __LIB_6__::func_995(100f, 140f), 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_147(uParam0, iLocal_92, 2, 4, 0, "Default_Angry", "angry_a");
	__LIB_7__::func_144(uParam0, iLocal_92, 1.5f, 1065353216 /* Float: 1f */, 1092616192 /* Float: 10f */);
	__LIB_7__::func_172(uParam0, iLocal_92, 1);
	__LIB_7__::func_107(uParam0, iLocal_93, 3, joaat("WORLD_HUMAN_SIT_GROUND_READING_JOURNAL"), "WORLD_HUMAN_SIT_GROUND_READING_JOURNAL_FEMALE_A", -1, 1);
	__LIB_7__::func_153(uParam0, iLocal_93, 2, joaat("WORLD_HUMAN_SIT_GROUND_READING_JOURNAL"), "WORLD_HUMAN_SIT_GROUND_READING_JOURNAL_FEMALE_A", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_139(uParam0, iLocal_93, iLocal_99, "p_cs_ledgerSmall01x_PH_L_HAND", 0, 0);
	__LIB_7__::func_151(uParam0, iLocal_93, 1, -1);
	Local_110 = { __LIB_7__::func_160(uParam0, 0.675f, -2.8075f, 1.0875f, -7.25f, 7f, 0.4675f, 0.183f) };
	Local_100 = { __LIB_7__::func_160(uParam0, 0.675f, -2.808f, 1.0875f, 34.75f, 7f, 1f, 0f) };
	Local_120 = { __LIB_7__::func_160(uParam0, -0.7275f, 3.0675f, 1.0875f, -40f, 5f, 0.5975f, 0.5455f) };
...
bool func_98(var uParam0)
{
	...
	{
		if (__LIB_7__::func_163(uParam0, Local_100, 1, 0))
		{
			__LIB_7__::func_154(uParam0, iLocal_96, 1);
		}
		else if (__LIB_7__::func_163(uParam0, Local_110, 1, 0))
		{
			__LIB_7__::func_154(uParam0, iLocal_97, 1);
		}
		else
		{
			__LIB_7__::func_154(uParam0, iLocal_95, 1);
		}
	}
	if (!bLocal_130)
	{
		if (__LIB_7__::func_74(uParam0, iLocal_92))
		{
			if (__LIB_7__::func_163(uParam0, Local_120, 1, 0))
			{
				__LIB_7__::func_310(uParam0, &uLocal_18);
				__LIB_7__::func_154(uParam0, iLocal_98, 1);
				bLocal_130 = true;
			}
			else
			{
