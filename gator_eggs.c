...
void __EntryFunction__()
{
	...
	iLocal_35 = __LIB_1__::func_35(iLocal_36, 24);
	while (func_6())
	{
...
void func_3(var uParam0)
{
	...
	iVar1 = 0;
	while (iVar1 < __LIB_1__::func_34(iLocal_36, 16))
	{
...
bool func_8(var uParam0)
{
	...
	{
		case 0:
			__LIB_3__::func_414(&(uParam0->f_2), vLocal_17, 2f, 1, -1, 0);
			func_13(uParam0);
		...
		case 2:
			...
			break;
		case 3:
			if (__LIB_0__::func_94(Global_35, vLocal_17, 0) < 25f)
			{
		...
		case 4:
			func_19();
			if (__LIB_3__::func_510(&uLocal_22, &iLocal_28, __LIB_1__::func_34(iLocal_36, 16), vLocal_17, 5f) > 0)
			{
				iVar0 = 0;
				while (iVar0 < __LIB_1__::func_34(iLocal_36, 16))
				{
			...
			if (func_21() == __LIB_1__::func_34(iLocal_36, 16))
			{
				__LIB_0__::func_19(uParam0, 5);
			}
			break;
		case 5:
			if (__LIB_0__::func_94(Global_35, vLocal_17, 0) < 10f)
			{
		...
		case 6:
			...
			break;
		case 7:
			if (__LIB_0__::func_94(Global_35, vLocal_17, 0) < 8f)
			{
		...
		case 8:
			...
			break;
		case 9:
			if (ENTITY::HAS_ANIM_EVENT_FIRED(Global_35, 89266752) && __LIB_0__::func_266(Global_35, vLocal_17, 1.5f, 1, 1))
			{
			...
			break;
		case 10:
			__LIB_0__::func_442(iLocal_36);
			__LIB_0__::func_703(0, 10);
			func_27(iLocal_36);
			func_28(joaat("PROVISION_GATOR_EGG"), __LIB_1__::func_34(iLocal_36, 16), 0, 0, 0, 752097756, 0, 0, 0, 0);
			func_29(uParam0);
			__LIB_0__::func_19(uParam0, 14);
			break;
		case 11:
...
bool func_16()
{
	...
	{
		if ((iLocal_36 == joaat("GATOR_EGG_NEST_17") || iLocal_36 == joaat("GATOR_EGG_NEST_18")) || iLocal_36 == joaat("GATOR_EGG_NEST_19"))
		{
			return true;
		}
	}
	if (__LIB_0__::func_923(Global_40.f_12019.f_5[__LIB_1__::func_34(iLocal_36, 15)]))
	{
		if (__LIB_1__::func_426(Global_40.f_12019.f_5[__LIB_1__::func_34(iLocal_36, 15)], 1))
		{
			return true;
		}
		else
...
void func_19()
{
	...
	while (iVar0 < 5)
	{
		iLocal_28[iVar0] = joaat("S_GATOREGG01X");
		iVar0++;
	}
}
	...
	while (iVar0 < __LIB_1__::func_34(iLocal_36, 16))
	{
		if (ENTITY::DOES_ENTITY_EXIST(uLocal_22[iVar0]))
		{
			if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_22[iVar0], Global_35, 1, 1))
			{
				if (__LIB_2__::func_765(256, 0))
				{
					if (iLocal_36 == joaat("GATOR_EGG_NEST_17"))
					{
						iVar1 = __LIB_5__::func_297(__LIB_1__::func_316(3, joaat("HAI_HUNTING_06")));
						MISC::SET_BIT(&iVar1, 0);
						__LIB_7__::func_448(__LIB_1__::func_316(3, joaat("HAI_HUNTING_06")), iVar1);
					}
					if (iLocal_36 == joaat("GATOR_EGG_NEST_18"))
					{
						iVar1 = __LIB_5__::func_297(__LIB_1__::func_316(3, joaat("HAI_HUNTING_06")));
						MISC::SET_BIT(&iVar1, 1);
						__LIB_7__::func_448(__LIB_1__::func_316(3, joaat("HAI_HUNTING_06")), iVar1);
					}
					if (iLocal_36 == joaat("GATOR_EGG_NEST_19"))
					{
						iVar1 = __LIB_5__::func_297(__LIB_1__::func_316(3, joaat("HAI_HUNTING_06")));
...
{
	Global_40.f_12019.f_5[__LIB_1__::func_34(iParam0, 15)] = __LIB_0__::func_23();
	__LIB_1__::func_446(&(Global_40.f_12019.f_5[__LIB_1__::func_34(iParam0, 15)]), 0, 0, 0, 7, 0, 0, 0);
}
...
{
	int iVar0;
	__LIB_2__::func_353(&(uParam0->f_2), 1);
	if (MAP::DOES_BLIP_EXIST(uParam0->f_1))
	{
		MAP::REMOVE_BLIP(&(uParam0->f_1));
	}
...
void func_30()
{
	...
	while (iVar0 < __LIB_1__::func_34(iLocal_36, 16))
	{
		...
		{
			__LIB_2__::func_919(uLocal_22[iVar0], 1, 1);
