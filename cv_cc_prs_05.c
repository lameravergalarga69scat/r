...
bool func_72(var uParam0)
{
	...
	__LIB_7__::func_47(uParam0, 0f, 0f, 0f, 0f, 3f, 3f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_PEARSON"), 1, 1, 1);
	iLocal_19 = __LIB_6__::func_958(uParam0, joaat("P_KNIFE03X"), 0f, 0f, 0f, "KNIFE", 0, 0, 1);
	iLocal_18 = __LIB_6__::func_958(uParam0, joaat("P_CS_RABBITHEADLESS"), 0f, 0f, 0f, "MEATBIT", 0, 0, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@pearson_5@base", 1, 1, 0, 0);
	iLocal_15 = __LIB_6__::func_959(uParam0, "script@vignette@pearson_5@action_a", 2, 0, 1, 1);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@pearson_5@action_b", 0, 0, 0, 1);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@pearson_5@exit_to_base", 0, 0, 0, 0);
	__LIB_7__::func_146(uParam0, "CPRS5AU");
	__LIB_7__::func_127(uParam0, iLocal_14, 4, joaat("WORLD_HUMAN_BUTCHER_RABBIT"), "WORLD_HUMAN_BUTCHER_RABBIT_MALE_A_RABBIT_CHOP", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_171(uParam0, iLocal_14, 4, 1);
	__LIB_7__::func_139(uParam0, iLocal_14, iLocal_18, "RABBIT", 0, 0);
	__LIB_7__::func_139(uParam0, iLocal_14, iLocal_19, "KNIFE", 0, 0);
	...
	Local_20 = { __LIB_7__::func_160(uParam0, 1.0009f, 0.067f, 1.0041f, 89.64f, 7f, 0.6f, 0.6f) };
	return true;
}
...
{
	uLocal_30 = STREAMING::_0xB223249B7798EEED(__LIB_6__::func_952(uParam0, iLocal_14), joaat("WORLD_HUMAN_BUTCHER_RABBIT"), 262145, joaat("WORLD_HUMAN_BUTCHER_RABBIT_MALE_A_RABBIT_CHOP"));
	return true;
}
