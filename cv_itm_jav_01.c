...
bool func_1(var uParam0)
{
	...
	__LIB_1__::func_281(&iLocal_31, 1, 1);
...
{
	__LIB_7__::func_45(uParam0, 163, 0, 0, 0);
	iLocal_14 = __LIB_7__::func_48(uParam0, 2, 0);
	__LIB_7__::func_47(uParam0, 0f, 0f, 0f, 0f, 1f, 1f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_JAVIER"), 1, 1, 1);
	iLocal_18 = __LIB_6__::func_958(uParam0, joaat("P_JAVIERKNIFE_TEMP"), 0f, 0f, 0f, "KNIFE1", 0, 1, 1);
	__LIB_6__::func_958(uParam0, joaat("P_CS_RAG02X"), 0f, 0f, 0f, "RAG", 0, 0, 1);
	iLocal_17 = __LIB_6__::func_958(uParam0, joaat("P_STOOLFOLDING01X"), 0f, 0f, 0f, 0, 1, 0, 1);
	vLocal_36 = { __LIB_6__::func_972(uParam0, vLocal_39) };
	__LIB_7__::func_385(uParam0, 1334068263, vLocal_39, 180f);
	iLocal_15 = __LIB_6__::func_959(uParam0, "script@vignette@itm@javier_item_1@base", 1, 0, 0, 0);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@itm@javier_item_1@action", 0, 0, 0, 1);
	__LIB_7__::func_107(uParam0, iLocal_14, 3, joaat("PROP_CAMP_SEAT_CHAIR_CRAFT_POISON_KNIVES"), "PROP_CAMP_SEAT_CHAIR_CRAFT_POISON_KNIVES_MALE_A_APPLY_POISON", iLocal_17, 0);
	__LIB_7__::func_127(uParam0, iLocal_14, 3, joaat("PROP_CAMP_SEAT_CHAIR_CRAFT_POISON_KNIVES"), "PROP_CAMP_SEAT_CHAIR_CRAFT_POISON_KNIVES_MALE_A_APPLY_POISON", iLocal_17, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_151(uParam0, iLocal_14, 2, -1);
	__LIB_7__::func_146(uParam0, "CJVI1AU");
	Local_19 = { __LIB_7__::func_160(uParam0, -0.0411f, -0.1084f, 0.5054f, 1.8007f, 5.5f, 0.65f, 0.65f) };
...
{
	ANIMSCENE::REMOVE_ANIM_SCENE_ENTITY(__LIB_7__::func_185(uParam0, iLocal_15), "JAVIER", __LIB_6__::func_952(uParam0, iLocal_14));
...
bool func_91(var uParam0)
{
	if (func_197(uParam0))
	{
		iLocal_33 = PED::_0x4D0D2E3D8BC000EB(__LIB_6__::func_952(uParam0, iLocal_14), "p_Javierknife_temp_PH_R_HAND", 1);
		iLocal_34 = PED::_0x4D0D2E3D8BC000EB(__LIB_6__::func_952(uParam0, iLocal_14), "p_cs_rag01x_PH_L_HAND", 1);
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_33))
		{
			__LIB_6__::func_986(iLocal_33, __LIB_7__::func_185(uParam0, iLocal_16), "KNIFE0");
		}
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_34))
		{
			__LIB_6__::func_986(iLocal_34, __LIB_7__::func_185(uParam0, iLocal_16), "RAG01");
		}
		return true;
	}
	return false;
...
bool func_94(var uParam0)
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(__LIB_6__::func_952(uParam0, iLocal_14)))
	{
		PLAYER::_0x3946FC742AC305CD(PLAYER::PLAYER_ID(), __LIB_6__::func_952(uParam0, iLocal_14), sLocal_35, 0f, 0f, 0f, 0, sLocal_35);
		MISC::_0xE98D55C5983F2509(__LIB_6__::func_952(uParam0, iLocal_14));
	}
...
bool func_97(var uParam0)
{
	...
	{
		PLAYER::_0xC67A4910425F11F1(PLAYER::PLAYER_ID(), sLocal_35);
		__LIB_7__::func_393(10, 2, 1);
	}
	if (__LIB_7__::func_74(uParam0, iLocal_14))
	{
		PED::_0x2B02DB082258625F(__LIB_6__::func_952(uParam0, iLocal_14), __LIB_7__::func_30(uParam0, iLocal_18), "p_Javierknife_temp_PH_R_HAND", joaat("PROP_CAMP_SEAT_CHAIR_CRAFT_POISON_KNIVES"), "PROP_CAMP_SEAT_CHAIR_CRAFT_POISON_KNIVES_MALE_A_APPLY_POISON", 1);
		PED::_0x2B02DB082258625F(__LIB_6__::func_952(uParam0, iLocal_14), iLocal_34, "p_cs_rag01x_PH_L_HAND", joaat("PROP_CAMP_SEAT_CHAIR_CRAFT_POISON_KNIVES"), "PROP_CAMP_SEAT_CHAIR_CRAFT_POISON_KNIVES_MALE_A_APPLY_POISON", 1);
	}
	return true;
}
...
bool func_197(var uParam0)
{
	...
	if (ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(iLocal_32) != __LIB_6__::func_952(uParam0, iLocal_14))
	{
		__LIB_1__::func_281(&iLocal_31, 1, 1);
		return false;
	}
	if (!__LIB_0__::func_139(iLocal_31))
	{
		iLocal_31 = __LIB_2__::func_403("INTERACT_GREET", joaat("INPUT_INTERACT_LOCKON_POS"), __LIB_6__::func_952(uParam0, iLocal_14), 3, 0, 0, 0, 0, 6f, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, joaat("SHORT_TIMED_EVENT"), 0, 0);
		__LIB_4__::func_12(iLocal_31, HUD::_UIPROMPT_GET_GROUP_ID_FOR_TARGET_ENTITY(__LIB_6__::func_952(uParam0, iLocal_14)), 0, 1);
	}
	if (__LIB_1__::func_732(iLocal_31, 1))
	{
		return true;
	}
	return false;
