...
bool func_72(var uParam0)
{
	...
	{
		case 6:
			__LIB_7__::func_45(uParam0, 11, 0, 0, 0);
			break;
		default:
			return false;
	}
	...
	__LIB_7__::func_47(uParam0, 1.7125f, -2.1875f, 0.5445f, 80f, 4.7f, 2f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_CHARLES"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, -0.55f, 5.525f, 0.5445f, 80f, 2f, 2f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_JAVIER"), 1, 1, 1);
	__LIB_7__::func_159(uParam0, 1.3873f, -2.8002f, 1.15f, -6.94f, 0.955f, 1.4525f, 2.685f, joaat("VOLCYLINDER"), 1);
	iLocal_19 = __LIB_6__::func_958(uParam0, joaat("P_HAMMER02X"), 0f, 0f, 0f, "HAMMER", 0, 0, 1);
	__LIB_6__::func_958(uParam0, joaat("P_CIGARETTE_CS01X"), 0f, 0f, 0f, "CIGARETTE", 0, 1, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@charles_5@base", 1, 1, 0, 0);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@charles_5@action_a", 2, 0, 1, 0);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@charles_5@action_b", 0, 0, 0, 0);
	iLocal_18 = __LIB_6__::func_959(uParam0, "script@vignette@charles_5@action_b_alt", 0, 0, 0, 1);
	__LIB_7__::func_146(uParam0, "CCHR5AU");
	__LIB_7__::func_149(uParam0, joaat("COMP_CHRCNV5"), joaat("PLAYER_CHRCNV5"));
	__LIB_7__::func_107(uParam0, iLocal_14, 4, joaat("PROP_HUMAN_REPAIR_WAGON_WHEEL_ON_LARGE"), "PROP_HUMAN_REPAIR_WAGON_WHEEL_ON_LARGE_MALE_A", -1, 1);
	__LIB_7__::func_233(uParam0, iLocal_14, 2351.12f, 1344.36f, 104.675f, -44.701f, 1, 0);
	__LIB_7__::func_139(uParam0, iLocal_14, iLocal_19, "p_hammer02x_PH_R_HAND", 0, 0);
	__LIB_7__::func_127(uParam0, iLocal_14, 4, joaat("PROP_HUMAN_REPAIR_WAGON_WHEEL_ON_LARGE"), "PROP_HUMAN_REPAIR_WAGON_WHEEL_ON_LARGE_MALE_A", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	...
	__LIB_7__::func_147(uParam0, iLocal_15, 2, 2, 0, 0, 0);
	__LIB_7__::func_151(uParam0, iLocal_15, 1, -1);
	Local_20 = { __LIB_7__::func_160(uParam0, 1.515f, -3.3075f, 1.07f, -164.88f, 6.5f, 0.7f, 0.349f) };
	return true;
}
...
void func_161(var uParam0, int iParam1, int iParam2, int iParam3)
{
	...
	switch (iParam2)
	{
		case 4:
			...
			break;
		default:
			Var0 = { func_262(__LIB_0__::func_78(uParam0), __LIB_7__::func_120(uParam0, iParam1), __LIB_4__::func_576(uParam0), 1) };
