...
bool func_72(var uParam0)
{
	switch (__LIB_0__::func_78(uParam0))
	{
		...
		case 2:
			...
			break;
		case 3:
			__LIB_7__::func_45(uParam0, 202, 0, 0, 0);
			break;
		case 6:
			__LIB_7__::func_116(uParam0, 2356.562f, 1344.005f, 105.013f, 0f, 0f, -97.56f);
			break;
		default:
			return false;
	}
	iLocal_14 = __LIB_7__::func_48(uParam0, 6, 0);
	iLocal_15 = __LIB_7__::func_48(uParam0, 20, "CAMP_FEMALE");
	__LIB_7__::func_47(uParam0, 0.4792f, 3.9927f, 1.0444f, 17.28f, 1.5f, 1.5f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_MICAH"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, -0.758f, -0.2913f, 0.3804f, 0f, 1.5f, 1.5f, 3f, joaat("VOLBOX"), -1, 1, 1, 1);
	__LIB_6__::func_958(uParam0, joaat("P_WASHBOARD01X"), 0f, 0f, 0f, "WASHBOARD", 0, 1, 1);
	__LIB_6__::func_958(uParam0, joaat("P_BASINWATER01X"), 0f, 0f, 0f, "BASIN", 0, 1, 1);
	__LIB_6__::func_959(uParam0, "script@vignette@micah_10@base", 1, 1, 0, 0);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@micah_10@action", 2, 0, 1, 0);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@micah_10@exit_action", 0, 0, 0, 0);
	__LIB_7__::func_146(uParam0, "CCM10AU");
	...
	__LIB_7__::func_277(uParam0, iLocal_14, "GREET_MICAH_MCHCNV10", 60000, 1);
	__LIB_7__::func_149(uParam0, joaat("COMP_MCHCNV10"), joaat("PLAYER_MCHCNV10"));
	__LIB_7__::func_150(uParam0, iLocal_16, -1, 0.74f);
	...
	switch (Global_1360165[iParam0 /*1157*/].f_11)
	{
		...
		case 3:
			if (!ENTITY::IS_ENTITY_DEAD(Global_1360165[iParam0 /*1157*/]) && !ANIMSCENE::_0x3AB6C7B0BB0DF4B1(Global_1360165[iParam0 /*1157*/], -1))
			{
				...
				func_418(Global_1360165[iParam0 /*1157*/], vVar0, iParam6, 2, 1073741824 /* Float: 2f */);
			}
			else if (bParam16)
			{
	...
	switch (Global_1360165[iParam0 /*1157*/].f_70.f_12)
	{
		...
		case 3:
			...
			if ((bParam2 && !__LIB_0__::func_86(vVar0)) && !__LIB_0__::func_175(vVar0, ENTITY::GET_ENTITY_COORDS(Global_1360165[iParam0 /*1157*/].f_124, true, false), 1056964608 /* Float: 0.5f */, 1))
			{
				...
				func_418(Global_1360165[iParam0 /*1157*/].f_124, vVar0, iParam6, 2, 1073741824 /* Float: 2f */);
			}
			if (bParam1)
			{
