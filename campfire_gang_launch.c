...
bool func_32(vector3 vParam0, var uParam3)
{
	...
	if (__LIB_0__::func_181() && (((iLocal_14 == 1 || iLocal_14 == 12) || iLocal_14 == 3) || iLocal_14 == 9))
	{
		return false;
	}
	...
	if (!__LIB_17__::func_936(1, vParam0, -1, __LIB_3__::func_554(iLocal_14, 0, 0, 0)))
	{
		return false;
	}
	...
	{
		if (!__LIB_0__::func_175(vParam0, -1165.043f, 91.94646f, 43.90535f, 10f, 0))
		{
			return false;
		}
	}
	...
	{
		case 11:
			if (__LIB_0__::func_175(vParam0, 1504.914f, -1469.925f, 71.38271f, 10f, 0))
			{
				return false;
			}
			break;
		case 9:
			if (__LIB_0__::func_175(vParam0, -1712.438f, 606.3528f, 117.7065f, 10f, 0))
			{
				return false;
			}
			break;
	...
	else if (!func_65(__LIB_3__::func_554(iLocal_14, 0, 0, 0)))
	{
		return false;
	}
...
bool func_65(int iParam0)
{
	...
	{
		if (Global_1393237.f_192[iParam0] < (__LIB_0__::func_485() / 1000))
		{
			return true;
		}
	}
