...
{
	switch (__LIB_7__::func_360(uParam0->f_2))
	{
		case 1:
	...
	__LIB_7__::func_47(uParam0, 4.4f, -8.9625f, 0f, 0f, 1.2f, 1.2f, 4f, joaat("VOLBOX"), joaat("APMS_COMP_DUTCH"), 1, 1, 1);
	__LIB_7__::func_47(uParam0, 0.9625f, -0.5f, 0f, 0f, 1.87f, 1.87f, 4f, joaat("VOLBOX"), joaat("APMS_COMP_JOHN"), 1, 1, 1);
	__LIB_7__::func_159(uParam0, 0.56f, -0.96f, 1.0325f, 0f, 0.8f, 0.8f, 2f, joaat("VOLCYLINDER"), 1);
	iLocal_51 = __LIB_6__::func_958(uParam0, joaat("P_CS_LEDGER01X"), 0f, 0f, 0f, "BOOK", 0, 1, 1);
	__LIB_6__::func_958(uParam0, joaat("P_CIGARLIT01X"), 0f, 0f, 0f, "CIGAR", 0, 1, 1);
	iLocal_52 = __LIB_6__::func_958(uParam0, joaat("P_STOOLFOLDING01X"), 0f, 0f, 0f, 0, 1, 0, 1);
	iLocal_53 = __LIB_6__::func_958(uParam0, joaat("P_PEN01X"), 0f, 0f, 0f, "PEN", 0, 1, 1);
	Local_21 = { __LIB_7__::func_160(uParam0, 1.0275f, -0.048f, 0.988f, 99.5f, 6.3375f, 0.5125f, 0.4325f) };
	Local_31 = { __LIB_7__::func_160(uParam0, 1.17f, 0.197f, 0.988f, 180f, 6.5f, 0.3f, 0.3775f) };
	Local_41 = { __LIB_7__::func_160(uParam0, 1.17f, -0.1425f, 0.988f, 3.88f, 6.5f, 0.625f, 0.205f) };
	__LIB_6__::func_959(uParam0, "script@vignette@dutch_and_john_4@base", 1, 1, 0, 0);
	iLocal_16 = __LIB_6__::func_959(uParam0, "script@vignette@dutch_and_john_4@action_a", 2, 0, 1, 0);
	iLocal_17 = __LIB_6__::func_959(uParam0, "script@vignette@dutch_and_john_4@action_a_int_front", 2, 0, 0, 1);
	iLocal_18 = __LIB_6__::func_959(uParam0, "script@vignette@dutch_and_john_4@action_a_int_left", 2, 0, 0, 1);
	iLocal_19 = __LIB_6__::func_959(uParam0, "script@vignette@dutch_and_john_4@action_a_int_right", 2, 0, 0, 1);
	iLocal_20 = __LIB_6__::func_959(uParam0, "script@vignette@dutch_and_john_4@action_b", 0, 0, 0, 0);
	__LIB_7__::func_146(uParam0, "DNJ4AUD");
	__LIB_7__::func_147(uParam0, iLocal_15, 1, 4, 0, 0, 0);
	...
	__LIB_7__::func_127(uParam0, iLocal_14, 3, joaat("PROP_HUMAN_SEAT_CHAIR_DESK_WRITING"), "PROP_HUMAN_SEAT_CHAIR_DESK_WRITING_MALE_A", iLocal_52, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	__LIB_7__::func_259(uParam0, iLocal_14, iLocal_53, "", 1, "p_pen01x_PH_R_HAND");
	__LIB_7__::func_259(uParam0, iLocal_14, iLocal_51, "", 1, "p_cs_ledger01x_PH_L_HAND");
	__LIB_7__::func_149(uParam0, joaat("COMP_DNJCNV4"), joaat("PLAYER_DNJCNV4"));
	__LIB_7__::func_150(uParam0, iLocal_20, -1, 0.42f);
	return true;
}
...
{
	vLocal_55 = { ENTITY::GET_ENTITY_COORDS(__LIB_7__::func_30(uParam0, iLocal_51), true, false) };
	return true;
}
...
bool func_93(var uParam0)
{
	if (!bLocal_54)
	{
		...
		{
			if (__LIB_7__::func_163(uParam0, Local_21, 1, 0))
			{
				__LIB_7__::func_154(uParam0, iLocal_17, 1);
			}
			else if (__LIB_7__::func_163(uParam0, Local_31, 1, 0))
			{
